...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:29:11 PM
   **        *   FROM COBOL PGM   :  SWEXEW07
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_KDMV_RESTRICT_REINSTATE   DATE: 2008/06/17
       TARGET OS:   MVS                       TIME: 15:04:50
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXEW07_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW07_fd_FileSection";
            internal const string KDOROUT = "KDOROUT";
            internal const string KDOROUT_RECORD = "KDOROUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink KDOROUT { get; set; }
        public IField KDOROUT_RECORD { get { return GetElementByName<IField>(Names.KDOROUT_RECORD); } }


        internal SWEXEW07_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.KDOROUT_RECORD, FieldType.String, 250);
        ...
        public override void Initialize()
        {
            ...
            KDOROUT = FileHandler.GetFile("KDOROUT");
            KDOROUT.StatusField = WS.KDOROUT_STAT;
            KDOROUT.AssociatedBuffer = KDOROUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW07_fd(SWEXEW07_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW07_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW07_ws_WorkingStorage";
            internal const string KDOROUT_STAT = "KDOROUT_STAT";
            ...
            internal const string WS_KDOROUT = "WS_KDOROUT";
        ...
        #region Direct-access element properties
        public IField KDOROUT_STAT { get { return GetExternalElementByName<IField>(Names.KDOROUT_STAT); } }
        ...
        public IGroup WS_KDOROUT { get { return GetElementByName<IGroup>(Names.WS_KDOROUT); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.KDOROUT_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW07 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_KDOROUT, (WS_KDOROUT) =>
           {
               WS_KDOROUT.CreateNewField(Names.RECORD_TYPE, FieldType.String, 1);
               WS_KDOROUT.CreateNewField(Names.LAST_NAME, FieldType.String, 17);
               WS_KDOROUT.CreateNewField(Names.FIRST_NAME, FieldType.String, 12);
               WS_KDOROUT.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_KDOROUT.CreateNewField(Names.DOB, FieldType.String, 8);
               WS_KDOROUT.CreateNewField(Names.CSE_PERSON_NUMBER, FieldType.String, 10);
               WS_KDOROUT.CreateNewField(Names.DRIVER_LICENSE_NUM, FieldType.String, 9);
               WS_KDOROUT.CreateNewField(Names.PROCESS_DATE, FieldType.String, 8);
               WS_KDOROUT.CreateNewFillerField(176, FillWith.Hashes);
           });
    ...
    internal class SWEXEW07_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW07_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.KDMV_FILE_0002ET, (KDMV_FILE_0002ET) =>
               {
                   ...
                   KDMV_FILE_0002ET.CreateNewField(Names.PROCESS_DATE_0002AS, FieldType.String, 1);

                   IField PROCESS_DATE_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.PROCESS_DATE_0002, FieldType.String, 8);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.PROCESS_DATE_0002XX, FieldType.String, PROCESS_DATE_0002_local, 8);
               });
           });
    ...
    public class SWEXEW07 : BatchBase
    {
        ...
        public SWEXEW07()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW07");

            WS = new SWEXEW07_ws();
            FD = new SWEXEW07_fd(WS);
            LS = new SWEXEW07_ls();
        }
        ...
        private SWEXEW07_ws WS;

        //==== File Data Class ========================================
        private SWEXEW07_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW07_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230596731(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230596731
        /// </summary>
        private void M_MAIN_1230596731(string returnMethod = "")
        {
            M_PARA_1230596731_INIT("M_PARA_1230596731_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230596731-INIT THRU PARA-1230596731-INIT-EXIT
            M_PARA_1230596731("M_PARA_1230596731_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230596731 THRU PARA-1230596731-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230596731
        /// </summary>
        private void M_PARA_1230596731(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE80 IS A PART OF SWEXEW07*
            //COMMENT: ******************************************
        ...
        {
            FD.KDOROUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT KDOROUT.
            if (!(WS.KDOROUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDOROUT-STAT NOT = 00
            {
                ...
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDOROUT_STAT);                                              //COBOL==> MOVE KDOROUT-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.KDOROUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO KDOROUT-RECORD.
            FD.KDOROUT_RECORD.SetValue(WS.WS_KDOROUT);                                                          //COBOL==> MOVE WS-KDOROUT TO KDOROUT-RECORD.
            FD.KDOROUT.WriteLine(FD.KDOROUT_RECORD.AsBytes);                                                    //COBOL==> WRITE KDOROUT-RECORD.
            if (!(WS.KDOROUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDOROUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("WR");                                                            //COBOL==> MOVE 'WR' TO TEXT-RETURN-CODE-0003
                LS.TEXT_LINE_80_0003.SetValue("AN ERROR OCCURRED IN WRITTING");                                     //COBOL==> MOVE 'AN ERROR OCCURRED IN WRITTING' TO TEXT-LINE-80-0003
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDOROUT_STAT);                                              //COBOL==> MOVE KDOROUT-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.KDOROUT.CloseFile();                                                                             //COBOL==> CLOSE KDOROUT
            if (!(WS.KDOROUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDOROUT-STAT NOT = 00
            {
        ...
        {
            WS.WS_KDOROUT.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO WS-KDOROUT
            WS.RECORD_TYPE.SetValue(LS.FILE_TYPE_0002);                                                         //COBOL==> MOVE FILE-TYPE-0002 TO RECORD-TYPE
            WS.LAST_NAME.SetValue(LS.LAST_NAME_0002);                                                           //COBOL==> MOVE LAST-NAME-0002 TO LAST-NAME
            WS.FIRST_NAME.SetValue(LS.FIRST_NAME_0002);                                                         //COBOL==> MOVE FIRST-NAME-0002 TO FIRST-NAME
            WS.SSN.SetValue(LS.SSN_0002);                                                                       //COBOL==> MOVE SSN-0002 TO SSN
            WS.DOB.SetValue(LS.DOB_0002);                                                                       //COBOL==> MOVE DOB-0002 TO DOB
            WS.CSE_PERSON_NUMBER.SetValue(LS.CSE_PERSON_NUMBER_0002);                                           //COBOL==> MOVE CSE-PERSON-NUMBER-0002 TO CSE-PERSON-NUMBER
            WS.DRIVER_LICENSE_NUM.SetValue(LS.DRIVER_LICENSE_NUMBER_0002);                                      //COBOL==> MOVE DRIVER-LICENSE-NUMBER-0002 TO DRIVER-LICENSE-NUM
            WS.PROCESS_DATE.SetValue(LS.PROCESS_DATE_0002);                                                     //COBOL==> MOVE PROCESS-DATE-0002 TO PROCESS-DATE
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230596731_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230596731_EXIT
        /// </summary>
        private void M_PARA_1230596731_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230596731_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230596731_EXIT") { M_PARA_1230596731_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230596731_INIT
        /// </summary>
        private void M_PARA_1230596731_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1230596731_INIT") { M_PARA_1230596731_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230596731_INIT_EXIT
        /// </summary>
        private void M_PARA_1230596731_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230596731_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
