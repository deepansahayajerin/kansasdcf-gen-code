...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:44:49 PM
   **        *   FROM COBOL PGM   :  SWEXLE17
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_BFX7_WRITE_FILE               DATE: 2014/07/14
       TARGET OS:   MVS                       TIME: 10:59:36
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXLE17_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE17_fd_FileSection";
            internal const string NCP_STATE_FILE = "NCP_STATE_FILE";
            internal const string NCP_STATE_RECORD = "NCP_STATE_RECORD";
            internal const string NCP_FAMILY_FILE = "NCP_FAMILY_FILE";
            internal const string NCP_FAMILY_RECORD = "NCP_FAMILY_RECORD";
            internal const string CP_FILE = "CP_FILE";
            internal const string CP_RECORD = "CP_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink NCP_STATE_FILE { get; set; }
        public IField NCP_STATE_RECORD { get { return GetElementByName<IField>(Names.NCP_STATE_RECORD); } }
        public IFileLink NCP_FAMILY_FILE { get; set; }
        public IField NCP_FAMILY_RECORD { get { return GetElementByName<IField>(Names.NCP_FAMILY_RECORD); } }
        public IFileLink CP_FILE { get; set; }
        public IField CP_RECORD { get { return GetElementByName<IField>(Names.CP_RECORD); } }


        internal SWEXLE17_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.NCP_STATE_RECORD, FieldType.String, 133);
            recordDef.CreateNewField(Names.NCP_FAMILY_RECORD, FieldType.String, 133);
            recordDef.CreateNewField(Names.CP_RECORD, FieldType.String, 133);
        ...
        public override void Initialize()
        {
            ...
            NCP_STATE_FILE = FileHandler.GetFile("NCPSTATE");
            NCP_STATE_FILE.StatusField = WS.FILE_STATUS;
            NCP_STATE_FILE.AssociatedBuffer = NCP_STATE_RECORD;

            NCP_FAMILY_FILE = FileHandler.GetFile("NCPFAMLY");
            NCP_FAMILY_FILE.StatusField = WS.FILE_STATUS;
            NCP_FAMILY_FILE.AssociatedBuffer = NCP_FAMILY_RECORD;

            CP_FILE = FileHandler.GetFile("CPFILE");
            CP_FILE.StatusField = WS.FILE_STATUS;
            CP_FILE.AssociatedBuffer = CP_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXLE17_fd(SWEXLE17_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE17_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE17_ws_WorkingStorage";
            internal const string FILE_STATUS = "FILE_STATUS";
            internal const string WS_RECORD = "WS_RECORD";
            internal const string OUT_REC_PERSON_NUMBER = "OUT_REC_PERSON_NUMBER";
            internal const string FILLER_1 = "FILLER_1";
            internal const string OUT_REC_CASE_NUMBER = "OUT_REC_CASE_NUMBER";
            internal const string FILLER_2 = "FILLER_2";
            internal const string OUT_REC_CASE_ROLE = "OUT_REC_CASE_ROLE";
            internal const string FILLER_3 = "FILLER_3";
            internal const string OUT_REC_LEG_ACT_ID = "OUT_REC_LEG_ACT_ID";
            internal const string FILLER_4 = "FILLER_4";
            internal const string OUT_REC_CH_PERS_NUM = "OUT_REC_CH_PERS_NUM";
        }
        #endregion
        ...
        public IField OUT_REC_PERSON_NUMBER { get { return GetElementByName<IField>(Names.OUT_REC_PERSON_NUMBER); } }
        public IField FILLER_1 { get { return GetElementByName<IField>(Names.FILLER_1); } }
        public IField OUT_REC_CASE_NUMBER { get { return GetElementByName<IField>(Names.OUT_REC_CASE_NUMBER); } }
        public IField FILLER_2 { get { return GetElementByName<IField>(Names.FILLER_2); } }
        public IField OUT_REC_CASE_ROLE { get { return GetElementByName<IField>(Names.OUT_REC_CASE_ROLE); } }
        public IField FILLER_3 { get { return GetElementByName<IField>(Names.FILLER_3); } }
        public IField OUT_REC_LEG_ACT_ID { get { return GetElementByName<IField>(Names.OUT_REC_LEG_ACT_ID); } }
        public IField FILLER_4 { get { return GetElementByName<IField>(Names.FILLER_4); } }
        public IField OUT_REC_CH_PERS_NUM { get { return GetElementByName<IField>(Names.OUT_REC_CH_PERS_NUM); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_RECORD.CreateNewField(Names.OUT_REC_PERSON_NUMBER, FieldType.String, 10);
               WS_RECORD.CreateNewField(Names.FILLER_1, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.OUT_REC_CASE_NUMBER, FieldType.String, 10);
               WS_RECORD.CreateNewField(Names.FILLER_2, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.OUT_REC_CASE_ROLE, FieldType.String, 2);
               WS_RECORD.CreateNewField(Names.FILLER_3, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.OUT_REC_LEG_ACT_ID, FieldType.UnsignedNumeric, 9);
               WS_RECORD.CreateNewField(Names.FILLER_4, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.OUT_REC_CH_PERS_NUM, FieldType.String, 10);
               WS_RECORD.CreateNewFillerField(88, FillWith.Hashes);
           });
    ...
    internal class SWEXLE17_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE17_ls_LinkageSection";
            ...
            internal const string CASE_ROLE_0003ET = "CASE_ROLE_0003ET";
            ...
            internal const string IMPORT_CHILD_0005EV = "IMPORT_CHILD_0005EV";
            ...
            internal const string IMPORT_FILE_NUMBER_0006EV = "IMPORT_FILE_NUMBER_0006EV";
            ...
            internal const string EAB_REPORT_SEND_0007ET = "EAB_REPORT_SEND_0007ET";
        ...
        public IGroup CASE_ROLE_0003ET { get { return GetElementByName<IGroup>(Names.CASE_ROLE_0003ET); } }
        ...
        public IGroup IMPORT_CHILD_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_CHILD_0005EV); } }
        ...
        public IGroup IMPORT_FILE_NUMBER_0006EV { get { return GetElementByName<IGroup>(Names.IMPORT_FILE_NUMBER_0006EV); } }
        ...
        public IGroup EAB_REPORT_SEND_0007ET { get { return GetElementByName<IGroup>(Names.EAB_REPORT_SEND_0007ET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0003EV.CreateNewGroup(Names.CASE_ROLE_0003ET, (CASE_ROLE_0003ET) =>
               {
                   CASE_ROLE_0003ET.CreateNewField(Names.TYPE_0003AS, FieldType.String, 1);

                   IField TYPE_0003_local = CASE_ROLE_0003ET.CreateNewField(Names.TYPE_0003, FieldType.String, 2);
                   CASE_ROLE_0003ET.CreateNewFieldRedefine(Names.TYPE_0003XX, FieldType.String, TYPE_0003_local, 2);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0004EV, (IMPORT_0004EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CHILD_0005EV, (IMPORT_CHILD_0005EV) =>
           {
               IMPORT_CHILD_0005EV.CreateNewGroup(Names.CSE_PERSON_0005ET, (CSE_PERSON_0005ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_FILE_NUMBER_0006EV, (IMPORT_FILE_NUMBER_0006EV) =>
           {
               IMPORT_FILE_NUMBER_0006EV.CreateNewGroup(Names.TEXT_WORK_AREA_0006ET, (TEXT_WORK_AREA_0006ET) =>
               {
           ...
           {
               IMPORT_0007EV.CreateNewGroup(Names.EAB_REPORT_SEND_0007ET, (EAB_REPORT_SEND_0007ET) =>
               {
                   EAB_REPORT_SEND_0007ET.CreateNewField(Names.RPT_DETAIL_0007AS, FieldType.String, 1);

                   IField RPT_DETAIL_0007_local = EAB_REPORT_SEND_0007ET.CreateNewField(Names.RPT_DETAIL_0007, FieldType.String, 132);
                   EAB_REPORT_SEND_0007ET.CreateNewFieldRedefine(Names.RPT_DETAIL_0007XX, FieldType.String, RPT_DETAIL_0007_local, 132);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_CHILD_0005EV, args, 7);
            SetPassedParm(IMPORT_FILE_NUMBER_0006EV, args, 8);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_CHILD_0005EV, args, 7);
            SetReturnParm(IMPORT_FILE_NUMBER_0006EV, args, 8);
    ...
    public class SWEXLE17 : BatchBase
    {
        ...
        public SWEXLE17()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE17");

            WS = new SWEXLE17_ws();
            FD = new SWEXLE17_fd(WS);
            LS = new SWEXLE17_ls();
        }
        ...
        private SWEXLE17_ws WS;

        //==== File Data Class ========================================
        private SWEXLE17_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE17_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0003EV , IMPORT-0004EV , IMPORT-CHILD-0005EV , IMPORT-FILE-NUMBER-0006EV , IMPORT-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1722025557(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1722025557
        /// </summary>
        private void M_MAIN_1722025557(string returnMethod = "")
        {
            M_PARA_1722025557_INIT("M_PARA_1722025557_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1722025557-INIT THRU PARA-1722025557-INIT-EXIT
            M_PARA_1722025557("M_PARA_1722025557_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1722025557 THRU PARA-1722025557-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1722025557
        /// </summary>
        private void M_PARA_1722025557(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1722025557") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0008.SetValue("BI");                                                                      //COBOL==> MOVE 'BI' TO STATUS-0008
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        {
            //COMMENT: ******************
            // EvaluateList !LS.TEXT_1_0006!                                                                    //COBOL==> EVALUATE TEXT-1-0006
            if ((LS.TEXT_1_0006.IsEqualTo("1")))                                                                //COBOL==> WHEN '1'
            {
                FD.NCP_STATE_FILE.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT NCP-STATE-FILE
            }                                                                                                //COBOL==> WHEN '2'
            else
            if ((LS.TEXT_1_0006.IsEqualTo("2")))
            {
                FD.NCP_FAMILY_FILE.OpenFile(FileAccessMode.Write);                                                  //COBOL==> OPEN OUTPUT NCP-FAMILY-FILE
            }                                                                                                //COBOL==> WHEN '3'
            else
            if ((LS.TEXT_1_0006.IsEqualTo("3")))
            {
                FD.CP_FILE.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT CP-FILE
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0008.SetValue("BN");                                                                      //COBOL==> MOVE 'BN' TO STATUS-0008
            }                                                                                                   //COBOL==> END-EVALUATE
            ...
            {
                LS.STATUS_0008.SetValue("PE");                                                                      //COBOL==> MOVE 'PE' TO STATUS-0008
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_2000_WRITE_FILE(string returnMethod = "")
        {
            ...
            if ((LS.TEXT_1_0006.IsEqualTo("1")))                                                                //COBOL==> WHEN '1'
            {
                FD.NCP_STATE_RECORD.SetValue(LS.RPT_DETAIL_0007);                                                   //COBOL==> MOVE RPT-DETAIL-0007 TO NCP-STATE-RECORD
                FD.NCP_STATE_FILE.WriteLine(FD.NCP_STATE_RECORD.AsBytes);                                           //COBOL==> WRITE NCP-STATE-RECORD
            }                                                                                                //COBOL==> WHEN '2'
            else
            if ((LS.TEXT_1_0006.IsEqualTo("2")))
            {
                FD.NCP_FAMILY_RECORD.SetValue(LS.RPT_DETAIL_0007);                                                  //COBOL==> MOVE RPT-DETAIL-0007 TO NCP-FAMILY-RECORD
                FD.NCP_FAMILY_FILE.WriteLine(FD.NCP_FAMILY_RECORD.AsBytes);                                         //COBOL==> WRITE NCP-FAMILY-RECORD
            }                                                                                                //COBOL==> WHEN '3'
            else
            if ((LS.TEXT_1_0006.IsEqualTo("3")))
            {
                WS.OUT_REC_PERSON_NUMBER.SetValue(LS.NUMBER_0002);                                                  //COBOL==> MOVE NUMBER-0002 TO OUT-REC-PERSON-NUMBER
                WS.OUT_REC_CASE_ROLE.SetValue(LS.TYPE_0003);                                                        //COBOL==> MOVE TYPE-0003 TO OUT-REC-CASE-ROLE
                WS.OUT_REC_CASE_NUMBER.SetValue(LS.NUMBER_0004);                                                    //COBOL==> MOVE NUMBER-0004 TO OUT-REC-CASE-NUMBER
                WS.OUT_REC_CH_PERS_NUM.SetValue(LS.NUMBER_0005);                                                    //COBOL==> MOVE NUMBER-0005 TO OUT-REC-CH-PERS-NUM
                FD.CP_RECORD.SetValue(WS.WS_RECORD);                                                                //COBOL==> MOVE WS-RECORD TO CP-RECORD
                FD.CP_FILE.WriteLine(FD.CP_RECORD.AsBytes);                                                         //COBOL==> WRITE CP-RECORD
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0008.SetValue("BN");                                                                      //COBOL==> MOVE 'BN' TO STATUS-0008
            ...
            {
                LS.STATUS_0008.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0008
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_3000_CLOSE_FILE(string returnMethod = "")
        {
            ...
            if ((LS.TEXT_1_0006.IsEqualTo("1")))                                                                //COBOL==> WHEN '1'
            {
                FD.NCP_STATE_FILE.CloseFile();                                                                      //COBOL==> CLOSE NCP-STATE-FILE
            }                                                                                                //COBOL==> WHEN '2'
            else
            if ((LS.TEXT_1_0006.IsEqualTo("2")))
            {
                FD.NCP_FAMILY_FILE.CloseFile();                                                                     //COBOL==> CLOSE NCP-FAMILY-FILE
            }                                                                                                //COBOL==> WHEN '3'
            else
            if ((LS.TEXT_1_0006.IsEqualTo("3")))
            {
                FD.CP_FILE.CloseFile();                                                                             //COBOL==> CLOSE CP-FILE
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0008.SetValue("BN");                                                                      //COBOL==> MOVE 'BN' TO STATUS-0008
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1722025557_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1722025557_EXIT
        /// </summary>
        private void M_PARA_1722025557_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1722025557_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1722025557_EXIT") { M_PARA_1722025557_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1722025557_INIT
        /// </summary>
        private void M_PARA_1722025557_INIT(string returnMethod = "")
        {
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1722025557_INIT") { M_PARA_1722025557_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1722025557_INIT_EXIT
        /// </summary>
        private void M_PARA_1722025557_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1722025557_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
