...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:46:26 PM
   **        *   FROM COBOL PGM   :  SWEXPW01
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: SP_EAB_WRITE_DOCUMENT            DATE: 2000/02/08
       TARGET OS:   MVS                       TIME: 08:42:49
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXPW01_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXPW01_fd_FileSection";
            internal const string RPTOUT1 = "RPTOUT1";
            internal const string DETAIL1 = "DETAIL1";
            internal const string RPTOUT2 = "RPTOUT2";
            internal const string DETAIL2 = "DETAIL2";
            internal const string RPTOUT3 = "RPTOUT3";
            internal const string DETAIL3 = "DETAIL3";
            internal const string RPTOUT4 = "RPTOUT4";
            internal const string DETAIL4 = "DETAIL4";
            internal const string RPTOUT5 = "RPTOUT5";
            internal const string DETAIL5 = "DETAIL5";
            internal const string RPTOUT6 = "RPTOUT6";
            internal const string DETAIL6 = "DETAIL6";
            internal const string RPTOUT7 = "RPTOUT7";
            internal const string DETAIL7 = "DETAIL7";
            internal const string RPTOUT8 = "RPTOUT8";
            internal const string DETAIL8 = "DETAIL8";
            internal const string RPTOUT9 = "RPTOUT9";
            internal const string DETAIL9 = "DETAIL9";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink RPTOUT1 { get; set; }
        public IField DETAIL1 { get { return GetElementByName<IField>(Names.DETAIL1); } }
        public IFileLink RPTOUT2 { get; set; }
        public IField DETAIL2 { get { return GetElementByName<IField>(Names.DETAIL2); } }
        public IFileLink RPTOUT3 { get; set; }
        public IField DETAIL3 { get { return GetElementByName<IField>(Names.DETAIL3); } }
        public IFileLink RPTOUT4 { get; set; }
        public IField DETAIL4 { get { return GetElementByName<IField>(Names.DETAIL4); } }
        public IFileLink RPTOUT5 { get; set; }
        public IField DETAIL5 { get { return GetElementByName<IField>(Names.DETAIL5); } }
        public IFileLink RPTOUT6 { get; set; }
        public IField DETAIL6 { get { return GetElementByName<IField>(Names.DETAIL6); } }
        public IFileLink RPTOUT7 { get; set; }
        public IField DETAIL7 { get { return GetElementByName<IField>(Names.DETAIL7); } }
        public IFileLink RPTOUT8 { get; set; }
        public IField DETAIL8 { get { return GetElementByName<IField>(Names.DETAIL8); } }
        public IFileLink RPTOUT9 { get; set; }
        public IField DETAIL9 { get { return GetElementByName<IField>(Names.DETAIL9); } }
        ...
        {
            recordDef.CreateNewField(Names.DETAIL1, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL2, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL3, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL4, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL5, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL6, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL7, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL8, FieldType.String, 81);
            recordDef.CreateNewField(Names.DETAIL9, FieldType.String, 81);
        ...
        public override void Initialize()
        {
            ...
            RPTOUT1 = FileHandler.GetFile("UT_S_RPT01");
            RPTOUT1.AssociatedBuffer = DETAIL1;
            RPTOUT1.RecordLength = 81;

            RPTOUT2 = FileHandler.GetFile("UT_S_RPT02");
            RPTOUT2.AssociatedBuffer = DETAIL2;
            RPTOUT2.RecordLength = 81;

            RPTOUT3 = FileHandler.GetFile("UT_S_RPT03");
            RPTOUT3.AssociatedBuffer = DETAIL3;
            RPTOUT3.RecordLength = 81;

            RPTOUT4 = FileHandler.GetFile("UT_S_RPT04");
            RPTOUT4.AssociatedBuffer = DETAIL4;
            RPTOUT4.RecordLength = 81;

            RPTOUT5 = FileHandler.GetFile("UT_S_RPT05");
            RPTOUT5.AssociatedBuffer = DETAIL5;
            RPTOUT5.RecordLength = 81;

            RPTOUT6 = FileHandler.GetFile("UT_S_RPT06");
            RPTOUT6.AssociatedBuffer = DETAIL6;
            RPTOUT6.RecordLength = 81;

            RPTOUT7 = FileHandler.GetFile("UT_S_RPT07");
            RPTOUT7.AssociatedBuffer = DETAIL7;
            RPTOUT7.RecordLength = 81;

            RPTOUT8 = FileHandler.GetFile("UT_S_RPT08");
            RPTOUT8.AssociatedBuffer = DETAIL8;
            RPTOUT8.RecordLength = 81;

            RPTOUT9 = FileHandler.GetFile("UT_S_RPT09");
            RPTOUT9.AssociatedBuffer = DETAIL9;
            RPTOUT9.RecordLength = 81;
        }
        #endregion
    ...
    internal class SWEXPW01_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXPW01_ws_WorkingStorage";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_DETAIL_LINE, (WS_DETAIL_LINE) =>
           {
               ...
               WS_DETAIL_LINE.CreateNewField(Names.WS_DETAIL_BODY, FieldType.String, 80, SPACES);
           });
    ...
    internal class SWEXPW01_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXPW01_ls_LinkageSection";
            ...
            internal const string RPT_DETAIL_0002AS = "RPT_DETAIL_0002AS";
            internal const string RPT_DETAIL_0002 = "RPT_DETAIL_0002";
            internal const string RPT_DETAIL_0002XX = "RPT_DETAIL_0002XX";
        ...
        public IField RPT_DETAIL_0002AS { get { return GetElementByName<IField>(Names.RPT_DETAIL_0002AS); } }
        public IField RPT_DETAIL_0002 { get { return GetElementByName<IField>(Names.RPT_DETAIL_0002); } }
        public IField RPT_DETAIL_0002XX { get { return GetElementByName<IField>(Names.RPT_DETAIL_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
               IMPORT_0002EV.CreateNewGroup(Names.EAB_REPORT_SEND_0002ET, (EAB_REPORT_SEND_0002ET) =>
               {
                   ...
                   EAB_REPORT_SEND_0002ET.CreateNewField(Names.RPT_DETAIL_0002AS, FieldType.String, 1);

                   IField RPT_DETAIL_0002_local = EAB_REPORT_SEND_0002ET.CreateNewField(Names.RPT_DETAIL_0002, FieldType.String, 132);
                   EAB_REPORT_SEND_0002ET.CreateNewFieldRedefine(Names.RPT_DETAIL_0002XX, FieldType.String, RPT_DETAIL_0002_local, 132);
               });
           });
    ...
    public class SWEXPW01 : BatchBase
    {
        ...
        public SWEXPW01()
            : base()
        {
            this.ProgramName.SetValue("SWEXPW01");
        ...
        private SWEXPW01_ws WS;

        //==== File Data Class ========================================
        private SWEXPW01_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXPW01_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1297089011(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1297089011
        /// </summary>
        private void M_MAIN_1297089011(string returnMethod = "")
        {
            M_PARA_1297089011_INIT("M_PARA_1297089011_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1297089011-INIT THRU PARA-1297089011-INIT-EXIT
            M_PARA_1297089011("M_PARA_1297089011_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1297089011 THRU PARA-1297089011-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1297089011
        /// </summary>
        private void M_PARA_1297089011(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1297089011") { M_PARA_1297089011_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1297089011_EXIT
        /// </summary>
        private void M_PARA_1297089011_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1297089011_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1297089011_EXIT") { M_PARA_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MAIN
        /// </summary>
        private void M_PARA_MAIN(string returnMethod = "")
        {
            ...
            if ((LS.COMMAND_0002.IsEqualTo("NEWPAGE")))                                                         //COBOL==> WHEN 'NEWPAGE'
            {
        ...
        private void M_PARA_DETAIL(string returnMethod = "")
        {
            ...
            WS.WS_DETAIL_BODY.SetValue(LS.RPT_DETAIL_0002);                                                     //COBOL==> MOVE RPT-DETAIL-0002 TO WS-DETAIL-BODY.
                                                                                                                // EvaluateList !LS.REPORT_NUMBER_0002!                                                             //COBOL==> EVALUATE REPORT-NUMBER-0002
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(01)))                                                          //COBOL==> WHEN 01
            {
                FD.RPTOUT1.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL1 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 02
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(02)))
            {
                FD.RPTOUT2.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL2 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 03
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(03)))
            {
                FD.RPTOUT3.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL3 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 04
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(04)))
            {
                FD.RPTOUT4.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL4 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 05
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(05)))
            {
                FD.RPTOUT5.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL5 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 06
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(06)))
            {
                FD.RPTOUT6.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL6 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 07
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(07)))
            {
                FD.RPTOUT7.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL7 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 08
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(08)))
            {
                FD.RPTOUT8.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL8 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN 09
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(09)))
            {
                FD.RPTOUT9.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.LINEBREAK, 0, 1);             //COBOL==> WRITE DETAIL9 FROM WS-DETAIL-LINE AFTER ADVANCING 1 LINE
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0003.SetValue("ABEND");                                                                   //COBOL==> MOVE 'ABEND' TO STATUS-0003.
        ...
        private void M_PARA_HEADINGS(string returnMethod = "")
        {
            ...
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(01)))                                                          //COBOL==> WHEN 01
            {
                FD.RPTOUT1.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL1 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 02
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(02)))
            {
                FD.RPTOUT2.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL2 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 03
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(03)))
            {
                FD.RPTOUT3.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL3 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 04
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(04)))
            {
                FD.RPTOUT4.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL4 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 05
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(05)))
            {
                FD.RPTOUT5.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL5 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 06
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(06)))
            {
                FD.RPTOUT6.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL6 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 07
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(07)))
            {
                FD.RPTOUT7.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL7 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 08
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(08)))
            {
                FD.RPTOUT8.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL8 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN 09
            else
            if ((LS.REPORT_NUMBER_0002.IsEqualTo(09)))
            {
                FD.RPTOUT9.WriteLinePrinter(WS.WS_DETAIL_LINE.AsString(), PrinterControl.PAGEBREAK, 0, 1);             //COBOL==> WRITE DETAIL9 FROM WS-DETAIL-LINE AFTER ADVANCING PAGE
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0003.SetValue("ABEND");                                                                   //COBOL==> MOVE 'ABEND' TO STATUS-0003.
        ...
        private void M_PARA_HEADINGS_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_HEADINGS_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.RPTOUT1.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT RPTOUT1 RPTOUT2 RPTOUT3 RPTOUT4 RPTOUT5 RPTOUT6 RPTOUT7 RPTOUT8 RPTOUT9.
            FD.RPTOUT2.OpenFile(FileAccessMode.Write);
            FD.RPTOUT3.OpenFile(FileAccessMode.Write);
            FD.RPTOUT4.OpenFile(FileAccessMode.Write);
            FD.RPTOUT5.OpenFile(FileAccessMode.Write);
            FD.RPTOUT6.OpenFile(FileAccessMode.Write);
            FD.RPTOUT7.OpenFile(FileAccessMode.Write);
            FD.RPTOUT8.OpenFile(FileAccessMode.Write);
            FD.RPTOUT9.OpenFile(FileAccessMode.Write);
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003.
        ...
        {
            FD.RPTOUT1.CloseFile();                                                                             //COBOL==> CLOSE RPTOUT1 RPTOUT2 RPTOUT3 RPTOUT4 RPTOUT5 RPTOUT6 RPTOUT7 RPTOUT8 RPTOUT9.
            FD.RPTOUT2.CloseFile();
            FD.RPTOUT3.CloseFile();
            FD.RPTOUT4.CloseFile();
            FD.RPTOUT5.CloseFile();
            FD.RPTOUT6.CloseFile();
            FD.RPTOUT7.CloseFile();
            FD.RPTOUT8.CloseFile();
            FD.RPTOUT9.CloseFile();
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_1297089011_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1297089011_INIT
        /// </summary>
        private void M_PARA_1297089011_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1297089011_INIT") { M_PARA_1297089011_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1297089011_INIT_EXIT
        /// </summary>
        private void M_PARA_1297089011_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1297089011_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
