...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:30:43 PM
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    public class SWEXF222 : BatchBase
    {
        ...
        {
            if ((LS.I_TEXT_10_0001_001XX.IsMaxValue())
             || (LS.I_TEXT_10_0001_001XX.IsMinValue()))  //COBOL==> IF I-TEXT-10-0001-001XX = HIGH-VALUES OR I-TEXT-10-0001-001XX = LOW-VALUES
            {
                LS.I_TEXT_10_0001_001.SetValueWithSpaces();                                                         //COBOL==> MOVE SPACES TO I-TEXT-10-0001-001
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_NAME_0002_002XX.IsMaxValue())
             || (LS.I_NAME_0002_002XX.IsMinValue()))     //COBOL==> IF I-NAME-0002-002XX = HIGH-VALUES OR I-NAME-0002-002XX = LOW-VALUES
            {
                LS.I_NAME_0002_002.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO I-NAME-0002-002
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_LAST_NAME_0003_003XX.IsMaxValue())
             || (LS.I_LAST_NAME_0003_003XX.IsMinValue()))  //COBOL==> IF I-LAST-NAME-0003-003XX = HIGH-VALUES OR I-LAST-NAME-0003-003XX = LOW-VALUES
            {
                LS.I_LAST_NAME_0003_003.SetValueWithSpaces();                                                       //COBOL==> MOVE SPACES TO I-LAST-NAME-0003-003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_FIRST_NAME_0003_004XX.IsMaxValue())
             || (LS.I_FIRST_NAME_0003_004XX.IsMinValue()))  //COBOL==> IF I-FIRST-NAME-0003-004XX = HIGH-VALUES OR I-FIRST-NAME-0003-004XX = LOW-VALUES
            {
                LS.I_FIRST_NAME_0003_004.SetValueWithSpaces();                                                      //COBOL==> MOVE SPACES TO I-FIRST-NAME-0003-004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_MIDDLE_INITIAL_0003_005XX.IsMaxValue())
             || (LS.I_MIDDLE_INITIAL_0003_005XX.IsMinValue()))  //COBOL==> IF I-MIDDLE-INITIAL-0003-005XX = HIGH-VALUES OR I-MIDDLE-INITIAL-0003-005XX = LOW-VALUES
            {
                LS.I_MIDDLE_INITIAL_0003_005.SetValueWithSpaces();                                                  //COBOL==> MOVE SPACES TO I-MIDDLE-INITIAL-0003-005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_USER_ID_0003_006XX.IsMaxValue())
             || (LS.I_USER_ID_0003_006XX.IsMinValue()))  //COBOL==> IF I-USER-ID-0003-006XX = HIGH-VALUES OR I-USER-ID-0003-006XX = LOW-VALUES
            {
                LS.I_USER_ID_0003_006.SetValueWithSpaces();                                                         //COBOL==> MOVE SPACES TO I-USER-ID-0003-006
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_USER_ID_0004_007XX.IsMaxValue())
             || (LS.I_USER_ID_0004_007XX.IsMinValue()))  //COBOL==> IF I-USER-ID-0004-007XX = HIGH-VALUES OR I-USER-ID-0004-007XX = LOW-VALUES
            {
                LS.I_USER_ID_0004_007.SetValueWithSpaces();                                                         //COBOL==> MOVE SPACES TO I-USER-ID-0004-007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_LAST_NAME_0004_008XX.IsMaxValue())
             || (LS.I_LAST_NAME_0004_008XX.IsMinValue()))  //COBOL==> IF I-LAST-NAME-0004-008XX = HIGH-VALUES OR I-LAST-NAME-0004-008XX = LOW-VALUES
            {
                LS.I_LAST_NAME_0004_008.SetValueWithSpaces();                                                       //COBOL==> MOVE SPACES TO I-LAST-NAME-0004-008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_FIRST_NAME_0004_009XX.IsMaxValue())
             || (LS.I_FIRST_NAME_0004_009XX.IsMinValue()))  //COBOL==> IF I-FIRST-NAME-0004-009XX = HIGH-VALUES OR I-FIRST-NAME-0004-009XX = LOW-VALUES
            {
                LS.I_FIRST_NAME_0004_009.SetValueWithSpaces();                                                      //COBOL==> MOVE SPACES TO I-FIRST-NAME-0004-009
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_MIDDLE_INITIAL_0004_010XX.IsMaxValue())
             || (LS.I_MIDDLE_INITIAL_0004_010XX.IsMinValue()))  //COBOL==> IF I-MIDDLE-INITIAL-0004-010XX = HIGH-VALUES OR I-MIDDLE-INITIAL-0004-010XX = LOW-VALUES
            {
                LS.I_MIDDLE_INITIAL_0004_010.SetValueWithSpaces();                                                  //COBOL==> MOVE SPACES TO I-MIDDLE-INITIAL-0004-010
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_NUMBER_0005_011XX.IsMaxValue())
             || (LS.I_NUMBER_0005_011XX.IsMinValue())) //COBOL==> IF I-NUMBER-0005-011XX = HIGH-VALUES OR I-NUMBER-0005-011XX = LOW-VALUES
            {
                LS.I_NUMBER_0005_011.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO I-NUMBER-0005-011
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_FORMATTED_NAME_0005_012XX.IsMaxValue())
             || (LS.I_FORMATTED_NAME_0005_012XX.IsMinValue()))  //COBOL==> IF I-FORMATTED-NAME-0005-012XX = HIGH-VALUES OR I-FORMATTED-NAME-0005-012XX = LOW-VALUES
            {
                LS.I_FORMATTED_NAME_0005_012.SetValueWithSpaces();                                                  //COBOL==> MOVE SPACES TO I-FORMATTED-NAME-0005-012
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_TEXT_10_0006_013XX.IsMaxValue())
             || (LS.I_TEXT_10_0006_013XX.IsMinValue()))  //COBOL==> IF I-TEXT-10-0006-013XX = HIGH-VALUES OR I-TEXT-10-0006-013XX = LOW-VALUES
            {
                LS.I_TEXT_10_0006_013.SetValueWithSpaces();                                                         //COBOL==> MOVE SPACES TO I-TEXT-10-0006-013
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_STANDARD_NUMBER_0007_014XX.IsMaxValue())
             || (LS.I_STANDARD_NUMBER_0007_014XX.IsMinValue()))  //COBOL==> IF I-STANDARD-NUMBER-0007-014XX = HIGH-VALUES OR I-STANDARD-NUMBER-0007-014XX = LOW-VALUES
            {
            ...
            if ((LS.I_CREATED_BY_0008_016XX.IsMaxValue())
             || (LS.I_CREATED_BY_0008_016XX.IsMinValue()))  //COBOL==> IF I-CREATED-BY-0008-016XX = HIGH-VALUES OR I-CREATED-BY-0008-016XX = LOW-VALUES
            {
                LS.I_CREATED_BY_0008_016.SetValueWithSpaces();                                                      //COBOL==> MOVE SPACES TO I-CREATED-BY-0008-016
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_TEXT_30_0009_017XX.IsMaxValue())
             || (LS.I_TEXT_30_0009_017XX.IsMinValue()))  //COBOL==> IF I-TEXT-30-0009-017XX = HIGH-VALUES OR I-TEXT-30-0009-017XX = LOW-VALUES
            {
                LS.I_TEXT_30_0009_017.SetValueWithSpaces();                                                         //COBOL==> MOVE SPACES TO I-TEXT-30-0009-017
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_PARM1_0010_018XX.IsMaxValue())
             || (LS.I_PARM1_0010_018XX.IsMinValue()))   //COBOL==> IF I-PARM1-0010-018XX = HIGH-VALUES OR I-PARM1-0010-018XX = LOW-VALUES
            {
                LS.I_PARM1_0010_018.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO I-PARM1-0010-018
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_PARM2_0010_019XX.IsMaxValue())
             || (LS.I_PARM2_0010_019XX.IsMinValue()))   //COBOL==> IF I-PARM2-0010-019XX = HIGH-VALUES OR I-PARM2-0010-019XX = LOW-VALUES
            {
