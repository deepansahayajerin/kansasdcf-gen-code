...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:29:40 PM
   **        *   FROM COBOL PGM   :  SWEXEW18
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_B607_WRITE_EXTRACT_DATA       DATE: 2013/08/23
       TARGET OS:   MVS                       TIME: 06:59:20
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXEW18_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW18_fd_FileSection";
            internal const string ATTYOUT = "ATTYOUT";
            internal const string ATTYOUT_RECORD = "ATTYOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink ATTYOUT { get; set; }
        public IField ATTYOUT_RECORD { get { return GetElementByName<IField>(Names.ATTYOUT_RECORD); } }


        internal SWEXEW18_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.ATTYOUT_RECORD, FieldType.String, 700);
        ...
        public override void Initialize()
        {
            ...
            ATTYOUT = FileHandler.GetFile("ATTYOUT");
            ATTYOUT.StatusField = WS.ATTYOUT_STAT;
            ATTYOUT.AssociatedBuffer = ATTYOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW18_fd(SWEXEW18_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW18_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW18_ws_WorkingStorage";
            internal const string ATTYOUT_STAT = "ATTYOUT_STAT";
            ...
            internal const string WS_ATTYOUT = "WS_ATTYOUT";
            internal const string ATTYNUM = "ATTYNUM";
            internal const string COUNTY_ABBR = "COUNTY_ABBR";
            internal const string CT_ORDER_NUM = "CT_ORDER_NUM";
            internal const string LA_ID = "LA_ID";
            internal const string AP_NUMBER = "AP_NUMBER";
            internal const string AR_NUMBER = "AR_NUMBER";
            internal const string ATTY_INFO = "ATTY_INFO";
        }
        #endregion

        #region Direct-access element properties
        public IField ATTYOUT_STAT { get { return GetExternalElementByName<IField>(Names.ATTYOUT_STAT); } }
        ...
        public IGroup WS_ATTYOUT { get { return GetElementByName<IGroup>(Names.WS_ATTYOUT); } }
        public IField ATTYNUM { get { return GetElementByName<IField>(Names.ATTYNUM); } }
        public IField COUNTY_ABBR { get { return GetElementByName<IField>(Names.COUNTY_ABBR); } }
        public IField CT_ORDER_NUM { get { return GetElementByName<IField>(Names.CT_ORDER_NUM); } }
        public IField LA_ID { get { return GetElementByName<IField>(Names.LA_ID); } }
        ...
        public IField ATTY_INFO { get { return GetElementByName<IField>(Names.ATTY_INFO); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.ATTYOUT_STAT, FieldType.UnsignedNumeric, 2);
            ...
            recordDef.CreateNewGroup(Names.WS_MISC, (WS_MISC) =>
           {
            ...
            recordDef.CreateNewGroup(Names.WS_ATTYOUT, (WS_ATTYOUT) =>
           {
               WS_ATTYOUT.CreateNewField(Names.ATTYNUM, FieldType.String, 2);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewField(Names.COUNTY_ABBR, FieldType.String, 2);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewField(Names.CT_ORDER_NUM, FieldType.String, 20);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewField(Names.LA_ID, FieldType.UnsignedNumeric, 9);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewField(Names.AP_NUMBER, FieldType.String, 200);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewField(Names.AR_NUMBER, FieldType.String, 200);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewField(Names.ATTY_INFO, FieldType.String, 200);
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_ATTYOUT.CreateNewFillerField(FieldType.String, 60, SPACES);
           });
    ...
    internal class SWEXEW18_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW18_ls_LinkageSection";
            ...
            internal const string FIPS_0001ET = "FIPS_0001ET";
            internal const string COUNTY_ABBREVIATION_0001AS = "COUNTY_ABBREVIATION_0001AS";
            internal const string COUNTY_ABBREVIATION_0001 = "COUNTY_ABBREVIATION_0001";
            internal const string COUNTY_ABBREVIATION_0001XX = "COUNTY_ABBREVIATION_0001XX";
            internal const string COUNTY_0001AS = "COUNTY_0001AS";
            internal const string COUNTY_0001 = "COUNTY_0001";
            internal const string COUNTY_0001XX = "COUNTY_0001XX";
            internal const string IMPORT_LEAD_ATTRNY_0002EV = "IMPORT_LEAD_ATTRNY_0002EV";
            internal const string TEXT_WORK_AREA_0002ET = "TEXT_WORK_AREA_0002ET";
            internal const string TEXT_2_0002AS = "TEXT_2_0002AS";
            internal const string TEXT_2_0002 = "TEXT_2_0002";
            internal const string TEXT_2_0002XX = "TEXT_2_0002XX";
            internal const string IMPORT_0003EV = "IMPORT_0003EV";
            internal const string LEGAL_ACTION_0003ET = "LEGAL_ACTION_0003ET";
            internal const string STANDARD_NUMBER_0003AS = "STANDARD_NUMBER_0003AS";
            internal const string STANDARD_NUMBER_0003 = "STANDARD_NUMBER_0003";
            internal const string STANDARD_NUMBER_0003XX = "STANDARD_NUMBER_0003XX";
            ...
            internal const string ACTION_0004AS = "ACTION_0004AS";
            internal const string ACTION_0004 = "ACTION_0004";
            internal const string ACTION_0004XX = "ACTION_0004XX";
            internal const string IMPORT_ATTOR_INFO_0005EV = "IMPORT_ATTOR_INFO_0005EV";
            internal const string WORK_AREA_0005ET = "WORK_AREA_0005ET";
            internal const string TEXT_200_0005AS = "TEXT_200_0005AS";
            internal const string TEXT_200_0005 = "TEXT_200_0005";
            internal const string TEXT_200_0005XX = "TEXT_200_0005XX";
            internal const string IMPORT_AP_NUMBER_0006EV = "IMPORT_AP_NUMBER_0006EV";
            internal const string WORK_AREA_0006ET = "WORK_AREA_0006ET";
            internal const string TEXT_200_0006AS = "TEXT_200_0006AS";
            internal const string TEXT_200_0006 = "TEXT_200_0006";
            internal const string TEXT_200_0006XX = "TEXT_200_0006XX";
            internal const string IMPORT_AR_NUMBER_0007EV = "IMPORT_AR_NUMBER_0007EV";
            internal const string WORK_AREA_0007ET = "WORK_AREA_0007ET";
            internal const string TEXT_200_0007AS = "TEXT_200_0007AS";
            internal const string TEXT_200_0007 = "TEXT_200_0007";
            internal const string TEXT_200_0007XX = "TEXT_200_0007XX";
        ...
        public IGroup FIPS_0001ET { get { return GetElementByName<IGroup>(Names.FIPS_0001ET); } }
        public IField COUNTY_ABBREVIATION_0001AS { get { return GetElementByName<IField>(Names.COUNTY_ABBREVIATION_0001AS); } }
        public IField COUNTY_ABBREVIATION_0001 { get { return GetElementByName<IField>(Names.COUNTY_ABBREVIATION_0001); } }
        public IField COUNTY_ABBREVIATION_0001XX { get { return GetElementByName<IField>(Names.COUNTY_ABBREVIATION_0001XX); } }
        public IField COUNTY_0001AS { get { return GetElementByName<IField>(Names.COUNTY_0001AS); } }
        public IField COUNTY_0001 { get { return GetElementByName<IField>(Names.COUNTY_0001); } }
        public IField COUNTY_0001XX { get { return GetElementByName<IField>(Names.COUNTY_0001XX); } }
        public IGroup IMPORT_LEAD_ATTRNY_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_LEAD_ATTRNY_0002EV); } }
        public IGroup TEXT_WORK_AREA_0002ET { get { return GetElementByName<IGroup>(Names.TEXT_WORK_AREA_0002ET); } }
        public IField TEXT_2_0002AS { get { return GetElementByName<IField>(Names.TEXT_2_0002AS); } }
        public IField TEXT_2_0002 { get { return GetElementByName<IField>(Names.TEXT_2_0002); } }
        public IField TEXT_2_0002XX { get { return GetElementByName<IField>(Names.TEXT_2_0002XX); } }
        public IGroup IMPORT_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_0003EV); } }
        public IGroup LEGAL_ACTION_0003ET { get { return GetElementByName<IGroup>(Names.LEGAL_ACTION_0003ET); } }
        public IField STANDARD_NUMBER_0003AS { get { return GetElementByName<IField>(Names.STANDARD_NUMBER_0003AS); } }
        public IField STANDARD_NUMBER_0003 { get { return GetElementByName<IField>(Names.STANDARD_NUMBER_0003); } }
        public IField STANDARD_NUMBER_0003XX { get { return GetElementByName<IField>(Names.STANDARD_NUMBER_0003XX); } }
        ...
        public IField ACTION_0004AS { get { return GetElementByName<IField>(Names.ACTION_0004AS); } }
        public IField ACTION_0004 { get { return GetElementByName<IField>(Names.ACTION_0004); } }
        public IField ACTION_0004XX { get { return GetElementByName<IField>(Names.ACTION_0004XX); } }
        public IGroup IMPORT_ATTOR_INFO_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_ATTOR_INFO_0005EV); } }
        public IGroup WORK_AREA_0005ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0005ET); } }
        public IField TEXT_200_0005AS { get { return GetElementByName<IField>(Names.TEXT_200_0005AS); } }
        public IField TEXT_200_0005 { get { return GetElementByName<IField>(Names.TEXT_200_0005); } }
        public IField TEXT_200_0005XX { get { return GetElementByName<IField>(Names.TEXT_200_0005XX); } }
        public IGroup IMPORT_AP_NUMBER_0006EV { get { return GetElementByName<IGroup>(Names.IMPORT_AP_NUMBER_0006EV); } }
        public IGroup WORK_AREA_0006ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0006ET); } }
        public IField TEXT_200_0006AS { get { return GetElementByName<IField>(Names.TEXT_200_0006AS); } }
        public IField TEXT_200_0006 { get { return GetElementByName<IField>(Names.TEXT_200_0006); } }
        public IField TEXT_200_0006XX { get { return GetElementByName<IField>(Names.TEXT_200_0006XX); } }
        public IGroup IMPORT_AR_NUMBER_0007EV { get { return GetElementByName<IGroup>(Names.IMPORT_AR_NUMBER_0007EV); } }
        public IGroup WORK_AREA_0007ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0007ET); } }
        public IField TEXT_200_0007AS { get { return GetElementByName<IField>(Names.TEXT_200_0007AS); } }
        public IField TEXT_200_0007 { get { return GetElementByName<IField>(Names.TEXT_200_0007); } }
        public IField TEXT_200_0007XX { get { return GetElementByName<IField>(Names.TEXT_200_0007XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.FIPS_0001ET, (FIPS_0001ET) =>
               {
                   FIPS_0001ET.CreateNewField(Names.COUNTY_ABBREVIATION_0001AS, FieldType.String, 1);

                   IField COUNTY_ABBREVIATION_0001_local = FIPS_0001ET.CreateNewField(Names.COUNTY_ABBREVIATION_0001, FieldType.String, 2);
                   FIPS_0001ET.CreateNewFieldRedefine(Names.COUNTY_ABBREVIATION_0001XX, FieldType.String, COUNTY_ABBREVIATION_0001_local, 2);
                   FIPS_0001ET.CreateNewField(Names.COUNTY_0001AS, FieldType.String, 1);

                   IField COUNTY_0001_local = FIPS_0001ET.CreateNewField(Names.COUNTY_0001, FieldType.SignedNumeric, 3);
                   FIPS_0001ET.CreateNewFieldRedefine(Names.COUNTY_0001XX, FieldType.String, COUNTY_0001_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_LEAD_ATTRNY_0002EV, (IMPORT_LEAD_ATTRNY_0002EV) =>
           {
               IMPORT_LEAD_ATTRNY_0002EV.CreateNewGroup(Names.TEXT_WORK_AREA_0002ET, (TEXT_WORK_AREA_0002ET) =>
               {
                   TEXT_WORK_AREA_0002ET.CreateNewField(Names.TEXT_2_0002AS, FieldType.String, 1);

                   IField TEXT_2_0002_local = TEXT_WORK_AREA_0002ET.CreateNewField(Names.TEXT_2_0002, FieldType.String, 2);
                   TEXT_WORK_AREA_0002ET.CreateNewFieldRedefine(Names.TEXT_2_0002XX, FieldType.String, TEXT_2_0002_local, 2);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0003EV, (IMPORT_0003EV) =>
           {
               IMPORT_0003EV.CreateNewGroup(Names.LEGAL_ACTION_0003ET, (LEGAL_ACTION_0003ET) =>
               {
                   LEGAL_ACTION_0003ET.CreateNewField(Names.STANDARD_NUMBER_0003AS, FieldType.String, 1);

                   IField STANDARD_NUMBER_0003_local = LEGAL_ACTION_0003ET.CreateNewField(Names.STANDARD_NUMBER_0003, FieldType.String, 20);
                   LEGAL_ACTION_0003ET.CreateNewFieldRedefine(Names.STANDARD_NUMBER_0003XX, FieldType.String, STANDARD_NUMBER_0003_local, 20);
                   LEGAL_ACTION_0003ET.CreateNewField(Names.IDENTIFIER_0003AS, FieldType.String, 1);

                   IField IDENTIFIER_0003_local = LEGAL_ACTION_0003ET.CreateNewField(Names.IDENTIFIER_0003, FieldType.SignedNumeric, 9);
                   LEGAL_ACTION_0003ET.CreateNewFieldRedefine(Names.IDENTIFIER_0003XX, FieldType.String, IDENTIFIER_0003_local, 9);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0004EV, (IMPORT_0004EV) =>
           {
               IMPORT_0004EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0004ET, (EAB_FILE_HANDLING_0004ET) =>
               {
                   EAB_FILE_HANDLING_0004ET.CreateNewField(Names.ACTION_0004AS, FieldType.String, 1);

                   IField ACTION_0004_local = EAB_FILE_HANDLING_0004ET.CreateNewField(Names.ACTION_0004, FieldType.String, 8);
                   EAB_FILE_HANDLING_0004ET.CreateNewFieldRedefine(Names.ACTION_0004XX, FieldType.String, ACTION_0004_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_ATTOR_INFO_0005EV, (IMPORT_ATTOR_INFO_0005EV) =>
           {
               IMPORT_ATTOR_INFO_0005EV.CreateNewGroup(Names.WORK_AREA_0005ET, (WORK_AREA_0005ET) =>
               {
                   WORK_AREA_0005ET.CreateNewField(Names.TEXT_200_0005AS, FieldType.String, 1);

                   IField TEXT_200_0005_local = WORK_AREA_0005ET.CreateNewField(Names.TEXT_200_0005, FieldType.String, 200);
                   WORK_AREA_0005ET.CreateNewFieldRedefine(Names.TEXT_200_0005XX, FieldType.String, TEXT_200_0005_local, 200);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_AP_NUMBER_0006EV, (IMPORT_AP_NUMBER_0006EV) =>
           {
               IMPORT_AP_NUMBER_0006EV.CreateNewGroup(Names.WORK_AREA_0006ET, (WORK_AREA_0006ET) =>
               {
                   WORK_AREA_0006ET.CreateNewField(Names.TEXT_200_0006AS, FieldType.String, 1);

                   IField TEXT_200_0006_local = WORK_AREA_0006ET.CreateNewField(Names.TEXT_200_0006, FieldType.String, 200);
                   WORK_AREA_0006ET.CreateNewFieldRedefine(Names.TEXT_200_0006XX, FieldType.String, TEXT_200_0006_local, 200);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_AR_NUMBER_0007EV, (IMPORT_AR_NUMBER_0007EV) =>
           {
               IMPORT_AR_NUMBER_0007EV.CreateNewGroup(Names.WORK_AREA_0007ET, (WORK_AREA_0007ET) =>
               {
                   WORK_AREA_0007ET.CreateNewField(Names.TEXT_200_0007AS, FieldType.String, 1);

                   IField TEXT_200_0007_local = WORK_AREA_0007ET.CreateNewField(Names.TEXT_200_0007, FieldType.String, 200);
                   WORK_AREA_0007ET.CreateNewFieldRedefine(Names.TEXT_200_0007XX, FieldType.String, TEXT_200_0007_local, 200);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_LEAD_ATTRNY_0002EV, args, 4);
            SetPassedParm(IMPORT_0003EV, args, 5);
            SetPassedParm(IMPORT_0004EV, args, 6);
            SetPassedParm(IMPORT_ATTOR_INFO_0005EV, args, 7);
            SetPassedParm(IMPORT_AP_NUMBER_0006EV, args, 8);
            SetPassedParm(IMPORT_AR_NUMBER_0007EV, args, 9);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_LEAD_ATTRNY_0002EV, args, 4);
            SetReturnParm(IMPORT_0003EV, args, 5);
            SetReturnParm(IMPORT_0004EV, args, 6);
            SetReturnParm(IMPORT_ATTOR_INFO_0005EV, args, 7);
            SetReturnParm(IMPORT_AP_NUMBER_0006EV, args, 8);
            SetReturnParm(IMPORT_AR_NUMBER_0007EV, args, 9);
    ...
    public class SWEXEW18 : BatchBase
    {
        ...
        public SWEXEW18()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW18");

            WS = new SWEXEW18_ws();
            FD = new SWEXEW18_fd(WS);
            LS = new SWEXEW18_ls();
        }
        ...
        private SWEXEW18_ws WS;

        //==== File Data Class ========================================
        private SWEXEW18_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW18_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-LEAD-ATTRNY-0002EV , IMPORT-0003EV , IMPORT-0004EV , IMPORT-ATTOR-INFO-0005EV , IMPORT-AP-NUMBER-0006EV , IMPORT-AR-NUMBER-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1266650243(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1266650243
        /// </summary>
        private void M_MAIN_1266650243(string returnMethod = "")
        {
            M_PARA_1266650243_INIT("M_PARA_1266650243_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1266650243-INIT THRU PARA-1266650243-INIT-EXIT
            M_PARA_1266650243("M_PARA_1266650243_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1266650243 THRU PARA-1266650243-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1266650243
        /// </summary>
        private void M_PARA_1266650243(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF51 IS A PART OF SWEXEW18*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.STATUS_0008.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0008
                                                                                                                // EvaluateList !LS.ACTION_0004!                                                                    //COBOL==> EVALUATE ACTION-0004
            if ((LS.ACTION_0004.IsEqualTo("OPEN")))                                                             //COBOL==> WHEN 'OPEN'
            {
        ...
        {
            FD.ATTYOUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT ATTYOUT.
            if (!(WS.ATTYOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF ATTYOUT-STAT NOT = 00
            {
                LS.STATUS_0008.SetValue("OP");                                                                      //COBOL==> MOVE 'OP' TO STATUS-0008
                                                                                                                    //COMMENT:        MOVE 'AN ERROR OCCURRED ON OPEN '
                                                                                                                    //COMMENT:            TO TEXT-LINE-80-0007
                                                                                                                    //COMMENT:        MOVE ATTYOUT-STAT TO NUMERIC-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.ATTYOUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO ATTYOUT-RECORD.
            FD.ATTYOUT_RECORD.SetValue(WS.WS_ATTYOUT);                                                          //COBOL==> MOVE WS-ATTYOUT TO ATTYOUT-RECORD.
            FD.ATTYOUT.WriteLine(FD.ATTYOUT_RECORD.AsBytes);                                                    //COBOL==> WRITE ATTYOUT-RECORD.
            if (!(WS.ATTYOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF ATTYOUT-STAT NOT = 00
            {
                LS.STATUS_0008.SetValue("WR");                                                                      //COBOL==> MOVE 'WR' TO STATUS-0008
        ...
        {
            FD.ATTYOUT.CloseFile();                                                                             //COBOL==> CLOSE ATTYOUT
            if (!(WS.ATTYOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF ATTYOUT-STAT NOT = 00
            {
                LS.STATUS_0008.SetValue("CL");                                                                      //COBOL==> MOVE 'CL' TO STATUS-0008
                                                                                                                    //COMMENT:             MOVE 'ERROR IN CLOSING FILE'
                                                                                                                    //COMMENT:             TO TEXT-LINE-80-0059
                                                                                                                    //COMMENT:             MOVE ATTYOUT-STAT TO NUMERIC-RETURN-CODE-0059
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            WS.COUNTY_ABBR.SetValue(LS.COUNTY_ABBREVIATION_0001);                                               //COBOL==> MOVE COUNTY-ABBREVIATION-0001 TO COUNTY-ABBR
            WS.ATTYNUM.SetValue(LS.TEXT_2_0002);                                                                //COBOL==> MOVE TEXT-2-0002 TO ATTYNUM
            WS.CT_ORDER_NUM.SetValue(LS.STANDARD_NUMBER_0003);                                                  //COBOL==> MOVE STANDARD-NUMBER-0003 TO CT-ORDER-NUM
            WS.LA_ID.SetValue(LS.IDENTIFIER_0003);                                                              //COBOL==> MOVE IDENTIFIER-0003 TO LA-ID
            WS.ATTY_INFO.SetValue(LS.TEXT_200_0005);                                                            //COBOL==> MOVE TEXT-200-0005 TO ATTY-INFO
            WS.AP_NUMBER.SetValue(LS.TEXT_200_0006);                                                            //COBOL==> MOVE TEXT-200-0006 TO AP-NUMBER
            WS.AR_NUMBER.SetValue(LS.TEXT_200_0007);                                                            //COBOL==> MOVE TEXT-200-0007 TO AR-NUMBER
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1266650243_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266650243_EXIT
        /// </summary>
        private void M_PARA_1266650243_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266650243_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1266650243_EXIT") { M_PARA_1266650243_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266650243_INIT
        /// </summary>
        private void M_PARA_1266650243_INIT(string returnMethod = "")
        {
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1266650243_INIT") { M_PARA_1266650243_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266650243_INIT_EXIT
        /// </summary>
        private void M_PARA_1266650243_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266650243_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
