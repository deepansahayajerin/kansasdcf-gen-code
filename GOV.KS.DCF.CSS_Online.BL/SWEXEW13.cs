...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:29:25 PM
   **        *   FROM COBOL PGM   :  SWEXEW13
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: FN_B682_WRITE_KHPA_RECORDS       DATE: 2010/08/05
       TARGET OS:   MVS                       TIME: 09:49:43
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXEW13_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW13_fd_FileSection";
            internal const string KHPAOUT = "KHPAOUT";
            internal const string KHPAOUT_RECORD = "KHPAOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink KHPAOUT { get; set; }
        public IField KHPAOUT_RECORD { get { return GetElementByName<IField>(Names.KHPAOUT_RECORD); } }


        internal SWEXEW13_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.KHPAOUT_RECORD, FieldType.String, 80);
        ...
        public override void Initialize()
        {
            ...
            KHPAOUT = FileHandler.GetFile("KHPAOUT");
            KHPAOUT.StatusField = WS.KHPAOUT_STAT;
            KHPAOUT.AssociatedBuffer = KHPAOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW13_fd(SWEXEW13_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW13_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW13_ws_WorkingStorage";
            internal const string KHPAOUT_STAT = "KHPAOUT_STAT";
            ...
            internal const string WS_KHPAOUT = "WS_KHPAOUT";
            internal const string DETAIL_LINE = "DETAIL_LINE";
        }
        #endregion

        #region Direct-access element properties
        public IField KHPAOUT_STAT { get { return GetExternalElementByName<IField>(Names.KHPAOUT_STAT); } }
        ...
        public IGroup WS_KHPAOUT { get { return GetElementByName<IGroup>(Names.WS_KHPAOUT); } }
        public IField DETAIL_LINE { get { return GetElementByName<IField>(Names.DETAIL_LINE); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.KHPAOUT_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW13 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_KHPAOUT, (WS_KHPAOUT) =>
           {
               WS_KHPAOUT.CreateNewField(Names.DETAIL_LINE, FieldType.String, 80);
           });
    ...
    internal class SWEXEW13_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW13_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0003EV.CreateNewGroup(Names.EAB_REPORT_SEND_0003ET, (EAB_REPORT_SEND_0003ET) =>
               {
    ...
    public class SWEXEW13 : BatchBase
    {
        ...
        public SWEXEW13()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW13");

            WS = new SWEXEW13_ws();
            FD = new SWEXEW13_fd(WS);
            LS = new SWEXEW13_ls();
        }
        ...
        private SWEXEW13_ws WS;

        //==== File Data Class ========================================
        private SWEXEW13_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW13_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0309615514(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0309615514
        /// </summary>
        private void M_MAIN_0309615514(string returnMethod = "")
        {
            M_PARA_0309615514_INIT("M_PARA_0309615514_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0309615514-INIT THRU PARA-0309615514-INIT-EXIT
            M_PARA_0309615514("M_PARA_0309615514_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0309615514 THRU PARA-0309615514-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0309615514
        /// </summary>
        private void M_PARA_0309615514(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF16 IS A PART OF SWEXEW13*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.TEXT_RETURN_CODE_0004.SetValue("OK");                                                            //COBOL==> MOVE 'OK' TO TEXT-RETURN-CODE-0004
            ...
            {
                LS.TEXT_RETURN_CODE_0004.SetValue("AB");                                                            //COBOL==> MOVE 'AB' TO TEXT-RETURN-CODE-0004
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        {
            FD.KHPAOUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT KHPAOUT.
            if (!(WS.KHPAOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KHPAOUT-STAT NOT = 00
            {
                ...
                LS.NUMERIC_RETURN_CODE_0004.SetValue(WS.KHPAOUT_STAT);                                              //COBOL==> MOVE KHPAOUT-STAT TO NUMERIC-RETURN-CODE-0004
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.KHPAOUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO KHPAOUT-RECORD.
            FD.KHPAOUT_RECORD.SetValue(WS.WS_KHPAOUT);                                                          //COBOL==> MOVE WS-KHPAOUT TO KHPAOUT-RECORD.
            FD.KHPAOUT.WriteLine(FD.KHPAOUT_RECORD.AsBytes);                                                    //COBOL==> WRITE KHPAOUT-RECORD.
            if (!(WS.KHPAOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KHPAOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0004.SetValue("WR");                                                            //COBOL==> MOVE 'WR' TO TEXT-RETURN-CODE-0004
                LS.TEXT_LINE_80_0004.SetValue("AN ERROR OCCURRED IN WRITTING");                                     //COBOL==> MOVE 'AN ERROR OCCURRED IN WRITTING' TO TEXT-LINE-80-0004
                LS.NUMERIC_RETURN_CODE_0004.SetValue(WS.KHPAOUT_STAT);                                              //COBOL==> MOVE KHPAOUT-STAT TO NUMERIC-RETURN-CODE-0004
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.KHPAOUT.CloseFile();                                                                             //COBOL==> CLOSE KHPAOUT
            if (!(WS.KHPAOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KHPAOUT-STAT NOT = 00
            {
        ...
        {
            WS.WS_KHPAOUT.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO WS-KHPAOUT
            WS.DETAIL_LINE.SetValue(LS.TEXT_LINE_80_0002);                                                      //COBOL==> MOVE TEXT-LINE-80-0002 TO DETAIL-LINE
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0309615514_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0309615514_EXIT
        /// </summary>
        private void M_PARA_0309615514_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0309615514_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0309615514_EXIT") { M_PARA_0309615514_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0309615514_INIT
        /// </summary>
        private void M_PARA_0309615514_INIT(string returnMethod = "")
        {
            LS.EXPORT_0004EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0004EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0309615514_INIT") { M_PARA_0309615514_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0309615514_INIT_EXIT
        /// </summary>
        private void M_PARA_0309615514_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0309615514_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
