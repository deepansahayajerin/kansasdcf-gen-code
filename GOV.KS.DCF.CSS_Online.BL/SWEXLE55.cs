...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:44:57 PM
   **        *   FROM COBOL PGM   :  SWEXLE55
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_FDSO_READ_RETURN_H           DATE: 1999/02/01
       TARGET OS:   MVS                       TIME: 15:24:12
       TARGET DBMS: DB2                       USER: SWSRLXC
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXLE55_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE55_fd_FileSection";
            internal const string INFILE = "INFILE";
            internal const string INFILE_REC = "INFILE_REC";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink INFILE { get; set; }
        public IField INFILE_REC { get { return GetElementByName<IField>(Names.INFILE_REC); } }
        ...
        {
            recordDef.CreateNewField(Names.INFILE_REC, FieldType.String, 245);
        ...
        public override void Initialize()
        {
            ...
            INFILE = FileHandler.GetFile("INFILE");
            INFILE.AssociatedBuffer = INFILE_REC;
            INFILE.RecordLength = 245;
        }
        #endregion
    ...
    internal class SWEXLE55_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE55_ws_WorkingStorage";
            internal const string FDSO50 = "FDSO50";
            internal const string F50_SUBMITTING_STATE = "F50_SUBMITTING_STATE";
            internal const string F50_LOCAL_CODE = "F50_LOCAL_CODE";
            internal const string F50_SSN = "F50_SSN";
            internal const string F50_CASE_NUMBER = "F50_CASE_NUMBER";
            internal const string F50_LAST_NAME = "F50_LAST_NAME";
            internal const string F50_FIRST_NAME = "F50_FIRST_NAME";
            internal const string F50_AMOUNT_OWED = "F50_AMOUNT_OWED";
            internal const string F50_TRANS_TYPE = "F50_TRANS_TYPE";
            internal const string F50_CASE_TYPE = "F50_CASE_TYPE";
            internal const string F50_TRANSFER_STATE = "F50_TRANSFER_STATE";
            internal const string F50_LOCAL_FOR_TRANSFER = "F50_LOCAL_FOR_TRANSFER";
            internal const string F50_PROCESS_YEAR = "F50_PROCESS_YEAR";
            internal const string F50_ADDRESS_LINE1 = "F50_ADDRESS_LINE1";
            internal const string F50_ADDRESS_LINE2 = "F50_ADDRESS_LINE2";
            internal const string F50_CITY = "F50_CITY";
            internal const string F50_STATE_CODE = "F50_STATE_CODE";
            internal const string F50_ZIP = "F50_ZIP";
            internal const string F50_DT_ISS_NOTICE = "F50_DT_ISS_NOTICE";
            internal const string F50_OFFSET_EXCLUSION = "F50_OFFSET_EXCLUSION";
            internal const string F50_ERROR_CD1 = "F50_ERROR_CD1";
            internal const string F50_ERROR_CD2 = "F50_ERROR_CD2";
            internal const string F50_ERROR_CD3 = "F50_ERROR_CD3";
            internal const string F50_ERROR_CD4 = "F50_ERROR_CD4";
            internal const string F50_ERROR_CD5 = "F50_ERROR_CD5";
            internal const string F50_ERROR_CD6 = "F50_ERROR_CD6";
            internal const string F50_FED_RETURNED_LAST_NAME = "F50_FED_RETURNED_LAST_NAME";
            internal const string FDSO55 = "FDSO55";
            internal const string F55_SUBMITTING_STATE = "F55_SUBMITTING_STATE";
            internal const string F55_CONTROL = "F55_CONTROL";
            internal const string F55_TANF_ACCEPTED = "F55_TANF_ACCEPTED";
            internal const string F55_TANF_REJECTED = "F55_TANF_REJECTED";
            internal const string F55_NONTANF_ACCEPTED = "F55_NONTANF_ACCEPTED";
            internal const string F55_NONTANF_REJECTED = "F55_NONTANF_REJECTED";
        }
        #endregion

        #region Direct-access element properties
        public IGroup FDSO50 { get { return GetElementByName<IGroup>(Names.FDSO50); } }
        public IField F50_SUBMITTING_STATE { get { return GetElementByName<IField>(Names.F50_SUBMITTING_STATE); } }
        public IField F50_LOCAL_CODE { get { return GetElementByName<IField>(Names.F50_LOCAL_CODE); } }
        public IField F50_SSN { get { return GetElementByName<IField>(Names.F50_SSN); } }
        public IField F50_CASE_NUMBER { get { return GetElementByName<IField>(Names.F50_CASE_NUMBER); } }
        public IField F50_LAST_NAME { get { return GetElementByName<IField>(Names.F50_LAST_NAME); } }
        public IField F50_FIRST_NAME { get { return GetElementByName<IField>(Names.F50_FIRST_NAME); } }
        public IField F50_AMOUNT_OWED { get { return GetElementByName<IField>(Names.F50_AMOUNT_OWED); } }
        public IField F50_TRANS_TYPE { get { return GetElementByName<IField>(Names.F50_TRANS_TYPE); } }
        public IField F50_CASE_TYPE { get { return GetElementByName<IField>(Names.F50_CASE_TYPE); } }
        public IField F50_TRANSFER_STATE { get { return GetElementByName<IField>(Names.F50_TRANSFER_STATE); } }
        public IField F50_LOCAL_FOR_TRANSFER { get { return GetElementByName<IField>(Names.F50_LOCAL_FOR_TRANSFER); } }
        public IField F50_PROCESS_YEAR { get { return GetElementByName<IField>(Names.F50_PROCESS_YEAR); } }
        public IField F50_ADDRESS_LINE1 { get { return GetElementByName<IField>(Names.F50_ADDRESS_LINE1); } }
        public IField F50_ADDRESS_LINE2 { get { return GetElementByName<IField>(Names.F50_ADDRESS_LINE2); } }
        public IField F50_CITY { get { return GetElementByName<IField>(Names.F50_CITY); } }
        public IField F50_STATE_CODE { get { return GetElementByName<IField>(Names.F50_STATE_CODE); } }
        public IField F50_ZIP { get { return GetElementByName<IField>(Names.F50_ZIP); } }
        public IField F50_DT_ISS_NOTICE { get { return GetElementByName<IField>(Names.F50_DT_ISS_NOTICE); } }
        public IField F50_OFFSET_EXCLUSION { get { return GetElementByName<IField>(Names.F50_OFFSET_EXCLUSION); } }
        public IField F50_ERROR_CD1 { get { return GetElementByName<IField>(Names.F50_ERROR_CD1); } }
        public IField F50_ERROR_CD2 { get { return GetElementByName<IField>(Names.F50_ERROR_CD2); } }
        public IField F50_ERROR_CD3 { get { return GetElementByName<IField>(Names.F50_ERROR_CD3); } }
        public IField F50_ERROR_CD4 { get { return GetElementByName<IField>(Names.F50_ERROR_CD4); } }
        public IField F50_ERROR_CD5 { get { return GetElementByName<IField>(Names.F50_ERROR_CD5); } }
        public IField F50_ERROR_CD6 { get { return GetElementByName<IField>(Names.F50_ERROR_CD6); } }
        public IField F50_FED_RETURNED_LAST_NAME { get { return GetElementByName<IField>(Names.F50_FED_RETURNED_LAST_NAME); } }
        public IGroup FDSO55 { get { return GetElementByName<IGroup>(Names.FDSO55); } }
        public IField F55_SUBMITTING_STATE { get { return GetElementByName<IField>(Names.F55_SUBMITTING_STATE); } }
        public IField F55_CONTROL { get { return GetElementByName<IField>(Names.F55_CONTROL); } }
        public IField F55_TANF_ACCEPTED { get { return GetElementByName<IField>(Names.F55_TANF_ACCEPTED); } }
        public IField F55_TANF_REJECTED { get { return GetElementByName<IField>(Names.F55_TANF_REJECTED); } }
        public IField F55_NONTANF_ACCEPTED { get { return GetElementByName<IField>(Names.F55_NONTANF_ACCEPTED); } }
        public IField F55_NONTANF_REJECTED { get { return GetElementByName<IField>(Names.F55_NONTANF_REJECTED); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.FDSO50, (FDSO50) =>
           {
               FDSO50.CreateNewField(Names.F50_SUBMITTING_STATE, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_LOCAL_CODE, FieldType.String, 3);
               FDSO50.CreateNewField(Names.F50_SSN, FieldType.UnsignedNumeric, 9);
               FDSO50.CreateNewField(Names.F50_CASE_NUMBER, FieldType.String, 15);
               FDSO50.CreateNewField(Names.F50_LAST_NAME, FieldType.String, 20);
               FDSO50.CreateNewField(Names.F50_FIRST_NAME, FieldType.String, 15);
               FDSO50.CreateNewField(Names.F50_AMOUNT_OWED, FieldType.UnsignedNumeric, 8);
               FDSO50.CreateNewField(Names.F50_TRANS_TYPE, FieldType.String, 1);
               FDSO50.CreateNewField(Names.F50_CASE_TYPE, FieldType.String, 1);
               FDSO50.CreateNewField(Names.F50_TRANSFER_STATE, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_LOCAL_FOR_TRANSFER, FieldType.UnsignedNumeric, 3);
               FDSO50.CreateNewField(Names.F50_PROCESS_YEAR, FieldType.String, 4);
               FDSO50.CreateNewField(Names.F50_ADDRESS_LINE1, FieldType.String, 30);
               FDSO50.CreateNewField(Names.F50_ADDRESS_LINE2, FieldType.String, 30);
               FDSO50.CreateNewField(Names.F50_CITY, FieldType.String, 25);
               FDSO50.CreateNewField(Names.F50_STATE_CODE, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_ZIP, FieldType.String, 9);
               FDSO50.CreateNewField(Names.F50_DT_ISS_NOTICE, FieldType.String, 8);
               FDSO50.CreateNewField(Names.F50_OFFSET_EXCLUSION, FieldType.String, 40);
               FDSO50.CreateNewField(Names.F50_ERROR_CD1, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_ERROR_CD2, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_ERROR_CD3, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_ERROR_CD4, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_ERROR_CD5, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_ERROR_CD6, FieldType.String, 2);
               FDSO50.CreateNewField(Names.F50_FED_RETURNED_LAST_NAME, FieldType.String, 4);
           });

            recordDef.CreateNewGroup(Names.FDSO55, (FDSO55) =>
           {
               FDSO55.CreateNewField(Names.F55_SUBMITTING_STATE, FieldType.String, 2);
               FDSO55.CreateNewField(Names.F55_CONTROL, FieldType.String, 3);
               FDSO55.CreateNewField(Names.F55_TANF_ACCEPTED, FieldType.UnsignedNumeric, 9);
               FDSO55.CreateNewField(Names.F55_TANF_REJECTED, FieldType.UnsignedNumeric, 9);
               FDSO55.CreateNewField(Names.F55_NONTANF_ACCEPTED, FieldType.UnsignedNumeric, 9);
               FDSO55.CreateNewField(Names.F55_NONTANF_REJECTED, FieldType.UnsignedNumeric, 9);
           });
    ...
    internal class SWEXLE55_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE55_ls_LinkageSection";
            ...
            internal const string FDSO_RETURN_H_TOTAL_0002ET = "FDSO_RETURN_H_TOTAL_0002ET";
            ...
            internal const string CONTROL_0002AS = "CONTROL_0002AS";
            internal const string CONTROL_0002 = "CONTROL_0002";
            internal const string CONTROL_0002XX = "CONTROL_0002XX";
            internal const string TANF_ACCEPTED_0002AS = "TANF_ACCEPTED_0002AS";
            internal const string TANF_ACCEPTED_0002 = "TANF_ACCEPTED_0002";
            internal const string TANF_ACCEPTED_0002XX = "TANF_ACCEPTED_0002XX";
            internal const string TANF_REJECTED_0002AS = "TANF_REJECTED_0002AS";
            internal const string TANF_REJECTED_0002 = "TANF_REJECTED_0002";
            internal const string TANF_REJECTED_0002XX = "TANF_REJECTED_0002XX";
            internal const string NONTANF_ACCEPTED_0002AS = "NONTANF_ACCEPTED_0002AS";
            internal const string NONTANF_ACCEPTED_0002 = "NONTANF_ACCEPTED_0002";
            internal const string NONTANF_ACCEPTED_0002XX = "NONTANF_ACCEPTED_0002XX";
            internal const string NONTANF_REJECTED_0002AS = "NONTANF_REJECTED_0002AS";
            internal const string NONTANF_REJECTED_0002 = "NONTANF_REJECTED_0002";
            internal const string NONTANF_REJECTED_0002XX = "NONTANF_REJECTED_0002XX";
            internal const string EXP_0003EV = "EXP_0003EV";
            internal const string FDSO_RETURN_H_0003ET = "FDSO_RETURN_H_0003ET";
            internal const string SUBMITTING_STATE_0003AS = "SUBMITTING_STATE_0003AS";
            internal const string SUBMITTING_STATE_0003 = "SUBMITTING_STATE_0003";
            internal const string SUBMITTING_STATE_0003XX = "SUBMITTING_STATE_0003XX";
            ...
            internal const string CASE_NUMBER_0003AS = "CASE_NUMBER_0003AS";
            internal const string CASE_NUMBER_0003 = "CASE_NUMBER_0003";
            internal const string CASE_NUMBER_0003XX = "CASE_NUMBER_0003XX";
            ...
            internal const string AMOUNT_OWED_0003AS = "AMOUNT_OWED_0003AS";
            internal const string AMOUNT_OWED_0003 = "AMOUNT_OWED_0003";
            internal const string AMOUNT_OWED_0003XX = "AMOUNT_OWED_0003XX";
            internal const string TRANSACTION_TYPE_0003AS = "TRANSACTION_TYPE_0003AS";
            internal const string TRANSACTION_TYPE_0003 = "TRANSACTION_TYPE_0003";
            internal const string TRANSACTION_TYPE_0003XX = "TRANSACTION_TYPE_0003XX";
            internal const string CASE_TYPE_IND_0003AS = "CASE_TYPE_IND_0003AS";
            internal const string CASE_TYPE_IND_0003 = "CASE_TYPE_IND_0003";
            internal const string CASE_TYPE_IND_0003XX = "CASE_TYPE_IND_0003XX";
            internal const string TRANSFER_STATE_0003AS = "TRANSFER_STATE_0003AS";
            internal const string TRANSFER_STATE_0003 = "TRANSFER_STATE_0003";
            internal const string TRANSFER_STATE_0003XX = "TRANSFER_STATE_0003XX";
            internal const string LOCAL_FOR_TRANSFER_0003AS = "LOCAL_FOR_TRANSFER_0003AS";
            internal const string LOCAL_FOR_TRANSFER_0003 = "LOCAL_FOR_TRANSFER_0003";
            internal const string LOCAL_FOR_TRANSFER_0003XX = "LOCAL_FOR_TRANSFER_0003XX";
            internal const string PROCESS_YEAR_0003AS = "PROCESS_YEAR_0003AS";
            internal const string PROCESS_YEAR_0003 = "PROCESS_YEAR_0003";
            internal const string PROCESS_YEAR_0003XX = "PROCESS_YEAR_0003XX";
            internal const string OFFSET_EXCLUSION_TYPE_0003AS = "OFFSET_EXCLUSION_TYPE_0003AS";
            internal const string OFFSET_EXCLUSION_TYPE_0003 = "OFFSET_EXCLUSION_TYPE_0003";
            internal const string OFFSET_EXCLUSION_TYPE_0003XX = "OFFSET_EXCLUSION_TYPE_0003XX";
            internal const string ERRCODE1_0003AS = "ERRCODE1_0003AS";
            internal const string ERRCODE1_0003 = "ERRCODE1_0003";
            internal const string ERRCODE1_0003XX = "ERRCODE1_0003XX";
            internal const string ERRCODE2_0003AS = "ERRCODE2_0003AS";
            internal const string ERRCODE2_0003 = "ERRCODE2_0003";
            internal const string ERRCODE2_0003XX = "ERRCODE2_0003XX";
            internal const string ERRCODE3_0003AS = "ERRCODE3_0003AS";
            internal const string ERRCODE3_0003 = "ERRCODE3_0003";
            internal const string ERRCODE3_0003XX = "ERRCODE3_0003XX";
            internal const string ERRCODE4_0003AS = "ERRCODE4_0003AS";
            internal const string ERRCODE4_0003 = "ERRCODE4_0003";
            internal const string ERRCODE4_0003XX = "ERRCODE4_0003XX";
            internal const string ERRCODE5_0003AS = "ERRCODE5_0003AS";
            internal const string ERRCODE5_0003 = "ERRCODE5_0003";
            internal const string ERRCODE5_0003XX = "ERRCODE5_0003XX";
            internal const string ERRCODE6_0003AS = "ERRCODE6_0003AS";
            internal const string ERRCODE6_0003 = "ERRCODE6_0003";
            internal const string ERRCODE6_0003XX = "ERRCODE6_0003XX";
            internal const string FED_RETURNED_LAST_NAME_0003AS = "FED_RETURNED_LAST_NAME_0003AS";
            internal const string FED_RETURNED_LAST_NAME_0003 = "FED_RETURNED_LAST_NAME_0003";
            internal const string FED_RETURNED_LAST_NAME_0003XX = "FED_RETURNED_LAST_NAME_0003XX";
        ...
        public IGroup FDSO_RETURN_H_TOTAL_0002ET { get { return GetElementByName<IGroup>(Names.FDSO_RETURN_H_TOTAL_0002ET); } }
        ...
        public IField CONTROL_0002AS { get { return GetElementByName<IField>(Names.CONTROL_0002AS); } }
        public IField CONTROL_0002 { get { return GetElementByName<IField>(Names.CONTROL_0002); } }
        public IField CONTROL_0002XX { get { return GetElementByName<IField>(Names.CONTROL_0002XX); } }
        public IField TANF_ACCEPTED_0002AS { get { return GetElementByName<IField>(Names.TANF_ACCEPTED_0002AS); } }
        public IField TANF_ACCEPTED_0002 { get { return GetElementByName<IField>(Names.TANF_ACCEPTED_0002); } }
        public IField TANF_ACCEPTED_0002XX { get { return GetElementByName<IField>(Names.TANF_ACCEPTED_0002XX); } }
        public IField TANF_REJECTED_0002AS { get { return GetElementByName<IField>(Names.TANF_REJECTED_0002AS); } }
        public IField TANF_REJECTED_0002 { get { return GetElementByName<IField>(Names.TANF_REJECTED_0002); } }
        public IField TANF_REJECTED_0002XX { get { return GetElementByName<IField>(Names.TANF_REJECTED_0002XX); } }
        public IField NONTANF_ACCEPTED_0002AS { get { return GetElementByName<IField>(Names.NONTANF_ACCEPTED_0002AS); } }
        public IField NONTANF_ACCEPTED_0002 { get { return GetElementByName<IField>(Names.NONTANF_ACCEPTED_0002); } }
        public IField NONTANF_ACCEPTED_0002XX { get { return GetElementByName<IField>(Names.NONTANF_ACCEPTED_0002XX); } }
        public IField NONTANF_REJECTED_0002AS { get { return GetElementByName<IField>(Names.NONTANF_REJECTED_0002AS); } }
        public IField NONTANF_REJECTED_0002 { get { return GetElementByName<IField>(Names.NONTANF_REJECTED_0002); } }
        public IField NONTANF_REJECTED_0002XX { get { return GetElementByName<IField>(Names.NONTANF_REJECTED_0002XX); } }
        public IGroup EXP_0003EV { get { return GetElementByName<IGroup>(Names.EXP_0003EV); } }
        public IGroup FDSO_RETURN_H_0003ET { get { return GetElementByName<IGroup>(Names.FDSO_RETURN_H_0003ET); } }
        public IField SUBMITTING_STATE_0003AS { get { return GetElementByName<IField>(Names.SUBMITTING_STATE_0003AS); } }
        public IField SUBMITTING_STATE_0003 { get { return GetElementByName<IField>(Names.SUBMITTING_STATE_0003); } }
        public IField SUBMITTING_STATE_0003XX { get { return GetElementByName<IField>(Names.SUBMITTING_STATE_0003XX); } }
        ...
        public IField CASE_NUMBER_0003AS { get { return GetElementByName<IField>(Names.CASE_NUMBER_0003AS); } }
        public IField CASE_NUMBER_0003 { get { return GetElementByName<IField>(Names.CASE_NUMBER_0003); } }
        public IField CASE_NUMBER_0003XX { get { return GetElementByName<IField>(Names.CASE_NUMBER_0003XX); } }
        ...
        public IField AMOUNT_OWED_0003AS { get { return GetElementByName<IField>(Names.AMOUNT_OWED_0003AS); } }
        public IField AMOUNT_OWED_0003 { get { return GetElementByName<IField>(Names.AMOUNT_OWED_0003); } }
        public IField AMOUNT_OWED_0003XX { get { return GetElementByName<IField>(Names.AMOUNT_OWED_0003XX); } }
        public IField TRANSACTION_TYPE_0003AS { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE_0003AS); } }
        public IField TRANSACTION_TYPE_0003 { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE_0003); } }
        public IField TRANSACTION_TYPE_0003XX { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE_0003XX); } }
        public IField CASE_TYPE_IND_0003AS { get { return GetElementByName<IField>(Names.CASE_TYPE_IND_0003AS); } }
        public IField CASE_TYPE_IND_0003 { get { return GetElementByName<IField>(Names.CASE_TYPE_IND_0003); } }
        public IField CASE_TYPE_IND_0003XX { get { return GetElementByName<IField>(Names.CASE_TYPE_IND_0003XX); } }
        public IField TRANSFER_STATE_0003AS { get { return GetElementByName<IField>(Names.TRANSFER_STATE_0003AS); } }
        public IField TRANSFER_STATE_0003 { get { return GetElementByName<IField>(Names.TRANSFER_STATE_0003); } }
        public IField TRANSFER_STATE_0003XX { get { return GetElementByName<IField>(Names.TRANSFER_STATE_0003XX); } }
        public IField LOCAL_FOR_TRANSFER_0003AS { get { return GetElementByName<IField>(Names.LOCAL_FOR_TRANSFER_0003AS); } }
        public IField LOCAL_FOR_TRANSFER_0003 { get { return GetElementByName<IField>(Names.LOCAL_FOR_TRANSFER_0003); } }
        public IField LOCAL_FOR_TRANSFER_0003XX { get { return GetElementByName<IField>(Names.LOCAL_FOR_TRANSFER_0003XX); } }
        public IField PROCESS_YEAR_0003AS { get { return GetElementByName<IField>(Names.PROCESS_YEAR_0003AS); } }
        public IField PROCESS_YEAR_0003 { get { return GetElementByName<IField>(Names.PROCESS_YEAR_0003); } }
        public IField PROCESS_YEAR_0003XX { get { return GetElementByName<IField>(Names.PROCESS_YEAR_0003XX); } }
        public IField OFFSET_EXCLUSION_TYPE_0003AS { get { return GetElementByName<IField>(Names.OFFSET_EXCLUSION_TYPE_0003AS); } }
        public IField OFFSET_EXCLUSION_TYPE_0003 { get { return GetElementByName<IField>(Names.OFFSET_EXCLUSION_TYPE_0003); } }
        public IField OFFSET_EXCLUSION_TYPE_0003XX { get { return GetElementByName<IField>(Names.OFFSET_EXCLUSION_TYPE_0003XX); } }
        public IField ERRCODE1_0003AS { get { return GetElementByName<IField>(Names.ERRCODE1_0003AS); } }
        public IField ERRCODE1_0003 { get { return GetElementByName<IField>(Names.ERRCODE1_0003); } }
        public IField ERRCODE1_0003XX { get { return GetElementByName<IField>(Names.ERRCODE1_0003XX); } }
        public IField ERRCODE2_0003AS { get { return GetElementByName<IField>(Names.ERRCODE2_0003AS); } }
        public IField ERRCODE2_0003 { get { return GetElementByName<IField>(Names.ERRCODE2_0003); } }
        public IField ERRCODE2_0003XX { get { return GetElementByName<IField>(Names.ERRCODE2_0003XX); } }
        public IField ERRCODE3_0003AS { get { return GetElementByName<IField>(Names.ERRCODE3_0003AS); } }
        public IField ERRCODE3_0003 { get { return GetElementByName<IField>(Names.ERRCODE3_0003); } }
        public IField ERRCODE3_0003XX { get { return GetElementByName<IField>(Names.ERRCODE3_0003XX); } }
        public IField ERRCODE4_0003AS { get { return GetElementByName<IField>(Names.ERRCODE4_0003AS); } }
        public IField ERRCODE4_0003 { get { return GetElementByName<IField>(Names.ERRCODE4_0003); } }
        public IField ERRCODE4_0003XX { get { return GetElementByName<IField>(Names.ERRCODE4_0003XX); } }
        public IField ERRCODE5_0003AS { get { return GetElementByName<IField>(Names.ERRCODE5_0003AS); } }
        public IField ERRCODE5_0003 { get { return GetElementByName<IField>(Names.ERRCODE5_0003); } }
        public IField ERRCODE5_0003XX { get { return GetElementByName<IField>(Names.ERRCODE5_0003XX); } }
        public IField ERRCODE6_0003AS { get { return GetElementByName<IField>(Names.ERRCODE6_0003AS); } }
        public IField ERRCODE6_0003 { get { return GetElementByName<IField>(Names.ERRCODE6_0003); } }
        public IField ERRCODE6_0003XX { get { return GetElementByName<IField>(Names.ERRCODE6_0003XX); } }
        public IField FED_RETURNED_LAST_NAME_0003AS { get { return GetElementByName<IField>(Names.FED_RETURNED_LAST_NAME_0003AS); } }
        public IField FED_RETURNED_LAST_NAME_0003 { get { return GetElementByName<IField>(Names.FED_RETURNED_LAST_NAME_0003); } }
        public IField FED_RETURNED_LAST_NAME_0003XX { get { return GetElementByName<IField>(Names.FED_RETURNED_LAST_NAME_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMP_0001EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0001ET, (EAB_FILE_HANDLING_0001ET) =>
               {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.FDSO_RETURN_H_TOTAL_0002ET, (FDSO_RETURN_H_TOTAL_0002ET) =>
               {
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.SUBMITTING_STATE_0002AS, FieldType.String, 1);

                   IField SUBMITTING_STATE_0002_local = FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.SUBMITTING_STATE_0002, FieldType.String, 2);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewFieldRedefine(Names.SUBMITTING_STATE_0002XX, FieldType.String, SUBMITTING_STATE_0002_local, 2);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.CONTROL_0002AS, FieldType.String, 1);

                   IField CONTROL_0002_local = FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.CONTROL_0002, FieldType.String, 3);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewFieldRedefine(Names.CONTROL_0002XX, FieldType.String, CONTROL_0002_local, 3);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.TANF_ACCEPTED_0002AS, FieldType.String, 1);

                   IField TANF_ACCEPTED_0002_local = FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.TANF_ACCEPTED_0002, FieldType.SignedNumeric, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewFieldRedefine(Names.TANF_ACCEPTED_0002XX, FieldType.String, TANF_ACCEPTED_0002_local, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.TANF_REJECTED_0002AS, FieldType.String, 1);

                   IField TANF_REJECTED_0002_local = FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.TANF_REJECTED_0002, FieldType.SignedNumeric, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewFieldRedefine(Names.TANF_REJECTED_0002XX, FieldType.String, TANF_REJECTED_0002_local, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.NONTANF_ACCEPTED_0002AS, FieldType.String, 1);

                   IField NONTANF_ACCEPTED_0002_local = FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.NONTANF_ACCEPTED_0002, FieldType.SignedNumeric, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewFieldRedefine(Names.NONTANF_ACCEPTED_0002XX, FieldType.String, NONTANF_ACCEPTED_0002_local, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.NONTANF_REJECTED_0002AS, FieldType.String, 1);

                   IField NONTANF_REJECTED_0002_local = FDSO_RETURN_H_TOTAL_0002ET.CreateNewField(Names.NONTANF_REJECTED_0002, FieldType.SignedNumeric, 9);
                   FDSO_RETURN_H_TOTAL_0002ET.CreateNewFieldRedefine(Names.NONTANF_REJECTED_0002XX, FieldType.String, NONTANF_REJECTED_0002_local, 9);
               });
           });

            recordDef.CreateNewGroup(Names.EXP_0003EV, (EXP_0003EV) =>
           {
               EXP_0003EV.CreateNewGroup(Names.FDSO_RETURN_H_0003ET, (FDSO_RETURN_H_0003ET) =>
               {
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.SUBMITTING_STATE_0003AS, FieldType.String, 1);

                   IField SUBMITTING_STATE_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.SUBMITTING_STATE_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.SUBMITTING_STATE_0003XX, FieldType.String, SUBMITTING_STATE_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.LOCAL_CODE_0003AS, FieldType.String, 1);

                   IField LOCAL_CODE_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.LOCAL_CODE_0003, FieldType.String, 3);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.LOCAL_CODE_0003XX, FieldType.String, LOCAL_CODE_0003_local, 3);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.SSN_0003AS, FieldType.String, 1);

                   IField SSN_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.SSN_0003, FieldType.SignedNumeric, 9);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.SSN_0003XX, FieldType.String, SSN_0003_local, 9);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.CASE_NUMBER_0003AS, FieldType.String, 1);

                   IField CASE_NUMBER_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.CASE_NUMBER_0003, FieldType.String, 15);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.CASE_NUMBER_0003XX, FieldType.String, CASE_NUMBER_0003_local, 15);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.LAST_NAME_0003AS, FieldType.String, 1);

                   IField LAST_NAME_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.LAST_NAME_0003, FieldType.String, 20);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.LAST_NAME_0003XX, FieldType.String, LAST_NAME_0003_local, 20);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.FIRST_NAME_0003AS, FieldType.String, 1);

                   IField FIRST_NAME_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.FIRST_NAME_0003, FieldType.String, 15);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.FIRST_NAME_0003XX, FieldType.String, FIRST_NAME_0003_local, 15);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.AMOUNT_OWED_0003AS, FieldType.String, 1);

                   IField AMOUNT_OWED_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.AMOUNT_OWED_0003, FieldType.SignedNumeric, 8);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.AMOUNT_OWED_0003XX, FieldType.String, AMOUNT_OWED_0003_local, 8);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.TRANSACTION_TYPE_0003AS, FieldType.String, 1);

                   IField TRANSACTION_TYPE_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.TRANSACTION_TYPE_0003, FieldType.String, 1);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.TRANSACTION_TYPE_0003XX, FieldType.String, TRANSACTION_TYPE_0003_local, 1);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.CASE_TYPE_IND_0003AS, FieldType.String, 1);

                   IField CASE_TYPE_IND_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.CASE_TYPE_IND_0003, FieldType.String, 1);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.CASE_TYPE_IND_0003XX, FieldType.String, CASE_TYPE_IND_0003_local, 1);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.TRANSFER_STATE_0003AS, FieldType.String, 1);

                   IField TRANSFER_STATE_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.TRANSFER_STATE_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.TRANSFER_STATE_0003XX, FieldType.String, TRANSFER_STATE_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.LOCAL_FOR_TRANSFER_0003AS, FieldType.String, 1);

                   IField LOCAL_FOR_TRANSFER_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.LOCAL_FOR_TRANSFER_0003, FieldType.SignedNumeric, 3);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.LOCAL_FOR_TRANSFER_0003XX, FieldType.String, LOCAL_FOR_TRANSFER_0003_local, 3);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.PROCESS_YEAR_0003AS, FieldType.String, 1);

                   IField PROCESS_YEAR_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.PROCESS_YEAR_0003, FieldType.String, 4);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.PROCESS_YEAR_0003XX, FieldType.String, PROCESS_YEAR_0003_local, 4);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.OFFSET_EXCLUSION_TYPE_0003AS, FieldType.String, 1);

                   IField OFFSET_EXCLUSION_TYPE_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.OFFSET_EXCLUSION_TYPE_0003, FieldType.String, 40);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.OFFSET_EXCLUSION_TYPE_0003XX, FieldType.String, OFFSET_EXCLUSION_TYPE_0003_local, 40);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE1_0003AS, FieldType.String, 1);

                   IField ERRCODE1_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE1_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.ERRCODE1_0003XX, FieldType.String, ERRCODE1_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE2_0003AS, FieldType.String, 1);

                   IField ERRCODE2_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE2_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.ERRCODE2_0003XX, FieldType.String, ERRCODE2_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE3_0003AS, FieldType.String, 1);

                   IField ERRCODE3_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE3_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.ERRCODE3_0003XX, FieldType.String, ERRCODE3_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE4_0003AS, FieldType.String, 1);

                   IField ERRCODE4_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE4_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.ERRCODE4_0003XX, FieldType.String, ERRCODE4_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE5_0003AS, FieldType.String, 1);

                   IField ERRCODE5_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE5_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.ERRCODE5_0003XX, FieldType.String, ERRCODE5_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE6_0003AS, FieldType.String, 1);

                   IField ERRCODE6_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.ERRCODE6_0003, FieldType.String, 2);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.ERRCODE6_0003XX, FieldType.String, ERRCODE6_0003_local, 2);
                   FDSO_RETURN_H_0003ET.CreateNewField(Names.FED_RETURNED_LAST_NAME_0003AS, FieldType.String, 1);

                   IField FED_RETURNED_LAST_NAME_0003_local = FDSO_RETURN_H_0003ET.CreateNewField(Names.FED_RETURNED_LAST_NAME_0003, FieldType.String, 4);
                   FDSO_RETURN_H_0003ET.CreateNewFieldRedefine(Names.FED_RETURNED_LAST_NAME_0003XX, FieldType.String, FED_RETURNED_LAST_NAME_0003_local, 4);
               });
           });

            recordDef.CreateNewGroup(Names.EXP_0004EV, (EXP_0004EV) =>
           {
               EXP_0004EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0004ET, (EAB_FILE_HANDLING_0004ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXP_0003EV, args, 5);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXP_0003EV, args, 5);
    ...
    public class SWEXLE55 : BatchBase
    {
        ...
        public SWEXLE55()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE55");
        ...
        private SWEXLE55_ws WS;

        //==== File Data Class ========================================
        private SWEXLE55_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE55_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMP-0001EV , EXPORT-0002EV EXP-0003EV EXP-0004EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0056900402(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0056900402
        /// </summary>
        private void M_MAIN_0056900402(string returnMethod = "")
        {
            M_PARA_0056900402_INIT("M_PARA_0056900402_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0056900402-INIT THRU PARA-0056900402-INIT-EXIT
            M_PARA_0056900402("M_PARA_0056900402_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0056900402 THRU PARA-0056900402-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0056900402
        /// </summary>
        private void M_PARA_0056900402(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: *************************************************************
            if (LS.ACTION_0001.IsEqualTo("OPEN"))                                                               //COBOL==> IF ACTION-0001 = 'OPEN'
            {
                LS.STATUS_0004.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0004
                FD.INFILE.OpenFile(FileAccessMode.Read);                                                            //COBOL==> OPEN INPUT INFILE
            }                                                                                                   //COBOL==> ELSE
            else
            {
                if (LS.ACTION_0001.IsEqualTo("READ"))                                                               //COBOL==> IF ACTION-0001 = 'READ'
                {
                    LS.STATUS_0004.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0004
                    M_6000_READ("M_6000_EXIT"); if (Control.ExitProgram) { return; }                                      //COBOL==> PERFORM 6000-READ THRU 6000-EXIT.
                }
            }
            M_8000_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 8000-EXIT.
        }
        /// <summary>
        /// Method M_6000_READ
        /// </summary>
        private void M_6000_READ(string returnMethod = "")
        {
            FD.INFILE.ReadLine();                                                                               //COBOL==> READ INFILE
            if (FD.INFILE.FileStatus == FileStatus.End_of_file)                                                 //COBOL==> AT END
            {
                LS.STATUS_0004.SetValue("C");                                                                       //COBOL==> MOVE 'C' TO STATUS-0004
                FD.INFILE.CloseFile();                                                                              //COBOL==> CLOSE INFILE
                M_6000_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 6000-EXIT.
            }
            WS.FDSO50.SetValue(FD.INFILE_REC);                                                                  //COBOL==> MOVE INFILE-REC TO FDSO50.
            if (WS.F50_LOCAL_CODE.IsEqualTo("CTL"))                                                             //COBOL==> IF F50-LOCAL-CODE = 'CTL'
            {
                M_8000_TOTAL("M_8000_EXIT"); if (Control.ExitProgram) { return; }                                     //COBOL==> PERFORM 8000-TOTAL THRU 8000-EXIT
            }                                                                                                   //COBOL==> ELSE
            else
            {
                M_7000_MOVE_WS("M_7000_EXIT"); if (Control.ExitProgram) { return; }                                   //COBOL==> PERFORM 7000-MOVE-WS THRU 7000-EXIT.
            }
            if (returnMethod != "" && returnMethod != "M_6000_READ") { M_6000_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_6000_EXIT
        /// </summary>
        private void M_6000_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_6000_EXIT") { M_7000_MOVE_WS(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_7000_MOVE_WS
        /// </summary>
        private void M_7000_MOVE_WS(string returnMethod = "")
        {
            LS.SUBMITTING_STATE_0003.SetValue(WS.F50_SUBMITTING_STATE);                                         //COBOL==> MOVE F50-SUBMITTING-STATE TO SUBMITTING-STATE-0003
            LS.LOCAL_CODE_0003.SetValue(WS.F50_LOCAL_CODE);                                                     //COBOL==> MOVE F50-LOCAL-CODE TO LOCAL-CODE-0003
            LS.SSN_0003.SetValue(WS.F50_SSN);                                                                   //COBOL==> MOVE F50-SSN TO SSN-0003
            LS.CASE_NUMBER_0003.SetValue(WS.F50_CASE_NUMBER);                                                   //COBOL==> MOVE F50-CASE-NUMBER TO CASE-NUMBER-0003
            LS.LAST_NAME_0003.SetValue(WS.F50_LAST_NAME);                                                       //COBOL==> MOVE F50-LAST-NAME TO LAST-NAME-0003
            LS.FIRST_NAME_0003.SetValue(WS.F50_FIRST_NAME);                                                     //COBOL==> MOVE F50-FIRST-NAME TO FIRST-NAME-0003
            LS.AMOUNT_OWED_0003.SetValue(WS.F50_AMOUNT_OWED);                                                   //COBOL==> MOVE F50-AMOUNT-OWED TO AMOUNT-OWED-0003
            LS.TRANSACTION_TYPE_0003.SetValue(WS.F50_TRANS_TYPE);                                               //COBOL==> MOVE F50-TRANS-TYPE TO TRANSACTION-TYPE-0003
            LS.CASE_TYPE_IND_0003.SetValue(WS.F50_CASE_TYPE);                                                   //COBOL==> MOVE F50-CASE-TYPE TO CASE-TYPE-IND-0003
            LS.TRANSFER_STATE_0003.SetValue(WS.F50_TRANSFER_STATE);                                             //COBOL==> MOVE F50-TRANSFER-STATE TO TRANSFER-STATE-0003
            LS.LOCAL_FOR_TRANSFER_0003.SetValue(WS.F50_LOCAL_FOR_TRANSFER);                                     //COBOL==> MOVE F50-LOCAL-FOR-TRANSFER TO LOCAL-FOR-TRANSFER-0003
            LS.PROCESS_YEAR_0003.SetValue(WS.F50_PROCESS_YEAR);                                                 //COBOL==> MOVE F50-PROCESS-YEAR TO PROCESS-YEAR-0003
                                                                                                                //COMMENT:     MOVE F50-ADDRESS-LINE1      TO
                                                                                                                //COMMENT:     MOVE F50-ADDRESS-LINE2      TO
                                                                                                                //COMMENT:     MOVE F50-CITY               TO
                                                                                                                //COMMENT:     MOVE F50-STATE-CODE         TO
                                                                                                                //COMMENT:     MOVE F50-ZIP                TO
                                                                                                                //COMMENT:     MOVE F50-DT-ISS-NOTICE      TO
            LS.OFFSET_EXCLUSION_TYPE_0003.SetValue(WS.F50_OFFSET_EXCLUSION);                                    //COBOL==> MOVE F50-OFFSET-EXCLUSION TO OFFSET-EXCLUSION-TYPE-0003
            LS.ERRCODE1_0003.SetValue(WS.F50_ERROR_CD1);                                                        //COBOL==> MOVE F50-ERROR-CD1 TO ERRCODE1-0003
            LS.ERRCODE2_0003.SetValue(WS.F50_ERROR_CD2);                                                        //COBOL==> MOVE F50-ERROR-CD2 TO ERRCODE2-0003
            LS.ERRCODE3_0003.SetValue(WS.F50_ERROR_CD3);                                                        //COBOL==> MOVE F50-ERROR-CD3 TO ERRCODE3-0003
            LS.ERRCODE4_0003.SetValue(WS.F50_ERROR_CD4);                                                        //COBOL==> MOVE F50-ERROR-CD4 TO ERRCODE4-0003
            LS.ERRCODE5_0003.SetValue(WS.F50_ERROR_CD5);                                                        //COBOL==> MOVE F50-ERROR-CD5 TO ERRCODE5-0003
            LS.ERRCODE6_0003.SetValue(WS.F50_ERROR_CD6);                                                        //COBOL==> MOVE F50-ERROR-CD6 TO ERRCODE6-0003.
            LS.FED_RETURNED_LAST_NAME_0003.SetValue(WS.F50_FED_RETURNED_LAST_NAME);                             //COBOL==> MOVE F50-FED-RETURNED-LAST-NAME TO FED-RETURNED-LAST-NAME-0003.
            if (returnMethod != "" && returnMethod != "M_7000_MOVE_WS") { M_7000_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_7000_EXIT
        /// </summary>
        private void M_7000_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_7000_EXIT") { M_8000_TOTAL(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_8000_TOTAL
        /// </summary>
        private void M_8000_TOTAL(string returnMethod = "")
        {
            WS.FDSO55.SetValue(FD.INFILE_REC);                                                                  //COBOL==> MOVE INFILE-REC TO FDSO55
            LS.SUBMITTING_STATE_0002.SetValue(WS.F55_SUBMITTING_STATE);                                         //COBOL==> MOVE F55-SUBMITTING-STATE TO SUBMITTING-STATE-0002
            LS.CONTROL_0002.SetValue(WS.F55_CONTROL);                                                           //COBOL==> MOVE F55-CONTROL TO CONTROL-0002.
            LS.TANF_ACCEPTED_0002.SetValue(WS.F55_TANF_ACCEPTED);                                               //COBOL==> MOVE F55-TANF-ACCEPTED TO TANF-ACCEPTED-0002.
            LS.TANF_REJECTED_0002.SetValue(WS.F55_TANF_REJECTED);                                               //COBOL==> MOVE F55-TANF-REJECTED TO TANF-REJECTED-0002.
            LS.NONTANF_ACCEPTED_0002.SetValue(WS.F55_NONTANF_ACCEPTED);                                         //COBOL==> MOVE F55-NONTANF-ACCEPTED TO NONTANF-ACCEPTED-0002.
            LS.NONTANF_REJECTED_0002.SetValue(WS.F55_NONTANF_REJECTED);                                         //COBOL==> MOVE F55-NONTANF-REJECTED TO NONTANF-REJECTED-0002.
            LS.STATUS_0004.SetValue("C");                                                                       //COBOL==> MOVE 'C' TO STATUS-0004
            FD.INFILE.CloseFile();                                                                              //COBOL==> CLOSE INFILE.
            if (returnMethod != "" && returnMethod != "M_8000_TOTAL") { M_8000_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_8000_EXIT
        /// </summary>
        private void M_8000_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_8000_EXIT") { M_PARA_0056900402_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0056900402_EXIT
        /// </summary>
        private void M_PARA_0056900402_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0056900402_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0056900402_EXIT") { M_PARA_0056900402_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0056900402_INIT
        /// </summary>
        private void M_PARA_0056900402_INIT(string returnMethod = "")
        {
            LS.EXPORT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0002EV
            LS.EXP_0003EV.ResetToInitialValue();                                                                //COBOL==> INITIALIZE EXP-0003EV
            LS.EXP_0004EV.ResetToInitialValue();                                                                //COBOL==> INITIALIZE EXP-0004EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0056900402_INIT") { M_PARA_0056900402_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0056900402_INIT_EXIT
        /// </summary>
        private void M_PARA_0056900402_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0056900402_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
