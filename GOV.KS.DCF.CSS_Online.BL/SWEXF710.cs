...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:32:46 PM
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    public class SWEXF710 : BatchBase
    {
        ...
        private void M_B000_INIT_FIELDS(string returnMethod = "")
        {
            ...
            if ((LS.LSI_PARM1_84XX.IsMaxValue())
             || (LS.LSI_PARM1_84XX.IsMinValue()))           //COBOL==> IF LSI-PARM1-84XX = HIGH-VALUES OR LSI-PARM1-84XX = LOW-VALUES
            {
                LS.LSI_PARM1_84.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO LSI-PARM1-84
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LSI_PARM2_85XX.IsMaxValue())
             || (LS.LSI_PARM2_85XX.IsMinValue()))           //COBOL==> IF LSI-PARM2-85XX = HIGH-VALUES OR LSI-PARM2-85XX = LOW-VALUES
            {
                LS.LSI_PARM2_85.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO LSI-PARM2-85
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LSI_SUBRPT_CD_86XX.IsMaxValue())
             || (LS.LSI_SUBRPT_CD_86XX.IsMinValue()))   //COBOL==> IF LSI-SUBRPT-CD-86XX = HIGH-VALUES OR LSI-SUBRPT-CD-86XX = LOW-VALUES
            {
