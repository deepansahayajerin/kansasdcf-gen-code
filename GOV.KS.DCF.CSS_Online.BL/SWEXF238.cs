...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:31:42 PM
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    public class SWEXF238 : BatchBase
    {
        ...
        private void M_B000_INIT_FIELDS(string returnMethod = "")
        {
            ...
            if ((LS.LS_IN_CODE_01XX.IsMaxValue())
             || (LS.LS_IN_CODE_01XX.IsMinValue()))         //COBOL==> IF LS-IN-CODE-01XX = HIGH-VALUES OR LS-IN-CODE-01XX = LOW-VALUES
            {
                LS.LS_IN_CODE_01.SetValueWithSpaces();                                                              //COBOL==> MOVE SPACES TO LS-IN-CODE-01
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_USR_ID_02XX.IsMaxValue())
             || (LS.LS_IN_USR_ID_02XX.IsMinValue()))     //COBOL==> IF LS-IN-USR-ID-02XX = HIGH-VALUES OR LS-IN-USR-ID-02XX = LOW-VALUES
            {
                LS.LS_IN_USR_ID_02.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO LS-IN-USR-ID-02
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_LST_NME_03XX.IsMaxValue())
             || (LS.LS_IN_LST_NME_03XX.IsMinValue()))   //COBOL==> IF LS-IN-LST-NME-03XX = HIGH-VALUES OR LS-IN-LST-NME-03XX = LOW-VALUES
            {
                LS.LS_IN_LST_NME_03.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-LST-NME-03
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_FST_NME_04XX.IsMaxValue())
             || (LS.LS_IN_FST_NME_04XX.IsMinValue()))   //COBOL==> IF LS-IN-FST-NME-04XX = HIGH-VALUES OR LS-IN-FST-NME-04XX = LOW-VALUES
            {
                LS.LS_IN_FST_NME_04.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-FST-NME-04
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_PARM1_07XX.IsMaxValue())
             || (LS.LS_IN_PARM1_07XX.IsMinValue()))       //COBOL==> IF LS-IN-PARM1-07XX = HIGH-VALUES OR LS-IN-PARM1-07XX = LOW-VALUES
            {
                LS.LS_IN_PARM1_07XX.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-PARM1-07XX
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_PARM2_08XX.IsMaxValue())
             || (LS.LS_IN_PARM2_08XX.IsMinValue()))       //COBOL==> IF LS-IN-PARM2-08XX = HIGH-VALUES OR LS-IN-PARM2-08XX = LOW-VALUES
            {
