...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:40:52 PM
   **        *   FROM COBOL PGM   :  SWEXIE02
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: SI_B283_EAB_READ_NEW_HIRE_FILE   DATE: 2016/01/19
       TARGET OS:   MVS                       TIME: 12:23:40
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXIE02_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXIE02_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 602);
           });
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE_01 = FileHandler.GetFile("NEWHIRE");
            INPUT_FILE_01.StatusField = WS.FILE_STATUS;
            INPUT_FILE_01.AssociatedBuffer = INPUT_RECORD_01;
            INPUT_FILE_01.RecordLength = 602;
        }
        #endregion

        #region Constructors
        public SWEXIE02_fd(SWEXIE02_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXIE02_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXIE02_ws_WorkingStorage";
            ...
            internal const string WS_TEMP_CC = "WS_TEMP_CC";
            internal const string WS_TEMP_YY = "WS_TEMP_YY";
            internal const string WS_NEW_HIRE = "WS_NEW_HIRE";
            ...
            internal const string WS_WORKERS_INIT = "WS_WORKERS_INIT";
            internal const string WS_OFFICE = "WS_OFFICE";
            internal const string WS_FIRST_NAME = "WS_FIRST_NAME";
            internal const string WS_MIDDLE_INIT = "WS_MIDDLE_INIT";
            internal const string WS_LAST_NAME = "WS_LAST_NAME";
            internal const string WS_STREET1 = "WS_STREET1";
            internal const string WS_STREET2 = "WS_STREET2";
            ...
            internal const string WS_HIRE_DATE = "WS_HIRE_DATE";
            internal const string WS_HD_MM = "WS_HD_MM";
            internal const string WS_HD_DD = "WS_HD_DD";
            internal const string WS_HD_CC = "WS_HD_CC";
            internal const string WS_HD_YY = "WS_HD_YY";
            internal const string WS_HIRE_STATE = "WS_HIRE_STATE";
            internal const string WS_COMP_NAME = "WS_COMP_NAME";
            internal const string WS_COMP_STREET1 = "WS_COMP_STREET1";
            internal const string WS_COMP_STREET2 = "WS_COMP_STREET2";
        ...
        public IField WS_TEMP_CC { get { return GetElementByName<IField>(Names.WS_TEMP_CC); } }
        public IField WS_TEMP_YY { get { return GetElementByName<IField>(Names.WS_TEMP_YY); } }
        public IGroup WS_NEW_HIRE { get { return GetElementByName<IGroup>(Names.WS_NEW_HIRE); } }
        ...
        public IArrayElementAccessor<IField> WS_CASE_NUM { get { return GetArrayElementAccessor<IField>(Names.WS_CASE_NUM); } }
        public IArrayElementAccessor<IField> WS_WORKERS_INIT { get { return GetArrayElementAccessor<IField>(Names.WS_WORKERS_INIT); } }
        public IArrayElementAccessor<IField> WS_OFFICE { get { return GetArrayElementAccessor<IField>(Names.WS_OFFICE); } }
        public IField WS_FIRST_NAME { get { return GetElementByName<IField>(Names.WS_FIRST_NAME); } }
        public IField WS_MIDDLE_INIT { get { return GetElementByName<IField>(Names.WS_MIDDLE_INIT); } }
        public IField WS_LAST_NAME { get { return GetElementByName<IField>(Names.WS_LAST_NAME); } }
        public IField WS_STREET1 { get { return GetElementByName<IField>(Names.WS_STREET1); } }
        public IField WS_STREET2 { get { return GetElementByName<IField>(Names.WS_STREET2); } }
        ...
        public IGroup WS_HIRE_DATE { get { return GetElementByName<IGroup>(Names.WS_HIRE_DATE); } }
        public IField WS_HD_MM { get { return GetElementByName<IField>(Names.WS_HD_MM); } }
        public IField WS_HD_DD { get { return GetElementByName<IField>(Names.WS_HD_DD); } }
        public IField WS_HD_CC { get { return GetElementByName<IField>(Names.WS_HD_CC); } }
        public IField WS_HD_YY { get { return GetElementByName<IField>(Names.WS_HD_YY); } }
        public IField WS_HIRE_STATE { get { return GetElementByName<IField>(Names.WS_HIRE_STATE); } }
        public IField WS_COMP_NAME { get { return GetElementByName<IField>(Names.WS_COMP_NAME); } }
        public IField WS_COMP_STREET1 { get { return GetElementByName<IField>(Names.WS_COMP_STREET1); } }
        public IField WS_COMP_STREET2 { get { return GetElementByName<IField>(Names.WS_COMP_STREET2); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_TEMP_DATE.CreateNewField(Names.WS_TEMP_MM, FieldType.String, 2, SPACES);
               WS_TEMP_DATE.CreateNewFillerField(FieldType.String, 1, "/");
               WS_TEMP_DATE.CreateNewField(Names.WS_TEMP_DD, FieldType.String, 2, SPACES);
               WS_TEMP_DATE.CreateNewFillerField(FieldType.String, 1, "/");
               WS_TEMP_DATE.CreateNewField(Names.WS_TEMP_CC, FieldType.String, 2, SPACES);
               WS_TEMP_DATE.CreateNewField(Names.WS_TEMP_YY, FieldType.String, 2, SPACES);
           });

            recordDef.CreateNewGroup(Names.WS_NEW_HIRE, (WS_NEW_HIRE) =>
           {
               WS_NEW_HIRE.CreateNewField(Names.WS_SOCIAL_SEC_NUM, FieldType.UnsignedNumeric, 9, 0);
               WS_NEW_HIRE.CreateNewField(Names.WS_PERSON_NUM, FieldType.String, 10, SPACES);
               WS_NEW_HIRE.CreateNewGroupArray("FILLER_d3", 10, (FILLER_d3) =>
               {
                   FILLER_d3.CreateNewField(Names.WS_CASE_NUM, FieldType.String, 10, SPACES);
                   FILLER_d3.CreateNewField(Names.WS_WORKERS_INIT, FieldType.String, 1, SPACES);
                   FILLER_d3.CreateNewField(Names.WS_OFFICE, FieldType.UnsignedNumeric, 4, 0);
               });
               WS_NEW_HIRE.CreateNewField(Names.WS_FIRST_NAME, FieldType.String, 12, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_MIDDLE_INIT, FieldType.String, 1, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_LAST_NAME, FieldType.String, 17, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_STREET1, FieldType.String, 40, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_STREET2, FieldType.String, 40, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_CITY, FieldType.String, 25, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_STATE, FieldType.String, 2, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_ZIP5, FieldType.String, 5, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_ZIP4, FieldType.String, 4, SPACES);
               WS_NEW_HIRE.CreateNewGroup(Names.WS_HIRE_DATE, (WS_HIRE_DATE) =>
               {
                   WS_HIRE_DATE.CreateNewField(Names.WS_HD_MM, FieldType.String, 2, SPACES);
                   WS_HIRE_DATE.CreateNewField(Names.WS_HD_DD, FieldType.String, 2, SPACES);
                   WS_HIRE_DATE.CreateNewField(Names.WS_HD_CC, FieldType.String, 2, SPACES);
                   WS_HIRE_DATE.CreateNewField(Names.WS_HD_YY, FieldType.String, 2, SPACES);
               });
               WS_NEW_HIRE.CreateNewField(Names.WS_HIRE_STATE, FieldType.String, 2, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_NAME, FieldType.String, 45, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_STREET1, FieldType.String, 40, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_STREET2, FieldType.String, 40, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_CITY, FieldType.String, 25, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_STATE, FieldType.String, 2, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_ZIP5, FieldType.String, 5, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_ZIP4, FieldType.String, 4, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_KSID, FieldType.String, 6, SPACES);
               WS_NEW_HIRE.CreateNewField(Names.WS_COMP_FEIN, FieldType.String, 9, SPACES);
               WS_NEW_HIRE.CreateNewFillerField(FieldType.String, 101, SPACES);
           });
    ...
    internal class SWEXIE02_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIE02_ls_LinkageSection";
            ...
            internal const string NEW_HIRE_INITIATIVE_REC_0003ET = "NEW_HIRE_INITIATIVE_REC_0003ET";
            internal const string FEIN_0003AS = "FEIN_0003AS";
            internal const string FEIN_0003 = "FEIN_0003";
            internal const string FEIN_0003XX = "FEIN_0003XX";
            ...
            internal const string ZIP_EXTENSION_0003AS = "ZIP_EXTENSION_0003AS";
            internal const string ZIP_EXTENSION_0003 = "ZIP_EXTENSION_0003";
            internal const string ZIP_EXTENSION_0003XX = "ZIP_EXTENSION_0003XX";
            ...
            internal const string HIRE_DATE_0003AS = "HIRE_DATE_0003AS";
            internal const string HIRE_DATE_0003 = "HIRE_DATE_0003";
            internal const string HIRE_DATE_0003XX = "HIRE_DATE_0003XX";
        }
        #endregion
        ...
        public IGroup NEW_HIRE_INITIATIVE_REC_0003ET { get { return GetElementByName<IGroup>(Names.NEW_HIRE_INITIATIVE_REC_0003ET); } }
        public IField FEIN_0003AS { get { return GetElementByName<IField>(Names.FEIN_0003AS); } }
        public IField FEIN_0003 { get { return GetElementByName<IField>(Names.FEIN_0003); } }
        public IField FEIN_0003XX { get { return GetElementByName<IField>(Names.FEIN_0003XX); } }
        ...
        public IField ZIP_EXTENSION_0003AS { get { return GetElementByName<IField>(Names.ZIP_EXTENSION_0003AS); } }
        public IField ZIP_EXTENSION_0003 { get { return GetElementByName<IField>(Names.ZIP_EXTENSION_0003); } }
        public IField ZIP_EXTENSION_0003XX { get { return GetElementByName<IField>(Names.ZIP_EXTENSION_0003XX); } }
        ...
        public IField HIRE_DATE_0003AS { get { return GetElementByName<IField>(Names.HIRE_DATE_0003AS); } }
        public IField HIRE_DATE_0003 { get { return GetElementByName<IField>(Names.HIRE_DATE_0003); } }
        public IField HIRE_DATE_0003XX { get { return GetElementByName<IField>(Names.HIRE_DATE_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.NEW_HIRE_INITIATIVE_REC_0003ET, (NEW_HIRE_INITIATIVE_REC_0003ET) =>
               {
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.FEIN_0003AS, FieldType.String, 1);

                   IField FEIN_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.FEIN_0003, FieldType.String, 9);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.FEIN_0003XX, FieldType.String, FEIN_0003_local, 9);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.KANSAS_ID_0003AS, FieldType.String, 1);

                   IField KANSAS_ID_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.KANSAS_ID_0003, FieldType.String, 6);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.KANSAS_ID_0003XX, FieldType.String, KANSAS_ID_0003_local, 6);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.EMPLOYER_NAME_0003AS, FieldType.String, 1);

                   IField EMPLOYER_NAME_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.EMPLOYER_NAME_0003, FieldType.String, 45);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.EMPLOYER_NAME_0003XX, FieldType.String, EMPLOYER_NAME_0003_local, 45);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ADDRESS_LINE_1_0003AS, FieldType.String, 1);

                   IField ADDRESS_LINE_1_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ADDRESS_LINE_1_0003, FieldType.String, 40);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.ADDRESS_LINE_1_0003XX, FieldType.String, ADDRESS_LINE_1_0003_local, 40);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ADDRESS_LINE_2_0003AS, FieldType.String, 1);

                   IField ADDRESS_LINE_2_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ADDRESS_LINE_2_0003, FieldType.String, 40);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.ADDRESS_LINE_2_0003XX, FieldType.String, ADDRESS_LINE_2_0003_local, 40);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.CITY_0003AS, FieldType.String, 1);

                   IField CITY_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.CITY_0003, FieldType.String, 25);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.CITY_0003XX, FieldType.String, CITY_0003_local, 25);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.STATE_0003AS, FieldType.String, 1);

                   IField STATE_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.STATE_0003, FieldType.String, 2);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.STATE_0003XX, FieldType.String, STATE_0003_local, 2);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ZIP_CODE_0003AS, FieldType.String, 1);

                   IField ZIP_CODE_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ZIP_CODE_0003, FieldType.String, 5);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.ZIP_CODE_0003XX, FieldType.String, ZIP_CODE_0003_local, 5);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ZIP_EXTENSION_0003AS, FieldType.String, 1);

                   IField ZIP_EXTENSION_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.ZIP_EXTENSION_0003, FieldType.String, 4);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.ZIP_EXTENSION_0003XX, FieldType.String, ZIP_EXTENSION_0003_local, 4);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.PERSON_NUMBER_0003AS, FieldType.String, 1);

                   IField PERSON_NUMBER_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.PERSON_NUMBER_0003, FieldType.String, 10);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.PERSON_NUMBER_0003XX, FieldType.String, PERSON_NUMBER_0003_local, 10);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.HIRE_DATE_0003AS, FieldType.String, 1);

                   IField HIRE_DATE_0003_local = NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewField(Names.HIRE_DATE_0003, FieldType.String, 10);
                   NEW_HIRE_INITIATIVE_REC_0003ET.CreateNewFieldRedefine(Names.HIRE_DATE_0003XX, FieldType.String, HIRE_DATE_0003_local, 10);
               });
           });
    ...
    public class SWEXIE02 : BatchBase
    {
        ...
        public SWEXIE02()
            : base()
        {
            this.ProgramName.SetValue("SWEXIE02");

            WS = new SWEXIE02_ws();
            FD = new SWEXIE02_fd(WS);
            LS = new SWEXIE02_ls();
        }
        ...
        private SWEXIE02_ws WS;

        //==== File Data Class ========================================
        private SWEXIE02_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXIE02_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0767297376(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0767297376
        /// </summary>
        private void M_MAIN_0767297376(string returnMethod = "")
        {
            M_PARA_0767297376_INIT("M_PARA_0767297376_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0767297376-INIT THRU PARA-0767297376-INIT-EXIT
            M_PARA_0767297376("M_PARA_0767297376_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0767297376 THRU PARA-0767297376-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0767297376
        /// </summary>
        private void M_PARA_0767297376(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0767297376") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
                M_2500_MOVE_DATA(); if (Control.ExitProgram) { return; }                                              //COBOL==> PERFORM 2500-MOVE-DATA
            }                                                                                                //COBOL==> WHEN '10'
            else
            ...
            if (returnMethod != "" && returnMethod != "M_2000_READ_FILE") { M_2500_MOVE_DATA(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: *************************
            WS.WS_NEW_HIRE.SetValue(FD.RECORD_01_DETAIL);                                                       //COBOL==> MOVE RECORD-01-DETAIL TO WS-NEW-HIRE
            LS.FEIN_0003.SetValue(WS.WS_COMP_FEIN);                                                             //COBOL==> MOVE WS-COMP-FEIN TO FEIN-0003
            LS.KANSAS_ID_0003.SetValue(WS.WS_COMP_KSID);                                                        //COBOL==> MOVE WS-COMP-KSID TO KANSAS-ID-0003
            LS.EMPLOYER_NAME_0003.SetValue(WS.WS_COMP_NAME);                                                    //COBOL==> MOVE WS-COMP-NAME TO EMPLOYER-NAME-0003
            LS.ADDRESS_LINE_1_0003.SetValue(WS.WS_COMP_STREET1);                                                //COBOL==> MOVE WS-COMP-STREET1 TO ADDRESS-LINE-1-0003
            LS.ADDRESS_LINE_2_0003.SetValue(WS.WS_COMP_STREET2);                                                //COBOL==> MOVE WS-COMP-STREET2 TO ADDRESS-LINE-2-0003
            LS.CITY_0003.SetValue(WS.WS_COMP_CITY);                                                             //COBOL==> MOVE WS-COMP-CITY TO CITY-0003
            LS.STATE_0003.SetValue(WS.WS_COMP_STATE);                                                           //COBOL==> MOVE WS-COMP-STATE TO STATE-0003
            LS.ZIP_CODE_0003.SetValue(WS.WS_COMP_ZIP5);                                                         //COBOL==> MOVE WS-COMP-ZIP5 TO ZIP-CODE-0003
            LS.ZIP_EXTENSION_0003.SetValue(WS.WS_COMP_ZIP4);                                                    //COBOL==> MOVE WS-COMP-ZIP4 TO ZIP-EXTENSION-0003
            LS.PERSON_NUMBER_0003.SetValue(WS.WS_PERSON_NUM);                                                   //COBOL==> MOVE WS-PERSON-NUM TO PERSON-NUMBER-0003
            WS.WS_TEMP_MM.SetValue(WS.WS_HD_MM);                                                                //COBOL==> MOVE WS-HD-MM TO WS-TEMP-MM
            WS.WS_TEMP_DD.SetValue(WS.WS_HD_DD);                                                                //COBOL==> MOVE WS-HD-DD TO WS-TEMP-DD
            WS.WS_TEMP_CC.SetValue(WS.WS_HD_CC);                                                                //COBOL==> MOVE WS-HD-CC TO WS-TEMP-CC
            WS.WS_TEMP_YY.SetValue(WS.WS_HD_YY);                                                                //COBOL==> MOVE WS-HD-YY TO WS-TEMP-YY
            LS.HIRE_DATE_0003.SetValue(WS.WS_TEMP_DATE);                                                        //COBOL==> MOVE WS-TEMP-DATE TO HIRE-DATE-0003.
            if (returnMethod != "" && returnMethod != "M_2500_MOVE_DATA") { M_3000_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0767297376_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0767297376_EXIT
        /// </summary>
        private void M_PARA_0767297376_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0767297376_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0767297376_EXIT") { M_PARA_0767297376_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0767297376_INIT
        /// </summary>
        private void M_PARA_0767297376_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0767297376_INIT") { M_PARA_0767297376_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0767297376_INIT_EXIT
        /// </summary>
        private void M_PARA_0767297376_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0767297376_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
