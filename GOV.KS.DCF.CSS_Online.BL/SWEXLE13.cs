...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:44:40 PM
   **        *   FROM COBOL PGM   :  SWEXLE13
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_BFX2_WRITE_EXTRACT_DATA_FILE  DATE: 2007/01/09
       TARGET OS:   MVS                       TIME: 14:41:53
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXLE13_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE13_fd_FileSection";
            ...
            internal const string AP_NAME = "AP_NAME";
        ...
        public IField AP_NAME { get { return GetElementByName<IField>(Names.AP_NAME); } }
        public IField CASE_NUMBER { get { return GetElementByName<IField>(Names.CASE_NUMBER); } }


        internal SWEXLE13_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.OUTPUT_RECORD, (OUTPUT_RECORD) =>
           {
               ...
               OUTPUT_RECORD.CreateNewField(Names.AP_NAME, FieldType.String, 33);
        ...
        #region Constructors
        public SWEXLE13_fd(SWEXLE13_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE13_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE13_ws_WorkingStorage";
    ...
    internal class SWEXLE13_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE13_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.CSE_PERSON_ADDRESS_0002ET, (CSE_PERSON_ADDRESS_0002ET) =>
               {
                   ...
                   CSE_PERSON_ADDRESS_0002ET.CreateNewField(Names.CITY_0002AS, FieldType.String, 1);

                   IField CITY_0002_local = CSE_PERSON_ADDRESS_0002ET.CreateNewField(Names.CITY_0002, FieldType.String, 15);
                   CSE_PERSON_ADDRESS_0002ET.CreateNewFieldRedefine(Names.CITY_0002XX, FieldType.String, CITY_0002_local, 15);
    ...
    public class SWEXLE13 : BatchBase
    {
        ...
        public SWEXLE13()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE13");

            WS = new SWEXLE13_ws();
            FD = new SWEXLE13_fd(WS);
            LS = new SWEXLE13_ls();
        }
        ...
        private SWEXLE13_ws WS;

        //==== File Data Class ========================================
        private SWEXLE13_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE13_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1507329239(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1507329239
        /// </summary>
        private void M_MAIN_1507329239(string returnMethod = "")
        {
            M_PARA_1507329239_INIT("M_PARA_1507329239_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1507329239-INIT THRU PARA-1507329239-INIT-EXIT
            M_PARA_1507329239("M_PARA_1507329239_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1507329239 THRU PARA-1507329239-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1507329239
        /// </summary>
        private void M_PARA_1507329239(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1507329239") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0005.SetValue("BI");                                                                      //COBOL==> MOVE 'BI' TO STATUS-0005
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0005.SetValue("PE");                                                                      //COBOL==> MOVE 'PE' TO STATUS-0005
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: ******************
            FD.ZIP_CODE.SetValue(LS.ZIP_CODE_0002);                                                             //COBOL==> MOVE ZIP-CODE-0002 TO ZIP-CODE
            FD.CITY.SetValue(LS.CITY_0002);                                                                     //COBOL==> MOVE CITY-0002 TO CITY
            FD.AP_NAME.SetValue(LS.FORMATTED_NAME_0003);                                                        //COBOL==> MOVE FORMATTED-NAME-0003 TO AP-NAME
            ...
            {
                LS.STATUS_0005.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0005
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1507329239_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1507329239_EXIT
        /// </summary>
        private void M_PARA_1507329239_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1507329239_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1507329239_EXIT") { M_PARA_1507329239_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1507329239_INIT
        /// </summary>
        private void M_PARA_1507329239_INIT(string returnMethod = "")
        {
            LS.EXPORT_0005EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0005EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1507329239_INIT") { M_PARA_1507329239_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1507329239_INIT_EXIT
        /// </summary>
        private void M_PARA_1507329239_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1507329239_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
