...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:39:16 PM
   **        *   FROM COBOL PGM   :  SWEXIC15
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_CREATE_NON_CASE_PERSON       DATE: 1999/01/05
       TARGET OS:   MVS                       TIME: 13:39:08
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXIC15_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXIC15_ws_WorkingStorage";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXTERNAL_ACTION_BLOCK_WS, (EXTERNAL_ACTION_BLOCK_WS) =>
           {
               ...
               EXTERNAL_ACTION_BLOCK_WS.CreateNewField(Names.SRMODLNK, FieldType.String, 8, "SWEXIC15");
    ...
    internal class SWEXIC15_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIC15_ls_LinkageSection";
            ...
            internal const string IMPORT_NEW_0001EV = "IMPORT_NEW_0001EV";
        ...
        public IGroup IMPORT_NEW_0001EV { get { return GetElementByName<IGroup>(Names.IMPORT_NEW_0001EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_NEW_0001EV, (IMPORT_NEW_0001EV) =>
           {
               IMPORT_NEW_0001EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0001ET, (CSE_PERSONS_WORK_SET_0001ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_NEW_0001EV, args, 1);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_NEW_0001EV, args, 1);
    ...
    public class SWEXIC15 : OnlineProgramBase
    {
        ...
        public SWEXIC15(OnlineControl controlData) : base(controlData)
        {
            this.ProgramName = "SWEXIC15";
        ...
        private SWEXIC15_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXIC15_ls LS;
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING GLOBDATA , IMPORT-NEW-0001EV , EXPORT-0002EV , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_2112890387(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_2112890387
        /// </summary>
        private void M_MAIN_2112890387(string returnMethod = "")
        {
            M_PARA_2112890387_INIT("M_PARA_2112890387_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-2112890387-INIT THRU PARA-2112890387-INIT-EXIT
            M_PARA_2112890387("M_PARA_2112890387_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-2112890387 THRU PARA-2112890387-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_2112890387
        /// </summary>
        private void M_PARA_2112890387(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_2112890387") { M_0000_ADABAS_ROUTINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        ///COMMENT: ****************************************************************
        ///COMMENT:                                                                *
        ///COMMENT:  INCLUDE NAME:  SWCSZG77.                                      *
        ///COMMENT:      EAB NAME:  SWEXIC15.                                      *
        ///COMMENT:   DESCRIPTION:  0000-ADABAS-ROUTINE FOR CSE NON-CASE PERSON.   *
        ...
        ///COMMENT:                                                                *
        ///COMMENT:       ACTIONS:  RECEIVE LAST-NAME                              *
        ///COMMENT:                         FIRST-NAME                             *
        ...
        private void M_0000_ADABAS_ROUTINE(string returnMethod = "")
        {
            ...
            SetHandleCondtions(HandleCondition.ERROR, "M_9999_CICS_ABEND");                                     //COBOL==> EXEC CICS HANDLE CONDITION ERROR ( 9999-CICS-ABEND ) END-EXEC.
                                                                                                                ...
                                                                                                                //COMMENT: ****************************************************************
            WS.IMP_CLIENT_NUMBER.SetValueWithZeroes();                                                          //COBOL==> MOVE ZERO TO IMP-CLIENT-NUMBER.
            ...
            M_1000_ADD_CSE_NON_CASE_CLIENT("M_1000_EXIT"); if (Control.ExitProgram) { return; }                   //COBOL==> PERFORM 1000-ADD-CSE-NON-CASE-CLIENT THRU 1000-EXIT.
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                M_0000_ADABAS_EXIT(CheckGotoReturn(returnMethod)); return;                                          //COBOL==> GO TO 0000-ADABAS-EXIT
            }                                                                                                   //COBOL==> END-IF.
            ...
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                M_0000_ADABAS_EXIT(CheckGotoReturn(returnMethod)); return;                                          //COBOL==> GO TO 0000-ADABAS-EXIT
                                                                                                                ...
                                                                                                                //COMMENT: ****************************************************************
            LS.NUMBER_0002.SetValue(WS.IMP_CLIENT_NUMBER_X10);                                                  //COBOL==> MOVE IMP-CLIENT-NUMBER-X10 TO NUMBER-0002.
                                                                                                                //COMMENT: ****************************************************************
                                                                                                                //COMMENT: ****************************************************************
            M_0000_ADABAS_EXIT(CheckGotoReturn(returnMethod)); return;                                          //COBOL==> GO TO 0000-ADABAS-EXIT.
        }
        ...
        {
            DisplayToLog("SWCSZG83:" + WS.MV_ABEND_TYPE.AsString() + " - " + WS.MV_ADA_FILE_NUMBER.AsString() + WS.MV_ADA_FILE_ACTION.AsString() + " - " + WS.MV_ADA_RESPONSE_CD.AsString());  //COBOL==> DISPLAY 'SWCSZG83:' MV-ABEND-TYPE ' - ' MV-ADA-FILE-NUMBER MV-ADA-FILE-ACTION ' - ' MV-ADA-RESPONSE-CD
            DisplayToLog(WS.DCLKSD_CLIENT_BASIC.AsString());                                                    //COBOL==> DISPLAY DCLKSD-CLIENT-BASIC
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
            ...
            if (returnMethod != "" && returnMethod != "M_0000_ADABAS_EXIT") { M_PARA_2112890387_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2112890387_EXIT
        /// </summary>
        private void M_PARA_2112890387_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_2112890387_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_2112890387_EXIT") { M_0500_COMMON_CLIENT_ROUTINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_1000_ADD_CSE_NON_CASE_CLIENT(string returnMethod = "")
        {
            WS.WS_PROCESS_ADD.SetValue(true);                                                                   //COBOL==> SET WS-PROCESS-ADD TO TRUE.
                                                                                                                ...
                                                                                                                //COMMENT:  CHECK FOR POTENTIALLY VALID SOCIAL SECURITY NUMBER.            *
                                                                                                                //COMMENT: *****************************************************************
            if (!(WS.IMP_SOC_SEC_NUM.IsZeros()))                                                                //COBOL==> IF IMP-SOC-SEC-NUM NOT = ZERO
            {
        ...
        EndOfSentence_1:;
            ...
            WS.CLIENT_SSN.SetValue(WS.IMP_SOC_SEC_NUM);                                                         //COBOL==> MOVE IMP-SOC-SEC-NUM TO CLIENT-SSN.
                                                                                                                //COMMENT:   M. BROWN PR# 87058, FEB 1, 2000
            if (WS.IMP_DATE_OF_BIRTH.IsZeros())                                                                 //COBOL==> IF IMP-DATE-OF-BIRTH = ZEROS
            {
                //COMMENT:         MOVE SPACES TO IMP-DATE-OF-BIRTH
                WS.IMP_DATE_OF_BIRTH.SetValue(00010101);                                                            //COBOL==> MOVE 00010101 TO IMP-DATE-OF-BIRTH
            }                                                                                                   //COBOL==> END-IF.
            if ((WS.IMP_DATE_OF_BIRTH.IsZeros())
        ...
        EndOfSentence_2:;
            ...
            WS.CLIENTB_EMAIL_ADDRESS_LEN.SetValueWithZeroes();                                                  //COBOL==> MOVE ZEROES TO CLIENTB-EMAIL-ADDRESS-LEN CLIENTB-OCCUPATION-LEN.
            WS.CLIENTB_OCCUPATION_LEN.SetValueWithZeroes();
            ...
            WS.CLIENT_PREVIOUS_SSN.SetValueWithZeroes();                                                        //COBOL==> MOVE ZEROES TO CLIENT-PREVIOUS-SSN
        ...
        {
            //WARNING: Unconverted Command (PGM=SWEXIC15)==>EXEC CICS ASSIGN USERID ( NEXTCLI-LAST-MODIFIED-BY ) END-EXEC.<==
        ...
        {
            //WARNING: Unconverted Command (PGM=SWEXIC15)==>EXEC CICS ASSIGN USERID ( CLIENT-LAST-MODIFIED-BY ) END-EXEC.<==
            DbConv.ExecuteSql("UPDATE KSD_CLIENT SET PREVIOUS_SSN = {0},  DATE_OF_BIRTH = {1},  PHONETIC_DATA = {2},  DT_OF_LAST_UPDATE = CURRENT_DATE,  GENDER = {3},  VERIFIED_SSN_FLAG = {4},  LAST_MODIFIED_BY = {5},  LAST_MODIFIED_TMST = CURRENT_TIMESTAMP WHERE FK_CLB_CLIENT_NO = {6} AND SSN = {7} AND CLIENT_NAME = {8}", WS.CLIENT_PREVIOUS_SSN, WS.CLIENT_DATE_OF_BIRTH, WS.CLIENT_PHONETIC_DATA, WS.CLIENT_GENDER, WS.CLIENT_VERIFIED_SSN_FLAG, WS.CLIENT_LAST_MODIFIED_BY, WS.CLIENT_FK_CLB_CLIENT_NO, WS.CLIENT_SSN, WS.CLIENT_CLIENT_NAME);  //COBOL==> EXEC SQL UPDATE KSD_CLIENT SET PREVIOUS_SSN = :CLIENT-PREVIOUS-SSN , DATE_OF_BIRTH = :CLIENT-DATE-OF-BIRTH , PHONETIC_DATA = :CLIENT-PHONETIC-DATA , DT_OF_LAST_UPDATE = CURRENT_DATE , GENDER = :CLIENT-GENDER , VERIFIED_SSN_FLAG = :CLIENT-VERIFIED-SSN-FLAG , LAST_MODIFIED_BY = :CLIENT-LAST-MODIFIED-BY , LAST_MODIFIED_TMST = CURRENT_TIMESTAMP WHERE FK_CLB_CLIENT_NO = :CLIENT-FK-CLB-CLIENT-NO AND SSN = :CLIENT-SSN AND CLIENT_NAME = :CLIENT-CLIENT-NAME END-EXEC.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              // EvaluateList !WS.SQLCA.SQLCODE!                                                                  //COBOL==> EVALUATE SQLCODE
            if ((WS.SQLCA.SQLCODE.IsZeroes()))                                                                  //COBOL==> WHEN 0
            {
                //Continue                                                                                          //COBOL==> CONTINUE
        ...
        {
            //WARNING: Unconverted Command (PGM=SWEXIC15)==>EXEC CICS ASSIGN USERID ( CLIENTB-CREATED-BY ) END-EXEC.<==
        ...
        {
            //WARNING: Unconverted Command (PGM=SWEXIC15)==>EXEC CICS ASSIGN USERID ( CLIENTB-LAST-MODIFIED-BY ) END-EXEC.<==
        ...
        {
            //WARNING: Unconverted Command (PGM=SWEXIC15)==>EXEC CICS ASSIGN USERID ( SYSPART-CREATED-BY ) END-EXEC.<==
            ...
            if ((WS.SQLCA.SQLCODE.IsEqualTo(-803)))
            {
                //Continue                                                                                          //COBOL==> CONTINUE
            }                                                                                                //COBOL==> WHEN OTHER
            else
        ...
        private void M_PH004_1200_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PH004_1200_EXIT") { M_PARA_2112890387_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2112890387_INIT
        /// </summary>
        /// <remarks>
        ///COMMENT: ************************
        ...
        ///COMMENT: ************************
        /// </remarks>
        private void M_PARA_2112890387_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_2112890387_INIT") { M_PARA_2112890387_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2112890387_INIT_EXIT
        /// </summary>
        private void M_PARA_2112890387_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_2112890387_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
