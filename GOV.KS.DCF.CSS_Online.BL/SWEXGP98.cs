...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:36:31 PM
   **        *   FROM COBOL PGM   :  SWEXGP98
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXGP98_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP98_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT98");
    ...
    internal class SWEXGP98_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP98_ws_WorkingStorage";
    ...
    internal class SWEXGP98_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP98_ls_LinkageSection";
    ...
    public class SWEXGP98 : BatchBase
    {
        ...
        public SWEXGP98()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP98");
        ...
        private SWEXGP98_ws WS;

        //==== File Data Class ========================================
        private SWEXGP98_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP98_ls LS;
        #endregion
