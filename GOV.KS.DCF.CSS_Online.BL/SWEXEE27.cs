...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:26:57 PM
   **        *   FROM COBOL PGM   :  SWEXEE27
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_READ_HINS_CO_FILE            DATE: 2002/11/25
       TARGET OS:   MVS                       TIME: 18:04:27
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXEE27_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEE27_fd_FileSection";
            internal const string HINSIN = "HINSIN";
            internal const string DETAIL_REC = "DETAIL_REC";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink HINSIN { get; set; }
        ...
        {
            recordDef.CreateNewField(Names.DETAIL_REC, FieldType.String, 250);
        ...
        public override void Initialize()
        {
            ...
            HINSIN = FileHandler.GetFile("UT_S_FILEIN");
            HINSIN.AssociatedBuffer = DETAIL_REC;
            HINSIN.RecordLength = 250;
        }
        #endregion
    ...
    internal class SWEXEE27_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEE27_ws_WorkingStorage";
            internal const string WS_TYPE_CA = "WS_TYPE_CA";
            internal const string WS_CA_RECORD_TYPE = "WS_CA_RECORD_TYPE";
            internal const string WS_CA_CARRIER_CODE = "WS_CA_CARRIER_CODE";
            internal const string WS_CA_CARRIER_NAME = "WS_CA_CARRIER_NAME";
            internal const string WS_CA_STREET1 = "WS_CA_STREET1";
            internal const string WS_CA_STREET2 = "WS_CA_STREET2";
            internal const string WS_CA_CITY = "WS_CA_CITY";
            internal const string WS_CA_STATE = "WS_CA_STATE";
            internal const string WS_CA_ZIP_CODE5 = "WS_CA_ZIP_CODE5";
            internal const string WS_CA_ZIP_CODE4 = "WS_CA_ZIP_CODE4";
            internal const string WS_CA_ZIP_CODE3 = "WS_CA_ZIP_CODE3";
            internal const string WS_CA_CONTACT_NAME = "WS_CA_CONTACT_NAME";
            internal const string WS_CA_FAX_AREA_CODE = "WS_CA_FAX_AREA_CODE";
            internal const string WS_CA_FAX_NUMBER = "WS_CA_FAX_NUMBER";
            internal const string WS_CA_FAX_EXTENSION = "WS_CA_FAX_EXTENSION";
            internal const string WS_CA_PHONE_AREA_CODE = "WS_CA_PHONE_AREA_CODE";
            internal const string WS_CA_PHONE_NUMBER = "WS_CA_PHONE_NUMBER";
            internal const string WS_CA_PHONE_EXTENSION = "WS_CA_PHONE_EXTENSION";
            ...
            internal const string WS_AA_CREATION_MMDD = "WS_AA_CREATION_MMDD";
            internal const string WS_AA_CREATION_CCYY = "WS_AA_CREATION_CCYY";
            ...
            internal const string WS_FILE_DATE = "WS_FILE_DATE";
            internal const string WS_CREATION_CCYY = "WS_CREATION_CCYY";
            internal const string WS_CREATION_MMDD = "WS_CREATION_MMDD";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_TYPE_CA { get { return GetElementByName<IGroup>(Names.WS_TYPE_CA); } }
        public IField WS_CA_RECORD_TYPE { get { return GetElementByName<IField>(Names.WS_CA_RECORD_TYPE); } }
        public IField WS_CA_CARRIER_CODE { get { return GetElementByName<IField>(Names.WS_CA_CARRIER_CODE); } }
        public IField WS_CA_CARRIER_NAME { get { return GetElementByName<IField>(Names.WS_CA_CARRIER_NAME); } }
        public IField WS_CA_STREET1 { get { return GetElementByName<IField>(Names.WS_CA_STREET1); } }
        public IField WS_CA_STREET2 { get { return GetElementByName<IField>(Names.WS_CA_STREET2); } }
        public IField WS_CA_CITY { get { return GetElementByName<IField>(Names.WS_CA_CITY); } }
        public IField WS_CA_STATE { get { return GetElementByName<IField>(Names.WS_CA_STATE); } }
        public IField WS_CA_ZIP_CODE5 { get { return GetElementByName<IField>(Names.WS_CA_ZIP_CODE5); } }
        public IField WS_CA_ZIP_CODE4 { get { return GetElementByName<IField>(Names.WS_CA_ZIP_CODE4); } }
        public IField WS_CA_ZIP_CODE3 { get { return GetElementByName<IField>(Names.WS_CA_ZIP_CODE3); } }
        public IField WS_CA_CONTACT_NAME { get { return GetElementByName<IField>(Names.WS_CA_CONTACT_NAME); } }
        public IField WS_CA_FAX_AREA_CODE { get { return GetElementByName<IField>(Names.WS_CA_FAX_AREA_CODE); } }
        public IField WS_CA_FAX_NUMBER { get { return GetElementByName<IField>(Names.WS_CA_FAX_NUMBER); } }
        public IField WS_CA_FAX_EXTENSION { get { return GetElementByName<IField>(Names.WS_CA_FAX_EXTENSION); } }
        public IField WS_CA_PHONE_AREA_CODE { get { return GetElementByName<IField>(Names.WS_CA_PHONE_AREA_CODE); } }
        public IField WS_CA_PHONE_NUMBER { get { return GetElementByName<IField>(Names.WS_CA_PHONE_NUMBER); } }
        public IField WS_CA_PHONE_EXTENSION { get { return GetElementByName<IField>(Names.WS_CA_PHONE_EXTENSION); } }
        ...
        public IGroup WS_AA_CREATION_DATE { get { return GetElementByName<IGroup>(Names.WS_AA_CREATION_DATE); } }
        public IField WS_AA_CREATION_MMDD { get { return GetElementByName<IField>(Names.WS_AA_CREATION_MMDD); } }
        public IField WS_AA_CREATION_CCYY { get { return GetElementByName<IField>(Names.WS_AA_CREATION_CCYY); } }
        ...
        public IField WS_FILE_DATE { get { return GetElementByName<IField>(Names.WS_FILE_DATE); } }
        public IField WS_CREATION_CCYY { get { return GetElementByName<IField>(Names.WS_CREATION_CCYY); } }
        public IField WS_CREATION_MMDD { get { return GetElementByName<IField>(Names.WS_CREATION_MMDD); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            IGroup WS_TYPE_CA_local = (IGroup)recordDef.CreateNewGroup(Names.WS_TYPE_CA, (WS_TYPE_CA) =>
           {
               WS_TYPE_CA.CreateNewField(Names.WS_CA_RECORD_TYPE, FieldType.String, 2, "CA");
               WS_TYPE_CA.CreateNewField(Names.WS_CA_CARRIER_CODE, FieldType.String, 7, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_CARRIER_NAME, FieldType.String, 45, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_STREET1, FieldType.String, 30, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_STREET2, FieldType.String, 30, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_CITY, FieldType.String, 15, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_STATE, FieldType.String, 2, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_ZIP_CODE5, FieldType.String, 5, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_ZIP_CODE4, FieldType.String, 4, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_ZIP_CODE3, FieldType.String, 3, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_CONTACT_NAME, FieldType.String, 40, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_FAX_AREA_CODE, FieldType.String, 3, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_FAX_NUMBER, FieldType.String, 7, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_FAX_EXTENSION, FieldType.String, 5, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_PHONE_AREA_CODE, FieldType.String, 3, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_PHONE_NUMBER, FieldType.String, 7, SPACES);
               WS_TYPE_CA.CreateNewField(Names.WS_CA_PHONE_EXTENSION, FieldType.String, 5, SPACES);
               WS_TYPE_CA.CreateNewFillerField(FieldType.String, 37, SPACES);
           });
            recordDef.CreateNewGroupRedefine(Names.WS_TYPE_AA, WS_TYPE_CA_local, (WS_TYPE_AA) =>
            {
                WS_TYPE_AA.CreateNewField(Names.WS_AA_RECORD_TYPE, FieldType.String, 2);
                WS_TYPE_AA.CreateNewGroup(Names.WS_AA_CREATION_DATE, (WS_AA_CREATION_DATE) =>
                {
                    WS_AA_CREATION_DATE.CreateNewField(Names.WS_AA_CREATION_MMDD, FieldType.UnsignedNumeric, 4);
                    WS_AA_CREATION_DATE.CreateNewField(Names.WS_AA_CREATION_CCYY, FieldType.UnsignedNumeric, 4);
                });
                WS_TYPE_AA.CreateNewFillerField(240, FillWith.Hashes);
            });
            recordDef.CreateNewGroupRedefine(Names.WS_TYPE_ZZ, WS_TYPE_CA_local, (WS_TYPE_ZZ) =>
            {
                WS_TYPE_ZZ.CreateNewField(Names.WS_ZZ_RECORD_TYPE, FieldType.String, 2);
                WS_TYPE_ZZ.CreateNewField(Names.WS_ZZ_RECORD_COUNT, FieldType.UnsignedNumeric, 8);
                WS_TYPE_ZZ.CreateNewFillerField(240, FillWith.Hashes);
            });

            IField WS_FILE_DATE_local = recordDef.CreateNewField(Names.WS_FILE_DATE, FieldType.UnsignedNumeric, 8, ZERO);
            recordDef.CreateNewGroupRedefine("FILLER_d4", WS_FILE_DATE_local, (FILLER_d4) =>
            {
                FILLER_d4.CreateNewField(Names.WS_CREATION_CCYY, FieldType.UnsignedNumeric, 4);
                FILLER_d4.CreateNewField(Names.WS_CREATION_MMDD, FieldType.UnsignedNumeric, 4);
            });
    ...
    internal class SWEXEE27_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEE27_ls_LinkageSection";
            ...
            internal const string HEALTH_INSURANCE_COMPAN_0002ET = "HEALTH_INSURANCE_COMPAN_0002ET";
            internal const string INSURER_PHONE_AREA_CODE_0003AS = "INSURER_PHONE_AREA_CODE_0003AS";
            internal const string INSURER_PHONE_AREA_CODE_0003 = "INSURER_PHONE_AREA_CODE_0003";
            internal const string INSURER_PHONE_AREA_CODE_0003XX = "INSURER_PHONE_AREA_CODE_0003XX";
            internal const string INSURER_FAX_AREA_CODE_0003AS = "INSURER_FAX_AREA_CODE_0003AS";
            internal const string INSURER_FAX_AREA_CODE_0003 = "INSURER_FAX_AREA_CODE_0003";
            internal const string INSURER_FAX_AREA_CODE_0003XX = "INSURER_FAX_AREA_CODE_0003XX";
            internal const string INSURER_FAX_EXT_0003AS = "INSURER_FAX_EXT_0003AS";
            internal const string INSURER_FAX_EXT_0003 = "INSURER_FAX_EXT_0003";
            internal const string INSURER_FAX_EXT_0003XX = "INSURER_FAX_EXT_0003XX";
            internal const string INSURER_PHONE_EXT_0003AS = "INSURER_PHONE_EXT_0003AS";
            internal const string INSURER_PHONE_EXT_0003 = "INSURER_PHONE_EXT_0003";
            internal const string INSURER_PHONE_EXT_0003XX = "INSURER_PHONE_EXT_0003XX";
            internal const string CARRIER_CODE_0003AS = "CARRIER_CODE_0003AS";
            internal const string CARRIER_CODE_0003 = "CARRIER_CODE_0003";
            internal const string CARRIER_CODE_0003XX = "CARRIER_CODE_0003XX";
            internal const string INSURANCE_POLICY_CARRIE_0004AS = "INSURANCE_POLICY_CARRIE_0004AS";
            internal const string INSURANCE_POLICY_CARRIER_0004 = "INSURANCE_POLICY_CARRIER_0004";
            internal const string INSURANCE_POLICY_CARRIE_0004XX = "INSURANCE_POLICY_CARRIE_0004XX";
            internal const string CONTACT_NAME_0004AS = "CONTACT_NAME_0004AS";
            internal const string CONTACT_NAME_0004 = "CONTACT_NAME_0004";
            internal const string CONTACT_NAME_0004XX = "CONTACT_NAME_0004XX";
            internal const string INSURER_PHONE_0004AS = "INSURER_PHONE_0004AS";
            internal const string INSURER_PHONE_0004 = "INSURER_PHONE_0004";
            internal const string INSURER_PHONE_0004XX = "INSURER_PHONE_0004XX";
            internal const string INSURER_FAX_0004AS = "INSURER_FAX_0004AS";
            internal const string INSURER_FAX_0004 = "INSURER_FAX_0004";
            internal const string INSURER_FAX_0004XX = "INSURER_FAX_0004XX";
            internal const string EXPORT_0005EV = "EXPORT_0005EV";
            internal const string HEALTH_INSURANCE_COMPAN_0005ET = "HEALTH_INSURANCE_COMPAN_0005ET";
            ...
            internal const string ZIP_CODE5_0005AS = "ZIP_CODE5_0005AS";
            internal const string ZIP_CODE5_0005 = "ZIP_CODE5_0005";
            internal const string ZIP_CODE5_0005XX = "ZIP_CODE5_0005XX";
            internal const string ZIP_CODE4_0005AS = "ZIP_CODE4_0005AS";
            internal const string ZIP_CODE4_0005 = "ZIP_CODE4_0005";
            internal const string ZIP_CODE4_0005XX = "ZIP_CODE4_0005XX";
            internal const string ZIP3_0005AS = "ZIP3_0005AS";
            internal const string ZIP3_0005 = "ZIP3_0005";
            internal const string ZIP3_0005XX = "ZIP3_0005XX";
            internal const string EXPORT_FILE_HEADER_0006EV = "EXPORT_FILE_HEADER_0006EV";
            ...
            internal const string EXPORT_TOTAL_RECORDS_0007EV = "EXPORT_TOTAL_RECORDS_0007EV";
            internal const string IEF_SUPPLIED_0007ET = "IEF_SUPPLIED_0007ET";
            internal const string COUNT_0007AS = "COUNT_0007AS";
            internal const string COUNT_0007 = "COUNT_0007";
            internal const string COUNT_0007XX = "COUNT_0007XX";
        ...
        public IGroup HEALTH_INSURANCE_COMPAN_0002ET { get { return GetElementByName<IGroup>(Names.HEALTH_INSURANCE_COMPAN_0002ET); } }
        public IField INSURER_PHONE_AREA_CODE_0003AS { get { return GetElementByName<IField>(Names.INSURER_PHONE_AREA_CODE_0003AS); } }
        public IField INSURER_PHONE_AREA_CODE_0003 { get { return GetElementByName<IField>(Names.INSURER_PHONE_AREA_CODE_0003); } }
        public IField INSURER_PHONE_AREA_CODE_0003XX { get { return GetElementByName<IField>(Names.INSURER_PHONE_AREA_CODE_0003XX); } }
        public IField INSURER_FAX_AREA_CODE_0003AS { get { return GetElementByName<IField>(Names.INSURER_FAX_AREA_CODE_0003AS); } }
        public IField INSURER_FAX_AREA_CODE_0003 { get { return GetElementByName<IField>(Names.INSURER_FAX_AREA_CODE_0003); } }
        public IField INSURER_FAX_AREA_CODE_0003XX { get { return GetElementByName<IField>(Names.INSURER_FAX_AREA_CODE_0003XX); } }
        public IField INSURER_FAX_EXT_0003AS { get { return GetElementByName<IField>(Names.INSURER_FAX_EXT_0003AS); } }
        public IField INSURER_FAX_EXT_0003 { get { return GetElementByName<IField>(Names.INSURER_FAX_EXT_0003); } }
        public IField INSURER_FAX_EXT_0003XX { get { return GetElementByName<IField>(Names.INSURER_FAX_EXT_0003XX); } }
        public IField INSURER_PHONE_EXT_0003AS { get { return GetElementByName<IField>(Names.INSURER_PHONE_EXT_0003AS); } }
        public IField INSURER_PHONE_EXT_0003 { get { return GetElementByName<IField>(Names.INSURER_PHONE_EXT_0003); } }
        public IField INSURER_PHONE_EXT_0003XX { get { return GetElementByName<IField>(Names.INSURER_PHONE_EXT_0003XX); } }
        public IField CARRIER_CODE_0003AS { get { return GetElementByName<IField>(Names.CARRIER_CODE_0003AS); } }
        public IField CARRIER_CODE_0003 { get { return GetElementByName<IField>(Names.CARRIER_CODE_0003); } }
        public IField CARRIER_CODE_0003XX { get { return GetElementByName<IField>(Names.CARRIER_CODE_0003XX); } }
        public IField INSURANCE_POLICY_CARRIE_0004AS { get { return GetElementByName<IField>(Names.INSURANCE_POLICY_CARRIE_0004AS); } }
        public IField INSURANCE_POLICY_CARRIER_0004 { get { return GetElementByName<IField>(Names.INSURANCE_POLICY_CARRIER_0004); } }
        public IField INSURANCE_POLICY_CARRIE_0004XX { get { return GetElementByName<IField>(Names.INSURANCE_POLICY_CARRIE_0004XX); } }
        public IField CONTACT_NAME_0004AS { get { return GetElementByName<IField>(Names.CONTACT_NAME_0004AS); } }
        public IField CONTACT_NAME_0004 { get { return GetElementByName<IField>(Names.CONTACT_NAME_0004); } }
        public IField CONTACT_NAME_0004XX { get { return GetElementByName<IField>(Names.CONTACT_NAME_0004XX); } }
        public IField INSURER_PHONE_0004AS { get { return GetElementByName<IField>(Names.INSURER_PHONE_0004AS); } }
        public IField INSURER_PHONE_0004 { get { return GetElementByName<IField>(Names.INSURER_PHONE_0004); } }
        public IField INSURER_PHONE_0004XX { get { return GetElementByName<IField>(Names.INSURER_PHONE_0004XX); } }
        public IField INSURER_FAX_0004AS { get { return GetElementByName<IField>(Names.INSURER_FAX_0004AS); } }
        public IField INSURER_FAX_0004 { get { return GetElementByName<IField>(Names.INSURER_FAX_0004); } }
        public IField INSURER_FAX_0004XX { get { return GetElementByName<IField>(Names.INSURER_FAX_0004XX); } }
        public IGroup EXPORT_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_0005EV); } }
        public IGroup HEALTH_INSURANCE_COMPAN_0005ET { get { return GetElementByName<IGroup>(Names.HEALTH_INSURANCE_COMPAN_0005ET); } }
        ...
        public IField ZIP_CODE5_0005AS { get { return GetElementByName<IField>(Names.ZIP_CODE5_0005AS); } }
        public IField ZIP_CODE5_0005 { get { return GetElementByName<IField>(Names.ZIP_CODE5_0005); } }
        public IField ZIP_CODE5_0005XX { get { return GetElementByName<IField>(Names.ZIP_CODE5_0005XX); } }
        public IField ZIP_CODE4_0005AS { get { return GetElementByName<IField>(Names.ZIP_CODE4_0005AS); } }
        public IField ZIP_CODE4_0005 { get { return GetElementByName<IField>(Names.ZIP_CODE4_0005); } }
        public IField ZIP_CODE4_0005XX { get { return GetElementByName<IField>(Names.ZIP_CODE4_0005XX); } }
        public IField ZIP3_0005AS { get { return GetElementByName<IField>(Names.ZIP3_0005AS); } }
        public IField ZIP3_0005 { get { return GetElementByName<IField>(Names.ZIP3_0005); } }
        public IField ZIP3_0005XX { get { return GetElementByName<IField>(Names.ZIP3_0005XX); } }
        public IGroup EXPORT_FILE_HEADER_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_FILE_HEADER_0006EV); } }
        ...
        public IGroup EXPORT_TOTAL_RECORDS_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_TOTAL_RECORDS_0007EV); } }
        public IGroup IEF_SUPPLIED_0007ET { get { return GetElementByName<IGroup>(Names.IEF_SUPPLIED_0007ET); } }
        public IField COUNT_0007AS { get { return GetElementByName<IField>(Names.COUNT_0007AS); } }
        public IField COUNT_0007 { get { return GetElementByName<IField>(Names.COUNT_0007); } }
        public IField COUNT_0007XX { get { return GetElementByName<IField>(Names.COUNT_0007XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.HEALTH_INSURANCE_COMPAN_0002ET, (HEALTH_INSURANCE_COMPAN_0002ET) =>
               {
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_PHONE_AREA_CODE_0003AS, FieldType.String, 1);

                   IField INSURER_PHONE_AREA_CODE_0003_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_PHONE_AREA_CODE_0003, FieldType.SignedNumeric, 3);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURER_PHONE_AREA_CODE_0003XX, FieldType.String, INSURER_PHONE_AREA_CODE_0003_local, 3);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_FAX_AREA_CODE_0003AS, FieldType.String, 1);

                   IField INSURER_FAX_AREA_CODE_0003_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_FAX_AREA_CODE_0003, FieldType.SignedNumeric, 3);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURER_FAX_AREA_CODE_0003XX, FieldType.String, INSURER_FAX_AREA_CODE_0003_local, 3);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_FAX_EXT_0003AS, FieldType.String, 1);

                   IField INSURER_FAX_EXT_0003_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_FAX_EXT_0003, FieldType.String, 5);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURER_FAX_EXT_0003XX, FieldType.String, INSURER_FAX_EXT_0003_local, 5);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_PHONE_EXT_0003AS, FieldType.String, 1);

                   IField INSURER_PHONE_EXT_0003_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_PHONE_EXT_0003, FieldType.String, 5);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURER_PHONE_EXT_0003XX, FieldType.String, INSURER_PHONE_EXT_0003_local, 5);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.CARRIER_CODE_0003AS, FieldType.String, 1);

                   IField CARRIER_CODE_0003_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.CARRIER_CODE_0003, FieldType.String, 7);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.CARRIER_CODE_0003XX, FieldType.String, CARRIER_CODE_0003_local, 7);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURANCE_POLICY_CARRIE_0004AS, FieldType.String, 1);

                   IField INSURANCE_POLICY_CARRIER_0004_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURANCE_POLICY_CARRIER_0004, FieldType.String, 45);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURANCE_POLICY_CARRIE_0004XX, FieldType.String, INSURANCE_POLICY_CARRIER_0004_local, 45);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.CONTACT_NAME_0004AS, FieldType.String, 1);

                   IField CONTACT_NAME_0004_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.CONTACT_NAME_0004, FieldType.String, 40);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.CONTACT_NAME_0004XX, FieldType.String, CONTACT_NAME_0004_local, 40);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_PHONE_0004AS, FieldType.String, 1);

                   IField INSURER_PHONE_0004_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_PHONE_0004, FieldType.SignedNumeric, 7);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURER_PHONE_0004XX, FieldType.String, INSURER_PHONE_0004_local, 7);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_FAX_0004AS, FieldType.String, 1);

                   IField INSURER_FAX_0004_local = HEALTH_INSURANCE_COMPAN_0002ET.CreateNewField(Names.INSURER_FAX_0004, FieldType.SignedNumeric, 7);
                   HEALTH_INSURANCE_COMPAN_0002ET.CreateNewFieldRedefine(Names.INSURER_FAX_0004XX, FieldType.String, INSURER_FAX_0004_local, 7);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0005EV, (EXPORT_0005EV) =>
           {
               EXPORT_0005EV.CreateNewGroup(Names.HEALTH_INSURANCE_COMPAN_0005ET, (HEALTH_INSURANCE_COMPAN_0005ET) =>
               {
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.STREET_1_0005AS, FieldType.String, 1);

                   IField STREET_1_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.STREET_1_0005, FieldType.String, 25);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.STREET_1_0005XX, FieldType.String, STREET_1_0005_local, 25);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.STREET_2_0005AS, FieldType.String, 1);

                   IField STREET_2_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.STREET_2_0005, FieldType.String, 25);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.STREET_2_0005XX, FieldType.String, STREET_2_0005_local, 25);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.CITY_0005AS, FieldType.String, 1);

                   IField CITY_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.CITY_0005, FieldType.String, 15);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.CITY_0005XX, FieldType.String, CITY_0005_local, 15);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.STATE_0005AS, FieldType.String, 1);

                   IField STATE_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.STATE_0005, FieldType.String, 2);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.STATE_0005XX, FieldType.String, STATE_0005_local, 2);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.ZIP_CODE5_0005AS, FieldType.String, 1);

                   IField ZIP_CODE5_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.ZIP_CODE5_0005, FieldType.String, 5);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.ZIP_CODE5_0005XX, FieldType.String, ZIP_CODE5_0005_local, 5);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.ZIP_CODE4_0005AS, FieldType.String, 1);

                   IField ZIP_CODE4_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.ZIP_CODE4_0005, FieldType.String, 4);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.ZIP_CODE4_0005XX, FieldType.String, ZIP_CODE4_0005_local, 4);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.ZIP3_0005AS, FieldType.String, 1);

                   IField ZIP3_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.ZIP3_0005, FieldType.String, 3);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.ZIP3_0005XX, FieldType.String, ZIP3_0005_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_FILE_HEADER_0006EV, (EXPORT_FILE_HEADER_0006EV) =>
           {
               EXPORT_FILE_HEADER_0006EV.CreateNewGroup(Names.DATE_WORK_AREA_0006ET, (DATE_WORK_AREA_0006ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_TOTAL_RECORDS_0007EV, (EXPORT_TOTAL_RECORDS_0007EV) =>
           {
               EXPORT_TOTAL_RECORDS_0007EV.CreateNewGroup(Names.IEF_SUPPLIED_0007ET, (IEF_SUPPLIED_0007ET) =>
               {
                   IEF_SUPPLIED_0007ET.CreateNewField(Names.COUNT_0007AS, FieldType.String, 1);

                   IField COUNT_0007_local = IEF_SUPPLIED_0007ET.CreateNewField(Names.COUNT_0007, FieldType.SignedNumeric, 9);
                   IEF_SUPPLIED_0007ET.CreateNewFieldRedefine(Names.COUNT_0007XX, FieldType.String, COUNT_0007_local, 9);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_0005EV, args, 5);
            SetPassedParm(EXPORT_FILE_HEADER_0006EV, args, 6);
            SetPassedParm(EXPORT_TOTAL_RECORDS_0007EV, args, 7);
            SetPassedParm(EXPORT_0008EV, args, 8);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_0005EV, args, 5);
            SetReturnParm(EXPORT_FILE_HEADER_0006EV, args, 6);
            SetReturnParm(EXPORT_TOTAL_RECORDS_0007EV, args, 7);
            SetReturnParm(EXPORT_0008EV, args, 8);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXEE27 : BatchBase
    {
        ...
        public SWEXEE27()
            : base()
        {
            this.ProgramName.SetValue("SWEXEE27");
        ...
        private SWEXEE27_ws WS;

        //==== File Data Class ========================================
        private SWEXEE27_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEE27_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0005EV , EXPORT-FILE-HEADER-0006EV , EXPORT-TOTAL-RECORDS-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0968425848(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0968425848
        /// </summary>
        private void M_MAIN_0968425848(string returnMethod = "")
        {
            M_PARA_0968425848_INIT("M_PARA_0968425848_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0968425848-INIT THRU PARA-0968425848-INIT-EXIT
            M_PARA_0968425848("M_PARA_0968425848_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0968425848 THRU PARA-0968425848-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0968425848
        /// </summary>
        private void M_PARA_0968425848(string returnMethod = "")
        {
            ...
            if ((LS.ACTION_0001.IsEqualTo("READ")))
            {
                ...
                M_PARA_EXAM("M_PARA_EXAM_EXIT"); if (Control.ExitProgram) { return; }                                 //COBOL==> PERFORM PARA-EXAM THRU PARA-EXAM-EXIT
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
            ...
            {
                LS.STATUS_0008.SetValue("ABEND");                                                                   //COBOL==> MOVE 'ABEND' TO STATUS-0008
            }                                                                                                   //COBOL==> END-EVALUATE .
            if (returnMethod != "" && returnMethod != "M_PARA_0968425848") { M_PARA_0968425848_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0968425848_EXIT
        /// </summary>
        private void M_PARA_0968425848_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0968425848_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0968425848_EXIT") { M_PARA_READ(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_READ
        /// </summary>
        private void M_PARA_READ(string returnMethod = "")
        {
            ...
            WS.WS_TYPE_CA.SetValue(FD.HINSIN.ReadLineInto());                                                   //COBOL==> READ HINSIN INTO WS-TYPE-CA
            if (FD.HINSIN.FileStatus == FileStatus.End_of_file)                                                 //COBOL==> AT END
            {
        ...
        private void M_PARA_READ_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_READ_EXIT") { M_PARA_EXAM(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_EXAM
        /// </summary>
        private void M_PARA_EXAM(string returnMethod = "")
        {
            if (LS.STATUS_0008.IsEqualTo("EOF"))                                                                //COBOL==> IF STATUS-0008 = 'EOF'
            {
                M_PARA_EXAM_EXIT(CheckGotoReturn(returnMethod)); return;                                            //COBOL==> GO TO PARA-EXAM-EXIT.
            }
            // EvaluateList !WS.WS_CA_RECORD_TYPE!                                                              //COBOL==> EVALUATE WS-CA-RECORD-TYPE
            if ((WS.WS_CA_RECORD_TYPE.IsEqualTo("CA")))                                                         //COBOL==> WHEN 'CA'
            {
                M_PARA_MOVE("M_PARA_MOVE_EXIT"); if (Control.ExitProgram) { return; }                                 //COBOL==> PERFORM PARA-MOVE THRU PARA-MOVE-EXIT
            }                                                                                                //COBOL==> WHEN 'AA'
            else
            if ((WS.WS_CA_RECORD_TYPE.IsEqualTo("AA")))
            {
                if ((WS.WS_AA_CREATION_MMDD.IsNumericValue())
             && (WS.WS_AA_CREATION_CCYY.IsNumericValue()))  //COBOL==> IF WS-AA-CREATION-MMDD NUMERIC AND WS-AA-CREATION-CCYY NUMERIC
                {
                    WS.WS_CREATION_MMDD.SetValue(WS.WS_AA_CREATION_MMDD);                                               //COBOL==> MOVE WS-AA-CREATION-MMDD TO WS-CREATION-MMDD
                    WS.WS_CREATION_CCYY.SetValue(WS.WS_AA_CREATION_CCYY);                                               //COBOL==> MOVE WS-AA-CREATION-CCYY TO WS-CREATION-CCYY
                    LS.DATE_0006.SetValue(WS.WS_FILE_DATE);                                                             //COBOL==> MOVE WS-FILE-DATE TO DATE-0006
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    LS.DATE_0006.SetValue("00010101");                                                                  //COBOL==> MOVE '00010101' TO DATE-0006
                }                                                                                                   //COBOL==> END-IF
                LS.STATUS_0008.SetValue("HEADER");                                                                  //COBOL==> MOVE 'HEADER' TO STATUS-0008
            }                                                                                                //COBOL==> WHEN 'ZZ'
            else
            if ((WS.WS_CA_RECORD_TYPE.IsEqualTo("ZZ")))
            {
                if (WS.WS_ZZ_RECORD_COUNT.IsNumericValue())                                                         //COBOL==> IF WS-ZZ-RECORD-COUNT NUMERIC
                {
                    LS.COUNT_0007.SetValue(WS.WS_ZZ_RECORD_COUNT);                                                      //COBOL==> MOVE WS-ZZ-RECORD-COUNT TO COUNT-0007
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    LS.COUNT_0007.SetValueWithZeroes();                                                                 //COBOL==> MOVE ZERO TO COUNT-0007
                }                                                                                                   //COBOL==> END-IF
                LS.STATUS_0008.SetValue("TRAILER");                                                                 //COBOL==> MOVE 'TRAILER' TO STATUS-0008
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0008.SetValue("ABEND");                                                                   //COBOL==> MOVE 'ABEND' TO STATUS-0008
            }                                                                                                   //COBOL==> END-EVALUATE .
            if (returnMethod != "" && returnMethod != "M_PARA_EXAM") { M_PARA_EXAM_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_EXAM_EXIT
        /// </summary>
        private void M_PARA_EXAM_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_EXAM_EXIT") { return; }                                                 //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_EXAM_EXIT") { M_PARA_MOVE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MOVE
        /// </summary>
        ...
        {
            LS.INSURER_PHONE_AREA_CODE_0003.SetValue(WS.WS_CA_PHONE_AREA_CODE);                                 //COBOL==> MOVE WS-CA-PHONE-AREA-CODE TO INSURER-PHONE-AREA-CODE-0003.
            LS.INSURER_PHONE_0004.SetValue(WS.WS_CA_PHONE_NUMBER);                                              //COBOL==> MOVE WS-CA-PHONE-NUMBER TO INSURER-PHONE-0004.
            LS.INSURER_PHONE_EXT_0003.SetValue(WS.WS_CA_PHONE_EXTENSION);                                       //COBOL==> MOVE WS-CA-PHONE-EXTENSION TO INSURER-PHONE-EXT-0003.
            LS.INSURER_FAX_AREA_CODE_0003.SetValue(WS.WS_CA_FAX_AREA_CODE);                                     //COBOL==> MOVE WS-CA-FAX-AREA-CODE TO INSURER-FAX-AREA-CODE-0003.
            LS.INSURER_FAX_0004.SetValue(WS.WS_CA_FAX_NUMBER);                                                  //COBOL==> MOVE WS-CA-FAX-NUMBER TO INSURER-FAX-0004.
            LS.INSURER_FAX_EXT_0003.SetValue(WS.WS_CA_FAX_EXTENSION);                                           //COBOL==> MOVE WS-CA-FAX-EXTENSION TO INSURER-FAX-EXT-0003.
            LS.CARRIER_CODE_0003.SetValue(WS.WS_CA_CARRIER_CODE);                                               //COBOL==> MOVE WS-CA-CARRIER-CODE TO CARRIER-CODE-0003.
            LS.INSURANCE_POLICY_CARRIER_0004.SetValue(WS.WS_CA_CARRIER_NAME);                                   //COBOL==> MOVE WS-CA-CARRIER-NAME TO INSURANCE-POLICY-CARRIER-0004.
            LS.CONTACT_NAME_0004.SetValue(WS.WS_CA_CONTACT_NAME);                                               //COBOL==> MOVE WS-CA-CONTACT-NAME TO CONTACT-NAME-0004.
            LS.STREET_1_0005.SetValue(WS.WS_CA_STREET1);                                                        //COBOL==> MOVE WS-CA-STREET1 TO STREET-1-0005.
            LS.STREET_2_0005.SetValue(WS.WS_CA_STREET2);                                                        //COBOL==> MOVE WS-CA-STREET2 TO STREET-2-0005.
            LS.CITY_0005.SetValue(WS.WS_CA_CITY);                                                               //COBOL==> MOVE WS-CA-CITY TO CITY-0005.
            LS.STATE_0005.SetValue(WS.WS_CA_STATE);                                                             //COBOL==> MOVE WS-CA-STATE TO STATE-0005.
            LS.ZIP_CODE5_0005.SetValue(WS.WS_CA_ZIP_CODE5);                                                     //COBOL==> MOVE WS-CA-ZIP-CODE5 TO ZIP-CODE5-0005.
            LS.ZIP_CODE4_0005.SetValue(WS.WS_CA_ZIP_CODE4);                                                     //COBOL==> MOVE WS-CA-ZIP-CODE4 TO ZIP-CODE4-0005.
            LS.ZIP3_0005.SetValue(WS.WS_CA_ZIP_CODE3);                                                          //COBOL==> MOVE WS-CA-ZIP-CODE3 TO ZIP3-0005.
        ...
        private void M_PARA_MOVE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_MOVE_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.HINSIN.OpenFile(FileAccessMode.Read);                                                            //COBOL==> OPEN INPUT HINSIN.
            LS.STATUS_0008.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0008.
        ...
        {
            FD.HINSIN.CloseFile();                                                                              //COBOL==> CLOSE HINSIN.
            LS.STATUS_0008.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0008.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_0968425848_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0968425848_INIT
        /// </summary>
        private void M_PARA_0968425848_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_FILE_HEADER_0006EV.ResetToInitialValue();                                                 //COBOL==> INITIALIZE EXPORT-FILE-HEADER-0006EV
            LS.EXPORT_TOTAL_RECORDS_0007EV.ResetToInitialValue();                                               //COBOL==> INITIALIZE EXPORT-TOTAL-RECORDS-0007EV
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0968425848_INIT") { M_PARA_0968425848_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0968425848_INIT_EXIT
        /// </summary>
        private void M_PARA_0968425848_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0968425848_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
