...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:30:17 PM
   **        *   FROM COBOL PGM   :  SWEXEW32
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_B591_WRITE_FILE               DATE: 2017/09/13
       TARGET OS:   MVS                       TIME: 11:33:19
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXEW32_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW32_fd_FileSection";
            internal const string SUMMOUT = "SUMMOUT";
            internal const string SUMMOUT_RECORD = "SUMMOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink SUMMOUT { get; set; }
        public IField SUMMOUT_RECORD { get { return GetElementByName<IField>(Names.SUMMOUT_RECORD); } }


        internal SWEXEW32_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.SUMMOUT_RECORD, FieldType.String, 920);
        ...
        public override void Initialize()
        {
            ...
            SUMMOUT = FileHandler.GetFile("SUMMOUT");
            SUMMOUT.StatusField = WS.SUMMOUT_STAT;
            SUMMOUT.AssociatedBuffer = SUMMOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW32_fd(SWEXEW32_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW32_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW32_ws_WorkingStorage";
            internal const string SUMMOUT_STAT = "SUMMOUT_STAT";
            ...
            internal const string PIX = "PIX";
            internal const string CASE_NUMBER = "CASE_NUMBER";
            internal const string CORR_CASE_NUMBER = "CORR_CASE_NUMBER";
            ...
            internal const string ORDER_STATUS = "ORDER_STATUS";
            internal const string FIPS = "FIPS";
            internal const string LEGEND1 = "LEGEND1";
            internal const string LEGEND2 = "LEGEND2";
            internal const string STREET1 = "STREET1";
            internal const string STREET2 = "STREET2";
            internal const string STREET3 = "STREET3";
            internal const string CITY = "CITY";
            internal const string STATE = "STATE";
            internal const string ZIP_CODE = "ZIP_CODE";
            internal const string CONVERT = "CONVERT";
            internal const string REMARKS = "REMARKS";
            internal const string MULTI_CT_ORDER1 = "MULTI_CT_ORDER1";
            internal const string MULTI_CT_ORDER2 = "MULTI_CT_ORDER2";
        }
        #endregion

        #region Direct-access element properties
        public IField SUMMOUT_STAT { get { return GetExternalElementByName<IField>(Names.SUMMOUT_STAT); } }
        ...
        public IField PIX { get { return GetElementByName<IField>(Names.PIX); } }
        public IField CASE_NUMBER { get { return GetElementByName<IField>(Names.CASE_NUMBER); } }
        public IField CORR_CASE_NUMBER { get { return GetElementByName<IField>(Names.CORR_CASE_NUMBER); } }
        ...
        public IField SUFFIX { get { return GetElementByName<IField>(Names.SUFFIX); } }
        public IField ORDER_STATUS { get { return GetElementByName<IField>(Names.ORDER_STATUS); } }
        public IField FIPS { get { return GetElementByName<IField>(Names.FIPS); } }
        public IField LEGEND1 { get { return GetElementByName<IField>(Names.LEGEND1); } }
        public IField LEGEND2 { get { return GetElementByName<IField>(Names.LEGEND2); } }
        public IField STREET1 { get { return GetElementByName<IField>(Names.STREET1); } }
        public IField STREET2 { get { return GetElementByName<IField>(Names.STREET2); } }
        public IField STREET3 { get { return GetElementByName<IField>(Names.STREET3); } }
        public IField CITY { get { return GetElementByName<IField>(Names.CITY); } }
        public IField STATE { get { return GetElementByName<IField>(Names.STATE); } }
        public IField ZIP_CODE { get { return GetElementByName<IField>(Names.ZIP_CODE); } }
        public IField CONVERT { get { return GetElementByName<IField>(Names.CONVERT); } }
        public IField REMARKS { get { return GetElementByName<IField>(Names.REMARKS); } }
        public IField MULTI_CT_ORDER1 { get { return GetElementByName<IField>(Names.MULTI_CT_ORDER1); } }
        public IField MULTI_CT_ORDER2 { get { return GetElementByName<IField>(Names.MULTI_CT_ORDER2); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.SUMMOUT_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW32 WORKING STORAGE STARTS HERE");
           ...
           {
               WS_DETAIL.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_DETAIL.CreateNewField(Names.PIX, FieldType.String, 3);
               WS_DETAIL.CreateNewField(Names.CASE_NUMBER, FieldType.String, 60);
               WS_DETAIL.CreateNewField(Names.CORR_CASE_NUMBER, FieldType.String, 60);
               WS_DETAIL.CreateNewField(Names.FIRST_NAME, FieldType.String, 12);
               WS_DETAIL.CreateNewField(Names.MIDDLE_NAME, FieldType.String, 12);
               WS_DETAIL.CreateNewField(Names.LAST_NAME, FieldType.String, 17);
               WS_DETAIL.CreateNewField(Names.SUFFIX, FieldType.String, 6);
               WS_DETAIL.CreateNewField(Names.ORDER_STATUS, FieldType.String, 5);
               WS_DETAIL.CreateNewField(Names.FIPS, FieldType.String, 1);
               WS_DETAIL.CreateNewField(Names.LEGEND1, FieldType.String, 33);
               WS_DETAIL.CreateNewField(Names.LEGEND2, FieldType.String, 33);
               WS_DETAIL.CreateNewField(Names.STREET1, FieldType.String, 25);
               WS_DETAIL.CreateNewField(Names.STREET2, FieldType.String, 25);
               WS_DETAIL.CreateNewField(Names.STREET3, FieldType.String, 25);
               WS_DETAIL.CreateNewField(Names.CITY, FieldType.String, 15);
               WS_DETAIL.CreateNewField(Names.STATE, FieldType.String, 2);
               WS_DETAIL.CreateNewField(Names.ZIP_CODE, FieldType.String, 5);
               WS_DETAIL.CreateNewField(Names.CONVERT, FieldType.String, 1);
               WS_DETAIL.CreateNewField(Names.REMARKS, FieldType.String, 12);
               WS_DETAIL.CreateNewField(Names.MULTI_CT_ORDER1, FieldType.String, 200);
               WS_DETAIL.CreateNewField(Names.MULTI_CT_ORDER2, FieldType.String, 200);
               WS_DETAIL.CreateNewFillerField(159, FillWith.Hashes);
           });
    ...
    internal class SWEXEW32_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW32_ls_LinkageSection";
            ...
            internal const string IMPORT_PIC_0003EV = "IMPORT_PIC_0003EV";
            internal const string WORK_AREA_0003ET = "WORK_AREA_0003ET";
            internal const string TEXT_3_0003AS = "TEXT_3_0003AS";
            internal const string TEXT_3_0003 = "TEXT_3_0003";
            internal const string TEXT_3_0003XX = "TEXT_3_0003XX";
            internal const string IMPORT_CT_CASE_NUMBER_0004EV = "IMPORT_CT_CASE_NUMBER_0004EV";
            internal const string WORK_AREA_0004ET = "WORK_AREA_0004ET";
            internal const string TEXT_60_0004AS = "TEXT_60_0004AS";
            internal const string TEXT_60_0004 = "TEXT_60_0004";
            internal const string TEXT_60_0004XX = "TEXT_60_0004XX";
            internal const string IMPORT_CORRECTED_CT_CAS_0005EV = "IMPORT_CORRECTED_CT_CAS_0005EV";
            internal const string WORK_AREA_0005ET = "WORK_AREA_0005ET";
            internal const string TEXT_60_0005AS = "TEXT_60_0005AS";
            internal const string TEXT_60_0005 = "TEXT_60_0005";
            internal const string TEXT_60_0005XX = "TEXT_60_0005XX";
            internal const string IMPORT_SUFFIX_0006EV = "IMPORT_SUFFIX_0006EV";
            internal const string WORK_AREA_0006ET = "WORK_AREA_0006ET";
            internal const string TEXT_6_0006AS = "TEXT_6_0006AS";
            internal const string TEXT_6_0006 = "TEXT_6_0006";
            internal const string TEXT_6_0006XX = "TEXT_6_0006XX";
            internal const string IMPORT_ORDER_STATUS_0007EV = "IMPORT_ORDER_STATUS_0007EV";
            ...
            internal const string IMPORT_FIPS_0008EV = "IMPORT_FIPS_0008EV";
            ...
            internal const string IMPORT_LEGENDS_1_0009EV = "IMPORT_LEGENDS_1_0009EV";
            internal const string WORK_AREA_0009ET = "WORK_AREA_0009ET";
            internal const string TEXT_33_0009AS = "TEXT_33_0009AS";
            internal const string TEXT_33_0009 = "TEXT_33_0009";
            internal const string TEXT_33_0009XX = "TEXT_33_0009XX";
            internal const string IMPORT_LEGENDS_2_0010EV = "IMPORT_LEGENDS_2_0010EV";
            internal const string WORK_AREA_0010ET = "WORK_AREA_0010ET";
            internal const string TEXT_33_0010AS = "TEXT_33_0010AS";
            internal const string TEXT_33_0010 = "TEXT_33_0010";
            internal const string TEXT_33_0010XX = "TEXT_33_0010XX";
            internal const string IMPORT_0011EV = "IMPORT_0011EV";
            internal const string EMPLOYER_ADDRESS_0011ET = "EMPLOYER_ADDRESS_0011ET";
            ...
            internal const string STREET1_0011AS = "STREET1_0011AS";
            internal const string STREET1_0011 = "STREET1_0011";
            internal const string STREET1_0011XX = "STREET1_0011XX";
            internal const string STREET2_0011AS = "STREET2_0011AS";
            internal const string STREET2_0011 = "STREET2_0011";
            internal const string STREET2_0011XX = "STREET2_0011XX";
            ...
            internal const string STREET3_0011AS = "STREET3_0011AS";
            internal const string STREET3_0011 = "STREET3_0011";
            internal const string STREET3_0011XX = "STREET3_0011XX";
            ...
            internal const string IMPORT_CONVERT_0012EV = "IMPORT_CONVERT_0012EV";
            internal const string WORK_AREA_0012ET = "WORK_AREA_0012ET";
            internal const string TEXT_1_0012AS = "TEXT_1_0012AS";
            internal const string TEXT_1_0012 = "TEXT_1_0012";
            internal const string TEXT_1_0012XX = "TEXT_1_0012XX";
            internal const string IMPORT_MIDDLE_NAME_0013EV = "IMPORT_MIDDLE_NAME_0013EV";
            internal const string WORK_AREA_0013ET = "WORK_AREA_0013ET";
            internal const string TEXT_12_0013AS = "TEXT_12_0013AS";
            internal const string TEXT_12_0013 = "TEXT_12_0013";
            internal const string TEXT_12_0013XX = "TEXT_12_0013XX";
            internal const string IMPORT_REMARKS_0014EV = "IMPORT_REMARKS_0014EV";
            internal const string WORK_AREA_0014ET = "WORK_AREA_0014ET";
            internal const string TEXT_12_0014AS = "TEXT_12_0014AS";
            internal const string TEXT_12_0014 = "TEXT_12_0014";
            internal const string TEXT_12_0014XX = "TEXT_12_0014XX";
            internal const string IMPORT_MULTI_CT_ORDER_N_0015EV = "IMPORT_MULTI_CT_ORDER_N_0015EV";
            internal const string WORK_AREA_0015ET = "WORK_AREA_0015ET";
            internal const string TEXT_200_0015AS = "TEXT_200_0015AS";
            internal const string TEXT_200_0015 = "TEXT_200_0015";
            internal const string TEXT_200_0015XX = "TEXT_200_0015XX";
            internal const string IMPORT_MULTI_CT_ORDER_N_0016EV = "IMPORT_MULTI_CT_ORDER_N_0016EV";
            internal const string WORK_AREA_0016ET = "WORK_AREA_0016ET";
            internal const string TEXT_200_0016AS = "TEXT_200_0016AS";
            internal const string TEXT_200_0016 = "TEXT_200_0016";
            internal const string TEXT_200_0016XX = "TEXT_200_0016XX";
        ...
        public IGroup IMPORT_PIC_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_PIC_0003EV); } }
        public IGroup WORK_AREA_0003ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0003ET); } }
        public IField TEXT_3_0003AS { get { return GetElementByName<IField>(Names.TEXT_3_0003AS); } }
        public IField TEXT_3_0003 { get { return GetElementByName<IField>(Names.TEXT_3_0003); } }
        public IField TEXT_3_0003XX { get { return GetElementByName<IField>(Names.TEXT_3_0003XX); } }
        public IGroup IMPORT_CT_CASE_NUMBER_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_CT_CASE_NUMBER_0004EV); } }
        public IGroup WORK_AREA_0004ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0004ET); } }
        public IField TEXT_60_0004AS { get { return GetElementByName<IField>(Names.TEXT_60_0004AS); } }
        public IField TEXT_60_0004 { get { return GetElementByName<IField>(Names.TEXT_60_0004); } }
        public IField TEXT_60_0004XX { get { return GetElementByName<IField>(Names.TEXT_60_0004XX); } }
        public IGroup IMPORT_CORRECTED_CT_CAS_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_CORRECTED_CT_CAS_0005EV); } }
        public IGroup WORK_AREA_0005ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0005ET); } }
        public IField TEXT_60_0005AS { get { return GetElementByName<IField>(Names.TEXT_60_0005AS); } }
        public IField TEXT_60_0005 { get { return GetElementByName<IField>(Names.TEXT_60_0005); } }
        public IField TEXT_60_0005XX { get { return GetElementByName<IField>(Names.TEXT_60_0005XX); } }
        public IGroup IMPORT_SUFFIX_0006EV { get { return GetElementByName<IGroup>(Names.IMPORT_SUFFIX_0006EV); } }
        public IGroup WORK_AREA_0006ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0006ET); } }
        public IField TEXT_6_0006AS { get { return GetElementByName<IField>(Names.TEXT_6_0006AS); } }
        public IField TEXT_6_0006 { get { return GetElementByName<IField>(Names.TEXT_6_0006); } }
        public IField TEXT_6_0006XX { get { return GetElementByName<IField>(Names.TEXT_6_0006XX); } }
        public IGroup IMPORT_ORDER_STATUS_0007EV { get { return GetElementByName<IGroup>(Names.IMPORT_ORDER_STATUS_0007EV); } }
        ...
        public IGroup IMPORT_FIPS_0008EV { get { return GetElementByName<IGroup>(Names.IMPORT_FIPS_0008EV); } }
        ...
        public IGroup IMPORT_LEGENDS_1_0009EV { get { return GetElementByName<IGroup>(Names.IMPORT_LEGENDS_1_0009EV); } }
        public IGroup WORK_AREA_0009ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0009ET); } }
        public IField TEXT_33_0009AS { get { return GetElementByName<IField>(Names.TEXT_33_0009AS); } }
        public IField TEXT_33_0009 { get { return GetElementByName<IField>(Names.TEXT_33_0009); } }
        public IField TEXT_33_0009XX { get { return GetElementByName<IField>(Names.TEXT_33_0009XX); } }
        public IGroup IMPORT_LEGENDS_2_0010EV { get { return GetElementByName<IGroup>(Names.IMPORT_LEGENDS_2_0010EV); } }
        public IGroup WORK_AREA_0010ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0010ET); } }
        public IField TEXT_33_0010AS { get { return GetElementByName<IField>(Names.TEXT_33_0010AS); } }
        public IField TEXT_33_0010 { get { return GetElementByName<IField>(Names.TEXT_33_0010); } }
        public IField TEXT_33_0010XX { get { return GetElementByName<IField>(Names.TEXT_33_0010XX); } }
        public IGroup IMPORT_0011EV { get { return GetElementByName<IGroup>(Names.IMPORT_0011EV); } }
        public IGroup EMPLOYER_ADDRESS_0011ET { get { return GetElementByName<IGroup>(Names.EMPLOYER_ADDRESS_0011ET); } }
        ...
        public IField STREET1_0011AS { get { return GetElementByName<IField>(Names.STREET1_0011AS); } }
        public IField STREET1_0011 { get { return GetElementByName<IField>(Names.STREET1_0011); } }
        public IField STREET1_0011XX { get { return GetElementByName<IField>(Names.STREET1_0011XX); } }
        public IField STREET2_0011AS { get { return GetElementByName<IField>(Names.STREET2_0011AS); } }
        public IField STREET2_0011 { get { return GetElementByName<IField>(Names.STREET2_0011); } }
        public IField STREET2_0011XX { get { return GetElementByName<IField>(Names.STREET2_0011XX); } }
        ...
        public IField STREET3_0011AS { get { return GetElementByName<IField>(Names.STREET3_0011AS); } }
        public IField STREET3_0011 { get { return GetElementByName<IField>(Names.STREET3_0011); } }
        public IField STREET3_0011XX { get { return GetElementByName<IField>(Names.STREET3_0011XX); } }
        ...
        public IGroup IMPORT_CONVERT_0012EV { get { return GetElementByName<IGroup>(Names.IMPORT_CONVERT_0012EV); } }
        public IGroup WORK_AREA_0012ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0012ET); } }
        public IField TEXT_1_0012AS { get { return GetElementByName<IField>(Names.TEXT_1_0012AS); } }
        public IField TEXT_1_0012 { get { return GetElementByName<IField>(Names.TEXT_1_0012); } }
        public IField TEXT_1_0012XX { get { return GetElementByName<IField>(Names.TEXT_1_0012XX); } }
        public IGroup IMPORT_MIDDLE_NAME_0013EV { get { return GetElementByName<IGroup>(Names.IMPORT_MIDDLE_NAME_0013EV); } }
        public IGroup WORK_AREA_0013ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0013ET); } }
        public IField TEXT_12_0013AS { get { return GetElementByName<IField>(Names.TEXT_12_0013AS); } }
        public IField TEXT_12_0013 { get { return GetElementByName<IField>(Names.TEXT_12_0013); } }
        public IField TEXT_12_0013XX { get { return GetElementByName<IField>(Names.TEXT_12_0013XX); } }
        public IGroup IMPORT_REMARKS_0014EV { get { return GetElementByName<IGroup>(Names.IMPORT_REMARKS_0014EV); } }
        public IGroup WORK_AREA_0014ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0014ET); } }
        public IField TEXT_12_0014AS { get { return GetElementByName<IField>(Names.TEXT_12_0014AS); } }
        public IField TEXT_12_0014 { get { return GetElementByName<IField>(Names.TEXT_12_0014); } }
        public IField TEXT_12_0014XX { get { return GetElementByName<IField>(Names.TEXT_12_0014XX); } }
        public IGroup IMPORT_MULTI_CT_ORDER_N_0015EV { get { return GetElementByName<IGroup>(Names.IMPORT_MULTI_CT_ORDER_N_0015EV); } }
        public IGroup WORK_AREA_0015ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0015ET); } }
        public IField TEXT_200_0015AS { get { return GetElementByName<IField>(Names.TEXT_200_0015AS); } }
        public IField TEXT_200_0015 { get { return GetElementByName<IField>(Names.TEXT_200_0015); } }
        public IField TEXT_200_0015XX { get { return GetElementByName<IField>(Names.TEXT_200_0015XX); } }
        public IGroup IMPORT_MULTI_CT_ORDER_N_0016EV { get { return GetElementByName<IGroup>(Names.IMPORT_MULTI_CT_ORDER_N_0016EV); } }
        public IGroup WORK_AREA_0016ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0016ET); } }
        public IField TEXT_200_0016AS { get { return GetElementByName<IField>(Names.TEXT_200_0016AS); } }
        public IField TEXT_200_0016 { get { return GetElementByName<IField>(Names.TEXT_200_0016); } }
        public IField TEXT_200_0016XX { get { return GetElementByName<IField>(Names.TEXT_200_0016XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_PIC_0003EV, (IMPORT_PIC_0003EV) =>
           {
               IMPORT_PIC_0003EV.CreateNewGroup(Names.WORK_AREA_0003ET, (WORK_AREA_0003ET) =>
               {
                   WORK_AREA_0003ET.CreateNewField(Names.TEXT_3_0003AS, FieldType.String, 1);

                   IField TEXT_3_0003_local = WORK_AREA_0003ET.CreateNewField(Names.TEXT_3_0003, FieldType.String, 3);
                   WORK_AREA_0003ET.CreateNewFieldRedefine(Names.TEXT_3_0003XX, FieldType.String, TEXT_3_0003_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_CT_CASE_NUMBER_0004EV, (IMPORT_CT_CASE_NUMBER_0004EV) =>
           {
               IMPORT_CT_CASE_NUMBER_0004EV.CreateNewGroup(Names.WORK_AREA_0004ET, (WORK_AREA_0004ET) =>
               {
                   WORK_AREA_0004ET.CreateNewField(Names.TEXT_60_0004AS, FieldType.String, 1);

                   IField TEXT_60_0004_local = WORK_AREA_0004ET.CreateNewField(Names.TEXT_60_0004, FieldType.String, 60);
                   WORK_AREA_0004ET.CreateNewFieldRedefine(Names.TEXT_60_0004XX, FieldType.String, TEXT_60_0004_local, 60);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_CORRECTED_CT_CAS_0005EV, (IMPORT_CORRECTED_CT_CAS_0005EV) =>
           {
               IMPORT_CORRECTED_CT_CAS_0005EV.CreateNewGroup(Names.WORK_AREA_0005ET, (WORK_AREA_0005ET) =>
               {
                   WORK_AREA_0005ET.CreateNewField(Names.TEXT_60_0005AS, FieldType.String, 1);

                   IField TEXT_60_0005_local = WORK_AREA_0005ET.CreateNewField(Names.TEXT_60_0005, FieldType.String, 60);
                   WORK_AREA_0005ET.CreateNewFieldRedefine(Names.TEXT_60_0005XX, FieldType.String, TEXT_60_0005_local, 60);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_SUFFIX_0006EV, (IMPORT_SUFFIX_0006EV) =>
           {
               IMPORT_SUFFIX_0006EV.CreateNewGroup(Names.WORK_AREA_0006ET, (WORK_AREA_0006ET) =>
               {
                   WORK_AREA_0006ET.CreateNewField(Names.TEXT_6_0006AS, FieldType.String, 1);

                   IField TEXT_6_0006_local = WORK_AREA_0006ET.CreateNewField(Names.TEXT_6_0006, FieldType.String, 6);
                   WORK_AREA_0006ET.CreateNewFieldRedefine(Names.TEXT_6_0006XX, FieldType.String, TEXT_6_0006_local, 6);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_ORDER_STATUS_0007EV, (IMPORT_ORDER_STATUS_0007EV) =>
           {
               IMPORT_ORDER_STATUS_0007EV.CreateNewGroup(Names.WORK_AREA_0007ET, (WORK_AREA_0007ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_FIPS_0008EV, (IMPORT_FIPS_0008EV) =>
           {
               IMPORT_FIPS_0008EV.CreateNewGroup(Names.WORK_AREA_0008ET, (WORK_AREA_0008ET) =>
               {
                   WORK_AREA_0008ET.CreateNewField(Names.TEXT_1_0008AS, FieldType.String, 1);

                   IField TEXT_1_0008_local = WORK_AREA_0008ET.CreateNewField(Names.TEXT_1_0008, FieldType.String, 1);
                   WORK_AREA_0008ET.CreateNewFieldRedefine(Names.TEXT_1_0008XX, FieldType.String, TEXT_1_0008_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_LEGENDS_1_0009EV, (IMPORT_LEGENDS_1_0009EV) =>
           {
               IMPORT_LEGENDS_1_0009EV.CreateNewGroup(Names.WORK_AREA_0009ET, (WORK_AREA_0009ET) =>
               {
                   WORK_AREA_0009ET.CreateNewField(Names.TEXT_33_0009AS, FieldType.String, 1);

                   IField TEXT_33_0009_local = WORK_AREA_0009ET.CreateNewField(Names.TEXT_33_0009, FieldType.String, 33);
                   WORK_AREA_0009ET.CreateNewFieldRedefine(Names.TEXT_33_0009XX, FieldType.String, TEXT_33_0009_local, 33);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_LEGENDS_2_0010EV, (IMPORT_LEGENDS_2_0010EV) =>
           {
               IMPORT_LEGENDS_2_0010EV.CreateNewGroup(Names.WORK_AREA_0010ET, (WORK_AREA_0010ET) =>
               {
                   WORK_AREA_0010ET.CreateNewField(Names.TEXT_33_0010AS, FieldType.String, 1);

                   IField TEXT_33_0010_local = WORK_AREA_0010ET.CreateNewField(Names.TEXT_33_0010, FieldType.String, 33);
                   WORK_AREA_0010ET.CreateNewFieldRedefine(Names.TEXT_33_0010XX, FieldType.String, TEXT_33_0010_local, 33);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0011EV, (IMPORT_0011EV) =>
           {
               IMPORT_0011EV.CreateNewGroup(Names.EMPLOYER_ADDRESS_0011ET, (EMPLOYER_ADDRESS_0011ET) =>
               {
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.LOCATION_TYPE_0011AS, FieldType.String, 1);

                   IField LOCATION_TYPE_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.LOCATION_TYPE_0011, FieldType.String, 1);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.LOCATION_TYPE_0011XX, FieldType.String, LOCATION_TYPE_0011_local, 1);
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STREET1_0011AS, FieldType.String, 1);

                   IField STREET1_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STREET1_0011, FieldType.String, 25);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.STREET1_0011XX, FieldType.String, STREET1_0011_local, 25);
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STREET2_0011AS, FieldType.String, 1);

                   IField STREET2_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STREET2_0011, FieldType.String, 25);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.STREET2_0011XX, FieldType.String, STREET2_0011_local, 25);
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.CITY_0011AS, FieldType.String, 1);

                   IField CITY_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.CITY_0011, FieldType.String, 15);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.CITY_0011XX, FieldType.String, CITY_0011_local, 15);
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STREET3_0011AS, FieldType.String, 1);

                   IField STREET3_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STREET3_0011, FieldType.String, 25);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.STREET3_0011XX, FieldType.String, STREET3_0011_local, 25);
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STATE_0011AS, FieldType.String, 1);

                   IField STATE_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.STATE_0011, FieldType.String, 2);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.STATE_0011XX, FieldType.String, STATE_0011_local, 2);
                   EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.ZIP_CODE_0011AS, FieldType.String, 1);

                   IField ZIP_CODE_0011_local = EMPLOYER_ADDRESS_0011ET.CreateNewField(Names.ZIP_CODE_0011, FieldType.String, 5);
                   EMPLOYER_ADDRESS_0011ET.CreateNewFieldRedefine(Names.ZIP_CODE_0011XX, FieldType.String, ZIP_CODE_0011_local, 5);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_CONVERT_0012EV, (IMPORT_CONVERT_0012EV) =>
           {
               IMPORT_CONVERT_0012EV.CreateNewGroup(Names.WORK_AREA_0012ET, (WORK_AREA_0012ET) =>
               {
                   WORK_AREA_0012ET.CreateNewField(Names.TEXT_1_0012AS, FieldType.String, 1);

                   IField TEXT_1_0012_local = WORK_AREA_0012ET.CreateNewField(Names.TEXT_1_0012, FieldType.String, 1);
                   WORK_AREA_0012ET.CreateNewFieldRedefine(Names.TEXT_1_0012XX, FieldType.String, TEXT_1_0012_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_MIDDLE_NAME_0013EV, (IMPORT_MIDDLE_NAME_0013EV) =>
           {
               IMPORT_MIDDLE_NAME_0013EV.CreateNewGroup(Names.WORK_AREA_0013ET, (WORK_AREA_0013ET) =>
               {
                   WORK_AREA_0013ET.CreateNewField(Names.TEXT_12_0013AS, FieldType.String, 1);

                   IField TEXT_12_0013_local = WORK_AREA_0013ET.CreateNewField(Names.TEXT_12_0013, FieldType.String, 12);
                   WORK_AREA_0013ET.CreateNewFieldRedefine(Names.TEXT_12_0013XX, FieldType.String, TEXT_12_0013_local, 12);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_REMARKS_0014EV, (IMPORT_REMARKS_0014EV) =>
           {
               IMPORT_REMARKS_0014EV.CreateNewGroup(Names.WORK_AREA_0014ET, (WORK_AREA_0014ET) =>
               {
                   WORK_AREA_0014ET.CreateNewField(Names.TEXT_12_0014AS, FieldType.String, 1);

                   IField TEXT_12_0014_local = WORK_AREA_0014ET.CreateNewField(Names.TEXT_12_0014, FieldType.String, 12);
                   WORK_AREA_0014ET.CreateNewFieldRedefine(Names.TEXT_12_0014XX, FieldType.String, TEXT_12_0014_local, 12);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_MULTI_CT_ORDER_N_0015EV, (IMPORT_MULTI_CT_ORDER_N_0015EV) =>
           {
               IMPORT_MULTI_CT_ORDER_N_0015EV.CreateNewGroup(Names.WORK_AREA_0015ET, (WORK_AREA_0015ET) =>
               {
                   WORK_AREA_0015ET.CreateNewField(Names.TEXT_200_0015AS, FieldType.String, 1);

                   IField TEXT_200_0015_local = WORK_AREA_0015ET.CreateNewField(Names.TEXT_200_0015, FieldType.String, 200);
                   WORK_AREA_0015ET.CreateNewFieldRedefine(Names.TEXT_200_0015XX, FieldType.String, TEXT_200_0015_local, 200);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_MULTI_CT_ORDER_N_0016EV, (IMPORT_MULTI_CT_ORDER_N_0016EV) =>
           {
               IMPORT_MULTI_CT_ORDER_N_0016EV.CreateNewGroup(Names.WORK_AREA_0016ET, (WORK_AREA_0016ET) =>
               {
                   WORK_AREA_0016ET.CreateNewField(Names.TEXT_200_0016AS, FieldType.String, 1);

                   IField TEXT_200_0016_local = WORK_AREA_0016ET.CreateNewField(Names.TEXT_200_0016, FieldType.String, 200);
                   WORK_AREA_0016ET.CreateNewFieldRedefine(Names.TEXT_200_0016XX, FieldType.String, TEXT_200_0016_local, 200);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_PIC_0003EV, args, 5);
            SetPassedParm(IMPORT_CT_CASE_NUMBER_0004EV, args, 6);
            SetPassedParm(IMPORT_CORRECTED_CT_CAS_0005EV, args, 7);
            SetPassedParm(IMPORT_SUFFIX_0006EV, args, 8);
            SetPassedParm(IMPORT_ORDER_STATUS_0007EV, args, 9);
            SetPassedParm(IMPORT_FIPS_0008EV, args, 10);
            SetPassedParm(IMPORT_LEGENDS_1_0009EV, args, 11);
            SetPassedParm(IMPORT_LEGENDS_2_0010EV, args, 12);
            SetPassedParm(IMPORT_0011EV, args, 13);
            SetPassedParm(IMPORT_CONVERT_0012EV, args, 14);
            SetPassedParm(IMPORT_MIDDLE_NAME_0013EV, args, 15);
            SetPassedParm(IMPORT_REMARKS_0014EV, args, 16);
            SetPassedParm(IMPORT_MULTI_CT_ORDER_N_0015EV, args, 17);
            SetPassedParm(IMPORT_MULTI_CT_ORDER_N_0016EV, args, 18);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_PIC_0003EV, args, 5);
            SetReturnParm(IMPORT_CT_CASE_NUMBER_0004EV, args, 6);
            SetReturnParm(IMPORT_CORRECTED_CT_CAS_0005EV, args, 7);
            SetReturnParm(IMPORT_SUFFIX_0006EV, args, 8);
            SetReturnParm(IMPORT_ORDER_STATUS_0007EV, args, 9);
            SetReturnParm(IMPORT_FIPS_0008EV, args, 10);
            SetReturnParm(IMPORT_LEGENDS_1_0009EV, args, 11);
            SetReturnParm(IMPORT_LEGENDS_2_0010EV, args, 12);
            SetReturnParm(IMPORT_0011EV, args, 13);
            SetReturnParm(IMPORT_CONVERT_0012EV, args, 14);
            SetReturnParm(IMPORT_MIDDLE_NAME_0013EV, args, 15);
            SetReturnParm(IMPORT_REMARKS_0014EV, args, 16);
            SetReturnParm(IMPORT_MULTI_CT_ORDER_N_0015EV, args, 17);
            SetReturnParm(IMPORT_MULTI_CT_ORDER_N_0016EV, args, 18);
    ...
    public class SWEXEW32 : BatchBase
    {
        ...
        public SWEXEW32()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW32");

            WS = new SWEXEW32_ws();
            FD = new SWEXEW32_fd(WS);
            LS = new SWEXEW32_ls();
        }
        ...
        private SWEXEW32_ws WS;

        //==== File Data Class ========================================
        private SWEXEW32_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW32_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , IMPORT-PIC-0003EV , IMPORT-CT-CASE-NUMBER-0004EV , IMPORT-CORRECTED-CT-CAS-0005EV , IMPORT-SUFFIX-0006EV , IMPORT-ORDER-STATUS-0007EV , IMPORT-FIPS-0008EV , IMPORT-LEGENDS-1-0009EV , IMPORT-LEGENDS-2-0010EV , IMPORT-0011EV , IMPORT-CONVERT-0012EV , IMPORT-MIDDLE-NAME-0013EV , IMPORT-REMARKS-0014EV , IMPORT-MULTI-CT-ORDER-N-0015EV , IMPORT-MULTI-CT-ORDER-N-0016EV , EXPORT-0017EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1832561666(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1832561666
        /// </summary>
        private void M_MAIN_1832561666(string returnMethod = "")
        {
            M_PARA_1832561666_INIT("M_PARA_1832561666_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1832561666-INIT THRU PARA-1832561666-INIT-EXIT
            M_PARA_1832561666("M_PARA_1832561666_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1832561666 THRU PARA-1832561666-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1832561666
        /// </summary>
        private void M_PARA_1832561666(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF88 IS A PART OF SWEXEW32*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.TEXT_RETURN_CODE_0017.SetValue("OK");                                                            //COBOL==> MOVE 'OK' TO TEXT-RETURN-CODE-0017
        ...
        {
            FD.SUMMOUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT SUMMOUT.
            if (!(WS.SUMMOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF SUMMOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0017.SetValue("OP");                                                            //COBOL==> MOVE 'OP' TO TEXT-RETURN-CODE-0017
                                                                                                                    //COMMENT:        MOVE 'AN ERROR OCCURRED ON OPEN '
                                                                                                                    //COMMENT:            TO TEXT-LINE-80-0017
                LS.NUMERIC_RETURN_CODE_0017.SetValue(WS.SUMMOUT_STAT);                                              //COBOL==> MOVE SUMMOUT-STAT TO NUMERIC-RETURN-CODE-0017
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.SUMMOUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO SUMMOUT-RECORD.
            FD.SUMMOUT_RECORD.SetValue(WS.WS_DETAIL);                                                           //COBOL==> MOVE WS-DETAIL TO SUMMOUT-RECORD.
            FD.SUMMOUT.WriteLine(FD.SUMMOUT_RECORD.AsBytes);                                                    //COBOL==> WRITE SUMMOUT-RECORD.
            if (!(WS.SUMMOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF SUMMOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0017.SetValue("WR");                                                            //COBOL==> MOVE 'WR' TO TEXT-RETURN-CODE-0017
                                                                                                                    //COMMENT:          MOVE 'AN ERROR OCCURRED IN WRITTING'
                                                                                                                    //COMMENT:           TO TEXT-LINE-80-0017
                LS.NUMERIC_RETURN_CODE_0017.SetValue(WS.SUMMOUT_STAT);                                              //COBOL==> MOVE SUMMOUT-STAT TO NUMERIC-RETURN-CODE-0017
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            WS.SSN.SetValue(LS.SSN_0002);                                                                       //COBOL==> MOVE SSN-0002 TO SSN.
            WS.PIX.SetValue(LS.TEXT_3_0003);                                                                    //COBOL==> MOVE TEXT-3-0003 TO PIX.
            WS.CASE_NUMBER.SetValue(LS.TEXT_60_0004);                                                           //COBOL==> MOVE TEXT-60-0004 TO CASE_NUMBER.
            WS.CORR_CASE_NUMBER.SetValue(LS.TEXT_60_0005);                                                      //COBOL==> MOVE TEXT-60-0005 TO CORR_CASE_NUMBER.
            WS.FIRST_NAME.SetValue(LS.FIRST_NAME_0002);                                                         //COBOL==> MOVE FIRST-NAME-0002 TO FIRST_NAME.
            WS.MIDDLE_NAME.SetValue(LS.TEXT_12_0013);                                                           //COBOL==> MOVE TEXT-12-0013 TO MIDDLE_NAME.
            WS.LAST_NAME.SetValue(LS.LAST_NAME_0002);                                                           //COBOL==> MOVE LAST-NAME-0002 TO LAST_NAME.
            WS.SUFFIX.SetValue(LS.TEXT_6_0006);                                                                 //COBOL==> MOVE TEXT-6-0006 TO SUFFIX.
            WS.ORDER_STATUS.SetValue(LS.TEXT_5_0007);                                                           //COBOL==> MOVE TEXT-5-0007 TO ORDER_STATUS.
            WS.FIPS.SetValue(LS.TEXT_1_0008);                                                                   //COBOL==> MOVE TEXT-1-0008 TO FIPS.
            WS.LEGEND1.SetValue(LS.TEXT_33_0009);                                                               //COBOL==> MOVE TEXT-33-0009 TO LEGEND1.
            WS.LEGEND2.SetValue(LS.TEXT_33_0010);                                                               //COBOL==> MOVE TEXT-33-0010 TO LEGEND2.
            WS.STREET1.SetValue(LS.STREET1_0011);                                                               //COBOL==> MOVE STREET1-0011 TO STREET1.
            WS.STREET2.SetValue(LS.STREET2_0011);                                                               //COBOL==> MOVE STREET2-0011 TO STREET2.
            WS.STREET3.SetValue(LS.STREET3_0011);                                                               //COBOL==> MOVE STREET3-0011 TO STREET3.
            WS.CITY.SetValue(LS.CITY_0011);                                                                     //COBOL==> MOVE CITY-0011 TO CITY.
            WS.STATE.SetValue(LS.STATE_0011);                                                                   //COBOL==> MOVE STATE-0011 TO STATE.
            WS.ZIP_CODE.SetValue(LS.ZIP_CODE_0011);                                                             //COBOL==> MOVE ZIP-CODE-0011 TO ZIP_CODE.
            WS.CONVERT.SetValue(LS.TEXT_1_0012);                                                                //COBOL==> MOVE TEXT-1-0012 TO CONVERT.
            WS.REMARKS.SetValue(LS.TEXT_12_0014);                                                               //COBOL==> MOVE TEXT-12-0014 TO REMARKS.
            WS.MULTI_CT_ORDER1.SetValue(LS.TEXT_200_0015);                                                      //COBOL==> MOVE TEXT-200-0015 TO MULTI_CT_ORDER1.
            WS.MULTI_CT_ORDER2.SetValue(LS.TEXT_200_0016);                                                      //COBOL==> MOVE TEXT-200-0016 TO MULTI_CT_ORDER2.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1832561666_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832561666_EXIT
        /// </summary>
        private void M_PARA_1832561666_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832561666_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1832561666_EXIT") { M_PARA_1832561666_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832561666_INIT
        /// </summary>
        private void M_PARA_1832561666_INIT(string returnMethod = "")
        {
            LS.EXPORT_0017EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0017EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1832561666_INIT") { M_PARA_1832561666_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832561666_INIT_EXIT
        /// </summary>
        private void M_PARA_1832561666_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832561666_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
