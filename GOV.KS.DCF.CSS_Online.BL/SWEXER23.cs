...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:28:47 PM
   **        *   FROM COBOL PGM   :  SWEXER23
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2016 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: LE_B572_READ_RESPONSE_FILE       DATE: 2016/05/18
       TARGET OS:   MVS                       TIME: 16:14:11
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXER23_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER23_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.INPUT_RECORD, FieldType.String, 245);
        ...
        #region Constructors
        public SWEXER23_fd(SWEXER23_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER23_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER23_ws_WorkingStorage";
    ...
    internal class SWEXER23_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER23_ls_LinkageSection";
            ...
            internal const string ALASKA_PERMANENT_FUND_0003ET = "ALASKA_PERMANENT_FUND_0003ET";
            internal const string INCOMING_RESPONSE_RECOR_0004AS = "INCOMING_RESPONSE_RECOR_0004AS";
            internal const string INCOMING_RESPONSE_RECORD_0004 = "INCOMING_RESPONSE_RECORD_0004";
            internal const string INCOMING_RESPONSE_RECOR_0004XX = "INCOMING_RESPONSE_RECOR_0004XX";
        }
        #endregion
        ...
        public IGroup ALASKA_PERMANENT_FUND_0003ET { get { return GetElementByName<IGroup>(Names.ALASKA_PERMANENT_FUND_0003ET); } }
        public IField INCOMING_RESPONSE_RECOR_0004AS { get { return GetElementByName<IField>(Names.INCOMING_RESPONSE_RECOR_0004AS); } }
        public IField INCOMING_RESPONSE_RECORD_0004 { get { return GetElementByName<IField>(Names.INCOMING_RESPONSE_RECORD_0004); } }
        public IField INCOMING_RESPONSE_RECOR_0004XX { get { return GetElementByName<IField>(Names.INCOMING_RESPONSE_RECOR_0004XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.ALASKA_PERMANENT_FUND_0003ET, (ALASKA_PERMANENT_FUND_0003ET) =>
               {
                   ALASKA_PERMANENT_FUND_0003ET.CreateNewField(Names.INCOMING_RESPONSE_RECOR_0004AS, FieldType.String, 1);

                   IField INCOMING_RESPONSE_RECORD_0004_local = ALASKA_PERMANENT_FUND_0003ET.CreateNewField(Names.INCOMING_RESPONSE_RECORD_0004, FieldType.String, 245);
                   ALASKA_PERMANENT_FUND_0003ET.CreateNewFieldRedefine(Names.INCOMING_RESPONSE_RECOR_0004XX, FieldType.String, INCOMING_RESPONSE_RECORD_0004_local, 245);
               });
           });
    ...
    public class SWEXER23 : BatchBase
    {
        ...
        public SWEXER23()
            : base()
        {
            this.ProgramName.SetValue("SWEXER23");

            WS = new SWEXER23_ws();
            FD = new SWEXER23_fd(WS);
            LS = new SWEXER23_ls();
        }
        ...
        private SWEXER23_ws WS;

        //==== File Data Class ========================================
        private SWEXER23_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER23_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0854597271(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0854597271
        /// </summary>
        private void M_MAIN_0854597271(string returnMethod = "")
        {
            M_PARA_0854597271_INIT("M_PARA_0854597271_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0854597271-INIT THRU PARA-0854597271-INIT-EXIT
            M_PARA_0854597271("M_PARA_0854597271_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0854597271 THRU PARA-0854597271-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0854597271
        /// </summary>
        private void M_PARA_0854597271(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0854597271") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.INCOMING_RESPONSE_RECORD_0004.SetValue(FD.INPUT_RECORD);                                         //COBOL==> MOVE INPUT-RECORD TO INCOMING-RESPONSE-RECORD-0004
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0854597271_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854597271_EXIT
        /// </summary>
        private void M_PARA_0854597271_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854597271_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0854597271_EXIT") { M_PARA_0854597271_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854597271_INIT
        /// </summary>
        private void M_PARA_0854597271_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0854597271_INIT") { M_PARA_0854597271_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854597271_INIT_EXIT
        /// </summary>
        private void M_PARA_0854597271_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854597271_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
