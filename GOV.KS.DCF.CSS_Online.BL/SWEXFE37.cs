...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:34:20 PM
   **        *   FROM COBOL PGM   :  SWEXFE37
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: FN_B603_EAB_EXTRACT_FILE         DATE: 2010/12/10
       TARGET OS:   MVS                       TIME: 08:48:56
       TARGET DBMS: DB2                       USER: SWCOJHX
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXFE37_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE37_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               OUTPUT_RECORD.CreateNewField(Names.RECORD_DETAIL, FieldType.String, 132);
           });
        ...
        #region Constructors
        public SWEXFE37_fd(SWEXFE37_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE37_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE37_ws_WorkingStorage";
    ...
    internal class SWEXFE37_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE37_ls_LinkageSection";
    ...
    public class SWEXFE37 : BatchBase
    {
        ...
        public SWEXFE37()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE37");

            WS = new SWEXFE37_ws();
            FD = new SWEXFE37_fd(WS);
            LS = new SWEXFE37_ls();
        }
        ...
        private SWEXFE37_ws WS;

        //==== File Data Class ========================================
        private SWEXFE37_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE37_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0990904467(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0990904467
        /// </summary>
        private void M_MAIN_0990904467(string returnMethod = "")
        {
            M_PARA_0990904467_INIT("M_PARA_0990904467_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0990904467-INIT THRU PARA-0990904467-INIT-EXIT
            M_PARA_0990904467("M_PARA_0990904467_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0990904467 THRU PARA-0990904467-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0990904467
        /// </summary>
        private void M_PARA_0990904467(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            {
                FD.OUTPUT_RECORD.SetValue(LS.RPT_DETAIL_0001);                                                      //COBOL==> MOVE RPT-DETAIL-0001 TO OUTPUT-RECORD
            ...
            {
                LS.STATUS_0003.SetValue(WS.FILE_STATUS);                                                            //COBOL==> MOVE FILE-STATUS TO STATUS-0003
            }                                                                                                   //COBOL==> END-IF .
            if (returnMethod != "" && returnMethod != "M_PARA_0990904467") { M_PARA_0990904467_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0990904467_EXIT
        /// </summary>
        private void M_PARA_0990904467_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0990904467_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0990904467_EXIT") { M_PARA_0990904467_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0990904467_INIT
        /// </summary>
        private void M_PARA_0990904467_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0990904467_INIT") { M_PARA_0990904467_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0990904467_INIT_EXIT
        /// </summary>
        private void M_PARA_0990904467_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0990904467_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
