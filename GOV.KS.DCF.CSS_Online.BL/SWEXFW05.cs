...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:35:28 PM
   **        *   FROM COBOL PGM   :  SWEXFW05
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_WRITE_SYSOUT_FILE            DATE: 2001/05/24
       TARGET OS:   MVS                       TIME: 12:15:17
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXFW05_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFW05_fd_FileSection";
            internal const string SYSOUT_FILE = "SYSOUT_FILE";
            internal const string SYSOUT_RECORD = "SYSOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink SYSOUT_FILE { get; set; }
        public IGroup SYSOUT_RECORD { get { return GetElementByName<IGroup>(Names.SYSOUT_RECORD); } }


        internal SWEXFW05_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.SYSOUT_RECORD, (SYSOUT_RECORD) =>
           {
               SYSOUT_RECORD.CreateNewFillerField(80, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            SYSOUT_FILE = FileHandler.GetFile("OUTFILE");
            SYSOUT_FILE.StatusField = WS.WS_FILE_STATUS;
            SYSOUT_FILE.AssociatedBuffer = SYSOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXFW05_fd(SWEXFW05_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFW05_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFW05_ws_WorkingStorage";
    ...
    internal class SWEXFW05_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFW05_ls_LinkageSection";
            ...
            internal const string IMPORT_SYSOUT_INFO_0001EV = "IMPORT_SYSOUT_INFO_0001EV";
        ...
        public IGroup IMPORT_SYSOUT_INFO_0001EV { get { return GetElementByName<IGroup>(Names.IMPORT_SYSOUT_INFO_0001EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_SYSOUT_INFO_0001EV, (IMPORT_SYSOUT_INFO_0001EV) =>
           {
               IMPORT_SYSOUT_INFO_0001EV.CreateNewGroup(Names.EXTERNAL_0001ET, (EXTERNAL_0001ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_SYSOUT_INFO_0001EV, args, 3);
            SetPassedParm(EXPORT_RETURN_CODE_0002EV, args, 4);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_SYSOUT_INFO_0001EV, args, 3);
            SetReturnParm(EXPORT_RETURN_CODE_0002EV, args, 4);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXFW05 : BatchBase
    {
        ...
        public SWEXFW05()
            : base()
        {
            this.ProgramName.SetValue("SWEXFW05");

            WS = new SWEXFW05_ws();
            FD = new SWEXFW05_fd(WS);
            LS = new SWEXFW05_ls();
        }
        ...
        private SWEXFW05_ws WS;

        //==== File Data Class ========================================
        private SWEXFW05_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFW05_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-SYSOUT-INFO-0001EV , EXPORT-RETURN-CODE-0002EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0842533659(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0842533659
        /// </summary>
        private void M_MAIN_0842533659(string returnMethod = "")
        {
            M_PARA_0842533659_INIT("M_PARA_0842533659_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0842533659-INIT THRU PARA-0842533659-INIT-EXIT
            M_PARA_0842533659("M_PARA_0842533659_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0842533659 THRU PARA-0842533659-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0842533659
        /// </summary>
        private void M_PARA_0842533659(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            FD.SYSOUT_FILE.OpenFile(FileAccessMode.Write);                                                      //COBOL==> OPEN OUTPUT SYSOUT-FILE
            if (!(WS.WS_FILE_STATUS.IsEqualTo("00")))                                                           //COBOL==> IF WS-FILE-STATUS IS NOT EQUAL TO '00'
            {
                LS.TEXT_RETURN_CODE_0002.SetValue("EO");                                                            //COBOL==> MOVE 'EO' TO TEXT-RETURN-CODE-0002
            }                                                                                                   //COBOL==> END-IF
            FD.SYSOUT_FILE.WriteLine(LS.TEXT_LINE_80_0001.AsBytes);                                             //COBOL==> WRITE SYSOUT-RECORD FROM TEXT-LINE-80-0001
            if (!(WS.WS_FILE_STATUS.IsEqualTo("00")))                                                           //COBOL==> IF WS-FILE-STATUS IS NOT EQUAL TO '00'
            {
                LS.TEXT_RETURN_CODE_0002.SetValue("EW");                                                            //COBOL==> MOVE 'EW' TO TEXT-RETURN-CODE-0002
            }                                                                                                   //COBOL==> END-IF .
            if (returnMethod != "" && returnMethod != "M_PARA_0842533659") { M_PARA_0842533659_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0842533659_EXIT
        /// </summary>
        private void M_PARA_0842533659_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0842533659_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0842533659_EXIT") { M_PARA_0842533659_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0842533659_INIT
        /// </summary>
        private void M_PARA_0842533659_INIT(string returnMethod = "")
        {
            LS.EXPORT_RETURN_CODE_0002EV.ResetToInitialValue();                                                 //COBOL==> INITIALIZE EXPORT-RETURN-CODE-0002EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0842533659_INIT") { M_PARA_0842533659_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0842533659_INIT_EXIT
        /// </summary>
        private void M_PARA_0842533659_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0842533659_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
