...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:28:04 PM
   **        *   FROM COBOL PGM   :  SWEXER10
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_KDMV_RESPONSE_NON_MATCH   DATE: 2008/08/28
       TARGET OS:   MVS                       TIME: 09:59:16
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXER10_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER10_fd_FileSection";
            internal const string KDORRED = "KDORRED";
            internal const string KDORRED_RECORD = "KDORRED_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink KDORRED { get; set; }
        public IField KDORRED_RECORD { get { return GetElementByName<IField>(Names.KDORRED_RECORD); } }


        internal SWEXER10_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.KDORRED_RECORD, FieldType.String, 250);
        ...
        public override void Initialize()
        {
            ...
            KDORRED = FileHandler.GetFile("KDORRED");
            KDORRED.StatusField = WS.KDORRED_STAT;
            KDORRED.AssociatedBuffer = KDORRED_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXER10_fd(SWEXER10_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER10_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER10_ws_WorkingStorage";
            internal const string KDORRED_STAT = "KDORRED_STAT";
            ...
            internal const string WS_KDORRED = "WS_KDORRED";
            internal const string LAST_NAME_IN = "LAST_NAME_IN";
            internal const string FIRST_NAME_IN = "FIRST_NAME_IN";
            internal const string SSN_IN = "SSN_IN";
            internal const string DOB_IN = "DOB_IN";
            internal const string CSE_PERSON_NUMBER_IN = "CSE_PERSON_NUMBER_IN";
            internal const string DRIVER_LICENSE_NUM_IN = "DRIVER_LICENSE_NUM_IN";
            internal const string REQUEST_STATUS_IN = "REQUEST_STATUS_IN";
            internal const string DMV_PROBLEM_TEXT_IN = "DMV_PROBLEM_TEXT_IN";
        }
        #endregion

        #region Direct-access element properties
        public IField KDORRED_STAT { get { return GetExternalElementByName<IField>(Names.KDORRED_STAT); } }
        ...
        public IGroup WS_KDORRED { get { return GetElementByName<IGroup>(Names.WS_KDORRED); } }
        public IField LAST_NAME_IN { get { return GetElementByName<IField>(Names.LAST_NAME_IN); } }
        public IField FIRST_NAME_IN { get { return GetElementByName<IField>(Names.FIRST_NAME_IN); } }
        public IField SSN_IN { get { return GetElementByName<IField>(Names.SSN_IN); } }
        public IField DOB_IN { get { return GetElementByName<IField>(Names.DOB_IN); } }
        public IField CSE_PERSON_NUMBER_IN { get { return GetElementByName<IField>(Names.CSE_PERSON_NUMBER_IN); } }
        public IField DRIVER_LICENSE_NUM_IN { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUM_IN); } }
        public IField REQUEST_STATUS_IN { get { return GetElementByName<IField>(Names.REQUEST_STATUS_IN); } }
        public IField DMV_PROBLEM_TEXT_IN { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_IN); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.KDORRED_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW03 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_KDORRED, (WS_KDORRED) =>
           {
               WS_KDORRED.CreateNewField(Names.LAST_NAME_IN, FieldType.String, 17);
               WS_KDORRED.CreateNewField(Names.FIRST_NAME_IN, FieldType.String, 12);
               WS_KDORRED.CreateNewField(Names.SSN_IN, FieldType.String, 9);
               WS_KDORRED.CreateNewField(Names.DOB_IN, FieldType.String, 8);
               WS_KDORRED.CreateNewField(Names.CSE_PERSON_NUMBER_IN, FieldType.String, 10);
               WS_KDORRED.CreateNewField(Names.DRIVER_LICENSE_NUM_IN, FieldType.String, 9);
               WS_KDORRED.CreateNewField(Names.REQUEST_STATUS_IN, FieldType.String, 3);
               WS_KDORRED.CreateNewField(Names.DMV_PROBLEM_TEXT_IN, FieldType.String, 37);
               WS_KDORRED.CreateNewFillerField(145, FillWith.Hashes);
           });
    ...
    internal class SWEXER10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER10_ls_LinkageSection";
            ...
            internal const string KDMV_FILE_0002ET = "KDMV_FILE_0002ET";
            internal const string CSE_PERSON_NUMBER_0002AS = "CSE_PERSON_NUMBER_0002AS";
            internal const string CSE_PERSON_NUMBER_0002 = "CSE_PERSON_NUMBER_0002";
            internal const string CSE_PERSON_NUMBER_0002XX = "CSE_PERSON_NUMBER_0002XX";
            ...
            internal const string FILE_TYPE_0002AS = "FILE_TYPE_0002AS";
            internal const string FILE_TYPE_0002 = "FILE_TYPE_0002";
            internal const string FILE_TYPE_0002XX = "FILE_TYPE_0002XX";
            internal const string DRIVER_LICENSE_NUMBER_0002AS = "DRIVER_LICENSE_NUMBER_0002AS";
            internal const string DRIVER_LICENSE_NUMBER_0002 = "DRIVER_LICENSE_NUMBER_0002";
            internal const string DRIVER_LICENSE_NUMBER_0002XX = "DRIVER_LICENSE_NUMBER_0002XX";
            internal const string REQUEST_STATUS_0002AS = "REQUEST_STATUS_0002AS";
            internal const string REQUEST_STATUS_0002 = "REQUEST_STATUS_0002";
            internal const string REQUEST_STATUS_0002XX = "REQUEST_STATUS_0002XX";
            internal const string DMV_PROBLEM_TEXT_0002AS = "DMV_PROBLEM_TEXT_0002AS";
            internal const string DMV_PROBLEM_TEXT_0002 = "DMV_PROBLEM_TEXT_0002";
            internal const string DMV_PROBLEM_TEXT_0002XX = "DMV_PROBLEM_TEXT_0002XX";
        ...
        public IGroup KDMV_FILE_0002ET { get { return GetElementByName<IGroup>(Names.KDMV_FILE_0002ET); } }
        public IField CSE_PERSON_NUMBER_0002AS { get { return GetElementByName<IField>(Names.CSE_PERSON_NUMBER_0002AS); } }
        public IField CSE_PERSON_NUMBER_0002 { get { return GetElementByName<IField>(Names.CSE_PERSON_NUMBER_0002); } }
        public IField CSE_PERSON_NUMBER_0002XX { get { return GetElementByName<IField>(Names.CSE_PERSON_NUMBER_0002XX); } }
        ...
        public IField FILE_TYPE_0002AS { get { return GetElementByName<IField>(Names.FILE_TYPE_0002AS); } }
        public IField FILE_TYPE_0002 { get { return GetElementByName<IField>(Names.FILE_TYPE_0002); } }
        public IField FILE_TYPE_0002XX { get { return GetElementByName<IField>(Names.FILE_TYPE_0002XX); } }
        public IField DRIVER_LICENSE_NUMBER_0002AS { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUMBER_0002AS); } }
        public IField DRIVER_LICENSE_NUMBER_0002 { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUMBER_0002); } }
        public IField DRIVER_LICENSE_NUMBER_0002XX { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUMBER_0002XX); } }
        public IField REQUEST_STATUS_0002AS { get { return GetElementByName<IField>(Names.REQUEST_STATUS_0002AS); } }
        public IField REQUEST_STATUS_0002 { get { return GetElementByName<IField>(Names.REQUEST_STATUS_0002); } }
        public IField REQUEST_STATUS_0002XX { get { return GetElementByName<IField>(Names.REQUEST_STATUS_0002XX); } }
        public IField DMV_PROBLEM_TEXT_0002AS { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_0002AS); } }
        public IField DMV_PROBLEM_TEXT_0002 { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_0002); } }
        public IField DMV_PROBLEM_TEXT_0002XX { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.KDMV_FILE_0002ET, (KDMV_FILE_0002ET) =>
               {
                   KDMV_FILE_0002ET.CreateNewField(Names.CSE_PERSON_NUMBER_0002AS, FieldType.String, 1);

                   IField CSE_PERSON_NUMBER_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.CSE_PERSON_NUMBER_0002, FieldType.String, 10);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.CSE_PERSON_NUMBER_0002XX, FieldType.String, CSE_PERSON_NUMBER_0002_local, 10);
                   KDMV_FILE_0002ET.CreateNewField(Names.LAST_NAME_0002AS, FieldType.String, 1);

                   IField LAST_NAME_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.LAST_NAME_0002, FieldType.String, 17);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.LAST_NAME_0002XX, FieldType.String, LAST_NAME_0002_local, 17);
                   KDMV_FILE_0002ET.CreateNewField(Names.FIRST_NAME_0002AS, FieldType.String, 1);

                   IField FIRST_NAME_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.FIRST_NAME_0002, FieldType.String, 12);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.FIRST_NAME_0002XX, FieldType.String, FIRST_NAME_0002_local, 12);
                   KDMV_FILE_0002ET.CreateNewField(Names.SSN_0002AS, FieldType.String, 1);

                   IField SSN_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.SSN_0002, FieldType.String, 9);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.SSN_0002XX, FieldType.String, SSN_0002_local, 9);
                   KDMV_FILE_0002ET.CreateNewField(Names.DOB_0002AS, FieldType.String, 1);

                   IField DOB_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.DOB_0002, FieldType.String, 8);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.DOB_0002XX, FieldType.String, DOB_0002_local, 8);
                   KDMV_FILE_0002ET.CreateNewField(Names.FILE_TYPE_0002AS, FieldType.String, 1);

                   IField FILE_TYPE_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.FILE_TYPE_0002, FieldType.String, 1);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.FILE_TYPE_0002XX, FieldType.String, FILE_TYPE_0002_local, 1);
                   KDMV_FILE_0002ET.CreateNewField(Names.DRIVER_LICENSE_NUMBER_0002AS, FieldType.String, 1);

                   IField DRIVER_LICENSE_NUMBER_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.DRIVER_LICENSE_NUMBER_0002, FieldType.String, 9);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.DRIVER_LICENSE_NUMBER_0002XX, FieldType.String, DRIVER_LICENSE_NUMBER_0002_local, 9);
                   KDMV_FILE_0002ET.CreateNewField(Names.REQUEST_STATUS_0002AS, FieldType.String, 1);

                   IField REQUEST_STATUS_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.REQUEST_STATUS_0002, FieldType.String, 3);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.REQUEST_STATUS_0002XX, FieldType.String, REQUEST_STATUS_0002_local, 3);
                   KDMV_FILE_0002ET.CreateNewField(Names.DMV_PROBLEM_TEXT_0002AS, FieldType.String, 1);

                   IField DMV_PROBLEM_TEXT_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.DMV_PROBLEM_TEXT_0002, FieldType.String, 37);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.DMV_PROBLEM_TEXT_0002XX, FieldType.String, DMV_PROBLEM_TEXT_0002_local, 37);
               });
           });
    ...
    public class SWEXER10 : BatchBase
    {
        ...
        public SWEXER10()
            : base()
        {
            this.ProgramName.SetValue("SWEXER10");

            WS = new SWEXER10_ws();
            FD = new SWEXER10_fd(WS);
            LS = new SWEXER10_ls();
        }
        ...
        private SWEXER10_ws WS;

        //==== File Data Class ========================================
        private SWEXER10_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER10_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230586089(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230586089
        /// </summary>
        private void M_MAIN_1230586089(string returnMethod = "")
        {
            M_PARA_1230586089_INIT("M_PARA_1230586089_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230586089-INIT THRU PARA-1230586089-INIT-EXIT
            M_PARA_1230586089("M_PARA_1230586089_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230586089 THRU PARA-1230586089-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230586089
        /// </summary>
        private void M_PARA_1230586089(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE76 IS A PART OF SWEXER10*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.TEXT_RETURN_CODE_0003.SetValue("OK");                                                            //COBOL==> MOVE 'OK' TO TEXT-RETURN-CODE-0003.
            ...
            {
                M_0100_OPEN(); if (Control.ExitProgram) { return; }                                                   //COBOL==> PERFORM 0100-OPEN
            }                                                                                                //COBOL==> WHEN 'READ'
            else
            ...
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("AB");                                                            //COBOL==> MOVE 'AB' TO TEXT-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        {
            FD.KDORRED.OpenFile(FileAccessMode.Read);                                                           //COBOL==> OPEN INPUT KDORRED
            if (WS.KDORRED_STAT.IsEqualTo(00))                                                                  //COBOL==> IF KDORRED-STAT = 00
            {
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDORRED_STAT);                                              //COBOL==> MOVE KDORRED-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("OP");                                                            //COBOL==> MOVE 'OP' TO TEXT-RETURN-CODE-0003
                LS.TEXT_LINE_80_0003.SetValue("AN ERROR OCCURRED ON OPEN OF KDORRED FILE");                         //COBOL==> MOVE 'AN ERROR OCCURRED ON OPEN OF KDORRED FILE' TO TEXT-LINE-80-0003
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDORRED_STAT);                                              //COBOL==> MOVE KDORRED-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
            if (returnMethod != "" && returnMethod != "M_0100_OPEN") { M_0500_PROCESS_TRANS(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            WS.WS_KDORRED.SetValue(FD.KDORRED.ReadLineInto());                                                  //COBOL==> READ KDORRED INTO WS-KDORRED.
            if (WS.KDORRED_STAT.IsEqualTo(10))                                                                  //COBOL==> IF KDORRED-STAT = 10
            {
                LS.TEXT_LINE_80_0003.SetValue("REACHED END OF KDOR NON-MATCH RESPONSE FILE");                       //COBOL==> MOVE 'REACHED END OF KDOR NON-MATCH RESPONSE FILE' TO TEXT-LINE-80-0003
            ...
            if (!(WS.KDORRED_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDORRED-STAT NOT = 00
            {
                LS.TEXT_LINE_80_0003.SetValue("ERROR IN READING NON-MATCH RESPONSE FILE");                          //COBOL==> MOVE 'ERROR IN READING NON-MATCH RESPONSE FILE' TO TEXT-LINE-80-0003
                LS.TEXT_RETURN_CODE_0003.SetValue("XX");                                                            //COBOL==> MOVE 'XX' TO TEXT-RETURN-CODE-0003
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDORRED_STAT);                                              //COBOL==> MOVE KDORRED-STAT TO NUMERIC-RETURN-CODE-0003
                M_0500_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 0500-EXIT
            }                                                                                                   //COBOL==> END-IF.
            LS.CSE_PERSON_NUMBER_0002.SetValue(WS.CSE_PERSON_NUMBER_IN);                                        //COBOL==> MOVE CSE-PERSON-NUMBER-IN TO CSE-PERSON-NUMBER-0002
            LS.LAST_NAME_0002.SetValue(WS.LAST_NAME_IN);                                                        //COBOL==> MOVE LAST-NAME-IN TO LAST-NAME-0002
            LS.FIRST_NAME_0002.SetValue(WS.FIRST_NAME_IN);                                                      //COBOL==> MOVE FIRST-NAME-IN TO FIRST-NAME-0002
            LS.SSN_0002.SetValue(WS.SSN_IN);                                                                    //COBOL==> MOVE SSN-IN TO SSN-0002
            LS.DOB_0002.SetValue(WS.DOB_IN);                                                                    //COBOL==> MOVE DOB-IN TO DOB-0002
            LS.DRIVER_LICENSE_NUMBER_0002.SetValue(WS.DRIVER_LICENSE_NUM_IN);                                   //COBOL==> MOVE DRIVER-LICENSE-NUM-IN TO DRIVER-LICENSE-NUMBER-0002
            LS.REQUEST_STATUS_0002.SetValue(WS.REQUEST_STATUS_IN);                                              //COBOL==> MOVE REQUEST-STATUS-IN TO REQUEST-STATUS-0002
            LS.DMV_PROBLEM_TEXT_0002.SetValue(WS.DMV_PROBLEM_TEXT_IN);                                          //COBOL==> MOVE DMV-PROBLEM-TEXT-IN TO DMV-PROBLEM-TEXT-0002
        ...
        {
            FD.KDORRED.CloseFile();                                                                             //COBOL==> CLOSE KDORRED.
            if (!(WS.KDORRED_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDORRED-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("CL");                                                            //COBOL==> MOVE 'CL' TO TEXT-RETURN-CODE-0003
                LS.TEXT_LINE_80_0003.SetValue("ERROR IN CLOSING KDOR READ FILE");                                   //COBOL==> MOVE 'ERROR IN CLOSING KDOR READ FILE' TO TEXT-LINE-80-0003
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDORRED_STAT);                                              //COBOL==> MOVE KDORRED-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230586089_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230586089_EXIT
        /// </summary>
        private void M_PARA_1230586089_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230586089_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230586089_EXIT") { M_PARA_1230586089_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230586089_INIT
        /// </summary>
        private void M_PARA_1230586089_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1230586089_INIT") { M_PARA_1230586089_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230586089_INIT_EXIT
        /// </summary>
        private void M_PARA_1230586089_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230586089_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
