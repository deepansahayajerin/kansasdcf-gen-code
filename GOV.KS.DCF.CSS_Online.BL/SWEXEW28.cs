...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:30:08 PM
   **        *   FROM COBOL PGM   :  SWEXEW28
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2016 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: LE_B571_WRITE_TO_MATCH_FILE      DATE: 2016/05/06
       TARGET OS:   MVS                       TIME: 15:37:32
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXEW28_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW28_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.NCP_RECORD, FieldType.String, 80);
        ...
        #region Constructors
        public SWEXEW28_fd(SWEXEW28_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW28_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW28_ws_WorkingStorage";
    ...
    internal class SWEXEW28_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW28_ls_LinkageSection";
    ...
    public class SWEXEW28 : BatchBase
    {
        ...
        public SWEXEW28()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW28");

            WS = new SWEXEW28_ws();
            FD = new SWEXEW28_fd(WS);
            LS = new SWEXEW28_ls();
        }
        ...
        private SWEXEW28_ws WS;

        //==== File Data Class ========================================
        private SWEXEW28_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW28_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0854596218(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0854596218
        /// </summary>
        private void M_MAIN_0854596218(string returnMethod = "")
        {
            M_PARA_0854596218_INIT("M_PARA_0854596218_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0854596218-INIT THRU PARA-0854596218-INIT-EXIT
            M_PARA_0854596218("M_PARA_0854596218_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0854596218 THRU PARA-0854596218-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0854596218
        /// </summary>
        private void M_PARA_0854596218(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0854596218") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.NCP_RECORD.SetValue(LS.TEXT_80_0002);                                                            //COBOL==> MOVE TEXT-80-0002 TO NCP-RECORD
            ...
            if (returnMethod != "" && returnMethod != "M_2000_WRITE_FILE") { M_4000_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0854596218_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854596218_EXIT
        /// </summary>
        private void M_PARA_0854596218_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854596218_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0854596218_EXIT") { M_PARA_0854596218_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854596218_INIT
        /// </summary>
        private void M_PARA_0854596218_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0854596218_INIT") { M_PARA_0854596218_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854596218_INIT_EXIT
        /// </summary>
        private void M_PARA_0854596218_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854596218_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
