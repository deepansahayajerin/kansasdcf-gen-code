...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:37:58 PM
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    public class SWEXI720 : BatchBase
    {
        ...
        {
            if ((LS.LS_IN_OFF_01XX.IsMaxValue())
             || (LS.LS_IN_OFF_01XX.IsMinValue()))           //COBOL==> IF LS-IN-OFF-01XX = HIGH-VALUES OR LS-IN-OFF-01XX = LOW-VALUES
            {
                LS.LS_IN_OFF_01.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO LS-IN-OFF-01
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_SERV_PROV_02XX.IsMaxValue())
             || (LS.LS_IN_SERV_PROV_02XX.IsMinValue()))  //COBOL==> IF LS-IN-SERV-PROV-02XX = HIGH-VALUES OR LS-IN-SERV-PROV-02XX = LOW-VALUES
            {
            ...
            if ((LS.LS_IN_REF_TYP_05XX.IsMaxValue())
             || (LS.LS_IN_REF_TYP_05XX.IsMinValue()))   //COBOL==> IF LS-IN-REF-TYP-05XX = HIGH-VALUES OR LS-IN-REF-TYP-05XX = LOW-VALUES
            {
                LS.LS_IN_REF_TYP_05.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-REF-TYP-05
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_PARM1_06XX.IsMaxValue())
             || (LS.LS_IN_PARM1_06XX.IsMinValue()))       //COBOL==> IF LS-IN-PARM1-06XX = HIGH-VALUES OR LS-IN-PARM1-06XX = LOW-VALUES
            {
                LS.LS_IN_PARM1_06.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO LS-IN-PARM1-06
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_PARM2_07XX.IsMaxValue())
             || (LS.LS_IN_PARM2_07XX.IsMinValue()))       //COBOL==> IF LS-IN-PARM2-07XX = HIGH-VALUES OR LS-IN-PARM2-07XX = LOW-VALUES
            {
                LS.LS_IN_PARM2_07.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO LS-IN-PARM2-07
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_OUT_PARM1_08XX.IsMaxValue())
             || (LS.LS_OUT_PARM1_08XX.IsMinValue()))     //COBOL==> IF LS-OUT-PARM1-08XX = HIGH-VALUES OR LS-OUT-PARM1-08XX = LOW-VALUES
            {
                LS.LS_OUT_PARM1_08.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO LS-OUT-PARM1-08
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_OUT_PARM2_09XX.IsMaxValue())
             || (LS.LS_OUT_PARM2_09XX.IsMinValue()))     //COBOL==> IF LS-OUT-PARM2-09XX = HIGH-VALUES OR LS-OUT-PARM2-09XX = LOW-VALUES
            {
