...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:25:23 PM
   **        *   FROM COBOL PGM   :  SWEX0003
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEX0003_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEX0003_fd_FileSection";
            internal const string INPUT_FILE = "INPUT_FILE";
            internal const string INPUT_RECORD = "INPUT_RECORD";
            internal const string WS_TYPE = "WS_TYPE";
            internal const string WS_SEQUENCE_NUMBER = "WS_SEQUENCE_NUMBER";
            internal const string WS_FIRST_PAGE_IND = "WS_FIRST_PAGE_IND";
            internal const string WS_LINE_CONTROL = "WS_LINE_CONTROL";
            internal const string WS_LINE_TEXT = "WS_LINE_TEXT";
            internal const string WS_TIMESTAMP = "WS_TIMESTAMP";
            internal const string WS_JOBNAME = "WS_JOBNAME";
        }
        #endregion
        ...
        public IField WS_TYPE { get { return GetElementByName<IField>(Names.WS_TYPE); } }
        public IField WS_SEQUENCE_NUMBER { get { return GetElementByName<IField>(Names.WS_SEQUENCE_NUMBER); } }
        public IField WS_FIRST_PAGE_IND { get { return GetElementByName<IField>(Names.WS_FIRST_PAGE_IND); } }
        public IField WS_LINE_CONTROL { get { return GetElementByName<IField>(Names.WS_LINE_CONTROL); } }
        public IField WS_LINE_TEXT { get { return GetElementByName<IField>(Names.WS_LINE_TEXT); } }
        public IField WS_TIMESTAMP { get { return GetElementByName<IField>(Names.WS_TIMESTAMP); } }
        public IField WS_JOBNAME { get { return GetElementByName<IField>(Names.WS_JOBNAME); } }


        internal SWEX0003_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD.CreateNewField(Names.WS_TYPE, FieldType.String, 1);
               INPUT_RECORD.CreateNewField(Names.WS_SEQUENCE_NUMBER, FieldType.CompInt, 9, 0);
               INPUT_RECORD.CreateNewField(Names.WS_FIRST_PAGE_IND, FieldType.String, 1);
               INPUT_RECORD.CreateNewField(Names.WS_LINE_CONTROL, FieldType.String, 2);
               INPUT_RECORD.CreateNewField(Names.WS_LINE_TEXT, FieldType.String, 132);
               INPUT_RECORD.CreateNewField(Names.WS_TIMESTAMP, FieldType.String, 26);
               INPUT_RECORD.CreateNewField(Names.WS_JOBNAME, FieldType.String, 8);
               INPUT_RECORD.CreateNewFillerField(1, FillWith.Hashes);
           });
        ...
        #region Constructors
        public SWEX0003_fd(SWEX0003_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEX0003_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEX0003_ws_WorkingStorage";
    ...
    internal class SWEX0003_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEX0003_ls_LinkageSection";
            ...
            internal const string PSMGR_EAB_DATA_d2 = "PSMGR_EAB_DATA_d2";
            ...
            internal const string SEQUENCE_NUMBER_0002AS = "SEQUENCE_NUMBER_0002AS";
            internal const string SEQUENCE_NUMBER_0002 = "SEQUENCE_NUMBER_0002";
            internal const string SEQUENCE_NUMBER_0002XX = "SEQUENCE_NUMBER_0002XX";
            internal const string FIRST_PAGE_ONLY_IND_0002AS = "FIRST_PAGE_ONLY_IND_0002AS";
            internal const string FIRST_PAGE_ONLY_IND_0002 = "FIRST_PAGE_ONLY_IND_0002";
            internal const string FIRST_PAGE_ONLY_IND_0002XX = "FIRST_PAGE_ONLY_IND_0002XX";
            internal const string LINE_CONTROL_0002AS = "LINE_CONTROL_0002AS";
            internal const string LINE_CONTROL_0002 = "LINE_CONTROL_0002";
            internal const string LINE_CONTROL_0002XX = "LINE_CONTROL_0002XX";
            internal const string LINE_TEXT_0002AS = "LINE_TEXT_0002AS";
        ...
        public IGroup PSMGR_EAB_DATA_d2 { get { return GetElementByName<IGroup>(Names.PSMGR_EAB_DATA_d2); } }
        ...
        public IField SEQUENCE_NUMBER_0002AS { get { return GetElementByName<IField>(Names.SEQUENCE_NUMBER_0002AS); } }
        public IField SEQUENCE_NUMBER_0002 { get { return GetElementByName<IField>(Names.SEQUENCE_NUMBER_0002); } }
        public IField SEQUENCE_NUMBER_0002XX { get { return GetElementByName<IField>(Names.SEQUENCE_NUMBER_0002XX); } }
        public IField FIRST_PAGE_ONLY_IND_0002AS { get { return GetElementByName<IField>(Names.FIRST_PAGE_ONLY_IND_0002AS); } }
        public IField FIRST_PAGE_ONLY_IND_0002 { get { return GetElementByName<IField>(Names.FIRST_PAGE_ONLY_IND_0002); } }
        public IField FIRST_PAGE_ONLY_IND_0002XX { get { return GetElementByName<IField>(Names.FIRST_PAGE_ONLY_IND_0002XX); } }
        public IField LINE_CONTROL_0002AS { get { return GetElementByName<IField>(Names.LINE_CONTROL_0002AS); } }
        public IField LINE_CONTROL_0002 { get { return GetElementByName<IField>(Names.LINE_CONTROL_0002); } }
        public IField LINE_CONTROL_0002XX { get { return GetElementByName<IField>(Names.LINE_CONTROL_0002XX); } }
        public IField LINE_TEXT_0002AS { get { return GetElementByName<IField>(Names.LINE_TEXT_0002AS); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.PSMGR_EAB_DATA_d2, (PSMGR_EAB_DATA_d2) =>
           {
               PSMGR_EAB_DATA_d2.CreateNewField(Names.PSMGR_EABPCB_CNT_d2, FieldType.CompInt, 9);
               PSMGR_EAB_DATA_d2.CreateNewGroupArray(Names.PSMGR_EABPCB_ENTRY_d2, 255, (PSMGR_EABPCB_ENTRY_d2) =>
               {
           ...
           {
               W_IA.CreateNewGroup(Names.EAB_FILE_HANDLING_0001ET, (EAB_FILE_HANDLING_0001ET) =>
               {
           ...
           {
               W_OA.CreateNewGroup(Names.REPORT_DATA_0002ET, (REPORT_DATA_0002ET) =>
               {
                   REPORT_DATA_0002ET.CreateNewField(Names.TYPE_0002AS, FieldType.String, 1);

                   IField TYPE_0002_local = REPORT_DATA_0002ET.CreateNewField(Names.TYPE_0002, FieldType.String, 1);
                   REPORT_DATA_0002ET.CreateNewFieldRedefine(Names.TYPE_0002XX, FieldType.String, TYPE_0002_local, 1);
                   REPORT_DATA_0002ET.CreateNewField(Names.SEQUENCE_NUMBER_0002AS, FieldType.String, 1);

                   IField SEQUENCE_NUMBER_0002_local = REPORT_DATA_0002ET.CreateNewField(Names.SEQUENCE_NUMBER_0002, FieldType.SignedNumeric, 9);
                   REPORT_DATA_0002ET.CreateNewFieldRedefine(Names.SEQUENCE_NUMBER_0002XX, FieldType.String, SEQUENCE_NUMBER_0002_local, 9);
                   REPORT_DATA_0002ET.CreateNewField(Names.FIRST_PAGE_ONLY_IND_0002AS, FieldType.String, 1);

                   IField FIRST_PAGE_ONLY_IND_0002_local = REPORT_DATA_0002ET.CreateNewField(Names.FIRST_PAGE_ONLY_IND_0002, FieldType.String, 1);
                   REPORT_DATA_0002ET.CreateNewFieldRedefine(Names.FIRST_PAGE_ONLY_IND_0002XX, FieldType.String, FIRST_PAGE_ONLY_IND_0002_local, 1);
                   REPORT_DATA_0002ET.CreateNewField(Names.LINE_CONTROL_0002AS, FieldType.String, 1);

                   IField LINE_CONTROL_0002_local = REPORT_DATA_0002ET.CreateNewField(Names.LINE_CONTROL_0002, FieldType.String, 2);
                   REPORT_DATA_0002ET.CreateNewFieldRedefine(Names.LINE_CONTROL_0002XX, FieldType.String, LINE_CONTROL_0002_local, 2);
                   REPORT_DATA_0002ET.CreateNewField(Names.LINE_TEXT_0002AS, FieldType.String, 1);
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(W_IA, args, 3);
            SetPassedParm(W_OA, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(W_IA, args, 3);
            SetReturnParm(W_OA, args, 4);
    ...
    public class SWEX0003 : BatchBase
    {
        ...
        public SWEX0003()
            : base()
        {
            this.ProgramName.SetValue("SWEX0003");

            WS = new SWEX0003_ws();
            FD = new SWEX0003_fd(WS);
            LS = new SWEX0003_ls();
        }
        ...
        private SWEX0003_ws WS;

        //==== File Data Class ========================================
        private SWEX0003_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEX0003_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , W-IA , W-OA , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            if (LS.ACTION_0001.IsEqualTo("OPEN"))                                                               //COBOL==> IF ACTION-0001 = 'OPEN'
            {
                ...
                if (WS.FILE_STS.IsEqualTo("00"))                                                                    //COBOL==> IF FILE-STS = '00'
                {
                    ...
                    DisplayToLog("SWEX0003: FILE OPEN AT " + WS.WS_RUN_TIME.GetSubstring(1, 2).AsString() + ":" + WS.WS_RUN_TIME.GetSubstring(3, 2).AsString() + ":" + WS.WS_RUN_TIME.GetSubstring(5, 2).AsString());  //COBOL==> DISPLAY 'SWEX0003: FILE OPEN AT ' WS-RUN-TIME ( 1:2 ) ':' WS-RUN-TIME ( 3:2 ) ':' WS-RUN-TIME ( 5:2 )
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    LS.STATUS_0003.SetValue(WS.FILE_STS);                                                               //COBOL==> MOVE FILE-STS TO STATUS-0003
                    DisplayToLog("SWEX0003: INDD01 OPEN ERROR - " + WS.FILE_STS.AsString());                            //COBOL==> DISPLAY 'SWEX0003: INDD01 OPEN ERROR - ' FILE-STS
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                   //COBOL==> END-IF.
            if (LS.ACTION_0001.IsEqualTo("READ"))                                                               //COBOL==> IF ACTION-0001 = 'READ'
            {
                ...
                {
                    if (!(WS.FILE_STS.IsEqualTo("00")))                                                                 //COBOL==> IF FILE-STS NOT = '00'
                    {
                        LS.STATUS_0003.SetValue(WS.FILE_STS);                                                               //COBOL==> MOVE FILE-STS TO STATUS-0003
                    }                                                                                                   //COBOL==> END-IF
                    LS.TYPE_0002.SetValue(FD.WS_TYPE);                                                                  //COBOL==> MOVE WS-TYPE TO TYPE-0002
                    LS.SEQUENCE_NUMBER_0002.SetValue(FD.WS_SEQUENCE_NUMBER);                                            //COBOL==> MOVE WS-SEQUENCE-NUMBER TO SEQUENCE-NUMBER-0002
                    LS.FIRST_PAGE_ONLY_IND_0002.SetValue(FD.WS_FIRST_PAGE_IND);                                         //COBOL==> MOVE WS-FIRST-PAGE-IND TO FIRST-PAGE-ONLY-IND-0002
                    LS.LINE_CONTROL_0002.SetValue(FD.WS_LINE_CONTROL);                                                  //COBOL==> MOVE WS-LINE-CONTROL TO LINE-CONTROL-0002
                    LS.LINE_TEXT_0002.SetValue(FD.WS_LINE_TEXT);                                                        //COBOL==> MOVE WS-LINE-TEXT TO LINE-TEXT-0002
                }                                                                                                   //COBOL==> END-READ
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_CLOSE_INPUT(string returnMethod = "")
        {
            ...
            if (WS.FILE_STS.IsEqualTo("00"))                                                                    //COBOL==> IF FILE-STS = '00'
            {
                ...
                DisplayToLog("SWEX0003: # RECS READ  " + WS.DISPLAY_COUNTS.AsString());                             //COBOL==> DISPLAY 'SWEX0003: # RECS READ  ' DISPLAY-COUNTS
                DisplayToLog("======================================");                                             //COBOL==> DISPLAY '======================================'
                DisplayToLog("SWEX0003: FILE CLOSED AT " + WS.WS_RUN_TIME.GetSubstring(1, 2).AsString() + ":" + WS.WS_RUN_TIME.GetSubstring(3, 2).AsString() + ":" + WS.WS_RUN_TIME.GetSubstring(5, 2).AsString());  //COBOL==> DISPLAY 'SWEX0003: FILE CLOSED AT ' WS-RUN-TIME ( 1:2 ) ':' WS-RUN-TIME ( 3:2 ) ':' WS-RUN-TIME ( 5:2 )
                WS.FILE_OPEN_SW.SetValue(WS.NOPE);                                                                  //COBOL==> MOVE NOPE TO FILE-OPEN-SW
            }                                                                                                   //COBOL==> ELSE
            else
            {
                DisplayToLog("SWEX0003: INDD01 CLOSE ERROR - " + WS.FILE_STS.AsString());                           //COBOL==> DISPLAY 'SWEX0003: INDD01 CLOSE ERROR - ' FILE-STS
            }                                                                                                   //COBOL==> END-IF.
        }
        #endregion
    }
