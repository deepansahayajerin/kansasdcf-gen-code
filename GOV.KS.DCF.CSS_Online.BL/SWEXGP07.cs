...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:36:21 PM
   **        *   FROM COBOL PGM   :  SWEXGP07
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXGP07_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP07_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT07");
    ...
    internal class SWEXGP07_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP07_ws_WorkingStorage";
    ...
    internal class SWEXGP07_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP07_ls_LinkageSection";
    ...
    public class SWEXGP07 : BatchBase
    {
        ...
        public SWEXGP07()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP07");
        ...
        private SWEXGP07_ws WS;

        //==== File Data Class ========================================
        private SWEXGP07_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP07_ls LS;
        #endregion
