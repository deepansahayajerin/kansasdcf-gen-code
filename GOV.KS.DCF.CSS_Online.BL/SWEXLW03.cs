...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:45:33 PM
   **        *   FROM COBOL PGM   :  SWEXLW03
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_EAB_WRITE_KDOL_MATCH_FILE     DATE: 2012/05/22
       TARGET OS:   MVS                       TIME: 16:07:59
       TARGET DBMS: DB2                       USER: SWDPRKM
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXLW03_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLW03_fd_FileSection";
        ...
        public IField OUTPUT_RECORD { get { return GetElementByName<IField>(Names.OUTPUT_RECORD); } }


        internal SWEXLW03_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.OUTPUT_RECORD, FieldType.String, 142);
        ...
        public override void Initialize()
        {
            ...
            OUTPUT_FILE = FileHandler.GetFile("KDOLEXT");
        ...
        #region Constructors
        public SWEXLW03_fd(SWEXLW03_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLW03_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLW03_ws_WorkingStorage";
            internal const string FILE_STATUS = "FILE_STATUS";
            internal const string DOL_OUTPUT_REC_FORMATS = "DOL_OUTPUT_REC_FORMATS";
            internal const string DOL_OUTPUT_REC = "DOL_OUTPUT_REC";
            ...
            internal const string REC2_CLIENT = "REC2_CLIENT";
            internal const string REC2_FILE_DATE = "REC2_FILE_DATE";
            internal const string REC2_AMOUNT = "REC2_AMOUNT";
            internal const string REC2_MAX_PERCENT = "REC2_MAX_PERCENT";
            internal const string REC3_FOOTER = "REC3_FOOTER";
        ...
        public IGroup DOL_OUTPUT_REC_FORMATS { get { return GetElementByName<IGroup>(Names.DOL_OUTPUT_REC_FORMATS); } }
        public IField DOL_OUTPUT_REC { get { return GetElementByName<IField>(Names.DOL_OUTPUT_REC); } }
        ...
        public IField REC2_CLIENT { get { return GetElementByName<IField>(Names.REC2_CLIENT); } }
        public IField REC2_FILE_DATE { get { return GetElementByName<IField>(Names.REC2_FILE_DATE); } }
        public IField REC2_AMOUNT { get { return GetElementByName<IField>(Names.REC2_AMOUNT); } }
        public IField REC2_MAX_PERCENT { get { return GetElementByName<IField>(Names.REC2_MAX_PERCENT); } }
        public IGroup REC3_FOOTER { get { return GetElementByName<IGroup>(Names.REC3_FOOTER); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.DOL_OUTPUT_REC_FORMATS, (DOL_OUTPUT_REC_FORMATS) =>
           {

               IField DOL_OUTPUT_REC_local = DOL_OUTPUT_REC_FORMATS.CreateNewField(Names.DOL_OUTPUT_REC, FieldType.String, 142);
               DOL_OUTPUT_REC_FORMATS.CreateNewGroupRedefine(Names.REC1_HEADER, DOL_OUTPUT_REC_local, (REC1_HEADER) =>
               {
                   ...
                   REC1_HEADER.CreateNewFillerField(133, FillWith.Hashes);
               });
               DOL_OUTPUT_REC_FORMATS.CreateNewGroupRedefine(Names.REC2_DETAIL, DOL_OUTPUT_REC_local, (REC2_DETAIL) =>
               {
                   ...
                   REC2_DETAIL.CreateNewFillerField(1, FillWith.Hashes);
                   ...
                   REC2_DETAIL.CreateNewFillerField(5, FillWith.Hashes);
                   REC2_DETAIL.CreateNewField(Names.REC2_CLIENT, FieldType.String, 14);
                   REC2_DETAIL.CreateNewFillerField(1, FillWith.Hashes);
                   REC2_DETAIL.CreateNewField(Names.REC2_FILE_DATE, FieldType.String, 8);
                   REC2_DETAIL.CreateNewFillerField(2, FillWith.Hashes);
                   REC2_DETAIL.CreateNewField(Names.REC2_AMOUNT, FieldType.UnsignedNumeric, 8, null, 2);
                   REC2_DETAIL.CreateNewFillerField(2, FillWith.Hashes);
                   REC2_DETAIL.CreateNewField(Names.REC2_MAX_PERCENT, FieldType.UnsignedNumeric, 3);
                   REC2_DETAIL.CreateNewFillerField(49, FillWith.Hashes);
               });
               DOL_OUTPUT_REC_FORMATS.CreateNewGroupRedefine(Names.REC3_FOOTER, DOL_OUTPUT_REC_local, (REC3_FOOTER) =>
               {
                   REC3_FOOTER.CreateNewField(Names.REC3_TYPE, FieldType.String, 1);
                   REC3_FOOTER.CreateNewFillerField(1, FillWith.Hashes);
                   REC3_FOOTER.CreateNewField(Names.REC3_COUNT, FieldType.UnsignedNumeric, 10);
                   REC3_FOOTER.CreateNewFillerField(1, FillWith.Hashes);
                   REC3_FOOTER.CreateNewField(Names.REC3_AMOUNT, FieldType.UnsignedNumeric, 15, null, 2);
                   REC3_FOOTER.CreateNewFillerField(114, FillWith.Hashes);
               });
           });
    ...
    internal class SWEXLW03_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLW03_ls_LinkageSection";
            ...
            internal const string IMPORT_TOTAL_AMOUNT_0001EV = "IMPORT_TOTAL_AMOUNT_0001EV";
            ...
            internal const string IMPORT_TOTAL_COUNT_0002EV = "IMPORT_TOTAL_COUNT_0002EV";
            ...
            internal const string IMPORT_REC_TYPE_0004EV = "IMPORT_REC_TYPE_0004EV";
            ...
            internal const string KDOL_FILE_0005ET = "KDOL_FILE_0005ET";
            ...
            internal const string CLIENT_NUMBER_0005AS = "CLIENT_NUMBER_0005AS";
            internal const string CLIENT_NUMBER_0005 = "CLIENT_NUMBER_0005";
            internal const string CLIENT_NUMBER_0005XX = "CLIENT_NUMBER_0005XX";
            internal const string EXTRACT_DATE_0005AS = "EXTRACT_DATE_0005AS";
            internal const string EXTRACT_DATE_0005 = "EXTRACT_DATE_0005";
            internal const string EXTRACT_DATE_0005XX = "EXTRACT_DATE_0005XX";
            ...
            internal const string MAX_PERCENT_0005AS = "MAX_PERCENT_0005AS";
            internal const string MAX_PERCENT_0005 = "MAX_PERCENT_0005";
            internal const string MAX_PERCENT_0005XX = "MAX_PERCENT_0005XX";
            ...
            internal const string S1380195550_0007EV = "S1380195550_0007EV";
            ...
            internal const string NUMERIC_RETURN_CODE_0007AS = "NUMERIC_RETURN_CODE_0007AS";
            internal const string NUMERIC_RETURN_CODE_0007 = "NUMERIC_RETURN_CODE_0007";
            internal const string NUMERIC_RETURN_CODE_0007XX = "NUMERIC_RETURN_CODE_0007XX";
            internal const string TEXT_RETURN_CODE_0007AS = "TEXT_RETURN_CODE_0007AS";
            internal const string TEXT_RETURN_CODE_0007 = "TEXT_RETURN_CODE_0007";
            internal const string TEXT_RETURN_CODE_0007XX = "TEXT_RETURN_CODE_0007XX";
            internal const string TEXT_LINE_80_0007AS = "TEXT_LINE_80_0007AS";
            internal const string TEXT_LINE_80_0007 = "TEXT_LINE_80_0007";
            internal const string TEXT_LINE_80_0007XX = "TEXT_LINE_80_0007XX";
        }
        #endregion
        ...
        public IGroup IMPORT_TOTAL_AMOUNT_0001EV { get { return GetElementByName<IGroup>(Names.IMPORT_TOTAL_AMOUNT_0001EV); } }
        ...
        public IGroup IMPORT_TOTAL_COUNT_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_TOTAL_COUNT_0002EV); } }
        ...
        public IGroup IMPORT_REC_TYPE_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_REC_TYPE_0004EV); } }
        ...
        public IGroup KDOL_FILE_0005ET { get { return GetElementByName<IGroup>(Names.KDOL_FILE_0005ET); } }
        ...
        public IField CLIENT_NUMBER_0005AS { get { return GetElementByName<IField>(Names.CLIENT_NUMBER_0005AS); } }
        public IField CLIENT_NUMBER_0005 { get { return GetElementByName<IField>(Names.CLIENT_NUMBER_0005); } }
        public IField CLIENT_NUMBER_0005XX { get { return GetElementByName<IField>(Names.CLIENT_NUMBER_0005XX); } }
        public IField EXTRACT_DATE_0005AS { get { return GetElementByName<IField>(Names.EXTRACT_DATE_0005AS); } }
        public IField EXTRACT_DATE_0005 { get { return GetElementByName<IField>(Names.EXTRACT_DATE_0005); } }
        public IField EXTRACT_DATE_0005XX { get { return GetElementByName<IField>(Names.EXTRACT_DATE_0005XX); } }
        ...
        public IField MAX_PERCENT_0005AS { get { return GetElementByName<IField>(Names.MAX_PERCENT_0005AS); } }
        public IField MAX_PERCENT_0005 { get { return GetElementByName<IField>(Names.MAX_PERCENT_0005); } }
        public IField MAX_PERCENT_0005XX { get { return GetElementByName<IField>(Names.MAX_PERCENT_0005XX); } }
        ...
        public IGroup S1380195550_0007EV { get { return GetElementByName<IGroup>(Names.S1380195550_0007EV); } }
        ...
        public IField NUMERIC_RETURN_CODE_0007AS { get { return GetElementByName<IField>(Names.NUMERIC_RETURN_CODE_0007AS); } }
        public IField NUMERIC_RETURN_CODE_0007 { get { return GetElementByName<IField>(Names.NUMERIC_RETURN_CODE_0007); } }
        public IField NUMERIC_RETURN_CODE_0007XX { get { return GetElementByName<IField>(Names.NUMERIC_RETURN_CODE_0007XX); } }
        public IField TEXT_RETURN_CODE_0007AS { get { return GetElementByName<IField>(Names.TEXT_RETURN_CODE_0007AS); } }
        public IField TEXT_RETURN_CODE_0007 { get { return GetElementByName<IField>(Names.TEXT_RETURN_CODE_0007); } }
        public IField TEXT_RETURN_CODE_0007XX { get { return GetElementByName<IField>(Names.TEXT_RETURN_CODE_0007XX); } }
        public IField TEXT_LINE_80_0007AS { get { return GetElementByName<IField>(Names.TEXT_LINE_80_0007AS); } }
        public IField TEXT_LINE_80_0007 { get { return GetElementByName<IField>(Names.TEXT_LINE_80_0007); } }
        public IField TEXT_LINE_80_0007XX { get { return GetElementByName<IField>(Names.TEXT_LINE_80_0007XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_TOTAL_AMOUNT_0001EV, (IMPORT_TOTAL_AMOUNT_0001EV) =>
           {
               IMPORT_TOTAL_AMOUNT_0001EV.CreateNewGroup(Names.IEF_SUPPLIED_0001ET, (IEF_SUPPLIED_0001ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_TOTAL_COUNT_0002EV, (IMPORT_TOTAL_COUNT_0002EV) =>
           {
               IMPORT_TOTAL_COUNT_0002EV.CreateNewGroup(Names.IEF_SUPPLIED_0002ET, (IEF_SUPPLIED_0002ET) =>
               {
           ...
           {
               IMPORT_0003EV.CreateNewGroup(Names.DATE_WORK_AREA_0003ET, (DATE_WORK_AREA_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_REC_TYPE_0004EV, (IMPORT_REC_TYPE_0004EV) =>
           {
               IMPORT_REC_TYPE_0004EV.CreateNewGroup(Names.TEXT_WORK_AREA_0004ET, (TEXT_WORK_AREA_0004ET) =>
               {
           ...
           {
               IMPORT_0005EV.CreateNewGroup(Names.KDOL_FILE_0005ET, (KDOL_FILE_0005ET) =>
               {
                   KDOL_FILE_0005ET.CreateNewField(Names.SSN_0005AS, FieldType.String, 1);

                   IField SSN_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.SSN_0005, FieldType.String, 9);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.SSN_0005XX, FieldType.String, SSN_0005_local, 9);
                   KDOL_FILE_0005ET.CreateNewField(Names.FIRST_NAME_0005AS, FieldType.String, 1);

                   IField FIRST_NAME_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.FIRST_NAME_0005, FieldType.String, 12);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.FIRST_NAME_0005XX, FieldType.String, FIRST_NAME_0005_local, 12);
                   KDOL_FILE_0005ET.CreateNewField(Names.MIDDLE_INITIAL_0005AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.MIDDLE_INITIAL_0005, FieldType.String, 1);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0005XX, FieldType.String, MIDDLE_INITIAL_0005_local, 1);
                   KDOL_FILE_0005ET.CreateNewField(Names.LAST_NAME_0005AS, FieldType.String, 1);

                   IField LAST_NAME_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.LAST_NAME_0005, FieldType.String, 25);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.LAST_NAME_0005XX, FieldType.String, LAST_NAME_0005_local, 25);
                   KDOL_FILE_0005ET.CreateNewField(Names.CLIENT_NUMBER_0005AS, FieldType.String, 1);

                   IField CLIENT_NUMBER_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.CLIENT_NUMBER_0005, FieldType.String, 14);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.CLIENT_NUMBER_0005XX, FieldType.String, CLIENT_NUMBER_0005_local, 14);
                   KDOL_FILE_0005ET.CreateNewField(Names.EXTRACT_DATE_0005AS, FieldType.String, 1);

                   IField EXTRACT_DATE_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.EXTRACT_DATE_0005, FieldType.String, 8);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.EXTRACT_DATE_0005XX, FieldType.String, EXTRACT_DATE_0005_local, 8);
                   KDOL_FILE_0005ET.CreateNewField(Names.AMOUNT_0005AS, FieldType.String, 1);

                   IField AMOUNT_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.AMOUNT_0005, FieldType.SignedNumeric, 8, null, 2);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.AMOUNT_0005XX, FieldType.String, AMOUNT_0005_local, 8);
                   KDOL_FILE_0005ET.CreateNewField(Names.MAX_PERCENT_0005AS, FieldType.String, 1);

                   IField MAX_PERCENT_0005_local = KDOL_FILE_0005ET.CreateNewField(Names.MAX_PERCENT_0005, FieldType.String, 3);
                   KDOL_FILE_0005ET.CreateNewFieldRedefine(Names.MAX_PERCENT_0005XX, FieldType.String, MAX_PERCENT_0005_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0006EV, (IMPORT_0006EV) =>
           {
               IMPORT_0006EV.CreateNewGroup(Names.EXTERNAL_0006ET, (EXTERNAL_0006ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.S1380195550_0007EV, (S1380195550_0007EV) =>
           {
               S1380195550_0007EV.CreateNewGroup(Names.EXTERNAL_0007ET, (EXTERNAL_0007ET) =>
               {
                   ...
                   EXTERNAL_0007ET.CreateNewField(Names.NUMERIC_RETURN_CODE_0007AS, FieldType.String, 1);

                   IField NUMERIC_RETURN_CODE_0007_local = EXTERNAL_0007ET.CreateNewField(Names.NUMERIC_RETURN_CODE_0007, FieldType.SignedNumeric, 2);
                   EXTERNAL_0007ET.CreateNewFieldRedefine(Names.NUMERIC_RETURN_CODE_0007XX, FieldType.String, NUMERIC_RETURN_CODE_0007_local, 2);
                   EXTERNAL_0007ET.CreateNewField(Names.TEXT_RETURN_CODE_0007AS, FieldType.String, 1);

                   IField TEXT_RETURN_CODE_0007_local = EXTERNAL_0007ET.CreateNewField(Names.TEXT_RETURN_CODE_0007, FieldType.String, 2);
                   EXTERNAL_0007ET.CreateNewFieldRedefine(Names.TEXT_RETURN_CODE_0007XX, FieldType.String, TEXT_RETURN_CODE_0007_local, 2);
                   EXTERNAL_0007ET.CreateNewField(Names.TEXT_LINE_80_0007AS, FieldType.String, 1);

                   IField TEXT_LINE_80_0007_local = EXTERNAL_0007ET.CreateNewField(Names.TEXT_LINE_80_0007, FieldType.String, 130);
                   EXTERNAL_0007ET.CreateNewFieldRedefine(Names.TEXT_LINE_80_0007XX, FieldType.String, TEXT_LINE_80_0007_local, 130);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_TOTAL_AMOUNT_0001EV, args, 3);
            SetPassedParm(IMPORT_TOTAL_COUNT_0002EV, args, 4);
            SetPassedParm(IMPORT_0003EV, args, 5);
            SetPassedParm(IMPORT_REC_TYPE_0004EV, args, 6);
            SetPassedParm(IMPORT_0005EV, args, 7);
            SetPassedParm(IMPORT_0006EV, args, 8);
            SetPassedParm(S1380195550_0007EV, args, 9);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_TOTAL_AMOUNT_0001EV, args, 3);
            SetReturnParm(IMPORT_TOTAL_COUNT_0002EV, args, 4);
            SetReturnParm(IMPORT_0003EV, args, 5);
            SetReturnParm(IMPORT_REC_TYPE_0004EV, args, 6);
            SetReturnParm(IMPORT_0005EV, args, 7);
            SetReturnParm(IMPORT_0006EV, args, 8);
            SetReturnParm(S1380195550_0007EV, args, 9);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXLW03 : BatchBase
    {
        ...
        public SWEXLW03()
            : base()
        {
            this.ProgramName.SetValue("SWEXLW03");

            WS = new SWEXLW03_ws();
            FD = new SWEXLW03_fd(WS);
            LS = new SWEXLW03_ls();
        }
        ...
        private SWEXLW03_ws WS;

        //==== File Data Class ========================================
        private SWEXLW03_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLW03_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-TOTAL-AMOUNT-0001EV , IMPORT-TOTAL-COUNT-0002EV , IMPORT-0003EV , IMPORT-REC-TYPE-0004EV , IMPORT-0005EV , IMPORT-0006EV , S1380195550-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1380195538(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1380195538
        /// </summary>
        private void M_MAIN_1380195538(string returnMethod = "")
        {
            M_PARA_1380195538_INIT("M_PARA_1380195538_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1380195538-INIT THRU PARA-1380195538-INIT-EXIT
            M_PARA_1380195538("M_PARA_1380195538_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1380195538 THRU PARA-1380195538-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1380195538
        /// </summary>
        private void M_PARA_1380195538(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1380195538") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: *******************
            LS.TEXT_RETURN_CODE_0007.SetValue("OK");                                                            //COBOL==> MOVE 'OK' TO TEXT-RETURN-CODE-0007.
                                                                                                                // EvaluateList !LS.FILE_INSTRUCTION_0006!                                                          //COBOL==> EVALUATE FILE-INSTRUCTION-0006
            if ((LS.FILE_INSTRUCTION_0006.IsEqualTo("OPEN")))                                                   //COBOL==> WHEN 'OPEN'
            {
                M_1000_OPEN_FILE(); if (Control.ExitProgram) { return; }                                              //COBOL==> PERFORM 1000-OPEN-FILE
            }                                                                                                //COBOL==> WHEN 'WRITE'
            else
            if ((LS.FILE_INSTRUCTION_0006.IsEqualTo("WRITE")))
            {
                M_2000_WRITE_FILE(); if (Control.ExitProgram) { return; }                                             //COBOL==> PERFORM 2000-WRITE-FILE
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
            if ((LS.FILE_INSTRUCTION_0006.IsEqualTo("CLOSE")))
            {
                M_3000_CLOSE_FILE(); if (Control.ExitProgram) { return; }                                             //COBOL==> PERFORM 3000-CLOSE-FILE
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("BI");                                                            //COBOL==> MOVE 'BI' TO TEXT-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-EVALUATE.
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("PE");                                                            //COBOL==> MOVE 'PE' TO TEXT-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: *******************
            WS.DOL_OUTPUT_REC.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO DOL-OUTPUT-REC.
                                                                                                                // EvaluateList !LS.TEXT_1_0004!                                                                    //COBOL==> EVALUATE TEXT-1-0004
            if ((LS.TEXT_1_0004.IsEqualTo("1")))                                                                //COBOL==> WHEN '1'
            {
                WS.REC1_TYPE.SetValue(LS.TEXT_1_0004);                                                              //COBOL==> MOVE TEXT-1-0004 TO REC1-TYPE
                WS.REC1_FILE_DATE.SetValue(LS.TEXT_DATE_0003);                                                      //COBOL==> MOVE TEXT-DATE-0003 TO REC1-FILE-DATE
            }                                                                                                //COBOL==> WHEN '2'
            else
            if ((LS.TEXT_1_0004.IsEqualTo("2")))
            {
                WS.REC2_TYPE.SetValue(LS.TEXT_1_0004);                                                              //COBOL==> MOVE TEXT-1-0004 TO REC2-TYPE
                ...
                WS.REC2_CLIENT.SetValue(LS.CLIENT_NUMBER_0005);                                                     //COBOL==> MOVE CLIENT-NUMBER-0005 TO REC2-CLIENT
                WS.REC2_FILE_DATE.SetValue(LS.EXTRACT_DATE_0005);                                                   //COBOL==> MOVE EXTRACT-DATE-0005 TO REC2-FILE-DATE
                WS.REC2_AMOUNT.SetValue(LS.AMOUNT_0005);                                                            //COBOL==> MOVE AMOUNT-0005 TO REC2-AMOUNT
                WS.REC2_MAX_PERCENT.SetValue(LS.MAX_PERCENT_0005);                                                  //COBOL==> MOVE MAX-PERCENT-0005 TO REC2-MAX-PERCENT
            }                                                                                                //COBOL==> WHEN '3'
            else
            if ((LS.TEXT_1_0004.IsEqualTo("3")))
            {
                WS.REC3_TYPE.SetValue(LS.TEXT_1_0004);                                                              //COBOL==> MOVE TEXT-1-0004 TO REC3-TYPE
                WS.REC3_COUNT.SetValue(LS.COUNT_0002);                                                              //COBOL==> MOVE COUNT-0002 TO REC3-COUNT
                WS.REC3_AMOUNT.SetValue(LS.TOTAL_CURRENCY_0001);                                                    //COBOL==> MOVE TOTAL-CURRENCY-0001 TO REC3-AMOUNT
            }                                                                                                   //COBOL==> END-EVALUATE.
            FD.OUTPUT_RECORD.SetValue(WS.DOL_OUTPUT_REC);                                                       //COBOL==> MOVE DOL-OUTPUT-REC TO OUTPUT-RECORD.
            ...
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("BW");                                                            //COBOL==> MOVE 'BW' TO TEXT-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1380195538_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1380195538_EXIT
        /// </summary>
        private void M_PARA_1380195538_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1380195538_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1380195538_EXIT") { M_PARA_1380195538_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1380195538_INIT
        /// </summary>
        private void M_PARA_1380195538_INIT(string returnMethod = "")
        {
            LS.S1380195550_0007EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE S1380195550-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1380195538_INIT") { M_PARA_1380195538_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1380195538_INIT_EXIT
        /// </summary>
        private void M_PARA_1380195538_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1380195538_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
