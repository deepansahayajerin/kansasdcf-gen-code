...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:46:16 PM
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    public class SWEXPL06 : BatchBase
    {
        ...
        private void M_B000_INIT_FIELDS(string returnMethod = "")
        {
            ...
            if ((LS.TEXT_30_0002XX.IsMaxValue())
             || (LS.TEXT_30_0002XX.IsMinValue()))           //COBOL==> IF TEXT-30-0002XX = HIGH-VALUES OR TEXT-30-0002XX = LOW-VALUES
            {
                LS.TEXT_30_0002.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO TEXT-30-0002
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.NAME_0003XX.IsMaxValue())
             || (LS.NAME_0003XX.IsMinValue()))                 //COBOL==> IF NAME-0003XX = HIGH-VALUES OR NAME-0003XX = LOW-VALUES
            {
                LS.NAME_0003.SetValueWithSpaces();                                                                  //COBOL==> MOVE SPACES TO NAME-0003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.STREET_1_0004XX.IsMaxValue())
             || (LS.STREET_1_0004XX.IsMinValue()))         //COBOL==> IF STREET-1-0004XX = HIGH-VALUES OR STREET-1-0004XX = LOW-VALUES
            {
                LS.STREET_1_0004.SetValueWithSpaces();                                                              //COBOL==> MOVE SPACES TO STREET-1-0004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.STREET_2_0004XX.IsMaxValue())
             || (LS.STREET_2_0004XX.IsMinValue()))         //COBOL==> IF STREET-2-0004XX = HIGH-VALUES OR STREET-2-0004XX = LOW-VALUES
            {
                LS.STREET_2_0004.SetValueWithSpaces();                                                              //COBOL==> MOVE SPACES TO STREET-2-0004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.TEXT_30_0005XX.IsMaxValue())
             || (LS.TEXT_30_0005XX.IsMinValue()))           //COBOL==> IF TEXT-30-0005XX = HIGH-VALUES OR TEXT-30-0005XX = LOW-VALUES
            {
            ...
            if ((LS.ROLE_CODE_0009XX.IsMaxValue())
             || (LS.ROLE_CODE_0009XX.IsMinValue()))       //COBOL==> IF ROLE-CODE-0009XX = HIGH-VALUES OR ROLE-CODE-0009XX = LOW-VALUES
            {
                LS.ROLE_CODE_0009.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO ROLE-CODE-0009
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.CODE_0010XX.IsMaxValue())
             || (LS.CODE_0010XX.IsMinValue()))                 //COBOL==> IF CODE-0010XX = HIGH-VALUES OR CODE-0010XX = LOW-VALUES
            {
                LS.CODE_0010.SetValueWithSpaces();                                                                  //COBOL==> MOVE SPACES TO CODE-0010
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.TEXT_4_0011XX.IsMaxValue())
             || (LS.TEXT_4_0011XX.IsMinValue()))             //COBOL==> IF TEXT-4-0011XX = HIGH-VALUES OR TEXT-4-0011XX = LOW-VALUES
            {
                LS.TEXT_4_0011.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO TEXT-4-0011
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.ENDING_ALPHA_0012XX.IsMaxValue())
             || (LS.ENDING_ALPHA_0012XX.IsMinValue())) //COBOL==> IF ENDING-ALPHA-0012XX = HIGH-VALUES OR ENDING-ALPHA-0012XX = LOW-VALUES
            {
                LS.ENDING_ALPHA_0012.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO ENDING-ALPHA-0012
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.BEGINING_ALPHA_0012XX.IsMaxValue())
             || (LS.BEGINING_ALPHA_0012XX.IsMinValue()))  //COBOL==> IF BEGINING-ALPHA-0012XX = HIGH-VALUES OR BEGINING-ALPHA-0012XX = LOW-VALUES
            {
                LS.BEGINING_ALPHA_0012.SetValueWithSpaces();                                                        //COBOL==> MOVE SPACES TO BEGINING-ALPHA-0012
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.FUNCTION_0012XX.IsMaxValue())
             || (LS.FUNCTION_0012XX.IsMinValue()))         //COBOL==> IF FUNCTION-0012XX = HIGH-VALUES OR FUNCTION-0012XX = LOW-VALUES
            {
