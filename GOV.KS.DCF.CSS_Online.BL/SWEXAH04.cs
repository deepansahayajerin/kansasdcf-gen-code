...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:26:34 PM
   **        *   FROM COBOL PGM   :  SWEXAH04
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_WRITE_ICR_EXTRACT            DATE: 2004/06/02
       TARGET OS:   MVS                       TIME: 15:06:00
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXAH04_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXAH04_fd_FileSection";
            internal const string OUTPUT_FILE = "OUTPUT_FILE";
            internal const string OUTPUT_RECORD = "OUTPUT_RECORD";
            internal const string KS_CASE_NUMBER = "KS_CASE_NUMBER";
            internal const string FILLER_NUMBER = "FILLER_NUMBER";
            internal const string KS_CASE_IND = "KS_CASE_IND";
            internal const string KS_FIPS = "KS_FIPS";
            internal const string PERSON_SSN = "PERSON_SSN";
            internal const string PERSON_NUMBER = "PERSON_NUMBER";
            internal const string CASE_ROLE_TYPE = "CASE_ROLE_TYPE";
            internal const string CASE_STATUS = "CASE_STATUS";
            ...
            internal const string PERSON_SEX = "PERSON_SEX";
            internal const string OS_CASE_NUMBER = "OS_CASE_NUMBER";
            internal const string OS_FIPS_CODE = "OS_FIPS_CODE";
            internal const string WORKER_NAME_LAST = "WORKER_NAME_LAST";
            internal const string WORKER_NAME_FIRST = "WORKER_NAME_FIRST";
            internal const string WORKER_AREA_CODE = "WORKER_AREA_CODE";
            internal const string WORKER_PHONE = "WORKER_PHONE";
            internal const string MAIN_EMAIL = "MAIN_EMAIL";
        }
        #endregion
        ...
        public IField KS_CASE_NUMBER { get { return GetElementByName<IField>(Names.KS_CASE_NUMBER); } }
        public IField FILLER_NUMBER { get { return GetElementByName<IField>(Names.FILLER_NUMBER); } }
        public IField KS_CASE_IND { get { return GetElementByName<IField>(Names.KS_CASE_IND); } }
        public IField KS_FIPS { get { return GetElementByName<IField>(Names.KS_FIPS); } }
        public IField PERSON_SSN { get { return GetElementByName<IField>(Names.PERSON_SSN); } }
        public IField PERSON_NUMBER { get { return GetElementByName<IField>(Names.PERSON_NUMBER); } }
        public IField CASE_ROLE_TYPE { get { return GetElementByName<IField>(Names.CASE_ROLE_TYPE); } }
        public IField CASE_STATUS { get { return GetElementByName<IField>(Names.CASE_STATUS); } }
        ...
        public IField DATE_OF_BIRTH { get { return GetElementByName<IField>(Names.DATE_OF_BIRTH); } }
        public IField PERSON_SEX { get { return GetElementByName<IField>(Names.PERSON_SEX); } }
        public IField OS_CASE_NUMBER { get { return GetElementByName<IField>(Names.OS_CASE_NUMBER); } }
        public IField OS_FIPS_CODE { get { return GetElementByName<IField>(Names.OS_FIPS_CODE); } }
        public IField WORKER_NAME_LAST { get { return GetElementByName<IField>(Names.WORKER_NAME_LAST); } }
        public IField WORKER_NAME_FIRST { get { return GetElementByName<IField>(Names.WORKER_NAME_FIRST); } }
        public IField WORKER_AREA_CODE { get { return GetElementByName<IField>(Names.WORKER_AREA_CODE); } }
        public IField WORKER_PHONE { get { return GetElementByName<IField>(Names.WORKER_PHONE); } }
        public IField MAIN_EMAIL { get { return GetElementByName<IField>(Names.MAIN_EMAIL); } }


        internal SWEXAH04_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               OUTPUT_RECORD.CreateNewField(Names.KS_CASE_NUMBER, FieldType.String, 10);
               OUTPUT_RECORD.CreateNewField(Names.FILLER_NUMBER, FieldType.String, 5, "     ");
               OUTPUT_RECORD.CreateNewField(Names.KS_CASE_IND, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.KS_FIPS, FieldType.String, 7);
               OUTPUT_RECORD.CreateNewField(Names.PERSON_SSN, FieldType.String, 9);
               OUTPUT_RECORD.CreateNewField(Names.PERSON_NUMBER, FieldType.String, 10);
               OUTPUT_RECORD.CreateNewFillerField(FieldType.String, 5, SPACES);
               OUTPUT_RECORD.CreateNewField(Names.CASE_ROLE_TYPE, FieldType.String, 2);
               OUTPUT_RECORD.CreateNewField(Names.CASE_STATUS, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.LAST_NAME, FieldType.String, 30);
               OUTPUT_RECORD.CreateNewField(Names.FIRST_NAME, FieldType.String, 16);
               OUTPUT_RECORD.CreateNewField(Names.MIDDLE_NAME, FieldType.String, 16);
               OUTPUT_RECORD.CreateNewField(Names.DATE_OF_BIRTH, FieldType.String, 8);
               OUTPUT_RECORD.CreateNewField(Names.PERSON_SEX, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.OS_CASE_NUMBER, FieldType.String, 15);
               OUTPUT_RECORD.CreateNewFillerField(1, FillWith.Hashes);
               OUTPUT_RECORD.CreateNewField(Names.OS_FIPS_CODE, FieldType.String, 2);
               OUTPUT_RECORD.CreateNewFillerField(FieldType.String, 5, SPACES);
               OUTPUT_RECORD.CreateNewFillerField(17, FillWith.Hashes);
               OUTPUT_RECORD.CreateNewField(Names.WORKER_NAME_LAST, FieldType.String, 20);
               OUTPUT_RECORD.CreateNewField(Names.WORKER_NAME_FIRST, FieldType.String, 20);
               OUTPUT_RECORD.CreateNewField(Names.WORKER_AREA_CODE, FieldType.String, 3);
               OUTPUT_RECORD.CreateNewField(Names.WORKER_PHONE, FieldType.String, 7);
               OUTPUT_RECORD.CreateNewField(Names.MAIN_EMAIL, FieldType.String, 30);
               OUTPUT_RECORD.CreateNewFillerField(309, FillWith.Hashes);
           });
        ...
        #region Constructors
        public SWEXAH04_fd(SWEXAH04_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXAH04_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXAH04_ws_WorkingStorage";
    ...
    internal class SWEXAH04_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXAH04_ls_LinkageSection";
            ...
            internal const string INTERSTATE_REQUEST_0002ET = "INTERSTATE_REQUEST_0002ET";
            internal const string KS_CASE_IND_0002AS = "KS_CASE_IND_0002AS";
            internal const string KS_CASE_IND_0002 = "KS_CASE_IND_0002";
            internal const string KS_CASE_IND_0002XX = "KS_CASE_IND_0002XX";
            internal const string OTHER_STATE_CASE_ID_0002AS = "OTHER_STATE_CASE_ID_0002AS";
            internal const string OTHER_STATE_CASE_ID_0002 = "OTHER_STATE_CASE_ID_0002";
            internal const string OTHER_STATE_CASE_ID_0002XX = "OTHER_STATE_CASE_ID_0002XX";
            internal const string OTHER_STATE_CASE_STATUS_0003AS = "OTHER_STATE_CASE_STATUS_0003AS";
            internal const string OTHER_STATE_CASE_STATUS_0003 = "OTHER_STATE_CASE_STATUS_0003";
            internal const string OTHER_STATE_CASE_STATUS_0003XX = "OTHER_STATE_CASE_STATUS_0003XX";
            internal const string OTHER_STATE_FIPS_0003AS = "OTHER_STATE_FIPS_0003AS";
            internal const string OTHER_STATE_FIPS_0003 = "OTHER_STATE_FIPS_0003";
            internal const string OTHER_STATE_FIPS_0003XX = "OTHER_STATE_FIPS_0003XX";
            ...
            internal const string CASE_ROLE_0005ET = "CASE_ROLE_0005ET";
            ...
            internal const string OFFICE_SERVICE_PROVIDER_0008ET = "OFFICE_SERVICE_PROVIDER_0008ET";
            internal const string WORK_PHONE_NUMBER_0008AS = "WORK_PHONE_NUMBER_0008AS";
            internal const string WORK_PHONE_NUMBER_0008 = "WORK_PHONE_NUMBER_0008";
            internal const string WORK_PHONE_NUMBER_0008XX = "WORK_PHONE_NUMBER_0008XX";
            internal const string WORK_PHONE_AREA_CODE_0008AS = "WORK_PHONE_AREA_CODE_0008AS";
            internal const string WORK_PHONE_AREA_CODE_0008 = "WORK_PHONE_AREA_CODE_0008";
            internal const string WORK_PHONE_AREA_CODE_0008XX = "WORK_PHONE_AREA_CODE_0008XX";
        ...
        public IGroup INTERSTATE_REQUEST_0002ET { get { return GetElementByName<IGroup>(Names.INTERSTATE_REQUEST_0002ET); } }
        public IField KS_CASE_IND_0002AS { get { return GetElementByName<IField>(Names.KS_CASE_IND_0002AS); } }
        public IField KS_CASE_IND_0002 { get { return GetElementByName<IField>(Names.KS_CASE_IND_0002); } }
        public IField KS_CASE_IND_0002XX { get { return GetElementByName<IField>(Names.KS_CASE_IND_0002XX); } }
        public IField OTHER_STATE_CASE_ID_0002AS { get { return GetElementByName<IField>(Names.OTHER_STATE_CASE_ID_0002AS); } }
        public IField OTHER_STATE_CASE_ID_0002 { get { return GetElementByName<IField>(Names.OTHER_STATE_CASE_ID_0002); } }
        public IField OTHER_STATE_CASE_ID_0002XX { get { return GetElementByName<IField>(Names.OTHER_STATE_CASE_ID_0002XX); } }
        public IField OTHER_STATE_CASE_STATUS_0003AS { get { return GetElementByName<IField>(Names.OTHER_STATE_CASE_STATUS_0003AS); } }
        public IField OTHER_STATE_CASE_STATUS_0003 { get { return GetElementByName<IField>(Names.OTHER_STATE_CASE_STATUS_0003); } }
        public IField OTHER_STATE_CASE_STATUS_0003XX { get { return GetElementByName<IField>(Names.OTHER_STATE_CASE_STATUS_0003XX); } }
        public IField OTHER_STATE_FIPS_0003AS { get { return GetElementByName<IField>(Names.OTHER_STATE_FIPS_0003AS); } }
        public IField OTHER_STATE_FIPS_0003 { get { return GetElementByName<IField>(Names.OTHER_STATE_FIPS_0003); } }
        public IField OTHER_STATE_FIPS_0003XX { get { return GetElementByName<IField>(Names.OTHER_STATE_FIPS_0003XX); } }
        ...
        public IGroup CASE_ROLE_0005ET { get { return GetElementByName<IGroup>(Names.CASE_ROLE_0005ET); } }
        ...
        public IGroup OFFICE_SERVICE_PROVIDER_0008ET { get { return GetElementByName<IGroup>(Names.OFFICE_SERVICE_PROVIDER_0008ET); } }
        public IField WORK_PHONE_NUMBER_0008AS { get { return GetElementByName<IField>(Names.WORK_PHONE_NUMBER_0008AS); } }
        public IField WORK_PHONE_NUMBER_0008 { get { return GetElementByName<IField>(Names.WORK_PHONE_NUMBER_0008); } }
        public IField WORK_PHONE_NUMBER_0008XX { get { return GetElementByName<IField>(Names.WORK_PHONE_NUMBER_0008XX); } }
        public IField WORK_PHONE_AREA_CODE_0008AS { get { return GetElementByName<IField>(Names.WORK_PHONE_AREA_CODE_0008AS); } }
        public IField WORK_PHONE_AREA_CODE_0008 { get { return GetElementByName<IField>(Names.WORK_PHONE_AREA_CODE_0008); } }
        public IField WORK_PHONE_AREA_CODE_0008XX { get { return GetElementByName<IField>(Names.WORK_PHONE_AREA_CODE_0008XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.INTERSTATE_REQUEST_0002ET, (INTERSTATE_REQUEST_0002ET) =>
               {
                   INTERSTATE_REQUEST_0002ET.CreateNewField(Names.KS_CASE_IND_0002AS, FieldType.String, 1);

                   IField KS_CASE_IND_0002_local = INTERSTATE_REQUEST_0002ET.CreateNewField(Names.KS_CASE_IND_0002, FieldType.String, 1);
                   INTERSTATE_REQUEST_0002ET.CreateNewFieldRedefine(Names.KS_CASE_IND_0002XX, FieldType.String, KS_CASE_IND_0002_local, 1);
                   INTERSTATE_REQUEST_0002ET.CreateNewField(Names.OTHER_STATE_CASE_ID_0002AS, FieldType.String, 1);

                   IField OTHER_STATE_CASE_ID_0002_local = INTERSTATE_REQUEST_0002ET.CreateNewField(Names.OTHER_STATE_CASE_ID_0002, FieldType.String, 15);
                   INTERSTATE_REQUEST_0002ET.CreateNewFieldRedefine(Names.OTHER_STATE_CASE_ID_0002XX, FieldType.String, OTHER_STATE_CASE_ID_0002_local, 15);
                   INTERSTATE_REQUEST_0002ET.CreateNewField(Names.OTHER_STATE_CASE_STATUS_0003AS, FieldType.String, 1);

                   IField OTHER_STATE_CASE_STATUS_0003_local = INTERSTATE_REQUEST_0002ET.CreateNewField(Names.OTHER_STATE_CASE_STATUS_0003, FieldType.String, 1);
                   INTERSTATE_REQUEST_0002ET.CreateNewFieldRedefine(Names.OTHER_STATE_CASE_STATUS_0003XX, FieldType.String, OTHER_STATE_CASE_STATUS_0003_local, 1);
                   INTERSTATE_REQUEST_0002ET.CreateNewField(Names.OTHER_STATE_FIPS_0003AS, FieldType.String, 1);

                   IField OTHER_STATE_FIPS_0003_local = INTERSTATE_REQUEST_0002ET.CreateNewField(Names.OTHER_STATE_FIPS_0003, FieldType.SignedNumeric, 2);
                   INTERSTATE_REQUEST_0002ET.CreateNewFieldRedefine(Names.OTHER_STATE_FIPS_0003XX, FieldType.String, OTHER_STATE_FIPS_0003_local, 2);
               });
           });
           ...
           {
               IMPORT_0005EV.CreateNewGroup(Names.CASE_ROLE_0005ET, (CASE_ROLE_0005ET) =>
               {
                   CASE_ROLE_0005ET.CreateNewField(Names.TYPE_0005AS, FieldType.String, 1);

                   IField TYPE_0005_local = CASE_ROLE_0005ET.CreateNewField(Names.TYPE_0005, FieldType.String, 2);
                   CASE_ROLE_0005ET.CreateNewFieldRedefine(Names.TYPE_0005XX, FieldType.String, TYPE_0005_local, 2);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0006EV, (IMPORT_0006EV) =>
           {
               IMPORT_0006EV.CreateNewGroup(Names.CSE_PERSON_0006ET, (CSE_PERSON_0006ET) =>
               {
           ...
           {
               IMPORT_0008EV.CreateNewGroup(Names.OFFICE_SERVICE_PROVIDER_0008ET, (OFFICE_SERVICE_PROVIDER_0008ET) =>
               {
                   OFFICE_SERVICE_PROVIDER_0008ET.CreateNewField(Names.WORK_PHONE_NUMBER_0008AS, FieldType.String, 1);

                   IField WORK_PHONE_NUMBER_0008_local = OFFICE_SERVICE_PROVIDER_0008ET.CreateNewField(Names.WORK_PHONE_NUMBER_0008, FieldType.SignedNumeric, 7);
                   OFFICE_SERVICE_PROVIDER_0008ET.CreateNewFieldRedefine(Names.WORK_PHONE_NUMBER_0008XX, FieldType.String, WORK_PHONE_NUMBER_0008_local, 7);
                   OFFICE_SERVICE_PROVIDER_0008ET.CreateNewField(Names.WORK_PHONE_AREA_CODE_0008AS, FieldType.String, 1);

                   IField WORK_PHONE_AREA_CODE_0008_local = OFFICE_SERVICE_PROVIDER_0008ET.CreateNewField(Names.WORK_PHONE_AREA_CODE_0008, FieldType.SignedNumeric, 3);
                   OFFICE_SERVICE_PROVIDER_0008ET.CreateNewFieldRedefine(Names.WORK_PHONE_AREA_CODE_0008XX, FieldType.String, WORK_PHONE_AREA_CODE_0008_local, 3);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_0005EV, args, 6);
            SetPassedParm(IMPORT_0006EV, args, 7);
            SetPassedParm(IMPORT_0007EV, args, 8);
            SetPassedParm(IMPORT_0008EV, args, 9);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_0005EV, args, 6);
            SetReturnParm(IMPORT_0006EV, args, 7);
            SetReturnParm(IMPORT_0007EV, args, 8);
            SetReturnParm(IMPORT_0008EV, args, 9);
    ...
    public class SWEXAH04 : BatchBase
    {
        ...
        public SWEXAH04()
            : base()
        {
            this.ProgramName.SetValue("SWEXAH04");

            WS = new SWEXAH04_ws();
            FD = new SWEXAH04_fd(WS);
            LS = new SWEXAH04_ls();
        }
        ...
        private SWEXAH04_ws WS;

        //==== File Data Class ========================================
        private SWEXAH04_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXAH04_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0004EV , IMPORT-0005EV , IMPORT-0006EV , IMPORT-0007EV , IMPORT-0008EV , IMPORT-0009EV , EXPORT-0010EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0436996214(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0436996214
        /// </summary>
        private void M_MAIN_0436996214(string returnMethod = "")
        {
            M_PARA_0436996214_INIT("M_PARA_0436996214_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0436996214-INIT THRU PARA-0436996214-INIT-EXIT
            M_PARA_0436996214("M_PARA_0436996214_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0436996214 THRU PARA-0436996214-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0436996214
        /// </summary>
        private void M_PARA_0436996214(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0436996214") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0010.SetValue("BI");                                                                      //COBOL==> MOVE 'BI' TO STATUS-0010
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0010.SetValue("PE");                                                                      //COBOL==> MOVE 'PE' TO STATUS-0010
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: ******************
            FD.OUTPUT_RECORD.SetValueWithSpaces();                                                              //COBOL==> MOVE SPACES TO OUTPUT-RECORD.
            FD.KS_CASE_NUMBER.SetValue(LS.NUMBER_0001);                                                         //COBOL==> MOVE NUMBER-0001 TO KS-CASE-NUMBER
            FD.KS_CASE_IND.SetValue(LS.KS_CASE_IND_0002);                                                       //COBOL==> MOVE KS-CASE-IND-0002 TO KS-CASE-IND
            FD.KS_FIPS.SetValue("2000000");                                                                     //COBOL==> MOVE '2000000' TO KS-FIPS
            if (LS.SSN_0004.IsEqualTo("000000000"))                                                             //COBOL==> IF SSN-0004 = '000000000'
            {
                FD.PERSON_SSN.SetValue("         ");                                                                //COBOL==> MOVE '         ' TO PERSON-SSN
            }                                                                                                   //COBOL==> ELSE
            else
            {
                FD.PERSON_SSN.SetValue(LS.SSN_0004);                                                                //COBOL==> MOVE SSN-0004 TO PERSON-SSN
            }                                                                                                   //COBOL==> END-IF
            FD.PERSON_NUMBER.SetValue(LS.NUMBER_0004);                                                          //COBOL==> MOVE NUMBER-0004 TO PERSON-NUMBER
            FD.CASE_ROLE_TYPE.SetValue(LS.TYPE_0005);                                                           //COBOL==> MOVE TYPE-0005 TO CASE-ROLE-TYPE
            FD.CASE_STATUS.SetValue(LS.OTHER_STATE_CASE_STATUS_0003);                                           //COBOL==> MOVE OTHER-STATE-CASE-STATUS-0003 TO CASE-STATUS
            FD.LAST_NAME.SetValue(LS.LAST_NAME_0004);                                                           //COBOL==> MOVE LAST-NAME-0004 TO LAST-NAME
            FD.FIRST_NAME.SetValue(LS.FIRST_NAME_0004);                                                         //COBOL==> MOVE FIRST-NAME-0004 TO FIRST-NAME
            FD.MIDDLE_NAME.SetValue(LS.MIDDLE_INITIAL_0004);                                                    //COBOL==> MOVE MIDDLE-INITIAL-0004 TO MIDDLE-NAME
            FD.DATE_OF_BIRTH.SetValue(LS.DOB_0004);                                                             //COBOL==> MOVE DOB-0004 TO DATE-OF-BIRTH
            FD.PERSON_SEX.SetValue(LS.SEX_0004);                                                                //COBOL==> MOVE SEX-0004 TO PERSON-SEX
            FD.OS_CASE_NUMBER.SetValue(LS.OTHER_STATE_CASE_ID_0002);                                            //COBOL==> MOVE OTHER-STATE-CASE-ID-0002 TO OS-CASE-NUMBER
            FD.OS_FIPS_CODE.SetValue(LS.OTHER_STATE_FIPS_0003);                                                 //COBOL==> MOVE OTHER-STATE-FIPS-0003 TO OS-FIPS-CODE
            FD.WORKER_NAME_LAST.SetValue(LS.LAST_NAME_0007);                                                    //COBOL==> MOVE LAST-NAME-0007 TO WORKER-NAME-LAST
            FD.WORKER_NAME_FIRST.SetValue(LS.FIRST_NAME_0007);                                                  //COBOL==> MOVE FIRST-NAME-0007 TO WORKER-NAME-FIRST
            FD.WORKER_AREA_CODE.SetValue(LS.WORK_PHONE_AREA_CODE_0008);                                         //COBOL==> MOVE WORK-PHONE-AREA-CODE-0008 TO WORKER-AREA-CODE
            FD.WORKER_PHONE.SetValue(LS.WORK_PHONE_NUMBER_0008);                                                //COBOL==> MOVE WORK-PHONE-NUMBER-0008 TO WORKER-PHONE
            FD.MAIN_EMAIL.SetValue("CSERECON@DCF.KS.GOV");                                                      //COBOL==> MOVE 'CSERECON@DCF.KS.GOV' TO MAIN-EMAIL
            if (FD.DATE_OF_BIRTH.IsEqualTo("00000000"))                                                         //COBOL==> IF DATE-OF-BIRTH = '00000000'
            {
                FD.DATE_OF_BIRTH.SetValue("         ");                                                             //COBOL==> MOVE '         ' TO DATE-OF-BIRTH
            }                                                                                                   //COBOL==> END-IF
            ...
            {
                LS.STATUS_0010.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0010
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0436996214_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0436996214_EXIT
        /// </summary>
        private void M_PARA_0436996214_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0436996214_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0436996214_EXIT") { M_PARA_0436996214_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0436996214_INIT
        /// </summary>
        private void M_PARA_0436996214_INIT(string returnMethod = "")
        {
            LS.EXPORT_0010EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0010EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0436996214_INIT") { M_PARA_0436996214_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0436996214_INIT_EXIT
        /// </summary>
        private void M_PARA_0436996214_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0436996214_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
