...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-11-16 12:34:54 PM
   **        *   FROM COBOL PGM   :  SWEXFE49
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B677_READ_KSCARES_INTERFACE   DATE: 2005/09/19
       TARGET OS:   MVS                       TIME: 08:54:20
...
namespace GOV.KS.DCF.CSS.Online.BL
{
    ...
    internal class SWEXFE49_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE49_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXTRACT_RECORD.CreateNewFillerField(30, FillWith.Hashes);
               EXTRACT_RECORD.CreateNewField(Names.CSP_NUMBER, FieldType.String, 10);
               EXTRACT_RECORD.CreateNewFillerField(153, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            EXTRACT_FILE = FileHandler.GetFile("HKKSC");
        ...
        #region Constructors
        public SWEXFE49_fd(SWEXFE49_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE49_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE49_ws_WorkingStorage";
    ...
    internal class SWEXFE49_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE49_ls_LinkageSection";
            ...
            internal const string S1168115524_0002EV = "S1168115524_0002EV";
            internal const string DISPLACED_PERSON_0002ET = "DISPLACED_PERSON_0002ET";
        ...
        public IGroup S1168115524_0002EV { get { return GetElementByName<IGroup>(Names.S1168115524_0002EV); } }
        public IGroup DISPLACED_PERSON_0002ET { get { return GetElementByName<IGroup>(Names.DISPLACED_PERSON_0002ET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.S1168115524_0002EV, (S1168115524_0002EV) =>
           {
               S1168115524_0002EV.CreateNewGroup(Names.DISPLACED_PERSON_0002ET, (DISPLACED_PERSON_0002ET) =>
               {
                   DISPLACED_PERSON_0002ET.CreateNewField(Names.NUMBER_0002AS, FieldType.String, 1);

                   IField NUMBER_0002_local = DISPLACED_PERSON_0002ET.CreateNewField(Names.NUMBER_0002, FieldType.String, 10);
                   DISPLACED_PERSON_0002ET.CreateNewFieldRedefine(Names.NUMBER_0002XX, FieldType.String, NUMBER_0002_local, 10);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(S1168115524_0002EV, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(S1168115524_0002EV, args, 4);
    ...
    public class SWEXFE49 : BatchBase
    {
        ...
        public SWEXFE49()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE49");

            WS = new SWEXFE49_ws();
            FD = new SWEXFE49_fd(WS);
            LS = new SWEXFE49_ls();
        }
        ...
        private SWEXFE49_ws WS;

        //==== File Data Class ========================================
        private SWEXFE49_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE49_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , S1168115524-0002EV , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1168115528(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1168115528
        /// </summary>
        private void M_MAIN_1168115528(string returnMethod = "")
        {
            M_PARA_1168115528_INIT("M_PARA_1168115528_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1168115528-INIT THRU PARA-1168115528-INIT-EXIT
            M_PARA_1168115528("M_PARA_1168115528_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1168115528 THRU PARA-1168115528-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1168115528
        /// </summary>
        private void M_PARA_1168115528(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1168115528") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003
                LS.NUMBER_0002.SetValue(FD.CSP_NUMBER);                                                             //COBOL==> MOVE CSP-NUMBER TO NUMBER-0002
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_3000_CLOSE_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0003.SetValue("CE");                                                                      //COBOL==> MOVE 'CE' TO STATUS-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1168115528_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1168115528_EXIT
        /// </summary>
        private void M_PARA_1168115528_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1168115528_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1168115528_EXIT") { M_PARA_1168115528_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1168115528_INIT
        /// </summary>
        private void M_PARA_1168115528_INIT(string returnMethod = "")
        {
            LS.S1168115524_0002EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE S1168115524-0002EV
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1168115528_INIT") { M_PARA_1168115528_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1168115528_INIT_EXIT
        /// </summary>
        private void M_PARA_1168115528_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1168115528_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
