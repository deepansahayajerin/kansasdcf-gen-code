...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:05:41 PM
   **        *   FROM COBOL PGM   :  SWEXER20
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: FN_EAB_B701_READ_ERROR_FILE      DATE: 2012/11/28
       TARGET OS:   MVS                       TIME: 13:54:07
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXER20_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER20_fd_FileSection";
            internal const string ATYERR = "ATYERR";
            internal const string ATYERR_RECORD = "ATYERR_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink ATYERR { get; set; }
        public IField ATYERR_RECORD { get { return GetElementByName<IField>(Names.ATYERR_RECORD); } }


        internal SWEXER20_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.ATYERR_RECORD, FieldType.String, 222);
        ...
        public override void Initialize()
        {
            ...
            ATYERR = FileHandler.GetFile("ATYERR");
            ATYERR.StatusField = WS.ATYERR_STAT;
            ATYERR.AssociatedBuffer = ATYERR_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXER20_fd(SWEXER20_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER20_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER20_ws_WorkingStorage";
            internal const string ATYERR_STAT = "ATYERR_STAT";
            ...
            internal const string WS_ATYERR = "WS_ATYERR";
        ...
        #region Direct-access element properties
        public IField ATYERR_STAT { get { return GetExternalElementByName<IField>(Names.ATYERR_STAT); } }
        ...
        public IGroup WS_ATYERR { get { return GetElementByName<IGroup>(Names.WS_ATYERR); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.ATYERR_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXER20 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_ATYERR, (WS_ATYERR) =>
           {
               WS_ATYERR.CreateNewField(Names.CASE_NUMBER, FieldType.String, 10);
               WS_ATYERR.CreateNewField(Names.LAST_NAME, FieldType.String, 17);
               WS_ATYERR.CreateNewField(Names.FIRST_NAME, FieldType.String, 12);
               WS_ATYERR.CreateNewField(Names.MIDDLE_INITIAL, FieldType.String, 1);
               WS_ATYERR.CreateNewField(Names.OFFICE_NAME, FieldType.String, 30);
               WS_ATYERR.CreateNewField(Names.REGION_NAME, FieldType.String, 20);
               WS_ATYERR.CreateNewField(Names.RPT_DETAIL, FieldType.String, 132);
           });
    ...
    internal class SWEXER20_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER20_ls_LinkageSection";
            ...
            internal const string EXPORT_REGION_0005EV = "EXPORT_REGION_0005EV";
        ...
        public IGroup EXPORT_REGION_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_REGION_0005EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.CASE_0002ET, (CASE_0002ET) =>
               {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.SERVICE_PROVIDER_0003ET, (SERVICE_PROVIDER_0003ET) =>
               {
           ...
           {
               EXPORT_0004EV.CreateNewGroup(Names.OFFICE_0004ET, (OFFICE_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_REGION_0005EV, (EXPORT_REGION_0005EV) =>
           {
               EXPORT_REGION_0005EV.CreateNewGroup(Names.CSE_ORGANIZATION_0005ET, (CSE_ORGANIZATION_0005ET) =>
               {
           ...
           {
               EXPORT_0006EV.CreateNewGroup(Names.EAB_REPORT_SEND_0006ET, (EAB_REPORT_SEND_0006ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_REGION_0005EV, args, 7);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_REGION_0005EV, args, 7);
    ...
    public class SWEXER20 : EABBase
    {
        ...
        public SWEXER20()
            : base()
        {
            this.ProgramName.SetValue("SWEXER20");

            WS = new SWEXER20_ws();
            FD = new SWEXER20_fd(WS);
            LS = new SWEXER20_ls();
        }
        ...
        private SWEXER20_ws WS;

        //==== File Data Class ========================================
        private SWEXER20_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER20_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-0004EV , EXPORT-REGION-0005EV , EXPORT-0006EV , EXPORT-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1266564935(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1266564935
        /// </summary>
        private void M_MAIN_1266564935(string returnMethod = "")
        {
            M_PARA_1266564935_INIT("M_PARA_1266564935_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1266564935-INIT THRU PARA-1266564935-INIT-EXIT
            M_PARA_1266564935("M_PARA_1266564935_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1266564935 THRU PARA-1266564935-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1266564935
        /// </summary>
        private void M_PARA_1266564935(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF43 IS A PART OF SWEXER20*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.TEXT_RETURN_CODE_0007.SetValue("00");                                                            //COBOL==> MOVE '00' TO TEXT-RETURN-CODE-0007.
        ...
        {
            FD.ATYERR.OpenFile(FileAccessMode.Read);                                                            //COBOL==> OPEN INPUT ATYERR.
            if (WS.ATYERR_STAT.IsEqualTo(00))                                                                   //COBOL==> IF ATYERR-STAT = 00
            {
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.ATYERR_STAT);                                               //COBOL==> MOVE ATYERR-STAT TO NUMERIC-RETURN-CODE-0007
            }                                                                                                   //COBOL==> ELSE
            else
            {
        ...
        {
            WS.WS_ATYERR.SetValue(FD.ATYERR.ReadLineInto());                                                    //COBOL==> READ ATYERR INTO WS-ATYERR.
            if (WS.ATYERR_STAT.IsEqualTo(10))                                                                   //COBOL==> IF ATYERR-STAT = 10
            {
                LS.TEXT_LINE_80_0007.SetValue("REACHED END OF ATYERR EXTRACT FILE");                                //COBOL==> MOVE 'REACHED END OF ATYERR EXTRACT FILE' TO TEXT-LINE-80-0007
                LS.TEXT_RETURN_CODE_0007.SetValue("EF");                                                            //COBOL==> MOVE 'EF' TO TEXT-RETURN-CODE-0007
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.ATYERR_STAT);                                               //COBOL==> MOVE ATYERR-STAT TO NUMERIC-RETURN-CODE-0007
                M_0500_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 0500-EXIT
            }                                                                                                   //COBOL==> END-IF.
            if (!(WS.ATYERR_STAT.IsEqualTo(00)))                                                                //COBOL==> IF ATYERR-STAT NOT = 00
            {
                LS.TEXT_LINE_80_0007.SetValue("ERROR IN READING RESPONSE FILE");                                    //COBOL==> MOVE 'ERROR IN READING RESPONSE FILE' TO TEXT-LINE-80-0007
                LS.TEXT_RETURN_CODE_0007.SetValue("XX");                                                            //COBOL==> MOVE 'XX' TO TEXT-RETURN-CODE-0007
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.ATYERR_STAT);                                               //COBOL==> MOVE ATYERR-STAT TO NUMERIC-RETURN-CODE-0007
                M_0500_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 0500-EXIT
            }                                                                                                   //COBOL==> END-IF.
            LS.NUMBER_0002.SetValue(WS.CASE_NUMBER);                                                            //COBOL==> MOVE CASE-NUMBER TO NUMBER-0002
            LS.LAST_NAME_0003.SetValue(WS.LAST_NAME);                                                           //COBOL==> MOVE LAST-NAME TO LAST-NAME-0003
            LS.FIRST_NAME_0003.SetValue(WS.FIRST_NAME);                                                         //COBOL==> MOVE FIRST-NAME TO FIRST-NAME-0003
            LS.MIDDLE_INITIAL_0003.SetValue(WS.MIDDLE_INITIAL);                                                 //COBOL==> MOVE MIDDLE-INITIAL TO MIDDLE-INITIAL-0003
            LS.NAME_0004.SetValue(WS.OFFICE_NAME);                                                              //COBOL==> MOVE OFFICE-NAME TO NAME-0004
            LS.NAME_0005.SetValue(WS.REGION_NAME);                                                              //COBOL==> MOVE REGION-NAME TO NAME-0005
            LS.RPT_DETAIL_0006.SetValue(WS.RPT_DETAIL);                                                         //COBOL==> MOVE RPT-DETAIL TO RPT-DETAIL-0006
        ...
        {
            FD.ATYERR.CloseFile();                                                                              //COBOL==> CLOSE ATYERR.
            if (!(WS.ATYERR_STAT.IsEqualTo(00)))                                                                //COBOL==> IF ATYERR-STAT NOT = 00
            {
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1266564935_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266564935_EXIT
        /// </summary>
        private void M_PARA_1266564935_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266564935_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1266564935_EXIT") { M_PARA_1266564935_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266564935_INIT
        /// </summary>
        private void M_PARA_1266564935_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_REGION_0005EV.ResetToInitialValue();                                                      //COBOL==> INITIALIZE EXPORT-REGION-0005EV
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1266564935_INIT") { M_PARA_1266564935_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266564935_INIT_EXIT
        /// </summary>
        private void M_PARA_1266564935_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266564935_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
