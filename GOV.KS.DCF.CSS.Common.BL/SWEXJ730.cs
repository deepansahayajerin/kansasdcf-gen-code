...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:21:21 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXJ730 : EABBase
    {
        ...
        private void M_INI_IMPORT_EXPORT_FLDS(string returnMethod = "")
        {
            ...
            if ((LS.I_OFFICE_0002_003XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_OFFICE_0002_003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-OFFICE-0002-003XX = HIGH-VALUES OR I-OFFICE-0002-003XX = LOW-VALUES
            {
            ...
            if ((LS.I_SERVICE_PROVIDER_0002_004XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_SERVICE_PROVIDER_0002_004XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-SERVICE-PROVIDER-0002-004XX = HIGH-VALUES OR I-SERVICE-PROVIDER-0002-004XX = LOW-VALUES
            {
            ...
            if ((LS.I_REFERRAL_TYPE_0002_007XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_REFERRAL_TYPE_0002_007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-REFERRAL-TYPE-0002-007XX = HIGH-VALUES OR I-REFERRAL-TYPE-0002-007XX = LOW-VALUES
            {
