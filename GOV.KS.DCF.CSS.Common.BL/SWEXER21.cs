...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:05:43 PM
   **        *   FROM COBOL PGM   :  SWEXER21
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_B608_READ_EXTRACT_FILE        DATE: 2013/08/27
       TARGET OS:   MVS                       TIME: 16:26:31
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXER21_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER21_fd_FileSection";
        ...
        #region Constructors
        public SWEXER21_fd(SWEXER21_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER21_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER21_ws_WorkingStorage";
    ...
    internal class SWEXER21_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER21_ls_LinkageSection";
            ...
            internal const string FIPS_0002ET = "FIPS_0002ET";
            internal const string COUNTY_ABBREVIATION_0002AS = "COUNTY_ABBREVIATION_0002AS";
            internal const string COUNTY_ABBREVIATION_0002 = "COUNTY_ABBREVIATION_0002";
            internal const string COUNTY_ABBREVIATION_0002XX = "COUNTY_ABBREVIATION_0002XX";
            ...
            internal const string EXPORT_LEAD_ATTY_0003EV = "EXPORT_LEAD_ATTY_0003EV";
            internal const string TEXT_WORK_AREA_0003ET = "TEXT_WORK_AREA_0003ET";
            internal const string TEXT_2_0003AS = "TEXT_2_0003AS";
            internal const string TEXT_2_0003 = "TEXT_2_0003";
            internal const string TEXT_2_0003XX = "TEXT_2_0003XX";
            ...
            internal const string EAB_FILE_HANDLING_0005ET = "EAB_FILE_HANDLING_0005ET";
            internal const string ACTION_0005AS = "ACTION_0005AS";
            internal const string ACTION_0005 = "ACTION_0005";
            internal const string ACTION_0005XX = "ACTION_0005XX";
            internal const string STATUS_0005AS = "STATUS_0005AS";
            internal const string STATUS_0005 = "STATUS_0005";
            internal const string STATUS_0005XX = "STATUS_0005XX";
            internal const string EXPORT_ATTOR_INFO_0006EV = "EXPORT_ATTOR_INFO_0006EV";
            ...
            internal const string EXPORT_AP_NUMBER_0007EV = "EXPORT_AP_NUMBER_0007EV";
            ...
            internal const string EXPORT_AR_NUMBER_0008EV = "EXPORT_AR_NUMBER_0008EV";
            internal const string WORK_AREA_0008ET = "WORK_AREA_0008ET";
            internal const string TEXT_200_0008AS = "TEXT_200_0008AS";
            internal const string TEXT_200_0008 = "TEXT_200_0008";
            internal const string TEXT_200_0008XX = "TEXT_200_0008XX";
        }
        #endregion
        ...
        public IGroup FIPS_0002ET { get { return GetElementByName<IGroup>(Names.FIPS_0002ET); } }
        public IField COUNTY_ABBREVIATION_0002AS { get { return GetElementByName<IField>(Names.COUNTY_ABBREVIATION_0002AS); } }
        public IField COUNTY_ABBREVIATION_0002 { get { return GetElementByName<IField>(Names.COUNTY_ABBREVIATION_0002); } }
        public IField COUNTY_ABBREVIATION_0002XX { get { return GetElementByName<IField>(Names.COUNTY_ABBREVIATION_0002XX); } }
        ...
        public IGroup EXPORT_LEAD_ATTY_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_LEAD_ATTY_0003EV); } }
        public IGroup TEXT_WORK_AREA_0003ET { get { return GetElementByName<IGroup>(Names.TEXT_WORK_AREA_0003ET); } }
        public IField TEXT_2_0003AS { get { return GetElementByName<IField>(Names.TEXT_2_0003AS); } }
        public IField TEXT_2_0003 { get { return GetElementByName<IField>(Names.TEXT_2_0003); } }
        public IField TEXT_2_0003XX { get { return GetElementByName<IField>(Names.TEXT_2_0003XX); } }
        ...
        public IGroup EAB_FILE_HANDLING_0005ET { get { return GetElementByName<IGroup>(Names.EAB_FILE_HANDLING_0005ET); } }
        public IField ACTION_0005AS { get { return GetElementByName<IField>(Names.ACTION_0005AS); } }
        public IField ACTION_0005 { get { return GetElementByName<IField>(Names.ACTION_0005); } }
        public IField ACTION_0005XX { get { return GetElementByName<IField>(Names.ACTION_0005XX); } }
        public IField STATUS_0005AS { get { return GetElementByName<IField>(Names.STATUS_0005AS); } }
        public IField STATUS_0005 { get { return GetElementByName<IField>(Names.STATUS_0005); } }
        public IField STATUS_0005XX { get { return GetElementByName<IField>(Names.STATUS_0005XX); } }
        public IGroup EXPORT_ATTOR_INFO_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_ATTOR_INFO_0006EV); } }
        ...
        public IGroup EXPORT_AP_NUMBER_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_AP_NUMBER_0007EV); } }
        ...
        public IGroup EXPORT_AR_NUMBER_0008EV { get { return GetElementByName<IGroup>(Names.EXPORT_AR_NUMBER_0008EV); } }
        public IGroup WORK_AREA_0008ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0008ET); } }
        public IField TEXT_200_0008AS { get { return GetElementByName<IField>(Names.TEXT_200_0008AS); } }
        public IField TEXT_200_0008 { get { return GetElementByName<IField>(Names.TEXT_200_0008); } }
        public IField TEXT_200_0008XX { get { return GetElementByName<IField>(Names.TEXT_200_0008XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.FIPS_0002ET, (FIPS_0002ET) =>
               {
                   FIPS_0002ET.CreateNewField(Names.COUNTY_ABBREVIATION_0002AS, FieldType.String, 1);

                   IField COUNTY_ABBREVIATION_0002_local = FIPS_0002ET.CreateNewField(Names.COUNTY_ABBREVIATION_0002, FieldType.String, 2);
                   FIPS_0002ET.CreateNewFieldRedefine(Names.COUNTY_ABBREVIATION_0002XX, FieldType.String, COUNTY_ABBREVIATION_0002_local, 2);
                   FIPS_0002ET.CreateNewField(Names.COUNTY_0002AS, FieldType.String, 1);

                   IField COUNTY_0002_local = FIPS_0002ET.CreateNewField(Names.COUNTY_0002, FieldType.SignedNumeric, 3);
                   FIPS_0002ET.CreateNewFieldRedefine(Names.COUNTY_0002XX, FieldType.String, COUNTY_0002_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_LEAD_ATTY_0003EV, (EXPORT_LEAD_ATTY_0003EV) =>
           {
               EXPORT_LEAD_ATTY_0003EV.CreateNewGroup(Names.TEXT_WORK_AREA_0003ET, (TEXT_WORK_AREA_0003ET) =>
               {
                   TEXT_WORK_AREA_0003ET.CreateNewField(Names.TEXT_2_0003AS, FieldType.String, 1);

                   IField TEXT_2_0003_local = TEXT_WORK_AREA_0003ET.CreateNewField(Names.TEXT_2_0003, FieldType.String, 2);
                   TEXT_WORK_AREA_0003ET.CreateNewFieldRedefine(Names.TEXT_2_0003XX, FieldType.String, TEXT_2_0003_local, 2);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0004EV, (EXPORT_0004EV) =>
           {
               EXPORT_0004EV.CreateNewGroup(Names.LEGAL_ACTION_0004ET, (LEGAL_ACTION_0004ET) =>
               {
                   ...
                   LEGAL_ACTION_0004ET.CreateNewField(Names.IDENTIFIER_0004AS, FieldType.String, 1);

                   IField IDENTIFIER_0004_local = LEGAL_ACTION_0004ET.CreateNewField(Names.IDENTIFIER_0004, FieldType.SignedNumeric, 9);
                   LEGAL_ACTION_0004ET.CreateNewFieldRedefine(Names.IDENTIFIER_0004XX, FieldType.String, IDENTIFIER_0004_local, 9);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0005EV, (EXPORT_0005EV) =>
           {
               EXPORT_0005EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0005ET, (EAB_FILE_HANDLING_0005ET) =>
               {
                   EAB_FILE_HANDLING_0005ET.CreateNewField(Names.ACTION_0005AS, FieldType.String, 1);

                   IField ACTION_0005_local = EAB_FILE_HANDLING_0005ET.CreateNewField(Names.ACTION_0005, FieldType.String, 8);
                   EAB_FILE_HANDLING_0005ET.CreateNewFieldRedefine(Names.ACTION_0005XX, FieldType.String, ACTION_0005_local, 8);
                   EAB_FILE_HANDLING_0005ET.CreateNewField(Names.STATUS_0005AS, FieldType.String, 1);

                   IField STATUS_0005_local = EAB_FILE_HANDLING_0005ET.CreateNewField(Names.STATUS_0005, FieldType.String, 8);
                   EAB_FILE_HANDLING_0005ET.CreateNewFieldRedefine(Names.STATUS_0005XX, FieldType.String, STATUS_0005_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_ATTOR_INFO_0006EV, (EXPORT_ATTOR_INFO_0006EV) =>
           {
               EXPORT_ATTOR_INFO_0006EV.CreateNewGroup(Names.WORK_AREA_0006ET, (WORK_AREA_0006ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_AP_NUMBER_0007EV, (EXPORT_AP_NUMBER_0007EV) =>
           {
               EXPORT_AP_NUMBER_0007EV.CreateNewGroup(Names.WORK_AREA_0007ET, (WORK_AREA_0007ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_AR_NUMBER_0008EV, (EXPORT_AR_NUMBER_0008EV) =>
           {
               EXPORT_AR_NUMBER_0008EV.CreateNewGroup(Names.WORK_AREA_0008ET, (WORK_AREA_0008ET) =>
               {
                   WORK_AREA_0008ET.CreateNewField(Names.TEXT_200_0008AS, FieldType.String, 1);

                   IField TEXT_200_0008_local = WORK_AREA_0008ET.CreateNewField(Names.TEXT_200_0008, FieldType.String, 200);
                   WORK_AREA_0008ET.CreateNewFieldRedefine(Names.TEXT_200_0008XX, FieldType.String, TEXT_200_0008_local, 200);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_LEAD_ATTY_0003EV, args, 5);
            SetPassedParm(EXPORT_0004EV, args, 6);
            SetPassedParm(EXPORT_0005EV, args, 7);
            SetPassedParm(EXPORT_ATTOR_INFO_0006EV, args, 8);
            SetPassedParm(EXPORT_AP_NUMBER_0007EV, args, 9);
            SetPassedParm(EXPORT_AR_NUMBER_0008EV, args, 10);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_LEAD_ATTY_0003EV, args, 5);
            SetReturnParm(EXPORT_0004EV, args, 6);
            SetReturnParm(EXPORT_0005EV, args, 7);
            SetReturnParm(EXPORT_ATTOR_INFO_0006EV, args, 8);
            SetReturnParm(EXPORT_AP_NUMBER_0007EV, args, 9);
            SetReturnParm(EXPORT_AR_NUMBER_0008EV, args, 10);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXER21 : EABBase
    {
        ...
        public SWEXER21()
            : base()
        {
            this.ProgramName.SetValue("SWEXER21");

            WS = new SWEXER21_ws();
            FD = new SWEXER21_fd(WS);
            LS = new SWEXER21_ls();
        }
        ...
        private SWEXER21_ws WS;

        //==== File Data Class ========================================
        private SWEXER21_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER21_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-LEAD-ATTY-0003EV , EXPORT-0004EV , EXPORT-0005EV , EXPORT-ATTOR-INFO-0006EV , EXPORT-AP-NUMBER-0007EV , EXPORT-AR-NUMBER-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1826098568(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1826098568
        /// </summary>
        private void M_MAIN_1826098568(string returnMethod = "")
        {
            M_PARA_1826098568_INIT("M_PARA_1826098568_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1826098568-INIT THRU PARA-1826098568-INIT-EXIT
            M_PARA_1826098568("M_PARA_1826098568_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1826098568 THRU PARA-1826098568-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1826098568
        /// </summary>
        private void M_PARA_1826098568(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF52 IS A PART OF SWEXER21*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.STATUS_0005.SetValue("00");                                                                      //COBOL==> MOVE '00' TO STATUS-0005.
            ...
            {
                LS.STATUS_0005.SetValue("AB");                                                                      //COBOL==> MOVE 'AB' TO STATUS-0005
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        {
            FD.ATTYOUT.OpenFile(FileAccessMode.Read);                                                           //COBOL==> OPEN INPUT ATTYOUT.
            if (WS.ATTYOUT_STAT.IsEqualTo(00))                                                                  //COBOL==> IF ATTYOUT-STAT = 00
            {
                LS.STATUS_0005.SetValue(WS.ATTYOUT_STAT);                                                           //COBOL==> MOVE ATTYOUT-STAT TO STATUS-0005
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.STATUS_0005.SetValue("OP");                                                                      //COBOL==> MOVE 'OP' TO STATUS-0005
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            WS.WS_ATTYOUT.SetValue(FD.ATTYOUT.ReadLineInto());                                                  //COBOL==> READ ATTYOUT INTO WS-ATTYOUT.
            if (WS.ATTYOUT_STAT.IsEqualTo(10))                                                                  //COBOL==> IF ATTYOUT-STAT = 10
            {
                LS.STATUS_0005.SetValue("EF");                                                                      //COBOL==> MOVE 'EF' TO STATUS-0005
            ...
            {
                LS.STATUS_0005.SetValue("XX");                                                                      //COBOL==> MOVE 'XX' TO STATUS-0005
                M_0500_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 0500-EXIT
            }                                                                                                   //COBOL==> END-IF.
            LS.TEXT_2_0003.SetValue(WS.ATTYNUM);                                                                //COBOL==> MOVE ATTYNUM TO TEXT-2-0003
            LS.COUNTY_ABBREVIATION_0002.SetValue(WS.COUNTY_ABBR);                                               //COBOL==> MOVE COUNTY-ABBR TO COUNTY-ABBREVIATION-0002
            LS.STANDARD_NUMBER_0004.SetValue(WS.CT_ORDER_NUM);                                                  //COBOL==> MOVE CT-ORDER-NUM TO STANDARD-NUMBER-0004
            LS.IDENTIFIER_0004.SetValue(WS.LA_ID);                                                              //COBOL==> MOVE LA-ID TO IDENTIFIER-0004
            LS.TEXT_200_0007.SetValue(WS.AP_NUMBER);                                                            //COBOL==> MOVE AP-NUMBER TO TEXT-200-0007
            LS.TEXT_200_0008.SetValue(WS.AR_NUMBER);                                                            //COBOL==> MOVE AR-NUMBER TO TEXT-200-0008
            LS.TEXT_200_0006.SetValue(WS.ATTY_INFO);                                                            //COBOL==> MOVE ATTY-INFO TO TEXT-200-0006
        ...
        private void M_0200_CLOSE(string returnMethod = "")
        {
            ...
            if (!(WS.ATTYOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF ATTYOUT-STAT NOT = 00
            {
                LS.STATUS_0005.SetValue("CL");                                                                      //COBOL==> MOVE 'CL' TO STATUS-0005
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1826098568_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1826098568_EXIT
        /// </summary>
        private void M_PARA_1826098568_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1826098568_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1826098568_EXIT") { M_PARA_1826098568_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1826098568_INIT
        /// </summary>
        private void M_PARA_1826098568_INIT(string returnMethod = "")
        {
            LS.EXPORT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0002EV
            LS.EXPORT_LEAD_ATTY_0003EV.ResetToInitialValue();                                                   //COBOL==> INITIALIZE EXPORT-LEAD-ATTY-0003EV
            ...
            LS.EXPORT_ATTOR_INFO_0006EV.ResetToInitialValue();                                                  //COBOL==> INITIALIZE EXPORT-ATTOR-INFO-0006EV
            LS.EXPORT_AP_NUMBER_0007EV.ResetToInitialValue();                                                   //COBOL==> INITIALIZE EXPORT-AP-NUMBER-0007EV
            LS.EXPORT_AR_NUMBER_0008EV.ResetToInitialValue();                                                   //COBOL==> INITIALIZE EXPORT-AR-NUMBER-0008EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1826098568_INIT") { M_PARA_1826098568_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1826098568_INIT_EXIT
        /// </summary>
        private void M_PARA_1826098568_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1826098568_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
