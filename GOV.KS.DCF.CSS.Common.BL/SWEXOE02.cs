...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:53 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXOE02 : OnlineEABBase
    {
        ...
        {
            DbConv.ExecuteSqlQueryWithUR("SELECT CASE_NUMBER , CASE_STATUS , CASE_STATUS_DATE INTO {0} , {1} , {2} FROM KSD_CASE_BASIC WHERE CASE_NUMBER = {3} ",  //COBOL==> EXEC SQL SELECT CASE_NUMBER , CASE_STATUS , CASE_STATUS_DATE INTO :CB-CASE-NUMBER , :CB-CASE-STATUS , :CB-CASE-STATUS-DATE FROM KSD_CASE_BASIC WHERE CASE_NUMBER = :CB-CASE-NUMBER WITH UR END-EXEC.
                                 WS.CB_CASE_NUMBER, WS.CB_CASE_STATUS, WS.CB_CASE_STATUS_DATE, WS.CB_CASE_NUMBER);
            WS.WS_DISPLAY_NUMBER.SetValue(DbConv.SQLCA.SQLCODE);                                                //COBOL==> MOVE SQLCODE TO WS-DISPLAY-NUMBER.
