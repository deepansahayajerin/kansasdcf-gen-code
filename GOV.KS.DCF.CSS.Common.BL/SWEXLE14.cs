...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:18 PM
   **        *   FROM COBOL PGM   :  SWEXLE14
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_BFX3_READ_EXTRACT_DATA_FILE   DATE: 2007/01/09
       TARGET OS:   MVS                       TIME: 14:46:04
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE14_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE14_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD.CreateNewField(Names.ZIP_CODE, FieldType.String, 5);
               INPUT_RECORD.CreateNewField(Names.CITY, FieldType.String, 15);
               INPUT_RECORD.CreateNewField(Names.AP_NAME, FieldType.String, 33);
               INPUT_RECORD.CreateNewField(Names.CASE_NUMBER, FieldType.String, 10);
           });
        ...
        #region Constructors
        public SWEXLE14_fd(SWEXLE14_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE14_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE14_ws_WorkingStorage";
    ...
    internal class SWEXLE14_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE14_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.CSE_PERSON_ADDRESS_0003ET, (CSE_PERSON_ADDRESS_0003ET) =>
               {
    ...
    public class SWEXLE14 : EABBase
    {
        ...
        public SWEXLE14()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE14");

            WS = new SWEXLE14_ws();
            FD = new SWEXLE14_fd(WS);
            LS = new SWEXLE14_ls();
        }
        ...
        private SWEXLE14_ws WS;

        //==== File Data Class ========================================
        private SWEXLE14_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE14_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-0004EV , EXPORT-0005EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1507330425(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1507330425
        /// </summary>
        private void M_MAIN_1507330425(string returnMethod = "")
        {
            M_PARA_1507330425_INIT("M_PARA_1507330425_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1507330425-INIT THRU PARA-1507330425-INIT-EXIT
            M_PARA_1507330425("M_PARA_1507330425_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1507330425 THRU PARA-1507330425-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1507330425
        /// </summary>
        private void M_PARA_1507330425(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1507330425") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.ZIP_CODE_0003.SetValue(FD.ZIP_CODE);                                                             //COBOL==> MOVE ZIP-CODE TO ZIP-CODE-0003
                LS.CITY_0003.SetValue(FD.CITY);                                                                     //COBOL==> MOVE CITY TO CITY-0003
                LS.FORMATTED_NAME_0004.SetValue(FD.AP_NAME);                                                        //COBOL==> MOVE AP-NAME TO FORMATTED-NAME-0004
                LS.NUMBER_0005.SetValue(FD.CASE_NUMBER);                                                            //COBOL==> MOVE CASE-NUMBER TO NUMBER-0005
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1507330425_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1507330425_EXIT
        /// </summary>
        private void M_PARA_1507330425_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1507330425_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1507330425_EXIT") { M_PARA_1507330425_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1507330425_INIT
        /// </summary>
        private void M_PARA_1507330425_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1507330425_INIT") { M_PARA_1507330425_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1507330425_INIT_EXIT
        /// </summary>
        private void M_PARA_1507330425_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1507330425_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
