...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:18 PM
   **        *   FROM COBOL PGM   :  SWEXGC06
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: EAB_CICS_COMMIT                  DATE: 2010/04/16
       TARGET OS:   MVS                       TIME: 15:03:35
       TARGET DBMS: DB2                       USER: SWCOTRP
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXGC06_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXGC06_ws_WorkingStorage";
        }
        #endregion
    ...
    internal class SWEXGC06_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGC06_ls_LinkageSection";
    ...
    public class SWEXGC06 : OnlineEABBase
    {
        ...
        public SWEXGC06(OnlineControl controlData) : base(controlData)
        {
            SetUpProgram();
        }
        ...
        private SWEXGC06_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXGC06_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING GLOBDATA.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0547619040(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0547619040
        /// </summary>
        private void M_MAIN_0547619040(string returnMethod = "")
        {
            M_PARA_0547619040_INIT("M_PARA_0547619040_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0547619040-INIT THRU PARA-0547619040-INIT-EXIT
            M_PARA_0547619040("M_PARA_0547619040_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0547619040 THRU PARA-0547619040-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0547619040
        /// </summary>
        private void M_PARA_0547619040(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            Data.SavePoint();                                                                                   //COBOL==> EXEC CICS SYNCPOINT END-EXEC.
            if (returnMethod != "" && returnMethod != "M_PARA_0547619040") { M_PARA_0547619040_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0547619040_EXIT
        /// </summary>
        private void M_PARA_0547619040_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0547619040_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0547619040_EXIT") { M_PARA_0547619040_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0547619040_INIT
        /// </summary>
        private void M_PARA_0547619040_INIT(string returnMethod = "")
        {
            //Continue                                                                                          //COBOL==> CONTINUE .
            if (returnMethod != "" && returnMethod != "M_PARA_0547619040_INIT") { M_PARA_0547619040_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0547619040_INIT_EXIT
        /// </summary>
        private void M_PARA_0547619040_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0547619040_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
