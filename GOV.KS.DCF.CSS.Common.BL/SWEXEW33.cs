...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:07:27 PM
   **        *   FROM COBOL PGM   :  SWEXEW33
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2019 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: EAB_WRITE_255_CHAR_FILE          DATE: 2019/08/12
       TARGET OS:   MVS                       TIME: 20:28:39
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEW33_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW33_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.OUT_FILE_RECORD, FieldType.String, 255);
        ...
        #region Constructors
        public SWEXEW33_fd(SWEXEW33_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW33_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW33_ws_WorkingStorage";
    ...
    internal class SWEXEW33_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW33_ls_LinkageSection";
            ...
            internal const string N55_CHARACTER_TEXT_RECO_0003ET = "N55_CHARACTER_TEXT_RECO_0003ET";
            internal const string DATA_0002AS = "DATA_0002AS";
            internal const string DATA_0002 = "DATA_0002";
            internal const string DATA_0002XX = "DATA_0002XX";
        ...
        public IGroup N55_CHARACTER_TEXT_RECO_0003ET { get { return GetElementByName<IGroup>(Names.N55_CHARACTER_TEXT_RECO_0003ET); } }
        public IField DATA_0002AS { get { return GetElementByName<IField>(Names.DATA_0002AS); } }
        public IField DATA_0002 { get { return GetElementByName<IField>(Names.DATA_0002); } }
        public IField DATA_0002XX { get { return GetElementByName<IField>(Names.DATA_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.N55_CHARACTER_TEXT_RECO_0003ET, (N55_CHARACTER_TEXT_RECO_0003ET) =>
               {
                   N55_CHARACTER_TEXT_RECO_0003ET.CreateNewField(Names.DATA_0002AS, FieldType.String, 1);

                   IField DATA_0002_local = N55_CHARACTER_TEXT_RECO_0003ET.CreateNewField(Names.DATA_0002, FieldType.String, 255);
                   N55_CHARACTER_TEXT_RECO_0003ET.CreateNewFieldRedefine(Names.DATA_0002XX, FieldType.String, DATA_0002_local, 255);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0004EV, (EXPORT_0004EV) =>
           {
               ...
               {
                   EAB_FILE_HANDLING_0004ET.CreateNewField(Names.STATUS_0003AS, FieldType.String, 1);

                   IField STATUS_0003_local = EAB_FILE_HANDLING_0004ET.CreateNewField(Names.STATUS_0003, FieldType.String, 8);
                   EAB_FILE_HANDLING_0004ET.CreateNewFieldRedefine(Names.STATUS_0003XX, FieldType.String, STATUS_0003_local, 8);
               });
           });
    ...
    public class SWEXEW33 : EABBase
    {
        ...
        public SWEXEW33()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW33");

            WS = new SWEXEW33_ws();
            FD = new SWEXEW33_fd(WS);
            LS = new SWEXEW33_ls();
        }
        ...
        private SWEXEW33_ws WS;

        //==== File Data Class ========================================
        private SWEXEW33_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW33_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , EXPORT-0004EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_2065439606(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_2065439606
        /// </summary>
        private void M_MAIN_2065439606(string returnMethod = "")
        {
            M_PARA_2065439606_INIT("M_PARA_2065439606_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-2065439606-INIT THRU PARA-2065439606-INIT-EXIT
            M_PARA_2065439606("M_PARA_2065439606_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-2065439606 THRU PARA-2065439606-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_2065439606
        /// </summary>
        private void M_PARA_2065439606(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_2065439606") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.OUT_FILE_RECORD.SetValue(LS.DATA_0002);                                                          //COBOL==> MOVE DATA-0002 TO OUT-FILE-RECORD
            ...
            if (returnMethod != "" && returnMethod != "M_2000_WRITE_RECORD") { M_4000_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.OUT_FILE.CloseFile();                                                                            //COBOL==> CLOSE OUT-FILE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_2065439606_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2065439606_EXIT
        /// </summary>
        private void M_PARA_2065439606_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_2065439606_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_2065439606_EXIT") { M_PARA_2065439606_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2065439606_INIT
        /// </summary>
        private void M_PARA_2065439606_INIT(string returnMethod = "")
        {
            LS.EXPORT_0004EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0004EV .
            if (returnMethod != "" && returnMethod != "M_PARA_2065439606_INIT") { M_PARA_2065439606_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2065439606_INIT_EXIT
        /// </summary>
        private void M_PARA_2065439606_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_2065439606_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
