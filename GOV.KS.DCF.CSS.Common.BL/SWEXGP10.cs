...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:13:49 PM
   **        *   FROM COBOL PGM   :  SWEXGP10
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXGP10_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP10_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT10");
    ...
    internal class SWEXGP10_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP10_ws_WorkingStorage";
    ...
    internal class SWEXGP10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP10_ls_LinkageSection";
    ...
    public class SWEXGP10 : EABBase
    {
        ...
        public SWEXGP10()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP10");
        ...
        private SWEXGP10_ws WS;

        //==== File Data Class ========================================
        private SWEXGP10_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP10_ls LS;
        #endregion
