...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:04:03 PM
   **        *   FROM COBOL PGM   :  SWEXEE28
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_READ_TERMINATED_POLICY_FILE  DATE: 2003/07/28
       TARGET OS:   MVS                       TIME: 14:18:08
       TARGET DBMS: DB2                       USER: SWSRESS
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEE28_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEE28_fd_FileSection";
            internal const string EDS_TERMINATED_POLICY_FILE = "EDS_TERMINATED_POLICY_FILE";
            internal const string INPUT_EDS_RECORD = "INPUT_EDS_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink EDS_TERMINATED_POLICY_FILE { get; set; }
        ...
        {
            recordDef.CreateNewField(Names.INPUT_EDS_RECORD, FieldType.String, 75);
        ...
        public override void Initialize()
        {
            ...
            EDS_TERMINATED_POLICY_FILE = FileHandler.GetFile("FILEIN");
            EDS_TERMINATED_POLICY_FILE.AssociatedBuffer = INPUT_EDS_RECORD;
        }
        #endregion
    ...
    internal class SWEXEE28_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEE28_ws_WorkingStorage";
            internal const string WS_TYPE_TP = "WS_TYPE_TP";
            internal const string WS_TP_RECORD_TYPE = "WS_TP_RECORD_TYPE";
            internal const string WS_TP_BENE_ID = "WS_TP_BENE_ID";
            internal const string WS_TP_POLICY_NUMBER = "WS_TP_POLICY_NUMBER";
            internal const string WS_TP_CARRIER_CODE = "WS_TP_CARRIER_CODE";
            internal const string WS_TP_END_DATE = "WS_TP_END_DATE";
            ...
            internal const string WS_CONVERT_DATE = "WS_CONVERT_DATE";
            internal const string WS_CONVERT_CCYY = "WS_CONVERT_CCYY";
            internal const string WS_CONVERT_MMDD = "WS_CONVERT_MMDD";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_TYPE_TP { get { return GetElementByName<IGroup>(Names.WS_TYPE_TP); } }
        public IField WS_TP_RECORD_TYPE { get { return GetElementByName<IField>(Names.WS_TP_RECORD_TYPE); } }
        public IField WS_TP_BENE_ID { get { return GetElementByName<IField>(Names.WS_TP_BENE_ID); } }
        public IField WS_TP_POLICY_NUMBER { get { return GetElementByName<IField>(Names.WS_TP_POLICY_NUMBER); } }
        public IField WS_TP_CARRIER_CODE { get { return GetElementByName<IField>(Names.WS_TP_CARRIER_CODE); } }
        public IField WS_TP_END_DATE { get { return GetElementByName<IField>(Names.WS_TP_END_DATE); } }
        ...
        public IField WS_CONVERT_DATE { get { return GetElementByName<IField>(Names.WS_CONVERT_DATE); } }
        public IField WS_CONVERT_CCYY { get { return GetElementByName<IField>(Names.WS_CONVERT_CCYY); } }
        public IField WS_CONVERT_MMDD { get { return GetElementByName<IField>(Names.WS_CONVERT_MMDD); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            IGroup WS_TYPE_TP_local = (IGroup)recordDef.CreateNewGroup(Names.WS_TYPE_TP, (WS_TYPE_TP) =>
           {
               WS_TYPE_TP.CreateNewField(Names.WS_TP_RECORD_TYPE, FieldType.String, 2, SPACES);
               WS_TYPE_TP.CreateNewField(Names.WS_TP_BENE_ID, FieldType.String, 12, SPACES);
               WS_TYPE_TP.CreateNewField(Names.WS_TP_POLICY_NUMBER, FieldType.String, 16, SPACES);
               WS_TYPE_TP.CreateNewField(Names.WS_TP_CARRIER_CODE, FieldType.String, 7, SPACES);
               WS_TYPE_TP.CreateNewField(Names.WS_TP_END_DATE, FieldType.UnsignedNumeric, 8, ZERO);
               WS_TYPE_TP.CreateNewFillerField(FieldType.String, 30, SPACES);
           });
            recordDef.CreateNewGroupRedefine(Names.WS_TYPE_AA, WS_TYPE_TP_local, (WS_TYPE_AA) =>
            {
                ...
                WS_TYPE_AA.CreateNewFillerField(65, FillWith.Hashes);
            });
            recordDef.CreateNewGroupRedefine(Names.WS_TYPE_ZZ, WS_TYPE_TP_local, (WS_TYPE_ZZ) =>
            {
                WS_TYPE_ZZ.CreateNewField(Names.WS_ZZ_RECORD_TYPE, FieldType.String, 2);
                WS_TYPE_ZZ.CreateNewField(Names.WS_ZZ_RECORD_COUNT, FieldType.String, 8);
                WS_TYPE_ZZ.CreateNewFillerField(65, FillWith.Hashes);
            });

            IField WS_CONVERT_DATE_local = recordDef.CreateNewField(Names.WS_CONVERT_DATE, FieldType.UnsignedNumeric, 8, ZERO);
            recordDef.CreateNewGroupRedefine("FILLER_d4", WS_CONVERT_DATE_local, (FILLER_d4) =>
            {
                FILLER_d4.CreateNewField(Names.WS_CONVERT_CCYY, FieldType.UnsignedNumeric, 4);
                FILLER_d4.CreateNewField(Names.WS_CONVERT_MMDD, FieldType.UnsignedNumeric, 4);
            });
    ...
    internal class SWEXEE28_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEE28_ls_LinkageSection";
            ...
            internal const string HEALTH_INSURANCE_COVERA_0003ET = "HEALTH_INSURANCE_COVERA_0003ET";
            ...
            internal const string CARRIER_CODE_0005AS = "CARRIER_CODE_0005AS";
            internal const string CARRIER_CODE_0005 = "CARRIER_CODE_0005";
            internal const string CARRIER_CODE_0005XX = "CARRIER_CODE_0005XX";
            ...
            internal const string EXPORT_FILE_TRAILER_0007EV = "EXPORT_FILE_TRAILER_0007EV";
        ...
        public IGroup HEALTH_INSURANCE_COVERA_0003ET { get { return GetElementByName<IGroup>(Names.HEALTH_INSURANCE_COVERA_0003ET); } }
        ...
        public IField CARRIER_CODE_0005AS { get { return GetElementByName<IField>(Names.CARRIER_CODE_0005AS); } }
        public IField CARRIER_CODE_0005 { get { return GetElementByName<IField>(Names.CARRIER_CODE_0005); } }
        public IField CARRIER_CODE_0005XX { get { return GetElementByName<IField>(Names.CARRIER_CODE_0005XX); } }
        ...
        public IGroup EXPORT_FILE_TRAILER_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_FILE_TRAILER_0007EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.HEALTH_INSURANCE_COVERA_0003ET, (HEALTH_INSURANCE_COVERA_0003ET) =>
               {
                   HEALTH_INSURANCE_COVERA_0003ET.CreateNewField(Names.INSURANCE_POLICY_NUMBER_0004AS, FieldType.String, 1);

                   IField INSURANCE_POLICY_NUMBER_0004_local = HEALTH_INSURANCE_COVERA_0003ET.CreateNewField(Names.INSURANCE_POLICY_NUMBER_0004, FieldType.String, 20);
                   HEALTH_INSURANCE_COVERA_0003ET.CreateNewFieldRedefine(Names.INSURANCE_POLICY_NUMBER_0004XX, FieldType.String, INSURANCE_POLICY_NUMBER_0004_local, 20);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0005EV, (EXPORT_0005EV) =>
           {
               ...
               {
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.CARRIER_CODE_0005AS, FieldType.String, 1);

                   IField CARRIER_CODE_0005_local = HEALTH_INSURANCE_COMPAN_0005ET.CreateNewField(Names.CARRIER_CODE_0005, FieldType.String, 7);
                   HEALTH_INSURANCE_COMPAN_0005ET.CreateNewFieldRedefine(Names.CARRIER_CODE_0005XX, FieldType.String, CARRIER_CODE_0005_local, 7);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.EXPORT_FILE_HEADER_0006EV, (EXPORT_FILE_HEADER_0006EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_FILE_TRAILER_0007EV, (EXPORT_FILE_TRAILER_0007EV) =>
           {
               EXPORT_FILE_TRAILER_0007EV.CreateNewGroup(Names.IEF_SUPPLIED_0007ET, (IEF_SUPPLIED_0007ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_0005EV, args, 6);
            SetPassedParm(EXPORT_FILE_HEADER_0006EV, args, 7);
            SetPassedParm(EXPORT_FILE_TRAILER_0007EV, args, 8);
            SetPassedParm(EXPORT_0008EV, args, 9);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_0005EV, args, 6);
            SetReturnParm(EXPORT_FILE_HEADER_0006EV, args, 7);
            SetReturnParm(EXPORT_FILE_TRAILER_0007EV, args, 8);
            SetReturnParm(EXPORT_0008EV, args, 9);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXEE28 : EABBase
    {
        ...
        public SWEXEE28()
            : base()
        {
            this.ProgramName.SetValue("SWEXEE28");
        ...
        private SWEXEE28_ws WS;

        //==== File Data Class ========================================
        private SWEXEE28_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEE28_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-0005EV , EXPORT-FILE-HEADER-0006EV , EXPORT-FILE-TRAILER-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1853107311(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1853107311
        /// </summary>
        private void M_MAIN_1853107311(string returnMethod = "")
        {
            M_PARA_1853107311_INIT("M_PARA_1853107311_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1853107311-INIT THRU PARA-1853107311-INIT-EXIT
            M_PARA_1853107311("M_PARA_1853107311_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1853107311 THRU PARA-1853107311-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1853107311
        /// </summary>
        private void M_PARA_1853107311(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1853107311") { M_PARA_1853107311_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1853107311_EXIT
        /// </summary>
        private void M_PARA_1853107311_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1853107311_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1853107311_EXIT") { M_PARA_EXAM(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_EXAM
        /// </summary>
        private void M_PARA_EXAM(string returnMethod = "")
        {
            ...
            // EvaluateList !WS.WS_TP_RECORD_TYPE!                                                              //COBOL==> EVALUATE WS-TP-RECORD-TYPE
            if ((WS.WS_TP_RECORD_TYPE.IsEqualTo("TP")))                                                         //COBOL==> WHEN 'TP'
            {
                M_PARA_MOVE("M_PARA_MOVE_EXIT"); if (Control.ExitProgram) { return; }                                 //COBOL==> PERFORM PARA-MOVE THRU PARA-MOVE-EXIT
            }                                                                                                //COBOL==> WHEN 'AA'
            else
            if ((WS.WS_TP_RECORD_TYPE.IsEqualTo("AA")))
            {
             ...
             && (WS.WS_AA_CREATION_CCYY.IsNumericValue()))  //COBOL==> IF WS-AA-CREATION-MMDD NUMERIC AND WS-AA-CREATION-CCYY NUMERIC
                {
                    WS.WS_CONVERT_MMDD.SetValue(WS.WS_AA_CREATION_MMDD);                                                //COBOL==> MOVE WS-AA-CREATION-MMDD TO WS-CONVERT-MMDD
                    WS.WS_CONVERT_CCYY.SetValue(WS.WS_AA_CREATION_CCYY);                                                //COBOL==> MOVE WS-AA-CREATION-CCYY TO WS-CONVERT-CCYY
                    LS.DATE_0006.SetValue(WS.WS_CONVERT_DATE);                                                          //COBOL==> MOVE WS-CONVERT-DATE TO DATE-0006
                }                                                                                                   //COBOL==> ELSE
                else
                {
            ...
            if ((WS.WS_TP_RECORD_TYPE.IsEqualTo("ZZ")))
            {
        ...
        {
            LS.NUMBER_0002.SetValue(WS.WS_TP_BENE_ID);                                                          //COBOL==> MOVE WS-TP-BENE-ID TO NUMBER-0002
            LS.INSURANCE_POLICY_NUMBER_0004.SetValue(WS.WS_TP_POLICY_NUMBER);                                   //COBOL==> MOVE WS-TP-POLICY-NUMBER TO INSURANCE-POLICY-NUMBER-0004
            LS.CARRIER_CODE_0005.SetValue(WS.WS_TP_CARRIER_CODE);                                               //COBOL==> MOVE WS-TP-CARRIER-CODE TO CARRIER-CODE-0005
            if (WS.WS_TP_END_DATE.IsNumericValue())                                                             //COBOL==> IF WS-TP-END-DATE NUMERIC
            {
                LS.DATE_0006.SetValue(WS.WS_TP_END_DATE);                                                           //COBOL==> MOVE WS-TP-END-DATE TO DATE-0006
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.DATE_0006.SetValue("00010101");                                                                  //COBOL==> MOVE '00010101' TO DATE-0006
        ...
        private void M_PARA_OPEN(string returnMethod = "")
        {
            ...
            FD.EDS_TERMINATED_POLICY_FILE.OpenFile(FileAccessMode.Read);                                        //COBOL==> OPEN INPUT EDS-TERMINATED-POLICY-FILE.
        ...
        {
            LS.STATUS_0008.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0008.
            WS.WS_TYPE_TP.SetValue(FD.EDS_TERMINATED_POLICY_FILE.ReadLineInto());                               //COBOL==> READ EDS-TERMINATED-POLICY-FILE INTO WS-TYPE-TP
            if (FD.EDS_TERMINATED_POLICY_FILE.FileStatus == FileStatus.End_of_file)                             //COBOL==> AT END
            {
        ...
        private void M_PARA_READ_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_READ_EXIT") { M_PARA_CLOSE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_CLOSE
        /// </summary>
        ...
        {
            FD.EDS_TERMINATED_POLICY_FILE.CloseFile();                                                          //COBOL==> CLOSE EDS-TERMINATED-POLICY-FILE.
            LS.STATUS_0008.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0008.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_1853107311_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1853107311_INIT
        /// </summary>
        private void M_PARA_1853107311_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_FILE_TRAILER_0007EV.ResetToInitialValue();                                                //COBOL==> INITIALIZE EXPORT-FILE-TRAILER-0007EV
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1853107311_INIT") { M_PARA_1853107311_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1853107311_INIT_EXIT
        /// </summary>
        private void M_PARA_1853107311_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1853107311_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
