...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:07:21 PM
   **        *   FROM COBOL PGM   :  SWEXEW31
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: EAB_EXTERNAL_REPORT_WRITER_SMALL DATE: 2017/02/08
       TARGET OS:   MVS                       TIME: 08:36:28
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEW31_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW31_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.SUMMOUT_RECORD, FieldType.String, 80);
        ...
        #region Constructors
        public SWEXEW31_fd(SWEXEW31_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW31_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW31_ws_WorkingStorage";
            ...
            internal const string WS_SUMMOUT = "WS_SUMMOUT";
            internal const string RECSUMM = "RECSUMM";
            internal const string WS_DETAIL = "WS_DETAIL";
            internal const string RECORD_SUMM = "RECORD_SUMM";
        }
        #endregion
        ...
        public IGroup WS_SUMMOUT { get { return GetElementByName<IGroup>(Names.WS_SUMMOUT); } }
        public IField RECSUMM { get { return GetElementByName<IField>(Names.RECSUMM); } }
        public IGroup WS_DETAIL { get { return GetElementByName<IGroup>(Names.WS_DETAIL); } }
        public IField RECORD_SUMM { get { return GetElementByName<IField>(Names.RECORD_SUMM); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW31 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_SUMMOUT, (WS_SUMMOUT) =>
           {
               WS_SUMMOUT.CreateNewField(Names.RECSUMM, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.WS_DETAIL, (WS_DETAIL) =>
           {
               WS_DETAIL.CreateNewField(Names.RECORD_SUMM, FieldType.String, 80);
           });
    ...
    internal class SWEXEW31_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW31_ls_LinkageSection";
    ...
    public class SWEXEW31 : EABBase
    {
        ...
        public SWEXEW31()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW31");

            WS = new SWEXEW31_ws();
            FD = new SWEXEW31_fd(WS);
            LS = new SWEXEW31_ls();
        }
        ...
        private SWEXEW31_ws WS;

        //==== File Data Class ========================================
        private SWEXEW31_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW31_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1832517923(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1832517923
        /// </summary>
        private void M_MAIN_1832517923(string returnMethod = "")
        {
            M_PARA_1832517923_INIT("M_PARA_1832517923_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1832517923-INIT THRU PARA-1832517923-INIT-EXIT
            M_PARA_1832517923("M_PARA_1832517923_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1832517923 THRU PARA-1832517923-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1832517923
        /// </summary>
        private void M_PARA_1832517923(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF80 IS A PART OF SWEXEW31*
            //COMMENT: ******************************************
        ...
        private void M_0100_INITIALIZE_AND_OPEN(string returnMethod = "")
        {
            ...
            if (!(WS.SUMMOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF SUMMOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("OP");                                                            //COBOL==> MOVE 'OP' TO TEXT-RETURN-CODE-0003
                                                                                                                    ...
                                                                                                                    //COMMENT:            TO TEXT-LINE-80-0003
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.SUMMOUT_STAT);                                              //COBOL==> MOVE SUMMOUT-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_0175_WRITE_TRANSMITTER_REC(string returnMethod = "")
        {
            ...
            FD.SUMMOUT_RECORD.SetValue(WS.WS_SUMMOUT);                                                          //COBOL==> MOVE WS-SUMMOUT TO SUMMOUT-RECORD.
        ...
        {
            WS.RECSUMM.SetValue(LS.TEXT_LINE_80_0002);                                                          //COBOL==> MOVE TEXT-LINE-80-0002 TO RECSUMM
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1832517923_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832517923_EXIT
        /// </summary>
        private void M_PARA_1832517923_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832517923_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1832517923_EXIT") { M_PARA_1832517923_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832517923_INIT
        /// </summary>
        private void M_PARA_1832517923_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1832517923_INIT") { M_PARA_1832517923_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832517923_INIT_EXIT
        /// </summary>
        private void M_PARA_1832517923_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832517923_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
