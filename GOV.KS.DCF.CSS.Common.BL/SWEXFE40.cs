...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:11:55 PM
   **        *   FROM COBOL PGM   :  SWEXFE40
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B663_WRITE_EXTRACT_DATA_FILE  DATE: 2005/03/25
       TARGET OS:   MVS                       TIME: 11:14:25
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXFE40_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE40_fd_FileSection";
            ...
            internal const string CRD_SEQUENTIAL_IDENTIFIER = "CRD_SEQUENTIAL_IDENTIFIER";
        ...
        public IGroup EXTRACT_RECORD { get { return GetElementByName<IGroup>(Names.EXTRACT_RECORD); } }
        ...
        public IField CRD_SEQUENTIAL_IDENTIFIER { get { return GetElementByName<IField>(Names.CRD_SEQUENTIAL_IDENTIFIER); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXTRACT_RECORD, (EXTRACT_RECORD) =>
           {
               EXTRACT_RECORD.CreateNewField(Names.AR_NUMBER, FieldType.String, 10);
               EXTRACT_RECORD.CreateNewField(Names.OBLIGOR_LAST_NAME, FieldType.String, 17);
               EXTRACT_RECORD.CreateNewField(Names.OBLIGOR_NUMBER, FieldType.String, 10);
               EXTRACT_RECORD.CreateNewField(Names.COURT_ORDER_APPLIED_TO, FieldType.String, 20);
               EXTRACT_RECORD.CreateNewField(Names.COLLECTION_DT, FieldType.UnsignedNumeric, 8);
               EXTRACT_RECORD.CreateNewField(Names.APPLIED_TO_CODE, FieldType.String, 1);
               EXTRACT_RECORD.CreateNewField(Names.AMOUNT_RETAINED, FieldType.SignedNumeric, 9, null, 2);
               EXTRACT_RECORD.CreateNewField(Names.AMOUNT_TO_FAMILY, FieldType.SignedNumeric, 9, null, 2);
               EXTRACT_RECORD.CreateNewFillerField(FieldType.String, 1, "<");
               EXTRACT_RECORD.CreateNewField(Names.OBLIGOR_TYPE, FieldType.String, 1);
               EXTRACT_RECORD.CreateNewField(Names.OB_TYPE_SYS_GEN_ID, FieldType.SignedNumeric, 3);
               EXTRACT_RECORD.CreateNewField(Names.OBLIGATION_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               EXTRACT_RECORD.CreateNewField(Names.OB_TRAN_SYS_GEN_ID, FieldType.UnsignedNumeric, 9);
               EXTRACT_RECORD.CreateNewField(Names.OB_TRAN_TYPE, FieldType.String, 2);
               EXTRACT_RECORD.CreateNewField(Names.CR_SOURCE_TYPE_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               EXTRACT_RECORD.CreateNewField(Names.CR_EVENT_SYS_GEN_ID, FieldType.UnsignedNumeric, 9);
               EXTRACT_RECORD.CreateNewField(Names.CR_RECEIPT_TYPE_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               EXTRACT_RECORD.CreateNewField(Names.CRD_SEQUENTIAL_IDENTIFIER, FieldType.UnsignedNumeric, 4);
               EXTRACT_RECORD.CreateNewField(Names.COLL_SYS_GEN_ID, FieldType.UnsignedNumeric, 9);
               EXTRACT_RECORD.CreateNewField(Names.PGM_APPLIED_TO, FieldType.String, 3);
           });
        ...
        public override void Initialize()
        {
            ...
            EXTRACT_FILE.StatusField = WS.EXTRACT_FILE_STATUS;
            EXTRACT_FILE.AssociatedBuffer = EXTRACT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXFE40_fd(SWEXFE40_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE40_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE40_ws_WorkingStorage";
            internal const string EXTRACT_FILE_STATUS = "EXTRACT_FILE_STATUS";
        }
        #endregion

        #region Direct-access element properties
        public IField EXTRACT_FILE_STATUS { get { return GetElementByName<IField>(Names.EXTRACT_FILE_STATUS); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewField(Names.EXTRACT_FILE_STATUS, FieldType.String, 2);
    ...
    internal class SWEXFE40_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE40_ls_LinkageSection";
            ...
            internal const string EXPORT_0023EV = "EXPORT_0023EV";
            internal const string EAB_FILE_HANDLING_0023ET = "EAB_FILE_HANDLING_0023ET";
            internal const string STATUS_0023AS = "STATUS_0023AS";
            internal const string STATUS_0023 = "STATUS_0023";
            internal const string STATUS_0023XX = "STATUS_0023XX";
        }
        #endregion
        ...
        public IGroup EXPORT_0023EV { get { return GetElementByName<IGroup>(Names.EXPORT_0023EV); } }
        public IGroup EAB_FILE_HANDLING_0023ET { get { return GetElementByName<IGroup>(Names.EAB_FILE_HANDLING_0023ET); } }
        public IField STATUS_0023AS { get { return GetElementByName<IField>(Names.STATUS_0023AS); } }
        public IField STATUS_0023 { get { return GetElementByName<IField>(Names.STATUS_0023); } }
        public IField STATUS_0023XX { get { return GetElementByName<IField>(Names.STATUS_0023XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0022EV, (IMPORT_0022EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0023EV, (EXPORT_0023EV) =>
           {
               EXPORT_0023EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0023ET, (EAB_FILE_HANDLING_0023ET) =>
               {
                   EAB_FILE_HANDLING_0023ET.CreateNewField(Names.STATUS_0023AS, FieldType.String, 1);

                   IField STATUS_0023_local = EAB_FILE_HANDLING_0023ET.CreateNewField(Names.STATUS_0023, FieldType.String, 8);
                   EAB_FILE_HANDLING_0023ET.CreateNewFieldRedefine(Names.STATUS_0023XX, FieldType.String, STATUS_0023_local, 8);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_0023EV, args, 18);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_0023EV, args, 18);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXFE40 : EABBase
    {
        ...
        public SWEXFE40()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE40");

            WS = new SWEXFE40_ws();
            FD = new SWEXFE40_fd(WS);
            LS = new SWEXFE40_ls();
        }
        ...
        private SWEXFE40_ws WS;

        //==== File Data Class ========================================
        private SWEXFE40_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE40_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0892338825(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0892338825
        /// </summary>
        private void M_MAIN_0892338825(string returnMethod = "")
        {
            M_PARA_0892338825_INIT("M_PARA_0892338825_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0892338825-INIT THRU PARA-0892338825-INIT-EXIT
            M_PARA_0892338825("M_PARA_0892338825_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0892338825 THRU PARA-0892338825-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0892338825
        /// </summary>
        private void M_PARA_0892338825(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0892338825") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            LS.STATUS_0023.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0023
            ...
            {
                LS.STATUS_0023.SetValue("BI");                                                                      //COBOL==> MOVE 'BI' TO STATUS-0023
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            if (WS.EXTRACT_FILE_STATUS.IsEqualTo("00"))                                                         //COBOL==> IF EXTRACT-FILE-STATUS = '00'
            {
                LS.STATUS_0023.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0023
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.STATUS_0023.SetValue("PE");                                                                      //COBOL==> MOVE 'PE' TO STATUS-0023
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: ******************
            FD.AR_NUMBER.SetValue(LS.NUMBER_0002);                                                              //COBOL==> MOVE NUMBER-0002 TO AR-NUMBER
            FD.OBLIGOR_LAST_NAME.SetValue(LS.LAST_NAME_0003);                                                   //COBOL==> MOVE LAST-NAME-0003 TO OBLIGOR-LAST-NAME
            FD.OBLIGOR_NUMBER.SetValue(LS.NUMBER_0004);                                                         //COBOL==> MOVE NUMBER-0004 TO OBLIGOR-NUMBER
            FD.COLL_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0006);                                     //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0006 TO COLL-SYS-GEN-ID
            FD.PGM_APPLIED_TO.SetValue(LS.PROGRAM_APPLIED_TO_0006);                                             //COBOL==> MOVE PROGRAM-APPLIED-TO-0006 TO PGM-APPLIED-TO
            FD.COURT_ORDER_APPLIED_TO.SetValue(LS.COURT_ORDER_APPLIED_TO_0006);                                 //COBOL==> MOVE COURT-ORDER-APPLIED-TO-0006 TO COURT-ORDER-APPLIED-TO
            FD.COLLECTION_DT.SetValue(LS.COLLECTION_DT_0006);                                                   //COBOL==> MOVE COLLECTION-DT-0006 TO COLLECTION-DT
            FD.APPLIED_TO_CODE.SetValue(LS.APPLIED_TO_CODE_0006);                                               //COBOL==> MOVE APPLIED-TO-CODE-0006 TO APPLIED-TO-CODE
            FD.AMOUNT_RETAINED.SetValue(LS.AMOUNT_0007);                                                        //COBOL==> MOVE AMOUNT-0007 TO AMOUNT-RETAINED
            FD.AMOUNT_TO_FAMILY.SetValue(LS.AMOUNT_0008);                                                       //COBOL==> MOVE AMOUNT-0008 TO AMOUNT-TO-FAMILY
            FD.OBLIGOR_TYPE.SetValue(LS.TYPE_0009);                                                             //COBOL==> MOVE TYPE-0009 TO OBLIGOR-TYPE
            FD.OB_TYPE_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0011);                                  //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0011 TO OB-TYPE-SYS-GEN-ID
            FD.OBLIGATION_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0013);                               //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0013 TO OBLIGATION-SYS-GEN-ID
            FD.OB_TRAN_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0015);                                  //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0015 TO OB-TRAN-SYS-GEN-ID
            FD.OB_TRAN_TYPE.SetValue(LS.TYPE_0015);                                                             //COBOL==> MOVE TYPE-0015 TO OB-TRAN-TYPE
            FD.CR_SOURCE_TYPE_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0017);                           //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0017 TO CR-SOURCE-TYPE-SYS-GEN-ID
            FD.CR_EVENT_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0019);                                 //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0019 TO CR-EVENT-SYS-GEN-ID
            FD.CR_RECEIPT_TYPE_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0021);                          //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0021 TO CR-RECEIPT-TYPE-SYS-GEN-ID
            FD.CRD_SEQUENTIAL_IDENTIFIER.SetValue(LS.SEQUENTIAL_IDENTIFIER_0022);                               //COBOL==> MOVE SEQUENTIAL-IDENTIFIER-0022 TO CRD-SEQUENTIAL-IDENTIFIER
            ...
            {
                LS.STATUS_0023.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0023
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0892338825_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0892338825_EXIT
        /// </summary>
        private void M_PARA_0892338825_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0892338825_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0892338825_EXIT") { M_PARA_0892338825_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0892338825_INIT
        /// </summary>
        private void M_PARA_0892338825_INIT(string returnMethod = "")
        {
            LS.EXPORT_0023EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0023EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0892338825_INIT") { M_PARA_0892338825_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0892338825_INIT_EXIT
        /// </summary>
        private void M_PARA_0892338825_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0892338825_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
