...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:23:08 PM
   **        *   FROM COBOL PGM   :  SWEXLW02
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_WRITE_B575_FILE_EXTRACT   DATE: 2009/04/28
       TARGET OS:   MVS                       TIME: 09:34:22
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLW02_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLW02_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            CLFILE = FileHandler.GetFile("OUTFILE");
        ...
        #region Constructors
        public SWEXLW02_fd(SWEXLW02_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLW02_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLW02_ws_WorkingStorage";
    ...
    internal class SWEXLW02_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLW02_ls_LinkageSection";
            ...
            internal const string IMPORT_REGION_INFO_0002EV = "IMPORT_REGION_INFO_0002EV";
            internal const string CSE_ORGANIZATION_0002ET = "CSE_ORGANIZATION_0002ET";
            ...
            internal const string IMPORT_OFFICE_INFO_0003EV = "IMPORT_OFFICE_INFO_0003EV";
            ...
            internal const string IMPORT_SP_INFO_0004EV = "IMPORT_SP_INFO_0004EV";
            ...
            internal const string IMPORT_CO_CASELOAD_CNT_0005EV = "IMPORT_CO_CASELOAD_CNT_0005EV";
            ...
            internal const string IMPORT_CO_REFERRED_CNT_0006EV = "IMPORT_CO_REFERRED_CNT_0006EV";
        ...
        public IGroup IMPORT_REGION_INFO_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_REGION_INFO_0002EV); } }
        public IGroup CSE_ORGANIZATION_0002ET { get { return GetElementByName<IGroup>(Names.CSE_ORGANIZATION_0002ET); } }
        ...
        public IGroup IMPORT_OFFICE_INFO_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_OFFICE_INFO_0003EV); } }
        ...
        public IGroup IMPORT_SP_INFO_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_SP_INFO_0004EV); } }
        ...
        public IGroup IMPORT_CO_CASELOAD_CNT_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_CO_CASELOAD_CNT_0005EV); } }
        ...
        public IGroup IMPORT_CO_REFERRED_CNT_0006EV { get { return GetElementByName<IGroup>(Names.IMPORT_CO_REFERRED_CNT_0006EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_REGION_INFO_0002EV, (IMPORT_REGION_INFO_0002EV) =>
           {
               IMPORT_REGION_INFO_0002EV.CreateNewGroup(Names.CSE_ORGANIZATION_0002ET, (CSE_ORGANIZATION_0002ET) =>
               {
                   CSE_ORGANIZATION_0002ET.CreateNewField(Names.CODE_0002AS, FieldType.String, 1);

                   IField CODE_0002_local = CSE_ORGANIZATION_0002ET.CreateNewField(Names.CODE_0002, FieldType.String, 2);
                   CSE_ORGANIZATION_0002ET.CreateNewFieldRedefine(Names.CODE_0002XX, FieldType.String, CODE_0002_local, 2);
                   CSE_ORGANIZATION_0002ET.CreateNewField(Names.NAME_0002AS, FieldType.String, 1);

                   IField NAME_0002_local = CSE_ORGANIZATION_0002ET.CreateNewField(Names.NAME_0002, FieldType.String, 20);
                   CSE_ORGANIZATION_0002ET.CreateNewFieldRedefine(Names.NAME_0002XX, FieldType.String, NAME_0002_local, 20);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_OFFICE_INFO_0003EV, (IMPORT_OFFICE_INFO_0003EV) =>
           {
               IMPORT_OFFICE_INFO_0003EV.CreateNewGroup(Names.OFFICE_0003ET, (OFFICE_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_SP_INFO_0004EV, (IMPORT_SP_INFO_0004EV) =>
           {
               IMPORT_SP_INFO_0004EV.CreateNewGroup(Names.SERVICE_PROVIDER_0004ET, (SERVICE_PROVIDER_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CO_CASELOAD_CNT_0005EV, (IMPORT_CO_CASELOAD_CNT_0005EV) =>
           {
               IMPORT_CO_CASELOAD_CNT_0005EV.CreateNewGroup(Names.IEF_SUPPLIED_0005ET, (IEF_SUPPLIED_0005ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CO_REFERRED_CNT_0006EV, (IMPORT_CO_REFERRED_CNT_0006EV) =>
           {
               IMPORT_CO_REFERRED_CNT_0006EV.CreateNewGroup(Names.IEF_SUPPLIED_0006ET, (IEF_SUPPLIED_0006ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_REGION_INFO_0002EV, args, 4);
            SetPassedParm(IMPORT_OFFICE_INFO_0003EV, args, 5);
            SetPassedParm(IMPORT_SP_INFO_0004EV, args, 6);
            SetPassedParm(IMPORT_CO_CASELOAD_CNT_0005EV, args, 7);
            SetPassedParm(IMPORT_CO_REFERRED_CNT_0006EV, args, 8);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_REGION_INFO_0002EV, args, 4);
            SetReturnParm(IMPORT_OFFICE_INFO_0003EV, args, 5);
            SetReturnParm(IMPORT_SP_INFO_0004EV, args, 6);
            SetReturnParm(IMPORT_CO_CASELOAD_CNT_0005EV, args, 7);
            SetReturnParm(IMPORT_CO_REFERRED_CNT_0006EV, args, 8);
    ...
    public class SWEXLW02 : EABBase
    {
        ...
        public SWEXLW02()
            : base()
        {
            this.ProgramName.SetValue("SWEXLW02");

            WS = new SWEXLW02_ws();
            FD = new SWEXLW02_fd(WS);
            LS = new SWEXLW02_ls();
        }
        ...
        private SWEXLW02_ws WS;

        //==== File Data Class ========================================
        private SWEXLW02_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLW02_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-REGION-INFO-0002EV , IMPORT-OFFICE-INFO-0003EV , IMPORT-SP-INFO-0004EV , IMPORT-CO-CASELOAD-CNT-0005EV , IMPORT-CO-REFERRED-CNT-0006EV , EXPORT-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0140773358(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0140773358
        /// </summary>
        private void M_MAIN_0140773358(string returnMethod = "")
        {
            M_PARA_0140773358_INIT("M_PARA_0140773358_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0140773358-INIT THRU PARA-0140773358-INIT-EXIT
            M_PARA_0140773358("M_PARA_0140773358_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0140773358 THRU PARA-0140773358-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0140773358
        /// </summary>
        private void M_PARA_0140773358(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: *************************************************************
            //COMMENT:   SWEXL75P - THIS CODE IS PART OF SWEXLW02 ,TO WRITE RECORDS
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0140773358") { M_PARA_0140773358_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0140773358_EXIT
        /// </summary>
        private void M_PARA_0140773358_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0140773358_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0140773358_EXIT") { M_100_OPEN_PARA(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        /// <remarks>
        ///COMMENT: *************************************************************
        ///COMMENT:   SWEXL75L - THIS CODE IS PART OF SWEXLW02 ,TO WRITE RECORDS
        ///COMMENT:   TO AN OUTPUT FILE .
        ...
        {
            FD.CLFILE.OpenFile(FileAccessMode.Write);                                                           //COBOL==> OPEN OUTPUT CLFILE.
        ...
        private void M_200_WRITE_PARA(string returnMethod = "")
        {
            ...
            WS.CL_REGION_CODE.SetValue(LS.CODE_0002);                                                           //COBOL==> MOVE CODE-0002 TO CL-REGION-CODE.
            WS.CL_REGION_NAME.SetValue(LS.NAME_0002);                                                           //COBOL==> MOVE NAME-0002 TO CL-REGION-NAME.
                                                                                                                //COMMENT: - OFFICE INFORMATION
            WS.CL_OFF_ID.SetValue(LS.SYSTEM_GENERATED_ID_0003);                                                 //COBOL==> MOVE SYSTEM-GENERATED-ID-0003 TO CL-OFF-ID.
            WS.CL_OFFICE_NAME.SetValue(LS.NAME_0003);                                                           //COBOL==> MOVE NAME-0003 TO CL-OFFICE-NAME.
                                                                                                                //COMMENT: - SERVICE PROVIDER INFORMATION
            WS.CL_SPD_ID.SetValue(LS.SYSTEM_GENERATED_ID_0004);                                                 //COBOL==> MOVE SYSTEM-GENERATED-ID-0004 TO CL-SPD-ID.
            WS.CL_SPD_LAST_NAME.SetValue(LS.LAST_NAME_0004);                                                    //COBOL==> MOVE LAST-NAME-0004 TO CL-SPD-LAST-NAME.
            WS.CL_SPD_FIRST_NAME.SetValue(LS.FIRST_NAME_0004);                                                  //COBOL==> MOVE FIRST-NAME-0004 TO CL-SPD-FIRST-NAME.
            WS.CL_SPD_MIDDLE_INITIAL.SetValue(LS.MIDDLE_INITIAL_0004);                                          //COBOL==> MOVE MIDDLE-INITIAL-0004 TO CL-SPD-MIDDLE-INITIAL.
                                                                                                                //COMMENT: - CASELOAD COUNT
            WS.CL_CASELOAD_CNT.SetValue(LS.COUNT_0005);                                                         //COBOL==> MOVE COUNT-0005 TO CL-CASELOAD-CNT.
                                                                                                                //COMMENT: - CASE REFERRED COUNT
            WS.CL_REFERRED_CNT.SetValue(LS.COUNT_0006);                                                         //COBOL==> MOVE COUNT-0006 TO CL-REFERRED-CNT.
            FD.CL_REC.SetValue(WS.WS_CL_REC);                                                                   //COBOL==> MOVE WS-CL-REC TO CL-REC.
            FD.CLFILE.WriteLine(FD.CL_REC.AsBytes);                                                             //COBOL==> WRITE CL-REC.
            if (WS.CLFILE_STAT.IsEqualTo(0))                                                                    //COBOL==> IF CLFILE-STAT = 0
            {
                LS.STATUS_0007.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_209_WRITE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_209_WRITE_EXIT") { M_PARA_0140773358_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0140773358_INIT
        /// </summary>
        private void M_PARA_0140773358_INIT(string returnMethod = "")
        {
            LS.EXPORT_0007EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0140773358_INIT") { M_PARA_0140773358_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0140773358_INIT_EXIT
        /// </summary>
        private void M_PARA_0140773358_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0140773358_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
