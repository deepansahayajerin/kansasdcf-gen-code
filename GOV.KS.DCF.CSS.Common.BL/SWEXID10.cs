...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:50:31 PM
   **        *   FROM COBOL PGM   :  SWEXID10
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_DELETE_ALIAS                 DATE: 96/01/04
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXID10_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXID10_ws_WorkingStorage";
            internal const string FUNC_0544740977_ESC_FLAG = "FUNC_0544740977_ESC_FLAG";
        ...
        public IField FUNC_0544740977_ESC_FLAG { get { return GetElementByName<IField>(Names.FUNC_0544740977_ESC_FLAG); } }
        ...
        {
            recordDef.CreateNewField(Names.FUNC_0544740977_ESC_FLAG, FieldType.String, 1);
            ...
            recordDef.CreateNewGroup(Names.EXTERNAL_ACTION_BLOCK_WS, (EXTERNAL_ACTION_BLOCK_WS) =>
           {
               ...
               EXTERNAL_ACTION_BLOCK_WS.CreateNewField(Names.SRMODLNK, FieldType.String, 8, "SWEXID10");
    ...
    internal class SWEXID10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXID10_ls_LinkageSection";
            ...
            internal const string A_0544740980_IA = "A_0544740980_IA";
            ...
            internal const string A_0544740999_OA = "A_0544740999_OA";
        ...
        public IGroup A_0544740980_IA { get { return GetElementByName<IGroup>(Names.A_0544740980_IA); } }
        ...
        public IGroup A_0544740999_OA { get { return GetElementByName<IGroup>(Names.A_0544740999_OA); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               W_IA.CreateNewGroup(Names.A_0544740980_IA, (A_0544740980_IA) =>
               {
                   A_0544740980_IA.CreateNewGroup(Names.INPUT_0001EV, (INPUT_0001EV) =>
                   {
           ...
           {
               W_OA.CreateNewGroup(Names.A_0544740999_OA, (A_0544740999_OA) =>
               {
                   A_0544740999_OA.CreateNewGroup(Names.OUTPUT_0002EV, (OUTPUT_0002EV) =>
                   {
    ...
    public class SWEXID10 : OnlineEABBase
    {
        ...
        public SWEXID10(OnlineControl controlData) : base(controlData)
        {
            SetUpProgram();
        }
        ...
        private SWEXID10_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXID10_ls LS;
        #endregion
        ...
        protected override void RunMain(string startLabel, string returnLbl)
        {
            ...
            switch (startLabel)
            {
                case "PARA-0544740977-INIT": goto L_PARA_0544740977_INIT; break;
                case "PARA-0544740977": goto L_PARA_0544740977; break;
                case "9999-CICS-ABEND": goto L_9999_CICS_ABEND; break;
                case "0500-COMMON-CLIENT-ROUTINE": goto L_0500_COMMON_CLIENT_ROUTINE; break;
                case "6000-DELET-ALIAS-CLIENT": goto L_6000_DELET_ALIAS_CLIENT; break;
        ...
        #region MAIN-0544740977
        L_MAIN_0544740977:;
            Perform("PARA-0544740977-INIT", "PARA-0544740977-INIT-EXIT"); if (Control.ExitProgram) { return; }    //COBOL==> PERFORM PARA-0544740977-INIT THRU PARA-0544740977-INIT-EXIT
            Perform("PARA-0544740977", "PARA-0544740977-EXIT"); if (Control.ExitProgram) { return; }              //COBOL==> PERFORM PARA-0544740977 THRU PARA-0544740977-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        #endregion MAIN-0544740977

        #region PARA-0544740977
        L_PARA_0544740977:;
            WS.FUNC_0544740977_ESC_FLAG.SetValue("N");                                                          //COBOL==> MOVE 'N' TO FUNC-0544740977-ESC-FLAG.
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT: ****************************************************************
            ///COMMENT:                                                                *
            ///COMMENT:  INCLUDE NAME:  SWCSZG22.                                      *
            ///COMMENT:      EAB NAME:  SWEXID10.                                      *
            ...
            ///COMMENT:                                                                *
            ///COMMENT: ****************************************************************
            if (returnLabel == "PARA-0544740977") { return; }  //Check for pass through to next method
        #endregion PARA-0544740977
        ...
        L_0000_ADABAS_ROUTINE:;
            ...
            Perform("6000-DELET-ALIAS-CLIENT", "6000-EXIT"); if (Control.ExitProgram) { return; }                 //COBOL==> PERFORM 6000-DELET-ALIAS-CLIENT THRU 6000-EXIT.
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                goto L_0000_ADABAS_EXIT;                                                                            //COBOL==> GO TO 0000-ADABAS-EXIT
            }                                                                                                   //COBOL==> END-IF.
        ...
        #region PARA-0544740977-EXIT
        L_PARA_0544740977_EXIT:;
            if (returnLabel == "PARA-0544740977-EXIT") { return; }                                              //COBOL==> EXIT.
        ///COMMENT: *****************************************************************
        ///COMMENT:                                                                 *
        ...
        ///COMMENT: *****************************************************************
        #endregion PARA-0544740977-EXIT
        ...
        #region PARA-0544740977-INIT
        L_PARA_0544740977_INIT:;
            LS.OUTPUT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE OUTPUT-0002EV .
            if (returnLabel == "PARA-0544740977-INIT") { return; }  //Check for pass through to next method
        #endregion PARA-0544740977-INIT

        #region PARA-0544740977-INIT-EXIT
        L_PARA_0544740977_INIT_EXIT:;
            if (returnLabel == "PARA-0544740977-INIT-EXIT") { return; }                                         //COBOL==> EXIT.
            #endregion PARA-0544740977-INIT-EXIT
        }
        #endregion
    }
    #endregion
