...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:13:33 PM
   **        *   FROM COBOL PGM   :  SWEXGP04
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXGP04_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP04_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT04");
    ...
    internal class SWEXGP04_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP04_ws_WorkingStorage";
    ...
    internal class SWEXGP04_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP04_ls_LinkageSection";
    ...
    public class SWEXGP04 : EABBase
    {
        ...
        public SWEXGP04()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP04");
        ...
        private SWEXGP04_ws WS;

        //==== File Data Class ========================================
        private SWEXGP04_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP04_ls LS;
        #endregion
