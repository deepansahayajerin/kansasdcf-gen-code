...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:11:37 PM
   **        *   FROM COBOL PGM   :  SWEXFE06
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B721_EXT_WRITE_FILE           DATE: 2003/12/19
       TARGET OS:   MVS                       TIME: 17:25:13
   ...
   06/17/2004 - CHANGES FOR PR 207423 - FDSO SUPPRESSED DISB
    CM JOHNSON- ADDED FILE OUTFILE8
   **************************************************************
*/
#endregion
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXFE06_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE06_fd_FileSection";
            internal const string OUTPUT_FILE_01 = "OUTPUT_FILE_01";
            internal const string OUTPUT_RECORD_01 = "OUTPUT_RECORD_01";
            internal const string RECORD_01_DETAIL = "RECORD_01_DETAIL";
            internal const string OUTPUT_FILE_02 = "OUTPUT_FILE_02";
            internal const string OUTPUT_RECORD_02 = "OUTPUT_RECORD_02";
            internal const string RECORD_02_DETAIL = "RECORD_02_DETAIL";
            internal const string OUTPUT_FILE_03 = "OUTPUT_FILE_03";
            internal const string OUTPUT_RECORD_03 = "OUTPUT_RECORD_03";
            internal const string RECORD_03_DETAIL = "RECORD_03_DETAIL";
            internal const string OUTPUT_FILE_04 = "OUTPUT_FILE_04";
            internal const string OUTPUT_RECORD_04 = "OUTPUT_RECORD_04";
            internal const string RECORD_04_DETAIL = "RECORD_04_DETAIL";
            internal const string OUTPUT_FILE_05 = "OUTPUT_FILE_05";
            internal const string OUTPUT_RECORD_05 = "OUTPUT_RECORD_05";
            internal const string RECORD_05_DETAIL = "RECORD_05_DETAIL";
            internal const string OUTPUT_FILE_06 = "OUTPUT_FILE_06";
            internal const string OUTPUT_RECORD_06 = "OUTPUT_RECORD_06";
            internal const string RECORD_06_DETAIL = "RECORD_06_DETAIL";
            internal const string OUTPUT_FILE_07 = "OUTPUT_FILE_07";
            internal const string OUTPUT_RECORD_07 = "OUTPUT_RECORD_07";
            internal const string RECORD_07_DETAIL = "RECORD_07_DETAIL";
            internal const string OUTPUT_FILE_08 = "OUTPUT_FILE_08";
            internal const string OUTPUT_RECORD_08 = "OUTPUT_RECORD_08";
            internal const string RECORD_08_DETAIL = "RECORD_08_DETAIL";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink OUTPUT_FILE_01 { get; set; }
        public IGroup OUTPUT_RECORD_01 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_01); } }
        public IField RECORD_01_DETAIL { get { return GetElementByName<IField>(Names.RECORD_01_DETAIL); } }
        public IFileLink OUTPUT_FILE_02 { get; set; }
        public IGroup OUTPUT_RECORD_02 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_02); } }
        public IField RECORD_02_DETAIL { get { return GetElementByName<IField>(Names.RECORD_02_DETAIL); } }
        public IFileLink OUTPUT_FILE_03 { get; set; }
        public IGroup OUTPUT_RECORD_03 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_03); } }
        public IField RECORD_03_DETAIL { get { return GetElementByName<IField>(Names.RECORD_03_DETAIL); } }
        public IFileLink OUTPUT_FILE_04 { get; set; }
        public IGroup OUTPUT_RECORD_04 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_04); } }
        public IField RECORD_04_DETAIL { get { return GetElementByName<IField>(Names.RECORD_04_DETAIL); } }
        public IFileLink OUTPUT_FILE_05 { get; set; }
        public IGroup OUTPUT_RECORD_05 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_05); } }
        public IField RECORD_05_DETAIL { get { return GetElementByName<IField>(Names.RECORD_05_DETAIL); } }
        public IFileLink OUTPUT_FILE_06 { get; set; }
        public IGroup OUTPUT_RECORD_06 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_06); } }
        public IField RECORD_06_DETAIL { get { return GetElementByName<IField>(Names.RECORD_06_DETAIL); } }
        public IFileLink OUTPUT_FILE_07 { get; set; }
        public IGroup OUTPUT_RECORD_07 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_07); } }
        public IField RECORD_07_DETAIL { get { return GetElementByName<IField>(Names.RECORD_07_DETAIL); } }
        public IFileLink OUTPUT_FILE_08 { get; set; }
        public IGroup OUTPUT_RECORD_08 { get { return GetElementByName<IGroup>(Names.OUTPUT_RECORD_08); } }
        public IField RECORD_08_DETAIL { get { return GetElementByName<IField>(Names.RECORD_08_DETAIL); } }


        internal SWEXFE06_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_01, (OUTPUT_RECORD_01) =>
           {
               OUTPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_02, (OUTPUT_RECORD_02) =>
           {
               OUTPUT_RECORD_02.CreateNewField(Names.RECORD_02_DETAIL, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_03, (OUTPUT_RECORD_03) =>
           {
               OUTPUT_RECORD_03.CreateNewField(Names.RECORD_03_DETAIL, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_04, (OUTPUT_RECORD_04) =>
           {
               OUTPUT_RECORD_04.CreateNewField(Names.RECORD_04_DETAIL, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_05, (OUTPUT_RECORD_05) =>
           {
               OUTPUT_RECORD_05.CreateNewField(Names.RECORD_05_DETAIL, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_06, (OUTPUT_RECORD_06) =>
           {
               OUTPUT_RECORD_06.CreateNewField(Names.RECORD_06_DETAIL, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_07, (OUTPUT_RECORD_07) =>
           {
               OUTPUT_RECORD_07.CreateNewField(Names.RECORD_07_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.OUTPUT_RECORD_08, (OUTPUT_RECORD_08) =>
           {
               OUTPUT_RECORD_08.CreateNewField(Names.RECORD_08_DETAIL, FieldType.String, 80);
           });
        ...
        public override void Initialize()
        {
            ...
            OUTPUT_FILE_01 = FileHandler.GetFile("OUTFILE1");
            OUTPUT_FILE_01.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_01.AssociatedBuffer = OUTPUT_RECORD_01;

            OUTPUT_FILE_02 = FileHandler.GetFile("OUTFILE2");
            OUTPUT_FILE_02.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_02.AssociatedBuffer = OUTPUT_RECORD_02;

            OUTPUT_FILE_03 = FileHandler.GetFile("OUTFILE3");
            OUTPUT_FILE_03.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_03.AssociatedBuffer = OUTPUT_RECORD_03;

            OUTPUT_FILE_04 = FileHandler.GetFile("OUTFILE4");
            OUTPUT_FILE_04.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_04.AssociatedBuffer = OUTPUT_RECORD_04;

            OUTPUT_FILE_05 = FileHandler.GetFile("OUTFILE5");
            OUTPUT_FILE_05.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_05.AssociatedBuffer = OUTPUT_RECORD_05;

            OUTPUT_FILE_06 = FileHandler.GetFile("OUTFILE6");
            OUTPUT_FILE_06.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_06.AssociatedBuffer = OUTPUT_RECORD_06;

            OUTPUT_FILE_07 = FileHandler.GetFile("OUTFILE7");
            OUTPUT_FILE_07.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_07.AssociatedBuffer = OUTPUT_RECORD_07;

            OUTPUT_FILE_08 = FileHandler.GetFile("OUTFILE8");
            OUTPUT_FILE_08.StatusField = WS.FILE_STATUS;
            OUTPUT_FILE_08.AssociatedBuffer = OUTPUT_RECORD_08;
        }
        #endregion

        #region Constructors
        public SWEXFE06_fd(SWEXFE06_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE06_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE06_ws_WorkingStorage";
    ...
    internal class SWEXFE06_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE06_ls_LinkageSection";
    ...
    public class SWEXFE06 : EABBase
    {
        ...
        public SWEXFE06()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE06");

            WS = new SWEXFE06_ws();
            FD = new SWEXFE06_fd(WS);
            LS = new SWEXFE06_ls();
        }
        ...
        private SWEXFE06_ws WS;

        //==== File Data Class ========================================
        private SWEXFE06_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE06_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-FILE-NUMBER-0001EV , IMPORT-0002EV , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0430965735(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0430965735
        /// </summary>
        private void M_MAIN_0430965735(string returnMethod = "")
        {
            M_PARA_0430965735_INIT("M_PARA_0430965735_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0430965735-INIT THRU PARA-0430965735-INIT-EXIT
            M_PARA_0430965735("M_PARA_0430965735_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0430965735 THRU PARA-0430965735-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0430965735
        /// </summary>
        private void M_PARA_0430965735(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0430965735") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            if ((LS.FILE_INSTRUCTION_0002.IsEqualTo("WRITE")))
            {
                M_2000_WRITE_FILE(); if (Control.ExitProgram) { return; }                                             //COBOL==> PERFORM 2000-WRITE-FILE
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
            if ((LS.FILE_INSTRUCTION_0002.IsEqualTo("CLOSE")))
            {
        ...
        private void M_1000_OPEN_FILES(string returnMethod = "")
        {
            ...
            {
                FD.OUTPUT_FILE_01.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-01
            }                                                                                                //COBOL==> WHEN 2
            else
            if ((LS.COUNT_0001.IsEqualTo(2)))
            {
                FD.OUTPUT_FILE_02.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-02
            }                                                                                                //COBOL==> WHEN 3
            else
            if ((LS.COUNT_0001.IsEqualTo(3)))
            {
                FD.OUTPUT_FILE_03.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-03
            }                                                                                                //COBOL==> WHEN 4
            else
            if ((LS.COUNT_0001.IsEqualTo(4)))
            {
                FD.OUTPUT_FILE_04.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-04
            }                                                                                                //COBOL==> WHEN 5
            else
            if ((LS.COUNT_0001.IsEqualTo(5)))
            {
                FD.OUTPUT_FILE_05.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-05
            }                                                                                                //COBOL==> WHEN 6
            else
            if ((LS.COUNT_0001.IsEqualTo(6)))
            {
                FD.OUTPUT_FILE_06.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-06
            }                                                                                                //COBOL==> WHEN 7
            else
            if ((LS.COUNT_0001.IsEqualTo(7)))
            {
                FD.OUTPUT_FILE_07.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-07
            }                                                                                                //COBOL==> WHEN 8
            else
            if ((LS.COUNT_0001.IsEqualTo(8)))
            {
                FD.OUTPUT_FILE_08.OpenFile(FileAccessMode.Write);                                                   //COBOL==> OPEN OUTPUT OUTPUT-FILE-08
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("BN");                                                            //COBOL==> MOVE 'BN' TO TEXT-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-EVALUATE
            ...
            if (returnMethod != "" && returnMethod != "M_1000_OPEN_FILES") { M_2000_WRITE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_WRITE_FILE(string returnMethod = "")
        {
            ...
            if ((LS.COUNT_0001.IsEqualTo(1)))                                                                   //COBOL==> WHEN 1
            {
                FD.RECORD_01_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-01-DETAIL
                FD.OUTPUT_FILE_01.WriteLine(FD.OUTPUT_RECORD_01.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-01
            }                                                                                                //COBOL==> WHEN 2
            else
            if ((LS.COUNT_0001.IsEqualTo(2)))
            {
                FD.RECORD_02_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-02-DETAIL
                FD.OUTPUT_FILE_02.WriteLine(FD.OUTPUT_RECORD_02.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-02
            }                                                                                                //COBOL==> WHEN 3
            else
            if ((LS.COUNT_0001.IsEqualTo(3)))
            {
                FD.RECORD_03_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-03-DETAIL
                FD.OUTPUT_FILE_03.WriteLine(FD.OUTPUT_RECORD_03.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-03
            }                                                                                                //COBOL==> WHEN 4
            else
            if ((LS.COUNT_0001.IsEqualTo(4)))
            {
                FD.RECORD_04_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-04-DETAIL
                FD.OUTPUT_FILE_04.WriteLine(FD.OUTPUT_RECORD_04.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-04
            }                                                                                                //COBOL==> WHEN 5
            else
            if ((LS.COUNT_0001.IsEqualTo(5)))
            {
                FD.RECORD_05_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-05-DETAIL
                FD.OUTPUT_FILE_05.WriteLine(FD.OUTPUT_RECORD_05.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-05
            }                                                                                                //COBOL==> WHEN 6
            else
            if ((LS.COUNT_0001.IsEqualTo(6)))
            {
                FD.RECORD_06_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-06-DETAIL
                FD.OUTPUT_FILE_06.WriteLine(FD.OUTPUT_RECORD_06.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-06
            }                                                                                                //COBOL==> WHEN 7
            else
            if ((LS.COUNT_0001.IsEqualTo(7)))
            {
                FD.RECORD_07_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-07-DETAIL
                FD.OUTPUT_FILE_07.WriteLine(FD.OUTPUT_RECORD_07.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-07
            }                                                                                                //COBOL==> WHEN 8
            else
            if ((LS.COUNT_0001.IsEqualTo(8)))
            {
                FD.RECORD_08_DETAIL.SetValue(LS.TEXT_LINE_80_0002);                                                 //COBOL==> MOVE TEXT-LINE-80-0002 TO RECORD-08-DETAIL
                FD.OUTPUT_FILE_08.WriteLine(FD.OUTPUT_RECORD_08.AsBytes);                                           //COBOL==> WRITE OUTPUT-RECORD-08
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("BN");                                                            //COBOL==> MOVE 'BN' TO TEXT-RETURN-CODE-0003
            ...
            if (returnMethod != "" && returnMethod != "M_2000_WRITE_FILE") { M_3000_CLOSE_FILES(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_3000_CLOSE_FILES(string returnMethod = "")
        {
            ...
            if ((LS.COUNT_0001.IsEqualTo(1)))                                                                   //COBOL==> WHEN 1
            {
                FD.OUTPUT_FILE_01.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-01
            }                                                                                                //COBOL==> WHEN 2
            else
            if ((LS.COUNT_0001.IsEqualTo(2)))
            {
                FD.OUTPUT_FILE_02.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-02
            }                                                                                                //COBOL==> WHEN 3
            else
            if ((LS.COUNT_0001.IsEqualTo(3)))
            {
                FD.OUTPUT_FILE_03.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-03
            }                                                                                                //COBOL==> WHEN 4
            else
            if ((LS.COUNT_0001.IsEqualTo(4)))
            {
                FD.OUTPUT_FILE_04.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-04
            }                                                                                                //COBOL==> WHEN 5
            else
            if ((LS.COUNT_0001.IsEqualTo(5)))
            {
                FD.OUTPUT_FILE_05.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-05
            }                                                                                                //COBOL==> WHEN 6
            else
            if ((LS.COUNT_0001.IsEqualTo(6)))
            {
                FD.OUTPUT_FILE_06.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-06
            }                                                                                                //COBOL==> WHEN 7
            else
            if ((LS.COUNT_0001.IsEqualTo(7)))
            {
                FD.OUTPUT_FILE_07.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-07
            }                                                                                                //COBOL==> WHEN 8
            else
            if ((LS.COUNT_0001.IsEqualTo(8)))
            {
                FD.OUTPUT_FILE_08.CloseFile();                                                                      //COBOL==> CLOSE OUTPUT-FILE-08
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("BN");                                                            //COBOL==> MOVE 'BN' TO TEXT-RETURN-CODE-0003
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0430965735_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0430965735_EXIT
        /// </summary>
        private void M_PARA_0430965735_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0430965735_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0430965735_EXIT") { M_PARA_0430965735_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0430965735_INIT
        /// </summary>
        private void M_PARA_0430965735_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0430965735_INIT") { M_PARA_0430965735_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0430965735_INIT_EXIT
        /// </summary>
        private void M_PARA_0430965735_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0430965735_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
