...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:04:36 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXEE39 : EABBase
    {
        ...
        private void M_2500_MOVE_DATA(string returnMethod = "")
        {
            ...
            if (!(FD.LOCATE_DOB.IsZeros()))                                                                     //COBOL==> IF LOCATE-DOB NOT = ZERO
            {
            ...
            if (!(FD.LOCATE_EXPIRE_DATE.IsZeros()))                                                             //COBOL==> IF LOCATE-EXPIRE-DATE NOT = ZERO
            {
            ...
            if (!(FD.LOCATE_REQUEST_DATE.IsZeros()))                                                            //COBOL==> IF LOCATE-REQUEST-DATE NOT = ZERO
            {
            ...
            if (!(FD.LOCATE_RESPONSE_DATE.IsZeros()))                                                           //COBOL==> IF LOCATE-RESPONSE-DATE NOT = ZERO
            {
            ...
            if (!(FD.LOCATE_ISSUED_DATE.IsZeros()))                                                             //COBOL==> IF LOCATE-ISSUED-DATE NOT = ZERO
            {
            ...
            if (!(FD.LOCATE_SUSPENDED_DATE.IsZeros()))                                                          //COBOL==> IF LOCATE-SUSPENDED-DATE NOT = ZERO
            {
