...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:51:59 PM
   **        *   FROM COBOL PGM   :  SWEXIU20
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_UPDATE_ALIAS                 DATE: 96/01/04
       TARGET OS:   MVS                       TIME: 10:22:34
       TARGET DBMS: DB2                       USER: SWMTHBS
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXIU20_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXIU20_ws_WorkingStorage";
            internal const string FUNC_0544741012_ESC_FLAG = "FUNC_0544741012_ESC_FLAG";
        ...
        public IField FUNC_0544741012_ESC_FLAG { get { return GetElementByName<IField>(Names.FUNC_0544741012_ESC_FLAG); } }
        ...
        {
            recordDef.CreateNewField(Names.FUNC_0544741012_ESC_FLAG, FieldType.String, 1);
            ...
            recordDef.CreateNewGroup(Names.EXTERNAL_ACTION_BLOCK_WS, (EXTERNAL_ACTION_BLOCK_WS) =>
           {
               ...
               EXTERNAL_ACTION_BLOCK_WS.CreateNewField(Names.SRMODLNK, FieldType.String, 8, "SWEXIU20");
    ...
    internal class SWEXIU20_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIU20_ls_LinkageSection";
            ...
            internal const string A_0544741015_IA = "A_0544741015_IA";
            ...
            internal const string DOB_0001AS = "DOB_0001AS";
            internal const string DOB_0001 = "DOB_0001";
            internal const string DOB_0001XX = "DOB_0001XX";
            ...
            internal const string A_0544741034_OA = "A_0544741034_OA";
        ...
        public IGroup A_0544741015_IA { get { return GetElementByName<IGroup>(Names.A_0544741015_IA); } }
        ...
        public IField DOB_0001AS { get { return GetElementByName<IField>(Names.DOB_0001AS); } }
        public IField DOB_0001 { get { return GetElementByName<IField>(Names.DOB_0001); } }
        public IField DOB_0001XX { get { return GetElementByName<IField>(Names.DOB_0001XX); } }
        ...
        public IGroup A_0544741034_OA { get { return GetElementByName<IGroup>(Names.A_0544741034_OA); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               W_IA.CreateNewGroup(Names.A_0544741015_IA, (A_0544741015_IA) =>
               {
                   A_0544741015_IA.CreateNewGroup(Names.INPUT_0001EV, (INPUT_0001EV) =>
                   {
                       INPUT_0001EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0001ET, (CSE_PERSONS_WORK_SET_0001ET) =>
                       {
                           ...
                           CSE_PERSONS_WORK_SET_0001ET.CreateNewField(Names.SEX_0001AS, FieldType.String, 1);

                           IField SEX_0001_local = CSE_PERSONS_WORK_SET_0001ET.CreateNewField(Names.SEX_0001, FieldType.String, 1);
                           CSE_PERSONS_WORK_SET_0001ET.CreateNewFieldRedefine(Names.SEX_0001XX, FieldType.String, SEX_0001_local, 1);
                           CSE_PERSONS_WORK_SET_0001ET.CreateNewField(Names.DOB_0001AS, FieldType.String, 1);

                           IField DOB_0001_local = CSE_PERSONS_WORK_SET_0001ET.CreateNewField(Names.DOB_0001, FieldType.SignedNumeric, 8);
                           CSE_PERSONS_WORK_SET_0001ET.CreateNewFieldRedefine(Names.DOB_0001XX, FieldType.String, DOB_0001_local, 8);
           ...
           {
               W_OA.CreateNewGroup(Names.A_0544741034_OA, (A_0544741034_OA) =>
               {
                   A_0544741034_OA.CreateNewGroup(Names.OUTPUT_0002EV, (OUTPUT_0002EV) =>
                   {
    ...
    public class SWEXIU20 : OnlineEABBase
    {
        ...
        public SWEXIU20(OnlineControl controlData) : base(controlData)
        {
            SetUpProgram();
        }
        ...
        private SWEXIU20_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXIU20_ls LS;
        #endregion
        ...
        protected override void RunMain(string startLabel, string returnLbl)
        {
            ...
            switch (startLabel)
            {
                case "PARA-0544741012-INIT": goto L_PARA_0544741012_INIT; break;
                case "PARA-0544741012": goto L_PARA_0544741012; break;
                case "9999-CICS-ABEND": goto L_9999_CICS_ABEND; break;
                case "0500-COMMON-CLIENT-ROUTINE": goto L_0500_COMMON_CLIENT_ROUTINE; break;
                case "5000-UPDT-ALIAS-CLIENT": goto L_5000_UPDT_ALIAS_CLIENT; break;
                case "5500-UPDT-ALIAS-CSE-FLAG": goto L_5500_UPDT_ALIAS_CSE_FLAG; break;
                ...
                case "8270-INSERT-SYS-PART": goto L_8270_INSERT_SYS_PART; break;
                case "5900-PROCESS-ALL-SYSTEM-PART": goto L_5900_PROCESS_ALL_SYSTEM_PART; break;
        ...
        #region MAIN-0544741012
        L_MAIN_0544741012:;
            Perform("PARA-0544741012-INIT", "PARA-0544741012-INIT-EXIT"); if (Control.ExitProgram) { return; }    //COBOL==> PERFORM PARA-0544741012-INIT THRU PARA-0544741012-INIT-EXIT
            Perform("PARA-0544741012", "PARA-0544741012-EXIT"); if (Control.ExitProgram) { return; }              //COBOL==> PERFORM PARA-0544741012 THRU PARA-0544741012-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        #endregion MAIN-0544741012

        #region PARA-0544741012
        L_PARA_0544741012:;
            WS.FUNC_0544741012_ESC_FLAG.SetValue("N");                                                          //COBOL==> MOVE 'N' TO FUNC-0544741012-ESC-FLAG.
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT: ****************************************************************
            ///COMMENT: *                                                              *
            ///COMMENT:  INCLUDE NAME:  SWCSZG21.                                      *
            ///COMMENT:      EAB NAME:  SWEXIU20.                                      *
            ...
            ///COMMENT:                                                                *
            ///COMMENT:                                                                *
            ///COMMENT:  01/17/17 RAJ     CQ35825 MODIFIED TO SET DB2 DEFAULT DATE     *
            ///COMMENT:                           VALUE TO CLIENT DATE OF BIRTH FIELD  *
            ///COMMENT:                           WHEN THERE IS NO VALUE PASSED.       *
            ///COMMENT:                                                                *
            ///COMMENT: ****************************************************************
            if (returnLabel == "PARA-0544741012") { return; }  //Check for pass through to next method
        #endregion PARA-0544741012
        ...
        L_0000_ADABAS_ROUTINE:;
            ...
            WS.IMP_LAST_NAME.SetValue(LS.LAST_NAME_0001);                                                       //COBOL==> MOVE LAST-NAME-0001 TO IMP-LAST-NAME.
            WS.IMP_FIRST_NAME.SetValue(LS.FIRST_NAME_0001);                                                     //COBOL==> MOVE FIRST-NAME-0001 TO IMP-FIRST-NAME.
            WS.IMP_INITIAL.SetValue(LS.MIDDLE_INITIAL_0001);                                                    //COBOL==> MOVE MIDDLE-INITIAL-0001 TO IMP-INITIAL.
            WS.IMP_DATE_OF_BIRTH.SetValue(LS.DOB_0001);                                                         //COBOL==> MOVE DOB-0001 TO IMP-DATE-OF-BIRTH.
                                                                                                                //COMMENT: ****************************************************************
                                                                                                                //COMMENT:   IF DATE OF BIRTH IS ZEROS, SET IT EQUAL TO SPACES. TS 3/9/99
                                                                                                                //COMMENT: ****************************************************************
            ...
            WS.IMP_SEX.SetValue(LS.SEX_0001);                                                                   //COBOL==> MOVE SEX-0001 TO IMP-SEX.
            WS.IMP_SOC_SEC_NUM_X9.SetValue(LS.SSN_0001);                                                        //COBOL==> MOVE SSN-0001 TO IMP-SOC-SEC-NUM-X9.
            ...
            Perform("5000-UPDT-ALIAS-CLIENT", "5000-EXIT"); if (Control.ExitProgram) { return; }                  //COBOL==> PERFORM 5000-UPDT-ALIAS-CLIENT THRU 5000-EXIT.
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                goto L_0000_ADABAS_EXIT;                                                                            //COBOL==> GO TO 0000-ADABAS-EXIT
            }                                                                                                   //COBOL==> END-IF.
        ...
        L_0000_ADABAS_EXIT:;
            ...
            DisplayToLog("**** START SWEXIU20 *****");                                                          //COBOL==> DISPLAY "**** START SWEXIU20 *****"
            DisplayToLog("ABEND    INFO.:" + LS.ABEND_DATA_0002ET.AsString());                                  //COBOL==> DISPLAY "ABEND    INFO.:" ABEND-DATA-0002ET
            DisplayToLog("INPUT    INFO.:" + LS.INPUT_0001EV.AsString());                                       //COBOL==> DISPLAY "INPUT    INFO.:" INPUT-0001EV
            DisplayToLog("****  END  SWEXIU20 *****");                                                          //COBOL==> DISPLAY "****  END  SWEXIU20 *****".
            ///COMMENT: WBR START
            ///COMMENT: *****************************************************************
        ...
        #region 5000-UPDT-ALIAS-CLIENT
        L_5000_UPDT_ALIAS_CLIENT:;
            WS.WS_UPD_UNIQUE_KEY.SetValue(LS.UNIQUE_KEY_0001);                                                  //COBOL==> MOVE UNIQUE-KEY-0001 TO WS-UPD-UNIQUE-KEY.
            if (((((((WS.WS_UUK_CLIENT_NUMBER.IsEqualTo(LS.NUMBER_0001))
             && (WS.WS_UUK_CLI_LAST_NAME.IsEqualTo(LS.LAST_NAME_0001)))
             && (WS.WS_UUK_CLI_FIRST_NAME.IsEqualTo(LS.FIRST_NAME_0001)))
             && (WS.WS_UUK_CLI_INITIAL.IsEqualTo(LS.MIDDLE_INITIAL_0001)))
             && (WS.WS_UUK_SSN.IsEqualTo(LS.SSN_0001)))
             && (WS.WS_UUK_DOB.IsEqualTo(LS.DOB_0001)))
             && (WS.WS_UUK_SEX.IsEqualTo(LS.SEX_0001)))  //COBOL==> IF WS-UUK-CLIENT-NUMBER = NUMBER-0001 AND WS-UUK-CLI-LAST-NAME = LAST-NAME-0001 AND WS-UUK-CLI-FIRST-NAME = FIRST-NAME-0001 AND WS-UUK-CLI-INITIAL = MIDDLE-INITIAL-0001 AND WS-UUK-SSN = SSN-0001 AND WS-UUK-DOB = DOB-0001 AND WS-UUK-SEX = SEX-0001
            {
                ...
                WS.MV_ADA_FILE_ACTION.SetValue("CAE");                                                              //COBOL==> MOVE 'CAE' TO MV-ADA-FILE-ACTION
                WS.MV_ADA_RESPONSE_CD.SetValueWithZeroes();                                                         //COBOL==> MOVE ZERO TO MV-ADA-RESPONSE-CD
                goto L_5000_EXIT;                                                                                   //COBOL==> GO TO 5000-EXIT
            }                                                                                                   //COBOL==> END-IF.
            if (WS.IMP_CLIENT_KEY.IsSpaces())                                                                   //COBOL==> IF IMP-CLIENT-KEY = SPACES
            {
                Perform("5500-UPDT-ALIAS-CSE-FLAG", "5500-EXIT"); if (Control.ExitProgram) { return; }                //COBOL==> PERFORM 5500-UPDT-ALIAS-CSE-FLAG THRU 5500-EXIT
                goto L_5000_EXIT;                                                                                   //COBOL==> GO TO 5000-EXIT
            }                                                                                                   //COBOL==> END-IF.
        ...
        EndOfSentence_1:;
            ...
            if (!(WS.IMP_SOC_SEC_NUM.IsEqualTo(WS.MV_CIK_SSN)))                                                 //COBOL==> IF IMP-SOC-SEC-NUM NOT = MV-CIK-SSN
            {
            ...
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                goto L_5000_EXIT;                                                                                   //COBOL==> GO TO 5000-EXIT
                                                                                                                ...
                                                                                                                //COMMENT: ****************************************************************
            WS.CLIENT_FK_CLB_CLIENT_NO.SetValue(WS.WS_UUK_CLIENT_NUMBER);                                       //COBOL==> MOVE WS-UUK-CLIENT-NUMBER TO CLIENT-FK-CLB-CLIENT-NO.
            WS.CLIENT_SSN.SetValue(WS.WS_UUK_SSN);                                                              //COBOL==> MOVE WS-UUK-SSN TO CLIENT-SSN.
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(1, 4, WS.WS_UUK_DOB.GetSubstring(1, 4).AsString());     //COBOL==> MOVE WS-UUK-DOB ( 1:4 ) TO CLIENT-DATE-OF-BIRTH ( 1:4 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(5, 1, "-");                                             //COBOL==> MOVE '-' TO CLIENT-DATE-OF-BIRTH ( 5:1 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(6, 2, WS.WS_UUK_DOB.GetSubstring(5, 2).AsString());     //COBOL==> MOVE WS-UUK-DOB ( 5:2 ) TO CLIENT-DATE-OF-BIRTH ( 6:2 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(8, 1, "-");                                             //COBOL==> MOVE '-' TO CLIENT-DATE-OF-BIRTH ( 8:1 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(9, 2, WS.WS_UUK_DOB.GetSubstring(7, 2).AsString());     //COBOL==> MOVE WS-UUK-DOB ( 7:2 ) TO CLIENT-DATE-OF-BIRTH ( 9:2 ) .
            WS.CLIENT_GENDER.SetValue(WS.WS_UUK_SEX);                                                           //COBOL==> MOVE WS-UUK-SEX TO CLIENT-GENDER.
            WS.CLIENT_CLIENT_NAME.SetValue(WS.WS_UUK_CLIENT_NAME);                                              //COBOL==> MOVE WS-UUK-CLIENT-NAME TO CLIENT-CLIENT-NAME.
            ...
            if (WS.MV_ABEND_TYPE_NONE.Value)                                                                    //COBOL==> IF MV-ABEND-TYPE-NONE
            {
                ...
                Perform("7900-BUILD-CLI-PTR-DATA", "7900-EXIT"); if (Control.ExitProgram) { return; }                 //COBOL==> PERFORM 7900-BUILD-CLI-PTR-DATA THRU 7900-EXIT
                                                                                                                      //COMMENT: 821
                goto L_5000_GO_DO_IT;                                                                               //COBOL==> GO TO 5000-GO-DO-IT
            }                                                                                                   //COBOL==> ELSE
            else
            {
                goto L_5000_EXIT;                                                                                   //COBOL==> GO TO 5000-EXIT
            ...
            ///COMMENT: *****************************************************************
            if (returnLabel == "5000-UPDT-ALIAS-CLIENT") { return; }  //Check for pass through to next method
        #endregion 5000-UPDT-ALIAS-CLIENT

        #region 5000-UPDT-ALIAS-CLIENT-LOOP
        L_5000_UPDT_ALIAS_CLIENT_LOOP:;
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                goto L_5000_EXIT;                                                                                   //COBOL==> GO TO 5000-EXIT
            }                                                                                                   //COBOL==> END-IF.
            ...
            {
                goto L_5000_UPDT_ALIAS_CLIENT_CONT;                                                                 //COBOL==> GO TO 5000-UPDT-ALIAS-CLIENT-CONT
            }                                                                                                   //COBOL==> END-IF.
                                                                                                                //COMMENT: *****************************************************************
            ...
            if (!(WS.MV_CLIENT_ID.IsEqualTo(WS.CLIENT_FK_CLB_CLIENT_NO)))                                       //COBOL==> IF MV-CLIENT-ID NOT = CLIENT-FK-CLB-CLIENT-NO
            {
                goto L_5000_UPDT_ALIAS_CLIENT_CONT;                                                                 //COBOL==> GO TO 5000-UPDT-ALIAS-CLIENT-CONT
            }                                                                                                   //COBOL==> END-IF.
            if ((((WS.CLIENT_CLIENT_NAME.IsEqualTo(WS.IMP_NAME))
             && (WS.CLIENT_SSN.IsEqualTo(WS.IMP_SOC_SEC_NUM)))
             && (WS.CLIENT_WS_DATE_OF_BIRTH.IsEqualTo(WS.IMP_DATE_OF_BIRTH_X8)))
             && (WS.CLIENT_GENDER.IsEqualTo(WS.IMP_SEX)))  //COBOL==> IF CLIENT-CLIENT-NAME = IMP-NAME AND CLIENT-SSN = IMP-SOC-SEC-NUM AND CLIENT-WS-DATE-OF-BIRTH = IMP-DATE-OF-BIRTH-X8 AND CLIENT-GENDER = IMP-SEX
            {
                WS.MV_ABEND_TYPE.SetValue("A");                                                                     //COBOL==> MOVE 'A' TO MV-ABEND-TYPE
                WS.MV_ADA_FILE_NUMBER.SetValue(149);                                                                //COBOL==> MOVE 149 TO MV-ADA-FILE-NUMBER
                                                                                                                    //COMMENT: ******* FILE = C * AE = ALREADY EXISTS **************************
            ...
            goto L_5000_UPDT_ALIAS_CLIENT_LOOP;                                                                 //COBOL==> GO TO 5000-UPDT-ALIAS-CLIENT-LOOP.
        ///COMMENT: *****************************************************************
        ///COMMENT:  CONTINUE UPDATING ALIAS CLIENT INFORMATION
        ///COMMENT: *****************************************************************
        #endregion 5000-UPDT-ALIAS-CLIENT-LOOP

        #region 5000-UPDT-ALIAS-CLIENT-CONT
        L_5000_UPDT_ALIAS_CLIENT_CONT:;
            ...
            WS.CLIENT_DATE_OF_BIRTH.SetValue(WS.IMP_CLIKEY_DATE_OF_BIRTH);                                      //COBOL==> MOVE IMP-CLIKEY-DATE-OF-BIRTH TO CLIENT-DATE-OF-BIRTH
            ...
            WS.MV_CLIENT_POINTER.SetValue(WS.WS_CLIENT_POINTER);                                                //COBOL==> MOVE WS-CLIENT-POINTER TO MV-CLIENT-POINTER.
                                                                                                                //COMMENT: *****************************************************************
            WS.MV_CIK_CLIENT_POINTER_X10.SetValue(WS.MV_CLIENT_POINTER_X10);                                    //COBOL==> MOVE MV-CLIENT-POINTER-X10 TO MV-CIK-CLIENT-POINTER-X10.
            ...
            if (!(WS.MV_CLIENT_ID_KEY.IsEqualTo(WS.IMP_CLIENT_KEY)))                                            //COBOL==> IF MV-CLIENT-ID-KEY NOT = IMP-CLIENT-KEY
            {
                WS.MV_ABEND_TYPE.SetValue("A");                                                                     //COBOL==> MOVE 'A' TO MV-ABEND-TYPE
                WS.MV_ADA_FILE_NUMBER.SetValue(149);                                                                //COBOL==> MOVE 149 TO MV-ADA-FILE-NUMBER
            ...
            if (!(WS.IMP_SOC_SEC_NUM.IsEqualTo(WS.CLIENT_SSN)))                                                 //COBOL==> IF IMP-SOC-SEC-NUM NOT = CLIENT-SSN
            {
                WS.CLIENT_PREVIOUS_SSN.SetValue(WS.CLIENT_SSN);                                                     //COBOL==> MOVE CLIENT-SSN TO CLIENT-PREVIOUS-SSN
                WS.MV_CIK_VERIFIED_SSN_FLAG.SetValue("N");                                                          //COBOL==> MOVE 'N' TO MV-CIK-VERIFIED-SSN-FLAG CLIENT-VERIFIED-SSN-FLAG
                WS.CLIENT_VERIFIED_SSN_FLAG.SetValue("N");
                WS.MV_CLIENT_POINTER_X21.SetValue(WS.MV_CIK_CLIENT_POINTER_X21);                                    //COBOL==> MOVE MV-CIK-CLIENT-POINTER-X21 TO MV-CLIENT-POINTER-X21
                WS.WS_CLIENT_POINTER.SetValue(WS.MV_CLIENT_POINTER_X31);                                            //COBOL==> MOVE MV-CLIENT-POINTER-X31 TO WS-CLIENT-POINTER
            ...
            WS.CLIENT_PHONETIC_DATA.SetValue(WS.MV_PHONETIC_DATA);                                              //COBOL==> MOVE MV-PHONETIC-DATA TO CLIENT-PHONETIC-DATA.
                                                                                                                ...
                                                                                                                //COMMENT: *****************************************************************
            WS.MV_CLIENT_ID_KEY.SetValue(WS.WS_UPD_UNIQUE_KEY);                                                 //COBOL==> MOVE WS-UPD-UNIQUE-KEY TO MV-CLIENT-ID-KEY.
            ...
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(9, 2, WS.WS_UUK_DOB.GetSubstring(7, 2).AsString());     //COBOL==> MOVE WS-UUK-DOB ( 7:2 ) TO CLIENT-DATE-OF-BIRTH ( 9:2 ) .
            WS.CLIENT_GENDER.SetValue(WS.WS_UUK_SEX);                                                           //COBOL==> MOVE WS-UUK-SEX TO CLIENT-GENDER.
            WS.CLIENT_VERIFIED_SSN_FLAG.SetValue(WS.WS_UUK_VERIFY_FLAG);                                        //COBOL==> MOVE WS-UUK-VERIFY-FLAG TO CLIENT-VERIFIED-SSN-FLAG.
            Perform("8149CF-READLOG-CLIENT-DBF", "8149CF-READLOG-EXIT"); if (Control.ExitProgram) { return; }     //COBOL==> PERFORM 8149CF-READLOG-CLIENT-DBF THRU 8149CF-READLOG-EXIT.
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                goto L_5000_EXIT;                                                                                   //COBOL==> GO TO 5000-EXIT
            }                                                                                                   //COBOL==> END-IF.
            if (returnLabel == "5000-UPDT-ALIAS-CLIENT-CONT") { return; }  //Check for pass through to next method
        #endregion 5000-UPDT-ALIAS-CLIENT-CONT

        #region 5000-GO-DO-IT
        L_5000_GO_DO_IT:;
            ...
            WS.SYSPART_FK_CLI_SSN.SetValue(WS.CLIENT_SSN);                                                      //COBOL==> MOVE CLIENT-SSN TO SYSPART-FK-CLI-SSN.
                                                                                                                //COMMENT: 821 MOVE WS-SYS-CD-CS TO SYSPART-SYSTEM-CODE.
                                                                                                                //COMMENT: 821 PERFORM 8260-SELECT-SYS-PART THRU
                                                                                                                //COMMENT: 821         8260-EXIT.
            WS.SYSPART_FK_CLB_CLIENT_NO.SetValue(WS.WS_UUK_CLIENT_NUMBER);                                      //COBOL==> MOVE WS-UUK-CLIENT-NUMBER TO SYSPART-FK-CLB-CLIENT-NO CLIENT-FK-CLB-CLIENT-NO.
            WS.CLIENT_FK_CLB_CLIENT_NO.SetValue(WS.WS_UUK_CLIENT_NUMBER);
            WS.SYSPART_FK_CLI_CLIENT_NAME.SetValue(WS.WS_UUK_CLIENT_NAME);                                      //COBOL==> MOVE WS-UUK-CLIENT-NAME TO SYSPART-FK-CLI-CLIENT-NAME CLIENT-CLIENT-NAME.
            WS.CLIENT_CLIENT_NAME.SetValue(WS.WS_UUK_CLIENT_NAME);
            WS.SYSPART_FK_CLI_SSN.SetValue(WS.WS_UUK_SSN);                                                      //COBOL==> MOVE WS-UUK-SSN TO SYSPART-FK-CLI-SSN CLIENT-SSN.
            WS.CLIENT_SSN.SetValue(WS.WS_UUK_SSN);
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(1, 4, WS.WS_UUK_DOB.GetSubstring(1, 4).AsString());     //COBOL==> MOVE WS-UUK-DOB ( 1:4 ) TO CLIENT-DATE-OF-BIRTH ( 1:4 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(5, 1, "-");                                             //COBOL==> MOVE '-' TO CLIENT-DATE-OF-BIRTH ( 5:1 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(6, 2, WS.WS_UUK_DOB.GetSubstring(5, 2).AsString());     //COBOL==> MOVE WS-UUK-DOB ( 5:2 ) TO CLIENT-DATE-OF-BIRTH ( 6:2 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(8, 1, "-");                                             //COBOL==> MOVE '-' TO CLIENT-DATE-OF-BIRTH ( 8:1 ) .
            ...
            WS.SYSPART_SYSTEM_CODE.SetValue(WS.WS_SYS_CD_CS);                                                   //COBOL==> MOVE WS-SYS-CD-CS TO SYSPART-SYSTEM-CODE.
                                                                                                                //COMMENT: 811 PERFORM 8250-DELETE-SYS-PART THRU
                                                                                                                //COMMENT: 811         8250-EXIT.
            ...
            WS.CLIENT_CLIENT_NAME.SetValue(WS.IMP_NAME);                                                        //COBOL==> MOVE IMP-NAME TO CLIENT-CLIENT-NAME SYSPART-FK-CLI-CLIENT-NAME.
            WS.SYSPART_FK_CLI_CLIENT_NAME.SetValue(WS.IMP_NAME);
            WS.CLIENT_SSN.SetValue(WS.IMP_SOC_SEC_NUM);                                                         //COBOL==> MOVE IMP-SOC-SEC-NUM TO CLIENT-SSN SYSPART-FK-CLI-SSN.
            WS.SYSPART_FK_CLI_SSN.SetValue(WS.IMP_SOC_SEC_NUM);
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(1, 4, WS.IMP_DATE_OF_BIRTH_X8.GetSubstring(1, 4).AsString());  //COBOL==> MOVE IMP-DATE-OF-BIRTH-X8 ( 1:4 ) TO CLIENT-DATE-OF-BIRTH ( 1:4 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(5, 1, "-");                                             //COBOL==> MOVE '-' TO CLIENT-DATE-OF-BIRTH ( 5:1 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(6, 2, WS.IMP_DATE_OF_BIRTH_X8.GetSubstring(5, 2).AsString());  //COBOL==> MOVE IMP-DATE-OF-BIRTH-X8 ( 5:2 ) TO CLIENT-DATE-OF-BIRTH ( 6:2 ) .
            WS.CLIENT_DATE_OF_BIRTH.SetValueOfSubstring(8, 1, "-");                                             //COBOL==> MOVE '-' TO CLIENT-DATE-OF-BIRTH ( 8:1 ) .
            ...
            WS.CLIENT_FK_CLB_CLIENT_NO.SetValue(WS.MV_CLIENT_ID);                                               //COBOL==> MOVE MV-CLIENT-ID TO CLIENT-FK-CLB-CLIENT-NO SYSPART-FK-CLB-CLIENT-NO.
            WS.SYSPART_FK_CLB_CLIENT_NO.SetValue(WS.MV_CLIENT_ID);
            ...
            if (WS.MV_ABEND_TYPE_NONE.Value)                                                                    //COBOL==> IF MV-ABEND-TYPE-NONE
            {
                ...
                Perform("8270-INSERT-SYS-PART", "8270-EXIT"); if (Control.ExitProgram) { return; }                    //COBOL==> PERFORM 8270-INSERT-SYS-PART THRU 8270-EXIT
                                                                                                                      //COMMENT: 819 * LOGIC TO MAKE SURE ALL SYSTEM PARTICIPATIONS ARE THERE
                Perform("5900-PROCESS-ALL-SYSTEM-PART", "5900-EXIT"); if (Control.ExitProgram) { return; }            //COBOL==> PERFORM 5900-PROCESS-ALL-SYSTEM-PART THRU 5900-EXIT
                                                                                                                      //COMMENT: 819 * LOGIC TO MAKE SURE ALL SYSTEM PARTICIPATIONS ARE THERE
            }                                                                                                   //COBOL==> END-IF.
            if (returnLabel == "5000-GO-DO-IT") { return; }  //Check for pass through to next method
        #endregion 5000-GO-DO-IT

        #region 5000-EXIT
        L_5000_EXIT:;
            if (returnLabel == "5000-EXIT") { return; }                                                         //COBOL==> EXIT.
        ///COMMENT: 819 * LOGIC TO MAKE SURE ALL SYSTEM PARTICIPATIONS ARE THERE
        ///COMMENT: *****************************************************************
        ///COMMENT:  THIS ROUTINE MAKES SURE ALL THE SYSTEMS THE CLIENT IS
        ///COMMENT:  PARTICIPATING IN ARE PUT BACK OUT WHEN THE CLIENT NAME OR
        ///COMMENT:  SSN CHANGES ON A CLIENT ALIAS
        ///COMMENT:  NOTE: THE FORIEGN KEY DATA WAS ALREADY MOVED TO THE HOST
        ///COMMENT:  NOTE: VARIAABLE BERFORR THIS ROUTINE IS PERFORMED
        ///COMMENT: *****************************************************************
        #endregion 5000-EXIT

        #region 5900-PROCESS-ALL-SYSTEM-PART
        L_5900_PROCESS_ALL_SYSTEM_PART:;
            for (WS.WS_INS_PART_CNT.SetValue(1); (!(WS.WS_INS_PART_CNT.IsGreaterThan(WS.WS_SYS_PART_CNT))); WS.WS_INS_PART_CNT.Add(1))  //COBOL==> PERFORM VARYING WS-INS-PART-CNT FROM 1 BY 1 UNTIL WS-INS-PART-CNT > WS-SYS-PART-CNT
            {
                WS.SYSPART_SYSTEM_CODE.SetValue(WS.WS_DB2_SYSTEM_CODE[WS.WS_INS_PART_CNT.AsInt()]);                 //COBOL==> MOVE WS-DB2-SYSTEM-CODE ( WS-INS-PART-CNT ) TO SYSPART-SYSTEM-CODE
                WS.SYSPART_PARTICIPATION_FLAG.SetValue(WS.WS_DB2_PARTICIPATION_FLAG[WS.WS_INS_PART_CNT.AsInt()]);   //COBOL==> MOVE WS-DB2-PARTICIPATION-FLAG ( WS-INS-PART-CNT ) TO SYSPART-PARTICIPATION-FLAG
                WS.SYSPART_CREATED_TIMESTAMP.SetValue(WS.WS_DB2_CREATED_TIMESTAMP[WS.WS_INS_PART_CNT.AsInt()]);     //COBOL==> MOVE WS-DB2-CREATED-TIMESTAMP ( WS-INS-PART-CNT ) TO SYSPART-CREATED-TIMESTAMP
                WS.SYSPART_CREATED_BY.SetValue(WS.WS_DB2_CREATED_BY[WS.WS_INS_PART_CNT.AsInt()]);                   //COBOL==> MOVE WS-DB2-CREATED-BY ( WS-INS-PART-CNT ) TO SYSPART-CREATED-BY
                Perform("8270-INSERT-SYS-PART", "8270-EXIT"); if (Control.ExitProgram) { return; }                    //COBOL==> PERFORM 8270-INSERT-SYS-PART THRU 8270-EXIT
            }                                                                                                   //COBOL==> END-PERFORM.
            if (returnLabel == "5900-PROCESS-ALL-SYSTEM-PART") { return; }  //Check for pass through to next method
        #endregion 5900-PROCESS-ALL-SYSTEM-PART

        #region 5900-EXIT
        L_5900_EXIT:;
            if (returnLabel == "5900-EXIT") { return; }                                                         //COBOL==> EXIT.
        ///COMMENT: 819 * LOGIC TO MAKE SURE ALL SYSTEM PARTICIPATIONS ARE THERE
        #endregion 5900-EXIT

        #region PARA-0544741012-EXIT
        L_PARA_0544741012_EXIT:;
            if (returnLabel == "PARA-0544741012-EXIT") { return; }                                              //COBOL==> EXIT.
        ///COMMENT: *****************************************************************
        ///COMMENT:                                                                 *
        ...
        ///COMMENT: *****************************************************************
        #endregion PARA-0544741012-EXIT
        ...
        #region PARA-0544741012-INIT
        L_PARA_0544741012_INIT:;
            LS.OUTPUT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE OUTPUT-0002EV .
            if (returnLabel == "PARA-0544741012-INIT") { return; }  //Check for pass through to next method
        #endregion PARA-0544741012-INIT

        #region PARA-0544741012-INIT-EXIT
        L_PARA_0544741012_INIT_EXIT:;
            if (returnLabel == "PARA-0544741012-INIT-EXIT") { return; }                                         //COBOL==> EXIT.
            #endregion PARA-0544741012-INIT-EXIT
        }
        #endregion
    }
    #endregion
