...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:50:05 PM
   **        *   FROM COBOL PGM   :  SWEXIC10
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_CREATE_CSE_PERSON            DATE: 95/11/06
       TARGET OS:   MVS                       TIME: 15:28:26
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXIC10_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXIC10_ws_WorkingStorage";
            internal const string FUNC_0329245189_ESC_FLAG = "FUNC_0329245189_ESC_FLAG";
        ...
        public IField FUNC_0329245189_ESC_FLAG { get { return GetElementByName<IField>(Names.FUNC_0329245189_ESC_FLAG); } }
        ...
        {
            recordDef.CreateNewField(Names.FUNC_0329245189_ESC_FLAG, FieldType.String, 1);
            ...
            recordDef.CreateNewGroup(Names.EXTERNAL_ACTION_BLOCK_WS, (EXTERNAL_ACTION_BLOCK_WS) =>
           {
               ...
               EXTERNAL_ACTION_BLOCK_WS.CreateNewField(Names.SRMODLNK, FieldType.String, 8, "SWEXIC10");
    ...
    internal class SWEXIC10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIC10_ls_LinkageSection";
            ...
            internal const string A_0329245193_IA = "A_0329245193_IA";
            ...
            internal const string A_0329245195_OA = "A_0329245195_OA";
        ...
        public IGroup A_0329245193_IA { get { return GetElementByName<IGroup>(Names.A_0329245193_IA); } }
        ...
        public IGroup A_0329245195_OA { get { return GetElementByName<IGroup>(Names.A_0329245195_OA); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               W_IA.CreateNewGroup(Names.A_0329245193_IA, (A_0329245193_IA) =>
               {
                   A_0329245193_IA.CreateNewGroup(Names.IMPORT_NEW_0001EV, (IMPORT_NEW_0001EV) =>
                   {
           ...
           {
               W_OA.CreateNewGroup(Names.A_0329245195_OA, (A_0329245195_OA) =>
               {
                   A_0329245195_OA.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
                   {
                   ...
                   A_0329245195_OA.CreateNewGroup(Names.EXPORT_0003EV, (EXPORT_0003EV) =>
                   {
    ...
    public class SWEXIC10 : OnlineEABBase
    {
        ...
        public SWEXIC10(OnlineControl controlData) : base(controlData)
        {
            SetUpProgram();
        }
        ...
        private SWEXIC10_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXIC10_ls LS;
        #endregion
        ...
        protected override void RunMain(string startLabel, string returnLbl)
        {
            ...
            switch (startLabel)
            {
                case "PARA-0329245189-INIT": goto L_PARA_0329245189_INIT; break;
                case "PARA-0329245189": goto L_PARA_0329245189; break;
                case "9999-CICS-ABEND": goto L_9999_CICS_ABEND; break;
                case "0500-COMMON-CLIENT-ROUTINE": goto L_0500_COMMON_CLIENT_ROUTINE; break;
                case "1000-ADD-PRIMARY-CLIENT": goto L_1000_ADD_PRIMARY_CLIENT; break;
        ...
        #region MAIN-0329245189
        L_MAIN_0329245189:;
            Perform("PARA-0329245189-INIT", "PARA-0329245189-INIT-EXIT"); if (Control.ExitProgram) { return; }    //COBOL==> PERFORM PARA-0329245189-INIT THRU PARA-0329245189-INIT-EXIT
            Perform("PARA-0329245189", "PARA-0329245189-EXIT"); if (Control.ExitProgram) { return; }              //COBOL==> PERFORM PARA-0329245189 THRU PARA-0329245189-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        #endregion MAIN-0329245189

        #region PARA-0329245189
        L_PARA_0329245189:;
            WS.FUNC_0329245189_ESC_FLAG.SetValue("N");                                                          //COBOL==> MOVE 'N' TO FUNC-0329245189-ESC-FLAG.
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT: ****************************************************************
            ///COMMENT:                                                                *
            ///COMMENT:  INCLUDE NAME:  SWCSZG17.                                      *
            ///COMMENT:      EAB NAME:  SWEXIC10.                                      *
            ...
            ///COMMENT:  -------  ------  ------  ------------------------------------ *
            ///COMMENT:                                                                *
            ///COMMENT:  01/12/17 RAJ     CQ35825 MODIFIED TO SET DB2 DEFAULT DATE     *
            ///COMMENT:                           VALUE TO CLIENT DATE OF BIRTH FIELD  *
            ///COMMENT:                           WHEN THERE IS NO VALUE PASSED.       *
            ///COMMENT:                                                                *
            ///COMMENT: ****************************************************************
            if (returnLabel == "PARA-0329245189") { return; }  //Check for pass through to next method
        #endregion PARA-0329245189
        ...
        L_0000_ADABAS_ROUTINE:;
            ...
            SetHandleCondtions(HandleCondition.ERROR, "9999-CICS-ABEND");                                       //COBOL==> EXEC CICS HANDLE CONDITION ERROR ( 9999-CICS-ABEND ) END-EXEC.
                                                                                                                ...
                                                                                                                //COMMENT: ****************************************************************
            WS.IMP_CLIENT_NUMBER_X10.SetValue("0000000000");                                                    //COBOL==> MOVE '0000000000' TO IMP-CLIENT-NUMBER-X10.
            ...
            Perform("1000-ADD-PRIMARY-CLIENT", "1000-EXIT"); if (Control.ExitProgram) { return; }                 //COBOL==> PERFORM 1000-ADD-PRIMARY-CLIENT THRU 1000-EXIT.
            if (!(WS.MV_ABEND_TYPE_NONE.Value))                                                                //COBOL==> IF NOT MV-ABEND-TYPE-NONE
            {
                goto L_0000_ADABAS_EXIT;                                                                            //COBOL==> GO TO 0000-ADABAS-EXIT
            }                                                                                                   //COBOL==> END-IF.
        ...
        L_0000_ADABAS_EXIT:;
            ...
            {
                LS.TYPE_0003.SetValueWithSpaces();                                                                  //COBOL==> MOVE SPACES TO TYPE-0003 ADABAS-FILE-NUMBER-0003 ADABAS-FILE-ACTION-0003 ADABAS-RESPONSE-CD-0003 CICS-RESOURCE-NM-0003 CICS-FUNCTION-CD-0003 CICS-RESPONSE-CD-0003
                LS.ADABAS_FILE_NUMBER_0003.SetValueWithSpaces();
                LS.ADABAS_FILE_ACTION_0003.SetValueWithSpaces();
                LS.ADABAS_RESPONSE_CD_0003.SetValueWithSpaces();
                LS.CICS_RESOURCE_NM_0003.SetValueWithSpaces();
                LS.CICS_FUNCTION_CD_0003.SetValueWithSpaces();
                LS.CICS_RESPONSE_CD_0003.SetValueWithSpaces();
            }                                                                                                   //COBOL==> END-IF.
            DisplayToLog("**** START SWEXIC10 *****");                                                          //COBOL==> DISPLAY "**** START SWEXIC10 *****"
            DisplayToLog(LS.IMPORT_NEW_0001EV.AsString());                                                      //COBOL==> DISPLAY IMPORT-NEW-0001EV
            DisplayToLog(LS.ABEND_DATA_0003ET.AsString());                                                      //COBOL==> DISPLAY ABEND-DATA-0003ET
            DisplayToLog(LS.TYPE_0003.AsString());                                                              //COBOL==> DISPLAY TYPE-0003
            DisplayToLog(LS.ADABAS_FILE_ACTION_0003.AsString());                                                //COBOL==> DISPLAY ADABAS-FILE-ACTION-0003
            DisplayToLog(LS.ADABAS_RESPONSE_CD_0003.AsString());                                                //COBOL==> DISPLAY ADABAS-RESPONSE-CD-0003
            DisplayToLog("****  END  SWEXIC10 *****");                                                          //COBOL==> DISPLAY "****  END  SWEXIC10 *****".
            if (returnLabel == "0000-ADABAS-EXIT") { return; }  //Check for pass through to next method
        #endregion 0000-ADABAS-EXIT

        #region PARA-0329245189-EXIT
        L_PARA_0329245189_EXIT:;
            if (returnLabel == "PARA-0329245189-EXIT") { return; }                                              //COBOL==> EXIT.
        ///COMMENT: *****************************************************************
        ///COMMENT:                                                                 *
        ...
        ///COMMENT: *****************************************************************
        #endregion PARA-0329245189-EXIT
        ...
        #region PARA-0329245189-INIT
        L_PARA_0329245189_INIT:;
            ...
            if (returnLabel == "PARA-0329245189-INIT") { return; }  //Check for pass through to next method
        #endregion PARA-0329245189-INIT

        #region PARA-0329245189-INIT-EXIT
        L_PARA_0329245189_INIT_EXIT:;
            if (returnLabel == "PARA-0329245189-INIT-EXIT") { return; }                                         //COBOL==> EXIT.
            #endregion PARA-0329245189-INIT-EXIT
        }
        #endregion
    }
    #endregion
