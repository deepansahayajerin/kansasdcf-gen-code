...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:32 PM
   **        *   FROM COBOL PGM   :  SWEXLE20
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_BFX9_WRITE_NCP_CHILD_FILE     DATE: 2014/12/15
       TARGET OS:   MVS                       TIME: 10:22:58
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE20_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE20_fd_FileSection";
            internal const string NCP_CH_FILE = "NCP_CH_FILE";
            internal const string NCP_CH_RECORD = "NCP_CH_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink NCP_CH_FILE { get; set; }
        public IField NCP_CH_RECORD { get { return GetElementByName<IField>(Names.NCP_CH_RECORD); } }


        internal SWEXLE20_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.NCP_CH_RECORD, FieldType.String, 102);
        ...
        public override void Initialize()
        {
            ...
            NCP_CH_FILE = FileHandler.GetFile("NCPCHOUT");
            NCP_CH_FILE.StatusField = WS.FILE_STATUS;
            NCP_CH_FILE.AssociatedBuffer = NCP_CH_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXLE20_fd(SWEXLE20_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE20_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE20_ws_WorkingStorage";
    ...
    internal class SWEXLE20_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE20_ls_LinkageSection";
            ...
            internal const string CSSI_WORKSET_0002ET = "CSSI_WORKSET_0002ET";
            internal const string NCP_CHILD_FILE_LAYOUT_0002AS = "NCP_CHILD_FILE_LAYOUT_0002AS";
            internal const string NCP_CHILD_FILE_LAYOUT_0002 = "NCP_CHILD_FILE_LAYOUT_0002";
            internal const string NCP_CHILD_FILE_LAYOUT_0002XX = "NCP_CHILD_FILE_LAYOUT_0002XX";
        ...
        public IGroup CSSI_WORKSET_0002ET { get { return GetElementByName<IGroup>(Names.CSSI_WORKSET_0002ET); } }
        public IField NCP_CHILD_FILE_LAYOUT_0002AS { get { return GetElementByName<IField>(Names.NCP_CHILD_FILE_LAYOUT_0002AS); } }
        public IField NCP_CHILD_FILE_LAYOUT_0002 { get { return GetElementByName<IField>(Names.NCP_CHILD_FILE_LAYOUT_0002); } }
        public IField NCP_CHILD_FILE_LAYOUT_0002XX { get { return GetElementByName<IField>(Names.NCP_CHILD_FILE_LAYOUT_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.CSSI_WORKSET_0002ET, (CSSI_WORKSET_0002ET) =>
               {
                   CSSI_WORKSET_0002ET.CreateNewField(Names.NCP_CHILD_FILE_LAYOUT_0002AS, FieldType.String, 1);

                   IField NCP_CHILD_FILE_LAYOUT_0002_local = CSSI_WORKSET_0002ET.CreateNewField(Names.NCP_CHILD_FILE_LAYOUT_0002, FieldType.String, 102);
                   CSSI_WORKSET_0002ET.CreateNewFieldRedefine(Names.NCP_CHILD_FILE_LAYOUT_0002XX, FieldType.String, NCP_CHILD_FILE_LAYOUT_0002_local, 102);
               });
           });
    ...
    public class SWEXLE20 : EABBase
    {
        ...
        public SWEXLE20()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE20");

            WS = new SWEXLE20_ws();
            FD = new SWEXLE20_fd(WS);
            LS = new SWEXLE20_ls();
        }
        ...
        private SWEXLE20_ws WS;

        //==== File Data Class ========================================
        private SWEXLE20_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE20_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0443288494(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0443288494
        /// </summary>
        private void M_MAIN_0443288494(string returnMethod = "")
        {
            M_PARA_0443288494_INIT("M_PARA_0443288494_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0443288494-INIT THRU PARA-0443288494-INIT-EXIT
            M_PARA_0443288494("M_PARA_0443288494_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0443288494 THRU PARA-0443288494-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0443288494
        /// </summary>
        private void M_PARA_0443288494(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0443288494") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.NCP_CH_FILE.OpenFile(FileAccessMode.Write);                                                      //COBOL==> OPEN OUTPUT NCP-CH-FILE
        ...
        {
            //COMMENT: ******************
            FD.NCP_CH_RECORD.SetValue(LS.NCP_CHILD_FILE_LAYOUT_0002);                                           //COBOL==> MOVE NCP-CHILD-FILE-LAYOUT-0002 TO NCP-CH-RECORD
            FD.NCP_CH_FILE.WriteLine(FD.NCP_CH_RECORD.AsBytes);                                                 //COBOL==> WRITE NCP-CH-RECORD
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003
            }                                                                                                   //COBOL==> ELSE
            ...
            {
                LS.STATUS_0003.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: ******************
            FD.NCP_CH_FILE.CloseFile();                                                                         //COBOL==> CLOSE NCP-CH-FILE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0443288494_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288494_EXIT
        /// </summary>
        private void M_PARA_0443288494_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0443288494_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0443288494_EXIT") { M_PARA_0443288494_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288494_INIT
        /// </summary>
        private void M_PARA_0443288494_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0443288494_INIT") { M_PARA_0443288494_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288494_INIT_EXIT
        /// </summary>
        private void M_PARA_0443288494_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0443288494_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
