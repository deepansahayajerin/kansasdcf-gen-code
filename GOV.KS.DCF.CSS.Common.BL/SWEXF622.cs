...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:08:53 PM
   **        *   FROM COBOL PGM   :  SWEXF622
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B622_EXTERNAL_TO_WRITE_REPORT DATE: 2001/10/25
       TARGET OS:   MVS                       TIME: 11:01:56
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXF622_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXF622_fd_FileSection";
            internal const string CP_REPORT_OUT = "CP_REPORT_OUT";
            internal const string DETAILS = "DETAILS";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink CP_REPORT_OUT { get; set; }
        ...
        public override void Initialize()
        {
            ...
            CP_REPORT_OUT = FileHandler.GetFile("US_S_CPRPT");
            CP_REPORT_OUT.AssociatedBuffer = DETAILS;
            CP_REPORT_OUT.RecordLength = 133;
        }
        #endregion
    ...
    internal class SWEXF622_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXF622_ws_WorkingStorage";
        }
        #endregion
    ...
    internal class SWEXF622_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXF622_ls_LinkageSection";
            ...
            internal const string EAB_REPORT_SEND_0001ET = "EAB_REPORT_SEND_0001ET";
            internal const string RPT_DETAIL_0001AS = "RPT_DETAIL_0001AS";
            internal const string RPT_DETAIL_0001 = "RPT_DETAIL_0001";
            internal const string RPT_DETAIL_0001XX = "RPT_DETAIL_0001XX";
        ...
        public IGroup EAB_REPORT_SEND_0001ET { get { return GetElementByName<IGroup>(Names.EAB_REPORT_SEND_0001ET); } }
        public IField RPT_DETAIL_0001AS { get { return GetElementByName<IField>(Names.RPT_DETAIL_0001AS); } }
        public IField RPT_DETAIL_0001 { get { return GetElementByName<IField>(Names.RPT_DETAIL_0001); } }
        public IField RPT_DETAIL_0001XX { get { return GetElementByName<IField>(Names.RPT_DETAIL_0001XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.EAB_REPORT_SEND_0001ET, (EAB_REPORT_SEND_0001ET) =>
               {
                   EAB_REPORT_SEND_0001ET.CreateNewField(Names.RPT_DETAIL_0001AS, FieldType.String, 1);

                   IField RPT_DETAIL_0001_local = EAB_REPORT_SEND_0001ET.CreateNewField(Names.RPT_DETAIL_0001, FieldType.String, 132);
                   EAB_REPORT_SEND_0001ET.CreateNewFieldRedefine(Names.RPT_DETAIL_0001XX, FieldType.String, RPT_DETAIL_0001_local, 132);
               });
           });
    ...
    public class SWEXF622 : EABBase
    {
        ...
        public SWEXF622()
            : base()
        {
            this.ProgramName.SetValue("SWEXF622");
        ...
        private SWEXF622_ws WS;

        //==== File Data Class ========================================
        private SWEXF622_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXF622_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1073488481(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1073488481
        /// </summary>
        private void M_MAIN_1073488481(string returnMethod = "")
        {
            M_PARA_1073488481_INIT("M_PARA_1073488481_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1073488481-INIT THRU PARA-1073488481-INIT-EXIT
            M_PARA_1073488481("M_PARA_1073488481_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1073488481 THRU PARA-1073488481-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1073488481
        /// </summary>
        private void M_PARA_1073488481(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if ((LS.ACTION_0002.IsEqualTo("WPAGE")))
            {
                M_PARA_DETAIL("M_PARA_DETAIL_EXIT"); if (Control.ExitProgram) { return; }                             //COBOL==> PERFORM PARA-DETAIL THRU PARA-DETAIL-EXIT
            }                                                                                                //COBOL==> WHEN OTHER
            else
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1073488481") { M_PARA_1073488481_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1073488481_EXIT
        /// </summary>
        private void M_PARA_1073488481_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1073488481_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1073488481_EXIT") { M_PARA_DETAIL(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            FD.DETAILS.SetValue(LS.RPT_DETAIL_0001);                                                            //COBOL==> MOVE RPT-DETAIL-0001 TO DETAILS
            if (LS.ACTION_0002.IsEqualTo("WPAGE"))                                                              //COBOL==> IF ACTION-0002 = 'WPAGE'
            {
                FD.CP_REPORT_OUT.WriteLinePrinter(FD.DETAILS.AsString(), PrinterControl.PAGEBREAK, 0, 1);              //COBOL==> WRITE DETAILS AFTER ADVANCING PAGE
            }                                                                                                   //COBOL==> ELSE
            else
            {
                FD.CP_REPORT_OUT.WriteLinePrinter(FD.DETAILS.AsString(), PrinterControl.LINEBREAK, 0, 1);              //COBOL==> WRITE DETAILS AFTER ADVANCING 1 LINE
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_PARA_DETAIL_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_DETAIL_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.CP_REPORT_OUT.OpenFile(FileAccessMode.Write);                                                    //COBOL==> OPEN OUTPUT CP-REPORT-OUT.
        ...
        {
            FD.CP_REPORT_OUT.CloseFile();                                                                       //COBOL==> CLOSE CP-REPORT-OUT.
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_1073488481_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1073488481_INIT
        /// </summary>
        private void M_PARA_1073488481_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1073488481_INIT") { M_PARA_1073488481_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1073488481_INIT_EXIT
        /// </summary>
        private void M_PARA_1073488481_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1073488481_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
