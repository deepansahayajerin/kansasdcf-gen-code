...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:09 PM
   **        *   FROM COBOL PGM   :  SWEXLE10
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_EAB_WRITE_IWO_45_DAY_INFO     DATE: 2017/07/13
       TARGET OS:   MVS                       TIME: 08:57:05
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE10_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE10_fd_FileSection";
            internal const string IWO_OUTPUT_FILE = "IWO_OUTPUT_FILE";
            internal const string IWO_OUTPUT_RECORD = "IWO_OUTPUT_RECORD";
        ...
        public IFileLink IWO_OUTPUT_FILE { get; set; }
        public IGroup IWO_OUTPUT_RECORD { get { return GetElementByName<IGroup>(Names.IWO_OUTPUT_RECORD); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IWO_OUTPUT_RECORD, (IWO_OUTPUT_RECORD) =>
           {
               IWO_OUTPUT_RECORD.CreateNewField(Names.AREA_OFFICE_TYPE, FieldType.String, 1);
               IWO_OUTPUT_RECORD.CreateNewField(Names.AREA_OFFICE_NAME, FieldType.String, 30);
               IWO_OUTPUT_RECORD.CreateNewField(Names.OFFICE_NAME, FieldType.String, 30);
               IWO_OUTPUT_RECORD.CreateNewField(Names.SP_LAST_NAME, FieldType.String, 17);
               IWO_OUTPUT_RECORD.CreateNewField(Names.SP_FIRST_NAME, FieldType.String, 12);
               IWO_OUTPUT_RECORD.CreateNewField(Names.SP_MIDDLE_INITIAL, FieldType.String, 1);
               IWO_OUTPUT_RECORD.CreateNewField(Names.PERSON_FORMATTED_NAME, FieldType.String, 33);
               IWO_OUTPUT_RECORD.CreateNewField(Names.PERSON_NUMBER, FieldType.String, 10);
               IWO_OUTPUT_RECORD.CreateNewField(Names.LA_STANDARD_NUMBER, FieldType.String, 20);
               IWO_OUTPUT_RECORD.CreateNewField(Names.EMPLOYER_NAME, FieldType.String, 33);
               IWO_OUTPUT_RECORD.CreateNewField(Names.EMPLOYER_CITY, FieldType.String, 15);
               IWO_OUTPUT_RECORD.CreateNewField(Names.EMPLOYER_STATE, FieldType.String, 2);
               IWO_OUTPUT_RECORD.CreateNewField(Names.IWGL_DATE, FieldType.SignedNumeric, 8);
               IWO_OUTPUT_RECORD.CreateNewField(Names.REPORTING_START_DATE, FieldType.SignedNumeric, 8);
               IWO_OUTPUT_RECORD.CreateNewField(Names.CASEWORKER_NAME, FieldType.String, 33);
           });
        ...
        public override void Initialize()
        {
            ...
            IWO_OUTPUT_FILE = FileHandler.GetFile("IWOOUT");
            IWO_OUTPUT_FILE.StatusField = WS.IWO_FILE_STATUS;
            IWO_OUTPUT_FILE.AssociatedBuffer = IWO_OUTPUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXLE10_fd(SWEXLE10_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE10_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE10_ws_WorkingStorage";
    ...
    internal class SWEXLE10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE10_ls_LinkageSection";
            ...
            internal const string IMPORT_REPORTING_PERIOD_0002EV = "IMPORT_REPORTING_PERIOD_0002EV";
            ...
            internal const string IMPORT_IWGL_CREATED_DAT_0003EV = "IMPORT_IWGL_CREATED_DAT_0003EV";
            ...
            internal const string IMPORT_AREA_0011EV = "IMPORT_AREA_0011EV";
            internal const string OFFICE_0011ET = "OFFICE_0011ET";
            internal const string TYPE_CODE_0011AS = "TYPE_CODE_0011AS";
            internal const string TYPE_CODE_0011 = "TYPE_CODE_0011";
            internal const string TYPE_CODE_0011XX = "TYPE_CODE_0011XX";
            internal const string NAME_0011AS = "NAME_0011AS";
            internal const string NAME_0011 = "NAME_0011";
            internal const string NAME_0011XX = "NAME_0011XX";
            internal const string IMPORT_CASEWORKER_0012EV = "IMPORT_CASEWORKER_0012EV";
            internal const string CSE_PERSONS_WORK_SET_0012ET = "CSE_PERSONS_WORK_SET_0012ET";
            internal const string FORMATTED_NAME_0012AS = "FORMATTED_NAME_0012AS";
            internal const string FORMATTED_NAME_0012 = "FORMATTED_NAME_0012";
            internal const string FORMATTED_NAME_0012XX = "FORMATTED_NAME_0012XX";
        ...
        public IGroup IMPORT_REPORTING_PERIOD_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_REPORTING_PERIOD_0002EV); } }
        ...
        public IGroup IMPORT_IWGL_CREATED_DAT_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_IWGL_CREATED_DAT_0003EV); } }
        ...
        public IGroup IMPORT_AREA_0011EV { get { return GetElementByName<IGroup>(Names.IMPORT_AREA_0011EV); } }
        public IGroup OFFICE_0011ET { get { return GetElementByName<IGroup>(Names.OFFICE_0011ET); } }
        public IField TYPE_CODE_0011AS { get { return GetElementByName<IField>(Names.TYPE_CODE_0011AS); } }
        public IField TYPE_CODE_0011 { get { return GetElementByName<IField>(Names.TYPE_CODE_0011); } }
        public IField TYPE_CODE_0011XX { get { return GetElementByName<IField>(Names.TYPE_CODE_0011XX); } }
        public IField NAME_0011AS { get { return GetElementByName<IField>(Names.NAME_0011AS); } }
        public IField NAME_0011 { get { return GetElementByName<IField>(Names.NAME_0011); } }
        public IField NAME_0011XX { get { return GetElementByName<IField>(Names.NAME_0011XX); } }
        public IGroup IMPORT_CASEWORKER_0012EV { get { return GetElementByName<IGroup>(Names.IMPORT_CASEWORKER_0012EV); } }
        public IGroup CSE_PERSONS_WORK_SET_0012ET { get { return GetElementByName<IGroup>(Names.CSE_PERSONS_WORK_SET_0012ET); } }
        public IField FORMATTED_NAME_0012AS { get { return GetElementByName<IField>(Names.FORMATTED_NAME_0012AS); } }
        public IField FORMATTED_NAME_0012 { get { return GetElementByName<IField>(Names.FORMATTED_NAME_0012); } }
        public IField FORMATTED_NAME_0012XX { get { return GetElementByName<IField>(Names.FORMATTED_NAME_0012XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_REPORTING_PERIOD_0002EV, (IMPORT_REPORTING_PERIOD_0002EV) =>
           {
               IMPORT_REPORTING_PERIOD_0002EV.CreateNewGroup(Names.DATE_WORK_AREA_0002ET, (DATE_WORK_AREA_0002ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_IWGL_CREATED_DAT_0003EV, (IMPORT_IWGL_CREATED_DAT_0003EV) =>
           {
               IMPORT_IWGL_CREATED_DAT_0003EV.CreateNewGroup(Names.DATE_WORK_AREA_0003ET, (DATE_WORK_AREA_0003ET) =>
               {
           ...
           {
               IMPORT_0004EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0004ET, (CSE_PERSONS_WORK_SET_0004ET) =>
               {
           ...
           {
               IMPORT_0005EV.CreateNewGroup(Names.EMPLOYER_ADDRESS_0005ET, (EMPLOYER_ADDRESS_0005ET) =>
               {
           ...
           {
               IMPORT_0006EV.CreateNewGroup(Names.EMPLOYER_0006ET, (EMPLOYER_0006ET) =>
               {
           ...
           {
               IMPORT_0007EV.CreateNewGroup(Names.LEGAL_ACTION_0007ET, (LEGAL_ACTION_0007ET) =>
               {
           ...
           {
               IMPORT_0008EV.CreateNewGroup(Names.CSE_PERSON_0008ET, (CSE_PERSON_0008ET) =>
               {
           ...
           {
               IMPORT_0009EV.CreateNewGroup(Names.SERVICE_PROVIDER_0009ET, (SERVICE_PROVIDER_0009ET) =>
               {
           ...
           {
               IMPORT_0010EV.CreateNewGroup(Names.OFFICE_0010ET, (OFFICE_0010ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_AREA_0011EV, (IMPORT_AREA_0011EV) =>
           {
               IMPORT_AREA_0011EV.CreateNewGroup(Names.OFFICE_0011ET, (OFFICE_0011ET) =>
               {
                   OFFICE_0011ET.CreateNewField(Names.TYPE_CODE_0011AS, FieldType.String, 1);

                   IField TYPE_CODE_0011_local = OFFICE_0011ET.CreateNewField(Names.TYPE_CODE_0011, FieldType.String, 1);
                   OFFICE_0011ET.CreateNewFieldRedefine(Names.TYPE_CODE_0011XX, FieldType.String, TYPE_CODE_0011_local, 1);
                   OFFICE_0011ET.CreateNewField(Names.NAME_0011AS, FieldType.String, 1);

                   IField NAME_0011_local = OFFICE_0011ET.CreateNewField(Names.NAME_0011, FieldType.String, 30);
                   OFFICE_0011ET.CreateNewFieldRedefine(Names.NAME_0011XX, FieldType.String, NAME_0011_local, 30);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_CASEWORKER_0012EV, (IMPORT_CASEWORKER_0012EV) =>
           {
               IMPORT_CASEWORKER_0012EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0012ET, (CSE_PERSONS_WORK_SET_0012ET) =>
               {
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.FORMATTED_NAME_0012AS, FieldType.String, 1);

                   IField FORMATTED_NAME_0012_local = CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.FORMATTED_NAME_0012, FieldType.String, 33);
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewFieldRedefine(Names.FORMATTED_NAME_0012XX, FieldType.String, FORMATTED_NAME_0012_local, 33);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_REPORTING_PERIOD_0002EV, args, 4);
            SetPassedParm(IMPORT_IWGL_CREATED_DAT_0003EV, args, 5);
            ...
            SetPassedParm(IMPORT_AREA_0011EV, args, 13);
            SetPassedParm(IMPORT_CASEWORKER_0012EV, args, 14);
            SetPassedParm(EXPORT_0013EV, args, 15);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_REPORTING_PERIOD_0002EV, args, 4);
            SetReturnParm(IMPORT_IWGL_CREATED_DAT_0003EV, args, 5);
            ...
            SetReturnParm(IMPORT_AREA_0011EV, args, 13);
            SetReturnParm(IMPORT_CASEWORKER_0012EV, args, 14);
            SetReturnParm(EXPORT_0013EV, args, 15);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXLE10 : EABBase
    {
        ...
        public SWEXLE10()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE10");

            WS = new SWEXLE10_ws();
            FD = new SWEXLE10_fd(WS);
            LS = new SWEXLE10_ls();
        }
        ...
        private SWEXLE10_ws WS;

        //==== File Data Class ========================================
        private SWEXLE10_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE10_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-REPORTING-PERIOD-0002EV , IMPORT-IWGL-CREATED-DAT-0003EV , IMPORT-0004EV , IMPORT-0005EV , IMPORT-0006EV , IMPORT-0007EV , IMPORT-0008EV , IMPORT-0009EV , IMPORT-0010EV , IMPORT-AREA-0011EV , IMPORT-CASEWORKER-0012EV , EXPORT-0013EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0297404417(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0297404417
        /// </summary>
        private void M_MAIN_0297404417(string returnMethod = "")
        {
            M_PARA_0297404417_INIT("M_PARA_0297404417_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0297404417-INIT THRU PARA-0297404417-INIT-EXIT
            M_PARA_0297404417("M_PARA_0297404417_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0297404417 THRU PARA-0297404417-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0297404417
        /// </summary>
        private void M_PARA_0297404417(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0297404417") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.IWO_OUTPUT_FILE.OpenFile(FileAccessMode.Write);                                                  //COBOL==> OPEN OUTPUT IWO-OUTPUT-FILE
        ...
        {
            //COMMENT: ******************
            FD.AREA_OFFICE_TYPE.SetValue(LS.TYPE_CODE_0011);                                                    //COBOL==> MOVE TYPE-CODE-0011 TO AREA-OFFICE-TYPE
            FD.AREA_OFFICE_NAME.SetValue(LS.NAME_0011);                                                         //COBOL==> MOVE NAME-0011 TO AREA-OFFICE-NAME
            FD.OFFICE_NAME.SetValue(LS.NAME_0010);                                                              //COBOL==> MOVE NAME-0010 TO OFFICE-NAME
            FD.SP_LAST_NAME.SetValue(LS.LAST_NAME_0009);                                                        //COBOL==> MOVE LAST-NAME-0009 TO SP-LAST-NAME
            FD.SP_FIRST_NAME.SetValue(LS.FIRST_NAME_0009);                                                      //COBOL==> MOVE FIRST-NAME-0009 TO SP-FIRST-NAME
            FD.SP_MIDDLE_INITIAL.SetValue(LS.MIDDLE_INITIAL_0009);                                              //COBOL==> MOVE MIDDLE-INITIAL-0009 TO SP-MIDDLE-INITIAL
            FD.PERSON_FORMATTED_NAME.SetValue(LS.FORMATTED_NAME_0004);                                          //COBOL==> MOVE FORMATTED-NAME-0004 TO PERSON-FORMATTED-NAME
            FD.PERSON_NUMBER.SetValue(LS.NUMBER_0008);                                                          //COBOL==> MOVE NUMBER-0008 TO PERSON-NUMBER
            FD.LA_STANDARD_NUMBER.SetValue(LS.STANDARD_NUMBER_0007);                                            //COBOL==> MOVE STANDARD-NUMBER-0007 TO LA-STANDARD-NUMBER
            FD.EMPLOYER_NAME.SetValue(LS.NAME_0006);                                                            //COBOL==> MOVE NAME-0006 TO EMPLOYER-NAME
            FD.EMPLOYER_CITY.SetValue(LS.CITY_0005);                                                            //COBOL==> MOVE CITY-0005 TO EMPLOYER-CITY
            FD.EMPLOYER_STATE.SetValue(LS.STATE_0005);                                                          //COBOL==> MOVE STATE-0005 TO EMPLOYER-STATE
            FD.IWGL_DATE.SetValue(LS.DATE_0003);                                                                //COBOL==> MOVE DATE-0003 TO IWGL-DATE
            FD.REPORTING_START_DATE.SetValue(LS.DATE_0002);                                                     //COBOL==> MOVE DATE-0002 TO REPORTING-START-DATE
            FD.CASEWORKER_NAME.SetValue(LS.FORMATTED_NAME_0012);                                                //COBOL==> MOVE FORMATTED-NAME-0012 TO CASEWORKER-NAME
            FD.IWO_OUTPUT_FILE.WriteLine(FD.IWO_OUTPUT_RECORD.AsBytes);                                         //COBOL==> WRITE IWO-OUTPUT-RECORD
            if (WS.IWO_FILE_STATUS.IsEqualTo("00"))                                                             //COBOL==> IF IWO-FILE-STATUS = '00'
            {
                LS.STATUS_0013.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0013
            }                                                                                                   //COBOL==> ELSE
        ...
        {
            //COMMENT: ******************
            FD.IWO_OUTPUT_FILE.CloseFile();                                                                     //COBOL==> CLOSE IWO-OUTPUT-FILE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0297404417_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0297404417_EXIT
        /// </summary>
        private void M_PARA_0297404417_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0297404417_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0297404417_EXIT") { M_PARA_0297404417_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0297404417_INIT
        /// </summary>
        private void M_PARA_0297404417_INIT(string returnMethod = "")
        {
            LS.EXPORT_0013EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0013EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0297404417_INIT") { M_PARA_0297404417_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0297404417_INIT_EXIT
        /// </summary>
        private void M_PARA_0297404417_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0297404417_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
