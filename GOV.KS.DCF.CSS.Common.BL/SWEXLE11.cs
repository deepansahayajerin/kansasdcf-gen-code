...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:12 PM
   **        *   FROM COBOL PGM   :  SWEXLE11
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_WRITE_INTERSTATE_CASE     DATE: 2001/10/09
       TARGET OS:   MVS                       TIME: 10:40:00
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE11_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE11_fd_FileSection";
            ...
            internal const string SP_MIDDLE_INTITIAL = "SP_MIDDLE_INTITIAL";
        ...
        public IField SP_MIDDLE_INTITIAL { get { return GetElementByName<IField>(Names.SP_MIDDLE_INTITIAL); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               OUTPUT_RECORD.CreateNewField(Names.SP_LAST_NAME, FieldType.String, 30);
               OUTPUT_RECORD.CreateNewField(Names.SP_FIRST_NAME, FieldType.String, 17);
               OUTPUT_RECORD.CreateNewField(Names.SP_MIDDLE_INTITIAL, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.PERSON_FORMATTED_NAME, FieldType.String, 33);
        ...
        public override void Initialize()
        {
            ...
            OUTPUT_FILE = FileHandler.GetFile("ICROUT");
        ...
        #region Constructors
        public SWEXLE11_fd(SWEXLE11_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE11_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE11_ws_WorkingStorage";
    ...
    internal class SWEXLE11_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE11_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
               IMPORT_0002EV.CreateNewGroup(Names.SERVICE_PROVIDER_0002ET, (SERVICE_PROVIDER_0002ET) =>
               {
                   ...
                   SERVICE_PROVIDER_0002ET.CreateNewField(Names.MIDDLE_INITIAL_0002AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0002_local = SERVICE_PROVIDER_0002ET.CreateNewField(Names.MIDDLE_INITIAL_0002, FieldType.String, 1);
                   SERVICE_PROVIDER_0002ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0002XX, FieldType.String, MIDDLE_INITIAL_0002_local, 1);
               });
           });
    ...
    public class SWEXLE11 : EABBase
    {
        ...
        public SWEXLE11()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE11");

            WS = new SWEXLE11_ws();
            FD = new SWEXLE11_fd(WS);
            LS = new SWEXLE11_ls();
        }
        ...
        private SWEXLE11_ws WS;

        //==== File Data Class ========================================
        private SWEXLE11_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE11_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1176241850(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1176241850
        /// </summary>
        private void M_MAIN_1176241850(string returnMethod = "")
        {
            M_PARA_1176241850_INIT("M_PARA_1176241850_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1176241850-INIT THRU PARA-1176241850-INIT-EXIT
            M_PARA_1176241850("M_PARA_1176241850_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1176241850 THRU PARA-1176241850-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1176241850
        /// </summary>
        private void M_PARA_1176241850(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1176241850") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: *****************
            FD.SP_LAST_NAME.SetValue(LS.LAST_NAME_0002);                                                        //COBOL==> MOVE LAST-NAME-0002 TO SP-LAST-NAME
            FD.SP_FIRST_NAME.SetValue(LS.FIRST_NAME_0002);                                                      //COBOL==> MOVE FIRST-NAME-0002 TO SP-FIRST-NAME
            FD.SP_MIDDLE_INTITIAL.SetValue(LS.MIDDLE_INITIAL_0002);                                             //COBOL==> MOVE MIDDLE-INITIAL-0002 TO SP-MIDDLE-INTITIAL
            FD.PERSON_FORMATTED_NAME.SetValue(LS.FORMATTED_NAME_0003);                                          //COBOL==> MOVE FORMATTED-NAME-0003 TO PERSON-FORMATTED-NAME
            FD.PERSON_NUMBER.SetValue(LS.NUMBER_0003);                                                          //COBOL==> MOVE NUMBER-0003 TO PERSON-NUMBER
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1176241850_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1176241850_EXIT
        /// </summary>
        private void M_PARA_1176241850_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1176241850_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1176241850_EXIT") { M_PARA_1176241850_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1176241850_INIT
        /// </summary>
        private void M_PARA_1176241850_INIT(string returnMethod = "")
        {
            LS.EXPORT_0005EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0005EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1176241850_INIT") { M_PARA_1176241850_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1176241850_INIT_EXIT
        /// </summary>
        private void M_PARA_1176241850_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1176241850_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
