...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:03:40 PM
   **        *   FROM COBOL PGM   :  SWEXE666
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_READ_IM_HHOLD_MULTI_CASE  DATE: 1999/07/19
       TARGET OS:   MVS                       TIME: 16:15:31
       TARGET DBMS: DB2                       USER: SWSRDEL
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXE666_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXE666_fd_FileSection";
            internal const string HH_MULTI_CASE = "HH_MULTI_CASE";
            internal const string INFILE = "INFILE";
            internal const string AE_CASE_NO = "AE_CASE_NO";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink HH_MULTI_CASE { get; set; }
        public IGroup INFILE { get { return GetElementByName<IGroup>(Names.INFILE); } }
        public IField AE_CASE_NO { get { return GetElementByName<IField>(Names.AE_CASE_NO); } }


        internal SWEXE666_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.INFILE, (INFILE) =>
           {
               INFILE.CreateNewField(Names.AE_CASE_NO, FieldType.String, 8);
               INFILE.CreateNewFillerField(21, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            HH_MULTI_CASE = FileHandler.GetFile("INFILEDD");
            HH_MULTI_CASE.StatusField = WS.FILE_STS;
            HH_MULTI_CASE.AssociatedBuffer = INFILE;
        }
        #endregion

        #region Constructors
        public SWEXE666_fd(SWEXE666_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXE666_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXE666_ws_WorkingStorage";
            internal const string WS_EAB_CONTROL = "WS_EAB_CONTROL";
            internal const string EOF_SW = "EOF_SW";
            internal const string FILE_STS = "FILE_STS";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_EAB_CONTROL { get { return GetElementByName<IGroup>(Names.WS_EAB_CONTROL); } }
        public IField EOF_SW { get { return GetElementByName<IField>(Names.EOF_SW); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_EAB_CONTROL, (WS_EAB_CONTROL) =>
           {
               WS_EAB_CONTROL.CreateNewField(Names.EOF_SW, FieldType.String, 1, SPACE);
               WS_EAB_CONTROL.CreateNewField(Names.FILE_STS, FieldType.String, 2);
           });
    ...
    internal class SWEXE666_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXE666_ls_LinkageSection";
            ...
            internal const string AE_CASE_NO_0002AS = "AE_CASE_NO_0002AS";
            internal const string AE_CASE_NO_0002 = "AE_CASE_NO_0002";
            internal const string AE_CASE_NO_0002XX = "AE_CASE_NO_0002XX";
            ...
            internal const string LOCAL_END_OF_FILE_0004EV = "LOCAL_END_OF_FILE_0004EV";
        ...
        public IField AE_CASE_NO_0002AS { get { return GetElementByName<IField>(Names.AE_CASE_NO_0002AS); } }
        public IField AE_CASE_NO_0002 { get { return GetElementByName<IField>(Names.AE_CASE_NO_0002); } }
        public IField AE_CASE_NO_0002XX { get { return GetElementByName<IField>(Names.AE_CASE_NO_0002XX); } }
        ...
        public IGroup LOCAL_END_OF_FILE_0004EV { get { return GetElementByName<IGroup>(Names.LOCAL_END_OF_FILE_0004EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
           {
               ...
               {
                   IM_HOUSEHOLD_0002ET.CreateNewField(Names.AE_CASE_NO_0002AS, FieldType.String, 1);

                   IField AE_CASE_NO_0002_local = IM_HOUSEHOLD_0002ET.CreateNewField(Names.AE_CASE_NO_0002, FieldType.String, 8);
                   IM_HOUSEHOLD_0002ET.CreateNewFieldRedefine(Names.AE_CASE_NO_0002XX, FieldType.String, AE_CASE_NO_0002_local, 8);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0003EV, (EXPORT_0003EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.LOCAL_END_OF_FILE_0004EV, (LOCAL_END_OF_FILE_0004EV) =>
           {
               LOCAL_END_OF_FILE_0004EV.CreateNewGroup(Names.IEF_SUPPLIED_0004ET, (IEF_SUPPLIED_0004ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(LOCAL_END_OF_FILE_0004EV, args, 6);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(LOCAL_END_OF_FILE_0004EV, args, 6);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXE666 : EABBase
    {
        ...
        public SWEXE666()
            : base()
        {
            this.ProgramName.SetValue("SWEXE666");

            WS = new SWEXE666_ws();
            FD = new SWEXE666_fd(WS);
            LS = new SWEXE666_ls();
        }
        ...
        private SWEXE666_ws WS;

        //==== File Data Class ========================================
        private SWEXE666_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXE666_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV EXPORT-0003EV LOCAL-END-OF-FILE-0004EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0647496290(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0647496290
        /// </summary>
        private void M_MAIN_0647496290(string returnMethod = "")
        {
            M_PARA_0647496290_INIT("M_PARA_0647496290_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0647496290-INIT THRU PARA-0647496290-INIT-EXIT
            M_PARA_0647496290("M_PARA_0647496290_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0647496290 THRU PARA-0647496290-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0647496290
        /// </summary>
        private void M_PARA_0647496290(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0647496290") { M_0000_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_0000_MAIN
        /// </summary>
        ...
        private void M_0000_MAIN(string returnMethod = "")
        {
            ...
            {
                FD.HH_MULTI_CASE.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT HH-MULTI-CASE
                if ((WS.FILE_STS.IsEqualTo("00"))
             || (WS.FILE_STS.IsEqualTo("  ")))                 //COBOL==> IF FILE-STS = '00' OR '  '
                {
                    LS.STATUS_0003.SetValue("OK      ");                                                                //COBOL==> MOVE 'OK      ' TO STATUS-0003
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    LS.STATUS_0003.SetValue("ERROR   ");                                                                //COBOL==> MOVE 'ERROR   ' TO STATUS-0003
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                //COBOL==> WHEN 'READ    '
            else
            if ((LS.ACTION_0001.IsEqualTo("READ    ")))
            {
                if (WS.EOF_SW.IsEqualTo("Y"))                                                                       //COBOL==> IF EOF-SW = 'Y'
                {
                    FD.HH_MULTI_CASE.CloseFile();                                                                       //COBOL==> CLOSE HH-MULTI-CASE
                    LS.FLAG_0004.SetValue("Y");                                                                         //COBOL==> MOVE 'Y' TO FLAG-0004
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    M_1000_READ_RECORD(); if (Control.ExitProgram) { return; }                                            //COBOL==> PERFORM 1000-READ-RECORD
                    if ((WS.FILE_STS.IsEqualTo("00"))
             || (WS.FILE_STS.IsEqualTo("  ")))                 //COBOL==> IF FILE-STS = '00' OR '  '
                    {
                        LS.STATUS_0003.SetValue("OK      ");                                                                //COBOL==> MOVE 'OK      ' TO STATUS-0003
            ...
            if (returnMethod != "" && returnMethod != "M_0000_MAIN") { M_PARA_0647496290_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0647496290_EXIT
        /// </summary>
        private void M_PARA_0647496290_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0647496290_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0647496290_EXIT") { M_1000_READ_RECORD(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1000_READ_RECORD
        /// </summary>
        private void M_1000_READ_RECORD(string returnMethod = "")
        {
            //COMMENT:     READ HH-MULTI-CASE INTO INFILE
            FD.HH_MULTI_CASE.ReadLine();                                                                        //COBOL==> READ HH-MULTI-CASE
            if (FD.HH_MULTI_CASE.FileStatus == FileStatus.End_of_file)                                          //COBOL==> AT END
            {
                FD.HH_MULTI_CASE.CloseFile();                                                                       //COBOL==> CLOSE HH-MULTI-CASE
                WS.EOF_SW.SetValue("Y");                                                                            //COBOL==> MOVE 'Y' TO EOF-SW
                LS.FLAG_0004.SetValue("Y");                                                                         //COBOL==> MOVE 'Y' TO FLAG-0004
            }                                                                                                   //COBOL==> NOT AT END
            if (!(FD.HH_MULTI_CASE.FileStatus == FileStatus.End_of_file))
            {
                LS.AE_CASE_NO_0002.SetValue(FD.AE_CASE_NO);                                                         //COBOL==> MOVE AE-CASE-NO TO AE-CASE-NO-0002
            }                                                                                                   //COBOL==> END-READ.
            if (returnMethod != "" && returnMethod != "M_1000_READ_RECORD") { M_PARA_0647496290_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0647496290_INIT
        /// </summary>
        private void M_PARA_0647496290_INIT(string returnMethod = "")
        {
            ...
            LS.LOCAL_END_OF_FILE_0004EV.ResetToInitialValue();                                                  //COBOL==> INITIALIZE LOCAL-END-OF-FILE-0004EV.
            if (returnMethod != "" && returnMethod != "M_PARA_0647496290_INIT") { M_PARA_0647496290_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0647496290_INIT_EXIT
        /// </summary>
        private void M_PARA_0647496290_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0647496290_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
