...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:55 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXGR10 : OnlineEABBase
    {
        ...
        private void M_0000_DATABASE_ROUTINE(string returnMethod = "")
        {
            ...
            SetHandleCondtions(HandleCondition.ERROR, "M_9999_CICS_ABEND");                                     //COBOL==> EXEC CICS HANDLE CONDITION ERROR ( 9999-CICS-ABEND ) END-EXEC.
                                                                                                                ...
                                                                                                                //COMMENT: *   END-EXEC.
            if (LS.DATE_0002.IsEqualTo(0))                                                                      //COBOL==> IF DATE-0002 = ZEROS
            {
        ...
        private void M_7200_CHECK_AE_PARTICIPATION(string returnMethod = "")
        {
            ...
            DbConv.ExecuteSqlQueryWithUR("SELECT COUNT ( * ) INTO {0} FROM KSD_PARTICIPATION WHERE FK_CLB_CLIENT_NO = {1} AND PART_START_DATE <= {2} AND PART_END_DATE >= {3} AND PART_CODE = 'IN' ",  //COBOL==> EXEC SQL SELECT COUNT ( * ) INTO :DBK1-COUNT FROM KSD_PARTICIPATION WHERE FK_CLB_CLIENT_NO = :DBK9-CLIENT-NUMBER AND PART_START_DATE <= :DBK1-CCYYMMDD AND PART_END_DATE >= :DBK1-CCYYMMDD AND PART_CODE = 'IN' WITH UR END-EXEC.
