...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:07:12 PM
   **        *   FROM COBOL PGM   :  SWEXEW26
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2016 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: FN_B796_WRITE_TO_TEXT_MSG_FILE   DATE: 2016/03/31
       TARGET OS:   MVS                       TIME: 15:11:03
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEW26_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW26_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.NCP_RECORD, FieldType.String, 200);
            recordDef.CreateNewField(Names.TEMP_RECORD, FieldType.String, 200);
        ...
        #region Constructors
        public SWEXEW26_fd(SWEXEW26_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW26_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW26_ws_WorkingStorage";
    ...
    internal class SWEXEW26_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW26_ls_LinkageSection";
            ...
            internal const string TEXT_200_0002AS = "TEXT_200_0002AS";
            internal const string TEXT_200_0002 = "TEXT_200_0002";
            internal const string TEXT_200_0002XX = "TEXT_200_0002XX";
        ...
        public IField TEXT_200_0002AS { get { return GetElementByName<IField>(Names.TEXT_200_0002AS); } }
        public IField TEXT_200_0002 { get { return GetElementByName<IField>(Names.TEXT_200_0002); } }
        public IField TEXT_200_0002XX { get { return GetElementByName<IField>(Names.TEXT_200_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.WORK_AREA_0002ET, (WORK_AREA_0002ET) =>
               {
                   WORK_AREA_0002ET.CreateNewField(Names.TEXT_200_0002AS, FieldType.String, 1);

                   IField TEXT_200_0002_local = WORK_AREA_0002ET.CreateNewField(Names.TEXT_200_0002, FieldType.String, 200);
                   WORK_AREA_0002ET.CreateNewFieldRedefine(Names.TEXT_200_0002XX, FieldType.String, TEXT_200_0002_local, 200);
               });
           });
    ...
    public class SWEXEW26 : EABBase
    {
        ...
        public SWEXEW26()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW26");

            WS = new SWEXEW26_ws();
            FD = new SWEXEW26_fd(WS);
            LS = new SWEXEW26_ls();
        }
        ...
        private SWEXEW26_ws WS;

        //==== File Data Class ========================================
        private SWEXEW26_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW26_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0854591140(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0854591140
        /// </summary>
        private void M_MAIN_0854591140(string returnMethod = "")
        {
            M_PARA_0854591140_INIT("M_PARA_0854591140_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0854591140-INIT THRU PARA-0854591140-INIT-EXIT
            M_PARA_0854591140("M_PARA_0854591140_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0854591140 THRU PARA-0854591140-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0854591140
        /// </summary>
        private void M_PARA_0854591140(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0854591140") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.TEMP_RECORD.SetValue(LS.TEXT_200_0002);                                                          //COBOL==> MOVE TEXT-200-0002 TO TEMP-RECORD
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0854591140_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854591140_EXIT
        /// </summary>
        private void M_PARA_0854591140_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854591140_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0854591140_EXIT") { M_PARA_0854591140_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854591140_INIT
        /// </summary>
        private void M_PARA_0854591140_INIT(string returnMethod = "")
        {
            LS.EXPORT_0004EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0004EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0854591140_INIT") { M_PARA_0854591140_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854591140_INIT_EXIT
        /// </summary>
        private void M_PARA_0854591140_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854591140_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
