...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:02 PM
   **        *   FROM COBOL PGM   :  SWEXLE08
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_READ_REFERRAL_EXTRACT     DATE: 2001/07/20
       TARGET OS:   MVS                       TIME: 09:00:12
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE08_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE08_fd_FileSection";
            internal const string INPUT_FILE_01 = "INPUT_FILE_01";
            internal const string INPUT_RECORD_01 = "INPUT_RECORD_01";
            internal const string RECORD_01_DETAIL = "RECORD_01_DETAIL";
            internal const string INPUT_FILE_02 = "INPUT_FILE_02";
            internal const string INPUT_RECORD_02 = "INPUT_RECORD_02";
            internal const string RECORD_02_DETAIL = "RECORD_02_DETAIL";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink INPUT_FILE_01 { get; set; }
        public IGroup INPUT_RECORD_01 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_01); } }
        public IField RECORD_01_DETAIL { get { return GetElementByName<IField>(Names.RECORD_01_DETAIL); } }
        public IFileLink INPUT_FILE_02 { get; set; }
        public IGroup INPUT_RECORD_02 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_02); } }
        public IField RECORD_02_DETAIL { get { return GetElementByName<IField>(Names.RECORD_02_DETAIL); } }


        internal SWEXLE08_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.INPUT_RECORD_01, (INPUT_RECORD_01) =>
           {
               INPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 229);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_02, (INPUT_RECORD_02) =>
           {
               INPUT_RECORD_02.CreateNewField(Names.RECORD_02_DETAIL, FieldType.String, 229);
           });
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE_01 = FileHandler.GetFile("RPT01IN");
            INPUT_FILE_01.StatusField = WS.FILE_STATUS;
            INPUT_FILE_01.AssociatedBuffer = INPUT_RECORD_01;

            INPUT_FILE_02 = FileHandler.GetFile("RPT02IN");
            INPUT_FILE_02.StatusField = WS.FILE_STATUS;
            INPUT_FILE_02.AssociatedBuffer = INPUT_RECORD_02;
        }
        #endregion

        #region Constructors
        public SWEXLE08_fd(SWEXLE08_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE08_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE08_ws_WorkingStorage";
            internal const string FILE_STATUS = "FILE_STATUS";
            internal const string WS_INPUT_RECORD = "WS_INPUT_RECORD";
            internal const string AREA_OFFICE_NAME = "AREA_OFFICE_NAME";
            internal const string CO_OFFICE_NAME = "CO_OFFICE_NAME";
            internal const string CO_OFFICE_ID = "CO_OFFICE_ID";
            internal const string SUPERVISOR_LAST_NAME = "SUPERVISOR_LAST_NAME";
            internal const string SUPERVISOR_FIRST_NAME = "SUPERVISOR_FIRST_NAME";
            internal const string SUPERVISOR_MIDDLE_IN = "SUPERVISOR_MIDDLE_IN";
            internal const string CO_LAST_NAME = "CO_LAST_NAME";
            internal const string CO_FIRST_NAME = "CO_FIRST_NAME";
            internal const string CO_MIDDLE_INITIAL = "CO_MIDDLE_INITIAL";
            internal const string ATTORNEY_LAST_NAME = "ATTORNEY_LAST_NAME";
            internal const string ATTORNEY_FIRST_NAME = "ATTORNEY_FIRST_NAME";
            internal const string ATTORNEY_MIDDLE_INITIAL = "ATTORNEY_MIDDLE_INITIAL";
            internal const string AP_FORMATTED_NAME = "AP_FORMATTED_NAME";
            ...
            internal const string REFERRAL_IDENTIFIER = "REFERRAL_IDENTIFIER";
        }
        #endregion

        #region Direct-access element properties
        public IField FILE_STATUS { get { return GetElementByName<IField>(Names.FILE_STATUS); } }
        public IGroup WS_INPUT_RECORD { get { return GetElementByName<IGroup>(Names.WS_INPUT_RECORD); } }
        ...
        public IField CO_OFFICE_ID { get { return GetElementByName<IField>(Names.CO_OFFICE_ID); } }
        public IField SUPERVISOR_LAST_NAME { get { return GetElementByName<IField>(Names.SUPERVISOR_LAST_NAME); } }
        public IField SUPERVISOR_FIRST_NAME { get { return GetElementByName<IField>(Names.SUPERVISOR_FIRST_NAME); } }
        public IField SUPERVISOR_MIDDLE_IN { get { return GetElementByName<IField>(Names.SUPERVISOR_MIDDLE_IN); } }
        public IField CO_LAST_NAME { get { return GetElementByName<IField>(Names.CO_LAST_NAME); } }
        public IField CO_FIRST_NAME { get { return GetElementByName<IField>(Names.CO_FIRST_NAME); } }
        public IField CO_MIDDLE_INITIAL { get { return GetElementByName<IField>(Names.CO_MIDDLE_INITIAL); } }
        public IField ATTORNEY_LAST_NAME { get { return GetElementByName<IField>(Names.ATTORNEY_LAST_NAME); } }
        public IField ATTORNEY_FIRST_NAME { get { return GetElementByName<IField>(Names.ATTORNEY_FIRST_NAME); } }
        public IField ATTORNEY_MIDDLE_INITIAL { get { return GetElementByName<IField>(Names.ATTORNEY_MIDDLE_INITIAL); } }
        public IField AP_FORMATTED_NAME { get { return GetElementByName<IField>(Names.AP_FORMATTED_NAME); } }
        ...
        public IField REFERRAL_IDENTIFIER { get { return GetElementByName<IField>(Names.REFERRAL_IDENTIFIER); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_INPUT_RECORD, (WS_INPUT_RECORD) =>
           {
               WS_INPUT_RECORD.CreateNewField(Names.AREA_OFFICE_NAME, FieldType.String, 30);
               WS_INPUT_RECORD.CreateNewField(Names.CO_OFFICE_NAME, FieldType.String, 30);
               WS_INPUT_RECORD.CreateNewField(Names.CO_OFFICE_ID, FieldType.SignedNumeric, 4);
               WS_INPUT_RECORD.CreateNewField(Names.SUPERVISOR_LAST_NAME, FieldType.String, 17);
               WS_INPUT_RECORD.CreateNewField(Names.SUPERVISOR_FIRST_NAME, FieldType.String, 12);
               WS_INPUT_RECORD.CreateNewField(Names.SUPERVISOR_MIDDLE_IN, FieldType.String, 1);
               WS_INPUT_RECORD.CreateNewField(Names.CO_LAST_NAME, FieldType.String, 17);
               WS_INPUT_RECORD.CreateNewField(Names.CO_FIRST_NAME, FieldType.String, 12);
               WS_INPUT_RECORD.CreateNewField(Names.CO_MIDDLE_INITIAL, FieldType.String, 1);
               WS_INPUT_RECORD.CreateNewField(Names.ATTORNEY_LAST_NAME, FieldType.String, 17);
               WS_INPUT_RECORD.CreateNewField(Names.ATTORNEY_FIRST_NAME, FieldType.String, 12);
               WS_INPUT_RECORD.CreateNewField(Names.ATTORNEY_MIDDLE_INITIAL, FieldType.String, 1);
               WS_INPUT_RECORD.CreateNewField(Names.AP_FORMATTED_NAME, FieldType.String, 33);
               WS_INPUT_RECORD.CreateNewField(Names.CASE_NUMBER, FieldType.String, 10);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_DATE, FieldType.SignedNumeric, 8);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_1, FieldType.String, 4);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_2, FieldType.String, 4);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_3, FieldType.String, 4);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_4, FieldType.String, 4);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_5, FieldType.String, 4);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_STATUS, FieldType.String, 1);
               WS_INPUT_RECORD.CreateNewField(Names.REFERRAL_IDENTIFIER, FieldType.SignedNumeric, 3);
           });
    ...
    internal class SWEXLE08_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE08_ls_LinkageSection";
            ...
            internal const string IMPORT_FILE_NUMBER_0001EV = "IMPORT_FILE_NUMBER_0001EV";
            ...
            internal const string LEGAL_REFERRAL_0004ET = "LEGAL_REFERRAL_0004ET";
            internal const string REFERRAL_DATE_0004AS = "REFERRAL_DATE_0004AS";
            internal const string REFERRAL_DATE_0004 = "REFERRAL_DATE_0004";
            internal const string REFERRAL_DATE_0004XX = "REFERRAL_DATE_0004XX";
            internal const string REFERRAL_REASON_1_0004AS = "REFERRAL_REASON_1_0004AS";
            internal const string REFERRAL_REASON_1_0004 = "REFERRAL_REASON_1_0004";
            internal const string REFERRAL_REASON_1_0004XX = "REFERRAL_REASON_1_0004XX";
            internal const string REFERRAL_REASON_2_0004AS = "REFERRAL_REASON_2_0004AS";
            internal const string REFERRAL_REASON_2_0004 = "REFERRAL_REASON_2_0004";
            internal const string REFERRAL_REASON_2_0004XX = "REFERRAL_REASON_2_0004XX";
            internal const string REFERRAL_REASON_3_0004AS = "REFERRAL_REASON_3_0004AS";
            internal const string REFERRAL_REASON_3_0004 = "REFERRAL_REASON_3_0004";
            internal const string REFERRAL_REASON_3_0004XX = "REFERRAL_REASON_3_0004XX";
            internal const string REFERRAL_REASON_5_0004AS = "REFERRAL_REASON_5_0004AS";
            internal const string REFERRAL_REASON_5_0004 = "REFERRAL_REASON_5_0004";
            internal const string REFERRAL_REASON_5_0004XX = "REFERRAL_REASON_5_0004XX";
            internal const string REFERRAL_REASON_4_0004AS = "REFERRAL_REASON_4_0004AS";
            internal const string REFERRAL_REASON_4_0004 = "REFERRAL_REASON_4_0004";
            internal const string REFERRAL_REASON_4_0004XX = "REFERRAL_REASON_4_0004XX";
            ...
            internal const string CASE_0005ET = "CASE_0005ET";
            ...
            internal const string EXPORT_LEGAL_0006EV = "EXPORT_LEGAL_0006EV";
            ...
            internal const string EXPORT_CO_0007EV = "EXPORT_CO_0007EV";
            ...
            internal const string EXPORT_SUPERVISOR_0008EV = "EXPORT_SUPERVISOR_0008EV";
            internal const string SERVICE_PROVIDER_0008ET = "SERVICE_PROVIDER_0008ET";
            ...
            internal const string EXPORT_CO_0009EV = "EXPORT_CO_0009EV";
            internal const string OFFICE_0009ET = "OFFICE_0009ET";
            internal const string SYSTEM_GENERATED_ID_0009AS = "SYSTEM_GENERATED_ID_0009AS";
            internal const string SYSTEM_GENERATED_ID_0009 = "SYSTEM_GENERATED_ID_0009";
            internal const string SYSTEM_GENERATED_ID_0009XX = "SYSTEM_GENERATED_ID_0009XX";
            ...
            internal const string EXPORT_AREA_0010EV = "EXPORT_AREA_0010EV";
        ...
        public IGroup IMPORT_FILE_NUMBER_0001EV { get { return GetElementByName<IGroup>(Names.IMPORT_FILE_NUMBER_0001EV); } }
        ...
        public IGroup LEGAL_REFERRAL_0004ET { get { return GetElementByName<IGroup>(Names.LEGAL_REFERRAL_0004ET); } }
        public IField REFERRAL_DATE_0004AS { get { return GetElementByName<IField>(Names.REFERRAL_DATE_0004AS); } }
        public IField REFERRAL_DATE_0004 { get { return GetElementByName<IField>(Names.REFERRAL_DATE_0004); } }
        public IField REFERRAL_DATE_0004XX { get { return GetElementByName<IField>(Names.REFERRAL_DATE_0004XX); } }
        public IField REFERRAL_REASON_1_0004AS { get { return GetElementByName<IField>(Names.REFERRAL_REASON_1_0004AS); } }
        public IField REFERRAL_REASON_1_0004 { get { return GetElementByName<IField>(Names.REFERRAL_REASON_1_0004); } }
        public IField REFERRAL_REASON_1_0004XX { get { return GetElementByName<IField>(Names.REFERRAL_REASON_1_0004XX); } }
        public IField REFERRAL_REASON_2_0004AS { get { return GetElementByName<IField>(Names.REFERRAL_REASON_2_0004AS); } }
        public IField REFERRAL_REASON_2_0004 { get { return GetElementByName<IField>(Names.REFERRAL_REASON_2_0004); } }
        public IField REFERRAL_REASON_2_0004XX { get { return GetElementByName<IField>(Names.REFERRAL_REASON_2_0004XX); } }
        public IField REFERRAL_REASON_3_0004AS { get { return GetElementByName<IField>(Names.REFERRAL_REASON_3_0004AS); } }
        public IField REFERRAL_REASON_3_0004 { get { return GetElementByName<IField>(Names.REFERRAL_REASON_3_0004); } }
        public IField REFERRAL_REASON_3_0004XX { get { return GetElementByName<IField>(Names.REFERRAL_REASON_3_0004XX); } }
        public IField REFERRAL_REASON_5_0004AS { get { return GetElementByName<IField>(Names.REFERRAL_REASON_5_0004AS); } }
        public IField REFERRAL_REASON_5_0004 { get { return GetElementByName<IField>(Names.REFERRAL_REASON_5_0004); } }
        public IField REFERRAL_REASON_5_0004XX { get { return GetElementByName<IField>(Names.REFERRAL_REASON_5_0004XX); } }
        public IField REFERRAL_REASON_4_0004AS { get { return GetElementByName<IField>(Names.REFERRAL_REASON_4_0004AS); } }
        public IField REFERRAL_REASON_4_0004 { get { return GetElementByName<IField>(Names.REFERRAL_REASON_4_0004); } }
        public IField REFERRAL_REASON_4_0004XX { get { return GetElementByName<IField>(Names.REFERRAL_REASON_4_0004XX); } }
        ...
        public IField IDENTIFIER_0004 { get { return GetElementByName<IField>(Names.IDENTIFIER_0004); } }
        ...
        public IGroup CASE_0005ET { get { return GetElementByName<IGroup>(Names.CASE_0005ET); } }
        ...
        public IGroup EXPORT_LEGAL_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_LEGAL_0006EV); } }
        ...
        public IGroup EXPORT_CO_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_CO_0007EV); } }
        ...
        public IGroup EXPORT_SUPERVISOR_0008EV { get { return GetElementByName<IGroup>(Names.EXPORT_SUPERVISOR_0008EV); } }
        public IGroup SERVICE_PROVIDER_0008ET { get { return GetElementByName<IGroup>(Names.SERVICE_PROVIDER_0008ET); } }
        ...
        public IGroup EXPORT_CO_0009EV { get { return GetElementByName<IGroup>(Names.EXPORT_CO_0009EV); } }
        public IGroup OFFICE_0009ET { get { return GetElementByName<IGroup>(Names.OFFICE_0009ET); } }
        public IField SYSTEM_GENERATED_ID_0009AS { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_ID_0009AS); } }
        public IField SYSTEM_GENERATED_ID_0009 { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_ID_0009); } }
        public IField SYSTEM_GENERATED_ID_0009XX { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_ID_0009XX); } }
        ...
        public IGroup EXPORT_AREA_0010EV { get { return GetElementByName<IGroup>(Names.EXPORT_AREA_0010EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_FILE_NUMBER_0001EV, (IMPORT_FILE_NUMBER_0001EV) =>
           {
               IMPORT_FILE_NUMBER_0001EV.CreateNewGroup(Names.IEF_SUPPLIED_0001ET, (IEF_SUPPLIED_0001ET) =>
               {
           ...
           {
               EXPORT_0004EV.CreateNewGroup(Names.LEGAL_REFERRAL_0004ET, (LEGAL_REFERRAL_0004ET) =>
               {
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_DATE_0004AS, FieldType.String, 1);

                   IField REFERRAL_DATE_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_DATE_0004, FieldType.SignedNumeric, 8);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.REFERRAL_DATE_0004XX, FieldType.String, REFERRAL_DATE_0004_local, 8);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_1_0004AS, FieldType.String, 1);

                   IField REFERRAL_REASON_1_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_1_0004, FieldType.String, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.REFERRAL_REASON_1_0004XX, FieldType.String, REFERRAL_REASON_1_0004_local, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_2_0004AS, FieldType.String, 1);

                   IField REFERRAL_REASON_2_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_2_0004, FieldType.String, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.REFERRAL_REASON_2_0004XX, FieldType.String, REFERRAL_REASON_2_0004_local, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_3_0004AS, FieldType.String, 1);

                   IField REFERRAL_REASON_3_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_3_0004, FieldType.String, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.REFERRAL_REASON_3_0004XX, FieldType.String, REFERRAL_REASON_3_0004_local, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_5_0004AS, FieldType.String, 1);

                   IField REFERRAL_REASON_5_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_5_0004, FieldType.String, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.REFERRAL_REASON_5_0004XX, FieldType.String, REFERRAL_REASON_5_0004_local, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_4_0004AS, FieldType.String, 1);

                   IField REFERRAL_REASON_4_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.REFERRAL_REASON_4_0004, FieldType.String, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.REFERRAL_REASON_4_0004XX, FieldType.String, REFERRAL_REASON_4_0004_local, 4);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.STATUS_0004AS, FieldType.String, 1);

                   IField STATUS_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.STATUS_0004, FieldType.String, 1);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.STATUS_0004XX, FieldType.String, STATUS_0004_local, 1);
                   LEGAL_REFERRAL_0004ET.CreateNewField(Names.IDENTIFIER_0004AS, FieldType.String, 1);

                   IField IDENTIFIER_0004_local = LEGAL_REFERRAL_0004ET.CreateNewField(Names.IDENTIFIER_0004, FieldType.SignedNumeric, 3);
                   LEGAL_REFERRAL_0004ET.CreateNewFieldRedefine(Names.IDENTIFIER_0004XX, FieldType.String, IDENTIFIER_0004_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0005EV, (EXPORT_0005EV) =>
           {
               EXPORT_0005EV.CreateNewGroup(Names.CASE_0005ET, (CASE_0005ET) =>
               {
                   CASE_0005ET.CreateNewField(Names.NUMBER_0005AS, FieldType.String, 1);

                   IField NUMBER_0005_local = CASE_0005ET.CreateNewField(Names.NUMBER_0005, FieldType.String, 10);
                   CASE_0005ET.CreateNewFieldRedefine(Names.NUMBER_0005XX, FieldType.String, NUMBER_0005_local, 10);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_LEGAL_0006EV, (EXPORT_LEGAL_0006EV) =>
           {
               EXPORT_LEGAL_0006EV.CreateNewGroup(Names.SERVICE_PROVIDER_0006ET, (SERVICE_PROVIDER_0006ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_CO_0007EV, (EXPORT_CO_0007EV) =>
           {
               EXPORT_CO_0007EV.CreateNewGroup(Names.SERVICE_PROVIDER_0007ET, (SERVICE_PROVIDER_0007ET) =>
               {
                   SERVICE_PROVIDER_0007ET.CreateNewField(Names.LAST_NAME_0007AS, FieldType.String, 1);

                   IField LAST_NAME_0007_local = SERVICE_PROVIDER_0007ET.CreateNewField(Names.LAST_NAME_0007, FieldType.String, 17);
                   SERVICE_PROVIDER_0007ET.CreateNewFieldRedefine(Names.LAST_NAME_0007XX, FieldType.String, LAST_NAME_0007_local, 17);
                   SERVICE_PROVIDER_0007ET.CreateNewField(Names.FIRST_NAME_0007AS, FieldType.String, 1);

                   IField FIRST_NAME_0007_local = SERVICE_PROVIDER_0007ET.CreateNewField(Names.FIRST_NAME_0007, FieldType.String, 12);
                   SERVICE_PROVIDER_0007ET.CreateNewFieldRedefine(Names.FIRST_NAME_0007XX, FieldType.String, FIRST_NAME_0007_local, 12);
                   SERVICE_PROVIDER_0007ET.CreateNewField(Names.MIDDLE_INITIAL_0007AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0007_local = SERVICE_PROVIDER_0007ET.CreateNewField(Names.MIDDLE_INITIAL_0007, FieldType.String, 1);
                   SERVICE_PROVIDER_0007ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0007XX, FieldType.String, MIDDLE_INITIAL_0007_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_SUPERVISOR_0008EV, (EXPORT_SUPERVISOR_0008EV) =>
           {
               EXPORT_SUPERVISOR_0008EV.CreateNewGroup(Names.SERVICE_PROVIDER_0008ET, (SERVICE_PROVIDER_0008ET) =>
               {
                   SERVICE_PROVIDER_0008ET.CreateNewField(Names.LAST_NAME_0008AS, FieldType.String, 1);

                   IField LAST_NAME_0008_local = SERVICE_PROVIDER_0008ET.CreateNewField(Names.LAST_NAME_0008, FieldType.String, 17);
                   SERVICE_PROVIDER_0008ET.CreateNewFieldRedefine(Names.LAST_NAME_0008XX, FieldType.String, LAST_NAME_0008_local, 17);
                   SERVICE_PROVIDER_0008ET.CreateNewField(Names.FIRST_NAME_0008AS, FieldType.String, 1);

                   IField FIRST_NAME_0008_local = SERVICE_PROVIDER_0008ET.CreateNewField(Names.FIRST_NAME_0008, FieldType.String, 12);
                   SERVICE_PROVIDER_0008ET.CreateNewFieldRedefine(Names.FIRST_NAME_0008XX, FieldType.String, FIRST_NAME_0008_local, 12);
                   SERVICE_PROVIDER_0008ET.CreateNewField(Names.MIDDLE_INITIAL_0008AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0008_local = SERVICE_PROVIDER_0008ET.CreateNewField(Names.MIDDLE_INITIAL_0008, FieldType.String, 1);
                   SERVICE_PROVIDER_0008ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0008XX, FieldType.String, MIDDLE_INITIAL_0008_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_CO_0009EV, (EXPORT_CO_0009EV) =>
           {
               EXPORT_CO_0009EV.CreateNewGroup(Names.OFFICE_0009ET, (OFFICE_0009ET) =>
               {
                   OFFICE_0009ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0009AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_ID_0009_local = OFFICE_0009ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0009, FieldType.SignedNumeric, 4);
                   OFFICE_0009ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_ID_0009XX, FieldType.String, SYSTEM_GENERATED_ID_0009_local, 4);
                   OFFICE_0009ET.CreateNewField(Names.NAME_0009AS, FieldType.String, 1);

                   IField NAME_0009_local = OFFICE_0009ET.CreateNewField(Names.NAME_0009, FieldType.String, 30);
                   OFFICE_0009ET.CreateNewFieldRedefine(Names.NAME_0009XX, FieldType.String, NAME_0009_local, 30);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_AREA_0010EV, (EXPORT_AREA_0010EV) =>
           {
               EXPORT_AREA_0010EV.CreateNewGroup(Names.OFFICE_0010ET, (OFFICE_0010ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_FILE_NUMBER_0001EV, args, 3);
            ...
            SetPassedParm(EXPORT_LEGAL_0006EV, args, 8);
            SetPassedParm(EXPORT_CO_0007EV, args, 9);
            SetPassedParm(EXPORT_SUPERVISOR_0008EV, args, 10);
            SetPassedParm(EXPORT_CO_0009EV, args, 11);
            SetPassedParm(EXPORT_AREA_0010EV, args, 12);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_FILE_NUMBER_0001EV, args, 3);
            ...
            SetReturnParm(EXPORT_LEGAL_0006EV, args, 8);
            SetReturnParm(EXPORT_CO_0007EV, args, 9);
            SetReturnParm(EXPORT_SUPERVISOR_0008EV, args, 10);
            SetReturnParm(EXPORT_CO_0009EV, args, 11);
            SetReturnParm(EXPORT_AREA_0010EV, args, 12);
    ...
    public class SWEXLE08 : EABBase
    {
        ...
        public SWEXLE08()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE08");

            WS = new SWEXLE08_ws();
            FD = new SWEXLE08_fd(WS);
            LS = new SWEXLE08_ls();
        }
        ...
        private SWEXLE08_ws WS;

        //==== File Data Class ========================================
        private SWEXLE08_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE08_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-FILE-NUMBER-0001EV , IMPORT-0002EV , EXPORT-0003EV , EXPORT-0004EV , EXPORT-0005EV , EXPORT-LEGAL-0006EV , EXPORT-CO-0007EV , EXPORT-SUPERVISOR-0008EV , EXPORT-CO-0009EV , EXPORT-AREA-0010EV , EXPORT-0011EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1042551209(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1042551209
        /// </summary>
        private void M_MAIN_1042551209(string returnMethod = "")
        {
            M_PARA_1042551209_INIT("M_PARA_1042551209_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1042551209-INIT THRU PARA-1042551209-INIT-EXIT
            M_PARA_1042551209("M_PARA_1042551209_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1042551209 THRU PARA-1042551209-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1042551209
        /// </summary>
        private void M_PARA_1042551209(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1042551209") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            {
                M_1000_OPEN_FILES(); if (Control.ExitProgram) { return; }                                             //COBOL==> PERFORM 1000-OPEN-FILES
            }                                                                                                //COBOL==> WHEN 'READ'
            else
            if ((LS.ACTION_0002.IsEqualTo("READ")))
            {
            ...
            {
                M_3000_CLOSE_FILES(); if (Control.ExitProgram) { return; }                                            //COBOL==> PERFORM 3000-CLOSE-FILES
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
        ...
        /// <summary>
        /// Method M_1000_OPEN_FILES
        /// </summary>
        /// <remarks>
        ///COMMENT: *************************
        /// </remarks>
        private void M_1000_OPEN_FILES(string returnMethod = "")
        {
            //COMMENT: *************************
            FD.INPUT_FILE_01.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-01
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                FD.INPUT_FILE_02.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-02
            }                                                                                                   //COBOL==> END-IF
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0011.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0011
            ...
            if (returnMethod != "" && returnMethod != "M_1000_OPEN_FILES") { M_2000_READ_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: *************************
            // EvaluateList !LS.COUNT_0001!                                                                     //COBOL==> EVALUATE COUNT-0001
            if ((LS.COUNT_0001.IsEqualTo(1)))                                                                   //COBOL==> WHEN 1
            {
                FD.INPUT_FILE_01.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-01
                                                                                                                    // EvaluateList !WS.FILE_STATUS!                                                                    //COBOL==> EVALUATE FILE-STATUS
                if ((WS.FILE_STATUS.IsEqualTo("00")))                                                               //COBOL==> WHEN '00'
                {
                    WS.WS_INPUT_RECORD.SetValue(FD.RECORD_01_DETAIL);                                                   //COBOL==> MOVE RECORD-01-DETAIL TO WS-INPUT-RECORD
                    LS.NAME_0010.SetValue(WS.AREA_OFFICE_NAME);                                                         //COBOL==> MOVE AREA-OFFICE-NAME TO NAME-0010
                    LS.NAME_0009.SetValue(WS.CO_OFFICE_NAME);                                                           //COBOL==> MOVE CO-OFFICE-NAME TO NAME-0009
                    LS.SYSTEM_GENERATED_ID_0009.SetValue(WS.CO_OFFICE_ID);                                              //COBOL==> MOVE CO-OFFICE-ID TO SYSTEM-GENERATED-ID-0009
                    LS.LAST_NAME_0008.SetValue(WS.SUPERVISOR_LAST_NAME);                                                //COBOL==> MOVE SUPERVISOR-LAST-NAME TO LAST-NAME-0008
                    LS.FIRST_NAME_0008.SetValue(WS.SUPERVISOR_FIRST_NAME);                                              //COBOL==> MOVE SUPERVISOR-FIRST-NAME TO FIRST-NAME-0008
                    LS.MIDDLE_INITIAL_0008.SetValue(WS.SUPERVISOR_MIDDLE_IN);                                           //COBOL==> MOVE SUPERVISOR-MIDDLE-IN TO MIDDLE-INITIAL-0008
                    LS.LAST_NAME_0007.SetValue(WS.CO_LAST_NAME);                                                        //COBOL==> MOVE CO-LAST-NAME TO LAST-NAME-0007
                    LS.FIRST_NAME_0007.SetValue(WS.CO_FIRST_NAME);                                                      //COBOL==> MOVE CO-FIRST-NAME TO FIRST-NAME-0007
                    LS.MIDDLE_INITIAL_0007.SetValue(WS.CO_MIDDLE_INITIAL);                                              //COBOL==> MOVE CO-MIDDLE-INITIAL TO MIDDLE-INITIAL-0007
                    LS.LAST_NAME_0006.SetValue(WS.ATTORNEY_LAST_NAME);                                                  //COBOL==> MOVE ATTORNEY-LAST-NAME TO LAST-NAME-0006
                    LS.FIRST_NAME_0006.SetValue(WS.ATTORNEY_FIRST_NAME);                                                //COBOL==> MOVE ATTORNEY-FIRST-NAME TO FIRST-NAME-0006
                    LS.MIDDLE_INITIAL_0006.SetValue(WS.ATTORNEY_MIDDLE_INITIAL);                                        //COBOL==> MOVE ATTORNEY-MIDDLE-INITIAL TO MIDDLE-INITIAL-0006
                    LS.FORMATTED_NAME_0003.SetValue(WS.AP_FORMATTED_NAME);                                              //COBOL==> MOVE AP-FORMATTED-NAME TO FORMATTED-NAME-0003
                    LS.NUMBER_0005.SetValue(WS.CASE_NUMBER);                                                            //COBOL==> MOVE CASE-NUMBER TO NUMBER-0005
                    LS.REFERRAL_DATE_0004.SetValue(WS.REFERRAL_DATE);                                                   //COBOL==> MOVE REFERRAL-DATE TO REFERRAL-DATE-0004
                    LS.REFERRAL_REASON_1_0004.SetValue(WS.REFERRAL_REASON_1);                                           //COBOL==> MOVE REFERRAL-REASON-1 TO REFERRAL-REASON-1-0004
                    LS.REFERRAL_REASON_2_0004.SetValue(WS.REFERRAL_REASON_2);                                           //COBOL==> MOVE REFERRAL-REASON-2 TO REFERRAL-REASON-2-0004
                    LS.REFERRAL_REASON_3_0004.SetValue(WS.REFERRAL_REASON_3);                                           //COBOL==> MOVE REFERRAL-REASON-3 TO REFERRAL-REASON-3-0004
                    LS.REFERRAL_REASON_4_0004.SetValue(WS.REFERRAL_REASON_4);                                           //COBOL==> MOVE REFERRAL-REASON-4 TO REFERRAL-REASON-4-0004
                    LS.REFERRAL_REASON_5_0004.SetValue(WS.REFERRAL_REASON_5);                                           //COBOL==> MOVE REFERRAL-REASON-5 TO REFERRAL-REASON-5-0004
                    LS.STATUS_0004.SetValue(WS.REFERRAL_STATUS);                                                        //COBOL==> MOVE REFERRAL-STATUS TO STATUS-0004
                    LS.IDENTIFIER_0004.SetValue(WS.REFERRAL_IDENTIFIER);                                                //COBOL==> MOVE REFERRAL-IDENTIFIER TO IDENTIFIER-0004
                }                                                                                                //COBOL==> WHEN '10'
                else
            ...
            if ((LS.COUNT_0001.IsEqualTo(2)))
            {
                FD.INPUT_FILE_02.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-02
                                                                                                                    // EvaluateList !WS.FILE_STATUS!                                                                    //COBOL==> EVALUATE FILE-STATUS
                if ((WS.FILE_STATUS.IsEqualTo("00")))                                                               //COBOL==> WHEN '00'
                {
                    WS.WS_INPUT_RECORD.SetValue(FD.RECORD_02_DETAIL);                                                   //COBOL==> MOVE RECORD-02-DETAIL TO WS-INPUT-RECORD
                    LS.NAME_0010.SetValue(WS.AREA_OFFICE_NAME);                                                         //COBOL==> MOVE AREA-OFFICE-NAME TO NAME-0010
                    LS.NAME_0009.SetValue(WS.CO_OFFICE_NAME);                                                           //COBOL==> MOVE CO-OFFICE-NAME TO NAME-0009
                    LS.SYSTEM_GENERATED_ID_0009.SetValue(WS.CO_OFFICE_ID);                                              //COBOL==> MOVE CO-OFFICE-ID TO SYSTEM-GENERATED-ID-0009
                    LS.LAST_NAME_0008.SetValue(WS.SUPERVISOR_LAST_NAME);                                                //COBOL==> MOVE SUPERVISOR-LAST-NAME TO LAST-NAME-0008
            ...
            {
                LS.STATUS_0011.SetValue("BN");                                                                      //COBOL==> MOVE 'BN' TO STATUS-0011
            }                                                                                                   //COBOL==> END-EVALUATE.
            if (returnMethod != "" && returnMethod != "M_2000_READ_FILE") { M_3000_CLOSE_FILES(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_3000_CLOSE_FILES
        /// </summary>
        /// <remarks>
        ///COMMENT: *************************
        /// </remarks>
        private void M_3000_CLOSE_FILES(string returnMethod = "")
        {
            //COMMENT: *************************
            FD.INPUT_FILE_01.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-01
            FD.INPUT_FILE_02.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-02.
            if (returnMethod != "" && returnMethod != "M_3000_CLOSE_FILES") { M_9999_FINISHED(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1042551209_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1042551209_EXIT
        /// </summary>
        private void M_PARA_1042551209_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1042551209_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1042551209_EXIT") { M_PARA_1042551209_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1042551209_INIT
        /// </summary>
        private void M_PARA_1042551209_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_LEGAL_0006EV.ResetToInitialValue();                                                       //COBOL==> INITIALIZE EXPORT-LEGAL-0006EV
            LS.EXPORT_CO_0007EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-CO-0007EV
            LS.EXPORT_SUPERVISOR_0008EV.ResetToInitialValue();                                                  //COBOL==> INITIALIZE EXPORT-SUPERVISOR-0008EV
            LS.EXPORT_CO_0009EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-CO-0009EV
            LS.EXPORT_AREA_0010EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE EXPORT-AREA-0010EV
            LS.EXPORT_0011EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0011EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1042551209_INIT") { M_PARA_1042551209_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1042551209_INIT_EXIT
        /// </summary>
        private void M_PARA_1042551209_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1042551209_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
