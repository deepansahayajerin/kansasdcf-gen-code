...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:28 PM
   **        *   FROM COBOL PGM   :  SWEXLE18
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_BFX9_READ_NCP_ADDRESS_FILE    DATE: 2014/12/15
       TARGET OS:   MVS                       TIME: 11:25:36
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE18_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE18_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 133);
           });
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE_01 = FileHandler.GetFile("NCPIN");
        ...
        #region Constructors
        public SWEXLE18_fd(SWEXLE18_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE18_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE18_ws_WorkingStorage";
    ...
    internal class SWEXLE18_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE18_ls_LinkageSection";
            ...
            internal const string CSSI_WORKSET_0003ET = "CSSI_WORKSET_0003ET";
            internal const string NCP_ADDRESS_FILE_LAYOUT_0004AS = "NCP_ADDRESS_FILE_LAYOUT_0004AS";
            internal const string NCP_ADDRESS_FILE_LAYOUT_0004 = "NCP_ADDRESS_FILE_LAYOUT_0004";
            internal const string NCP_ADDRESS_FILE_LAYOUT_0004XX = "NCP_ADDRESS_FILE_LAYOUT_0004XX";
        }
        #endregion
        ...
        public IGroup CSSI_WORKSET_0003ET { get { return GetElementByName<IGroup>(Names.CSSI_WORKSET_0003ET); } }
        public IField NCP_ADDRESS_FILE_LAYOUT_0004AS { get { return GetElementByName<IField>(Names.NCP_ADDRESS_FILE_LAYOUT_0004AS); } }
        public IField NCP_ADDRESS_FILE_LAYOUT_0004 { get { return GetElementByName<IField>(Names.NCP_ADDRESS_FILE_LAYOUT_0004); } }
        public IField NCP_ADDRESS_FILE_LAYOUT_0004XX { get { return GetElementByName<IField>(Names.NCP_ADDRESS_FILE_LAYOUT_0004XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.CSSI_WORKSET_0003ET, (CSSI_WORKSET_0003ET) =>
               {
                   CSSI_WORKSET_0003ET.CreateNewField(Names.NCP_ADDRESS_FILE_LAYOUT_0004AS, FieldType.String, 1);

                   IField NCP_ADDRESS_FILE_LAYOUT_0004_local = CSSI_WORKSET_0003ET.CreateNewField(Names.NCP_ADDRESS_FILE_LAYOUT_0004, FieldType.String, 133);
                   CSSI_WORKSET_0003ET.CreateNewFieldRedefine(Names.NCP_ADDRESS_FILE_LAYOUT_0004XX, FieldType.String, NCP_ADDRESS_FILE_LAYOUT_0004_local, 133);
               });
           });
    ...
    public class SWEXLE18 : EABBase
    {
        ...
        public SWEXLE18()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE18");

            WS = new SWEXLE18_ws();
            FD = new SWEXLE18_fd(WS);
            LS = new SWEXLE18_ls();
        }
        ...
        private SWEXLE18_ws WS;

        //==== File Data Class ========================================
        private SWEXLE18_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE18_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0443288517(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0443288517
        /// </summary>
        private void M_MAIN_0443288517(string returnMethod = "")
        {
            M_PARA_0443288517_INIT("M_PARA_0443288517_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0443288517-INIT THRU PARA-0443288517-INIT-EXIT
            M_PARA_0443288517("M_PARA_0443288517_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0443288517 THRU PARA-0443288517-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0443288517
        /// </summary>
        private void M_PARA_0443288517(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0443288517") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.NCP_ADDRESS_FILE_LAYOUT_0004.SetValue(FD.RECORD_01_DETAIL);                                      //COBOL==> MOVE RECORD-01-DETAIL TO NCP-ADDRESS-FILE-LAYOUT-0004
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0443288517_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288517_EXIT
        /// </summary>
        private void M_PARA_0443288517_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0443288517_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0443288517_EXIT") { M_PARA_0443288517_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288517_INIT
        /// </summary>
        private void M_PARA_0443288517_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0443288517_INIT") { M_PARA_0443288517_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288517_INIT_EXIT
        /// </summary>
        private void M_PARA_0443288517_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0443288517_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
