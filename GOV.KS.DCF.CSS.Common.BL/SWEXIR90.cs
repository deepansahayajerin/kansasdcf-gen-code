...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:51:36 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXIR90 : OnlineEABBase
    {
        ...
        private void M_JUSTIFY_OFFICE(string returnMethod = "")
        {
            ...
            for (WS.I3.SetValue(1); (!((WS.TMP_OFC_X[WS.I3.AsInt()].IsGreaterThan("0")) || (WS.I3.IsGreaterThan(4)))); WS.I3.Add(1))         //COBOL==> PERFORM VARYING I3 FROM 1 BY 1 UNTIL TMP-OFC-X ( I3 ) > '0'
            {
            }                                                                                                   //COBOL==> END-PERFORM
