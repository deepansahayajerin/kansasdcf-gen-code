...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:01 PM
   **        *   FROM COBOL PGM   :  SWEXEE29
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_DATE_VALIDATION_ROUTINE      DATE: 2003/02/03
       TARGET OS:   MVS                       TIME: 15:36:37
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEE29_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXEE29_ws_WorkingStorage";
            internal const string WS_SWEXGDAT = "WS_SWEXGDAT";
            internal const string WS_DATE_AREA = "WS_DATE_AREA";
            internal const string WS_DATE_INPUT = "WS_DATE_INPUT";
            internal const string WS_DATE_OUTPUT = "WS_DATE_OUTPUT";
            internal const string WS_VALIDITY_CODE = "WS_VALIDITY_CODE";
        }
        #endregion
        ...
        public IField WS_DATE_INPUT { get { return GetElementByName<IField>(Names.WS_DATE_INPUT); } }
        public IField WS_DATE_OUTPUT { get { return GetElementByName<IField>(Names.WS_DATE_OUTPUT); } }
        public IField WS_VALIDITY_CODE { get { return GetElementByName<IField>(Names.WS_VALIDITY_CODE); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            {
                FILLER.CreateNewField(Names.WS_DATE_INPUT, FieldType.String, 8);
                FILLER.CreateNewField(Names.WS_DATE_OUTPUT, FieldType.UnsignedNumeric, 8);
                FILLER.CreateNewField(Names.WS_VALIDITY_CODE, FieldType.String, 2);
    ...
    internal class SWEXEE29_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEE29_ls_LinkageSection";
            ...
            internal const string EXPORT_VALIDITY_0003EV = "EXPORT_VALIDITY_0003EV";
        ...
        public IGroup EXPORT_VALIDITY_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_VALIDITY_0003EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.DATE_WORK_AREA_0001ET, (DATE_WORK_AREA_0001ET) =>
               {
                   DATE_WORK_AREA_0001ET.CreateNewField(Names.DATE_0001AS, FieldType.String, 1);

                   IField DATE_0001_local = DATE_WORK_AREA_0001ET.CreateNewField(Names.DATE_0001, FieldType.String, 8);
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.DATE_WORK_AREA_0002ET, (DATE_WORK_AREA_0002ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_VALIDITY_0003EV, (EXPORT_VALIDITY_0003EV) =>
           {
               EXPORT_VALIDITY_0003EV.CreateNewGroup(Names.IEF_SUPPLIED_0003ET, (IEF_SUPPLIED_0003ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_VALIDITY_0003EV, args, 5);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_VALIDITY_0003EV, args, 5);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXEE29 : EABBase
    {
        ...
        public SWEXEE29()
            : base()
        {
            this.ProgramName.SetValue("SWEXEE29");
        ...
        private SWEXEE29_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXEE29_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-VALIDITY-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1391469811(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1391469811
        /// </summary>
        private void M_MAIN_1391469811(string returnMethod = "")
        {
            M_PARA_1391469811_INIT("M_PARA_1391469811_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1391469811-INIT THRU PARA-1391469811-INIT-EXIT
            M_PARA_1391469811("M_PARA_1391469811_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1391469811 THRU PARA-1391469811-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1391469811
        /// </summary>
        private void M_PARA_1391469811(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            WS.WS_DATE_INPUT.SetValue(LS.DATE_0001);                                                            //COBOL==> MOVE DATE-0001 TO WS-DATE-INPUT
            ...
            LS.DATE_0002.SetValue(WS.WS_DATE_OUTPUT);                                                           //COBOL==> MOVE WS-DATE-OUTPUT TO DATE-0002
            LS.ACTION_ENTRY_0003.SetValue(WS.WS_VALIDITY_CODE);                                                 //COBOL==> MOVE WS-VALIDITY-CODE TO ACTION-ENTRY-0003 .
            if (returnMethod != "" && returnMethod != "M_PARA_1391469811") { M_PARA_1391469811_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1391469811_EXIT
        /// </summary>
        private void M_PARA_1391469811_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1391469811_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1391469811_EXIT") { M_PARA_1391469811_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1391469811_INIT
        /// </summary>
        private void M_PARA_1391469811_INIT(string returnMethod = "")
        {
            LS.EXPORT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0002EV
            LS.EXPORT_VALIDITY_0003EV.ResetToInitialValue();                                                    //COBOL==> INITIALIZE EXPORT-VALIDITY-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1391469811_INIT") { M_PARA_1391469811_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1391469811_INIT_EXIT
        /// </summary>
        private void M_PARA_1391469811_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1391469811_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
