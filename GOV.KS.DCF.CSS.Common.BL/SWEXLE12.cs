...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:14 PM
   **        *   FROM COBOL PGM   :  SWEXLE12
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_READ_INTERSTATE_CASE      DATE: 2001/10/09
       TARGET OS:   MVS                       TIME: 10:40:49
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE12_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE12_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD.CreateNewField(Names.SP_LAST_NAME, FieldType.String, 30);
               INPUT_RECORD.CreateNewField(Names.SP_FIRST_NAME, FieldType.String, 17);
               INPUT_RECORD.CreateNewField(Names.SP_MIDDLE_INTITIAL, FieldType.String, 1);
               INPUT_RECORD.CreateNewField(Names.PERSON_FORMATTED_NAME, FieldType.String, 33);
               INPUT_RECORD.CreateNewField(Names.PERSON_NUMBER, FieldType.String, 10);
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE = FileHandler.GetFile("ICRIN");
        ...
        #region Constructors
        public SWEXLE12_fd(SWEXLE12_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE12_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE12_ws_WorkingStorage";
    ...
    internal class SWEXLE12_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE12_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0004EV.CreateNewGroup(Names.SERVICE_PROVIDER_0004ET, (SERVICE_PROVIDER_0004ET) =>
               {
    ...
    public class SWEXLE12 : EABBase
    {
        ...
        public SWEXLE12()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE12");

            WS = new SWEXLE12_ws();
            FD = new SWEXLE12_fd(WS);
            LS = new SWEXLE12_ls();
        }
        ...
        private SWEXLE12_ws WS;

        //==== File Data Class ========================================
        private SWEXLE12_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE12_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1176243619(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1176243619
        /// </summary>
        private void M_MAIN_1176243619(string returnMethod = "")
        {
            M_PARA_1176243619_INIT("M_PARA_1176243619_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1176243619-INIT THRU PARA-1176243619-INIT-EXIT
            M_PARA_1176243619("M_PARA_1176243619_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1176243619 THRU PARA-1176243619-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1176243619
        /// </summary>
        private void M_PARA_1176243619(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1176243619") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.LAST_NAME_0004.SetValue(FD.SP_LAST_NAME);                                                        //COBOL==> MOVE SP-LAST-NAME TO LAST-NAME-0004
                LS.FIRST_NAME_0004.SetValue(FD.SP_FIRST_NAME);                                                      //COBOL==> MOVE SP-FIRST-NAME TO FIRST-NAME-0004
                LS.MIDDLE_INITIAL_0004.SetValue(FD.SP_MIDDLE_INTITIAL);                                             //COBOL==> MOVE SP-MIDDLE-INTITIAL TO MIDDLE-INITIAL-0004
                LS.FORMATTED_NAME_0002.SetValue(FD.PERSON_FORMATTED_NAME);                                          //COBOL==> MOVE PERSON-FORMATTED-NAME TO FORMATTED-NAME-0002
                LS.NUMBER_0002.SetValue(FD.PERSON_NUMBER);                                                          //COBOL==> MOVE PERSON-NUMBER TO NUMBER-0002
                LS.NUMBER_0003.SetValue(FD.CASE_NUMBER);                                                            //COBOL==> MOVE CASE-NUMBER TO NUMBER-0003
            }                                                                                                //COBOL==> WHEN '10'
            else
            ...
            {
                LS.STATUS_0005.SetValue("BR");                                                                      //COBOL==> MOVE 'BR' TO STATUS-0005
            }                                                                                                   //COBOL==> END-EVALUATE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1176243619_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1176243619_EXIT
        /// </summary>
        private void M_PARA_1176243619_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1176243619_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1176243619_EXIT") { M_PARA_1176243619_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1176243619_INIT
        /// </summary>
        private void M_PARA_1176243619_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1176243619_INIT") { M_PARA_1176243619_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1176243619_INIT_EXIT
        /// </summary>
        private void M_PARA_1176243619_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1176243619_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
