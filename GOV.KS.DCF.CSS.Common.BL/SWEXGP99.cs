...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:13:54 PM
   **        *   FROM COBOL PGM   :  SWEXGP99
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXGP99_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP99_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT99");
    ...
    internal class SWEXGP99_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP99_ws_WorkingStorage";
    ...
    internal class SWEXGP99_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP99_ls_LinkageSection";
    ...
    public class SWEXGP99 : EABBase
    {
        ...
        public SWEXGP99()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP99");
        ...
        private SWEXGP99_ws WS;

        //==== File Data Class ========================================
        private SWEXGP99_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP99_ls LS;
        #endregion
