...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:21:58 PM
   **        *   FROM COBOL PGM   :  SWEXLE07
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_WRITE_REFERRAL_EXTRACT    DATE: 2001/07/19
       TARGET OS:   MVS                       TIME: 16:18:51
   ...
   *-----------------------------------------------------------**
   * 05/20/21 RAJ S         CQ68844     MODIFIED TO SKIP MODI- **
   *                                    FICATION REASON CODES  **
   *                                    FROM PROCESSING.       **
   **************************************************************
*/
#endregion
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE07_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE07_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.OUTPUT_RECORD, (OUTPUT_RECORD) =>
           {
               ...
               OUTPUT_RECORD.CreateNewField(Names.CO_OFFICE_ID, FieldType.SignedNumeric, 4);
               OUTPUT_RECORD.CreateNewField(Names.SUPERVISOR_LAST_NAME, FieldType.String, 17);
               OUTPUT_RECORD.CreateNewField(Names.SUPERVISOR_FIRST_NAME, FieldType.String, 12);
               OUTPUT_RECORD.CreateNewField(Names.SUPERVISOR_MIDDLE_IN, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.CO_LAST_NAME, FieldType.String, 17);
               OUTPUT_RECORD.CreateNewField(Names.CO_FIRST_NAME, FieldType.String, 12);
               OUTPUT_RECORD.CreateNewField(Names.CO_MIDDLE_INITIAL, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.ATTORNEY_LAST_NAME, FieldType.String, 17);
               OUTPUT_RECORD.CreateNewField(Names.ATTORNEY_FIRST_NAME, FieldType.String, 12);
               OUTPUT_RECORD.CreateNewField(Names.ATTORNEY_MIDDLE_INITIAL, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.AP_FORMATTED_NAME, FieldType.String, 33);
               OUTPUT_RECORD.CreateNewField(Names.CASE_NUMBER, FieldType.String, 10);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_DATE, FieldType.SignedNumeric, 8);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_1, FieldType.String, 4);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_2, FieldType.String, 4);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_3, FieldType.String, 4);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_4, FieldType.String, 4);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_REASON_5, FieldType.String, 4);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_STATUS, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.REFERRAL_IDENTIFIER, FieldType.SignedNumeric, 3);
           });
        ...
        #region Constructors
        public SWEXLE07_fd(SWEXLE07_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE07_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE07_ws_WorkingStorage";
    ...
    internal class SWEXLE07_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE07_ls_LinkageSection";
    ...
    public class SWEXLE07 : EABBase
    {
        ...
        public SWEXLE07()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE07");

            WS = new SWEXLE07_ws();
            FD = new SWEXLE07_fd(WS);
            LS = new SWEXLE07_ls();
        }
        ...
        private SWEXLE07_ws WS;

        //==== File Data Class ========================================
        private SWEXLE07_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE07_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0003EV , IMPORT-LEGAL-0004EV , IMPORT-CO-0005EV , IMPORT-SUPERVISOR-0006EV , IMPORT-CO-0007EV , IMPORT-AREA-0008EV , IMPORT-0009EV , EXPORT-0010EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1042548397(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1042548397
        /// </summary>
        private void M_MAIN_1042548397(string returnMethod = "")
        {
            M_PARA_1042548397_INIT("M_PARA_1042548397_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1042548397-INIT THRU PARA-1042548397-INIT-EXIT
            M_PARA_1042548397("M_PARA_1042548397_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1042548397 THRU PARA-1042548397-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1042548397
        /// </summary>
        private void M_PARA_1042548397(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1042548397") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.AREA_OFFICE_NAME.SetValue(LS.NAME_0008);                                                         //COBOL==> MOVE NAME-0008 TO AREA-OFFICE-NAME
            FD.CO_OFFICE_NAME.SetValue(LS.NAME_0007);                                                           //COBOL==> MOVE NAME-0007 TO CO-OFFICE-NAME
            FD.CO_OFFICE_ID.SetValue(LS.SYSTEM_GENERATED_ID_0007);                                              //COBOL==> MOVE SYSTEM-GENERATED-ID-0007 TO CO-OFFICE-ID
            FD.SUPERVISOR_LAST_NAME.SetValue(LS.LAST_NAME_0006);                                                //COBOL==> MOVE LAST-NAME-0006 TO SUPERVISOR-LAST-NAME
            FD.SUPERVISOR_FIRST_NAME.SetValue(LS.FIRST_NAME_0006);                                              //COBOL==> MOVE FIRST-NAME-0006 TO SUPERVISOR-FIRST-NAME
            FD.SUPERVISOR_MIDDLE_IN.SetValue(LS.MIDDLE_INITIAL_0006);                                           //COBOL==> MOVE MIDDLE-INITIAL-0006 TO SUPERVISOR-MIDDLE-IN
            FD.CO_LAST_NAME.SetValue(LS.LAST_NAME_0005);                                                        //COBOL==> MOVE LAST-NAME-0005 TO CO-LAST-NAME
            FD.CO_FIRST_NAME.SetValue(LS.FIRST_NAME_0005);                                                      //COBOL==> MOVE FIRST-NAME-0005 TO CO-FIRST-NAME
            FD.CO_MIDDLE_INITIAL.SetValue(LS.MIDDLE_INITIAL_0005);                                              //COBOL==> MOVE MIDDLE-INITIAL-0005 TO CO-MIDDLE-INITIAL
            FD.ATTORNEY_LAST_NAME.SetValue(LS.LAST_NAME_0004);                                                  //COBOL==> MOVE LAST-NAME-0004 TO ATTORNEY-LAST-NAME
            FD.ATTORNEY_FIRST_NAME.SetValue(LS.FIRST_NAME_0004);                                                //COBOL==> MOVE FIRST-NAME-0004 TO ATTORNEY-FIRST-NAME
            FD.ATTORNEY_MIDDLE_INITIAL.SetValue(LS.MIDDLE_INITIAL_0004);                                        //COBOL==> MOVE MIDDLE-INITIAL-0004 TO ATTORNEY-MIDDLE-INITIAL
            FD.AP_FORMATTED_NAME.SetValue(LS.FORMATTED_NAME_0001);                                              //COBOL==> MOVE FORMATTED-NAME-0001 TO AP-FORMATTED-NAME
            ...
            if (WS.NON_MOD_REASONS.Value)                                                                       //COBOL==> IF NON-MOD-REASONS
            {
            ...
            if (WS.NON_MOD_REASONS.Value)                                                                       //COBOL==> IF NON-MOD-REASONS
            {
                ...
                WS.WS_SKIP_FLAG.SetValue("N");                                                                      //COBOL==> MOVE 'N' TO WS-SKIP-FLAG
                                                                                                                ...
                                                                                                                //COMMENT: *    MOVE REFERRAL-REASON-1-0002
                                                                                                                //COMMENT: *      TO REFERRAL-REASON-1
                                                                                                                //COMMENT: *    MOVE REFERRAL-REASON-2-0002
                                                                                                                //COMMENT: *      TO REFERRAL-REASON-2
                                                                                                                //COMMENT: *    MOVE REFERRAL-REASON-3-0002
                                                                                                                //COMMENT: *      TO REFERRAL-REASON-3
                                                                                                                //COMMENT: *    MOVE REFERRAL-REASON-4-0002
                                                                                                                //COMMENT: *      TO REFERRAL-REASON-4
                                                                                                                //COMMENT: *    MOVE REFERRAL-REASON-5-0002
                                                                                                                //COMMENT: *      TO REFERRAL-REASON-5
            FD.REFERRAL_STATUS.SetValue(LS.STATUS_0002);                                                        //COBOL==> MOVE STATUS-0002 TO REFERRAL-STATUS
            FD.REFERRAL_IDENTIFIER.SetValue(LS.IDENTIFIER_0002);                                                //COBOL==> MOVE IDENTIFIER-0002 TO REFERRAL-IDENTIFIER
        ...
        {
            //COMMENT: **********************
            if (WS.WS_CURR_CNT.IsZeros())                                                                       //COBOL==> IF WS-CURR-CNT = ZEROS
            {
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1042548397_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1042548397_EXIT
        /// </summary>
        private void M_PARA_1042548397_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1042548397_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1042548397_EXIT") { M_PARA_1042548397_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1042548397_INIT
        /// </summary>
        private void M_PARA_1042548397_INIT(string returnMethod = "")
        {
            LS.EXPORT_0010EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0010EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1042548397_INIT") { M_PARA_1042548397_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1042548397_INIT_EXIT
        /// </summary>
        private void M_PARA_1042548397_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1042548397_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
