...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:52:10 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXIU30 : OnlineEABBase
    {
        ...
        private void M_AA005_DECLARE_REF_CURSOR(string returnMethod = "")
        {
            ...
            WS.REF_AP_NUMBER.SetValue(WS.MV_REFERRAL_AP);                                                       //COBOL==> MOVE MV-REFERRAL-AP TO REF-AP-NUMBER.
                                                                                                                // Declare Relocated to Method SetUpProgram!                                                        //COBOL==> EXEC SQL DECLARE REF-VIEW CURSOR FOR SELECT FK_CSB_CASE_NO , AP_NUMBER , REFERRAL_TYPE , REFERRAL_DATE , PI_CLIENT_NUMBER , CSE_CASE_NUMBER , CSE_ESTABLISH_DATE , AP_CLIENT_NUMBER , SYSTEM_ORIGIN , LAST_MODIFIED_BY , LAST_MODIFIED_TMST FROM KSD_REFERRAL WHERE ( FK_CSB_CASE_NO = :REF-FK-CSB-CASE-NO ) AND ( AP_NUMBER = :REF-AP-NUMBER ) ORDER BY FK_CSB_CASE_NO , AP_NUMBER , REFERRAL_TYPE , REFERRAL_DATE END-EXEC.
