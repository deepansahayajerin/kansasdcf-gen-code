...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:30 PM
   **        *   FROM COBOL PGM   :  SWEXLE19
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_BFX9_WRITE_NCP_FILE           DATE: 2014/12/15
       TARGET OS:   MVS                       TIME: 10:22:59
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE19_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE19_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.NCP_RECORD, FieldType.String, 126);
        ...
        public override void Initialize()
        {
            ...
            NCP_FILE = FileHandler.GetFile("NCPOUT");
        ...
        #region Constructors
        public SWEXLE19_fd(SWEXLE19_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE19_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE19_ws_WorkingStorage";
    ...
    internal class SWEXLE19_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE19_ls_LinkageSection";
            ...
            internal const string NCP_FILE_LAYOUT_0002AS = "NCP_FILE_LAYOUT_0002AS";
            internal const string NCP_FILE_LAYOUT_0002 = "NCP_FILE_LAYOUT_0002";
            internal const string NCP_FILE_LAYOUT_0002XX = "NCP_FILE_LAYOUT_0002XX";
        ...
        public IField NCP_FILE_LAYOUT_0002AS { get { return GetElementByName<IField>(Names.NCP_FILE_LAYOUT_0002AS); } }
        public IField NCP_FILE_LAYOUT_0002 { get { return GetElementByName<IField>(Names.NCP_FILE_LAYOUT_0002); } }
        public IField NCP_FILE_LAYOUT_0002XX { get { return GetElementByName<IField>(Names.NCP_FILE_LAYOUT_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
               ...
               {
                   CSSI_WORKSET_0002ET.CreateNewField(Names.NCP_FILE_LAYOUT_0002AS, FieldType.String, 1);

                   IField NCP_FILE_LAYOUT_0002_local = CSSI_WORKSET_0002ET.CreateNewField(Names.NCP_FILE_LAYOUT_0002, FieldType.String, 126);
                   CSSI_WORKSET_0002ET.CreateNewFieldRedefine(Names.NCP_FILE_LAYOUT_0002XX, FieldType.String, NCP_FILE_LAYOUT_0002_local, 126);
               });
           });
    ...
    public class SWEXLE19 : EABBase
    {
        ...
        public SWEXLE19()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE19");

            WS = new SWEXLE19_ws();
            FD = new SWEXLE19_fd(WS);
            LS = new SWEXLE19_ls();
        }
        ...
        private SWEXLE19_ws WS;

        //==== File Data Class ========================================
        private SWEXLE19_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE19_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0443288471(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0443288471
        /// </summary>
        private void M_MAIN_0443288471(string returnMethod = "")
        {
            M_PARA_0443288471_INIT("M_PARA_0443288471_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0443288471-INIT THRU PARA-0443288471-INIT-EXIT
            M_PARA_0443288471("M_PARA_0443288471_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0443288471 THRU PARA-0443288471-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0443288471
        /// </summary>
        private void M_PARA_0443288471(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0443288471") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.NCP_RECORD.SetValue(LS.NCP_FILE_LAYOUT_0002);                                                    //COBOL==> MOVE NCP-FILE-LAYOUT-0002 TO NCP-RECORD
        ...
        {
            //COMMENT: ******************
            FD.NCP_FILE.CloseFile();                                                                            //COBOL==> CLOSE NCP-FILE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0443288471_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288471_EXIT
        /// </summary>
        private void M_PARA_0443288471_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0443288471_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0443288471_EXIT") { M_PARA_0443288471_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288471_INIT
        /// </summary>
        private void M_PARA_0443288471_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0443288471_INIT") { M_PARA_0443288471_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0443288471_INIT_EXIT
        /// </summary>
        private void M_PARA_0443288471_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0443288471_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
