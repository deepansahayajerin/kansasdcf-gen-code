...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:52 PM
   **        *   FROM COBOL PGM   :  SWEXNE02
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: SP_EAB_CONCAT                    DATE: 96/06/28
       TARGET OS:   MVS                       TIME: 09:47:57
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXNE02_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXNE02_ws_WorkingStorage";
            ...
            internal const string FUNC_0469009040_ESC_FLAG = "FUNC_0469009040_ESC_FLAG";
        }
        #endregion
        ...
        public IField FUNC_0469009040_ESC_FLAG { get { return GetElementByName<IField>(Names.FUNC_0469009040_ESC_FLAG); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_COPY, (IMPORT_COPY) =>
           {
            ...
            recordDef.CreateNewField(Names.FUNC_0469009040_ESC_FLAG, FieldType.String, 1);
    ...
    internal class SWEXNE02_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXNE02_ls_LinkageSection";
            ...
            internal const string A_0469009043_IA = "A_0469009043_IA";
            ...
            internal const string A_0469009044_OA = "A_0469009044_OA";
        ...
        public IGroup A_0469009043_IA { get { return GetElementByName<IGroup>(Names.A_0469009043_IA); } }
        ...
        public IGroup A_0469009044_OA { get { return GetElementByName<IGroup>(Names.A_0469009044_OA); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               W_IA.CreateNewGroup(Names.A_0469009043_IA, (A_0469009043_IA) =>
               {
                   A_0469009043_IA.CreateNewGroup(Names.IMPORT_INPUT_1_0001EV, (IMPORT_INPUT_1_0001EV) =>
                   {
                   ...
                   A_0469009043_IA.CreateNewGroup(Names.IMPORT_INPUT_2_0002EV, (IMPORT_INPUT_2_0002EV) =>
                   {
           ...
           {
               W_OA.CreateNewGroup(Names.A_0469009044_OA, (A_0469009044_OA) =>
               {
                   A_0469009044_OA.CreateNewGroup(Names.EXPORT_0003EV, (EXPORT_0003EV) =>
                   {
    ...
    public class SWEXNE02 : EABBase
    {
        ...
        public SWEXNE02()
            : base()
        {
            this.ProgramName.SetValue("SWEXNE02");
        ...
        private SWEXNE02_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXNE02_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0469009040(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0469009040
        /// </summary>
        private void M_MAIN_0469009040(string returnMethod = "")
        {
            M_PARA_0469009040_INIT("M_PARA_0469009040_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0469009040-INIT THRU PARA-0469009040-INIT-EXIT
            M_PARA_0469009040("M_PARA_0469009040_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0469009040 THRU PARA-0469009040-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0469009040
        /// </summary>
        private void M_PARA_0469009040(string returnMethod = "")
        {
            WS.FUNC_0469009040_ESC_FLAG.SetValue("N");                                                          //COBOL==> MOVE 'N' TO FUNC-0469009040-ESC-FLAG
            ...
            LS.VALUE_0003DV.SetStringValueWithPointer(StringUtils.Stringify(StringUtils.DelimitedByString(WS.TILDE.AsString(), WS.STRING1_COPY.AsString(), WS.STRING2_COPY.AsString())), WS.STRING3_COUNT);  //COBOL==> STRING STRING1-COPY STRING2-COPY DELIMITED BY TILDE INTO VALUE-0003DV WITH POINTER STRING3-COUNT
            LS.VALUE_0003DL.SetComputeValue((WS.STRING1_SUB.AsDecimal() + WS.STRING2_SUB.AsDecimal()) - 2m);    //COBOL==> COMPUTE VALUE-0003DL = STRING1-SUB + STRING2-SUB - 2 .
            if (returnMethod != "" && returnMethod != "M_PARA_0469009040") { M_PARA_0469009040_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0469009040_EXIT
        /// </summary>
        private void M_PARA_0469009040_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0469009040_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0469009040_EXIT") { M_PARA_0469009040_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0469009040_INIT
        /// </summary>
        private void M_PARA_0469009040_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0469009040_INIT") { M_PARA_0469009040_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0469009040_INIT_EXIT
        /// </summary>
        private void M_PARA_0469009040_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0469009040_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
