...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:20 PM
   **        *   FROM COBOL PGM   :  SWEXLE15
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_BFX4_WRITE_EXTRACT_DATA_FILE  DATE: 2007/02/09
       TARGET OS:   MVS                       TIME: 11:49:12
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE15_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE15_fd_FileSection";
            ...
            internal const string CSP_NAME = "CSP_NAME";
        ...
        public IField CSP_NAME { get { return GetElementByName<IField>(Names.CSP_NAME); } }
        public IField STREET { get { return GetElementByName<IField>(Names.STREET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               OUTPUT_RECORD.CreateNewField(Names.CSP_NUMBER, FieldType.String, 10);
               OUTPUT_RECORD.CreateNewField(Names.CSP_NAME, FieldType.String, 33);
               OUTPUT_RECORD.CreateNewField(Names.STREET, FieldType.String, 25);
               OUTPUT_RECORD.CreateNewField(Names.STREET_2, FieldType.String, 25);
               OUTPUT_RECORD.CreateNewField(Names.CITY, FieldType.String, 15);
               OUTPUT_RECORD.CreateNewField(Names.STATE, FieldType.String, 2);
               OUTPUT_RECORD.CreateNewField(Names.ZIP_CODE, FieldType.String, 5);
           });
        ...
        public override void Initialize()
        {
            ...
            OUTPUT_FILE = FileHandler.GetFile("OUTFILE");
        ...
        #region Constructors
        public SWEXLE15_fd(SWEXLE15_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE15_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE15_ws_WorkingStorage";
    ...
    internal class SWEXLE15_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE15_ls_LinkageSection";
            ...
            internal const string CSE_PERSON_ADDRESS_0003ET = "CSE_PERSON_ADDRESS_0003ET";
        ...
        public IGroup CSE_PERSON_ADDRESS_0003ET { get { return GetElementByName<IGroup>(Names.CSE_PERSON_ADDRESS_0003ET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0003EV.CreateNewGroup(Names.CSE_PERSON_ADDRESS_0003ET, (CSE_PERSON_ADDRESS_0003ET) =>
               {
                   CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.LOCATION_TYPE_0003AS, FieldType.String, 1);

                   IField LOCATION_TYPE_0003_local = CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.LOCATION_TYPE_0003, FieldType.String, 1);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewFieldRedefine(Names.LOCATION_TYPE_0003XX, FieldType.String, LOCATION_TYPE_0003_local, 1);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.STREET_1_0003AS, FieldType.String, 1);

                   IField STREET_1_0003_local = CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.STREET_1_0003, FieldType.String, 25);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewFieldRedefine(Names.STREET_1_0003XX, FieldType.String, STREET_1_0003_local, 25);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.CITY_0003AS, FieldType.String, 1);

                   IField CITY_0003_local = CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.CITY_0003, FieldType.String, 15);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewFieldRedefine(Names.CITY_0003XX, FieldType.String, CITY_0003_local, 15);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.STATE_0003AS, FieldType.String, 1);

                   IField STATE_0003_local = CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.STATE_0003, FieldType.String, 2);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewFieldRedefine(Names.STATE_0003XX, FieldType.String, STATE_0003_local, 2);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.ZIP_CODE_0003AS, FieldType.String, 1);

                   IField ZIP_CODE_0003_local = CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.ZIP_CODE_0003, FieldType.String, 5);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewFieldRedefine(Names.ZIP_CODE_0003XX, FieldType.String, ZIP_CODE_0003_local, 5);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.STREET_2_0003AS, FieldType.String, 1);

                   IField STREET_2_0003_local = CSE_PERSON_ADDRESS_0003ET.CreateNewField(Names.STREET_2_0003, FieldType.String, 25);
                   CSE_PERSON_ADDRESS_0003ET.CreateNewFieldRedefine(Names.STREET_2_0003XX, FieldType.String, STREET_2_0003_local, 25);
               });
           });
    ...
    public class SWEXLE15 : EABBase
    {
        ...
        public SWEXLE15()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE15");

            WS = new SWEXLE15_ws();
            FD = new SWEXLE15_fd(WS);
            LS = new SWEXLE15_ls();
        }
        ...
        private SWEXLE15_ws WS;

        //==== File Data Class ========================================
        private SWEXLE15_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE15_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1546390409(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1546390409
        /// </summary>
        private void M_MAIN_1546390409(string returnMethod = "")
        {
            M_PARA_1546390409_INIT("M_PARA_1546390409_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1546390409-INIT THRU PARA-1546390409-INIT-EXIT
            M_PARA_1546390409("M_PARA_1546390409_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1546390409 THRU PARA-1546390409-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1546390409
        /// </summary>
        private void M_PARA_1546390409(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1546390409") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0004.SetValue("BI");                                                                      //COBOL==> MOVE 'BI' TO STATUS-0004
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0004.SetValue("PE");                                                                      //COBOL==> MOVE 'PE' TO STATUS-0004
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_2000_WRITE_FILE(string returnMethod = "")
        {
            ...
            FD.CSP_NAME.SetValue(LS.FORMATTED_NAME_0002);                                                       //COBOL==> MOVE FORMATTED-NAME-0002 TO CSP-NAME
            FD.STREET.SetValue(LS.STREET_1_0003);                                                               //COBOL==> MOVE STREET-1-0003 TO STREET
            FD.STREET_2.SetValue(LS.STREET_2_0003);                                                             //COBOL==> MOVE STREET-2-0003 TO STREET-2
            FD.CITY.SetValue(LS.CITY_0003);                                                                     //COBOL==> MOVE CITY-0003 TO CITY
            FD.STATE.SetValue(LS.STATE_0003);                                                                   //COBOL==> MOVE STATE-0003 TO STATE
            FD.ZIP_CODE.SetValue(LS.ZIP_CODE_0003);                                                             //COBOL==> MOVE ZIP-CODE-0003 TO ZIP-CODE
            ...
            {
                LS.STATUS_0004.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0004
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1546390409_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1546390409_EXIT
        /// </summary>
        private void M_PARA_1546390409_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1546390409_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1546390409_EXIT") { M_PARA_1546390409_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1546390409_INIT
        /// </summary>
        private void M_PARA_1546390409_INIT(string returnMethod = "")
        {
            LS.EXPORT_0004EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0004EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1546390409_INIT") { M_PARA_1546390409_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1546390409_INIT_EXIT
        /// </summary>
        private void M_PARA_1546390409_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1546390409_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
