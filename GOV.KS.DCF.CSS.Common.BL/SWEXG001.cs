...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:10 PM
   **        *   FROM COBOL PGM   :  SWEXG001
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_EXT_GET_PARMS_THRU_JCL_SYSIN  DATE: 1999/07/15
       TARGET OS:   MVS                       TIME: 10:58:58
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXG001_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXG001_ws_WorkingStorage";
        }
        #endregion
    ...
    internal class SWEXG001_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXG001_ls_LinkageSection";
            ...
            internal const string PROGRAM_PROCESSING_INFO_0001ET = "PROGRAM_PROCESSING_INFO_0001ET";
            internal const string PARAMETER_LIST_0001AS = "PARAMETER_LIST_0001AS";
            internal const string PARAMETER_LIST_0001 = "PARAMETER_LIST_0001";
            internal const string PARAMETER_LIST_0001DL = "PARAMETER_LIST_0001DL";
            internal const string PARAMETER_LIST_0001XL = "PARAMETER_LIST_0001XL";
            internal const string PARAMETER_LIST_0001DV = "PARAMETER_LIST_0001DV";
            internal const string PARAMETER_LIST_0001XV = "PARAMETER_LIST_0001XV";
            internal const string PARAMETER_LIST_0001XX = "PARAMETER_LIST_0001XX";
        ...
        public IGroup PROGRAM_PROCESSING_INFO_0001ET { get { return GetElementByName<IGroup>(Names.PROGRAM_PROCESSING_INFO_0001ET); } }
        public IField PARAMETER_LIST_0001AS { get { return GetElementByName<IField>(Names.PARAMETER_LIST_0001AS); } }
        public IGroup PARAMETER_LIST_0001 { get { return GetElementByName<IGroup>(Names.PARAMETER_LIST_0001); } }
        public IField PARAMETER_LIST_0001DL { get { return GetElementByName<IField>(Names.PARAMETER_LIST_0001DL); } }
        public IField PARAMETER_LIST_0001XL { get { return GetElementByName<IField>(Names.PARAMETER_LIST_0001XL); } }
        public IField PARAMETER_LIST_0001DV { get { return GetElementByName<IField>(Names.PARAMETER_LIST_0001DV); } }
        public IField PARAMETER_LIST_0001XV { get { return GetElementByName<IField>(Names.PARAMETER_LIST_0001XV); } }
        public IField PARAMETER_LIST_0001XX { get { return GetElementByName<IField>(Names.PARAMETER_LIST_0001XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0001EV, (EXPORT_0001EV) =>
           {
               EXPORT_0001EV.CreateNewGroup(Names.PROGRAM_PROCESSING_INFO_0001ET, (PROGRAM_PROCESSING_INFO_0001ET) =>
               {
                   PROGRAM_PROCESSING_INFO_0001ET.CreateNewField(Names.PARAMETER_LIST_0001AS, FieldType.String, 1);
                   IGroup PARAMETER_LIST_0001_local = (IGroup)PROGRAM_PROCESSING_INFO_0001ET.CreateNewGroup(Names.PARAMETER_LIST_0001, (PARAMETER_LIST_0001) =>
                   {

                       IField PARAMETER_LIST_0001DL_local = PARAMETER_LIST_0001.CreateNewField(Names.PARAMETER_LIST_0001DL, FieldType.CompShort, 4);
                       PARAMETER_LIST_0001.CreateNewFieldRedefine(Names.PARAMETER_LIST_0001XL, FieldType.String, PARAMETER_LIST_0001DL_local, 2);

                       IField PARAMETER_LIST_0001DV_local = PARAMETER_LIST_0001.CreateNewField(Names.PARAMETER_LIST_0001DV, FieldType.String, 100);
                       PARAMETER_LIST_0001.CreateNewFieldRedefine(Names.PARAMETER_LIST_0001XV, FieldType.String, PARAMETER_LIST_0001DV_local, 100);
                   });
                   PROGRAM_PROCESSING_INFO_0001ET.CreateNewFieldRedefine(Names.PARAMETER_LIST_0001XX, FieldType.String, PARAMETER_LIST_0001_local, 102);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_0001EV, args, 3);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_0001EV, args, 3);
    ...
    public class SWEXG001 : EABBase
    {
        ...
        public SWEXG001()
            : base()
        {
            this.ProgramName.SetValue("SWEXG001");
        ...
        private SWEXG001_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXG001_ls LS;
        //==== Special names flags =======================================
        bool SYSIN = false;
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , EXPORT-0001EV EXPORT-0002EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0293617870(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0293617870
        /// </summary>
        private void M_MAIN_0293617870(string returnMethod = "")
        {
            M_PARA_0293617870_INIT("M_PARA_0293617870_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0293617870-INIT THRU PARA-0293617870-INIT-EXIT
            M_PARA_0293617870("M_PARA_0293617870_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0293617870 THRU PARA-0293617870-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0293617870
        /// </summary>
        private void M_PARA_0293617870(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            GetAcceptData("SYSIN", LS.PARAMETER_LIST_0001DV);                                                   //COBOL==> ACCEPT PARAMETER-LIST-0001DV FROM SYSIN
            LS.PARAMETER_LIST_0001DL.SetValue(100);                                                             //COBOL==> MOVE 100 TO PARAMETER-LIST-0001DL
            LS.NUMERIC_RETURN_CODE_0002.SetValueWithZeroes();                                                   //COBOL==> MOVE ZEROS TO NUMERIC-RETURN-CODE-0002
            DisplayToLog(LS.PARAMETER_LIST_0001DV.AsString());                                                  //COBOL==> DISPLAY PARAMETER-LIST-0001DV .
            if (returnMethod != "" && returnMethod != "M_PARA_0293617870") { M_PARA_0293617870_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0293617870_EXIT
        /// </summary>
        private void M_PARA_0293617870_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0293617870_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0293617870_EXIT") { M_PARA_0293617870_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0293617870_INIT
        /// </summary>
        private void M_PARA_0293617870_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0293617870_INIT") { M_PARA_0293617870_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0293617870_INIT_EXIT
        /// </summary>
        private void M_PARA_0293617870_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0293617870_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }

        private void SetSpecialNames()
        {
            SetUPSIFlags();
            // Special Names Clause not translated:=:SYSIN IS SYSIN.:=:
        }
        #endregion
    }
    #endregion
