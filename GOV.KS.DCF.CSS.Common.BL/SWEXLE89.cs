...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:22:40 PM
   **        *   FROM COBOL PGM   :  SWEXLE89
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_WRITE_FDSO_SNAPSHOT_FILE  DATE: 2000/09/25
       TARGET OS:   MVS                       TIME: 11:07:24
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXLE89_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE89_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.EXTFILE_RECORD, FieldType.String, 245);
        ...
        #region Constructors
        public SWEXLE89_fd(SWEXLE89_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE89_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE89_ws_WorkingStorage";
        ...
        public IField TRANSACTION_TYPE { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXLE89 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_FDSO_SNAPSHOT_DETAIL, (WS_FDSO_SNAPSHOT_DETAIL) =>
           {
               ...
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.SUBMITTING_STATE, FieldType.String, 2);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.LOCAL_CODE, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.SSN, FieldType.UnsignedNumeric, 9);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.CASE_NUMBER, FieldType.String, 15);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.LAST_NAME, FieldType.String, 20);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.FIRST_NAME, FieldType.String, 15);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.CURRENT_ARREARAGE_AMT, FieldType.UnsignedNumeric, 8);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.CASE_TYPE, FieldType.String, 1);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.SPACES_2, FieldType.String, 10);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.ADMINISTRATIVE_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.FED_RETIREMENT_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.VENDOR_PAYMENTS_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.FEDERAL_SALARY_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.TAX_REFUND_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.PASSPORT_DENIAL_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.FIDM_OFFSET, FieldType.String, 3);
               WS_FDSO_SNAPSHOT_DETAIL.CreateNewField(Names.TRANSACTION_TYPE, FieldType.String, 1);
    ...
    internal class SWEXLE89_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE89_ls_LinkageSection";
            ...
            internal const string FDSO_SNAPSHOT_FILE_RECO_0001ET = "FDSO_SNAPSHOT_FILE_RECO_0001ET";
            ...
            internal const string CURRENT_ARREARAGE_AMOUN_0002AS = "CURRENT_ARREARAGE_AMOUN_0002AS";
            internal const string CURRENT_ARREARAGE_AMOUNT_0002 = "CURRENT_ARREARAGE_AMOUNT_0002";
            internal const string CURRENT_ARREARAGE_AMOUN_0002XX = "CURRENT_ARREARAGE_AMOUN_0002XX";
            internal const string CASE_TYPE_0002AS = "CASE_TYPE_0002AS";
            internal const string CASE_TYPE_0002 = "CASE_TYPE_0002";
            internal const string CASE_TYPE_0002XX = "CASE_TYPE_0002XX";
            internal const string ETYPE_ADMINISTRATIVE_OF_0003AS = "ETYPE_ADMINISTRATIVE_OF_0003AS";
            internal const string ETYPE_ADMINISTRATIVE_OFFS_0003 = "ETYPE_ADMINISTRATIVE_OFFS_0003";
            internal const string ETYPE_ADMINISTRATIVE_OF_0003XX = "ETYPE_ADMINISTRATIVE_OF_0003XX";
            internal const string ETYPE_FEDERAL_RETIREMEN_0004AS = "ETYPE_FEDERAL_RETIREMEN_0004AS";
            internal const string ETYPE_FEDERAL_RETIREMENT_0004 = "ETYPE_FEDERAL_RETIREMENT_0004";
            internal const string ETYPE_FEDERAL_RETIREMEN_0004XX = "ETYPE_FEDERAL_RETIREMEN_0004XX";
            internal const string ETYPE_VENDOR_PAYMENT_OR_0005AS = "ETYPE_VENDOR_PAYMENT_OR_0005AS";
            internal const string ETYPE_VENDOR_PAYMENT_OR_M_0005 = "ETYPE_VENDOR_PAYMENT_OR_M_0005";
            internal const string ETYPE_VENDOR_PAYMENT_OR_0005XX = "ETYPE_VENDOR_PAYMENT_OR_0005XX";
            internal const string ETYPE_FEDERAL_SALARY_0005AS = "ETYPE_FEDERAL_SALARY_0005AS";
            internal const string ETYPE_FEDERAL_SALARY_0005 = "ETYPE_FEDERAL_SALARY_0005";
            internal const string ETYPE_FEDERAL_SALARY_0005XX = "ETYPE_FEDERAL_SALARY_0005XX";
            internal const string ETYPE_TAX_REFUND_0005AS = "ETYPE_TAX_REFUND_0005AS";
            internal const string ETYPE_TAX_REFUND_0005 = "ETYPE_TAX_REFUND_0005";
            internal const string ETYPE_TAX_REFUND_0005XX = "ETYPE_TAX_REFUND_0005XX";
            internal const string ETYPE_PASSPORT_DENIAL_0005AS = "ETYPE_PASSPORT_DENIAL_0005AS";
            internal const string ETYPE_PASSPORT_DENIAL_0005 = "ETYPE_PASSPORT_DENIAL_0005";
            internal const string ETYPE_PASSPORT_DENIAL_0005XX = "ETYPE_PASSPORT_DENIAL_0005XX";
            internal const string ETYPE_FINANCIAL_INSTITU_0006AS = "ETYPE_FINANCIAL_INSTITU_0006AS";
            internal const string ETYPE_FINANCIAL_INSTITUTI_0006 = "ETYPE_FINANCIAL_INSTITUTI_0006";
            internal const string ETYPE_FINANCIAL_INSTITU_0006XX = "ETYPE_FINANCIAL_INSTITU_0006XX";
            internal const string TRANSACTION_TYPE_0006AS = "TRANSACTION_TYPE_0006AS";
            internal const string TRANSACTION_TYPE_0006 = "TRANSACTION_TYPE_0006";
            internal const string TRANSACTION_TYPE_0006XX = "TRANSACTION_TYPE_0006XX";
        ...
        public IGroup FDSO_SNAPSHOT_FILE_RECO_0001ET { get { return GetElementByName<IGroup>(Names.FDSO_SNAPSHOT_FILE_RECO_0001ET); } }
        ...
        public IField CURRENT_ARREARAGE_AMOUN_0002AS { get { return GetElementByName<IField>(Names.CURRENT_ARREARAGE_AMOUN_0002AS); } }
        public IField CURRENT_ARREARAGE_AMOUNT_0002 { get { return GetElementByName<IField>(Names.CURRENT_ARREARAGE_AMOUNT_0002); } }
        public IField CURRENT_ARREARAGE_AMOUN_0002XX { get { return GetElementByName<IField>(Names.CURRENT_ARREARAGE_AMOUN_0002XX); } }
        public IField CASE_TYPE_0002AS { get { return GetElementByName<IField>(Names.CASE_TYPE_0002AS); } }
        public IField CASE_TYPE_0002 { get { return GetElementByName<IField>(Names.CASE_TYPE_0002); } }
        public IField CASE_TYPE_0002XX { get { return GetElementByName<IField>(Names.CASE_TYPE_0002XX); } }
        public IField ETYPE_ADMINISTRATIVE_OF_0003AS { get { return GetElementByName<IField>(Names.ETYPE_ADMINISTRATIVE_OF_0003AS); } }
        public IField ETYPE_ADMINISTRATIVE_OFFS_0003 { get { return GetElementByName<IField>(Names.ETYPE_ADMINISTRATIVE_OFFS_0003); } }
        public IField ETYPE_ADMINISTRATIVE_OF_0003XX { get { return GetElementByName<IField>(Names.ETYPE_ADMINISTRATIVE_OF_0003XX); } }
        public IField ETYPE_FEDERAL_RETIREMEN_0004AS { get { return GetElementByName<IField>(Names.ETYPE_FEDERAL_RETIREMEN_0004AS); } }
        public IField ETYPE_FEDERAL_RETIREMENT_0004 { get { return GetElementByName<IField>(Names.ETYPE_FEDERAL_RETIREMENT_0004); } }
        public IField ETYPE_FEDERAL_RETIREMEN_0004XX { get { return GetElementByName<IField>(Names.ETYPE_FEDERAL_RETIREMEN_0004XX); } }
        public IField ETYPE_VENDOR_PAYMENT_OR_0005AS { get { return GetElementByName<IField>(Names.ETYPE_VENDOR_PAYMENT_OR_0005AS); } }
        public IField ETYPE_VENDOR_PAYMENT_OR_M_0005 { get { return GetElementByName<IField>(Names.ETYPE_VENDOR_PAYMENT_OR_M_0005); } }
        public IField ETYPE_VENDOR_PAYMENT_OR_0005XX { get { return GetElementByName<IField>(Names.ETYPE_VENDOR_PAYMENT_OR_0005XX); } }
        public IField ETYPE_FEDERAL_SALARY_0005AS { get { return GetElementByName<IField>(Names.ETYPE_FEDERAL_SALARY_0005AS); } }
        public IField ETYPE_FEDERAL_SALARY_0005 { get { return GetElementByName<IField>(Names.ETYPE_FEDERAL_SALARY_0005); } }
        public IField ETYPE_FEDERAL_SALARY_0005XX { get { return GetElementByName<IField>(Names.ETYPE_FEDERAL_SALARY_0005XX); } }
        public IField ETYPE_TAX_REFUND_0005AS { get { return GetElementByName<IField>(Names.ETYPE_TAX_REFUND_0005AS); } }
        public IField ETYPE_TAX_REFUND_0005 { get { return GetElementByName<IField>(Names.ETYPE_TAX_REFUND_0005); } }
        public IField ETYPE_TAX_REFUND_0005XX { get { return GetElementByName<IField>(Names.ETYPE_TAX_REFUND_0005XX); } }
        public IField ETYPE_PASSPORT_DENIAL_0005AS { get { return GetElementByName<IField>(Names.ETYPE_PASSPORT_DENIAL_0005AS); } }
        public IField ETYPE_PASSPORT_DENIAL_0005 { get { return GetElementByName<IField>(Names.ETYPE_PASSPORT_DENIAL_0005); } }
        public IField ETYPE_PASSPORT_DENIAL_0005XX { get { return GetElementByName<IField>(Names.ETYPE_PASSPORT_DENIAL_0005XX); } }
        public IField ETYPE_FINANCIAL_INSTITU_0006AS { get { return GetElementByName<IField>(Names.ETYPE_FINANCIAL_INSTITU_0006AS); } }
        public IField ETYPE_FINANCIAL_INSTITUTI_0006 { get { return GetElementByName<IField>(Names.ETYPE_FINANCIAL_INSTITUTI_0006); } }
        public IField ETYPE_FINANCIAL_INSTITU_0006XX { get { return GetElementByName<IField>(Names.ETYPE_FINANCIAL_INSTITU_0006XX); } }
        public IField TRANSACTION_TYPE_0006AS { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE_0006AS); } }
        public IField TRANSACTION_TYPE_0006 { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE_0006); } }
        public IField TRANSACTION_TYPE_0006XX { get { return GetElementByName<IField>(Names.TRANSACTION_TYPE_0006XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.FDSO_SNAPSHOT_FILE_RECO_0001ET, (FDSO_SNAPSHOT_FILE_RECO_0001ET) =>
               {
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.SUBMITTING_STATE_0001AS, FieldType.String, 1);

                   IField SUBMITTING_STATE_0001_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.SUBMITTING_STATE_0001, FieldType.String, 2);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.SUBMITTING_STATE_0001XX, FieldType.String, SUBMITTING_STATE_0001_local, 2);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.LOCAL_CODE_0001AS, FieldType.String, 1);

                   IField LOCAL_CODE_0001_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.LOCAL_CODE_0001, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.LOCAL_CODE_0001XX, FieldType.String, LOCAL_CODE_0001_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.SSN_0001AS, FieldType.String, 1);

                   IField SSN_0001_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.SSN_0001, FieldType.SignedNumeric, 9);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.SSN_0001XX, FieldType.String, SSN_0001_local, 9);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.CASE_NUMBER_0001AS, FieldType.String, 1);

                   IField CASE_NUMBER_0001_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.CASE_NUMBER_0001, FieldType.String, 15);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.CASE_NUMBER_0001XX, FieldType.String, CASE_NUMBER_0001_local, 15);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.LAST_NAME_0001AS, FieldType.String, 1);

                   IField LAST_NAME_0001_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.LAST_NAME_0001, FieldType.String, 20);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.LAST_NAME_0001XX, FieldType.String, LAST_NAME_0001_local, 20);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.FIRST_NAME_0001AS, FieldType.String, 1);

                   IField FIRST_NAME_0001_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.FIRST_NAME_0001, FieldType.String, 15);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.FIRST_NAME_0001XX, FieldType.String, FIRST_NAME_0001_local, 15);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.CURRENT_ARREARAGE_AMOUN_0002AS, FieldType.String, 1);

                   IField CURRENT_ARREARAGE_AMOUNT_0002_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.CURRENT_ARREARAGE_AMOUNT_0002, FieldType.SignedNumeric, 8);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.CURRENT_ARREARAGE_AMOUN_0002XX, FieldType.String, CURRENT_ARREARAGE_AMOUNT_0002_local, 8);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.CASE_TYPE_0002AS, FieldType.String, 1);

                   IField CASE_TYPE_0002_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.CASE_TYPE_0002, FieldType.String, 1);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.CASE_TYPE_0002XX, FieldType.String, CASE_TYPE_0002_local, 1);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_ADMINISTRATIVE_OF_0003AS, FieldType.String, 1);

                   IField ETYPE_ADMINISTRATIVE_OFFS_0003_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_ADMINISTRATIVE_OFFS_0003, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_ADMINISTRATIVE_OF_0003XX, FieldType.String, ETYPE_ADMINISTRATIVE_OFFS_0003_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_FEDERAL_RETIREMEN_0004AS, FieldType.String, 1);

                   IField ETYPE_FEDERAL_RETIREMENT_0004_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_FEDERAL_RETIREMENT_0004, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_FEDERAL_RETIREMEN_0004XX, FieldType.String, ETYPE_FEDERAL_RETIREMENT_0004_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_VENDOR_PAYMENT_OR_0005AS, FieldType.String, 1);

                   IField ETYPE_VENDOR_PAYMENT_OR_M_0005_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_VENDOR_PAYMENT_OR_M_0005, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_VENDOR_PAYMENT_OR_0005XX, FieldType.String, ETYPE_VENDOR_PAYMENT_OR_M_0005_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_FEDERAL_SALARY_0005AS, FieldType.String, 1);

                   IField ETYPE_FEDERAL_SALARY_0005_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_FEDERAL_SALARY_0005, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_FEDERAL_SALARY_0005XX, FieldType.String, ETYPE_FEDERAL_SALARY_0005_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_TAX_REFUND_0005AS, FieldType.String, 1);

                   IField ETYPE_TAX_REFUND_0005_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_TAX_REFUND_0005, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_TAX_REFUND_0005XX, FieldType.String, ETYPE_TAX_REFUND_0005_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_PASSPORT_DENIAL_0005AS, FieldType.String, 1);

                   IField ETYPE_PASSPORT_DENIAL_0005_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_PASSPORT_DENIAL_0005, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_PASSPORT_DENIAL_0005XX, FieldType.String, ETYPE_PASSPORT_DENIAL_0005_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_FINANCIAL_INSTITU_0006AS, FieldType.String, 1);

                   IField ETYPE_FINANCIAL_INSTITUTI_0006_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.ETYPE_FINANCIAL_INSTITUTI_0006, FieldType.String, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.ETYPE_FINANCIAL_INSTITU_0006XX, FieldType.String, ETYPE_FINANCIAL_INSTITUTI_0006_local, 3);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.TRANSACTION_TYPE_0006AS, FieldType.String, 1);

                   IField TRANSACTION_TYPE_0006_local = FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewField(Names.TRANSACTION_TYPE_0006, FieldType.String, 1);
                   FDSO_SNAPSHOT_FILE_RECO_0001ET.CreateNewFieldRedefine(Names.TRANSACTION_TYPE_0006XX, FieldType.String, TRANSACTION_TYPE_0006_local, 1);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_0007EV, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_0007EV, args, 4);
    ...
    public class SWEXLE89 : EABBase
    {
        ...
        public SWEXLE89()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE89");

            WS = new SWEXLE89_ws();
            FD = new SWEXLE89_fd(WS);
            LS = new SWEXLE89_ls();
        }
        ...
        private SWEXLE89_ws WS;

        //==== File Data Class ========================================
        private SWEXLE89_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE89_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0988807753(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0988807753
        /// </summary>
        private void M_MAIN_0988807753(string returnMethod = "")
        {
            M_PARA_0988807753_INIT("M_PARA_0988807753_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0988807753-INIT THRU PARA-0988807753-INIT-EXIT
            M_PARA_0988807753("M_PARA_0988807753_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0988807753 THRU PARA-0988807753-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0988807753
        /// </summary>
        private void M_PARA_0988807753(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:     *******************************************
            //COMMENT:     THIS CODE SWEXL891 IS A PART OF SWEEXLE89 *
            //COMMENT:     LE_EAB_WRITE_FDSO_SNAPSHOT_FILE           *
            //COMMENT:     *******************************************
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0988807753") { M_1000_EAB_CODE_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_1000_EAB_CODE_MAIN(string returnMethod = "")
        {
            ...
            {
                M_1301_WRITE_DETAIL_FILE("M_1301_EXIT"); if (Control.ExitProgram) { return; }                         //COBOL==> PERFORM 1301-WRITE-DETAIL-FILE THRU 1301-EXIT
                M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_1100_OPEN_FILE(string returnMethod = "")
        {
            ...
            if (!(WS.EXTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF EXTFILE-STAT NOT = 0
            {
                ...
                LS.NUMERIC_RETURN_CODE_0008.SetValue(WS.EXTFILE_STAT);                                              //COBOL==> MOVE EXTFILE-STAT TO NUMERIC-RETURN-CODE-0008
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_1100_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1100_EXIT") { M_1301_WRITE_DETAIL_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1301_WRITE_DETAIL_FILE
        /// </summary>
        /// <remarks>
        ///COMMENT: *****************************************************
        ...
        ///COMMENT: *****************************************************
        /// </remarks>
        private void M_1301_WRITE_DETAIL_FILE(string returnMethod = "")
        {
            WS.WS_FDSO_SNAPSHOT_DETAIL.SetValueWithSpaces();                                                    //COBOL==> MOVE SPACES TO WS-FDSO-SNAPSHOT-DETAIL.
            WS.SSN.SetValueWithZeroes();                                                                        //COBOL==> MOVE ZEROS TO SSN.
            WS.CURRENT_ARREARAGE_AMT.SetValueWithZeroes();                                                      //COBOL==> MOVE ZEROS TO CURRENT-ARREARAGE-AMT.
            WS.SUBMITTING_STATE.SetValue(LS.SUBMITTING_STATE_0001);                                             //COBOL==> MOVE SUBMITTING-STATE-0001 TO SUBMITTING-STATE.
            WS.LOCAL_CODE.SetValue(LS.LOCAL_CODE_0001);                                                         //COBOL==> MOVE LOCAL-CODE-0001 TO LOCAL-CODE.
            WS.SSN.SetValue(LS.SSN_0001);                                                                       //COBOL==> MOVE SSN-0001 TO SSN.
            WS.CASE_NUMBER.SetValue(LS.CASE_NUMBER_0001);                                                       //COBOL==> MOVE CASE-NUMBER-0001 TO CASE-NUMBER.
            WS.LAST_NAME.SetValue(LS.LAST_NAME_0001);                                                           //COBOL==> MOVE LAST-NAME-0001 TO LAST-NAME.
            WS.FIRST_NAME.SetValue(LS.FIRST_NAME_0001);                                                         //COBOL==> MOVE FIRST-NAME-0001 TO FIRST-NAME.
            WS.CURRENT_ARREARAGE_AMT.SetValue(LS.CURRENT_ARREARAGE_AMOUNT_0002);                                //COBOL==> MOVE CURRENT-ARREARAGE-AMOUNT-0002 TO CURRENT-ARREARAGE-AMT.
            WS.CASE_TYPE.SetValue(LS.CASE_TYPE_0002);                                                           //COBOL==> MOVE CASE-TYPE-0002 TO CASE-TYPE.
            WS.ADMINISTRATIVE_OFFSET.SetValue(LS.ETYPE_ADMINISTRATIVE_OFFS_0003);                               //COBOL==> MOVE ETYPE-ADMINISTRATIVE-OFFS-0003 TO ADMINISTRATIVE-OFFSET.
            WS.FED_RETIREMENT_OFFSET.SetValue(LS.ETYPE_FEDERAL_RETIREMENT_0004);                                //COBOL==> MOVE ETYPE-FEDERAL-RETIREMENT-0004 TO FED-RETIREMENT-OFFSET.
            WS.VENDOR_PAYMENTS_OFFSET.SetValue(LS.ETYPE_VENDOR_PAYMENT_OR_M_0005);                              //COBOL==> MOVE ETYPE-VENDOR-PAYMENT-OR-M-0005 TO VENDOR-PAYMENTS-OFFSET.
            WS.FEDERAL_SALARY_OFFSET.SetValue(LS.ETYPE_FEDERAL_SALARY_0005);                                    //COBOL==> MOVE ETYPE-FEDERAL-SALARY-0005 TO FEDERAL-SALARY-OFFSET.
            WS.TAX_REFUND_OFFSET.SetValue(LS.ETYPE_TAX_REFUND_0005);                                            //COBOL==> MOVE ETYPE-TAX-REFUND-0005 TO TAX-REFUND-OFFSET.
            WS.PASSPORT_DENIAL_OFFSET.SetValue(LS.ETYPE_PASSPORT_DENIAL_0005);                                  //COBOL==> MOVE ETYPE-PASSPORT-DENIAL-0005 TO PASSPORT-DENIAL-OFFSET.
            WS.FIDM_OFFSET.SetValue(LS.ETYPE_FINANCIAL_INSTITUTI_0006);                                         //COBOL==> MOVE ETYPE-FINANCIAL-INSTITUTI-0006 TO FIDM-OFFSET.
            WS.TRANSACTION_TYPE.SetValue(LS.TRANSACTION_TYPE_0006);                                             //COBOL==> MOVE TRANSACTION-TYPE-0006 TO TRANSACTION-TYPE.
            FD.EXTFILE_RECORD.SetValue(WS.WS_FDSO_SNAPSHOT_DETAIL);                                             //COBOL==> MOVE WS-FDSO-SNAPSHOT-DETAIL TO EXTFILE-RECORD.
            ...
            if (returnMethod != "" && returnMethod != "M_1301_WRITE_DETAIL_FILE") { M_1301_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1301_EXIT
        /// </summary>
        ...
        private void M_9999_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_EXIT") { M_PARA_0988807753_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0988807753_EXIT
        /// </summary>
        private void M_PARA_0988807753_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0988807753_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0988807753_EXIT") { M_PARA_0988807753_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0988807753_INIT
        /// </summary>
        private void M_PARA_0988807753_INIT(string returnMethod = "")
        {
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0988807753_INIT") { M_PARA_0988807753_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0988807753_INIT_EXIT
        /// </summary>
        private void M_PARA_0988807753_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0988807753_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
