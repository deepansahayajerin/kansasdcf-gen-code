...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:06:53 PM
   **        *   FROM COBOL PGM   :  SWEXEW21
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: FN_B794_WRITE_TO_NCP_FILE        DATE: 2015/01/20
       TARGET OS:   MVS                       TIME: 10:31:31
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEW21_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW21_fd_FileSection";
            internal const string NCP_FILE = "NCP_FILE";
            internal const string NCP_RECORD = "NCP_RECORD";
        ...
        public IFileLink NCP_FILE { get; set; }
        public IField NCP_RECORD { get { return GetElementByName<IField>(Names.NCP_RECORD); } }
        public IFileLink TEMP_FILE { get; set; }
        public IField TEMP_RECORD { get { return GetElementByName<IField>(Names.TEMP_RECORD); } }


        internal SWEXEW21_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.NCP_RECORD, FieldType.String, 132);
            recordDef.CreateNewField(Names.TEMP_RECORD, FieldType.String, 132);
        ...
        public override void Initialize()
        {
            ...
            NCP_FILE = FileHandler.GetFile("NCPFILE");
            NCP_FILE.StatusField = WS.FILE_STATUS;
            NCP_FILE.AssociatedBuffer = NCP_RECORD;

            TEMP_FILE = FileHandler.GetFile("TEMPFILE");
            TEMP_FILE.StatusField = WS.FILE_STATUS;
            TEMP_FILE.AssociatedBuffer = TEMP_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW21_fd(SWEXEW21_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW21_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW21_ws_WorkingStorage";
    ...
    internal class SWEXEW21_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW21_ls_LinkageSection";
            ...
            internal const string IMPORT_RECORD_LENGTH_0003EV = "IMPORT_RECORD_LENGTH_0003EV";
        ...
        public IGroup IMPORT_RECORD_LENGTH_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_RECORD_LENGTH_0003EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_RECORD_LENGTH_0003EV, (IMPORT_RECORD_LENGTH_0003EV) =>
           {
               IMPORT_RECORD_LENGTH_0003EV.CreateNewGroup(Names.IEF_SUPPLIED_0003ET, (IEF_SUPPLIED_0003ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_RECORD_LENGTH_0003EV, args, 5);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_RECORD_LENGTH_0003EV, args, 5);
    ...
    public class SWEXEW21 : EABBase
    {
        ...
        public SWEXEW21()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW21");

            WS = new SWEXEW21_ws();
            FD = new SWEXEW21_fd(WS);
            LS = new SWEXEW21_ls();
        }
        ...
        private SWEXEW21_ws WS;

        //==== File Data Class ========================================
        private SWEXEW21_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW21_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-RECORD-LENGTH-0003EV , EXPORT-0004EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0490998613(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0490998613
        /// </summary>
        private void M_MAIN_0490998613(string returnMethod = "")
        {
            M_PARA_0490998613_INIT("M_PARA_0490998613_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0490998613-INIT THRU PARA-0490998613-INIT-EXIT
            M_PARA_0490998613("M_PARA_0490998613_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0490998613 THRU PARA-0490998613-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0490998613
        /// </summary>
        private void M_PARA_0490998613(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0490998613") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0004.SetValue("O1");                                                                      //COBOL==> MOVE 'O1' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF
            FD.NCP_FILE.OpenFile(FileAccessMode.Write);                                                         //COBOL==> OPEN OUTPUT NCP-FILE
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0004.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0004
            }                                                                                                   //COBOL==> ELSE
            ...
            {
                LS.STATUS_0004.SetValue("O2");                                                                      //COBOL==> MOVE 'O2' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_1100_EXTEND_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0004.SetValue("O3");                                                                      //COBOL==> MOVE 'O3' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF
            FD.NCP_FILE.OpenFile(FileAccessMode.WriteExtend);                                                   //COBOL==> OPEN EXTEND NCP-FILE
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0004.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0004
            }                                                                                                   //COBOL==> ELSE
            ...
            {
                LS.STATUS_0004.SetValue("O4");                                                                      //COBOL==> MOVE 'O4' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: ******************
            FD.TEMP_RECORD.SetValue(LS.RPT_DETAIL_0002);                                                        //COBOL==> MOVE RPT-DETAIL-0002 TO TEMP-RECORD
            FD.TEMP_FILE.WriteLine(FD.TEMP_RECORD.AsBytes);                                                     //COBOL==> WRITE TEMP-RECORD
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0004.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0004
            }                                                                                                   //COBOL==> ELSE
            ...
            {
                LS.STATUS_0004.SetValue("W1");                                                                      //COBOL==> MOVE 'W1' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_3000_COMMIT_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0004.SetValue("O5");                                                                      //COBOL==> MOVE 'O5' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF
            ...
            {
                LS.STATUS_0004.SetValue("R1");                                                                      //COBOL==> MOVE 'R1' TO STATUS-0004
                M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
            }                                                                                                   //COBOL==> END-IF
            while (!(WS.NO_MORE_RECORDS.Value))                                                                 //COBOL==> PERFORM UNTIL NO-MORE-RECORDS
            {
                FD.NCP_RECORD.SetValue(FD.TEMP_RECORD);                                                             //COBOL==> MOVE TEMP-RECORD TO NCP-RECORD
                FD.NCP_FILE.WriteLine(FD.NCP_RECORD.AsBytes);                                                       //COBOL==> WRITE NCP-RECORD
                if (!(WS.FILE_STATUS.IsEqualTo("00")))                                                              //COBOL==> IF FILE-STATUS NOT = '00'
                {
                    LS.STATUS_0004.SetValue("W2");                                                                      //COBOL==> MOVE 'W2' TO STATUS-0004
                    M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
                }                                                                                                   //COBOL==> END-IF
                FD.TEMP_FILE.ReadLine();                                                                            //COBOL==> READ TEMP-FILE
                if (FD.TEMP_FILE.FileStatus == FileStatus.End_of_file)                                              //COBOL==> AT END
             ...
             && (WS.NO_MORE_RECORDS_SWITCH.IsEqualTo("N")))  //COBOL==> IF ( FILE-STATUS NOT = '00' AND NO-MORE-RECORDS-SWITCH = 'N' )
                {
                    LS.STATUS_0004.SetValue("R2");                                                                      //COBOL==> MOVE 'R2' TO STATUS-0004
                    M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                   //COBOL==> END-PERFORM
            M_4000_CLOSE_FILE(); if (Control.ExitProgram) { return; }                                             //COBOL==> PERFORM 4000-CLOSE-FILE
        ...
        {
            //COMMENT: ******************
            FD.TEMP_FILE.CloseFile();                                                                           //COBOL==> CLOSE TEMP-FILE , NCP-FILE.
            FD.NCP_FILE.CloseFile();
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0490998613_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0490998613_EXIT
        /// </summary>
        private void M_PARA_0490998613_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0490998613_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0490998613_EXIT") { M_PARA_0490998613_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0490998613_INIT
        /// </summary>
        private void M_PARA_0490998613_INIT(string returnMethod = "")
        {
            LS.EXPORT_0004EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0004EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0490998613_INIT") { M_PARA_0490998613_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0490998613_INIT_EXIT
        /// </summary>
        private void M_PARA_0490998613_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0490998613_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
