...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:23:38 PM
   **        *   FROM COBOL PGM   :  SWEXPE07
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_WRITE_PATERNITY_EXTRACT      DATE: 2003/06/27
       TARGET OS:   MVS                       TIME: 08:13:06
       TARGET DBMS: DB2                       USER: SWDPJEH
       GENERATION OPTIONS:
       DEBUG TRACE OPTION NOT SELECTED
       DATA MODELING CONSTRAINT ENFORCEMENT NOT SELECTED
       OPTIMIZED IMPORT VIEW INITIALIZATION SELECTED 0
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXPE07_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXPE07_fd_FileSection";
            ...
            internal const string SUPER_LAST = "SUPER_LAST";
            internal const string SUPER_FIRST = "SUPER_FIRST";
            internal const string CO_LAST = "CO_LAST";
            internal const string CO_FIRST = "CO_FIRST";
            internal const string PRIORITY = "PRIORITY";
            internal const string PRIORITY4_CAT = "PRIORITY4_CAT";
            ...
            internal const string AP_SEX = "AP_SEX";
            ...
            internal const string E_DATE = "E_DATE";
        }
        #endregion
        ...
        public IField SUPER_LAST { get { return GetElementByName<IField>(Names.SUPER_LAST); } }
        public IField SUPER_FIRST { get { return GetElementByName<IField>(Names.SUPER_FIRST); } }
        public IField CO_LAST { get { return GetElementByName<IField>(Names.CO_LAST); } }
        public IField CO_FIRST { get { return GetElementByName<IField>(Names.CO_FIRST); } }
        public IField PRIORITY { get { return GetElementByName<IField>(Names.PRIORITY); } }
        public IField PRIORITY4_CAT { get { return GetElementByName<IField>(Names.PRIORITY4_CAT); } }
        ...
        public IField AP_SEX { get { return GetElementByName<IField>(Names.AP_SEX); } }
        ...
        public IField E_DATE { get { return GetElementByName<IField>(Names.E_DATE); } }


        internal SWEXPE07_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.OUTPUT_RECORD, (OUTPUT_RECORD) =>
           {
               ...
               OUTPUT_RECORD.CreateNewField(Names.SUPER_LAST, FieldType.String, 17);
               OUTPUT_RECORD.CreateNewField(Names.SUPER_FIRST, FieldType.String, 12);
               OUTPUT_RECORD.CreateNewField(Names.CO_LAST, FieldType.String, 17);
               OUTPUT_RECORD.CreateNewField(Names.CO_FIRST, FieldType.String, 12);
               OUTPUT_RECORD.CreateNewField(Names.PRIORITY, FieldType.String, 1);
               OUTPUT_RECORD.CreateNewField(Names.PRIORITY4_CAT, FieldType.String, 1);
               ...
               OUTPUT_RECORD.CreateNewField(Names.AP_SEX, FieldType.String, 1);
               ...
               OUTPUT_RECORD.CreateNewField(Names.E_DATE, FieldType.String, 8);
           });
        ...
        public override void Initialize()
        {
            ...
            OUTPUT_FILE = FileHandler.GetFile("EXTOUT");
        ...
        #region Constructors
        public SWEXPE07_fd(SWEXPE07_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXPE07_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXPE07_ws_WorkingStorage";
    ...
    internal class SWEXPE07_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXPE07_ls_LinkageSection";
            ...
            internal const string IMPORT_SUPERVISOR_NAME_0003EV = "IMPORT_SUPERVISOR_NAME_0003EV";
            ...
            internal const string IMPORT_CO_0004EV = "IMPORT_CO_0004EV";
            ...
            internal const string IMPORT_PRIORITY_4_CATEG_0005EV = "IMPORT_PRIORITY_4_CATEG_0005EV";
            ...
            internal const string IMPORT_PRIORITY_NUMBER_0006EV = "IMPORT_PRIORITY_NUMBER_0006EV";
            internal const string IEF_SUPPLIED_0006ET = "IEF_SUPPLIED_0006ET";
            internal const string SELECT_CHAR_0006AS = "SELECT_CHAR_0006AS";
            internal const string SELECT_CHAR_0006 = "SELECT_CHAR_0006";
            internal const string SELECT_CHAR_0006XX = "SELECT_CHAR_0006XX";
            internal const string IMPORT_0007EV = "IMPORT_0007EV";
            internal const string CASE_0007ET = "CASE_0007ET";
            ...
            internal const string IMPORT_AP_0008EV = "IMPORT_AP_0008EV";
            ...
            internal const string IMPORT_CH_0009EV = "IMPORT_CH_0009EV";
            internal const string CSE_PERSON_0009ET = "CSE_PERSON_0009ET";
            ...
            internal const string BIRTH_PLACE_STATE_0009AS = "BIRTH_PLACE_STATE_0009AS";
            internal const string BIRTH_PLACE_STATE_0009 = "BIRTH_PLACE_STATE_0009";
            internal const string BIRTH_PLACE_STATE_0009XX = "BIRTH_PLACE_STATE_0009XX";
            internal const string IMPORT_CH_E_DATE_0010EV = "IMPORT_CH_E_DATE_0010EV";
            internal const string CASE_ROLE_0010ET = "CASE_ROLE_0010ET";
            internal const string TYPE_0010AS = "TYPE_0010AS";
            internal const string TYPE_0010 = "TYPE_0010";
            internal const string TYPE_0010XX = "TYPE_0010XX";
            internal const string DATE_OF_EMANCIPATION_0010AS = "DATE_OF_EMANCIPATION_0010AS";
            internal const string DATE_OF_EMANCIPATION_0010 = "DATE_OF_EMANCIPATION_0010";
            internal const string DATE_OF_EMANCIPATION_0010XX = "DATE_OF_EMANCIPATION_0010XX";
            internal const string IMPORT_AP_NAME_0011EV = "IMPORT_AP_NAME_0011EV";
            ...
            internal const string MIDDLE_INITIAL_0011AS = "MIDDLE_INITIAL_0011AS";
            internal const string MIDDLE_INITIAL_0011 = "MIDDLE_INITIAL_0011";
            internal const string MIDDLE_INITIAL_0011XX = "MIDDLE_INITIAL_0011XX";
            ...
            internal const string SEX_0011AS = "SEX_0011AS";
            internal const string SEX_0011 = "SEX_0011";
            internal const string SEX_0011XX = "SEX_0011XX";
            internal const string IMPORT_CH_NAME_0012EV = "IMPORT_CH_NAME_0012EV";
            internal const string CSE_PERSONS_WORK_SET_0012ET = "CSE_PERSONS_WORK_SET_0012ET";
            ...
            internal const string MIDDLE_INITIAL_0012AS = "MIDDLE_INITIAL_0012AS";
            internal const string MIDDLE_INITIAL_0012 = "MIDDLE_INITIAL_0012";
            internal const string MIDDLE_INITIAL_0012XX = "MIDDLE_INITIAL_0012XX";
        ...
        public IGroup IMPORT_SUPERVISOR_NAME_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_SUPERVISOR_NAME_0003EV); } }
        ...
        public IGroup IMPORT_CO_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_CO_0004EV); } }
        ...
        public IGroup IMPORT_PRIORITY_4_CATEG_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_PRIORITY_4_CATEG_0005EV); } }
        ...
        public IGroup IMPORT_PRIORITY_NUMBER_0006EV { get { return GetElementByName<IGroup>(Names.IMPORT_PRIORITY_NUMBER_0006EV); } }
        public IGroup IEF_SUPPLIED_0006ET { get { return GetElementByName<IGroup>(Names.IEF_SUPPLIED_0006ET); } }
        public IField SELECT_CHAR_0006AS { get { return GetElementByName<IField>(Names.SELECT_CHAR_0006AS); } }
        public IField SELECT_CHAR_0006 { get { return GetElementByName<IField>(Names.SELECT_CHAR_0006); } }
        public IField SELECT_CHAR_0006XX { get { return GetElementByName<IField>(Names.SELECT_CHAR_0006XX); } }
        public IGroup IMPORT_0007EV { get { return GetElementByName<IGroup>(Names.IMPORT_0007EV); } }
        public IGroup CASE_0007ET { get { return GetElementByName<IGroup>(Names.CASE_0007ET); } }
        ...
        public IGroup IMPORT_AP_0008EV { get { return GetElementByName<IGroup>(Names.IMPORT_AP_0008EV); } }
        ...
        public IGroup IMPORT_CH_0009EV { get { return GetElementByName<IGroup>(Names.IMPORT_CH_0009EV); } }
        public IGroup CSE_PERSON_0009ET { get { return GetElementByName<IGroup>(Names.CSE_PERSON_0009ET); } }
        ...
        public IField BIRTH_PLACE_STATE_0009AS { get { return GetElementByName<IField>(Names.BIRTH_PLACE_STATE_0009AS); } }
        public IField BIRTH_PLACE_STATE_0009 { get { return GetElementByName<IField>(Names.BIRTH_PLACE_STATE_0009); } }
        public IField BIRTH_PLACE_STATE_0009XX { get { return GetElementByName<IField>(Names.BIRTH_PLACE_STATE_0009XX); } }
        public IGroup IMPORT_CH_E_DATE_0010EV { get { return GetElementByName<IGroup>(Names.IMPORT_CH_E_DATE_0010EV); } }
        public IGroup CASE_ROLE_0010ET { get { return GetElementByName<IGroup>(Names.CASE_ROLE_0010ET); } }
        public IField TYPE_0010AS { get { return GetElementByName<IField>(Names.TYPE_0010AS); } }
        ...
        public IField DATE_OF_EMANCIPATION_0010AS { get { return GetElementByName<IField>(Names.DATE_OF_EMANCIPATION_0010AS); } }
        public IField DATE_OF_EMANCIPATION_0010 { get { return GetElementByName<IField>(Names.DATE_OF_EMANCIPATION_0010); } }
        public IField DATE_OF_EMANCIPATION_0010XX { get { return GetElementByName<IField>(Names.DATE_OF_EMANCIPATION_0010XX); } }
        public IGroup IMPORT_AP_NAME_0011EV { get { return GetElementByName<IGroup>(Names.IMPORT_AP_NAME_0011EV); } }
        public IGroup CSE_PERSONS_WORK_SET_0011ET { get { return GetElementByName<IGroup>(Names.CSE_PERSONS_WORK_SET_0011ET); } }
        ...
        public IField MIDDLE_INITIAL_0011AS { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL_0011AS); } }
        public IField MIDDLE_INITIAL_0011 { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL_0011); } }
        public IField MIDDLE_INITIAL_0011XX { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL_0011XX); } }
        ...
        public IField SEX_0011AS { get { return GetElementByName<IField>(Names.SEX_0011AS); } }
        public IField SEX_0011 { get { return GetElementByName<IField>(Names.SEX_0011); } }
        public IField SEX_0011XX { get { return GetElementByName<IField>(Names.SEX_0011XX); } }
        public IGroup IMPORT_CH_NAME_0012EV { get { return GetElementByName<IGroup>(Names.IMPORT_CH_NAME_0012EV); } }
        public IGroup CSE_PERSONS_WORK_SET_0012ET { get { return GetElementByName<IGroup>(Names.CSE_PERSONS_WORK_SET_0012ET); } }
        ...
        public IField MIDDLE_INITIAL_0012AS { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL_0012AS); } }
        public IField MIDDLE_INITIAL_0012 { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL_0012); } }
        public IField MIDDLE_INITIAL_0012XX { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL_0012XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_NAME_0002EV, (IMPORT_NAME_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_SUPERVISOR_NAME_0003EV, (IMPORT_SUPERVISOR_NAME_0003EV) =>
           {
               IMPORT_SUPERVISOR_NAME_0003EV.CreateNewGroup(Names.SERVICE_PROVIDER_0003ET, (SERVICE_PROVIDER_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CO_0004EV, (IMPORT_CO_0004EV) =>
           {
               IMPORT_CO_0004EV.CreateNewGroup(Names.SERVICE_PROVIDER_0004ET, (SERVICE_PROVIDER_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_PRIORITY_4_CATEG_0005EV, (IMPORT_PRIORITY_4_CATEG_0005EV) =>
           {
               IMPORT_PRIORITY_4_CATEG_0005EV.CreateNewGroup(Names.IEF_SUPPLIED_0005ET, (IEF_SUPPLIED_0005ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_PRIORITY_NUMBER_0006EV, (IMPORT_PRIORITY_NUMBER_0006EV) =>
           {
               IMPORT_PRIORITY_NUMBER_0006EV.CreateNewGroup(Names.IEF_SUPPLIED_0006ET, (IEF_SUPPLIED_0006ET) =>
               {
                   IEF_SUPPLIED_0006ET.CreateNewField(Names.SELECT_CHAR_0006AS, FieldType.String, 1);

                   IField SELECT_CHAR_0006_local = IEF_SUPPLIED_0006ET.CreateNewField(Names.SELECT_CHAR_0006, FieldType.String, 1);
                   IEF_SUPPLIED_0006ET.CreateNewFieldRedefine(Names.SELECT_CHAR_0006XX, FieldType.String, SELECT_CHAR_0006_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0007EV, (IMPORT_0007EV) =>
           {
               IMPORT_0007EV.CreateNewGroup(Names.CASE_0007ET, (CASE_0007ET) =>
               {
                   CASE_0007ET.CreateNewField(Names.NUMBER_0007AS, FieldType.String, 1);

                   IField NUMBER_0007_local = CASE_0007ET.CreateNewField(Names.NUMBER_0007, FieldType.String, 10);
                   CASE_0007ET.CreateNewFieldRedefine(Names.NUMBER_0007XX, FieldType.String, NUMBER_0007_local, 10);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_AP_0008EV, (IMPORT_AP_0008EV) =>
           {
               IMPORT_AP_0008EV.CreateNewGroup(Names.CSE_PERSON_0008ET, (CSE_PERSON_0008ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CH_0009EV, (IMPORT_CH_0009EV) =>
           {
               IMPORT_CH_0009EV.CreateNewGroup(Names.CSE_PERSON_0009ET, (CSE_PERSON_0009ET) =>
               {
                   CSE_PERSON_0009ET.CreateNewField(Names.TYPE_0009AS, FieldType.String, 1);

                   IField TYPE_0009_local = CSE_PERSON_0009ET.CreateNewField(Names.TYPE_0009, FieldType.String, 1);
                   CSE_PERSON_0009ET.CreateNewFieldRedefine(Names.TYPE_0009XX, FieldType.String, TYPE_0009_local, 1);
                   CSE_PERSON_0009ET.CreateNewField(Names.NUMBER_0009AS, FieldType.String, 1);

                   IField NUMBER_0009_local = CSE_PERSON_0009ET.CreateNewField(Names.NUMBER_0009, FieldType.String, 10);
                   CSE_PERSON_0009ET.CreateNewFieldRedefine(Names.NUMBER_0009XX, FieldType.String, NUMBER_0009_local, 10);
                   CSE_PERSON_0009ET.CreateNewField(Names.BIRTH_PLACE_STATE_0009AS, FieldType.String, 1);

                   IField BIRTH_PLACE_STATE_0009_local = CSE_PERSON_0009ET.CreateNewField(Names.BIRTH_PLACE_STATE_0009, FieldType.String, 2);
                   CSE_PERSON_0009ET.CreateNewFieldRedefine(Names.BIRTH_PLACE_STATE_0009XX, FieldType.String, BIRTH_PLACE_STATE_0009_local, 2);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_CH_E_DATE_0010EV, (IMPORT_CH_E_DATE_0010EV) =>
           {
               IMPORT_CH_E_DATE_0010EV.CreateNewGroup(Names.CASE_ROLE_0010ET, (CASE_ROLE_0010ET) =>
               {
                   CASE_ROLE_0010ET.CreateNewField(Names.TYPE_0010AS, FieldType.String, 1);

                   IField TYPE_0010_local = CASE_ROLE_0010ET.CreateNewField(Names.TYPE_0010, FieldType.String, 2);
                   CASE_ROLE_0010ET.CreateNewFieldRedefine(Names.TYPE_0010XX, FieldType.String, TYPE_0010_local, 2);
                   CASE_ROLE_0010ET.CreateNewField(Names.DATE_OF_EMANCIPATION_0010AS, FieldType.String, 1);

                   IField DATE_OF_EMANCIPATION_0010_local = CASE_ROLE_0010ET.CreateNewField(Names.DATE_OF_EMANCIPATION_0010, FieldType.SignedNumeric, 8);
                   CASE_ROLE_0010ET.CreateNewFieldRedefine(Names.DATE_OF_EMANCIPATION_0010XX, FieldType.String, DATE_OF_EMANCIPATION_0010_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_AP_NAME_0011EV, (IMPORT_AP_NAME_0011EV) =>
           {
               IMPORT_AP_NAME_0011EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0011ET, (CSE_PERSONS_WORK_SET_0011ET) =>
               {
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.FIRST_NAME_0011AS, FieldType.String, 1);

                   IField FIRST_NAME_0011_local = CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.FIRST_NAME_0011, FieldType.String, 12);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewFieldRedefine(Names.FIRST_NAME_0011XX, FieldType.String, FIRST_NAME_0011_local, 12);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.MIDDLE_INITIAL_0011AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0011_local = CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.MIDDLE_INITIAL_0011, FieldType.String, 1);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0011XX, FieldType.String, MIDDLE_INITIAL_0011_local, 1);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.LAST_NAME_0011AS, FieldType.String, 1);

                   IField LAST_NAME_0011_local = CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.LAST_NAME_0011, FieldType.String, 17);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewFieldRedefine(Names.LAST_NAME_0011XX, FieldType.String, LAST_NAME_0011_local, 17);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.SEX_0011AS, FieldType.String, 1);

                   IField SEX_0011_local = CSE_PERSONS_WORK_SET_0011ET.CreateNewField(Names.SEX_0011, FieldType.String, 1);
                   CSE_PERSONS_WORK_SET_0011ET.CreateNewFieldRedefine(Names.SEX_0011XX, FieldType.String, SEX_0011_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_CH_NAME_0012EV, (IMPORT_CH_NAME_0012EV) =>
           {
               IMPORT_CH_NAME_0012EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0012ET, (CSE_PERSONS_WORK_SET_0012ET) =>
               {
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.FIRST_NAME_0012AS, FieldType.String, 1);

                   IField FIRST_NAME_0012_local = CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.FIRST_NAME_0012, FieldType.String, 12);
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewFieldRedefine(Names.FIRST_NAME_0012XX, FieldType.String, FIRST_NAME_0012_local, 12);
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.MIDDLE_INITIAL_0012AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0012_local = CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.MIDDLE_INITIAL_0012, FieldType.String, 1);
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0012XX, FieldType.String, MIDDLE_INITIAL_0012_local, 1);
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.LAST_NAME_0012AS, FieldType.String, 1);

                   IField LAST_NAME_0012_local = CSE_PERSONS_WORK_SET_0012ET.CreateNewField(Names.LAST_NAME_0012, FieldType.String, 17);
                   CSE_PERSONS_WORK_SET_0012ET.CreateNewFieldRedefine(Names.LAST_NAME_0012XX, FieldType.String, LAST_NAME_0012_local, 17);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_SUPERVISOR_NAME_0003EV, args, 5);
            SetPassedParm(IMPORT_CO_0004EV, args, 6);
            SetPassedParm(IMPORT_PRIORITY_4_CATEG_0005EV, args, 7);
            SetPassedParm(IMPORT_PRIORITY_NUMBER_0006EV, args, 8);
            SetPassedParm(IMPORT_0007EV, args, 9);
            SetPassedParm(IMPORT_AP_0008EV, args, 10);
            SetPassedParm(IMPORT_CH_0009EV, args, 11);
            SetPassedParm(IMPORT_CH_E_DATE_0010EV, args, 12);
            SetPassedParm(IMPORT_AP_NAME_0011EV, args, 13);
            SetPassedParm(IMPORT_CH_NAME_0012EV, args, 14);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_SUPERVISOR_NAME_0003EV, args, 5);
            SetReturnParm(IMPORT_CO_0004EV, args, 6);
            SetReturnParm(IMPORT_PRIORITY_4_CATEG_0005EV, args, 7);
            SetReturnParm(IMPORT_PRIORITY_NUMBER_0006EV, args, 8);
            SetReturnParm(IMPORT_0007EV, args, 9);
            SetReturnParm(IMPORT_AP_0008EV, args, 10);
            SetReturnParm(IMPORT_CH_0009EV, args, 11);
            SetReturnParm(IMPORT_CH_E_DATE_0010EV, args, 12);
            SetReturnParm(IMPORT_AP_NAME_0011EV, args, 13);
            SetReturnParm(IMPORT_CH_NAME_0012EV, args, 14);
    ...
    public class SWEXPE07 : EABBase
    {
        ...
        public SWEXPE07()
            : base()
        {
            this.ProgramName.SetValue("SWEXPE07");

            WS = new SWEXPE07_ws();
            FD = new SWEXPE07_fd(WS);
            LS = new SWEXPE07_ls();
        }
        ...
        private SWEXPE07_ws WS;

        //==== File Data Class ========================================
        private SWEXPE07_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXPE07_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-NAME-AREA-0001EV , IMPORT-NAME-0002EV , IMPORT-SUPERVISOR-NAME-0003EV , IMPORT-CO-0004EV , IMPORT-PRIORITY-4-CATEG-0005EV , IMPORT-PRIORITY-NUMBER-0006EV , IMPORT-0007EV , IMPORT-AP-0008EV , IMPORT-CH-0009EV , IMPORT-CH-E-DATE-0010EV , IMPORT-AP-NAME-0011EV , IMPORT-CH-NAME-0012EV , IMPORT-0013EV , EXPORT-0014EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0289931585(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0289931585
        /// </summary>
        private void M_MAIN_0289931585(string returnMethod = "")
        {
            M_PARA_0289931585_INIT("M_PARA_0289931585_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0289931585-INIT THRU PARA-0289931585-INIT-EXIT
            M_PARA_0289931585("M_PARA_0289931585_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0289931585 THRU PARA-0289931585-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0289931585
        /// </summary>
        private void M_PARA_0289931585(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0289931585") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0014.SetValue("BI");                                                                      //COBOL==> MOVE 'BI' TO STATUS-0014
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0014.SetValue("PE");                                                                      //COBOL==> MOVE 'PE' TO STATUS-0014
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_2000_WRITE_FILE(string returnMethod = "")
        {
            ...
            FD.SUPER_LAST.SetValue(LS.LAST_NAME_0003);                                                          //COBOL==> MOVE LAST-NAME-0003 TO SUPER-LAST
            FD.SUPER_FIRST.SetValue(LS.FIRST_NAME_0003);                                                        //COBOL==> MOVE FIRST-NAME-0003 TO SUPER-FIRST
            FD.CO_LAST.SetValue(LS.LAST_NAME_0004);                                                             //COBOL==> MOVE LAST-NAME-0004 TO CO-LAST
            FD.CO_FIRST.SetValue(LS.FIRST_NAME_0004);                                                           //COBOL==> MOVE FIRST-NAME-0004 TO CO-FIRST
            FD.PRIORITY.SetValue(LS.SELECT_CHAR_0006);                                                          //COBOL==> MOVE SELECT-CHAR-0006 TO PRIORITY
            FD.PRIORITY4_CAT.SetValue(LS.SELECT_CHAR_0005);                                                     //COBOL==> MOVE SELECT-CHAR-0005 TO PRIORITY4-CAT
            FD.CASE_NUMBER.SetValue(LS.NUMBER_0007);                                                            //COBOL==> MOVE NUMBER-0007 TO CASE-NUMBER
            FD.AP_LAST.SetValue(LS.LAST_NAME_0011);                                                             //COBOL==> MOVE LAST-NAME-0011 TO AP-LAST
            FD.AP_FIRST.SetValue(LS.FIRST_NAME_0011);                                                           //COBOL==> MOVE FIRST-NAME-0011 TO AP-FIRST
            FD.AP_MI.SetValue(LS.MIDDLE_INITIAL_0011);                                                          //COBOL==> MOVE MIDDLE-INITIAL-0011 TO AP-MI
            FD.AP_NUMBER.SetValue(LS.NUMBER_0008);                                                              //COBOL==> MOVE NUMBER-0008 TO AP-NUMBER
            FD.AP_SEX.SetValue(LS.SEX_0011);                                                                    //COBOL==> MOVE SEX-0011 TO AP-SEX
            FD.CH_LAST.SetValue(LS.LAST_NAME_0012);                                                             //COBOL==> MOVE LAST-NAME-0012 TO CH-LAST
            FD.CH_FIRST.SetValue(LS.FIRST_NAME_0012);                                                           //COBOL==> MOVE FIRST-NAME-0012 TO CH-FIRST
            FD.CH_MI.SetValue(LS.MIDDLE_INITIAL_0012);                                                          //COBOL==> MOVE MIDDLE-INITIAL-0012 TO CH-MI
            FD.CH_NUMBER.SetValue(LS.NUMBER_0009);                                                              //COBOL==> MOVE NUMBER-0009 TO CH-NUMBER
            FD.POB_STATE.SetValue(LS.BIRTH_PLACE_STATE_0009);                                                   //COBOL==> MOVE BIRTH-PLACE-STATE-0009 TO POB-STATE
            FD.E_DATE.SetValue(LS.DATE_OF_EMANCIPATION_0010);                                                   //COBOL==> MOVE DATE-OF-EMANCIPATION-0010 TO E-DATE
            ...
            {
                LS.STATUS_0014.SetValue("BW");                                                                      //COBOL==> MOVE 'BW' TO STATUS-0014
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0289931585_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0289931585_EXIT
        /// </summary>
        private void M_PARA_0289931585_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0289931585_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0289931585_EXIT") { M_PARA_0289931585_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0289931585_INIT
        /// </summary>
        private void M_PARA_0289931585_INIT(string returnMethod = "")
        {
            LS.EXPORT_0014EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0014EV.
            if (returnMethod != "" && returnMethod != "M_PARA_0289931585_INIT") { M_PARA_0289931585_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0289931585_INIT_EXIT
        /// </summary>
        private void M_PARA_0289931585_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0289931585_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
