...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:13:09 PM
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    public class SWEXG750 : EABBase
    {
        ...
        private void M_INIT_LINKAGE(string returnMethod = "")
        {
            ...
            if ((LS.E_PARM1_0002_003XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_PARM1_0002_003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-PARM1-0002-003XX = HIGH-VALUES OR E-PARM1-0002-003XX = LOW-VALUES
            {
                LS.E_PARM1_0002_003.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM1-0002-003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_PARM2_0002_004XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_PARM2_0002_004XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-PARM2-0002-004XX = HIGH-VALUES OR E-PARM2-0002-004XX = LOW-VALUES
            {
                LS.E_PARM2_0002_004.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM2-0002-004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_OFFICE_0003_005XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_OFFICE_0003_005XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-OFFICE-0003-005XX = HIGH-VALUES OR E-OFFICE-0003-005XX = LOW-VALUES
            {
                LS.E_OFFICE_0003_005.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO E-OFFICE-0003-005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_SECTION_SUPERVISOR_000306XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_SECTION_SUPERVISOR_000306XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-SECTION-SUPERVISOR-000306XX = HIGH-VALUES OR E-SECTION-SUPERVISOR-000306XX = LOW-VALUES
            {
                LS.E_SECTION_SUPERVISOR_0003_006.SetValueWithSpaces();                                              //COBOL==> MOVE SPACES TO E-SECTION-SUPERVISOR-0003-006
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_COLLECTION_OFFICER_000307XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_COLLECTION_OFFICER_000307XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-COLLECTION-OFFICER-000307XX = HIGH-VALUES OR E-COLLECTION-OFFICER-000307XX = LOW-VALUES
            {
                LS.E_COLLECTION_OFFICER_0003_007.SetValueWithSpaces();                                              //COBOL==> MOVE SPACES TO E-COLLECTION-OFFICER-0003-007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_CASE_NUMBER_0003_008XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_CASE_NUMBER_0003_008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-CASE-NUMBER-0003-008XX = HIGH-VALUES OR E-CASE-NUMBER-0003-008XX = LOW-VALUES
            {
                LS.E_CASE_NUMBER_0003_008.SetValueWithSpaces();                                                     //COBOL==> MOVE SPACES TO E-CASE-NUMBER-0003-008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_OBLIGATION_CODE_0003_009XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_OBLIGATION_CODE_0003_009XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-OBLIGATION-CODE-0003-009XX = HIGH-VALUES OR E-OBLIGATION-CODE-0003-009XX = LOW-VALUES
            {
                LS.E_OBLIGATION_CODE_0003_009.SetValueWithSpaces();                                                 //COBOL==> MOVE SPACES TO E-OBLIGATION-CODE-0003-009
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_APPLIED_TO_0003_010XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_APPLIED_TO_0003_010XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-APPLIED-TO-0003-010XX = HIGH-VALUES OR E-APPLIED-TO-0003-010XX = LOW-VALUES
            {
