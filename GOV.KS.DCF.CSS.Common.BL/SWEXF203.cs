...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:07:37 PM
   **        *   FROM COBOL PGM   :  SWEXF203
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_EXT_WRITE_EMPLOYER_NCP_RECORD DATE: 2000/04/28
       TARGET OS:   MVS                       TIME: 14:38:02
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXF203_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXF203_fd_FileSection";
            internal const string EMPNCP_FILE = "EMPNCP_FILE";
            internal const string EMPNCP_REC = "EMPNCP_REC";
            internal const string EMPNCP_REC_DATA = "EMPNCP_REC_DATA";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink EMPNCP_FILE { get; set; }
        public IGroup EMPNCP_REC { get { return GetElementByName<IGroup>(Names.EMPNCP_REC); } }
        public IField EMPNCP_REC_DATA { get { return GetElementByName<IField>(Names.EMPNCP_REC_DATA); } }


        internal SWEXF203_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EMPNCP_REC, (EMPNCP_REC) =>
           {
               EMPNCP_REC.CreateNewField(Names.EMPNCP_REC_DATA, FieldType.String, 320);
           });
        ...
        public override void Initialize()
        {
            ...
            EMPNCP_FILE = FileHandler.GetFile("EMPNCPFL");
            EMPNCP_FILE.StatusField = WS.EMPNCP_FILE_STAT;
            EMPNCP_FILE.AssociatedBuffer = EMPNCP_REC;
        }
        #endregion

        #region Constructors
        public SWEXF203_fd(SWEXF203_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXF203_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXF203_ws_WorkingStorage";
            internal const string TEMP_VARIABLES = "TEMP_VARIABLES";
            internal const string EMPNCP_FILE_STAT = "EMPNCP_FILE_STAT";
            internal const string WS_EMP_NCP_REC = "WS_EMP_NCP_REC";
            ...
            internal const string NCP_MIDDLE_INIT = "NCP_MIDDLE_INIT";
            internal const string NCP_SUFFIX = "NCP_SUFFIX";
            internal const string NCP_SSN = "NCP_SSN";
            internal const string COUNTY_ID = "COUNTY_ID";
            internal const string COURT_ORDER_NO = "COURT_ORDER_NO";
        }
        #endregion

        #region Direct-access element properties
        public IGroup TEMP_VARIABLES { get { return GetElementByName<IGroup>(Names.TEMP_VARIABLES); } }
        public IField EMPNCP_FILE_STAT { get { return GetElementByName<IField>(Names.EMPNCP_FILE_STAT); } }
        public IGroup WS_EMP_NCP_REC { get { return GetElementByName<IGroup>(Names.WS_EMP_NCP_REC); } }
        ...
        public IField NCP_MIDDLE_INIT { get { return GetElementByName<IField>(Names.NCP_MIDDLE_INIT); } }
        ...
        public IField COUNTY_ID { get { return GetElementByName<IField>(Names.COUNTY_ID); } }
        public IField COURT_ORDER_NO { get { return GetElementByName<IField>(Names.COURT_ORDER_NO); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               TEMP_VARIABLES.CreateNewField(Names.EMPNCP_FILE_STAT, FieldType.String, 2);
           });

            recordDef.CreateNewGroup(Names.WS_EMP_NCP_REC, (WS_EMP_NCP_REC) =>
           {
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_NAME, FieldType.String, 50, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_STREET1, FieldType.String, 50, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_STREET2, FieldType.String, 50, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_STREET3, FieldType.String, 50, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_CITY, FieldType.String, 20, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_STATE, FieldType.String, 2, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_ZIP, FieldType.String, 5, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_PHONE_NO, FieldType.String, 10, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_PHONE_EXT, FieldType.String, 5, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.EMP_EIN, FieldType.String, 10, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.NCP_LAST_NAME, FieldType.String, 20, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.NCP_FIRST_NAME, FieldType.String, 20, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.NCP_MIDDLE_INIT, FieldType.String, 1, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.NCP_SUFFIX, FieldType.String, 4, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.NCP_SSN, FieldType.String, 9, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.COUNTY_ID, FieldType.String, 2, SPACES);
               WS_EMP_NCP_REC.CreateNewField(Names.COURT_ORDER_NO, FieldType.String, 12, SPACES);
           });
    ...
    internal class SWEXF203_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXF203_ls_LinkageSection";
            ...
            internal const string EMPLOYER_NCP_RECORD_0002ET = "EMPLOYER_NCP_RECORD_0002ET";
            ...
            internal const string SUFFIX_0002AS = "SUFFIX_0002AS";
            internal const string SUFFIX_0002 = "SUFFIX_0002";
            internal const string SUFFIX_0002XX = "SUFFIX_0002XX";
            ...
            internal const string COUNTY_ID_0002AS = "COUNTY_ID_0002AS";
            internal const string COUNTY_ID_0002 = "COUNTY_ID_0002";
            internal const string COUNTY_ID_0002XX = "COUNTY_ID_0002XX";
            internal const string COURT_ORDER_NUMBER_0002AS = "COURT_ORDER_NUMBER_0002AS";
            internal const string COURT_ORDER_NUMBER_0002 = "COURT_ORDER_NUMBER_0002";
            internal const string COURT_ORDER_NUMBER_0002XX = "COURT_ORDER_NUMBER_0002XX";
        ...
        public IGroup EMPLOYER_NCP_RECORD_0002ET { get { return GetElementByName<IGroup>(Names.EMPLOYER_NCP_RECORD_0002ET); } }
        ...
        public IField SUFFIX_0002AS { get { return GetElementByName<IField>(Names.SUFFIX_0002AS); } }
        public IField SUFFIX_0002 { get { return GetElementByName<IField>(Names.SUFFIX_0002); } }
        public IField SUFFIX_0002XX { get { return GetElementByName<IField>(Names.SUFFIX_0002XX); } }
        ...
        public IField COUNTY_ID_0002AS { get { return GetElementByName<IField>(Names.COUNTY_ID_0002AS); } }
        public IField COUNTY_ID_0002 { get { return GetElementByName<IField>(Names.COUNTY_ID_0002); } }
        public IField COUNTY_ID_0002XX { get { return GetElementByName<IField>(Names.COUNTY_ID_0002XX); } }
        public IField COURT_ORDER_NUMBER_0002AS { get { return GetElementByName<IField>(Names.COURT_ORDER_NUMBER_0002AS); } }
        public IField COURT_ORDER_NUMBER_0002 { get { return GetElementByName<IField>(Names.COURT_ORDER_NUMBER_0002); } }
        public IField COURT_ORDER_NUMBER_0002XX { get { return GetElementByName<IField>(Names.COURT_ORDER_NUMBER_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.EMPLOYER_NCP_RECORD_0002ET, (EMPLOYER_NCP_RECORD_0002ET) =>
               {
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.NAME_0002AS, FieldType.String, 1);

                   IField NAME_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.NAME_0002, FieldType.String, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.NAME_0002XX, FieldType.String, NAME_0002_local, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STREET1_0002AS, FieldType.String, 1);

                   IField STREET1_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STREET1_0002, FieldType.String, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.STREET1_0002XX, FieldType.String, STREET1_0002_local, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STREET2_0002AS, FieldType.String, 1);

                   IField STREET2_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STREET2_0002, FieldType.String, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.STREET2_0002XX, FieldType.String, STREET2_0002_local, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STREET3_0002AS, FieldType.String, 1);

                   IField STREET3_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STREET3_0002, FieldType.String, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.STREET3_0002XX, FieldType.String, STREET3_0002_local, 50);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.CITY_0002AS, FieldType.String, 1);

                   IField CITY_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.CITY_0002, FieldType.String, 20);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.CITY_0002XX, FieldType.String, CITY_0002_local, 20);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STATE_0002AS, FieldType.String, 1);

                   IField STATE_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.STATE_0002, FieldType.String, 2);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.STATE_0002XX, FieldType.String, STATE_0002_local, 2);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.ZIP_CODE_0002AS, FieldType.String, 1);

                   IField ZIP_CODE_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.ZIP_CODE_0002, FieldType.String, 5);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.ZIP_CODE_0002XX, FieldType.String, ZIP_CODE_0002_local, 5);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.PHONE_NUMBER_0002AS, FieldType.String, 1);

                   IField PHONE_NUMBER_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.PHONE_NUMBER_0002, FieldType.String, 10);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.PHONE_NUMBER_0002XX, FieldType.String, PHONE_NUMBER_0002_local, 10);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.EXTENSION_0002AS, FieldType.String, 1);

                   IField EXTENSION_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.EXTENSION_0002, FieldType.String, 5);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.EXTENSION_0002XX, FieldType.String, EXTENSION_0002_local, 5);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.EIN_0002AS, FieldType.String, 1);

                   IField EIN_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.EIN_0002, FieldType.String, 10);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.EIN_0002XX, FieldType.String, EIN_0002_local, 10);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.LAST_NAME_0002AS, FieldType.String, 1);

                   IField LAST_NAME_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.LAST_NAME_0002, FieldType.String, 20);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.LAST_NAME_0002XX, FieldType.String, LAST_NAME_0002_local, 20);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.FIRST_NAME_0002AS, FieldType.String, 1);

                   IField FIRST_NAME_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.FIRST_NAME_0002, FieldType.String, 20);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.FIRST_NAME_0002XX, FieldType.String, FIRST_NAME_0002_local, 20);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.MIDDLE_INITIAL_0002AS, FieldType.String, 1);

                   IField MIDDLE_INITIAL_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.MIDDLE_INITIAL_0002, FieldType.String, 1);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.MIDDLE_INITIAL_0002XX, FieldType.String, MIDDLE_INITIAL_0002_local, 1);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.SUFFIX_0002AS, FieldType.String, 1);

                   IField SUFFIX_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.SUFFIX_0002, FieldType.String, 4);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.SUFFIX_0002XX, FieldType.String, SUFFIX_0002_local, 4);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.SSN_0002AS, FieldType.String, 1);

                   IField SSN_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.SSN_0002, FieldType.String, 9);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.SSN_0002XX, FieldType.String, SSN_0002_local, 9);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.COUNTY_ID_0002AS, FieldType.String, 1);

                   IField COUNTY_ID_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.COUNTY_ID_0002, FieldType.String, 2);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.COUNTY_ID_0002XX, FieldType.String, COUNTY_ID_0002_local, 2);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.COURT_ORDER_NUMBER_0002AS, FieldType.String, 1);

                   IField COURT_ORDER_NUMBER_0002_local = EMPLOYER_NCP_RECORD_0002ET.CreateNewField(Names.COURT_ORDER_NUMBER_0002, FieldType.String, 12);
                   EMPLOYER_NCP_RECORD_0002ET.CreateNewFieldRedefine(Names.COURT_ORDER_NUMBER_0002XX, FieldType.String, COURT_ORDER_NUMBER_0002_local, 12);
               });
           });
    ...
    public class SWEXF203 : EABBase
    {
        ...
        public SWEXF203()
            : base()
        {
            this.ProgramName.SetValue("SWEXF203");

            WS = new SWEXF203_ws();
            FD = new SWEXF203_fd(WS);
            LS = new SWEXF203_ls();
        }
        ...
        private SWEXF203_ws WS;

        //==== File Data Class ========================================
        private SWEXF203_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXF203_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1723616207(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1723616207
        /// </summary>
        private void M_MAIN_1723616207(string returnMethod = "")
        {
            M_PARA_1723616207_INIT("M_PARA_1723616207_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1723616207-INIT THRU PARA-1723616207-INIT-EXIT
            M_PARA_1723616207("M_PARA_1723616207_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1723616207 THRU PARA-1723616207-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1723616207
        /// </summary>
        private void M_PARA_1723616207(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1723616207") { M_PARA_1723616207_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1723616207_EXIT
        /// </summary>
        private void M_PARA_1723616207_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1723616207_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1723616207_EXIT") { M_PARA_1723616207_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1723616207_INIT
        /// </summary>
        private void M_PARA_1723616207_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1723616207_INIT") { M_PARA_1723616207_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1723616207_INIT_EXIT
        /// </summary>
        private void M_PARA_1723616207_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1723616207_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1723616207_INIT_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.EMPNCP_FILE.OpenFile(FileAccessMode.Write);                                                      //COBOL==> OPEN OUTPUT EMPNCP-FILE
            if (WS.EMPNCP_FILE_STAT.IsEqualTo("00"))                                                            //COBOL==> IF EMPNCP-FILE-STAT = '00'
            {
        ...
        private void M_PARA_WRITE(string returnMethod = "")
        {
            ...
            WS.NCP_MIDDLE_INIT.SetValue(LS.MIDDLE_INITIAL_0002);                                                //COBOL==> MOVE MIDDLE-INITIAL-0002 TO NCP-MIDDLE-INIT
            WS.NCP_SUFFIX.SetValue(LS.SUFFIX_0002);                                                             //COBOL==> MOVE SUFFIX-0002 TO NCP-SUFFIX
            WS.NCP_SSN.SetValue(LS.SSN_0002);                                                                   //COBOL==> MOVE SSN-0002 TO NCP-SSN
            WS.COUNTY_ID.SetValue(LS.COUNTY_ID_0002);                                                           //COBOL==> MOVE COUNTY-ID-0002 TO COUNTY-ID
            WS.COURT_ORDER_NO.SetValue(LS.COURT_ORDER_NUMBER_0002);                                             //COBOL==> MOVE COURT-ORDER-NUMBER-0002 TO COURT-ORDER-NO
            FD.EMPNCP_REC_DATA.SetValue(WS.WS_EMP_NCP_REC);                                                     //COBOL==> MOVE WS-EMP-NCP-REC TO EMPNCP-REC-DATA
            FD.EMPNCP_FILE.WriteLine(FD.EMPNCP_REC.AsBytes);                                                    //COBOL==> WRITE EMPNCP-REC
            if (WS.EMPNCP_FILE_STAT.IsEqualTo("00"))                                                            //COBOL==> IF EMPNCP-FILE-STAT = '00'
            {
                //Continue                                                                                          //COBOL==> CONTINUE
            }                                                                                                   //COBOL==> ELSE
        ...
        {
            FD.EMPNCP_FILE.CloseFile();                                                                         //COBOL==> CLOSE EMPNCP-FILE
            if (WS.EMPNCP_FILE_STAT.IsEqualTo("00"))                                                            //COBOL==> IF EMPNCP-FILE-STAT = '00'
            {
                //Continue                                                                                          //COBOL==> CONTINUE
            }                                                                                                   //COBOL==> ELSE
