...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:15:32 PM
   **        *   FROM COBOL PGM   :  SWEXI740
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_CSENET_ERRORS_FILE_READER    DATE: 2001/10/18
       TARGET OS:   MVS                       TIME: 15:10:35
       TARGET DBMS: DB2                       USER: SWSRMCA
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXI740_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXI740_fd_FileSection";
            internal const string TRANSACTION_ERROR = "TRANSACTION_ERROR";
            internal const string TRANSACTION_ERROR_REC = "TRANSACTION_ERROR_REC";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink TRANSACTION_ERROR { get; set; }
        public IField TRANSACTION_ERROR_REC { get { return GetElementByName<IField>(Names.TRANSACTION_ERROR_REC); } }
        ...
        {
            recordDef.CreateNewField(Names.TRANSACTION_ERROR_REC, FieldType.String, 145);
        ...
        public override void Initialize()
        {
            ...
            TRANSACTION_ERROR = FileHandler.GetFile("TXNERROR");
            TRANSACTION_ERROR.AssociatedBuffer = TRANSACTION_ERROR_REC;
            TRANSACTION_ERROR.RecordLength = 145;
        }
        #endregion
    ...
    internal class SWEXI740_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXI740_ws_WorkingStorage";
            internal const string WS_TRANSACTION_ERROR = "WS_TRANSACTION_ERROR";
            internal const string WS_TXN_COUNTER = "WS_TXN_COUNTER";
            internal const string WS_LOCAL_FIPS_CODE = "WS_LOCAL_FIPS_CODE";
            internal const string WS_OTHER_FIPS_CODE = "WS_OTHER_FIPS_CODE";
            internal const string WS_LOCAL_CASE_ID = "WS_LOCAL_CASE_ID";
            internal const string WS_OTHER_CASE_ID = "WS_OTHER_CASE_ID";
            internal const string WS_ACTION_CODE = "WS_ACTION_CODE";
            internal const string WS_FUNCTIONAL_TYPE = "WS_FUNCTIONAL_TYPE";
            internal const string WS_ACTION_REASON = "WS_ACTION_REASON";
            internal const string WS_ACTION_RES_DATE = "WS_ACTION_RES_DATE";
            internal const string WS_TRANSACTION_DATE = "WS_TRANSACTION_DATE";
            internal const string WS_ERROR_CODE = "WS_ERROR_CODE";
            internal const string WS_ERROR_MSG = "WS_ERROR_MSG";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_TRANSACTION_ERROR { get { return GetElementByName<IGroup>(Names.WS_TRANSACTION_ERROR); } }
        public IField WS_TXN_COUNTER { get { return GetElementByName<IField>(Names.WS_TXN_COUNTER); } }
        public IField WS_LOCAL_FIPS_CODE { get { return GetElementByName<IField>(Names.WS_LOCAL_FIPS_CODE); } }
        public IField WS_OTHER_FIPS_CODE { get { return GetElementByName<IField>(Names.WS_OTHER_FIPS_CODE); } }
        public IField WS_LOCAL_CASE_ID { get { return GetElementByName<IField>(Names.WS_LOCAL_CASE_ID); } }
        public IField WS_OTHER_CASE_ID { get { return GetElementByName<IField>(Names.WS_OTHER_CASE_ID); } }
        public IField WS_ACTION_CODE { get { return GetElementByName<IField>(Names.WS_ACTION_CODE); } }
        public IField WS_FUNCTIONAL_TYPE { get { return GetElementByName<IField>(Names.WS_FUNCTIONAL_TYPE); } }
        public IField WS_ACTION_REASON { get { return GetElementByName<IField>(Names.WS_ACTION_REASON); } }
        public IField WS_ACTION_RES_DATE { get { return GetElementByName<IField>(Names.WS_ACTION_RES_DATE); } }
        public IField WS_TRANSACTION_DATE { get { return GetElementByName<IField>(Names.WS_TRANSACTION_DATE); } }
        public IField WS_ERROR_CODE { get { return GetElementByName<IField>(Names.WS_ERROR_CODE); } }
        public IField WS_ERROR_MSG { get { return GetElementByName<IField>(Names.WS_ERROR_MSG); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_TRANSACTION_ERROR, (WS_TRANSACTION_ERROR) =>
           {
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_TXN_COUNTER, FieldType.UnsignedNumeric, 6);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_LOCAL_FIPS_CODE, FieldType.String, 7);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_OTHER_FIPS_CODE, FieldType.String, 7);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_LOCAL_CASE_ID, FieldType.String, 15);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_OTHER_CASE_ID, FieldType.String, 15);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_ACTION_CODE, FieldType.String, 1);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_FUNCTIONAL_TYPE, FieldType.String, 3);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_ACTION_REASON, FieldType.String, 5);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_ACTION_RES_DATE, FieldType.String, 8);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_TRANSACTION_DATE, FieldType.String, 8);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_ERROR_CODE, FieldType.String, 4);
               WS_TRANSACTION_ERROR.CreateNewFillerField(1, FillWith.Hashes);
               WS_TRANSACTION_ERROR.CreateNewField(Names.WS_ERROR_MSG, FieldType.String, 55);
           });
    ...
    internal class SWEXI740_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXI740_ls_LinkageSection";
            ...
            internal const string CSENET_HOST_ERROR_FILE_0002ET = "CSENET_HOST_ERROR_FILE_0002ET";
            internal const string TXN_COUNTER_0002AS = "TXN_COUNTER_0002AS";
            internal const string TXN_COUNTER_0002 = "TXN_COUNTER_0002";
            internal const string TXN_COUNTER_0002XX = "TXN_COUNTER_0002XX";
            internal const string LOCAL_FIPS_CD_0002AS = "LOCAL_FIPS_CD_0002AS";
            internal const string LOCAL_FIPS_CD_0002 = "LOCAL_FIPS_CD_0002";
            internal const string LOCAL_FIPS_CD_0002XX = "LOCAL_FIPS_CD_0002XX";
            internal const string OTHER_FIPS_CD_0002AS = "OTHER_FIPS_CD_0002AS";
            internal const string OTHER_FIPS_CD_0002 = "OTHER_FIPS_CD_0002";
            internal const string OTHER_FIPS_CD_0002XX = "OTHER_FIPS_CD_0002XX";
            internal const string LOCAL_CASE_ID_0002AS = "LOCAL_CASE_ID_0002AS";
            internal const string LOCAL_CASE_ID_0002 = "LOCAL_CASE_ID_0002";
            internal const string LOCAL_CASE_ID_0002XX = "LOCAL_CASE_ID_0002XX";
            internal const string OTHER_CASE_ID_0002AS = "OTHER_CASE_ID_0002AS";
            internal const string OTHER_CASE_ID_0002 = "OTHER_CASE_ID_0002";
            internal const string OTHER_CASE_ID_0002XX = "OTHER_CASE_ID_0002XX";
            internal const string ACTION_CD_0002AS = "ACTION_CD_0002AS";
            internal const string ACTION_CD_0002 = "ACTION_CD_0002";
            internal const string ACTION_CD_0002XX = "ACTION_CD_0002XX";
            internal const string FUNCTIONAL_TYPE_CD_0002AS = "FUNCTIONAL_TYPE_CD_0002AS";
            internal const string FUNCTIONAL_TYPE_CD_0002 = "FUNCTIONAL_TYPE_CD_0002";
            internal const string FUNCTIONAL_TYPE_CD_0002XX = "FUNCTIONAL_TYPE_CD_0002XX";
            internal const string ACTION_REASON_CD_0002AS = "ACTION_REASON_CD_0002AS";
            internal const string ACTION_REASON_CD_0002 = "ACTION_REASON_CD_0002";
            internal const string ACTION_REASON_CD_0002XX = "ACTION_REASON_CD_0002XX";
            internal const string ACTION_RESOLUTION_DT_0002AS = "ACTION_RESOLUTION_DT_0002AS";
            internal const string ACTION_RESOLUTION_DT_0002 = "ACTION_RESOLUTION_DT_0002";
            internal const string ACTION_RESOLUTION_DT_0002XX = "ACTION_RESOLUTION_DT_0002XX";
            internal const string TRANSACTION_DT_0002AS = "TRANSACTION_DT_0002AS";
            internal const string TRANSACTION_DT_0002 = "TRANSACTION_DT_0002";
            internal const string TRANSACTION_DT_0002XX = "TRANSACTION_DT_0002XX";
            internal const string ERROR_CD_0002AS = "ERROR_CD_0002AS";
            internal const string ERROR_CD_0002 = "ERROR_CD_0002";
            internal const string ERROR_CD_0002XX = "ERROR_CD_0002XX";
            internal const string ERROR_MSG_0002AS = "ERROR_MSG_0002AS";
            internal const string ERROR_MSG_0002 = "ERROR_MSG_0002";
            internal const string ERROR_MSG_0002XX = "ERROR_MSG_0002XX";
            internal const string ERROR_MSG_REDEF = "ERROR_MSG_REDEF";
            internal const string TRANSACTION_ID_0002AS = "TRANSACTION_ID_0002AS";
            internal const string TRANSACTION_ID_0002 = "TRANSACTION_ID_0002";
            internal const string TRANSACTION_ID_0002XX = "TRANSACTION_ID_0002XX";
        ...
        public IGroup CSENET_HOST_ERROR_FILE_0002ET { get { return GetElementByName<IGroup>(Names.CSENET_HOST_ERROR_FILE_0002ET); } }
        public IField TXN_COUNTER_0002AS { get { return GetElementByName<IField>(Names.TXN_COUNTER_0002AS); } }
        public IField TXN_COUNTER_0002 { get { return GetElementByName<IField>(Names.TXN_COUNTER_0002); } }
        public IField TXN_COUNTER_0002XX { get { return GetElementByName<IField>(Names.TXN_COUNTER_0002XX); } }
        public IField LOCAL_FIPS_CD_0002AS { get { return GetElementByName<IField>(Names.LOCAL_FIPS_CD_0002AS); } }
        public IField LOCAL_FIPS_CD_0002 { get { return GetElementByName<IField>(Names.LOCAL_FIPS_CD_0002); } }
        public IField LOCAL_FIPS_CD_0002XX { get { return GetElementByName<IField>(Names.LOCAL_FIPS_CD_0002XX); } }
        public IField OTHER_FIPS_CD_0002AS { get { return GetElementByName<IField>(Names.OTHER_FIPS_CD_0002AS); } }
        public IField OTHER_FIPS_CD_0002 { get { return GetElementByName<IField>(Names.OTHER_FIPS_CD_0002); } }
        public IField OTHER_FIPS_CD_0002XX { get { return GetElementByName<IField>(Names.OTHER_FIPS_CD_0002XX); } }
        public IField LOCAL_CASE_ID_0002AS { get { return GetElementByName<IField>(Names.LOCAL_CASE_ID_0002AS); } }
        public IField LOCAL_CASE_ID_0002 { get { return GetElementByName<IField>(Names.LOCAL_CASE_ID_0002); } }
        public IField LOCAL_CASE_ID_0002XX { get { return GetElementByName<IField>(Names.LOCAL_CASE_ID_0002XX); } }
        public IField OTHER_CASE_ID_0002AS { get { return GetElementByName<IField>(Names.OTHER_CASE_ID_0002AS); } }
        public IField OTHER_CASE_ID_0002 { get { return GetElementByName<IField>(Names.OTHER_CASE_ID_0002); } }
        public IField OTHER_CASE_ID_0002XX { get { return GetElementByName<IField>(Names.OTHER_CASE_ID_0002XX); } }
        public IField ACTION_CD_0002AS { get { return GetElementByName<IField>(Names.ACTION_CD_0002AS); } }
        public IField ACTION_CD_0002 { get { return GetElementByName<IField>(Names.ACTION_CD_0002); } }
        public IField ACTION_CD_0002XX { get { return GetElementByName<IField>(Names.ACTION_CD_0002XX); } }
        public IField FUNCTIONAL_TYPE_CD_0002AS { get { return GetElementByName<IField>(Names.FUNCTIONAL_TYPE_CD_0002AS); } }
        public IField FUNCTIONAL_TYPE_CD_0002 { get { return GetElementByName<IField>(Names.FUNCTIONAL_TYPE_CD_0002); } }
        public IField FUNCTIONAL_TYPE_CD_0002XX { get { return GetElementByName<IField>(Names.FUNCTIONAL_TYPE_CD_0002XX); } }
        public IField ACTION_REASON_CD_0002AS { get { return GetElementByName<IField>(Names.ACTION_REASON_CD_0002AS); } }
        public IField ACTION_REASON_CD_0002 { get { return GetElementByName<IField>(Names.ACTION_REASON_CD_0002); } }
        public IField ACTION_REASON_CD_0002XX { get { return GetElementByName<IField>(Names.ACTION_REASON_CD_0002XX); } }
        public IField ACTION_RESOLUTION_DT_0002AS { get { return GetElementByName<IField>(Names.ACTION_RESOLUTION_DT_0002AS); } }
        public IField ACTION_RESOLUTION_DT_0002 { get { return GetElementByName<IField>(Names.ACTION_RESOLUTION_DT_0002); } }
        public IField ACTION_RESOLUTION_DT_0002XX { get { return GetElementByName<IField>(Names.ACTION_RESOLUTION_DT_0002XX); } }
        public IField TRANSACTION_DT_0002AS { get { return GetElementByName<IField>(Names.TRANSACTION_DT_0002AS); } }
        public IField TRANSACTION_DT_0002 { get { return GetElementByName<IField>(Names.TRANSACTION_DT_0002); } }
        public IField TRANSACTION_DT_0002XX { get { return GetElementByName<IField>(Names.TRANSACTION_DT_0002XX); } }
        public IField ERROR_CD_0002AS { get { return GetElementByName<IField>(Names.ERROR_CD_0002AS); } }
        public IField ERROR_CD_0002 { get { return GetElementByName<IField>(Names.ERROR_CD_0002); } }
        public IField ERROR_CD_0002XX { get { return GetElementByName<IField>(Names.ERROR_CD_0002XX); } }
        public IField ERROR_MSG_0002AS { get { return GetElementByName<IField>(Names.ERROR_MSG_0002AS); } }
        public IField ERROR_MSG_0002 { get { return GetElementByName<IField>(Names.ERROR_MSG_0002); } }
        public IGroup ERROR_MSG_0002XX { get { return GetElementByName<IGroup>(Names.ERROR_MSG_0002XX); } }
        public IField ERROR_MSG_REDEF { get { return GetElementByName<IField>(Names.ERROR_MSG_REDEF); } }
        public IField TRANSACTION_ID_0002AS { get { return GetElementByName<IField>(Names.TRANSACTION_ID_0002AS); } }
        public IField TRANSACTION_ID_0002 { get { return GetElementByName<IField>(Names.TRANSACTION_ID_0002); } }
        public IField TRANSACTION_ID_0002XX { get { return GetElementByName<IField>(Names.TRANSACTION_ID_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.CSENET_HOST_ERROR_FILE_0002ET, (CSENET_HOST_ERROR_FILE_0002ET) =>
               {
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.TXN_COUNTER_0002AS, FieldType.String, 1);

                   IField TXN_COUNTER_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.TXN_COUNTER_0002, FieldType.SignedNumeric, 6);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.TXN_COUNTER_0002XX, FieldType.String, TXN_COUNTER_0002_local, 6);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.LOCAL_FIPS_CD_0002AS, FieldType.String, 1);

                   IField LOCAL_FIPS_CD_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.LOCAL_FIPS_CD_0002, FieldType.String, 7);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.LOCAL_FIPS_CD_0002XX, FieldType.String, LOCAL_FIPS_CD_0002_local, 7);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.OTHER_FIPS_CD_0002AS, FieldType.String, 1);

                   IField OTHER_FIPS_CD_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.OTHER_FIPS_CD_0002, FieldType.String, 7);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.OTHER_FIPS_CD_0002XX, FieldType.String, OTHER_FIPS_CD_0002_local, 7);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.LOCAL_CASE_ID_0002AS, FieldType.String, 1);

                   IField LOCAL_CASE_ID_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.LOCAL_CASE_ID_0002, FieldType.String, 15);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.LOCAL_CASE_ID_0002XX, FieldType.String, LOCAL_CASE_ID_0002_local, 15);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.OTHER_CASE_ID_0002AS, FieldType.String, 1);

                   IField OTHER_CASE_ID_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.OTHER_CASE_ID_0002, FieldType.String, 15);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.OTHER_CASE_ID_0002XX, FieldType.String, OTHER_CASE_ID_0002_local, 15);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ACTION_CD_0002AS, FieldType.String, 1);

                   IField ACTION_CD_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ACTION_CD_0002, FieldType.String, 1);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.ACTION_CD_0002XX, FieldType.String, ACTION_CD_0002_local, 1);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.FUNCTIONAL_TYPE_CD_0002AS, FieldType.String, 1);

                   IField FUNCTIONAL_TYPE_CD_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.FUNCTIONAL_TYPE_CD_0002, FieldType.String, 3);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.FUNCTIONAL_TYPE_CD_0002XX, FieldType.String, FUNCTIONAL_TYPE_CD_0002_local, 3);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ACTION_REASON_CD_0002AS, FieldType.String, 1);

                   IField ACTION_REASON_CD_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ACTION_REASON_CD_0002, FieldType.String, 5);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.ACTION_REASON_CD_0002XX, FieldType.String, ACTION_REASON_CD_0002_local, 5);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ACTION_RESOLUTION_DT_0002AS, FieldType.String, 1);

                   IField ACTION_RESOLUTION_DT_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ACTION_RESOLUTION_DT_0002, FieldType.SignedNumeric, 8);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.ACTION_RESOLUTION_DT_0002XX, FieldType.String, ACTION_RESOLUTION_DT_0002_local, 8);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.TRANSACTION_DT_0002AS, FieldType.String, 1);

                   IField TRANSACTION_DT_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.TRANSACTION_DT_0002, FieldType.SignedNumeric, 8);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.TRANSACTION_DT_0002XX, FieldType.String, TRANSACTION_DT_0002_local, 8);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ERROR_CD_0002AS, FieldType.String, 1);

                   IField ERROR_CD_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ERROR_CD_0002, FieldType.String, 4);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.ERROR_CD_0002XX, FieldType.String, ERROR_CD_0002_local, 4);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ERROR_MSG_0002AS, FieldType.String, 1);

                   IField ERROR_MSG_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.ERROR_MSG_0002, FieldType.String, 55);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewGroupRedefine(Names.ERROR_MSG_0002XX, ERROR_MSG_0002_local, (ERROR_MSG_0002XX) =>
                   {
                       ERROR_MSG_0002XX.CreateNewField(Names.ERROR_MSG_REDEF, FieldType.UnsignedNumeric, 12);
                       ERROR_MSG_0002XX.CreateNewFillerField(43, FillWith.Hashes);
                   });
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.TRANSACTION_ID_0002AS, FieldType.String, 1);

                   IField TRANSACTION_ID_0002_local = CSENET_HOST_ERROR_FILE_0002ET.CreateNewField(Names.TRANSACTION_ID_0002, FieldType.SignedNumeric, 12);
                   CSENET_HOST_ERROR_FILE_0002ET.CreateNewFieldRedefine(Names.TRANSACTION_ID_0002XX, FieldType.String, TRANSACTION_ID_0002_local, 12);
               });
           });
    ...
    public class SWEXI740 : EABBase
    {
        ...
        public SWEXI740()
            : base()
        {
            this.ProgramName.SetValue("SWEXI740");
        ...
        private SWEXI740_ws WS;

        //==== File Data Class ========================================
        private SWEXI740_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXI740_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1016596215(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1016596215
        /// </summary>
        private void M_MAIN_1016596215(string returnMethod = "")
        {
            M_PARA_1016596215_INIT("M_PARA_1016596215_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1016596215-INIT THRU PARA-1016596215-INIT-EXIT
            M_PARA_1016596215("M_PARA_1016596215_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1016596215 THRU PARA-1016596215-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1016596215
        /// </summary>
        private void M_PARA_1016596215(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1016596215") { M_PARA_1016596215_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1016596215_EXIT
        /// </summary>
        private void M_PARA_1016596215_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1016596215_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1016596215_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.TRANSACTION_ERROR.OpenFile(FileAccessMode.Read);                                                 //COBOL==> OPEN INPUT TRANSACTION-ERROR
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003 .
        ...
        {
            WS.WS_TRANSACTION_ERROR.SetValue(FD.TRANSACTION_ERROR.ReadLineInto());                              //COBOL==> READ TRANSACTION-ERROR INTO WS-TRANSACTION-ERROR
            if (FD.TRANSACTION_ERROR.FileStatus == FileStatus.End_of_file)                                      //COBOL==> AT END
            {
                LS.STATUS_0003.SetValue("EOF");                                                                     //COBOL==> MOVE 'EOF' TO STATUS-0003.
            }
        ...
        {
            LS.TXN_COUNTER_0002.SetValue(WS.WS_TXN_COUNTER);                                                    //COBOL==> MOVE WS-TXN-COUNTER TO TXN-COUNTER-0002
            LS.LOCAL_FIPS_CD_0002.SetValue(WS.WS_LOCAL_FIPS_CODE);                                              //COBOL==> MOVE WS-LOCAL-FIPS-CODE TO LOCAL-FIPS-CD-0002
            LS.OTHER_FIPS_CD_0002.SetValue(WS.WS_OTHER_FIPS_CODE);                                              //COBOL==> MOVE WS-OTHER-FIPS-CODE TO OTHER-FIPS-CD-0002
            LS.LOCAL_CASE_ID_0002.SetValue(WS.WS_LOCAL_CASE_ID);                                                //COBOL==> MOVE WS-LOCAL-CASE-ID TO LOCAL-CASE-ID-0002
            LS.OTHER_CASE_ID_0002.SetValue(WS.WS_OTHER_CASE_ID);                                                //COBOL==> MOVE WS-OTHER-CASE-ID TO OTHER-CASE-ID-0002
            LS.ACTION_CD_0002.SetValue(WS.WS_ACTION_CODE);                                                      //COBOL==> MOVE WS-ACTION-CODE TO ACTION-CD-0002
            LS.FUNCTIONAL_TYPE_CD_0002.SetValue(WS.WS_FUNCTIONAL_TYPE);                                         //COBOL==> MOVE WS-FUNCTIONAL-TYPE TO FUNCTIONAL-TYPE-CD-0002
            LS.ACTION_REASON_CD_0002.SetValue(WS.WS_ACTION_REASON);                                             //COBOL==> MOVE WS-ACTION-REASON TO ACTION-REASON-CD-0002
            LS.ACTION_RESOLUTION_DT_0002.SetValue(WS.WS_ACTION_RES_DATE);                                       //COBOL==> MOVE WS-ACTION-RES-DATE TO ACTION-RESOLUTION-DT-0002
            LS.TRANSACTION_DT_0002.SetValue(WS.WS_TRANSACTION_DATE);                                            //COBOL==> MOVE WS-TRANSACTION-DATE TO TRANSACTION-DT-0002
            LS.ERROR_CD_0002.SetValue(WS.WS_ERROR_CODE);                                                        //COBOL==> MOVE WS-ERROR-CODE TO ERROR-CD-0002
            LS.ERROR_MSG_0002.SetValue(WS.WS_ERROR_MSG);                                                        //COBOL==> MOVE WS-ERROR-MSG TO ERROR-MSG-0002
            if (LS.ERROR_MSG_REDEF.IsNumericValue())                                                            //COBOL==> IF ERROR-MSG-REDEF NUMERIC
            {
                LS.TRANSACTION_ID_0002.SetValue(LS.ERROR_MSG_REDEF);                                                //COBOL==> MOVE ERROR-MSG-REDEF TO TRANSACTION-ID-0002
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.TRANSACTION_ID_0002.SetValue(+0);                                                                //COBOL==> MOVE +0 TO TRANSACTION-ID-0002
            }                                                                                                   //COBOL==> END-IF .
        ...
        {
            FD.TRANSACTION_ERROR.CloseFile();                                                                   //COBOL==> CLOSE TRANSACTION-ERROR.
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_1016596215_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1016596215_INIT
        /// </summary>
        private void M_PARA_1016596215_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1016596215_INIT") { M_PARA_1016596215_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1016596215_INIT_EXIT
        /// </summary>
        private void M_PARA_1016596215_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1016596215_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
