...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:06:09 PM
   **        *   FROM COBOL PGM   :  SWEXEW04
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_SSN_AND_DOB_MISS_RPT      DATE: 2007/02/12
       TARGET OS:   MVS                       TIME: 08:15:29
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXEW04_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW04_fd_FileSection";
            internal const string SSNADOB = "SSNADOB";
            internal const string SSNADOB_RECORD = "SSNADOB_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink SSNADOB { get; set; }
        public IField SSNADOB_RECORD { get { return GetElementByName<IField>(Names.SSNADOB_RECORD); } }


        internal SWEXEW04_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.SSNADOB_RECORD, FieldType.String, 920);
        ...
        public override void Initialize()
        {
            ...
            SSNADOB = FileHandler.GetFile("SSNADOB");
            SSNADOB.StatusField = WS.SSNADOB_STAT;
            SSNADOB.AssociatedBuffer = SSNADOB_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW04_fd(SWEXEW04_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW04_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW04_ws_WorkingStorage";
            internal const string SSNADOB_STAT = "SSNADOB_STAT";
            ...
            internal const string WS_SSNADOB = "WS_SSNADOB";
            internal const string SSN_AND_DOB_IND = "SSN_AND_DOB_IND";
        ...
        #region Direct-access element properties
        public IField SSNADOB_STAT { get { return GetExternalElementByName<IField>(Names.SSNADOB_STAT); } }
        ...
        public IGroup WS_SSNADOB { get { return GetElementByName<IGroup>(Names.WS_SSNADOB); } }
        public IField SSN_AND_DOB_IND { get { return GetElementByName<IField>(Names.SSN_AND_DOB_IND); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.SSNADOB_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW04 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_SSNADOB, (WS_SSNADOB) =>
           {
               WS_SSNADOB.CreateNewField(Names.SSN_AND_DOB_IND, FieldType.String, 1);
               WS_SSNADOB.CreateNewField(Names.CSE_PERSON_NUMBER, FieldType.String, 10);
               WS_SSNADOB.CreateNewField(Names.LAST_NAME, FieldType.String, 30);
               WS_SSNADOB.CreateNewField(Names.FIRST_NAME, FieldType.String, 16);
               WS_SSNADOB.CreateNewField(Names.MIDDLE_NAME, FieldType.String, 16);
               WS_SSNADOB.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_SSNADOB.CreateNewField(Names.DOB, FieldType.String, 8);
               WS_SSNADOB.CreateNewFillerField(830, FillWith.Hashes);
           });
    ...
    internal class SWEXEW04_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW04_ls_LinkageSection";
            ...
            internal const string MISSING_SSN_AND_DOD_RPT_0002ET = "MISSING_SSN_AND_DOD_RPT_0002ET";
            ...
            internal const string MIDDLE_INT_0002AS = "MIDDLE_INT_0002AS";
            internal const string MIDDLE_INT_0002 = "MIDDLE_INT_0002";
            internal const string MIDDLE_INT_0002XX = "MIDDLE_INT_0002XX";
            ...
            internal const string MISSING_ATTRIBUTE_0002AS = "MISSING_ATTRIBUTE_0002AS";
            internal const string MISSING_ATTRIBUTE_0002 = "MISSING_ATTRIBUTE_0002";
            internal const string MISSING_ATTRIBUTE_0002XX = "MISSING_ATTRIBUTE_0002XX";
        ...
        public IGroup MISSING_SSN_AND_DOD_RPT_0002ET { get { return GetElementByName<IGroup>(Names.MISSING_SSN_AND_DOD_RPT_0002ET); } }
        ...
        public IField MIDDLE_INT_0002AS { get { return GetElementByName<IField>(Names.MIDDLE_INT_0002AS); } }
        public IField MIDDLE_INT_0002 { get { return GetElementByName<IField>(Names.MIDDLE_INT_0002); } }
        public IField MIDDLE_INT_0002XX { get { return GetElementByName<IField>(Names.MIDDLE_INT_0002XX); } }
        ...
        public IField MISSING_ATTRIBUTE_0002AS { get { return GetElementByName<IField>(Names.MISSING_ATTRIBUTE_0002AS); } }
        public IField MISSING_ATTRIBUTE_0002 { get { return GetElementByName<IField>(Names.MISSING_ATTRIBUTE_0002); } }
        public IField MISSING_ATTRIBUTE_0002XX { get { return GetElementByName<IField>(Names.MISSING_ATTRIBUTE_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.MISSING_SSN_AND_DOD_RPT_0002ET, (MISSING_SSN_AND_DOD_RPT_0002ET) =>
               {
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.CSE_PERSON_NUMBER_0002AS, FieldType.String, 1);

                   IField CSE_PERSON_NUMBER_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.CSE_PERSON_NUMBER_0002, FieldType.String, 10);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.CSE_PERSON_NUMBER_0002XX, FieldType.String, CSE_PERSON_NUMBER_0002_local, 10);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.LAST_NAME_0002AS, FieldType.String, 1);

                   IField LAST_NAME_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.LAST_NAME_0002, FieldType.String, 30);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.LAST_NAME_0002XX, FieldType.String, LAST_NAME_0002_local, 30);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.FIRST_NAME_0002AS, FieldType.String, 1);

                   IField FIRST_NAME_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.FIRST_NAME_0002, FieldType.String, 16);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.FIRST_NAME_0002XX, FieldType.String, FIRST_NAME_0002_local, 16);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.MIDDLE_INT_0002AS, FieldType.String, 1);

                   IField MIDDLE_INT_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.MIDDLE_INT_0002, FieldType.String, 1);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.MIDDLE_INT_0002XX, FieldType.String, MIDDLE_INT_0002_local, 1);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.SSN_0002AS, FieldType.String, 1);

                   IField SSN_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.SSN_0002, FieldType.String, 9);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.SSN_0002XX, FieldType.String, SSN_0002_local, 9);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.DOB_0002AS, FieldType.String, 1);

                   IField DOB_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.DOB_0002, FieldType.String, 8);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.DOB_0002XX, FieldType.String, DOB_0002_local, 8);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.MISSING_ATTRIBUTE_0002AS, FieldType.String, 1);

                   IField MISSING_ATTRIBUTE_0002_local = MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewField(Names.MISSING_ATTRIBUTE_0002, FieldType.String, 1);
                   MISSING_SSN_AND_DOD_RPT_0002ET.CreateNewFieldRedefine(Names.MISSING_ATTRIBUTE_0002XX, FieldType.String, MISSING_ATTRIBUTE_0002_local, 1);
               });
           });
    ...
    public class SWEXEW04 : EABBase
    {
        ...
        public SWEXEW04()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW04");

            WS = new SWEXEW04_ws();
            FD = new SWEXEW04_fd(WS);
            LS = new SWEXEW04_ls();
        }
        ...
        private SWEXEW04_ws WS;

        //==== File Data Class ========================================
        private SWEXEW04_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW04_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230561480(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230561480
        /// </summary>
        private void M_MAIN_1230561480(string returnMethod = "")
        {
            M_PARA_1230561480_INIT("M_PARA_1230561480_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230561480-INIT THRU PARA-1230561480-INIT-EXIT
            M_PARA_1230561480("M_PARA_1230561480_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230561480 THRU PARA-1230561480-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230561480
        /// </summary>
        private void M_PARA_1230561480(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE64 IS A PART OF SWEXEW04*
            //COMMENT: ******************************************
        ...
        {
            FD.SSNADOB.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT SSNADOB.
            if (!(WS.SSNADOB_STAT.IsEqualTo(00)))                                                               //COBOL==> IF SSNADOB-STAT NOT = 00
            {
                ...
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.SSNADOB_STAT);                                              //COBOL==> MOVE SSNADOB-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.SSNADOB_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO SSNADOB-RECORD.
            FD.SSNADOB_RECORD.SetValue(WS.WS_SSNADOB);                                                          //COBOL==> MOVE WS-SSNADOB TO SSNADOB-RECORD.
            FD.SSNADOB.WriteLine(FD.SSNADOB_RECORD.AsBytes);                                                    //COBOL==> WRITE SSNADOB-RECORD.
            if (!(WS.SSNADOB_STAT.IsEqualTo(00)))                                                               //COBOL==> IF SSNADOB-STAT NOT = 00
            {
        ...
        {
            FD.SSNADOB.CloseFile();                                                                             //COBOL==> CLOSE SSNADOB.
            if (!(WS.SSNADOB_STAT.IsEqualTo(00)))                                                               //COBOL==> IF SSNADOB-STAT NOT = 00
            {
        ...
        {
            WS.WS_SSNADOB.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO WS-SSNADOB
            ...
            WS.MIDDLE_NAME.SetValue(LS.MIDDLE_INT_0002);                                                        //COBOL==> MOVE MIDDLE-INT-0002 TO MIDDLE-NAME
            WS.SSN_AND_DOB_IND.SetValue(LS.MISSING_ATTRIBUTE_0002);                                             //COBOL==> MOVE MISSING-ATTRIBUTE-0002 TO SSN-AND-DOB-IND
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230561480_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230561480_EXIT
        /// </summary>
        private void M_PARA_1230561480_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230561480_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230561480_EXIT") { M_PARA_1230561480_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230561480_INIT
        /// </summary>
        private void M_PARA_1230561480_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1230561480_INIT") { M_PARA_1230561480_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230561480_INIT_EXIT
        /// </summary>
        private void M_PARA_1230561480_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230561480_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
