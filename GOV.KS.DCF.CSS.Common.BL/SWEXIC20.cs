...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:50:21 PM
   **        *   FROM COBOL PGM   :  SWEXIC20
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_ADD_ALIAS                    DATE: 96/01/04
...
namespace GOV.KS.DCF.CSS.Common.BL
{
    ...
    internal class SWEXIC20_ws : PredefinedRecordBase
    {
        ...
        {
            internal const string WorkingStorage = "SWEXIC20_ws_WorkingStorage";
            internal const string FUNC_0544735592_ESC_FLAG = "FUNC_0544735592_ESC_FLAG";
        ...
        public IField FUNC_0544735592_ESC_FLAG { get { return GetElementByName<IField>(Names.FUNC_0544735592_ESC_FLAG); } }
        ...
        {
            recordDef.CreateNewField(Names.FUNC_0544735592_ESC_FLAG, FieldType.String, 1);
            ...
            recordDef.CreateNewGroup(Names.EXTERNAL_ACTION_BLOCK_WS, (EXTERNAL_ACTION_BLOCK_WS) =>
           {
               ...
               EXTERNAL_ACTION_BLOCK_WS.CreateNewField(Names.SRMODLNK, FieldType.String, 8, "SWEXIC20");
    ...
    internal class SWEXIC20_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIC20_ls_LinkageSection";
            ...
            internal const string A_0544735595_IA = "A_0544735595_IA";
            internal const string INPUT_NEW_0001EV = "INPUT_NEW_0001EV";
            ...
            internal const string A_0544735596_OA = "A_0544735596_OA";
            internal const string OUTPUT_KEY_0002EV = "OUTPUT_KEY_0002EV";
            ...
            internal const string UNIQUE_KEY_0002AS = "UNIQUE_KEY_0002AS";
            internal const string UNIQUE_KEY_0002 = "UNIQUE_KEY_0002";
            internal const string UNIQUE_KEY_0002XX = "UNIQUE_KEY_0002XX";
        ...
        public IGroup A_0544735595_IA { get { return GetElementByName<IGroup>(Names.A_0544735595_IA); } }
        public IGroup INPUT_NEW_0001EV { get { return GetElementByName<IGroup>(Names.INPUT_NEW_0001EV); } }
        ...
        public IGroup A_0544735596_OA { get { return GetElementByName<IGroup>(Names.A_0544735596_OA); } }
        public IGroup OUTPUT_KEY_0002EV { get { return GetElementByName<IGroup>(Names.OUTPUT_KEY_0002EV); } }
        ...
        public IField UNIQUE_KEY_0002AS { get { return GetElementByName<IField>(Names.UNIQUE_KEY_0002AS); } }
        public IField UNIQUE_KEY_0002 { get { return GetElementByName<IField>(Names.UNIQUE_KEY_0002); } }
        public IField UNIQUE_KEY_0002XX { get { return GetElementByName<IField>(Names.UNIQUE_KEY_0002XX); } }
        public IGroup OUTPUT_0003EV { get { return GetElementByName<IGroup>(Names.OUTPUT_0003EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               W_IA.CreateNewGroup(Names.A_0544735595_IA, (A_0544735595_IA) =>
               {
                   A_0544735595_IA.CreateNewGroup(Names.INPUT_NEW_0001EV, (INPUT_NEW_0001EV) =>
                   {
                       INPUT_NEW_0001EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0001ET, (CSE_PERSONS_WORK_SET_0001ET) =>
                       {
           ...
           {
               W_OA.CreateNewGroup(Names.A_0544735596_OA, (A_0544735596_OA) =>
               {
                   A_0544735596_OA.CreateNewGroup(Names.OUTPUT_KEY_0002EV, (OUTPUT_KEY_0002EV) =>
                   {
                       OUTPUT_KEY_0002EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0002ET, (CSE_PERSONS_WORK_SET_0002ET) =>
                       {
                           ...
                           CSE_PERSONS_WORK_SET_0002ET.CreateNewField(Names.UNIQUE_KEY_0002AS, FieldType.String, 1);

                           IField UNIQUE_KEY_0002_local = CSE_PERSONS_WORK_SET_0002ET.CreateNewField(Names.UNIQUE_KEY_0002, FieldType.String, 100);
                           CSE_PERSONS_WORK_SET_0002ET.CreateNewFieldRedefine(Names.UNIQUE_KEY_0002XX, FieldType.String, UNIQUE_KEY_0002_local, 100);
                       });
                   });
                   A_0544735596_OA.CreateNewGroup(Names.OUTPUT_0003EV, (OUTPUT_0003EV) =>
                   {
                       OUTPUT_0003EV.CreateNewGroup(Names.ABEND_DATA_0003ET, (ABEND_DATA_0003ET) =>
                       {
    ...
    public class SWEXIC20 : OnlineEABBase
    {
        ...
        public SWEXIC20(OnlineControl controlData) : base(controlData)
        {
            SetUpProgram();
        }
        ...
        private SWEXIC20_ws WS;

        //==== Linkage Section Data Class ========================================
        private SWEXIC20_ls LS;
        #endregion
        ...
        protected override void RunMain(string startLabel, string returnLbl)
        {
            ...
            switch (startLabel)
            {
                case "PARA-0544735592-INIT": goto L_PARA_0544735592_INIT; break;
                case "PARA-0544735592": goto L_PARA_0544735592; break;
        ...
        #region MAIN-0544735592
        L_MAIN_0544735592:;
            Perform("PARA-0544735592-INIT", "PARA-0544735592-INIT-EXIT"); if (Control.ExitProgram) { return; }    //COBOL==> PERFORM PARA-0544735592-INIT THRU PARA-0544735592-INIT-EXIT
            Perform("PARA-0544735592", "PARA-0544735592-EXIT"); if (Control.ExitProgram) { return; }              //COBOL==> PERFORM PARA-0544735592 THRU PARA-0544735592-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        #endregion MAIN-0544735592

        #region PARA-0544735592
        L_PARA_0544735592:;
            WS.FUNC_0544735592_ESC_FLAG.SetValue("N");                                                          //COBOL==> MOVE 'N' TO FUNC-0544735592-ESC-FLAG.
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            ///COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ///COMMENT: ****************************************************************
            ///COMMENT:                                                                *
            ///COMMENT:  INCLUDE NAME:  SWCSZG20.                                      *
            ///COMMENT:      EAB NAME:  SWEXIC20.                                      *
            ...
            ///COMMENT:                                                                *
            ///COMMENT: ****************************************************************
            if (returnLabel == "PARA-0544735592") { return; }  //Check for pass through to next method
        #endregion PARA-0544735592
        ...
        L_0000_ADABAS_ROUTINE:;
            ...
            WS.IMP_CLIENT_KEY.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO IMP-CLIENT-KEY.
                                                                                                                //COMMENT: ****************************************************************
                                                                                                                //COMMENT: ****************************************************************
            ...
            LS.UNIQUE_KEY_0002.SetValue(WS.IMP_CLIENT_KEY);                                                     //COBOL==> MOVE IMP-CLIENT-KEY TO UNIQUE-KEY-0002.
                                                                                                                //COMMENT: ****************************************************************
                                                                                                                //COMMENT: ****************************************************************
            goto L_0000_ADABAS_EXIT;                                                                            //COBOL==> GO TO 0000-ADABAS-EXIT.
        ...
        #region PARA-0544735592-EXIT
        L_PARA_0544735592_EXIT:;
            if (returnLabel == "PARA-0544735592-EXIT") { return; }                                              //COBOL==> EXIT.
        ///COMMENT: *****************************************************************
        ///COMMENT:                                                                 *
        ...
        ///COMMENT: *****************************************************************
        #endregion PARA-0544735592-EXIT
        ...
        #region PARA-0544735592-INIT
        L_PARA_0544735592_INIT:;
            LS.OUTPUT_KEY_0002EV.ResetToInitialValue();                                                         //COBOL==> INITIALIZE OUTPUT-KEY-0002EV
            LS.OUTPUT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE OUTPUT-0003EV .
            if (returnLabel == "PARA-0544735592-INIT") { return; }  //Check for pass through to next method
        #endregion PARA-0544735592-INIT

        #region PARA-0544735592-INIT-EXIT
        L_PARA_0544735592_INIT_EXIT:;
            if (returnLabel == "PARA-0544735592-INIT-EXIT") { return; }                                         //COBOL==> EXIT.
            #endregion PARA-0544735592-INIT-EXIT
        }
        #endregion
    }
    #endregion
