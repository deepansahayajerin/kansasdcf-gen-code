...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:24 PM
   **        *   FROM COBOL PGM   :  SWEXGP01
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGP01_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP01_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT01");
    ...
    internal class SWEXGP01_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP01_ws_WorkingStorage";
    ...
    internal class SWEXGP01_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP01_ls_LinkageSection";
    ...
    public class SWEXGP01 : EABBase
    {
        ...
        public SWEXGP01()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP01");
        ...
        private SWEXGP01_ws WS;

        //==== File Data Class ========================================
        private SWEXGP01_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP01_ls LS;
        #endregion
