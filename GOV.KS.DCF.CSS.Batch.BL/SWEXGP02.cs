...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:25 PM
   **        *   FROM COBOL PGM   :  SWEXGP02
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGP02_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP02_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT02");
    ...
    internal class SWEXGP02_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP02_ws_WorkingStorage";
    ...
    internal class SWEXGP02_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP02_ls_LinkageSection";
    ...
    public class SWEXGP02 : EABBase
    {
        ...
        public SWEXGP02()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP02");
        ...
        private SWEXGP02_ws WS;

        //==== File Data Class ========================================
        private SWEXGP02_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP02_ls LS;
        #endregion
