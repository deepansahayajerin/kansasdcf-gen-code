...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:29 PM
   **        *   FROM COBOL PGM   :  SWEXGP05
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGP05_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP05_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT05");
    ...
    internal class SWEXGP05_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP05_ws_WorkingStorage";
    ...
    internal class SWEXGP05_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP05_ls_LinkageSection";
    ...
    public class SWEXGP05 : EABBase
    {
        ...
        public SWEXGP05()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP05");
        ...
        private SWEXGP05_ws WS;

        //==== File Data Class ========================================
        private SWEXGP05_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP05_ls LS;
        #endregion
