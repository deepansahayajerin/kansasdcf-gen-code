...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:49:25 PM
   **        *   FROM COBOL PGM   :  SWEXI710
...
/* Original Program Identification Comments
   *********************************************************
     ...
     REPORT COMPOSER LICENSE INFORMATION:
           STATE OF KANSAS
    EAB DEFINITION NAME:  CSENET 10 DAY FILE READER V1
    ACTION BLOCK NAME:    EAB-CSENET-FILE-READER
    LANGUAGE:             COBOL
    STYLE:                READER - POSITIONAL FILE
                          CHECKPOINT RESTART NOT ENABLED
    TARGET OS:            MVS
    SOURCE:               C:\COOLGEN\MODELS\SRRUN065.IEF\COBOL\SWEXI
    GEN DATE:             9/1/1999
    GEN TIME:             16:03:16
    LAST UPDATE USER:     FAIRLEY , COLIN
    LAST UPDATE DATE:     9/1/1999 4:03:16 PM
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXI710_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXI710_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            SEQ_FILE = FileHandler.GetFile("CSENETFR");
        ...
        #region Constructors
        public SWEXI710_fd(SWEXI710_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXI710_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXI710_ws_WorkingStorage";
            ...
            internal const string WS_31_WS31_SERVICE_PROVIDER__X = "WS_31_WS31_SERVICE_PROVIDER__X";
            internal const string WS_61_WS61_REFERRAL_NUMBER_X = "WS_61_WS61_REFERRAL_NUMBER_X";
            internal const string WS_61_WS61_REFERRAL_NUMBER_9 = "WS_61_WS61_REFERRAL_NUMBER_9";
            internal const string WS_73_WS73_START_DATE_X = "WS_73_WS73_START_DATE_X";
            internal const string WS_73_WS73_START_DATE_9 = "WS_73_WS73_START_DATE_9";
            internal const string WS_81_WS81_NON_COMPLIANCE_DA_X = "WS_81_WS81_NON_COMPLIANCE_DA_X";
            internal const string WS_81_WS81_NON_COMPLIANCE_DA_9 = "WS_81_WS81_NON_COMPLIANCE_DA_9";
        ...
        public IField WS_31_WS31_SERVICE_PROVIDER__X { get { return GetElementByName<IField>(Names.WS_31_WS31_SERVICE_PROVIDER__X); } }
        public IField WS_61_WS61_REFERRAL_NUMBER_X { get { return GetElementByName<IField>(Names.WS_61_WS61_REFERRAL_NUMBER_X); } }
        public IField WS_61_WS61_REFERRAL_NUMBER_9 { get { return GetElementByName<IField>(Names.WS_61_WS61_REFERRAL_NUMBER_9); } }
        public IField WS_73_WS73_START_DATE_X { get { return GetElementByName<IField>(Names.WS_73_WS73_START_DATE_X); } }
        public IField WS_73_WS73_START_DATE_9 { get { return GetElementByName<IField>(Names.WS_73_WS73_START_DATE_9); } }
        public IField WS_81_WS81_NON_COMPLIANCE_DA_X { get { return GetElementByName<IField>(Names.WS_81_WS81_NON_COMPLIANCE_DA_X); } }
        public IField WS_81_WS81_NON_COMPLIANCE_DA_9 { get { return GetElementByName<IField>(Names.WS_81_WS81_NON_COMPLIANCE_DA_9); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewFillerField(FieldType.String, 40, "SWEXI710 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_RECORD, (WS_RECORD) =>
           {
               ...
               WS_RECORD.CreateNewField(Names.WS_31_WS31_SERVICE_PROVIDER__X, FieldType.String, 30);

               IField WS_61_WS61_REFERRAL_NUMBER_X_local = WS_RECORD.CreateNewField(Names.WS_61_WS61_REFERRAL_NUMBER_X, FieldType.String, 12);
               WS_RECORD.CreateNewFieldRedefine(Names.WS_61_WS61_REFERRAL_NUMBER_9, FieldType.SignedNumeric, WS_61_WS61_REFERRAL_NUMBER_X_local, 12);

               IField WS_73_WS73_START_DATE_X_local = WS_RECORD.CreateNewField(Names.WS_73_WS73_START_DATE_X, FieldType.String, 8);
               WS_RECORD.CreateNewFieldRedefine(Names.WS_73_WS73_START_DATE_9, FieldType.SignedNumeric, WS_73_WS73_START_DATE_X_local, 8);

               IField WS_81_WS81_NON_COMPLIANCE_DA_X_local = WS_RECORD.CreateNewField(Names.WS_81_WS81_NON_COMPLIANCE_DA_X, FieldType.String, 8);
               WS_RECORD.CreateNewFieldRedefine(Names.WS_81_WS81_NON_COMPLIANCE_DA_9, FieldType.SignedNumeric, WS_81_WS81_NON_COMPLIANCE_DA_X_local, 8);
           });
    ...
    internal class SWEXI710_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXI710_ls_LinkageSection";
            ...
            internal const string E_CSENET_10_DAY_EXTRACT_ET = "E_CSENET_10_DAY_EXTRACT_ET";
            ...
            internal const string E_SERVICE_PROVIDER_NAME_0002MS = "E_SERVICE_PROVIDER_NAME_0002MS";
            internal const string E_SERVICE_PROVIDER_NAME_00_002 = "E_SERVICE_PROVIDER_NAME_00_002";
            internal const string E_SERVICE_PROVIDER_NAME_0002XX = "E_SERVICE_PROVIDER_NAME_0002XX";
            internal const string E_REFERRAL_NUMBER_0002_005MS = "E_REFERRAL_NUMBER_0002_005MS";
            internal const string E_REFERRAL_NUMBER_0002_005 = "E_REFERRAL_NUMBER_0002_005";
            internal const string E_REFERRAL_NUMBER_0002_005XX = "E_REFERRAL_NUMBER_0002_005XX";
            internal const string E_START_DATE_0002_006MS = "E_START_DATE_0002_006MS";
            internal const string E_START_DATE_0002_006 = "E_START_DATE_0002_006";
            internal const string E_START_DATE_0002_006XX = "E_START_DATE_0002_006XX";
            internal const string E_NON_COMPLIANCE_DATE_000207MS = "E_NON_COMPLIANCE_DATE_000207MS";
            internal const string E_NON_COMPLIANCE_DATE_0002_007 = "E_NON_COMPLIANCE_DATE_0002_007";
            internal const string E_NON_COMPLIANCE_DATE_000207XX = "E_NON_COMPLIANCE_DATE_000207XX";
        ...
        public IGroup E_CSENET_10_DAY_EXTRACT_ET { get { return GetElementByName<IGroup>(Names.E_CSENET_10_DAY_EXTRACT_ET); } }
        ...
        public IField E_SERVICE_PROVIDER_NAME_0002MS { get { return GetElementByName<IField>(Names.E_SERVICE_PROVIDER_NAME_0002MS); } }
        public IField E_SERVICE_PROVIDER_NAME_00_002 { get { return GetElementByName<IField>(Names.E_SERVICE_PROVIDER_NAME_00_002); } }
        public IField E_SERVICE_PROVIDER_NAME_0002XX { get { return GetElementByName<IField>(Names.E_SERVICE_PROVIDER_NAME_0002XX); } }
        public IField E_REFERRAL_NUMBER_0002_005MS { get { return GetElementByName<IField>(Names.E_REFERRAL_NUMBER_0002_005MS); } }
        public IField E_REFERRAL_NUMBER_0002_005 { get { return GetElementByName<IField>(Names.E_REFERRAL_NUMBER_0002_005); } }
        public IField E_REFERRAL_NUMBER_0002_005XX { get { return GetElementByName<IField>(Names.E_REFERRAL_NUMBER_0002_005XX); } }
        public IField E_START_DATE_0002_006MS { get { return GetElementByName<IField>(Names.E_START_DATE_0002_006MS); } }
        public IField E_START_DATE_0002_006 { get { return GetElementByName<IField>(Names.E_START_DATE_0002_006); } }
        public IField E_START_DATE_0002_006XX { get { return GetElementByName<IField>(Names.E_START_DATE_0002_006XX); } }
        public IField E_NON_COMPLIANCE_DATE_000207MS { get { return GetElementByName<IField>(Names.E_NON_COMPLIANCE_DATE_000207MS); } }
        public IField E_NON_COMPLIANCE_DATE_0002_007 { get { return GetElementByName<IField>(Names.E_NON_COMPLIANCE_DATE_0002_007); } }
        public IField E_NON_COMPLIANCE_DATE_000207XX { get { return GetElementByName<IField>(Names.E_NON_COMPLIANCE_DATE_000207XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               E_EXPORT_EV2.CreateNewGroup(Names.E_CSENET_10_DAY_EXTRACT_ET, (E_CSENET_10_DAY_EXTRACT_ET) =>
               {
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_OFFICE_0002_003MS, FieldType.String, 1);

                   IField E_OFFICE_0002_003_local = E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_OFFICE_0002_003, FieldType.String, 30);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewFieldRedefine(Names.E_OFFICE_0002_003XX, FieldType.String, E_OFFICE_0002_003_local, 30);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_SERVICE_PROVIDER_NAME_0002MS, FieldType.String, 1);

                   IField E_SERVICE_PROVIDER_NAME_00_002_local = E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_SERVICE_PROVIDER_NAME_00_002, FieldType.String, 30);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewFieldRedefine(Names.E_SERVICE_PROVIDER_NAME_0002XX, FieldType.String, E_SERVICE_PROVIDER_NAME_00_002_local, 30);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_REFERRAL_NUMBER_0002_005MS, FieldType.String, 1);

                   IField E_REFERRAL_NUMBER_0002_005_local = E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_REFERRAL_NUMBER_0002_005, FieldType.SignedNumeric, 12);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewFieldRedefine(Names.E_REFERRAL_NUMBER_0002_005XX, FieldType.String, E_REFERRAL_NUMBER_0002_005_local, 12);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_START_DATE_0002_006MS, FieldType.String, 1);

                   IField E_START_DATE_0002_006_local = E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_START_DATE_0002_006, FieldType.SignedNumeric, 8);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewFieldRedefine(Names.E_START_DATE_0002_006XX, FieldType.String, E_START_DATE_0002_006_local, 8);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_NON_COMPLIANCE_DATE_000207MS, FieldType.String, 1);

                   IField E_NON_COMPLIANCE_DATE_0002_007_local = E_CSENET_10_DAY_EXTRACT_ET.CreateNewField(Names.E_NON_COMPLIANCE_DATE_0002_007, FieldType.SignedNumeric, 8);
                   E_CSENET_10_DAY_EXTRACT_ET.CreateNewFieldRedefine(Names.E_NON_COMPLIANCE_DATE_000207XX, FieldType.String, E_NON_COMPLIANCE_DATE_0002_007_local, 8);
               });
           });
    ...
    public class SWEXI710 : EABBase
    {
        ...
        public SWEXI710()
            : base()
        {
            this.ProgramName.SetValue("SWEXI710");

            WS = new SWEXI710_ws();
            FD = new SWEXI710_fd(WS);
            LS = new SWEXI710_ls();
        }
        ...
        private SWEXI710_ws WS;

        //==== File Data Class ========================================
        private SWEXI710_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXI710_ls LS;
        #endregion
        ...
        private void M_POPULATE_ATTRIBUTES(string returnMethod = "")
        {
            ...
            LS.E_SERVICE_PROVIDER_NAME_00_002.SetValue(WS.WS_31_WS31_SERVICE_PROVIDER__X);                      //COBOL==> MOVE WS-31-WS31-SERVICE-PROVIDER--X TO E-SERVICE-PROVIDER-NAME-00-002.
            if (!(WS.WS_61_WS61_REFERRAL_NUMBER_9.IsNumericValue()))                                           //COBOL==> IF WS-61-WS61-REFERRAL-NUMBER-9 NOT NUMERIC
            {
                DisplayToLog(" NON-NUMERIC DATA FOUND IN POSITION  61 ");                                           //COBOL==> DISPLAY ' NON-NUMERIC DATA FOUND IN POSITION  61 '
                WS.WS_61_WS61_REFERRAL_NUMBER_9.SetValueWithZeroes();                                               //COBOL==> MOVE ZERO TO WS-61-WS61-REFERRAL-NUMBER-9
                LS.E_PARM1_0003_008.SetValue("EN");                                                                 //COBOL==> MOVE 'EN' TO E-PARM1-0003-008
            }                                                                                                   //COBOL==> END-IF.
            LS.E_REFERRAL_NUMBER_0002_005.SetValue(WS.WS_61_WS61_REFERRAL_NUMBER_9);                            //COBOL==> MOVE WS-61-WS61-REFERRAL-NUMBER-9 TO E-REFERRAL-NUMBER-0002-005.
            if (!(WS.WS_73_WS73_START_DATE_9.IsNumericValue()))                                                //COBOL==> IF WS-73-WS73-START-DATE-9 NOT NUMERIC
            {
                DisplayToLog(" NON-NUMERIC DATA FOUND IN POSITION  73 ");                                           //COBOL==> DISPLAY ' NON-NUMERIC DATA FOUND IN POSITION  73 '
                WS.WS_73_WS73_START_DATE_9.SetValueWithZeroes();                                                    //COBOL==> MOVE ZERO TO WS-73-WS73-START-DATE-9
                LS.E_PARM1_0003_008.SetValue("EN");                                                                 //COBOL==> MOVE 'EN' TO E-PARM1-0003-008
            }                                                                                                   //COBOL==> END-IF.
            LS.E_START_DATE_0002_006.SetValue(WS.WS_73_WS73_START_DATE_9);                                      //COBOL==> MOVE WS-73-WS73-START-DATE-9 TO E-START-DATE-0002-006.
            if (!(WS.WS_81_WS81_NON_COMPLIANCE_DA_9.IsNumericValue()))                                         //COBOL==> IF WS-81-WS81-NON-COMPLIANCE-DA-9 NOT NUMERIC
            {
                DisplayToLog(" NON-NUMERIC DATA FOUND IN POSITION  81 ");                                           //COBOL==> DISPLAY ' NON-NUMERIC DATA FOUND IN POSITION  81 '
                WS.WS_81_WS81_NON_COMPLIANCE_DA_9.SetValueWithZeroes();                                             //COBOL==> MOVE ZERO TO WS-81-WS81-NON-COMPLIANCE-DA-9
                LS.E_PARM1_0003_008.SetValue("EN");                                                                 //COBOL==> MOVE 'EN' TO E-PARM1-0003-008
            }                                                                                                   //COBOL==> END-IF.
            LS.E_NON_COMPLIANCE_DATE_0002_007.SetValue(WS.WS_81_WS81_NON_COMPLIANCE_DA_9);                      //COBOL==> MOVE WS-81-WS81-NON-COMPLIANCE-DA-9 TO E-NON-COMPLIANCE-DATE-0002-007.
        ...
        private void M_INIT_LINKAGE(string returnMethod = "")
        {
            ...
            if ((LS.E_SERVICE_PROVIDER_NAME_0002XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_SERVICE_PROVIDER_NAME_0002XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-SERVICE-PROVIDER-NAME-0002XX = HIGH-VALUES OR E-SERVICE-PROVIDER-NAME-0002XX = LOW-VALUES
            {
                LS.E_SERVICE_PROVIDER_NAME_00_002.SetValueWithSpaces();                                             //COBOL==> MOVE SPACES TO E-SERVICE-PROVIDER-NAME-00-002
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.E_REFERRAL_NUMBER_0002_005.IsNumericValue()))                                             //COBOL==> IF E-REFERRAL-NUMBER-0002-005 IS NOT NUMERIC
            {
                LS.E_REFERRAL_NUMBER_0002_005.SetValueWithZeroes();                                                 //COBOL==> MOVE ZEROS TO E-REFERRAL-NUMBER-0002-005
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.E_START_DATE_0002_006.IsNumericValue()))                                                  //COBOL==> IF E-START-DATE-0002-006 IS NOT NUMERIC
            {
                LS.E_START_DATE_0002_006.SetValueWithZeroes();                                                      //COBOL==> MOVE ZEROS TO E-START-DATE-0002-006
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.E_NON_COMPLIANCE_DATE_0002_007.IsNumericValue()))                                         //COBOL==> IF E-NON-COMPLIANCE-DATE-0002-007 IS NOT NUMERIC
            {
                LS.E_NON_COMPLIANCE_DATE_0002_007.SetValueWithZeroes();                                             //COBOL==> MOVE ZEROS TO E-NON-COMPLIANCE-DATE-0002-007
            }                                                                                                   //COBOL==> END-IF.
