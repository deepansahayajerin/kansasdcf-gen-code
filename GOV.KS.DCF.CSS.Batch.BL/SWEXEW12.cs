...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:35 PM
   **        *   FROM COBOL PGM   :  SWEXEW12
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: FN_B680_AR_EXTRACT_DATA1         DATE: 2010/06/14
       TARGET OS:   MVS                       TIME: 08:55:45
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW12_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW12_fd_FileSection";
            internal const string DISBOUT = "DISBOUT";
            internal const string DISBOUT_RECORD = "DISBOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink DISBOUT { get; set; }
        public IField DISBOUT_RECORD { get { return GetElementByName<IField>(Names.DISBOUT_RECORD); } }


        internal SWEXEW12_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.DISBOUT_RECORD, FieldType.String, 245);
        ...
        public override void Initialize()
        {
            ...
            DISBOUT = FileHandler.GetFile("DISBOUT");
            DISBOUT.StatusField = WS.DISBOUT_STAT;
            DISBOUT.AssociatedBuffer = DISBOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW12_fd(SWEXEW12_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW12_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW12_ws_WorkingStorage";
            internal const string DISBOUT_STAT = "DISBOUT_STAT";
            ...
            internal const string WS_DISBOUT = "WS_DISBOUT";
        ...
        #region Direct-access element properties
        public IField DISBOUT_STAT { get { return GetExternalElementByName<IField>(Names.DISBOUT_STAT); } }
        ...
        public IGroup WS_DISBOUT { get { return GetElementByName<IGroup>(Names.WS_DISBOUT); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.DISBOUT_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW11 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_DISBOUT, (WS_DISBOUT) =>
           {
               WS_DISBOUT.CreateNewField(Names.AR_NUMBER, FieldType.String, 10);
               WS_DISBOUT.CreateNewField(Names.AR_LAST_NAME, FieldType.String, 20);
               WS_DISBOUT.CreateNewField(Names.AR_FIRST_NAME, FieldType.String, 14);
               WS_DISBOUT.CreateNewField(Names.AR_MI, FieldType.String, 1);
               WS_DISBOUT.CreateNewField(Names.CH_NUMBER, FieldType.String, 10);
               WS_DISBOUT.CreateNewField(Names.CH_LAST_NAME, FieldType.String, 20);
               WS_DISBOUT.CreateNewField(Names.CH_FIRST_NAME, FieldType.String, 14);
               WS_DISBOUT.CreateNewField(Names.CH_MI, FieldType.String, 1);
               WS_DISBOUT.CreateNewField(Names.COLLECTION_DATE, FieldType.UnsignedNumeric, 8);
               WS_DISBOUT.CreateNewField(Names.COLLECTION_AMOUNT, FieldType.SignedNumeric, 7, null, 2);
               WS_DISBOUT.CreateNewField(Names.PGM_APPLIED_TO, FieldType.String, 2);
               WS_DISBOUT.CreateNewField(Names.APPLIED_TO_CODE, FieldType.String, 1);
               WS_DISBOUT.CreateNewField(Names.AR_NUMBER_SORT, FieldType.String, 10);
               WS_DISBOUT.CreateNewField(Names.OBLIGOR_LAST_NAME, FieldType.String, 17);
               WS_DISBOUT.CreateNewField(Names.OBLIGOR_NUMBER, FieldType.String, 10);
               WS_DISBOUT.CreateNewField(Names.COURT_ORDER_APPLIED_TO, FieldType.String, 20);
               WS_DISBOUT.CreateNewField(Names.COLL_DATE_SORT, FieldType.UnsignedNumeric, 8);
               WS_DISBOUT.CreateNewField(Names.APPLIED_TO_CODE_SORT, FieldType.String, 1);
               WS_DISBOUT.CreateNewField(Names.AMOUNT_RETAINED, FieldType.SignedNumeric, 9, null, 2);
               WS_DISBOUT.CreateNewField(Names.AMOUNT_TO_FAMILY, FieldType.SignedNumeric, 9, null, 2);
               WS_DISBOUT.CreateNewFillerField(FieldType.String, 1, "<");
               WS_DISBOUT.CreateNewField(Names.OBLIGOR_TYPE, FieldType.String, 1);
               WS_DISBOUT.CreateNewField(Names.OB_TYPE_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               WS_DISBOUT.CreateNewField(Names.OBLIGATION_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               WS_DISBOUT.CreateNewField(Names.OB_TRAN_SYS_GEN_ID, FieldType.UnsignedNumeric, 9);
               WS_DISBOUT.CreateNewField(Names.OB_TRAN_TYPE, FieldType.String, 2);
               WS_DISBOUT.CreateNewField(Names.CR_SOURCE_TYPE_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               WS_DISBOUT.CreateNewField(Names.CR_EVENT_SYS_GEN_ID, FieldType.UnsignedNumeric, 9);
               WS_DISBOUT.CreateNewField(Names.CR_RECEIPT_TYPE_SYS_GEN_ID, FieldType.UnsignedNumeric, 3);
               WS_DISBOUT.CreateNewField(Names.CRD_SEQ_ID, FieldType.UnsignedNumeric, 4);
               WS_DISBOUT.CreateNewField(Names.COLL_SYS_GEN_ID, FieldType.UnsignedNumeric, 9);
               WS_DISBOUT.CreateNewField(Names.PGM_APPLIED_TO_SORT, FieldType.String, 3);
               WS_DISBOUT.CreateNewField(Names.TAF_OBL_TYP_GEN_ID, FieldType.UnsignedNumeric, 3);
           });
    ...
    internal class SWEXEW12_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW12_ls_LinkageSection";
            ...
            internal const string IMPORT_OBLIGOR_0003EV = "IMPORT_OBLIGOR_0003EV";
            ...
            internal const string IMPORT_OBLIGOR_0004EV = "IMPORT_OBLIGOR_0004EV";
            ...
            internal const string IMPORT_RETAINED_0007EV = "IMPORT_RETAINED_0007EV";
            ...
            internal const string IMPORT_FORWARDED_TO_FAM_0008EV = "IMPORT_FORWARDED_TO_FAM_0008EV";
            ...
            internal const string IMPORT_0018EV = "IMPORT_0018EV";
            ...
            internal const string IMPORT_0022EV = "IMPORT_0022EV";
            ...
            internal const string IMPORT_CH_PERSON_0023EV = "IMPORT_CH_PERSON_0023EV";
            ...
            internal const string IMPORT_AR_0024EV = "IMPORT_AR_0024EV";
            ...
            internal const string IMPORT_TAF_0025EV = "IMPORT_TAF_0025EV";
            internal const string OBLIGATION_TYPE_0025ET = "OBLIGATION_TYPE_0025ET";
            internal const string SYSTEM_GENERATED_IDENTI_0026AS = "SYSTEM_GENERATED_IDENTI_0026AS";
            internal const string SYSTEM_GENERATED_IDENTIFI_0026 = "SYSTEM_GENERATED_IDENTIFI_0026";
            internal const string SYSTEM_GENERATED_IDENTI_0026XX = "SYSTEM_GENERATED_IDENTI_0026XX";
            internal const string EXPORT_0027EV = "EXPORT_0027EV";
            internal const string EXTERNAL_0027ET = "EXTERNAL_0027ET";
            internal const string NUMERIC_RETURN_CODE_0027AS = "NUMERIC_RETURN_CODE_0027AS";
            internal const string NUMERIC_RETURN_CODE_0027 = "NUMERIC_RETURN_CODE_0027";
            internal const string NUMERIC_RETURN_CODE_0027XX = "NUMERIC_RETURN_CODE_0027XX";
            internal const string TEXT_RETURN_CODE_0027AS = "TEXT_RETURN_CODE_0027AS";
            internal const string TEXT_RETURN_CODE_0027 = "TEXT_RETURN_CODE_0027";
            internal const string TEXT_RETURN_CODE_0027XX = "TEXT_RETURN_CODE_0027XX";
            internal const string TEXT_LINE_80_0027AS = "TEXT_LINE_80_0027AS";
            internal const string TEXT_LINE_80_0027 = "TEXT_LINE_80_0027";
            internal const string TEXT_LINE_80_0027XX = "TEXT_LINE_80_0027XX";
            internal const string FILE_INSTRUCTION_0027AS = "FILE_INSTRUCTION_0027AS";
            internal const string FILE_INSTRUCTION_0027 = "FILE_INSTRUCTION_0027";
            internal const string FILE_INSTRUCTION_0027XX = "FILE_INSTRUCTION_0027XX";
        }
        #endregion
        ...
        public IGroup IMPORT_OBLIGOR_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_OBLIGOR_0003EV); } }
        ...
        public IGroup IMPORT_OBLIGOR_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_OBLIGOR_0004EV); } }
        ...
        public IGroup IMPORT_RETAINED_0007EV { get { return GetElementByName<IGroup>(Names.IMPORT_RETAINED_0007EV); } }
        ...
        public IGroup IMPORT_FORWARDED_TO_FAM_0008EV { get { return GetElementByName<IGroup>(Names.IMPORT_FORWARDED_TO_FAM_0008EV); } }
        ...
        public IGroup IMPORT_0018EV { get { return GetElementByName<IGroup>(Names.IMPORT_0018EV); } }
        ...
        public IGroup IMPORT_0022EV { get { return GetElementByName<IGroup>(Names.IMPORT_0022EV); } }
        ...
        public IGroup IMPORT_CH_PERSON_0023EV { get { return GetElementByName<IGroup>(Names.IMPORT_CH_PERSON_0023EV); } }
        ...
        public IGroup IMPORT_AR_0024EV { get { return GetElementByName<IGroup>(Names.IMPORT_AR_0024EV); } }
        ...
        public IGroup IMPORT_TAF_0025EV { get { return GetElementByName<IGroup>(Names.IMPORT_TAF_0025EV); } }
        public IGroup OBLIGATION_TYPE_0025ET { get { return GetElementByName<IGroup>(Names.OBLIGATION_TYPE_0025ET); } }
        public IField SYSTEM_GENERATED_IDENTI_0026AS { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTI_0026AS); } }
        public IField SYSTEM_GENERATED_IDENTIFI_0026 { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTIFI_0026); } }
        public IField SYSTEM_GENERATED_IDENTI_0026XX { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTI_0026XX); } }
        public IGroup EXPORT_0027EV { get { return GetElementByName<IGroup>(Names.EXPORT_0027EV); } }
        public IGroup EXTERNAL_0027ET { get { return GetElementByName<IGroup>(Names.EXTERNAL_0027ET); } }
        public IField NUMERIC_RETURN_CODE_0027AS { get { return GetElementByName<IField>(Names.NUMERIC_RETURN_CODE_0027AS); } }
        public IField NUMERIC_RETURN_CODE_0027 { get { return GetElementByName<IField>(Names.NUMERIC_RETURN_CODE_0027); } }
        public IField NUMERIC_RETURN_CODE_0027XX { get { return GetElementByName<IField>(Names.NUMERIC_RETURN_CODE_0027XX); } }
        public IField TEXT_RETURN_CODE_0027AS { get { return GetElementByName<IField>(Names.TEXT_RETURN_CODE_0027AS); } }
        public IField TEXT_RETURN_CODE_0027 { get { return GetElementByName<IField>(Names.TEXT_RETURN_CODE_0027); } }
        public IField TEXT_RETURN_CODE_0027XX { get { return GetElementByName<IField>(Names.TEXT_RETURN_CODE_0027XX); } }
        public IField TEXT_LINE_80_0027AS { get { return GetElementByName<IField>(Names.TEXT_LINE_80_0027AS); } }
        public IField TEXT_LINE_80_0027 { get { return GetElementByName<IField>(Names.TEXT_LINE_80_0027); } }
        public IField TEXT_LINE_80_0027XX { get { return GetElementByName<IField>(Names.TEXT_LINE_80_0027XX); } }
        public IField FILE_INSTRUCTION_0027AS { get { return GetElementByName<IField>(Names.FILE_INSTRUCTION_0027AS); } }
        public IField FILE_INSTRUCTION_0027 { get { return GetElementByName<IField>(Names.FILE_INSTRUCTION_0027); } }
        public IField FILE_INSTRUCTION_0027XX { get { return GetElementByName<IField>(Names.FILE_INSTRUCTION_0027XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_AR_0002EV.CreateNewGroup(Names.CSE_PERSON_0002ET, (CSE_PERSON_0002ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_OBLIGOR_0003EV, (IMPORT_OBLIGOR_0003EV) =>
           {
               IMPORT_OBLIGOR_0003EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0003ET, (CSE_PERSONS_WORK_SET_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_OBLIGOR_0004EV, (IMPORT_OBLIGOR_0004EV) =>
           {
               IMPORT_OBLIGOR_0004EV.CreateNewGroup(Names.CSE_PERSON_0004ET, (CSE_PERSON_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0005EV, (IMPORT_0005EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_RETAINED_0007EV, (IMPORT_RETAINED_0007EV) =>
           {
               IMPORT_RETAINED_0007EV.CreateNewGroup(Names.COLLECTION_0007ET, (COLLECTION_0007ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_FORWARDED_TO_FAM_0008EV, (IMPORT_FORWARDED_TO_FAM_0008EV) =>
           {
               IMPORT_FORWARDED_TO_FAM_0008EV.CreateNewGroup(Names.COLLECTION_0008ET, (COLLECTION_0008ET) =>
               {
           ...
           {
               IMPORT_0009EV.CreateNewGroup(Names.OBLIGOR_0009ET, (OBLIGOR_0009ET) =>
               {
           ...
           {
               IMPORT_0010EV.CreateNewGroup(Names.OBLIGATION_TYPE_0010ET, (OBLIGATION_TYPE_0010ET) =>
               {
           ...
           {
               IMPORT_0012EV.CreateNewGroup(Names.OBLIGATION_0012ET, (OBLIGATION_0012ET) =>
               {
           ...
           {
               IMPORT_0014EV.CreateNewGroup(Names.OBLIGATION_TRANSACTION_0014ET, (OBLIGATION_TRANSACTION_0014ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0016EV, (IMPORT_0016EV) =>
           {
               IMPORT_0016EV.CreateNewGroup(Names.CASH_RECEIPT_SOURCE_TYP_0016ET, (CASH_RECEIPT_SOURCE_TYP_0016ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0018EV, (IMPORT_0018EV) =>
           {
               IMPORT_0018EV.CreateNewGroup(Names.CASH_RECEIPT_EVENT_0018ET, (CASH_RECEIPT_EVENT_0018ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0020EV, (IMPORT_0020EV) =>
           {
               IMPORT_0020EV.CreateNewGroup(Names.CASH_RECEIPT_TYPE_0020ET, (CASH_RECEIPT_TYPE_0020ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0022EV, (IMPORT_0022EV) =>
           {
               IMPORT_0022EV.CreateNewGroup(Names.CASH_RECEIPT_DETAIL_0022ET, (CASH_RECEIPT_DETAIL_0022ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CH_PERSON_0023EV, (IMPORT_CH_PERSON_0023EV) =>
           {
               IMPORT_CH_PERSON_0023EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0023ET, (CSE_PERSONS_WORK_SET_0023ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_AR_0024EV, (IMPORT_AR_0024EV) =>
           {
               IMPORT_AR_0024EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0024ET, (CSE_PERSONS_WORK_SET_0024ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_TAF_0025EV, (IMPORT_TAF_0025EV) =>
           {
               IMPORT_TAF_0025EV.CreateNewGroup(Names.OBLIGATION_TYPE_0025ET, (OBLIGATION_TYPE_0025ET) =>
               {
                   OBLIGATION_TYPE_0025ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTI_0026AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_IDENTIFI_0026_local = OBLIGATION_TYPE_0025ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTIFI_0026, FieldType.SignedNumeric, 3);
                   OBLIGATION_TYPE_0025ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_IDENTI_0026XX, FieldType.String, SYSTEM_GENERATED_IDENTIFI_0026_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0027EV, (EXPORT_0027EV) =>
           {
               EXPORT_0027EV.CreateNewGroup(Names.EXTERNAL_0027ET, (EXTERNAL_0027ET) =>
               {
                   EXTERNAL_0027ET.CreateNewField(Names.NUMERIC_RETURN_CODE_0027AS, FieldType.String, 1);

                   IField NUMERIC_RETURN_CODE_0027_local = EXTERNAL_0027ET.CreateNewField(Names.NUMERIC_RETURN_CODE_0027, FieldType.SignedNumeric, 2);
                   EXTERNAL_0027ET.CreateNewFieldRedefine(Names.NUMERIC_RETURN_CODE_0027XX, FieldType.String, NUMERIC_RETURN_CODE_0027_local, 2);
                   EXTERNAL_0027ET.CreateNewField(Names.TEXT_RETURN_CODE_0027AS, FieldType.String, 1);

                   IField TEXT_RETURN_CODE_0027_local = EXTERNAL_0027ET.CreateNewField(Names.TEXT_RETURN_CODE_0027, FieldType.String, 2);
                   EXTERNAL_0027ET.CreateNewFieldRedefine(Names.TEXT_RETURN_CODE_0027XX, FieldType.String, TEXT_RETURN_CODE_0027_local, 2);
                   EXTERNAL_0027ET.CreateNewField(Names.TEXT_LINE_80_0027AS, FieldType.String, 1);

                   IField TEXT_LINE_80_0027_local = EXTERNAL_0027ET.CreateNewField(Names.TEXT_LINE_80_0027, FieldType.String, 130);
                   EXTERNAL_0027ET.CreateNewFieldRedefine(Names.TEXT_LINE_80_0027XX, FieldType.String, TEXT_LINE_80_0027_local, 130);
                   EXTERNAL_0027ET.CreateNewField(Names.FILE_INSTRUCTION_0027AS, FieldType.String, 1);

                   IField FILE_INSTRUCTION_0027_local = EXTERNAL_0027ET.CreateNewField(Names.FILE_INSTRUCTION_0027, FieldType.String, 10);
                   EXTERNAL_0027ET.CreateNewFieldRedefine(Names.FILE_INSTRUCTION_0027XX, FieldType.String, FILE_INSTRUCTION_0027_local, 10);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_OBLIGOR_0003EV, args, 5);
            SetPassedParm(IMPORT_OBLIGOR_0004EV, args, 6);
            SetPassedParm(IMPORT_0005EV, args, 7);
            SetPassedParm(IMPORT_RETAINED_0007EV, args, 8);
            SetPassedParm(IMPORT_FORWARDED_TO_FAM_0008EV, args, 9);
            SetPassedParm(IMPORT_0009EV, args, 10);
            SetPassedParm(IMPORT_0010EV, args, 11);
            SetPassedParm(IMPORT_0012EV, args, 12);
            SetPassedParm(IMPORT_0014EV, args, 13);
            SetPassedParm(IMPORT_0016EV, args, 14);
            SetPassedParm(IMPORT_0018EV, args, 15);
            SetPassedParm(IMPORT_0020EV, args, 16);
            SetPassedParm(IMPORT_0022EV, args, 17);
            SetPassedParm(IMPORT_CH_PERSON_0023EV, args, 18);
            SetPassedParm(IMPORT_AR_0024EV, args, 19);
            SetPassedParm(IMPORT_TAF_0025EV, args, 20);
            SetPassedParm(EXPORT_0027EV, args, 21);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_OBLIGOR_0003EV, args, 5);
            SetReturnParm(IMPORT_OBLIGOR_0004EV, args, 6);
            SetReturnParm(IMPORT_0005EV, args, 7);
            SetReturnParm(IMPORT_RETAINED_0007EV, args, 8);
            SetReturnParm(IMPORT_FORWARDED_TO_FAM_0008EV, args, 9);
            SetReturnParm(IMPORT_0009EV, args, 10);
            SetReturnParm(IMPORT_0010EV, args, 11);
            SetReturnParm(IMPORT_0012EV, args, 12);
            SetReturnParm(IMPORT_0014EV, args, 13);
            SetReturnParm(IMPORT_0016EV, args, 14);
            SetReturnParm(IMPORT_0018EV, args, 15);
            SetReturnParm(IMPORT_0020EV, args, 16);
            SetReturnParm(IMPORT_0022EV, args, 17);
            SetReturnParm(IMPORT_CH_PERSON_0023EV, args, 18);
            SetReturnParm(IMPORT_AR_0024EV, args, 19);
            SetReturnParm(IMPORT_TAF_0025EV, args, 20);
            SetReturnParm(EXPORT_0027EV, args, 21);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXEW12 : EABBase
    {
        ...
        public SWEXEW12()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW12");

            WS = new SWEXEW12_ws();
            FD = new SWEXEW12_fd(WS);
            LS = new SWEXEW12_ls();
        }
        ...
        private SWEXEW12_ws WS;

        //==== File Data Class ========================================
        private SWEXEW12_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW12_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-AR-0002EV , IMPORT-OBLIGOR-0003EV , IMPORT-OBLIGOR-0004EV , IMPORT-0005EV , IMPORT-RETAINED-0007EV , IMPORT-FORWARDED-TO-FAM-0008EV , IMPORT-0009EV , IMPORT-0010EV , IMPORT-0012EV , IMPORT-0014EV , IMPORT-0016EV , IMPORT-0018EV , IMPORT-0020EV , IMPORT-0022EV , IMPORT-CH-PERSON-0023EV , IMPORT-AR-0024EV , IMPORT-TAF-0025EV , EXPORT-0027EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0309599462(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0309599462
        /// </summary>
        private void M_MAIN_0309599462(string returnMethod = "")
        {
            M_PARA_0309599462_INIT("M_PARA_0309599462_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0309599462-INIT THRU PARA-0309599462-INIT-EXIT
            M_PARA_0309599462("M_PARA_0309599462_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0309599462 THRU PARA-0309599462-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0309599462
        /// </summary>
        private void M_PARA_0309599462(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF08 IS A PART OF SWEXEW12*
            //COMMENT: ******************************************
            //COMMENT: IF A NEW STUB IS GENERATED CHANGE
            //COMMENT: ***********************************************************
            LS.TEXT_RETURN_CODE_0027.SetValue("OK");                                                            //COBOL==> MOVE 'OK' TO TEXT-RETURN-CODE-0027
            ...
            {
                LS.TEXT_RETURN_CODE_0027.SetValue("AB");                                                            //COBOL==> MOVE 'AB' TO TEXT-RETURN-CODE-0027
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        {
            FD.DISBOUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT DISBOUT.
            if (!(WS.DISBOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF DISBOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0027.SetValue("OP");                                                            //COBOL==> MOVE 'OP' TO TEXT-RETURN-CODE-0027
                LS.TEXT_LINE_80_0027.SetValue("AN ERROR OCCURRED ON OPEN ");                                        //COBOL==> MOVE 'AN ERROR OCCURRED ON OPEN ' TO TEXT-LINE-80-0027
                LS.NUMERIC_RETURN_CODE_0027.SetValue(WS.DISBOUT_STAT);                                              //COBOL==> MOVE DISBOUT-STAT TO NUMERIC-RETURN-CODE-0027
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.DISBOUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO DISBOUT-RECORD.
            FD.DISBOUT_RECORD.SetValue(WS.WS_DISBOUT);                                                          //COBOL==> MOVE WS-DISBOUT TO DISBOUT-RECORD.
            FD.DISBOUT.WriteLine(FD.DISBOUT_RECORD.AsBytes);                                                    //COBOL==> WRITE DISBOUT-RECORD.
            if (!(WS.DISBOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF DISBOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0027.SetValue("WR");                                                            //COBOL==> MOVE 'WR' TO TEXT-RETURN-CODE-0027
                LS.TEXT_LINE_80_0027.SetValue("AN ERROR OCCURRED IN WRITTING");                                     //COBOL==> MOVE 'AN ERROR OCCURRED IN WRITTING' TO TEXT-LINE-80-0027
                LS.NUMERIC_RETURN_CODE_0027.SetValue(WS.DISBOUT_STAT);                                              //COBOL==> MOVE DISBOUT-STAT TO NUMERIC-RETURN-CODE-0027
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.DISBOUT.CloseFile();                                                                             //COBOL==> CLOSE DISBOUT
            if (!(WS.DISBOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF DISBOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0027.SetValue("CL");                                                            //COBOL==> MOVE 'CL' TO TEXT-RETURN-CODE-0027
                LS.TEXT_LINE_80_0027.SetValue("ERROR IN CLOSING FILE");                                             //COBOL==> MOVE 'ERROR IN CLOSING FILE' TO TEXT-LINE-80-0027
                LS.NUMERIC_RETURN_CODE_0027.SetValue(WS.DISBOUT_STAT);                                              //COBOL==> MOVE DISBOUT-STAT TO NUMERIC-RETURN-CODE-0027
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            WS.WS_DISBOUT.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO WS-DISBOUT
            WS.AR_LAST_NAME.SetValue(LS.LAST_NAME_0024);                                                        //COBOL==> MOVE LAST-NAME-0024 TO AR-LAST-NAME
            WS.AR_FIRST_NAME.SetValue(LS.FIRST_NAME_0024);                                                      //COBOL==> MOVE FIRST-NAME-0024 TO AR-FIRST-NAME
            WS.AR_MI.SetValue(LS.MIDDLE_INITIAL_0024);                                                          //COBOL==> MOVE MIDDLE-INITIAL-0024 TO AR-MI
            WS.AR_NUMBER.SetValue(LS.NUMBER_0024);                                                              //COBOL==> MOVE NUMBER-0024 TO AR-NUMBER
            WS.CH_LAST_NAME.SetValue(LS.LAST_NAME_0023);                                                        //COBOL==> MOVE LAST-NAME-0023 TO CH-LAST-NAME
            WS.CH_FIRST_NAME.SetValue(LS.FIRST_NAME_0023);                                                      //COBOL==> MOVE FIRST-NAME-0023 TO CH-FIRST-NAME
            WS.CH_MI.SetValue(LS.MIDDLE_INITIAL_0023);                                                          //COBOL==> MOVE MIDDLE-INITIAL-0023 TO CH-MI
            WS.CH_NUMBER.SetValue(LS.NUMBER_0023);                                                              //COBOL==> MOVE NUMBER-0023 TO CH-NUMBER
            WS.COLLECTION_DATE.SetValue(LS.COLLECTION_DT_0006);                                                 //COBOL==> MOVE COLLECTION-DT-0006 TO COLLECTION-DATE
            WS.COLLECTION_AMOUNT.SetValue(LS.AMOUNT_0006);                                                      //COBOL==> MOVE AMOUNT-0006 TO COLLECTION-AMOUNT
            WS.PGM_APPLIED_TO.SetValue(LS.PROGRAM_APPLIED_TO_0006);                                             //COBOL==> MOVE PROGRAM-APPLIED-TO-0006 TO PGM-APPLIED-TO
            WS.APPLIED_TO_CODE.SetValue(LS.APPLIED_TO_CODE_0006);                                               //COBOL==> MOVE APPLIED-TO-CODE-0006 TO APPLIED-TO-CODE
            WS.AR_NUMBER_SORT.SetValue(LS.NUMBER_0002);                                                         //COBOL==> MOVE NUMBER-0002 TO AR-NUMBER-SORT
            WS.OBLIGOR_LAST_NAME.SetValue(LS.LAST_NAME_0003);                                                   //COBOL==> MOVE LAST-NAME-0003 TO OBLIGOR-LAST-NAME
            WS.OBLIGOR_NUMBER.SetValue(LS.NUMBER_0004);                                                         //COBOL==> MOVE NUMBER-0004 TO OBLIGOR-NUMBER
            WS.COLL_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0006);                                     //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0006 TO COLL-SYS-GEN-ID
            WS.COURT_ORDER_APPLIED_TO.SetValue(LS.COURT_ORDER_APPLIED_TO_0006);                                 //COBOL==> MOVE COURT-ORDER-APPLIED-TO-0006 TO COURT-ORDER-APPLIED-TO
            WS.COLL_DATE_SORT.SetValue(LS.COLLECTION_DT_0006);                                                  //COBOL==> MOVE COLLECTION-DT-0006 TO COLL-DATE-SORT
            WS.APPLIED_TO_CODE_SORT.SetValue(LS.APPLIED_TO_CODE_0006);                                          //COBOL==> MOVE APPLIED-TO-CODE-0006 TO APPLIED-TO-CODE-SORT
            WS.AMOUNT_RETAINED.SetValue(LS.AMOUNT_0007);                                                        //COBOL==> MOVE AMOUNT-0007 TO AMOUNT-RETAINED
            WS.AMOUNT_TO_FAMILY.SetValue(LS.AMOUNT_0008);                                                       //COBOL==> MOVE AMOUNT-0008 TO AMOUNT-TO-FAMILY
            WS.OBLIGOR_TYPE.SetValue(LS.TYPE_0009);                                                             //COBOL==> MOVE TYPE-0009 TO OBLIGOR-TYPE
            WS.OB_TYPE_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0011);                                  //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0011 TO OB-TYPE-SYS-GEN-ID
            WS.OBLIGATION_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0013);                               //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0013 TO OBLIGATION-SYS-GEN-ID
            WS.OB_TRAN_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0015);                                  //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0015 TO OB-TRAN-SYS-GEN-ID
            WS.OB_TRAN_TYPE.SetValue(LS.TYPE_0015);                                                             //COBOL==> MOVE TYPE-0015 TO OB-TRAN-TYPE
            WS.CR_SOURCE_TYPE_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0017);                           //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0017 TO CR-SOURCE-TYPE-SYS-GEN-ID
            WS.CR_EVENT_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0019);                                 //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0019 TO CR-EVENT-SYS-GEN-ID
            WS.CR_RECEIPT_TYPE_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0021);                          //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0021 TO CR-RECEIPT-TYPE-SYS-GEN-ID
            WS.CRD_SEQ_ID.SetValue(LS.SEQUENTIAL_IDENTIFIER_0022);                                              //COBOL==> MOVE SEQUENTIAL-IDENTIFIER-0022 TO CRD-SEQ-ID
            WS.COLL_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0006);                                     //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0006 TO COLL-SYS-GEN-ID
            WS.PGM_APPLIED_TO_SORT.SetValue(LS.PROGRAM_APPLIED_TO_0006);                                        //COBOL==> MOVE PROGRAM-APPLIED-TO-0006 TO PGM-APPLIED-TO-SORT
            WS.TAF_OBL_TYP_GEN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0026);                                  //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0026 TO TAF-OBL-TYP-GEN-ID
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0309599462_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0309599462_EXIT
        /// </summary>
        private void M_PARA_0309599462_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0309599462_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0309599462_EXIT") { M_PARA_0309599462_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0309599462_INIT
        /// </summary>
        private void M_PARA_0309599462_INIT(string returnMethod = "")
        {
            LS.EXPORT_0027EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0027EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0309599462_INIT") { M_PARA_0309599462_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0309599462_INIT_EXIT
        /// </summary>
        private void M_PARA_0309599462_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0309599462_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
