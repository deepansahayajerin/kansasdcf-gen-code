...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:47:42 PM
   **        *   FROM COBOL PGM   :  SWEXFE80
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_READ_FEDERAL_DEBT_SETOFF_LST DATE: 2005/02/09
       TARGET OS:   MVS                       TIME: 09:25:21
       TARGET DBMS: DB2                       USER: SWDPMJQ
       GENERATION OPTIONS:
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXFE80_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE80_fd_FileSection";
            internal const string FEDERAL_DEBT_SETOFF_LIST = "FEDERAL_DEBT_SETOFF_LIST";
            internal const string FEDERAL_DEBT_SETOFF_LIST_REC = "FEDERAL_DEBT_SETOFF_LIST_REC";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink FEDERAL_DEBT_SETOFF_LIST { get; set; }
        public IField FEDERAL_DEBT_SETOFF_LIST_REC { get { return GetElementByName<IField>(Names.FEDERAL_DEBT_SETOFF_LIST_REC); } }
        ...
        {
            recordDef.CreateNewField(Names.FEDERAL_DEBT_SETOFF_LIST_REC, FieldType.String, 240);
        ...
        public override void Initialize()
        {
            ...
            FEDERAL_DEBT_SETOFF_LIST = FileHandler.GetFile("FDSL");
            FEDERAL_DEBT_SETOFF_LIST.AssociatedBuffer = FEDERAL_DEBT_SETOFF_LIST_REC;
            FEDERAL_DEBT_SETOFF_LIST.RecordLength = 240;
        }
        #endregion
    ...
    internal class SWEXFE80_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE80_ws_WorkingStorage";
            internal const string WS_FEDERAL_DEBT_SETOFF_LIST = "WS_FEDERAL_DEBT_SETOFF_LIST";
            internal const string WS_STATE = "WS_STATE";
            internal const string WS_LOCAL_CD = "WS_LOCAL_CD";
            internal const string WS_SSN = "WS_SSN";
            internal const string WS_AP_NBR = "WS_AP_NBR";
            ...
            internal const string WS_ADJUST_AMT = "WS_ADJUST_AMT";
            internal const string WS_ADJUST_YEAR = "WS_ADJUST_YEAR";
            internal const string WS_TAX_YEAR = "WS_TAX_YEAR";
            internal const string WS_JOINT_RETURN = "WS_JOINT_RETURN";
            ...
            internal const string WS_JOINT_NAMES = "WS_JOINT_NAMES";
            internal const string WS_ADDRESS = "WS_ADDRESS";
            internal const string WS_CITY_ST = "WS_CITY_ST";
            internal const string WS_ZIP5 = "WS_ZIP5";
            internal const string WS_ZIP4 = "WS_ZIP4";
            internal const string WS_TYPE_OFFSET = "WS_TYPE_OFFSET";
            internal const string WS_FEE_AMOUNT = "WS_FEE_AMOUNT";
            internal const string WS_INJURED_SPOUSE_IND = "WS_INJURED_SPOUSE_IND";
            internal const string WS_ZERO_BALANCE_DELETE_IND = "WS_ZERO_BALANCE_DELETE_IND";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_FEDERAL_DEBT_SETOFF_LIST { get { return GetElementByName<IGroup>(Names.WS_FEDERAL_DEBT_SETOFF_LIST); } }
        public IField WS_STATE { get { return GetElementByName<IField>(Names.WS_STATE); } }
        public IField WS_LOCAL_CD { get { return GetElementByName<IField>(Names.WS_LOCAL_CD); } }
        public IField WS_SSN { get { return GetElementByName<IField>(Names.WS_SSN); } }
        public IField WS_AP_NBR { get { return GetElementByName<IField>(Names.WS_AP_NBR); } }
        ...
        public IField WS_ADJUST_AMT { get { return GetElementByName<IField>(Names.WS_ADJUST_AMT); } }
        public IField WS_ADJUST_YEAR { get { return GetElementByName<IField>(Names.WS_ADJUST_YEAR); } }
        public IField WS_TAX_YEAR { get { return GetElementByName<IField>(Names.WS_TAX_YEAR); } }
        public IField WS_JOINT_RETURN { get { return GetElementByName<IField>(Names.WS_JOINT_RETURN); } }
        ...
        public IField WS_JOINT_NAMES { get { return GetElementByName<IField>(Names.WS_JOINT_NAMES); } }
        public IField WS_ADDRESS { get { return GetElementByName<IField>(Names.WS_ADDRESS); } }
        public IField WS_CITY_ST { get { return GetElementByName<IField>(Names.WS_CITY_ST); } }
        ...
        public IField WS_TYPE_OFFSET { get { return GetElementByName<IField>(Names.WS_TYPE_OFFSET); } }
        public IField WS_FEE_AMOUNT { get { return GetElementByName<IField>(Names.WS_FEE_AMOUNT); } }
        public IField WS_INJURED_SPOUSE_IND { get { return GetElementByName<IField>(Names.WS_INJURED_SPOUSE_IND); } }
        public IField WS_ZERO_BALANCE_DELETE_IND { get { return GetElementByName<IField>(Names.WS_ZERO_BALANCE_DELETE_IND); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_FEDERAL_DEBT_SETOFF_LIST, (WS_FEDERAL_DEBT_SETOFF_LIST) =>
           {
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_STATE, FieldType.String, 2);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_LOCAL_CD, FieldType.String, 3);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_SSN, FieldType.String, 9);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_AP_NBR, FieldType.String, 10);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewFillerField(5, FillWith.Hashes);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_LAST_NAME, FieldType.String, 20);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_FIRST_NAME, FieldType.String, 15);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ARREARAGE, FieldType.UnsignedNumeric, 11, null, 2);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_COLLECT_AMT, FieldType.UnsignedNumeric, 11, null, 2);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ADJUST_AMT, FieldType.UnsignedNumeric, 11, null, 2);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ADJUST_YEAR, FieldType.String, 4);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_TAX_YEAR, FieldType.String, 4);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_JOINT_RETURN, FieldType.String, 1);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_CASE_TYPE, FieldType.String, 1);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_TRANSFER_STATE, FieldType.String, 2);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_TRANSFER_LOCAL, FieldType.String, 3);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_JOINT_NAMES, FieldType.String, 35);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ADDRESS, FieldType.String, 35);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_CITY_ST, FieldType.String, 25);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ZIP5, FieldType.String, 5);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ZIP4, FieldType.String, 4);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_TYPE_OFFSET, FieldType.String, 3);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_FEE_AMOUNT, FieldType.String, 5);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_INJURED_SPOUSE_IND, FieldType.String, 1);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewField(Names.WS_ZERO_BALANCE_DELETE_IND, FieldType.String, 1);
               WS_FEDERAL_DEBT_SETOFF_LIST.CreateNewFillerField(14, FillWith.Hashes);
           });
    ...
    internal class SWEXFE80_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE80_ls_LinkageSection";
            ...
            internal const string EXPORT_INJURED_SPOUSE_I_0002EV = "EXPORT_INJURED_SPOUSE_I_0002EV";
            ...
            internal const string EXPORT_RETURN_INDICATOR_0003EV = "EXPORT_RETURN_INDICATOR_0003EV";
            ...
            internal const string EXPORT_COLLECTION_AMOUN_0004EV = "EXPORT_COLLECTION_AMOUN_0004EV";
            ...
            internal const string CSE_PERSON_0005ET = "CSE_PERSON_0005ET";
        ...
        public IGroup EXPORT_INJURED_SPOUSE_I_0002EV { get { return GetElementByName<IGroup>(Names.EXPORT_INJURED_SPOUSE_I_0002EV); } }
        ...
        public IGroup EXPORT_RETURN_INDICATOR_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_RETURN_INDICATOR_0003EV); } }
        ...
        public IGroup EXPORT_COLLECTION_AMOUN_0004EV { get { return GetElementByName<IGroup>(Names.EXPORT_COLLECTION_AMOUN_0004EV); } }
        ...
        public IGroup CSE_PERSON_0005ET { get { return GetElementByName<IGroup>(Names.CSE_PERSON_0005ET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_INJURED_SPOUSE_I_0002EV, (EXPORT_INJURED_SPOUSE_I_0002EV) =>
           {
               EXPORT_INJURED_SPOUSE_I_0002EV.CreateNewGroup(Names.TEXT_WORK_AREA_0002ET, (TEXT_WORK_AREA_0002ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_RETURN_INDICATOR_0003EV, (EXPORT_RETURN_INDICATOR_0003EV) =>
           {
               EXPORT_RETURN_INDICATOR_0003EV.CreateNewGroup(Names.TEXT_WORK_AREA_0003ET, (TEXT_WORK_AREA_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_COLLECTION_AMOUN_0004EV, (EXPORT_COLLECTION_AMOUN_0004EV) =>
           {
               EXPORT_COLLECTION_AMOUN_0004EV.CreateNewGroup(Names.IEF_SUPPLIED_0004ET, (IEF_SUPPLIED_0004ET) =>
               {
           ...
           {
               EXPORT_0005EV.CreateNewGroup(Names.CSE_PERSON_0005ET, (CSE_PERSON_0005ET) =>
               {
                   CSE_PERSON_0005ET.CreateNewField(Names.NUMBER_0005AS, FieldType.String, 1);

                   IField NUMBER_0005_local = CSE_PERSON_0005ET.CreateNewField(Names.NUMBER_0005, FieldType.String, 10);
                   CSE_PERSON_0005ET.CreateNewFieldRedefine(Names.NUMBER_0005XX, FieldType.String, NUMBER_0005_local, 10);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_INJURED_SPOUSE_I_0002EV, args, 4);
            SetPassedParm(EXPORT_RETURN_INDICATOR_0003EV, args, 5);
            SetPassedParm(EXPORT_COLLECTION_AMOUN_0004EV, args, 6);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_INJURED_SPOUSE_I_0002EV, args, 4);
            SetReturnParm(EXPORT_RETURN_INDICATOR_0003EV, args, 5);
            SetReturnParm(EXPORT_COLLECTION_AMOUN_0004EV, args, 6);
    ...
    public class SWEXFE80 : EABBase
    {
        ...
        public SWEXFE80()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE80");
        ...
        private SWEXFE80_ws WS;

        //==== File Data Class ========================================
        private SWEXFE80_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE80_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-INJURED-SPOUSE-I-0002EV , EXPORT-RETURN-INDICATOR-0003EV , EXPORT-COLLECTION-AMOUN-0004EV , EXPORT-0005EV , EXPORT-0006EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0846987310(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0846987310
        /// </summary>
        private void M_MAIN_0846987310(string returnMethod = "")
        {
            M_PARA_0846987310_INIT("M_PARA_0846987310_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0846987310-INIT THRU PARA-0846987310-INIT-EXIT
            M_PARA_0846987310("M_PARA_0846987310_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0846987310 THRU PARA-0846987310-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0846987310
        /// </summary>
        private void M_PARA_0846987310(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if ((LS.ACTION_0001.IsEqualTo("READ")))
            {
                ...
                if (LS.STATUS_0006.IsEqualTo("OK"))                                                                 //COBOL==> IF STATUS-0006 = 'OK'
                {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0846987310") { M_PARA_0846987310_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0846987310_EXIT
        /// </summary>
        private void M_PARA_0846987310_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0846987310_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0846987310_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.FEDERAL_DEBT_SETOFF_LIST.OpenFile(FileAccessMode.Read);                                          //COBOL==> OPEN INPUT FEDERAL-DEBT-SETOFF-LIST
            LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006.
        ...
        {
            WS.WS_FEDERAL_DEBT_SETOFF_LIST.SetValue(FD.FEDERAL_DEBT_SETOFF_LIST.ReadLineInto());                //COBOL==> READ FEDERAL-DEBT-SETOFF-LIST INTO WS-FEDERAL-DEBT-SETOFF-LIST
            if (FD.FEDERAL_DEBT_SETOFF_LIST.FileStatus == FileStatus.End_of_file)                               //COBOL==> AT END
            {
        ...
        {
            LS.NUMBER_0005.SetValue(WS.WS_AP_NBR);                                                              //COBOL==> MOVE WS-AP-NBR TO NUMBER-0005.
            LS.AVERAGE_CURRENCY_0004.SetValue(WS.WS_COLLECT_AMT);                                               //COBOL==> MOVE WS-COLLECT-AMT TO AVERAGE-CURRENCY-0004.
            LS.TEXT_1_0003.SetValue(WS.WS_JOINT_RETURN);                                                        //COBOL==> MOVE WS-JOINT-RETURN TO TEXT-1-0003.
            LS.TEXT_1_0002.SetValue(WS.WS_INJURED_SPOUSE_IND);                                                  //COBOL==> MOVE WS-INJURED-SPOUSE-IND TO TEXT-1-0002.
        ...
        {
            FD.FEDERAL_DEBT_SETOFF_LIST.CloseFile();                                                            //COBOL==> CLOSE FEDERAL-DEBT-SETOFF-LIST.
            LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_0846987310_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0846987310_INIT
        /// </summary>
        private void M_PARA_0846987310_INIT(string returnMethod = "")
        {
            LS.EXPORT_INJURED_SPOUSE_I_0002EV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-INJURED-SPOUSE-I-0002EV
            LS.EXPORT_RETURN_INDICATOR_0003EV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-RETURN-INDICATOR-0003EV
            LS.EXPORT_COLLECTION_AMOUN_0004EV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-COLLECTION-AMOUN-0004EV
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0846987310_INIT") { M_PARA_0846987310_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0846987310_INIT_EXIT
        /// </summary>
        private void M_PARA_0846987310_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0846987310_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
