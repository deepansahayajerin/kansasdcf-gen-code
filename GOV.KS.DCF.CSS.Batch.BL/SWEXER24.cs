...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:12 PM
   **        *   FROM COBOL PGM   :  SWEXER24
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2016 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: FN_B798_READ_TEXT_OPT_OUT_FILE   DATE: 2016/07/19
       TARGET OS:   MVS                       TIME: 11:03:37
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXER24_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER24_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.INPUT_RECORD, FieldType.String, 30);
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE = FileHandler.GetFile("NCPIN");
        ...
        #region Constructors
        public SWEXER24_fd(SWEXER24_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER24_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER24_ws_WorkingStorage";
            internal const string FILE_STATUS = "FILE_STATUS";
            internal const string WS_OPTOUT_RECORD = "WS_OPTOUT_RECORD";
            internal const string WS_OPTOUT_PHONE = "WS_OPTOUT_PHONE";
        }
        #endregion

        #region Direct-access element properties
        public IField FILE_STATUS { get { return GetElementByName<IField>(Names.FILE_STATUS); } }
        public IGroup WS_OPTOUT_RECORD { get { return GetElementByName<IGroup>(Names.WS_OPTOUT_RECORD); } }
        public IField WS_OPTOUT_PHONE { get { return GetElementByName<IField>(Names.WS_OPTOUT_PHONE); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_OPTOUT_RECORD, (WS_OPTOUT_RECORD) =>
           {
               WS_OPTOUT_RECORD.CreateNewField(Names.WS_OPTOUT_PHONE, FieldType.String, 12);
               WS_OPTOUT_RECORD.CreateNewFillerField(18, FillWith.Hashes);
           });
    ...
    internal class SWEXER24_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER24_ls_LinkageSection";
            ...
            internal const string EXPORT_FILE_RECORD_0003EV = "EXPORT_FILE_RECORD_0003EV";
        ...
        public IGroup EXPORT_FILE_RECORD_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_FILE_RECORD_0003EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_FILE_RECORD_0003EV, (EXPORT_FILE_RECORD_0003EV) =>
           {
               EXPORT_FILE_RECORD_0003EV.CreateNewGroup(Names.WORK_AREA_0003ET, (WORK_AREA_0003ET) =>
               {
                   WORK_AREA_0003ET.CreateNewField(Names.TEXT_12_0003AS, FieldType.String, 1);

                   IField TEXT_12_0003_local = WORK_AREA_0003ET.CreateNewField(Names.TEXT_12_0003, FieldType.String, 12);
                   WORK_AREA_0003ET.CreateNewFieldRedefine(Names.TEXT_12_0003XX, FieldType.String, TEXT_12_0003_local, 12);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_FILE_RECORD_0003EV, args, 5);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_FILE_RECORD_0003EV, args, 5);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXER24 : EABBase
    {
        ...
        public SWEXER24()
            : base()
        {
            this.ProgramName.SetValue("SWEXER24");

            WS = new SWEXER24_ws();
            FD = new SWEXER24_fd(WS);
            LS = new SWEXER24_ls();
        }
        ...
        private SWEXER24_ws WS;

        //==== File Data Class ========================================
        private SWEXER24_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER24_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-FILE-RECORD-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0854602490(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0854602490
        /// </summary>
        private void M_MAIN_0854602490(string returnMethod = "")
        {
            M_PARA_0854602490_INIT("M_PARA_0854602490_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0854602490-INIT THRU PARA-0854602490-INIT-EXIT
            M_PARA_0854602490("M_PARA_0854602490_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0854602490 THRU PARA-0854602490-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0854602490
        /// </summary>
        private void M_PARA_0854602490(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0854602490") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAINLINE(string returnMethod = "")
        {
            ...
            if ((LS.ACTION_0001.IsEqualTo("RESET")))
            {
                M_2500_RESET_FILE(); if (Control.ExitProgram) { return; }                                             //COBOL==> PERFORM 2500-RESET-FILE
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                WS.WS_OPTOUT_RECORD.SetValue(FD.INPUT_RECORD);                                                      //COBOL==> MOVE INPUT-RECORD TO WS-OPTOUT-RECORD
                LS.TEXT_12_0003.SetValue(WS.WS_OPTOUT_PHONE);                                                       //COBOL==> MOVE WS-OPTOUT-PHONE TO TEXT-12-0003
            }                                                                                                //COBOL==> WHEN '10'
            else
            ...
            if (returnMethod != "" && returnMethod != "M_2000_READ_FILE") { M_2500_RESET_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_2500_RESET_FILE
        /// </summary>
        /// <remarks>
        ///COMMENT: *************************
        /// </remarks>
        private void M_2500_RESET_FILE(string returnMethod = "")
        {
            //COMMENT: *************************
            FD.INPUT_FILE.CloseFile();                                                                          //COBOL==> CLOSE INPUT-FILE
            FD.INPUT_FILE.OpenFile(FileAccessMode.Write);                                                       //COBOL==> OPEN OUTPUT INPUT-FILE
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
            }                                                                                                   //COBOL==> ELSE
            ...
            if (returnMethod != "" && returnMethod != "M_2500_RESET_FILE") { M_3000_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0854602490_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854602490_EXIT
        /// </summary>
        private void M_PARA_0854602490_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854602490_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0854602490_EXIT") { M_PARA_0854602490_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854602490_INIT
        /// </summary>
        private void M_PARA_0854602490_INIT(string returnMethod = "")
        {
            LS.EXPORT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0002EV
            LS.EXPORT_FILE_RECORD_0003EV.ResetToInitialValue();                                                 //COBOL==> INITIALIZE EXPORT-FILE-RECORD-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0854602490_INIT") { M_PARA_0854602490_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0854602490_INIT_EXIT
        /// </summary>
        private void M_PARA_0854602490_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0854602490_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
