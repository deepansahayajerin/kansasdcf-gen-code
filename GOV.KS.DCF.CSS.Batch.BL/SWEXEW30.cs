...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:45:13 PM
   **        *   FROM COBOL PGM   :  SWEXEW30
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: EAB_EXTERNAL_REPORT_WRITER       DATE: 2017/02/08
       TARGET OS:   MVS                       TIME: 08:36:10
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW30_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW30_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.ARSTOUT_RECORD, FieldType.String, 132);
        ...
        #region Constructors
        public SWEXEW30_fd(SWEXEW30_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW30_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW30_ws_WorkingStorage";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_ARSTOUT.CreateNewField(Names.RECOUT, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.WS_DETAIL, (WS_DETAIL) =>
           {
               WS_DETAIL.CreateNewField(Names.RECORD_DETL, FieldType.String, 132);
           });
    ...
    internal class SWEXEW30_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW30_ls_LinkageSection";
    ...
    public class SWEXEW30 : EABBase
    {
        ...
        public SWEXEW30()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW30");

            WS = new SWEXEW30_ws();
            FD = new SWEXEW30_fd(WS);
            LS = new SWEXEW30_ls();
        }
        ...
        private SWEXEW30_ws WS;

        //==== File Data Class ========================================
        private SWEXEW30_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW30_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1832517905(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1832517905
        /// </summary>
        private void M_MAIN_1832517905(string returnMethod = "")
        {
            M_PARA_1832517905_INIT("M_PARA_1832517905_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1832517905-INIT THRU PARA-1832517905-INIT-EXIT
            M_PARA_1832517905("M_PARA_1832517905_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1832517905 THRU PARA-1832517905-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1832517905
        /// </summary>
        private void M_PARA_1832517905(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF76 IS A PART OF SWEXEW30*
            //COMMENT: ******************************************
        ...
        {
            WS.RECOUT.SetValue(LS.RPT_DETAIL_0002);                                                             //COBOL==> MOVE RPT-DETAIL-0002 TO RECOUT
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1832517905_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832517905_EXIT
        /// </summary>
        private void M_PARA_1832517905_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832517905_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1832517905_EXIT") { M_PARA_1832517905_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832517905_INIT
        /// </summary>
        private void M_PARA_1832517905_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1832517905_INIT") { M_PARA_1832517905_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832517905_INIT_EXIT
        /// </summary>
        private void M_PARA_1832517905_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832517905_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
