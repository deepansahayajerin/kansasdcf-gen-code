...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:03 PM
   **        *   FROM COBOL PGM   :  SWEXEE30
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_WRITE_FIDM_INQUIRY_FILE   DATE: 2000/05/19
       TARGET OS:   MVS                       TIME: 10:29:00
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEE30_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEE30_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.EXTFILE_RECORD, FieldType.String, 99);
        ...
        #region Constructors
        public SWEXEE30_fd(SWEXEE30_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEE30_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEE30_ws_WorkingStorage";
            internal const string EXTFILE_STAT = "EXTFILE_STAT";
            internal const string WS_TOTAL_NO_INQUIRY_REC = "WS_TOTAL_NO_INQUIRY_REC";
            ...
            internal const string WS_EXTERNAL_FIDM_HEADER = "WS_EXTERNAL_FIDM_HEADER";
            internal const string RECORD_TYPE_HEADER = "RECORD_TYPE_HEADER";
            internal const string YYYYMM = "YYYYMM";
            internal const string DATA_MATCH_FI = "DATA_MATCH_FI";
            internal const string SPACES_2 = "SPACES_2";
            internal const string WS_EXTERNAL_FIDM_DETAIL = "WS_EXTERNAL_FIDM_DETAIL";
            internal const string RECORD_TYPE_DETAIL = "RECORD_TYPE_DETAIL";
            internal const string SSN = "SSN";
            internal const string SPACES_2_d2 = "SPACES_2_d2";
            internal const string LAST_NAME = "LAST_NAME";
            internal const string FIRST_NAME = "FIRST_NAME";
            internal const string CSE_PERSON_NO = "CSE_PERSON_NO";
            internal const string FIPS = "FIPS";
            internal const string SPACES_2_d3 = "SPACES_2_d3";
            internal const string WS_EXTERNAL_FIDM_TRAILER = "WS_EXTERNAL_FIDM_TRAILER";
            internal const string RECORD_TYPE_TRAILER = "RECORD_TYPE_TRAILER";
            internal const string TOTAL_NO_INQUIRY_REC = "TOTAL_NO_INQUIRY_REC";
            internal const string SPACES_2_d4 = "SPACES_2_d4";
        }
        #endregion

        #region Direct-access element properties
        public IField EXTFILE_STAT { get { return GetExternalElementByName<IField>(Names.EXTFILE_STAT); } }
        public IField WS_TOTAL_NO_INQUIRY_REC { get { return GetElementByName<IField>(Names.WS_TOTAL_NO_INQUIRY_REC); } }
        ...
        public IGroup WS_EXTERNAL_FIDM_HEADER { get { return GetElementByName<IGroup>(Names.WS_EXTERNAL_FIDM_HEADER); } }
        public IField RECORD_TYPE_HEADER { get { return GetElementByName<IField>(Names.RECORD_TYPE_HEADER); } }
        public IField YYYYMM { get { return GetElementByName<IField>(Names.YYYYMM); } }
        public IField DATA_MATCH_FI { get { return GetElementByName<IField>(Names.DATA_MATCH_FI); } }
        public IField SPACES_2 { get { return GetElementByName<IField>(Names.SPACES_2); } }
        public IGroup WS_EXTERNAL_FIDM_DETAIL { get { return GetElementByName<IGroup>(Names.WS_EXTERNAL_FIDM_DETAIL); } }
        public IField RECORD_TYPE_DETAIL { get { return GetElementByName<IField>(Names.RECORD_TYPE_DETAIL); } }
        public IField SSN { get { return GetElementByName<IField>(Names.SSN); } }
        public IField SPACES_2_d2 { get { return GetElementByName<IField>(Names.SPACES_2_d2); } }
        ...
        public IField CSE_PERSON_NO { get { return GetElementByName<IField>(Names.CSE_PERSON_NO); } }
        public IField FIPS { get { return GetElementByName<IField>(Names.FIPS); } }
        public IField SPACES_2_d3 { get { return GetElementByName<IField>(Names.SPACES_2_d3); } }
        public IGroup WS_EXTERNAL_FIDM_TRAILER { get { return GetElementByName<IGroup>(Names.WS_EXTERNAL_FIDM_TRAILER); } }
        public IField RECORD_TYPE_TRAILER { get { return GetElementByName<IField>(Names.RECORD_TYPE_TRAILER); } }
        public IField TOTAL_NO_INQUIRY_REC { get { return GetElementByName<IField>(Names.TOTAL_NO_INQUIRY_REC); } }
        public IField SPACES_2_d4 { get { return GetElementByName<IField>(Names.SPACES_2_d4); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewField(Names.WS_TOTAL_NO_INQUIRY_REC, FieldType.UnsignedNumeric, 10);
            ...
            recordDef.CreateNewGroup(Names.WS_MISC, (WS_MISC) =>
           {
            ...
            recordDef.CreateNewGroup(Names.WS_EXTERNAL_FIDM_HEADER, (WS_EXTERNAL_FIDM_HEADER) =>
           {
               WS_EXTERNAL_FIDM_HEADER.CreateNewField(Names.RECORD_TYPE_HEADER, FieldType.String, 1);
               WS_EXTERNAL_FIDM_HEADER.CreateNewField(Names.YYYYMM, FieldType.String, 6);
               WS_EXTERNAL_FIDM_HEADER.CreateNewField(Names.DATA_MATCH_FI, FieldType.String, 1);
               WS_EXTERNAL_FIDM_HEADER.CreateNewField(Names.SPACES_2, FieldType.String, 91);
           });

            recordDef.CreateNewGroup(Names.WS_EXTERNAL_FIDM_DETAIL, (WS_EXTERNAL_FIDM_DETAIL) =>
           {
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.RECORD_TYPE_DETAIL, FieldType.String, 1);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.SPACES_2_d2, FieldType.String, 10);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.LAST_NAME, FieldType.String, 20);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.FIRST_NAME, FieldType.String, 16);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.CSE_PERSON_NO, FieldType.String, 15);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.FIPS, FieldType.String, 5);
               WS_EXTERNAL_FIDM_DETAIL.CreateNewField(Names.SPACES_2_d3, FieldType.String, 23);
           });

            recordDef.CreateNewGroup(Names.WS_EXTERNAL_FIDM_TRAILER, (WS_EXTERNAL_FIDM_TRAILER) =>
           {
               WS_EXTERNAL_FIDM_TRAILER.CreateNewField(Names.RECORD_TYPE_TRAILER, FieldType.String, 1);
               WS_EXTERNAL_FIDM_TRAILER.CreateNewField(Names.TOTAL_NO_INQUIRY_REC, FieldType.UnsignedNumeric, 10);
               WS_EXTERNAL_FIDM_TRAILER.CreateNewField(Names.SPACES_2_d4, FieldType.String, 88);
           });
    ...
    internal class SWEXEE30_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEE30_ls_LinkageSection";
            ...
            internal const string EXTERNAL_FIDM_TRAILER_0001ET = "EXTERNAL_FIDM_TRAILER_0001ET";
            internal const string RECORD_TYPE_0001AS = "RECORD_TYPE_0001AS";
            internal const string RECORD_TYPE_0001 = "RECORD_TYPE_0001";
            internal const string RECORD_TYPE_0001XX = "RECORD_TYPE_0001XX";
            internal const string TOTAL_NO_INQUIRY_REC_0001AS = "TOTAL_NO_INQUIRY_REC_0001AS";
            internal const string TOTAL_NO_INQUIRY_REC_0001 = "TOTAL_NO_INQUIRY_REC_0001";
            internal const string TOTAL_NO_INQUIRY_REC_0001XX = "TOTAL_NO_INQUIRY_REC_0001XX";
            internal const string IMPORT_0002EV = "IMPORT_0002EV";
            internal const string EXTERNAL_FIDM_HEADER_0002ET = "EXTERNAL_FIDM_HEADER_0002ET";
            internal const string RECORD_TYPE_0002AS = "RECORD_TYPE_0002AS";
            internal const string RECORD_TYPE_0002 = "RECORD_TYPE_0002";
            internal const string RECORD_TYPE_0002XX = "RECORD_TYPE_0002XX";
            internal const string YYYYMM_0002AS = "YYYYMM_0002AS";
            internal const string YYYYMM_0002 = "YYYYMM_0002";
            internal const string YYYYMM_0002XX = "YYYYMM_0002XX";
            internal const string DATA_MATCH_FI_0002AS = "DATA_MATCH_FI_0002AS";
            internal const string DATA_MATCH_FI_0002 = "DATA_MATCH_FI_0002";
            internal const string DATA_MATCH_FI_0002XX = "DATA_MATCH_FI_0002XX";
            internal const string IMPORT_0003EV = "IMPORT_0003EV";
            internal const string EXTERNAL_FIDM_DETAIL_0003ET = "EXTERNAL_FIDM_DETAIL_0003ET";
            internal const string RECORD_TYPE_0003AS = "RECORD_TYPE_0003AS";
            internal const string RECORD_TYPE_0003 = "RECORD_TYPE_0003";
            internal const string RECORD_TYPE_0003XX = "RECORD_TYPE_0003XX";
            ...
            internal const string CSE_PERSON_NO_0003AS = "CSE_PERSON_NO_0003AS";
            internal const string CSE_PERSON_NO_0003 = "CSE_PERSON_NO_0003";
            internal const string CSE_PERSON_NO_0003XX = "CSE_PERSON_NO_0003XX";
            internal const string FIPS_0003AS = "FIPS_0003AS";
            internal const string FIPS_0003 = "FIPS_0003";
            internal const string FIPS_0003XX = "FIPS_0003XX";
        ...
        public IGroup EXTERNAL_FIDM_TRAILER_0001ET { get { return GetElementByName<IGroup>(Names.EXTERNAL_FIDM_TRAILER_0001ET); } }
        public IField RECORD_TYPE_0001AS { get { return GetElementByName<IField>(Names.RECORD_TYPE_0001AS); } }
        public IField RECORD_TYPE_0001 { get { return GetElementByName<IField>(Names.RECORD_TYPE_0001); } }
        public IField RECORD_TYPE_0001XX { get { return GetElementByName<IField>(Names.RECORD_TYPE_0001XX); } }
        public IField TOTAL_NO_INQUIRY_REC_0001AS { get { return GetElementByName<IField>(Names.TOTAL_NO_INQUIRY_REC_0001AS); } }
        public IField TOTAL_NO_INQUIRY_REC_0001 { get { return GetElementByName<IField>(Names.TOTAL_NO_INQUIRY_REC_0001); } }
        public IField TOTAL_NO_INQUIRY_REC_0001XX { get { return GetElementByName<IField>(Names.TOTAL_NO_INQUIRY_REC_0001XX); } }
        public IGroup IMPORT_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_0002EV); } }
        public IGroup EXTERNAL_FIDM_HEADER_0002ET { get { return GetElementByName<IGroup>(Names.EXTERNAL_FIDM_HEADER_0002ET); } }
        public IField RECORD_TYPE_0002AS { get { return GetElementByName<IField>(Names.RECORD_TYPE_0002AS); } }
        public IField RECORD_TYPE_0002 { get { return GetElementByName<IField>(Names.RECORD_TYPE_0002); } }
        public IField RECORD_TYPE_0002XX { get { return GetElementByName<IField>(Names.RECORD_TYPE_0002XX); } }
        public IField YYYYMM_0002AS { get { return GetElementByName<IField>(Names.YYYYMM_0002AS); } }
        public IField YYYYMM_0002 { get { return GetElementByName<IField>(Names.YYYYMM_0002); } }
        public IField YYYYMM_0002XX { get { return GetElementByName<IField>(Names.YYYYMM_0002XX); } }
        public IField DATA_MATCH_FI_0002AS { get { return GetElementByName<IField>(Names.DATA_MATCH_FI_0002AS); } }
        public IField DATA_MATCH_FI_0002 { get { return GetElementByName<IField>(Names.DATA_MATCH_FI_0002); } }
        public IField DATA_MATCH_FI_0002XX { get { return GetElementByName<IField>(Names.DATA_MATCH_FI_0002XX); } }
        public IGroup IMPORT_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_0003EV); } }
        public IGroup EXTERNAL_FIDM_DETAIL_0003ET { get { return GetElementByName<IGroup>(Names.EXTERNAL_FIDM_DETAIL_0003ET); } }
        public IField RECORD_TYPE_0003AS { get { return GetElementByName<IField>(Names.RECORD_TYPE_0003AS); } }
        public IField RECORD_TYPE_0003 { get { return GetElementByName<IField>(Names.RECORD_TYPE_0003); } }
        public IField RECORD_TYPE_0003XX { get { return GetElementByName<IField>(Names.RECORD_TYPE_0003XX); } }
        ...
        public IField CSE_PERSON_NO_0003AS { get { return GetElementByName<IField>(Names.CSE_PERSON_NO_0003AS); } }
        public IField CSE_PERSON_NO_0003 { get { return GetElementByName<IField>(Names.CSE_PERSON_NO_0003); } }
        public IField CSE_PERSON_NO_0003XX { get { return GetElementByName<IField>(Names.CSE_PERSON_NO_0003XX); } }
        public IField FIPS_0003AS { get { return GetElementByName<IField>(Names.FIPS_0003AS); } }
        public IField FIPS_0003 { get { return GetElementByName<IField>(Names.FIPS_0003); } }
        public IField FIPS_0003XX { get { return GetElementByName<IField>(Names.FIPS_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.EXTERNAL_FIDM_TRAILER_0001ET, (EXTERNAL_FIDM_TRAILER_0001ET) =>
               {
                   EXTERNAL_FIDM_TRAILER_0001ET.CreateNewField(Names.RECORD_TYPE_0001AS, FieldType.String, 1);

                   IField RECORD_TYPE_0001_local = EXTERNAL_FIDM_TRAILER_0001ET.CreateNewField(Names.RECORD_TYPE_0001, FieldType.String, 1);
                   EXTERNAL_FIDM_TRAILER_0001ET.CreateNewFieldRedefine(Names.RECORD_TYPE_0001XX, FieldType.String, RECORD_TYPE_0001_local, 1);
                   EXTERNAL_FIDM_TRAILER_0001ET.CreateNewField(Names.TOTAL_NO_INQUIRY_REC_0001AS, FieldType.String, 1);

                   IField TOTAL_NO_INQUIRY_REC_0001_local = EXTERNAL_FIDM_TRAILER_0001ET.CreateNewField(Names.TOTAL_NO_INQUIRY_REC_0001, FieldType.SignedNumeric, 10);
                   EXTERNAL_FIDM_TRAILER_0001ET.CreateNewFieldRedefine(Names.TOTAL_NO_INQUIRY_REC_0001XX, FieldType.String, TOTAL_NO_INQUIRY_REC_0001_local, 10);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
               IMPORT_0002EV.CreateNewGroup(Names.EXTERNAL_FIDM_HEADER_0002ET, (EXTERNAL_FIDM_HEADER_0002ET) =>
               {
                   EXTERNAL_FIDM_HEADER_0002ET.CreateNewField(Names.RECORD_TYPE_0002AS, FieldType.String, 1);

                   IField RECORD_TYPE_0002_local = EXTERNAL_FIDM_HEADER_0002ET.CreateNewField(Names.RECORD_TYPE_0002, FieldType.String, 1);
                   EXTERNAL_FIDM_HEADER_0002ET.CreateNewFieldRedefine(Names.RECORD_TYPE_0002XX, FieldType.String, RECORD_TYPE_0002_local, 1);
                   EXTERNAL_FIDM_HEADER_0002ET.CreateNewField(Names.YYYYMM_0002AS, FieldType.String, 1);

                   IField YYYYMM_0002_local = EXTERNAL_FIDM_HEADER_0002ET.CreateNewField(Names.YYYYMM_0002, FieldType.String, 6);
                   EXTERNAL_FIDM_HEADER_0002ET.CreateNewFieldRedefine(Names.YYYYMM_0002XX, FieldType.String, YYYYMM_0002_local, 6);
                   EXTERNAL_FIDM_HEADER_0002ET.CreateNewField(Names.DATA_MATCH_FI_0002AS, FieldType.String, 1);

                   IField DATA_MATCH_FI_0002_local = EXTERNAL_FIDM_HEADER_0002ET.CreateNewField(Names.DATA_MATCH_FI_0002, FieldType.String, 1);
                   EXTERNAL_FIDM_HEADER_0002ET.CreateNewFieldRedefine(Names.DATA_MATCH_FI_0002XX, FieldType.String, DATA_MATCH_FI_0002_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0003EV, (IMPORT_0003EV) =>
           {
               IMPORT_0003EV.CreateNewGroup(Names.EXTERNAL_FIDM_DETAIL_0003ET, (EXTERNAL_FIDM_DETAIL_0003ET) =>
               {
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.RECORD_TYPE_0003AS, FieldType.String, 1);

                   IField RECORD_TYPE_0003_local = EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.RECORD_TYPE_0003, FieldType.String, 1);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewFieldRedefine(Names.RECORD_TYPE_0003XX, FieldType.String, RECORD_TYPE_0003_local, 1);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.SSN_0003AS, FieldType.String, 1);

                   IField SSN_0003_local = EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.SSN_0003, FieldType.String, 9);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewFieldRedefine(Names.SSN_0003XX, FieldType.String, SSN_0003_local, 9);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.LAST_NAME_0003AS, FieldType.String, 1);

                   IField LAST_NAME_0003_local = EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.LAST_NAME_0003, FieldType.String, 20);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewFieldRedefine(Names.LAST_NAME_0003XX, FieldType.String, LAST_NAME_0003_local, 20);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.FIRST_NAME_0003AS, FieldType.String, 1);

                   IField FIRST_NAME_0003_local = EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.FIRST_NAME_0003, FieldType.String, 16);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewFieldRedefine(Names.FIRST_NAME_0003XX, FieldType.String, FIRST_NAME_0003_local, 16);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.CSE_PERSON_NO_0003AS, FieldType.String, 1);

                   IField CSE_PERSON_NO_0003_local = EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.CSE_PERSON_NO_0003, FieldType.String, 15);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewFieldRedefine(Names.CSE_PERSON_NO_0003XX, FieldType.String, CSE_PERSON_NO_0003_local, 15);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.FIPS_0003AS, FieldType.String, 1);

                   IField FIPS_0003_local = EXTERNAL_FIDM_DETAIL_0003ET.CreateNewField(Names.FIPS_0003, FieldType.String, 5);
                   EXTERNAL_FIDM_DETAIL_0003ET.CreateNewFieldRedefine(Names.FIPS_0003XX, FieldType.String, FIPS_0003_local, 5);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0004EV, (IMPORT_0004EV) =>
           {
               IMPORT_0004EV.CreateNewGroup(Names.EXTERNAL_0004ET, (EXTERNAL_0004ET) =>
               {
    ...
    public class SWEXEE30 : EABBase
    {
        ...
        public SWEXEE30()
            : base()
        {
            this.ProgramName.SetValue("SWEXEE30");

            WS = new SWEXEE30_ws();
            FD = new SWEXEE30_fd(WS);
            LS = new SWEXEE30_ls();
        }
        ...
        private SWEXEE30_ws WS;

        //==== File Data Class ========================================
        private SWEXEE30_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEE30_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0003EV , IMPORT-0004EV , EXPORT-0005EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1901854885(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1901854885
        /// </summary>
        private void M_MAIN_1901854885(string returnMethod = "")
        {
            M_PARA_1901854885_INIT("M_PARA_1901854885_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1901854885-INIT THRU PARA-1901854885-INIT-EXIT
            M_PARA_1901854885("M_PARA_1901854885_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1901854885 THRU PARA-1901854885-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1901854885
        /// </summary>
        private void M_PARA_1901854885(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:     *******************************************
            //COMMENT:     THIS CODE SWCSZ100 IS A PART OF SWEEXEE30 *
            //COMMENT:     OE_EAB_WRITE_FIDM_INQUIRY                 *
            //COMMENT:     *******************************************
            LS.TEXT_RETURN_CODE_0005.SetValueWithSpaces();                                                      //COBOL==> MOVE SPACES TO TEXT-RETURN-CODE-0005.
            LS.NUMERIC_RETURN_CODE_0005.SetValue(ZEROES);                                                       //COBOL==> MOVE ZEROES TO NUMERIC-RETURN-CODE-0005.
            LS.FILE_INSTRUCTION_0005.SetValue(LS.FILE_INSTRUCTION_0004);                                        //COBOL==> MOVE FILE-INSTRUCTION-0004 TO FILE-INSTRUCTION-0005.
            if (returnMethod != "" && returnMethod != "M_PARA_1901854885") { M_1000_EAB_CODE_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            if (LS.FILE_INSTRUCTION_0004.IsEqualTo("OPEN"))                                                     //COBOL==> IF FILE-INSTRUCTION-0004 = 'OPEN'
            {
            ...
            if (LS.FILE_INSTRUCTION_0004.IsEqualTo("WRITEH"))                                                   //COBOL==> IF FILE-INSTRUCTION-0004 = 'WRITEH'
            {
                M_1300_WRITE_HEADER_FILE("M_1300_EXIT"); if (Control.ExitProgram) { return; }                         //COBOL==> PERFORM 1300-WRITE-HEADER-FILE THRU 1300-EXIT
                M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT
            }                                                                                                   //COBOL==> END-IF.
            if (LS.FILE_INSTRUCTION_0004.IsEqualTo("WRITED"))                                                   //COBOL==> IF FILE-INSTRUCTION-0004 = 'WRITED'
            {
                M_1301_WRITE_DETAIL_FILE("M_1301_EXIT"); if (Control.ExitProgram) { return; }                         //COBOL==> PERFORM 1301-WRITE-DETAIL-FILE THRU 1301-EXIT
                M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT
            }                                                                                                   //COBOL==> END-IF.
            if (LS.FILE_INSTRUCTION_0004.IsEqualTo("WRITET"))                                                   //COBOL==> IF FILE-INSTRUCTION-0004 = 'WRITET'
            {
                M_1302_WRITE_TRAILER_FILE("M_1302_EXIT"); if (Control.ExitProgram) { return; }                        //COBOL==> PERFORM 1302-WRITE-TRAILER-FILE THRU 1302-EXIT
                M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT
            }                                                                                                   //COBOL==> END-IF.
            if (LS.FILE_INSTRUCTION_0004.IsEqualTo("CLOSE"))                                                    //COBOL==> IF FILE-INSTRUCTION-0004 = 'CLOSE'
            {
                M_1400_CLOSE_FILE("M_1400_EXIT"); if (Control.ExitProgram) { return; }                                //COBOL==> PERFORM 1400-CLOSE-FILE THRU 1400-EXIT
                M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT
            }                                                                                                   //COBOL==> END-IF.
            LS.TEXT_RETURN_CODE_0005.SetValue("FN");                                                            //COBOL==> MOVE 'FN' TO TEXT-RETURN-CODE-0005.
            LS.NUMERIC_RETURN_CODE_0005.SetValue(1);                                                            //COBOL==> MOVE 1 TO NUMERIC-RETURN-CODE-0005.
            M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT.
        }
        /// <summary>
        ...
        private void M_1100_OPEN_FILE(string returnMethod = "")
        {
            ...
            if (!(WS.EXTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF EXTFILE-STAT NOT = 0
            {
                ...
                LS.NUMERIC_RETURN_CODE_0005.SetValue(WS.EXTFILE_STAT);                                              //COBOL==> MOVE EXTFILE-STAT TO NUMERIC-RETURN-CODE-0005
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_1100_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1100_EXIT") { M_1300_WRITE_HEADER_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1300_WRITE_HEADER_FILE
        /// </summary>
        /// <remarks>
        ///COMMENT: *****************************************************
        ///COMMENT:     WRITE HEADER RECORD TO THE OUTPUT FILE          *
        ///COMMENT: *****************************************************
        /// </remarks>
        private void M_1300_WRITE_HEADER_FILE(string returnMethod = "")
        {
            WS.WS_EXTERNAL_FIDM_HEADER.SetValueWithSpaces();                                                    //COBOL==> MOVE SPACES TO WS-EXTERNAL-FIDM-HEADER.
            WS.RECORD_TYPE_HEADER.SetValue(LS.RECORD_TYPE_0002);                                                //COBOL==> MOVE RECORD-TYPE-0002 TO RECORD-TYPE-HEADER.
            WS.YYYYMM.SetValue(LS.YYYYMM_0002);                                                                 //COBOL==> MOVE YYYYMM-0002 TO YYYYMM.
            WS.DATA_MATCH_FI.SetValue(LS.DATA_MATCH_FI_0002);                                                   //COBOL==> MOVE DATA-MATCH-FI-0002 TO DATA-MATCH-FI.
            FD.EXTFILE_RECORD.SetValue(WS.WS_EXTERNAL_FIDM_HEADER);                                             //COBOL==> MOVE WS-EXTERNAL-FIDM-HEADER TO EXTFILE-RECORD.
            FD.EXTFILE.WriteLine(FD.EXTFILE_RECORD.AsBytes);                                                    //COBOL==> WRITE EXTFILE-RECORD.
            if (!(WS.EXTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF EXTFILE-STAT NOT = 0
            {
                LS.TEXT_RETURN_CODE_0005.SetValue("WD");                                                            //COBOL==> MOVE 'WD' TO TEXT-RETURN-CODE-0005
                LS.NUMERIC_RETURN_CODE_0005.SetValue(WS.EXTFILE_STAT);                                              //COBOL==> MOVE EXTFILE-STAT TO NUMERIC-RETURN-CODE-0005
                WS.WS_RECORD_COUNT.Add(1);                                                                          //COBOL==> ADD 1 TO WS-RECORD-COUNT
            }                                                                                                   //COBOL==> END-IF.
            if (returnMethod != "" && returnMethod != "M_1300_WRITE_HEADER_FILE") { M_1300_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1300_EXIT
        /// </summary>
        private void M_1300_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1300_EXIT") { M_1301_WRITE_DETAIL_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            WS.WS_EXTERNAL_FIDM_DETAIL.SetValueWithSpaces();                                                    //COBOL==> MOVE SPACES TO WS-EXTERNAL-FIDM-DETAIL.
            WS.RECORD_TYPE_DETAIL.SetValue(LS.RECORD_TYPE_0003);                                                //COBOL==> MOVE RECORD-TYPE-0003 TO RECORD-TYPE-DETAIL.
            WS.SSN.SetValue(LS.SSN_0003);                                                                       //COBOL==> MOVE SSN-0003 TO SSN.
            WS.LAST_NAME.SetValue(LS.LAST_NAME_0003);                                                           //COBOL==> MOVE LAST-NAME-0003 TO LAST-NAME.
            WS.FIRST_NAME.SetValue(LS.FIRST_NAME_0003);                                                         //COBOL==> MOVE FIRST-NAME-0003 TO FIRST-NAME.
            WS.CSE_PERSON_NO.SetValue(LS.CSE_PERSON_NO_0003);                                                   //COBOL==> MOVE CSE-PERSON-NO-0003 TO CSE-PERSON-NO.
            WS.FIPS.SetValue(LS.FIPS_0003);                                                                     //COBOL==> MOVE FIPS-0003 TO FIPS.
            FD.EXTFILE_RECORD.SetValue(WS.WS_EXTERNAL_FIDM_DETAIL);                                             //COBOL==> MOVE WS-EXTERNAL-FIDM-DETAIL TO EXTFILE-RECORD.
            FD.EXTFILE.WriteLine(FD.EXTFILE_RECORD.AsBytes);                                                    //COBOL==> WRITE EXTFILE-RECORD.
            if (!(WS.EXTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF EXTFILE-STAT NOT = 0
            {
                LS.TEXT_RETURN_CODE_0005.SetValue("WD");                                                            //COBOL==> MOVE 'WD' TO TEXT-RETURN-CODE-0005
            ...
            WS.WS_TOTAL_NO_INQUIRY_REC.Add(1);                                                                  //COBOL==> ADD 1 TO WS-TOTAL-NO-INQUIRY-REC.
        ...
        /// </summary>
        /// <remarks>
        ///COMMENT:     DISPLAY 'TOTAL-NO-INQUIRY-REC :' WS-TOTAL-NO-INQUIRY-REC.
        /// </remarks>
        private void M_1301_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_1301_EXIT") { return; }                                                      //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_1301_EXIT") { M_1302_WRITE_TRAILER_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1302_WRITE_TRAILER_FILE
        /// </summary>
        /// <remarks>
        ///COMMENT: *****************************************************
        ///COMMENT:     WRITE TRAILER RECORD TO THE OUTPUT FILE         *
        ///COMMENT: *****************************************************
        /// </remarks>
        private void M_1302_WRITE_TRAILER_FILE(string returnMethod = "")
        {
            WS.WS_EXTERNAL_FIDM_TRAILER.SetValueWithSpaces();                                                   //COBOL==> MOVE SPACES TO WS-EXTERNAL-FIDM-TRAILER.
            WS.TOTAL_NO_INQUIRY_REC.SetValueWithZeroes();                                                       //COBOL==> MOVE ZEROS TO TOTAL-NO-INQUIRY-REC.
            WS.RECORD_TYPE_TRAILER.SetValue(LS.RECORD_TYPE_0001);                                               //COBOL==> MOVE RECORD-TYPE-0001 TO RECORD-TYPE-TRAILER.
            WS.TOTAL_NO_INQUIRY_REC.SetValue(WS.WS_TOTAL_NO_INQUIRY_REC);                                       //COBOL==> MOVE WS-TOTAL-NO-INQUIRY-REC TO TOTAL-NO-INQUIRY-REC.
                                                                                                                //COMMENT:     MOVE TOTAL-NO-INQUIRY-REC-0001  TO TOTAL-NO-INQUIRY-REC.
            FD.EXTFILE_RECORD.SetValue(WS.WS_EXTERNAL_FIDM_TRAILER);                                            //COBOL==> MOVE WS-EXTERNAL-FIDM-TRAILER TO EXTFILE-RECORD.
            FD.EXTFILE.WriteLine(FD.EXTFILE_RECORD.AsBytes);                                                    //COBOL==> WRITE EXTFILE-RECORD.
            if (!(WS.EXTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF EXTFILE-STAT NOT = 0
            {
                LS.TEXT_RETURN_CODE_0005.SetValue("WD");                                                            //COBOL==> MOVE 'WD' TO TEXT-RETURN-CODE-0005
            ...
            if (returnMethod != "" && returnMethod != "M_1302_WRITE_TRAILER_FILE") { M_1302_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1302_EXIT
        /// </summary>
        private void M_1302_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1302_EXIT") { M_1400_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_EXIT") { M_PARA_1901854885_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1901854885_EXIT
        /// </summary>
        private void M_PARA_1901854885_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1901854885_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1901854885_EXIT") { M_PARA_1901854885_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1901854885_INIT
        /// </summary>
        private void M_PARA_1901854885_INIT(string returnMethod = "")
        {
            LS.EXPORT_0005EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0005EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1901854885_INIT") { M_PARA_1901854885_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1901854885_INIT_EXIT
        /// </summary>
        private void M_PARA_1901854885_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1901854885_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
