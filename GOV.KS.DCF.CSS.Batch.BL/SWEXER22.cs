...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:08 PM
   **        *   FROM COBOL PGM   :  SWEXER22
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: EAB_READ_EIWO_EMPLOYER           DATE: 2015/06/11
       TARGET OS:   MVS                       TIME: 10:38:35
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXER22_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER22_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.EMPLIN_RECORD, FieldType.String, 600);
        ...
        #region Constructors
        public SWEXER22_fd(SWEXER22_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER22_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER22_ws_WorkingStorage";
            ...
            internal const string FEIN = "FEIN";
            internal const string START_DATE = "START_DATE";
            internal const string ORGAN_NAME = "ORGAN_NAME";
            internal const string ADDRESS_LINE1 = "ADDRESS_LINE1";
            internal const string ADDRESS_LINE2 = "ADDRESS_LINE2";
            ...
            internal const string ZIP_PLUS_5 = "ZIP_PLUS_5";
            internal const string ZIP_PLUS_FORMAT1 = "ZIP_PLUS_FORMAT1";
            internal const string ZIP_HYPHEN = "ZIP_HYPHEN";
            internal const string ZIP_PLUS_FOUR1 = "ZIP_PLUS_FOUR1";
            internal const string ZIP_PLUS_FORMAT2 = "ZIP_PLUS_FORMAT2";
            internal const string ZIP_PLUS_FOUR2 = "ZIP_PLUS_FOUR2";
            internal const string CONTACT_NAME = "CONTACT_NAME";
            internal const string PHONE_NUMBER = "PHONE_NUMBER";
            internal const string AREA_CODE = "AREA_CODE";
            internal const string PHONE = "PHONE";
            internal const string EXTENSION = "EXTENSION";
            internal const string EMAIL = "EMAIL";
            internal const string ALT_ADDRESS_LINE1 = "ALT_ADDRESS_LINE1";
            internal const string ALT_ADDRESS_LINE2 = "ALT_ADDRESS_LINE2";
            internal const string ALT_CITY = "ALT_CITY";
            internal const string ALT_STATE = "ALT_STATE";
            internal const string ALT_POSTAL_CODE = "ALT_POSTAL_CODE";
            internal const string ACTIVE_INACTIVE_IND = "ACTIVE_INACTIVE_IND";
            internal const string INACTIVE_DATE = "INACTIVE_DATE";
            internal const string YEAR1 = "YEAR1";
            internal const string MONTH1 = "MONTH1";
            internal const string DAY1 = "DAY1";
            internal const string ORGAN_KNOWN_AS = "ORGAN_KNOWN_AS";
        }
        #endregion
        ...
        public IField FEIN { get { return GetElementByName<IField>(Names.FEIN); } }
        public IField START_DATE { get { return GetElementByName<IField>(Names.START_DATE); } }
        public IField ORGAN_NAME { get { return GetElementByName<IField>(Names.ORGAN_NAME); } }
        public IField ADDRESS_LINE1 { get { return GetElementByName<IField>(Names.ADDRESS_LINE1); } }
        public IField ADDRESS_LINE2 { get { return GetElementByName<IField>(Names.ADDRESS_LINE2); } }
        ...
        public IGroup POSTAL_CODE { get { return GetElementByName<IGroup>(Names.POSTAL_CODE); } }
        public IField ZIP_CODE { get { return GetElementByName<IField>(Names.ZIP_CODE); } }
        public IField ZIP_PLUS_5 { get { return GetElementByName<IField>(Names.ZIP_PLUS_5); } }
        public IGroup ZIP_PLUS_FORMAT1 { get { return GetElementByName<IGroup>(Names.ZIP_PLUS_FORMAT1); } }
        public IField ZIP_HYPHEN { get { return GetElementByName<IField>(Names.ZIP_HYPHEN); } }
        public IField ZIP_PLUS_FOUR1 { get { return GetElementByName<IField>(Names.ZIP_PLUS_FOUR1); } }
        public IGroup ZIP_PLUS_FORMAT2 { get { return GetElementByName<IGroup>(Names.ZIP_PLUS_FORMAT2); } }
        public IField ZIP_PLUS_FOUR2 { get { return GetElementByName<IField>(Names.ZIP_PLUS_FOUR2); } }
        public IField CONTACT_NAME { get { return GetElementByName<IField>(Names.CONTACT_NAME); } }
        public IGroup PHONE_NUMBER { get { return GetElementByName<IGroup>(Names.PHONE_NUMBER); } }
        public IField AREA_CODE { get { return GetElementByName<IField>(Names.AREA_CODE); } }
        public IField PHONE { get { return GetElementByName<IField>(Names.PHONE); } }
        public IField EXTENSION { get { return GetElementByName<IField>(Names.EXTENSION); } }
        public IField EMAIL { get { return GetElementByName<IField>(Names.EMAIL); } }
        public IField ALT_ADDRESS_LINE1 { get { return GetElementByName<IField>(Names.ALT_ADDRESS_LINE1); } }
        public IField ALT_ADDRESS_LINE2 { get { return GetElementByName<IField>(Names.ALT_ADDRESS_LINE2); } }
        public IField ALT_CITY { get { return GetElementByName<IField>(Names.ALT_CITY); } }
        public IField ALT_STATE { get { return GetElementByName<IField>(Names.ALT_STATE); } }
        public IField ALT_POSTAL_CODE { get { return GetElementByName<IField>(Names.ALT_POSTAL_CODE); } }
        public IField ACTIVE_INACTIVE_IND { get { return GetElementByName<IField>(Names.ACTIVE_INACTIVE_IND); } }
        public IGroup INACTIVE_DATE { get { return GetElementByName<IGroup>(Names.INACTIVE_DATE); } }
        public IField YEAR1 { get { return GetElementByName<IField>(Names.YEAR1); } }
        public IField MONTH1 { get { return GetElementByName<IField>(Names.MONTH1); } }
        public IField DAY1 { get { return GetElementByName<IField>(Names.DAY1); } }
        public IField ORGAN_KNOWN_AS { get { return GetElementByName<IField>(Names.ORGAN_KNOWN_AS); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_EMPLIN.CreateNewField(Names.FEIN, FieldType.UnsignedNumeric, 9);
               WS_EMPLIN.CreateNewField(Names.START_DATE, FieldType.String, 10);
               WS_EMPLIN.CreateNewField(Names.ORGAN_NAME, FieldType.String, 65);
               WS_EMPLIN.CreateNewField(Names.ADDRESS_LINE1, FieldType.String, 40);
               WS_EMPLIN.CreateNewField(Names.ADDRESS_LINE2, FieldType.String, 40);
               WS_EMPLIN.CreateNewField(Names.CITY, FieldType.String, 25);
               WS_EMPLIN.CreateNewField(Names.STATE, FieldType.String, 2);
               WS_EMPLIN.CreateNewGroup(Names.POSTAL_CODE, (POSTAL_CODE) =>
               {
                   POSTAL_CODE.CreateNewField(Names.ZIP_CODE, FieldType.String, 5);

                   IField ZIP_PLUS_5_local = POSTAL_CODE.CreateNewField(Names.ZIP_PLUS_5, FieldType.String, 5);
                   POSTAL_CODE.CreateNewGroupRedefine(Names.ZIP_PLUS_FORMAT1, ZIP_PLUS_5_local, (ZIP_PLUS_FORMAT1) =>
                   {
                       ZIP_PLUS_FORMAT1.CreateNewField(Names.ZIP_HYPHEN, FieldType.String, 1);
                       ZIP_PLUS_FORMAT1.CreateNewField(Names.ZIP_PLUS_FOUR1, FieldType.String, 4);
                   });
                   POSTAL_CODE.CreateNewGroupRedefine(Names.ZIP_PLUS_FORMAT2, ZIP_PLUS_5_local, (ZIP_PLUS_FORMAT2) =>
                   {
                       ZIP_PLUS_FORMAT2.CreateNewField(Names.ZIP_PLUS_FOUR2, FieldType.String, 4);
                       ZIP_PLUS_FORMAT2.CreateNewFillerField(1, FillWith.Hashes);
                   });
               });
               WS_EMPLIN.CreateNewField(Names.CONTACT_NAME, FieldType.String, 40);
               WS_EMPLIN.CreateNewGroup(Names.PHONE_NUMBER, (PHONE_NUMBER) =>
               {
                   PHONE_NUMBER.CreateNewField(Names.AREA_CODE, FieldType.String, 3);
                   PHONE_NUMBER.CreateNewField(Names.PHONE, FieldType.String, 7);
               });
               WS_EMPLIN.CreateNewField(Names.EXTENSION, FieldType.UnsignedNumeric, 5);
               WS_EMPLIN.CreateNewField(Names.EMAIL, FieldType.String, 65);
               WS_EMPLIN.CreateNewField(Names.ALT_ADDRESS_LINE1, FieldType.String, 40);
               WS_EMPLIN.CreateNewField(Names.ALT_ADDRESS_LINE2, FieldType.String, 40);
               WS_EMPLIN.CreateNewField(Names.ALT_CITY, FieldType.String, 25);
               WS_EMPLIN.CreateNewField(Names.ALT_STATE, FieldType.String, 2);
               WS_EMPLIN.CreateNewField(Names.ALT_POSTAL_CODE, FieldType.String, 10);
               WS_EMPLIN.CreateNewField(Names.ACTIVE_INACTIVE_IND, FieldType.String, 1);
               WS_EMPLIN.CreateNewGroup(Names.INACTIVE_DATE, (INACTIVE_DATE) =>
               {
                   INACTIVE_DATE.CreateNewField(Names.YEAR1, FieldType.String, 4);
                   INACTIVE_DATE.CreateNewFillerField(FieldType.String, 1, "-");
                   INACTIVE_DATE.CreateNewField(Names.MONTH1, FieldType.String, 2);
                   INACTIVE_DATE.CreateNewFillerField(FieldType.String, 1, "-");
                   INACTIVE_DATE.CreateNewField(Names.DAY1, FieldType.String, 2);
               });
               WS_EMPLIN.CreateNewField(Names.ORGAN_KNOWN_AS, FieldType.String, 65);
               WS_EMPLIN.CreateNewFillerField(86, FillWith.Hashes);
           });
    ...
    internal class SWEXER22_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER22_ls_LinkageSection";
            ...
            internal const string EIWO_END_DATE_0002AS = "EIWO_END_DATE_0002AS";
            internal const string EIWO_END_DATE_0002 = "EIWO_END_DATE_0002";
            internal const string EIWO_END_DATE_0002XX = "EIWO_END_DATE_0002XX";
            ...
            internal const string EXPORT_ACTIVE_IND_0004EV = "EXPORT_ACTIVE_IND_0004EV";
            ...
            internal const string EXTERNAL_0005EV = "EXTERNAL_0005EV";
        ...
        public IField PHONE_NO_0002XX { get { return GetElementByName<IField>(Names.PHONE_NO_0002XX); } }
        ...
        public IField EIWO_END_DATE_0002AS { get { return GetElementByName<IField>(Names.EIWO_END_DATE_0002AS); } }
        public IField EIWO_END_DATE_0002 { get { return GetElementByName<IField>(Names.EIWO_END_DATE_0002); } }
        public IField EIWO_END_DATE_0002XX { get { return GetElementByName<IField>(Names.EIWO_END_DATE_0002XX); } }
        ...
        public IGroup EXPORT_ACTIVE_IND_0004EV { get { return GetElementByName<IGroup>(Names.EXPORT_ACTIVE_IND_0004EV); } }
        ...
        public IGroup EXTERNAL_0005EV { get { return GetElementByName<IGroup>(Names.EXTERNAL_0005EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.EMPLOYER_0002ET, (EMPLOYER_0002ET) =>
               {
                   ...
                   EMPLOYER_0002ET.CreateNewFieldRedefine(Names.PHONE_NO_0002XX, FieldType.String, PHONE_NO_0002_local, 7);
                   ...
                   EMPLOYER_0002ET.CreateNewField(Names.EIWO_END_DATE_0002AS, FieldType.String, 1);

                   IField EIWO_END_DATE_0002_local = EMPLOYER_0002ET.CreateNewField(Names.EIWO_END_DATE_0002, FieldType.SignedNumeric, 8);
                   EMPLOYER_0002ET.CreateNewFieldRedefine(Names.EIWO_END_DATE_0002XX, FieldType.String, EIWO_END_DATE_0002_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0003EV, (EXPORT_0003EV) =>
           {
               EXPORT_0003EV.CreateNewGroup(Names.EMPLOYER_ADDRESS_0003ET, (EMPLOYER_ADDRESS_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_ACTIVE_IND_0004EV, (EXPORT_ACTIVE_IND_0004EV) =>
           {
               EXPORT_ACTIVE_IND_0004EV.CreateNewGroup(Names.WORK_AREA_0004ET, (WORK_AREA_0004ET) =>
               {
                   WORK_AREA_0004ET.CreateNewField(Names.TEXT_1_0004AS, FieldType.String, 1);

                   IField TEXT_1_0004_local = WORK_AREA_0004ET.CreateNewField(Names.TEXT_1_0004, FieldType.String, 1);
                   WORK_AREA_0004ET.CreateNewFieldRedefine(Names.TEXT_1_0004XX, FieldType.String, TEXT_1_0004_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.EXTERNAL_0005EV, (EXTERNAL_0005EV) =>
           {
               EXTERNAL_0005EV.CreateNewGroup(Names.EXTERNAL_0005ET, (EXTERNAL_0005ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_ACTIVE_IND_0004EV, args, 6);
            SetPassedParm(EXTERNAL_0005EV, args, 7);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_ACTIVE_IND_0004EV, args, 6);
            SetReturnParm(EXTERNAL_0005EV, args, 7);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXER22 : EABBase
    {
        ...
        public SWEXER22()
            : base()
        {
            this.ProgramName.SetValue("SWEXER22");

            WS = new SWEXER22_ws();
            FD = new SWEXER22_fd(WS);
            LS = new SWEXER22_ls();
        }
        ...
        private SWEXER22_ws WS;

        //==== File Data Class ========================================
        private SWEXER22_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER22_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-ACTIVE-IND-0004EV , EXTERNAL-0005EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1832406365(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1832406365
        /// </summary>
        private void M_MAIN_1832406365(string returnMethod = "")
        {
            M_PARA_1832406365_INIT("M_PARA_1832406365_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1832406365-INIT THRU PARA-1832406365-INIT-EXIT
            M_PARA_1832406365("M_PARA_1832406365_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1832406365 THRU PARA-1832406365-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1832406365
        /// </summary>
        private void M_PARA_1832406365(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF64 IS A PART OF SWEXER22*
            //COMMENT: ******************************************
        ...
        private void M_0100_OPEN(string returnMethod = "")
        {
            ...
            {
                LS.NUMERIC_RETURN_CODE_0005.SetValue(WS.EMPLIN_STAT);                                               //COBOL==> MOVE EMPLIN-STAT TO NUMERIC-RETURN-CODE-0005
            }                                                                                                   //COBOL==> ELSE
            else
            {
        ...
        private void M_0500_PROCESS_TRANS(string returnMethod = "")
        {
            ...
            {
                LS.TEXT_LINE_80_0005.SetValue("REACHED END OF EMPLIN EXTRACT FILE");                                //COBOL==> MOVE 'REACHED END OF EMPLIN EXTRACT FILE' TO TEXT-LINE-80-0005
            ...
            LS.EIN_0002.SetValue(WS.FEIN);                                                                      //COBOL==> MOVE FEIN TO EIN-0002
            LS.NAME_0002.SetValue(WS.ORGAN_NAME);                                                               //COBOL==> MOVE ORGAN-NAME TO NAME-0002
            LS.STREET1_0003.SetValue(WS.ADDRESS_LINE1);                                                         //COBOL==> MOVE ADDRESS-LINE1 TO STREET1-0003
            LS.STREET2_0003.SetValue(WS.ADDRESS_LINE2);                                                         //COBOL==> MOVE ADDRESS-LINE2 TO STREET2-0003
            LS.CITY_0003.SetValue(WS.CITY);                                                                     //COBOL==> MOVE CITY TO CITY-0003
            LS.STATE_0003.SetValue(WS.STATE);                                                                   //COBOL==> MOVE STATE TO STATE-0003
            LS.ZIP_CODE_0003.SetValue(WS.ZIP_CODE);                                                             //COBOL==> MOVE ZIP-CODE TO ZIP-CODE-0003
            if (WS.ZIP_HYPHEN.IsEqualTo("-"))                                                                   //COBOL==> IF ZIP-HYPHEN = '-'
            {
                LS.ZIP4_0003.SetValue(WS.ZIP_PLUS_FOUR1);                                                           //COBOL==> MOVE ZIP-PLUS-FOUR1 TO ZIP4-0003
            }                                                                                                   //COBOL==> ELSE
            else
            {
                if (WS.ZIP_HYPHEN.IsEqualTo(" "))                                                                   //COBOL==> IF ZIP-HYPHEN = ' '
                ...
                {
                    LS.ZIP4_0003.SetValue(WS.ZIP_PLUS_FOUR2);                                                           //COBOL==> MOVE ZIP-PLUS-FOUR2 TO ZIP4-0003
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                   //COBOL==> END-IF.
            LS.AREA_CODE_0002.SetValue(WS.AREA_CODE);                                                           //COBOL==> MOVE AREA-CODE TO AREA-CODE-0002
            LS.PHONE_NO_0002.SetValue(WS.PHONE);                                                                //COBOL==> MOVE PHONE TO PHONE-NO-0002
            LS.TEXT_1_0004.SetValue(WS.ACTIVE_INACTIVE_IND);                                                    //COBOL==> MOVE ACTIVE-INACTIVE-IND TO TEXT-1-0004
            WS.YEAR1.SetValue(WS.WS_YEAR1);                                                                     //COBOL==> MOVE WS-YEAR1 TO YEAR1
            WS.MONTH1.SetValue(WS.WS_MONTH1);                                                                   //COBOL==> MOVE WS-MONTH1 TO MONTH1
            WS.DAY1.SetValue(WS.WS_DAY1);                                                                       //COBOL==> MOVE WS-DAY1 TO DAY1
            LS.EIWO_END_DATE_0002.SetValue(WS.WS_DATE);                                                         //COBOL==> MOVE WS-DATE TO EIWO-END-DATE-0002
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1832406365_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832406365_EXIT
        /// </summary>
        private void M_PARA_1832406365_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832406365_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1832406365_EXIT") { M_PARA_1832406365_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832406365_INIT
        /// </summary>
        private void M_PARA_1832406365_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_ACTIVE_IND_0004EV.ResetToInitialValue();                                                  //COBOL==> INITIALIZE EXPORT-ACTIVE-IND-0004EV
            LS.EXTERNAL_0005EV.ResetToInitialValue();                                                           //COBOL==> INITIALIZE EXTERNAL-0005EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1832406365_INIT") { M_PARA_1832406365_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832406365_INIT_EXIT
        /// </summary>
        private void M_PARA_1832406365_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832406365_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
