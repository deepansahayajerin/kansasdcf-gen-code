...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:47:53 PM
   **        *   FROM COBOL PGM   :  SWEXFR01
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B700_EXT_READ_FILE            DATE: 2004/09/16
       TARGET OS:   MVS                       TIME: 10:02:20
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXFR01_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFR01_fd_FileSection";
        ...
        #region Constructors
        public SWEXFR01_fd(SWEXFR01_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFR01_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFR01_ws_WorkingStorage";
            internal const string FILE_STATUS = "FILE_STATUS";
            internal const string WS_INPUT_RECORD = "WS_INPUT_RECORD";
            internal const string TEXT_132 = "TEXT_132";
        }
        #endregion
        ...
        public IField TEXT_132 { get { return GetElementByName<IField>(Names.TEXT_132); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_INPUT_RECORD.CreateNewField(Names.TEXT_132, FieldType.String, 132);
           });
    ...
    internal class SWEXFR01_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFR01_ls_LinkageSection";
            ...
            internal const string EXPORT_EXTERNAL_0003EV = "EXPORT_EXTERNAL_0003EV";
        ...
        public IGroup EXPORT_EXTERNAL_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_EXTERNAL_0003EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_EXTERNAL_0003EV, (EXPORT_EXTERNAL_0003EV) =>
           {
               EXPORT_EXTERNAL_0003EV.CreateNewGroup(Names.EXTERNAL_0003ET, (EXTERNAL_0003ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_EXTERNAL_0003EV, args, 5);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_EXTERNAL_0003EV, args, 5);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXFR01 : EABBase
    {
        ...
        public SWEXFR01()
            : base()
        {
            this.ProgramName.SetValue("SWEXFR01");

            WS = new SWEXFR01_ws();
            FD = new SWEXFR01_fd(WS);
            LS = new SWEXFR01_ls();
        }
        ...
        private SWEXFR01_ws WS;

        //==== File Data Class ========================================
        private SWEXFR01_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFR01_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-FILE-NUMBER-0001EV , IMPORT-0002EV , EXPORT-EXTERNAL-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0436222418(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0436222418
        /// </summary>
        private void M_MAIN_0436222418(string returnMethod = "")
        {
            M_PARA_0436222418_INIT("M_PARA_0436222418_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0436222418-INIT THRU PARA-0436222418-INIT-EXIT
            M_PARA_0436222418("M_PARA_0436222418_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0436222418 THRU PARA-0436222418-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0436222418
        /// </summary>
        private void M_PARA_0436222418(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0436222418") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            if ((LS.COUNT_0001.IsEqualTo(1)))                                                                   //COBOL==> WHEN 1
            {
                ...
                LS.TEXT_LINE_130_0003.SetValue(FD.RECORD_01_DETAIL);                                                //COBOL==> MOVE RECORD-01-DETAIL TO TEXT-LINE-130-0003
            }                                                                                                //COBOL==> WHEN 2
            else
            if ((LS.COUNT_0001.IsEqualTo(2)))
            {
                FD.INPUT_FILE_02.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-02
                LS.TEXT_LINE_130_0003.SetValue(FD.RECORD_02_DETAIL);                                                //COBOL==> MOVE RECORD-02-DETAIL TO TEXT-LINE-130-0003
            }                                                                                                //COBOL==> WHEN 3
            else
            if ((LS.COUNT_0001.IsEqualTo(3)))
            {
                FD.INPUT_FILE_03.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-03
                LS.TEXT_LINE_130_0003.SetValue(FD.RECORD_03_DETAIL);                                                //COBOL==> MOVE RECORD-03-DETAIL TO TEXT-LINE-130-0003
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0436222418_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0436222418_EXIT
        /// </summary>
        private void M_PARA_0436222418_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0436222418_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0436222418_EXIT") { M_PARA_0436222418_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0436222418_INIT
        /// </summary>
        private void M_PARA_0436222418_INIT(string returnMethod = "")
        {
            LS.EXPORT_EXTERNAL_0003EV.ResetToInitialValue();                                                    //COBOL==> INITIALIZE EXPORT-EXTERNAL-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0436222418_INIT") { M_PARA_0436222418_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0436222418_INIT_EXIT
        /// </summary>
        private void M_PARA_0436222418_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0436222418_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
