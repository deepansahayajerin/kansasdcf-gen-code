...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:23 PM
   **        *   FROM COBOL PGM   :  SWEXEW03
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_REQUEST_TO_KDOR           DATE: 2008/02/22
       TARGET OS:   MVS                       TIME: 09:20:28
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW03_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW03_fd_FileSection";
        ...
        #region Constructors
        public SWEXEW03_fd(SWEXEW03_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW03_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW03_ws_WorkingStorage";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_KDOROUT, (WS_KDOROUT) =>
           {
               ...
               WS_KDOROUT.CreateNewFillerField(185, FillWith.Hashes);
           });
    ...
    internal class SWEXEW03_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW03_ls_LinkageSection";
    ...
    public class SWEXEW03 : EABBase
    {
        ...
        public SWEXEW03()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW03");

            WS = new SWEXEW03_ws();
            FD = new SWEXEW03_fd(WS);
            LS = new SWEXEW03_ls();
        }
        ...
        private SWEXEW03_ws WS;

        //==== File Data Class ========================================
        private SWEXEW03_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW03_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230560858(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230560858
        /// </summary>
        private void M_MAIN_1230560858(string returnMethod = "")
        {
            M_PARA_1230560858_INIT("M_PARA_1230560858_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230560858-INIT THRU PARA-1230560858-INIT-EXIT
            M_PARA_1230560858("M_PARA_1230560858_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230560858 THRU PARA-1230560858-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230560858
        /// </summary>
        private void M_PARA_1230560858(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE59 IS A PART OF SWEXEW03*
            //COMMENT: ******************************************
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230560858_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230560858_EXIT
        /// </summary>
        private void M_PARA_1230560858_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230560858_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230560858_EXIT") { M_PARA_1230560858_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230560858_INIT
        /// </summary>
        private void M_PARA_1230560858_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1230560858_INIT") { M_PARA_1230560858_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230560858_INIT_EXIT
        /// </summary>
        private void M_PARA_1230560858_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230560858_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
