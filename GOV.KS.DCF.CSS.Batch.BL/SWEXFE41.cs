...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:47:29 PM
   **        *   FROM COBOL PGM   :  SWEXFE41
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B664_READ_EXTRACT_DATA_FILE   DATE: 2005/05/05
       TARGET OS:   MVS                       TIME: 10:47:47
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXFE41_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE41_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXTRACT_RECORD, (EXTRACT_RECORD) =>
           {
               ...
               EXTRACT_RECORD.CreateNewFillerField(2, FillWith.Hashes);
               EXTRACT_RECORD.CreateNewField(Names.OB_TYPE_SYS_GEN_ID, FieldType.SignedNumeric, 3);
               EXTRACT_RECORD.CreateNewFillerField(45, FillWith.Hashes);
           });
        ...
        #region Constructors
        public SWEXFE41_fd(SWEXFE41_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE41_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE41_ws_WorkingStorage";
    ...
    internal class SWEXFE41_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE41_ls_LinkageSection";
            ...
            internal const string COLLECTION_0004ET = "COLLECTION_0004ET";
            internal const string COURT_ORDER_APPLIED_TO_0004AS = "COURT_ORDER_APPLIED_TO_0004AS";
            internal const string COURT_ORDER_APPLIED_TO_0004 = "COURT_ORDER_APPLIED_TO_0004";
            internal const string COURT_ORDER_APPLIED_TO_0004XX = "COURT_ORDER_APPLIED_TO_0004XX";
            internal const string COLLECTION_DT_0004AS = "COLLECTION_DT_0004AS";
            internal const string COLLECTION_DT_0004 = "COLLECTION_DT_0004";
            internal const string COLLECTION_DT_0004XX = "COLLECTION_DT_0004XX";
            internal const string APPLIED_TO_CODE_0004AS = "APPLIED_TO_CODE_0004AS";
            internal const string APPLIED_TO_CODE_0004 = "APPLIED_TO_CODE_0004";
            internal const string APPLIED_TO_CODE_0004XX = "APPLIED_TO_CODE_0004XX";
            internal const string EXPORT_RETAINED_0005EV = "EXPORT_RETAINED_0005EV";
            ...
            internal const string EXPORT_FORWARDED_TO_FAM_0006EV = "EXPORT_FORWARDED_TO_FAM_0006EV";
            ...
            internal const string OBLIGATION_TYPE_0008ET = "OBLIGATION_TYPE_0008ET";
        ...
        public IGroup COLLECTION_0004ET { get { return GetElementByName<IGroup>(Names.COLLECTION_0004ET); } }
        public IField COURT_ORDER_APPLIED_TO_0004AS { get { return GetElementByName<IField>(Names.COURT_ORDER_APPLIED_TO_0004AS); } }
        public IField COURT_ORDER_APPLIED_TO_0004 { get { return GetElementByName<IField>(Names.COURT_ORDER_APPLIED_TO_0004); } }
        public IField COURT_ORDER_APPLIED_TO_0004XX { get { return GetElementByName<IField>(Names.COURT_ORDER_APPLIED_TO_0004XX); } }
        public IField COLLECTION_DT_0004AS { get { return GetElementByName<IField>(Names.COLLECTION_DT_0004AS); } }
        public IField COLLECTION_DT_0004 { get { return GetElementByName<IField>(Names.COLLECTION_DT_0004); } }
        public IField COLLECTION_DT_0004XX { get { return GetElementByName<IField>(Names.COLLECTION_DT_0004XX); } }
        public IField APPLIED_TO_CODE_0004AS { get { return GetElementByName<IField>(Names.APPLIED_TO_CODE_0004AS); } }
        public IField APPLIED_TO_CODE_0004 { get { return GetElementByName<IField>(Names.APPLIED_TO_CODE_0004); } }
        public IField APPLIED_TO_CODE_0004XX { get { return GetElementByName<IField>(Names.APPLIED_TO_CODE_0004XX); } }
        public IGroup EXPORT_RETAINED_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_RETAINED_0005EV); } }
        ...
        public IGroup EXPORT_FORWARDED_TO_FAM_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_FORWARDED_TO_FAM_0006EV); } }
        ...
        public IGroup OBLIGATION_TYPE_0008ET { get { return GetElementByName<IGroup>(Names.OBLIGATION_TYPE_0008ET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_OBLIGOR_0003EV.CreateNewGroup(Names.CSE_PERSON_0003ET, (CSE_PERSON_0003ET) =>
               {
           ...
           {
               EXPORT_0004EV.CreateNewGroup(Names.COLLECTION_0004ET, (COLLECTION_0004ET) =>
               {
                   COLLECTION_0004ET.CreateNewField(Names.COURT_ORDER_APPLIED_TO_0004AS, FieldType.String, 1);

                   IField COURT_ORDER_APPLIED_TO_0004_local = COLLECTION_0004ET.CreateNewField(Names.COURT_ORDER_APPLIED_TO_0004, FieldType.String, 20);
                   COLLECTION_0004ET.CreateNewFieldRedefine(Names.COURT_ORDER_APPLIED_TO_0004XX, FieldType.String, COURT_ORDER_APPLIED_TO_0004_local, 20);
                   COLLECTION_0004ET.CreateNewField(Names.COLLECTION_DT_0004AS, FieldType.String, 1);

                   IField COLLECTION_DT_0004_local = COLLECTION_0004ET.CreateNewField(Names.COLLECTION_DT_0004, FieldType.SignedNumeric, 8);
                   COLLECTION_0004ET.CreateNewFieldRedefine(Names.COLLECTION_DT_0004XX, FieldType.String, COLLECTION_DT_0004_local, 8);
                   COLLECTION_0004ET.CreateNewField(Names.APPLIED_TO_CODE_0004AS, FieldType.String, 1);

                   IField APPLIED_TO_CODE_0004_local = COLLECTION_0004ET.CreateNewField(Names.APPLIED_TO_CODE_0004, FieldType.String, 1);
                   COLLECTION_0004ET.CreateNewFieldRedefine(Names.APPLIED_TO_CODE_0004XX, FieldType.String, APPLIED_TO_CODE_0004_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_RETAINED_0005EV, (EXPORT_RETAINED_0005EV) =>
           {
               EXPORT_RETAINED_0005EV.CreateNewGroup(Names.COLLECTION_0005ET, (COLLECTION_0005ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_FORWARDED_TO_FAM_0006EV, (EXPORT_FORWARDED_TO_FAM_0006EV) =>
           {
               EXPORT_FORWARDED_TO_FAM_0006EV.CreateNewGroup(Names.COLLECTION_0006ET, (COLLECTION_0006ET) =>
               {
           ...
           {
               EXPORT_0008EV.CreateNewGroup(Names.OBLIGATION_TYPE_0008ET, (OBLIGATION_TYPE_0008ET) =>
               {
                   OBLIGATION_TYPE_0008ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTI_0009AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_IDENTIFI_0009_local = OBLIGATION_TYPE_0008ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTIFI_0009, FieldType.SignedNumeric, 3);
                   OBLIGATION_TYPE_0008ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_IDENTI_0009XX, FieldType.String, SYSTEM_GENERATED_IDENTIFI_0009_local, 3);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_RETAINED_0005EV, args, 7);
            SetPassedParm(EXPORT_FORWARDED_TO_FAM_0006EV, args, 8);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_RETAINED_0005EV, args, 7);
            SetReturnParm(EXPORT_FORWARDED_TO_FAM_0006EV, args, 8);
    ...
    public class SWEXFE41 : EABBase
    {
        ...
        public SWEXFE41()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE41");

            WS = new SWEXFE41_ws();
            FD = new SWEXFE41_fd(WS);
            LS = new SWEXFE41_ls();
        }
        ...
        private SWEXFE41_ws WS;

        //==== File Data Class ========================================
        private SWEXFE41_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE41_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-AR-0002EV , EXPORT-OBLIGOR-0003EV , EXPORT-0004EV , EXPORT-RETAINED-0005EV , EXPORT-FORWARDED-TO-FAM-0006EV , EXPORT-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0968467925(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0968467925
        /// </summary>
        private void M_MAIN_0968467925(string returnMethod = "")
        {
            M_PARA_0968467925_INIT("M_PARA_0968467925_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0968467925-INIT THRU PARA-0968467925-INIT-EXIT
            M_PARA_0968467925("M_PARA_0968467925_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0968467925 THRU PARA-0968467925-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0968467925
        /// </summary>
        private void M_PARA_0968467925(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0968467925") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: *************************
            FD.EXTRACT_FILE.OpenFile(FileAccessMode.Read);                                                      //COBOL==> OPEN INPUT EXTRACT-FILE
        ...
        {
            //COMMENT: *************************
            FD.EXTRACT_FILE.ReadLine();                                                                         //COBOL==> READ EXTRACT-FILE
                                                                                                                // EvaluateList !WS.FILE_STATUS!                                                                    //COBOL==> EVALUATE FILE-STATUS
            if ((WS.FILE_STATUS.IsEqualTo("00")))                                                               //COBOL==> WHEN '00'
            {
                LS.STATUS_0007.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0007
                LS.NUMBER_0002.SetValue(FD.AR_NUMBER);                                                              //COBOL==> MOVE AR-NUMBER TO NUMBER-0002
                LS.NUMBER_0003.SetValue(FD.OBLIGOR_NUMBER);                                                         //COBOL==> MOVE OBLIGOR-NUMBER TO NUMBER-0003
                LS.COURT_ORDER_APPLIED_TO_0004.SetValue(FD.COURT_ORDER_APPLIED_TO);                                 //COBOL==> MOVE COURT-ORDER-APPLIED-TO TO COURT-ORDER-APPLIED-TO-0004
                LS.COLLECTION_DT_0004.SetValue(FD.COLLECTION_DT);                                                   //COBOL==> MOVE COLLECTION-DT TO COLLECTION-DT-0004
                LS.APPLIED_TO_CODE_0004.SetValue(FD.APPLIED_TO_CODE);                                               //COBOL==> MOVE APPLIED-TO-CODE TO APPLIED-TO-CODE-0004
                LS.AMOUNT_0005.SetValue(FD.AMOUNT_RETAINED);                                                        //COBOL==> MOVE AMOUNT-RETAINED TO AMOUNT-0005
                LS.AMOUNT_0006.SetValue(FD.AMOUNT_TO_FAMILY);                                                       //COBOL==> MOVE AMOUNT-TO-FAMILY TO AMOUNT-0006
                LS.SYSTEM_GENERATED_IDENTIFI_0009.SetValue(FD.OB_TYPE_SYS_GEN_ID);                                  //COBOL==> MOVE OB-TYPE-SYS-GEN-ID TO SYSTEM-GENERATED-IDENTIFI-0009
            }                                                                                                //COBOL==> WHEN '10'
            else
            if ((WS.FILE_STATUS.IsEqualTo("10")))
            {
                LS.STATUS_0007.SetValue("EF");                                                                      //COBOL==> MOVE 'EF' TO STATUS-0007
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0007.SetValue("BR");                                                                      //COBOL==> MOVE 'BR' TO STATUS-0007
            }                                                                                                   //COBOL==> END-EVALUATE.
        ...
        private void M_3000_CLOSE_FILE(string returnMethod = "")
        {
            ...
            {
                LS.STATUS_0007.SetValue("CE");                                                                      //COBOL==> MOVE 'CE' TO STATUS-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0968467925_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0968467925_EXIT
        /// </summary>
        private void M_PARA_0968467925_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0968467925_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0968467925_EXIT") { M_PARA_0968467925_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0968467925_INIT
        /// </summary>
        private void M_PARA_0968467925_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_RETAINED_0005EV.ResetToInitialValue();                                                    //COBOL==> INITIALIZE EXPORT-RETAINED-0005EV
            LS.EXPORT_FORWARDED_TO_FAM_0006EV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-FORWARDED-TO-FAM-0006EV
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0968467925_INIT") { M_PARA_0968467925_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0968467925_INIT_EXIT
        /// </summary>
        private void M_PARA_0968467925_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0968467925_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
