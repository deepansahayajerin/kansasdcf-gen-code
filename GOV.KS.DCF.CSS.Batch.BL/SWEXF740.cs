...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:46:43 PM
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    public class SWEXF740 : EABBase
    {
        ...
        private void M_INIT_LINKAGE(string returnMethod = "")
        {
            ...
            if ((LS.I_SECTION_SUPERVISOR_000204XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_SECTION_SUPERVISOR_000204XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-SECTION-SUPERVISOR-000204XX = HIGH-VALUES OR I-SECTION-SUPERVISOR-000204XX = LOW-VALUES
            {
                LS.I_SECTION_SUPERVISOR_0002_004.SetValueWithSpaces();                                              //COBOL==> MOVE SPACES TO I-SECTION-SUPERVISOR-0002-004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_COLLECTION_OFFICER_000205XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_COLLECTION_OFFICER_000205XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-COLLECTION-OFFICER-000205XX = HIGH-VALUES OR I-COLLECTION-OFFICER-000205XX = LOW-VALUES
            {
                LS.I_COLLECTION_OFFICER_0002_005.SetValueWithSpaces();                                              //COBOL==> MOVE SPACES TO I-COLLECTION-OFFICER-0002-005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_CASE_NUMBER_0002_006XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_CASE_NUMBER_0002_006XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-CASE-NUMBER-0002-006XX = HIGH-VALUES OR I-CASE-NUMBER-0002-006XX = LOW-VALUES
            {
                LS.I_CASE_NUMBER_0002_006.SetValueWithSpaces();                                                     //COBOL==> MOVE SPACES TO I-CASE-NUMBER-0002-006
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_OBLIGATION_CODE_0002_007XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_OBLIGATION_CODE_0002_007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-OBLIGATION-CODE-0002-007XX = HIGH-VALUES OR I-OBLIGATION-CODE-0002-007XX = LOW-VALUES
            {
                LS.I_OBLIGATION_CODE_0002_007.SetValueWithSpaces();                                                 //COBOL==> MOVE SPACES TO I-OBLIGATION-CODE-0002-007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_APPLIED_TO_0002_008XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_APPLIED_TO_0002_008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-APPLIED-TO-0002-008XX = HIGH-VALUES OR I-APPLIED-TO-0002-008XX = LOW-VALUES
            {
            ...
            if ((LS.E_PARM1_0003_016XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_PARM1_0003_016XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-PARM1-0003-016XX = HIGH-VALUES OR E-PARM1-0003-016XX = LOW-VALUES
            {
                LS.E_PARM1_0003_016.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM1-0003-016
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_PARM2_0003_017XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_PARM2_0003_017XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-PARM2-0003-017XX = HIGH-VALUES OR E-PARM2-0003-017XX = LOW-VALUES
            {
