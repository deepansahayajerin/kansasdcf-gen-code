...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:42:16 PM
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    public class SWEX608W : EABBase
    {
        ...
        private void M_B000_INIT_FIELDS(string returnMethod = "")
        {
            ...
            if ((LS.SUBREPORT_CODE_0001XX.IsEqualTo(HIGH_VALUES))
             || (LS.SUBREPORT_CODE_0001XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF SUBREPORT-CODE-0001XX = HIGH-VALUES OR SUBREPORT-CODE-0001XX = LOW-VALUES
            {
                LS.SUBREPORT_CODE_0001.SetValueWithSpaces();                                                        //COBOL==> MOVE SPACES TO SUBREPORT-CODE-0001
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.USER_ID_0003XX.IsEqualTo(HIGH_VALUES))
             || (LS.USER_ID_0003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF USER-ID-0003XX = HIGH-VALUES OR USER-ID-0003XX = LOW-VALUES
            {
                LS.USER_ID_0003.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO USER-ID-0003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LAST_NAME_0003XX.IsEqualTo(HIGH_VALUES))
             || (LS.LAST_NAME_0003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LAST-NAME-0003XX = HIGH-VALUES OR LAST-NAME-0003XX = LOW-VALUES
            {
                LS.LAST_NAME_0003.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO LAST-NAME-0003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.FIRST_NAME_0003XX.IsEqualTo(HIGH_VALUES))
             || (LS.FIRST_NAME_0003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF FIRST-NAME-0003XX = HIGH-VALUES OR FIRST-NAME-0003XX = LOW-VALUES
            {
                LS.FIRST_NAME_0003.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO FIRST-NAME-0003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.MIDDLE_INITIAL_0003XX.IsEqualTo(HIGH_VALUES))
             || (LS.MIDDLE_INITIAL_0003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF MIDDLE-INITIAL-0003XX = HIGH-VALUES OR MIDDLE-INITIAL-0003XX = LOW-VALUES
            {
                LS.MIDDLE_INITIAL_0003.SetValueWithSpaces();                                                        //COBOL==> MOVE SPACES TO MIDDLE-INITIAL-0003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.TEXT_1_0004XX.IsEqualTo(HIGH_VALUES))
             || (LS.TEXT_1_0004XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF TEXT-1-0004XX = HIGH-VALUES OR TEXT-1-0004XX = LOW-VALUES
            {
                LS.TEXT_1_0004.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO TEXT-1-0004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.PROGRAM_APPLIED_TO_0005XX.IsEqualTo(HIGH_VALUES))
             || (LS.PROGRAM_APPLIED_TO_0005XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF PROGRAM-APPLIED-TO-0005XX = HIGH-VALUES OR PROGRAM-APPLIED-TO-0005XX = LOW-VALUES
            {
                LS.PROGRAM_APPLIED_TO_0005.SetValueWithSpaces();                                                    //COBOL==> MOVE SPACES TO PROGRAM-APPLIED-TO-0005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.APPLIED_TO_CODE_0005XX.IsEqualTo(HIGH_VALUES))
             || (LS.APPLIED_TO_CODE_0005XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF APPLIED-TO-CODE-0005XX = HIGH-VALUES OR APPLIED-TO-CODE-0005XX = LOW-VALUES
            {
                LS.APPLIED_TO_CODE_0005.SetValueWithSpaces();                                                       //COBOL==> MOVE SPACES TO APPLIED-TO-CODE-0005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.ADJUSTED_IND_0005XX.IsEqualTo(HIGH_VALUES))
             || (LS.ADJUSTED_IND_0005XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF ADJUSTED-IND-0005XX = HIGH-VALUES OR ADJUSTED-IND-0005XX = LOW-VALUES
            {
                LS.ADJUSTED_IND_0005.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO ADJUSTED-IND-0005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.TEXT_1_0006XX.IsEqualTo(HIGH_VALUES))
             || (LS.TEXT_1_0006XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF TEXT-1-0006XX = HIGH-VALUES OR TEXT-1-0006XX = LOW-VALUES
            {
                LS.TEXT_1_0006.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO TEXT-1-0006
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.NUMBER_0007XX.IsEqualTo(HIGH_VALUES))
             || (LS.NUMBER_0007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF NUMBER-0007XX = HIGH-VALUES OR NUMBER-0007XX = LOW-VALUES
            {
                LS.NUMBER_0007.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO NUMBER-0007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.FIRST_NAME_0007XX.IsEqualTo(HIGH_VALUES))
             || (LS.FIRST_NAME_0007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF FIRST-NAME-0007XX = HIGH-VALUES OR FIRST-NAME-0007XX = LOW-VALUES
            {
                LS.FIRST_NAME_0007.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO FIRST-NAME-0007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.MIDDLE_INITIAL_0007XX.IsEqualTo(HIGH_VALUES))
             || (LS.MIDDLE_INITIAL_0007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF MIDDLE-INITIAL-0007XX = HIGH-VALUES OR MIDDLE-INITIAL-0007XX = LOW-VALUES
            {
                LS.MIDDLE_INITIAL_0007.SetValueWithSpaces();                                                        //COBOL==> MOVE SPACES TO MIDDLE-INITIAL-0007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.FORMATTED_NAME_0007XX.IsEqualTo(HIGH_VALUES))
             || (LS.FORMATTED_NAME_0007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF FORMATTED-NAME-0007XX = HIGH-VALUES OR FORMATTED-NAME-0007XX = LOW-VALUES
            {
                LS.FORMATTED_NAME_0007.SetValueWithSpaces();                                                        //COBOL==> MOVE SPACES TO FORMATTED-NAME-0007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LAST_NAME_0007XX.IsEqualTo(HIGH_VALUES))
             || (LS.LAST_NAME_0007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LAST-NAME-0007XX = HIGH-VALUES OR LAST-NAME-0007XX = LOW-VALUES
            {
                LS.LAST_NAME_0007.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO LAST-NAME-0007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.NUMBER_0008XX.IsEqualTo(HIGH_VALUES))
             || (LS.NUMBER_0008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF NUMBER-0008XX = HIGH-VALUES OR NUMBER-0008XX = LOW-VALUES
            {
                LS.NUMBER_0008.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO NUMBER-0008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.FIRST_NAME_0008XX.IsEqualTo(HIGH_VALUES))
             || (LS.FIRST_NAME_0008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF FIRST-NAME-0008XX = HIGH-VALUES OR FIRST-NAME-0008XX = LOW-VALUES
            {
                LS.FIRST_NAME_0008.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO FIRST-NAME-0008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.MIDDLE_INITIAL_0008XX.IsEqualTo(HIGH_VALUES))
             || (LS.MIDDLE_INITIAL_0008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF MIDDLE-INITIAL-0008XX = HIGH-VALUES OR MIDDLE-INITIAL-0008XX = LOW-VALUES
            {
            ...
            if ((LS.LAST_NAME_0008XX.IsEqualTo(HIGH_VALUES))
             || (LS.LAST_NAME_0008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LAST-NAME-0008XX = HIGH-VALUES OR LAST-NAME-0008XX = LOW-VALUES
            {
                LS.LAST_NAME_0008.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO LAST-NAME-0008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.COURT_CASE_NUMBER_0009XX.IsEqualTo(HIGH_VALUES))
             || (LS.COURT_CASE_NUMBER_0009XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF COURT-CASE-NUMBER-0009XX = HIGH-VALUES OR COURT-CASE-NUMBER-0009XX = LOW-VALUES
            {
                LS.COURT_CASE_NUMBER_0009.SetValueWithSpaces();                                                     //COBOL==> MOVE SPACES TO COURT-CASE-NUMBER-0009
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.STANDARD_NUMBER_0009XX.IsEqualTo(HIGH_VALUES))
             || (LS.STANDARD_NUMBER_0009XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF STANDARD-NUMBER-0009XX = HIGH-VALUES OR STANDARD-NUMBER-0009XX = LOW-VALUES
            {
                LS.STANDARD_NUMBER_0009.SetValueWithSpaces();                                                       //COBOL==> MOVE SPACES TO STANDARD-NUMBER-0009
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.NUMBER_0010XX.IsEqualTo(HIGH_VALUES))
             || (LS.NUMBER_0010XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF NUMBER-0010XX = HIGH-VALUES OR NUMBER-0010XX = LOW-VALUES
            {
                LS.NUMBER_0010.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO NUMBER-0010
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.CODE_0011XX.IsEqualTo(HIGH_VALUES))
             || (LS.CODE_0011XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF CODE-0011XX = HIGH-VALUES OR CODE-0011XX = LOW-VALUES
            {
                LS.CODE_0011.SetValueWithSpaces();                                                                  //COBOL==> MOVE SPACES TO CODE-0011
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.JUDICIAL_DISTRICT_0015XX.IsEqualTo(HIGH_VALUES))
             || (LS.JUDICIAL_DISTRICT_0015XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF JUDICIAL-DISTRICT-0015XX = HIGH-VALUES OR JUDICIAL-DISTRICT-0015XX = LOW-VALUES
            {
                LS.JUDICIAL_DISTRICT_0015.SetValueWithSpaces();                                                     //COBOL==> MOVE SPACES TO JUDICIAL-DISTRICT-0015
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.NAME_0015XX.IsEqualTo(HIGH_VALUES))
             || (LS.NAME_0015XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF NAME-0015XX = HIGH-VALUES OR NAME-0015XX = LOW-VALUES
            {
                LS.NAME_0015.SetValueWithSpaces();                                                                  //COBOL==> MOVE SPACES TO NAME-0015
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.COUNTY_DESCRIPTION_0014XX.IsEqualTo(HIGH_VALUES))
             || (LS.COUNTY_DESCRIPTION_0014XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF COUNTY-DESCRIPTION-0014XX = HIGH-VALUES OR COUNTY-DESCRIPTION-0014XX = LOW-VALUES
            {
                LS.COUNTY_DESCRIPTION_0014.SetValueWithSpaces();                                                    //COBOL==> MOVE SPACES TO COUNTY-DESCRIPTION-0014
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.PARM1_0016XX.IsEqualTo(HIGH_VALUES))
             || (LS.PARM1_0016XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF PARM1-0016XX = HIGH-VALUES OR PARM1-0016XX = LOW-VALUES
            {
                LS.PARM1_0016.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO PARM1-0016
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.PARM2_0016XX.IsEqualTo(HIGH_VALUES))
             || (LS.PARM2_0016XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF PARM2-0016XX = HIGH-VALUES OR PARM2-0016XX = LOW-VALUES
            {
                LS.PARM2_0016.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO PARM2-0016
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.SUBREPORT_CODE_0016XX.IsEqualTo(HIGH_VALUES))
             || (LS.SUBREPORT_CODE_0016XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF SUBREPORT-CODE-0016XX = HIGH-VALUES OR SUBREPORT-CODE-0016XX = LOW-VALUES
            {
