...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:49:34 PM
   **        *   FROM COBOL PGM   :  SWEXIC01
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_WRITE_DHR_NEWHIRE_QUERY_FILE DATE: 1999/05/10
       TARGET OS:   MVS                       TIME: 17:49:42
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXIC01_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXIC01_fd_FileSection";
            internal const string DHROUT = "DHROUT";
            internal const string DHR_OUT1 = "DHR_OUT1";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink DHROUT { get; set; }
        public IField DHR_OUT1 { get { return GetElementByName<IField>(Names.DHR_OUT1); } }
        ...
        {
            recordDef.CreateNewField(Names.DHR_OUT1, FieldType.String, 602);
        ...
        public override void Initialize()
        {
            ...
            DHROUT = FileHandler.GetFile("UT_S_DHROUT");
            DHROUT.AssociatedBuffer = DHR_OUT1;
            DHROUT.RecordLength = 602;
        }
        #endregion
    ...
    internal class SWEXIC01_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXIC01_ws_WorkingStorage";
            internal const string WS_OUT = "WS_OUT";
            ...
            internal const string WS_LAST_INIT = "WS_LAST_INIT";
            ...
            internal const string WS_SUB = "WS_SUB";
            internal const string WS_CLEAR = "WS_CLEAR";
            internal const string IMPORT_GRP_0001FL = "IMPORT_GRP_0001FL";
            internal const string IMPORT_GRP_0001PS = "IMPORT_GRP_0001PS";
            internal const string IMPORT_GRP_0001RF = "IMPORT_GRP_0001RF";
            internal const string IMPORT_GRP_0001MM = "IMPORT_GRP_0001MM";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_OUT { get { return GetElementByName<IGroup>(Names.WS_OUT); } }
        ...
        public IArrayElementAccessor<IField> WS_LAST_INIT { get { return GetArrayElementAccessor<IField>(Names.WS_LAST_INIT); } }
        ...
        public IField WS_SUB { get { return GetElementByName<IField>(Names.WS_SUB); } }
        public IField WS_CLEAR { get { return GetElementByName<IField>(Names.WS_CLEAR); } }
        public IField IMPORT_GRP_0001FL { get { return GetElementByName<IField>(Names.IMPORT_GRP_0001FL); } }
        public IField IMPORT_GRP_0001PS { get { return GetElementByName<IField>(Names.IMPORT_GRP_0001PS); } }
        public IField IMPORT_GRP_0001RF { get { return GetElementByName<IField>(Names.IMPORT_GRP_0001RF); } }
        public IField IMPORT_GRP_0001MM { get { return GetElementByName<IField>(Names.IMPORT_GRP_0001MM); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_OUT, (WS_OUT) =>
           {
               WS_OUT.CreateNewField(Names.WS_SOCIAL_SEC_NUM, FieldType.UnsignedNumeric, 9, 0);
               WS_OUT.CreateNewField(Names.WS_PERSON_NUM, FieldType.String, 10, SPACES);
               WS_OUT.CreateNewGroupArray("FILLER", 10, (FILLER) =>
               {
                   FILLER.CreateNewField(Names.WS_CASE_NUM, FieldType.String, 10, SPACES);
                   FILLER.CreateNewField(Names.WS_LAST_INIT, FieldType.String, 1, SPACES);
                   FILLER.CreateNewField(Names.WS_OFFICE, FieldType.UnsignedNumeric, 4, 0);
               });
               WS_OUT.CreateNewField(Names.WS_FIRST_NAME, FieldType.String, 12, SPACES);
               WS_OUT.CreateNewField(Names.WS_MIDDLE_NAME, FieldType.String, 1, SPACES);
               WS_OUT.CreateNewField(Names.WS_LAST_NAME, FieldType.String, 17, SPACES);
               WS_OUT.CreateNewFillerField(FieldType.String, 403, SPACES);
           });
            ...
            recordDef.CreateNewGroup("FILLER_d3", (FILLER_d3) =>
           {
               ...
               FILLER_d3.CreateNewField(Names.WS_SUB, FieldType.CompInt, 8);
           });
            recordDef.CreateNewField(Names.WS_CLEAR, FieldType.String, 602, SPACES);

            recordDef.CreateNewGroup("FILLER_d4", (FILLER_d4) =>
           {
               FILLER_d4.CreateNewField(Names.IMPORT_GRP_0001FL, FieldType.String, 1);
               FILLER_d4.CreateNewField(Names.IMPORT_GRP_0001PS, FieldType.CompShort, 4);
               FILLER_d4.CreateNewField(Names.IMPORT_GRP_0001RF, FieldType.String, 1);
               FILLER_d4.CreateNewField(Names.IMPORT_GRP_0001MM, FieldType.CompInt, 9, 10);
           });
    ...
    internal class SWEXIC01_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIC01_ls_LinkageSection";
            ...
            internal const string IMPORT_GRP_0001RG = "IMPORT_GRP_0001RG";
            internal const string IMPORT_GRP_0001MA = "IMPORT_GRP_0001MA";
            internal const string IMPORT_GRP_0001MX = "IMPORT_GRP_0001MX";
            internal const string IMPORT_GRP_0001 = "IMPORT_GRP_0001";
            internal const string IMPORT_GRP_0001AC = "IMPORT_GRP_0001AC";
            internal const string GRP_0003EV = "GRP_0003EV";
            ...
            internal const string GRP_0004EV = "GRP_0004EV";
            ...
            internal const string GRP_0005EV = "GRP_0005EV";
        ...
        public IGroup IMPORT_GRP_0001RG { get { return GetElementByName<IGroup>(Names.IMPORT_GRP_0001RG); } }
        public IField IMPORT_GRP_0001MA { get { return GetElementByName<IField>(Names.IMPORT_GRP_0001MA); } }
        public IField IMPORT_GRP_0001MX { get { return GetElementByName<IField>(Names.IMPORT_GRP_0001MX); } }
        public IArrayElementAccessor<IGroup> IMPORT_GRP_0001 { get { return GetArrayElementAccessor<IGroup>(Names.IMPORT_GRP_0001); } }
        public IArrayElementAccessor<IField> IMPORT_GRP_0001AC { get { return GetArrayElementAccessor<IField>(Names.IMPORT_GRP_0001AC); } }
        public IArrayElementAccessor<IGroup> GRP_0003EV { get { return GetArrayElementAccessor<IGroup>(Names.GRP_0003EV); } }
        public IArrayElementAccessor<IGroup> CASE_0003ET { get { return GetArrayElementAccessor<IGroup>(Names.CASE_0003ET); } }
        ...
        public IArrayElementAccessor<IGroup> GRP_0004EV { get { return GetArrayElementAccessor<IGroup>(Names.GRP_0004EV); } }
        public IArrayElementAccessor<IGroup> OFFICE_0004ET { get { return GetArrayElementAccessor<IGroup>(Names.OFFICE_0004ET); } }
        public IArrayElementAccessor<IField> SYSTEM_GENERATED_ID_0004AS { get { return GetArrayElementAccessor<IField>(Names.SYSTEM_GENERATED_ID_0004AS); } }
        public IArrayElementAccessor<IField> SYSTEM_GENERATED_ID_0004 { get { return GetArrayElementAccessor<IField>(Names.SYSTEM_GENERATED_ID_0004); } }
        public IArrayElementAccessor<IField> SYSTEM_GENERATED_ID_0004XX { get { return GetArrayElementAccessor<IField>(Names.SYSTEM_GENERATED_ID_0004XX); } }
        public IArrayElementAccessor<IGroup> GRP_0005EV { get { return GetArrayElementAccessor<IGroup>(Names.GRP_0005EV); } }
        public IArrayElementAccessor<IGroup> SERVICE_PROVIDER_0005ET { get { return GetArrayElementAccessor<IGroup>(Names.SERVICE_PROVIDER_0005ET); } }
        public IArrayElementAccessor<IField> LAST_NAME_0005AS { get { return GetArrayElementAccessor<IField>(Names.LAST_NAME_0005AS); } }
        public IArrayElementAccessor<IField> LAST_NAME_0005 { get { return GetArrayElementAccessor<IField>(Names.LAST_NAME_0005); } }
        public IArrayElementAccessor<IField> LAST_NAME_0005XX { get { return GetArrayElementAccessor<IField>(Names.LAST_NAME_0005XX); } }
        public IArrayElementAccessor<IField> FIRST_NAME_0005AS { get { return GetArrayElementAccessor<IField>(Names.FIRST_NAME_0005AS); } }
        public IArrayElementAccessor<IField> FIRST_NAME_0005 { get { return GetArrayElementAccessor<IField>(Names.FIRST_NAME_0005); } }
        public IArrayElementAccessor<IField> FIRST_NAME_0005XX { get { return GetArrayElementAccessor<IField>(Names.FIRST_NAME_0005XX); } }
        public IArrayElementAccessor<IField> MIDDLE_INITIAL_0005AS { get { return GetArrayElementAccessor<IField>(Names.MIDDLE_INITIAL_0005AS); } }
        public IArrayElementAccessor<IField> MIDDLE_INITIAL_0005 { get { return GetArrayElementAccessor<IField>(Names.MIDDLE_INITIAL_0005); } }
        public IArrayElementAccessor<IField> MIDDLE_INITIAL_0005XX { get { return GetArrayElementAccessor<IField>(Names.MIDDLE_INITIAL_0005XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_GRP_0001RG, (IMPORT_GRP_0001RG) =>
           {

               IField IMPORT_GRP_0001MA_local = IMPORT_GRP_0001RG.CreateNewField(Names.IMPORT_GRP_0001MA, FieldType.SignedNumeric, 4);
               IMPORT_GRP_0001RG.CreateNewFieldRedefine(Names.IMPORT_GRP_0001MX, FieldType.String, IMPORT_GRP_0001MA_local, 4);
               IMPORT_GRP_0001RG.CreateNewGroupArray(Names.IMPORT_GRP_0001, 10, (IMPORT_GRP_0001) =>
               {
                   IMPORT_GRP_0001.CreateNewField(Names.IMPORT_GRP_0001AC, FieldType.String, 1);
                   IMPORT_GRP_0001.CreateNewGroup(Names.GRP_0003EV, (GRP_0003EV) =>
                   {
                       GRP_0003EV.CreateNewGroup(Names.CASE_0003ET, (CASE_0003ET) =>
                       {
                   ...
                   IMPORT_GRP_0001.CreateNewGroup(Names.GRP_0004EV, (GRP_0004EV) =>
                   {
                       GRP_0004EV.CreateNewGroup(Names.OFFICE_0004ET, (OFFICE_0004ET) =>
                       {
                   ...
                   IMPORT_GRP_0001.CreateNewGroup(Names.GRP_0005EV, (GRP_0005EV) =>
                   {
                       GRP_0005EV.CreateNewGroup(Names.SERVICE_PROVIDER_0005ET, (SERVICE_PROVIDER_0005ET) =>
                       {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_GRP_0001RG, args, 5);
            SetPassedParm(EXPORT_0006EV, args, 6);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_GRP_0001RG, args, 5);
            SetReturnParm(EXPORT_0006EV, args, 6);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXIC01 : EABBase
    {
        ...
        public SWEXIC01()
            : base()
        {
            this.ProgramName.SetValue("SWEXIC01");
        ...
        private SWEXIC01_ws WS;

        //==== File Data Class ========================================
        private SWEXIC01_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXIC01_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV IMPORT-0002EV IMPORT-GRP-0001RG , EXPORT-0006EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0291509644(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0291509644
        /// </summary>
        private void M_MAIN_0291509644(string returnMethod = "")
        {
            M_PARA_0291509644_INIT("M_PARA_0291509644_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0291509644-INIT THRU PARA-0291509644-INIT-EXIT
            M_PARA_0291509644("M_PARA_0291509644_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0291509644 THRU PARA-0291509644-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0291509644
        /// </summary>
        private void M_PARA_0291509644(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0291509644") { M_PARA_0291509644_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0291509644_EXIT
        /// </summary>
        private void M_PARA_0291509644_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0291509644_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0291509644_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.DHROUT.OpenFile(FileAccessMode.Write);                                                           //COBOL==> OPEN OUTPUT DHROUT
            LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006
            WS.WS_CLEAR.SetValue(WS.WS_OUT);                                                                    //COBOL==> MOVE WS-OUT TO WS-CLEAR .
        ...
        private void M_PARA_OPEN_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_OPEN_EXIT") { M_PARA_MOVE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MOVE
        /// </summary>
        ...
        {
            WS.WS_OUT.SetValue(WS.WS_CLEAR);                                                                    //COBOL==> MOVE WS-CLEAR TO WS-OUT
            WS.WS_PERSON_NUM.SetValue(LS.NUMBER_0002);                                                          //COBOL==> MOVE NUMBER-0002 TO WS-PERSON-NUM
            WS.WS_SOCIAL_SEC_NUM.SetValue(LS.SSN_0002);                                                         //COBOL==> MOVE SSN-0002 TO WS-SOCIAL-SEC-NUM
            WS.WS_FIRST_NAME.SetValue(LS.FIRST_NAME_0002);                                                      //COBOL==> MOVE FIRST-NAME-0002 TO WS-FIRST-NAME
            WS.WS_MIDDLE_NAME.SetValue(LS.MIDDLE_INITIAL_0002);                                                 //COBOL==> MOVE MIDDLE-INITIAL-0002 TO WS-MIDDLE-NAME
            WS.WS_LAST_NAME.SetValue(LS.LAST_NAME_0002);                                                        //COBOL==> MOVE LAST-NAME-0002 TO WS-LAST-NAME
            WS.WS_SUB.SetValue(+1);                                                                             //COBOL==> MOVE +1 TO WS-SUB
            while (!(WS.WS_SUB.IsGreaterThan(LS.IMPORT_GRP_0001MA)))                                            //COBOL==> PERFORM PARA-MOVE-CASES THRU PARA-MOVE-CASES-EXIT UNTIL WS-SUB GREATER THAN IMPORT-GRP-0001MA
            {
                M_PARA_MOVE_CASES("M_PARA_MOVE_CASES_EXIT"); if (Control.ExitProgram) { return; }
            }
            FD.DHROUT.WriteLine(WS.WS_OUT.AsBytes);                                                             //COBOL==> WRITE DHR-OUT1 FROM WS-OUT
            LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006 .
        ...
        private void M_PARA_MOVE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_MOVE_EXIT") { M_PARA_MOVE_CASES(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MOVE_CASES
        /// </summary>
        private void M_PARA_MOVE_CASES(string returnMethod = "")
        {
            WS.WS_LAST_INIT[WS.WS_SUB.AsInt()].SetValue(LS.LAST_NAME_0005[WS.WS_SUB.AsInt()]);                  //COBOL==> MOVE LAST-NAME-0005 ( WS-SUB ) TO WS-LAST-INIT ( WS-SUB )
            WS.WS_CASE_NUM[WS.WS_SUB.AsInt()].SetValue(LS.NUMBER_0003[WS.WS_SUB.AsInt()]);                      //COBOL==> MOVE NUMBER-0003 ( WS-SUB ) TO WS-CASE-NUM ( WS-SUB )
            WS.WS_OFFICE[WS.WS_SUB.AsInt()].SetValue(LS.SYSTEM_GENERATED_ID_0004[WS.WS_SUB.AsInt()]);           //COBOL==> MOVE SYSTEM-GENERATED-ID-0004 ( WS-SUB ) TO WS-OFFICE ( WS-SUB )
            WS.WS_SUB.Add(+1);                                                                                  //COBOL==> ADD +1 TO WS-SUB .
            if (returnMethod != "" && returnMethod != "M_PARA_MOVE_CASES") { M_PARA_MOVE_CASES_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MOVE_CASES_EXIT
        /// </summary>
        private void M_PARA_MOVE_CASES_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_MOVE_CASES_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_MOVE_CASES_EXIT") { M_PARA_CLOSE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_CLOSE
        /// </summary>
        ...
        {
            FD.DHROUT.CloseFile();                                                                              //COBOL==> CLOSE DHROUT
            LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006 .
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_0291509644_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0291509644_INIT
        /// </summary>
        private void M_PARA_0291509644_INIT(string returnMethod = "")
        {
            WS.IMPORT_GRP_0001PS.SetValueWithZeroes();                                                          //COBOL==> MOVE ZERO TO IMPORT-GRP-0001PS
            LS.EXPORT_0006EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0006EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0291509644_INIT") { M_PARA_0291509644_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0291509644_INIT_EXIT
        /// </summary>
        private void M_PARA_0291509644_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0291509644_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
