...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:54:20 PM
   **        *   FROM COBOL PGM   :  SWEXPP01
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_FOUR_REC_DRIVER              DATE: 2001/09/11
       TARGET OS:   MVS                       TIME: 16:14:27
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXPP01_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXPP01_fd_FileSection";
            internal const string FOUR_REC_FILE = "FOUR_REC_FILE";
            internal const string FOUR_REC_RECORD = "FOUR_REC_RECORD";
            internal const string FOUR_REC_FROM = "FOUR_REC_FROM";
            internal const string FOUR_REC_TO = "FOUR_REC_TO";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink FOUR_REC_FILE { get; set; }
        public IGroup FOUR_REC_RECORD { get { return GetElementByName<IGroup>(Names.FOUR_REC_RECORD); } }
        public IField FOUR_REC_FROM { get { return GetElementByName<IField>(Names.FOUR_REC_FROM); } }
        public IField FOUR_REC_TO { get { return GetElementByName<IField>(Names.FOUR_REC_TO); } }


        internal SWEXPP01_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.FOUR_REC_RECORD, (FOUR_REC_RECORD) =>
           {
               FOUR_REC_RECORD.CreateNewField(Names.FOUR_REC_FROM, FieldType.UnsignedNumeric, 8);
               FOUR_REC_RECORD.CreateNewField(Names.FOUR_REC_TO, FieldType.UnsignedNumeric, 8);
           });
        ...
        public override void Initialize()
        {
            ...
            FOUR_REC_FILE = FileHandler.GetFile("UT_S_FOURREC");
            FOUR_REC_FILE.StatusField = WS.FOUR_REC_STATUS;
            FOUR_REC_FILE.AssociatedBuffer = FOUR_REC_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXPP01_fd(SWEXPP01_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXPP01_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXPP01_ws_WorkingStorage";
            internal const string FOUR_REC_STATUS = "FOUR_REC_STATUS";
            internal const string FOUR_REC_CONV = "FOUR_REC_CONV";
            internal const string FOUR_REC_FILLER = "FOUR_REC_FILLER";
            internal const string FOUR_REC_EIGHT = "FOUR_REC_EIGHT";
            internal const string FOUR_REC_TEXT = "FOUR_REC_TEXT";
            internal const string FOUR_REC_NUM = "FOUR_REC_NUM";
            internal const string FOUR_REC_REDF = "FOUR_REC_REDF";
        }
        #endregion

        #region Direct-access element properties
        public IField FOUR_REC_STATUS { get { return GetElementByName<IField>(Names.FOUR_REC_STATUS); } }
        public IGroup FOUR_REC_CONV { get { return GetElementByName<IGroup>(Names.FOUR_REC_CONV); } }
        public IField FOUR_REC_FILLER { get { return GetElementByName<IField>(Names.FOUR_REC_FILLER); } }
        public IField FOUR_REC_EIGHT { get { return GetElementByName<IField>(Names.FOUR_REC_EIGHT); } }
        public IGroup FOUR_REC_TEXT { get { return GetElementByName<IGroup>(Names.FOUR_REC_TEXT); } }
        public IField FOUR_REC_NUM { get { return GetElementByName<IField>(Names.FOUR_REC_NUM); } }
        public IField FOUR_REC_REDF { get { return GetElementByName<IField>(Names.FOUR_REC_REDF); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewField(Names.FOUR_REC_STATUS, FieldType.String, 2);

            recordDef.CreateNewGroup(Names.FOUR_REC_CONV, (FOUR_REC_CONV) =>
           {
               FOUR_REC_CONV.CreateNewField(Names.FOUR_REC_FILLER, FieldType.String, 6, "000000");
               FOUR_REC_CONV.CreateNewField(Names.FOUR_REC_EIGHT, FieldType.String, 8);
           });

            recordDef.CreateNewGroup(Names.FOUR_REC_TEXT, (FOUR_REC_TEXT) =>
           {

               IField FOUR_REC_NUM_local = FOUR_REC_TEXT.CreateNewField(Names.FOUR_REC_NUM, FieldType.UnsignedNumeric, 8);
               FOUR_REC_TEXT.CreateNewFieldRedefine(Names.FOUR_REC_REDF, FieldType.String, FOUR_REC_NUM_local, 8);
           });
    ...
    internal class SWEXPP01_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXPP01_ls_LinkageSection";
            ...
            internal const string CASH_RECEIPT_DETAIL_0003ET = "CASH_RECEIPT_DETAIL_0003ET";
            internal const string INTERFACE_TRANS_ID_0003AS = "INTERFACE_TRANS_ID_0003AS";
            internal const string INTERFACE_TRANS_ID_0003 = "INTERFACE_TRANS_ID_0003";
            internal const string INTERFACE_TRANS_ID_0003XX = "INTERFACE_TRANS_ID_0003XX";
            ...
            internal const string INTERFACE_TRANS_ID_0004AS = "INTERFACE_TRANS_ID_0004AS";
            internal const string INTERFACE_TRANS_ID_0004 = "INTERFACE_TRANS_ID_0004";
            internal const string INTERFACE_TRANS_ID_0004XX = "INTERFACE_TRANS_ID_0004XX";
        }
        #endregion
        ...
        public IGroup CASH_RECEIPT_DETAIL_0003ET { get { return GetElementByName<IGroup>(Names.CASH_RECEIPT_DETAIL_0003ET); } }
        public IField INTERFACE_TRANS_ID_0003AS { get { return GetElementByName<IField>(Names.INTERFACE_TRANS_ID_0003AS); } }
        public IField INTERFACE_TRANS_ID_0003 { get { return GetElementByName<IField>(Names.INTERFACE_TRANS_ID_0003); } }
        public IField INTERFACE_TRANS_ID_0003XX { get { return GetElementByName<IField>(Names.INTERFACE_TRANS_ID_0003XX); } }
        ...
        public IField INTERFACE_TRANS_ID_0004AS { get { return GetElementByName<IField>(Names.INTERFACE_TRANS_ID_0004AS); } }
        public IField INTERFACE_TRANS_ID_0004 { get { return GetElementByName<IField>(Names.INTERFACE_TRANS_ID_0004); } }
        public IField INTERFACE_TRANS_ID_0004XX { get { return GetElementByName<IField>(Names.INTERFACE_TRANS_ID_0004XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_FROM_0003EV.CreateNewGroup(Names.CASH_RECEIPT_DETAIL_0003ET, (CASH_RECEIPT_DETAIL_0003ET) =>
               {
                   CASH_RECEIPT_DETAIL_0003ET.CreateNewField(Names.INTERFACE_TRANS_ID_0003AS, FieldType.String, 1);

                   IField INTERFACE_TRANS_ID_0003_local = CASH_RECEIPT_DETAIL_0003ET.CreateNewField(Names.INTERFACE_TRANS_ID_0003, FieldType.String, 14);
                   CASH_RECEIPT_DETAIL_0003ET.CreateNewFieldRedefine(Names.INTERFACE_TRANS_ID_0003XX, FieldType.String, INTERFACE_TRANS_ID_0003_local, 14);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_TO_0004EV, (EXPORT_TO_0004EV) =>
           {
               EXPORT_TO_0004EV.CreateNewGroup(Names.CASH_RECEIPT_DETAIL_0004ET, (CASH_RECEIPT_DETAIL_0004ET) =>
               {
                   CASH_RECEIPT_DETAIL_0004ET.CreateNewField(Names.INTERFACE_TRANS_ID_0004AS, FieldType.String, 1);

                   IField INTERFACE_TRANS_ID_0004_local = CASH_RECEIPT_DETAIL_0004ET.CreateNewField(Names.INTERFACE_TRANS_ID_0004, FieldType.String, 14);
                   CASH_RECEIPT_DETAIL_0004ET.CreateNewFieldRedefine(Names.INTERFACE_TRANS_ID_0004XX, FieldType.String, INTERFACE_TRANS_ID_0004_local, 14);
               });
           });
    ...
    public class SWEXPP01 : EABBase
    {
        ...
        public SWEXPP01()
            : base()
        {
            this.ProgramName.SetValue("SWEXPP01");

            WS = new SWEXPP01_ws();
            FD = new SWEXPP01_fd(WS);
            LS = new SWEXPP01_ls();
        }
        ...
        private SWEXPP01_ws WS;

        //==== File Data Class ========================================
        private SWEXPP01_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXPP01_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-FROM-0003EV , EXPORT-TO-0004EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1141640603(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1141640603
        /// </summary>
        private void M_MAIN_1141640603(string returnMethod = "")
        {
            M_PARA_1141640603_INIT("M_PARA_1141640603_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1141640603-INIT THRU PARA-1141640603-INIT-EXIT
            M_PARA_1141640603("M_PARA_1141640603_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1141640603 THRU PARA-1141640603-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1141640603
        /// </summary>
        private void M_PARA_1141640603(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1141640603") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            FD.FOUR_REC_FILE.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT FOUR-REC-FILE
            if (WS.FOUR_REC_STATUS.IsEqualTo("00"))                                                             //COBOL==> IF FOUR-REC-STATUS = '00'
            {
                LS.TEXT_RETURN_CODE_0002.SetValue("00");                                                            //COBOL==> MOVE '00' TO TEXT-RETURN-CODE-0002
            }                                                                                                   //COBOL==> ELSE
            else
        ...
        {
            FD.FOUR_REC_FILE.ReadLine();                                                                        //COBOL==> READ FOUR-REC-FILE
                                                                                                                // EvaluateList !WS.FOUR_REC_STATUS!                                                                //COBOL==> EVALUATE FOUR-REC-STATUS
            if ((WS.FOUR_REC_STATUS.IsEqualTo("00")))                                                           //COBOL==> WHEN '00'
            {
                M_2500_MOVE_DATA("M_2500_EXIT"); if (Control.ExitProgram) { return; }                                 //COBOL==> PERFORM 2500-MOVE-DATA THRU 2500-EXIT
            }                                                                                                //COBOL==> WHEN '10'
            else
            if ((WS.FOUR_REC_STATUS.IsEqualTo("10")))
            {
        ...
        {
            WS.FOUR_REC_NUM.SetValue(FD.FOUR_REC_FROM);                                                         //COBOL==> MOVE FOUR-REC-FROM TO FOUR-REC-NUM.
            WS.FOUR_REC_EIGHT.SetValue(WS.FOUR_REC_REDF);                                                       //COBOL==> MOVE FOUR-REC-REDF TO FOUR-REC-EIGHT.
            LS.INTERFACE_TRANS_ID_0003.SetValue(WS.FOUR_REC_CONV);                                              //COBOL==> MOVE FOUR-REC-CONV TO INTERFACE-TRANS-ID-0003.
            WS.FOUR_REC_NUM.SetValue(FD.FOUR_REC_TO);                                                           //COBOL==> MOVE FOUR-REC-TO TO FOUR-REC-NUM.
            WS.FOUR_REC_EIGHT.SetValue(WS.FOUR_REC_REDF);                                                       //COBOL==> MOVE FOUR-REC-REDF TO FOUR-REC-EIGHT.
            LS.INTERFACE_TRANS_ID_0004.SetValue(WS.FOUR_REC_CONV);                                              //COBOL==> MOVE FOUR-REC-CONV TO INTERFACE-TRANS-ID-0004.
        ...
        private void M_2500_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_2500_EXIT") { M_3000_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            FD.FOUR_REC_FILE.CloseFile();                                                                       //COBOL==> CLOSE FOUR-REC-FILE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1141640603_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1141640603_EXIT
        /// </summary>
        private void M_PARA_1141640603_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1141640603_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1141640603_EXIT") { M_PARA_1141640603_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1141640603_INIT
        /// </summary>
        private void M_PARA_1141640603_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1141640603_INIT") { M_PARA_1141640603_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1141640603_INIT_EXIT
        /// </summary>
        private void M_PARA_1141640603_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1141640603_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
