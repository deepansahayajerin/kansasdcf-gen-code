...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:42:12 PM
   **        *   FROM COBOL PGM   :  SWEX375W
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: SP_EAB_B375_FILE_EXTRACT         DATE: 2001/06/05
       TARGET OS:   MVS                       TIME: 08:38:07
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEX375W_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEX375W_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.FILEREC, FieldType.String, 152);
        ...
        public override void Initialize()
        {
            ...
            EXTRACT_FILE = FileHandler.GetFile("EXTRFLE");
            EXTRACT_FILE.StatusField = WS.WS_FILE_STATUS;
            EXTRACT_FILE.AssociatedBuffer = FILEREC;
        }
        #endregion

        #region Constructors
        public SWEX375W_fd(SWEX375W_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEX375W_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEX375W_ws_WorkingStorage";
            internal const string WS_FILE_STATUS = "WS_FILE_STATUS";
            internal const string WS_EXTRACT_RECORD = "WS_EXTRACT_RECORD";
            internal const string WS_CASE_NUMBER = "WS_CASE_NUMBER";
            internal const string WS_CO_FORMATTED_NAME = "WS_CO_FORMATTED_NAME";
            internal const string WS_SS_FORMATTED_NAME = "WS_SS_FORMATTED_NAME";
            internal const string WS_OFFICE_NAME = "WS_OFFICE_NAME";
            internal const string WS_AP_FORMATTED_NAME = "WS_AP_FORMATTED_NAME";
            internal const string WS_REVIEW_DATE = "WS_REVIEW_DATE";
        }
        #endregion

        #region Direct-access element properties
        public IField WS_FILE_STATUS { get { return GetElementByName<IField>(Names.WS_FILE_STATUS); } }
        public IGroup WS_EXTRACT_RECORD { get { return GetElementByName<IGroup>(Names.WS_EXTRACT_RECORD); } }
        public IField WS_CASE_NUMBER { get { return GetElementByName<IField>(Names.WS_CASE_NUMBER); } }
        public IField WS_CO_FORMATTED_NAME { get { return GetElementByName<IField>(Names.WS_CO_FORMATTED_NAME); } }
        public IField WS_SS_FORMATTED_NAME { get { return GetElementByName<IField>(Names.WS_SS_FORMATTED_NAME); } }
        public IField WS_OFFICE_NAME { get { return GetElementByName<IField>(Names.WS_OFFICE_NAME); } }
        public IField WS_AP_FORMATTED_NAME { get { return GetElementByName<IField>(Names.WS_AP_FORMATTED_NAME); } }
        public IField WS_REVIEW_DATE { get { return GetElementByName<IField>(Names.WS_REVIEW_DATE); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_EXTRACT_RECORD, (WS_EXTRACT_RECORD) =>
           {
               WS_EXTRACT_RECORD.CreateNewField(Names.WS_CASE_NUMBER, FieldType.String, 10);
               WS_EXTRACT_RECORD.CreateNewField(Names.WS_CO_FORMATTED_NAME, FieldType.String, 33);
               WS_EXTRACT_RECORD.CreateNewField(Names.WS_SS_FORMATTED_NAME, FieldType.String, 33);
               WS_EXTRACT_RECORD.CreateNewField(Names.WS_OFFICE_NAME, FieldType.String, 30);
               WS_EXTRACT_RECORD.CreateNewField(Names.WS_AP_FORMATTED_NAME, FieldType.String, 33);
               WS_EXTRACT_RECORD.CreateNewField(Names.WS_REVIEW_DATE, FieldType.String, 8);
               WS_EXTRACT_RECORD.CreateNewFillerField(5, FillWith.Hashes);
           });
    ...
    internal class SWEX375W_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEX375W_ls_LinkageSection";
            ...
            internal const string IMPORT_CO_0003EV = "IMPORT_CO_0003EV";
            ...
            internal const string IMPORT_SS_0004EV = "IMPORT_SS_0004EV";
            ...
            internal const string IMPORT_REVIEW_0007EV = "IMPORT_REVIEW_0007EV";
            internal const string DATE_WORK_AREA_0007ET = "DATE_WORK_AREA_0007ET";
            internal const string TEXT_DATE_0007AS = "TEXT_DATE_0007AS";
            internal const string TEXT_DATE_0007 = "TEXT_DATE_0007";
            internal const string TEXT_DATE_0007XX = "TEXT_DATE_0007XX";
        ...
        public IGroup IMPORT_CO_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_CO_0003EV); } }
        ...
        public IGroup IMPORT_SS_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_SS_0004EV); } }
        ...
        public IField FORMATTED_NAME_0006AS { get { return GetElementByName<IField>(Names.FORMATTED_NAME_0006AS); } }
        public IField FORMATTED_NAME_0006 { get { return GetElementByName<IField>(Names.FORMATTED_NAME_0006); } }
        public IField FORMATTED_NAME_0006XX { get { return GetElementByName<IField>(Names.FORMATTED_NAME_0006XX); } }
        public IGroup IMPORT_REVIEW_0007EV { get { return GetElementByName<IGroup>(Names.IMPORT_REVIEW_0007EV); } }
        public IGroup DATE_WORK_AREA_0007ET { get { return GetElementByName<IGroup>(Names.DATE_WORK_AREA_0007ET); } }
        public IField TEXT_DATE_0007AS { get { return GetElementByName<IField>(Names.TEXT_DATE_0007AS); } }
        public IField TEXT_DATE_0007 { get { return GetElementByName<IField>(Names.TEXT_DATE_0007); } }
        public IField TEXT_DATE_0007XX { get { return GetElementByName<IField>(Names.TEXT_DATE_0007XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0002EV, (IMPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CO_0003EV, (IMPORT_CO_0003EV) =>
           {
               IMPORT_CO_0003EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0003ET, (CSE_PERSONS_WORK_SET_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_SS_0004EV, (IMPORT_SS_0004EV) =>
           {
               IMPORT_SS_0004EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0004ET, (CSE_PERSONS_WORK_SET_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0005EV, (IMPORT_0005EV) =>
           {
               ...
               {
                   OFFICE_0005ET.CreateNewField(Names.NAME_0005AS, FieldType.String, 1);

                   IField NAME_0005_local = OFFICE_0005ET.CreateNewField(Names.NAME_0005, FieldType.String, 30);
                   OFFICE_0005ET.CreateNewFieldRedefine(Names.NAME_0005XX, FieldType.String, NAME_0005_local, 30);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.IMPORT_AP_0006EV, (IMPORT_AP_0006EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_REVIEW_0007EV, (IMPORT_REVIEW_0007EV) =>
           {
               IMPORT_REVIEW_0007EV.CreateNewGroup(Names.DATE_WORK_AREA_0007ET, (DATE_WORK_AREA_0007ET) =>
               {
                   DATE_WORK_AREA_0007ET.CreateNewField(Names.TEXT_DATE_0007AS, FieldType.String, 1);

                   IField TEXT_DATE_0007_local = DATE_WORK_AREA_0007ET.CreateNewField(Names.TEXT_DATE_0007, FieldType.String, 8);
                   DATE_WORK_AREA_0007ET.CreateNewFieldRedefine(Names.TEXT_DATE_0007XX, FieldType.String, TEXT_DATE_0007_local, 8);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_CO_0003EV, args, 5);
            SetPassedParm(IMPORT_SS_0004EV, args, 6);
            SetPassedParm(IMPORT_0005EV, args, 7);
            SetPassedParm(IMPORT_AP_0006EV, args, 8);
            SetPassedParm(IMPORT_REVIEW_0007EV, args, 9);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_CO_0003EV, args, 5);
            SetReturnParm(IMPORT_SS_0004EV, args, 6);
            SetReturnParm(IMPORT_0005EV, args, 7);
            SetReturnParm(IMPORT_AP_0006EV, args, 8);
            SetReturnParm(IMPORT_REVIEW_0007EV, args, 9);
    ...
    public class SWEX375W : EABBase
    {
        ...
        public SWEX375W()
            : base()
        {
            this.ProgramName.SetValue("SWEX375W");

            WS = new SWEX375W_ws();
            FD = new SWEX375W_fd(WS);
            LS = new SWEX375W_ls();
        }
        ...
        private SWEX375W_ws WS;

        //==== File Data Class ========================================
        private SWEX375W_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEX375W_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-CO-0003EV , IMPORT-SS-0004EV , IMPORT-0005EV , IMPORT-AP-0006EV , IMPORT-REVIEW-0007EV , EXPORT-0008EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0906233140(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0906233140
        /// </summary>
        private void M_MAIN_0906233140(string returnMethod = "")
        {
            M_PARA_0906233140_INIT("M_PARA_0906233140_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0906233140-INIT THRU PARA-0906233140-INIT-EXIT.
            M_PARA_0906233140("M_PARA_0906233140_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0906233140 THRU PARA-0906233140-EXIT.
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0906233140
        /// </summary>
        private void M_PARA_0906233140(string returnMethod = "")
        {
            ...
            if ((LS.ACTION_ENTRY_0001.IsEqualTo("WR")))
            {
                M_PARA_MOVE_DATA("M_PARA_MOVE_DATA_EXIT"); if (Control.ExitProgram) { return; }                       //COBOL==> PERFORM PARA-MOVE-DATA THRU PARA-MOVE-DATA-EXIT
                FD.EXTRACT_FILE.WriteLine(WS.WS_EXTRACT_RECORD.AsBytes);                                            //COBOL==> WRITE FILEREC FROM WS-EXTRACT-RECORD
            }                                                                                                //COBOL==> WHEN 'CL'
            else
            ...
            {
                LS.STATUS_0008.SetValue(WS.WS_FILE_STATUS);                                                         //COBOL==> MOVE WS-FILE-STATUS TO STATUS-0008
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.STATUS_0008.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0008
            }                                                                                                   //COBOL==> END-IF.
            if (returnMethod != "" && returnMethod != "M_PARA_0906233140") { M_PARA_0906233140_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0906233140_EXIT
        /// </summary>
        private void M_PARA_0906233140_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0906233140_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0906233140_EXIT") { M_PARA_0906233140_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0906233140_INIT
        /// </summary>
        private void M_PARA_0906233140_INIT(string returnMethod = "")
        {
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV.
            if (returnMethod != "" && returnMethod != "M_PARA_0906233140_INIT") { M_PARA_0906233140_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0906233140_INIT_EXIT
        /// </summary>
        private void M_PARA_0906233140_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0906233140_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0906233140_INIT_EXIT") { M_PARA_MOVE_DATA(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MOVE_DATA
        /// </summary>
        private void M_PARA_MOVE_DATA(string returnMethod = "")
        {
            WS.WS_CASE_NUMBER.SetValue(LS.NUMBER_0002);                                                         //COBOL==> MOVE NUMBER-0002 TO WS-CASE-NUMBER.
            WS.WS_CO_FORMATTED_NAME.SetValue(LS.FORMATTED_NAME_0003);                                           //COBOL==> MOVE FORMATTED-NAME-0003 TO WS-CO-FORMATTED-NAME.
            WS.WS_SS_FORMATTED_NAME.SetValue(LS.FORMATTED_NAME_0004);                                           //COBOL==> MOVE FORMATTED-NAME-0004 TO WS-SS-FORMATTED-NAME.
            WS.WS_OFFICE_NAME.SetValue(LS.NAME_0005);                                                           //COBOL==> MOVE NAME-0005 TO WS-OFFICE-NAME.
            WS.WS_AP_FORMATTED_NAME.SetValue(LS.FORMATTED_NAME_0006);                                           //COBOL==> MOVE FORMATTED-NAME-0006 TO WS-AP-FORMATTED-NAME.
            WS.WS_REVIEW_DATE.SetValue(LS.TEXT_DATE_0007);                                                      //COBOL==> MOVE TEXT-DATE-0007 TO WS-REVIEW-DATE.
            if (returnMethod != "" && returnMethod != "M_PARA_MOVE_DATA") { M_PARA_MOVE_DATA_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MOVE_DATA_EXIT
        /// </summary>
        private void M_PARA_MOVE_DATA_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_MOVE_DATA_EXIT") { return; }                                            //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
