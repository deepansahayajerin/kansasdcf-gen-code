...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:45:22 PM
   **        *   FROM COBOL PGM   :  SWEXEW34
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2020 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: EAB_EXTERNAL_REPORT_WRITER_LARGE DATE: 2020/01/28
       TARGET OS:   MVS                       TIME: 14:57:12
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW34_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW34_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.ARSTOUT_RECORD, FieldType.String, 200);
        ...
        #region Constructors
        public SWEXEW34_fd(SWEXEW34_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW34_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW34_ws_WorkingStorage";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_ARSTOUT.CreateNewField(Names.RECOUT, FieldType.String, 200);
           });

            recordDef.CreateNewGroup(Names.WS_DETAIL, (WS_DETAIL) =>
           {
               WS_DETAIL.CreateNewField(Names.RECORD_DETL, FieldType.String, 200);
           });
    ...
    internal class SWEXEW34_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW34_ls_LinkageSection";
            ...
            internal const string IMPORT_RTP_DETAIL_0002EV = "IMPORT_RTP_DETAIL_0002EV";
        ...
        public IGroup IMPORT_RTP_DETAIL_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_RTP_DETAIL_0002EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_RTP_DETAIL_0002EV, (IMPORT_RTP_DETAIL_0002EV) =>
           {
               IMPORT_RTP_DETAIL_0002EV.CreateNewGroup(Names.WORK_AREA_0002ET, (WORK_AREA_0002ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_RTP_DETAIL_0002EV, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_RTP_DETAIL_0002EV, args, 4);
    ...
    public class SWEXEW34 : EABBase
    {
        ...
        public SWEXEW34()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW34");

            WS = new SWEXEW34_ws();
            FD = new SWEXEW34_fd(WS);
            LS = new SWEXEW34_ls();
        }
        ...
        private SWEXEW34_ws WS;

        //==== File Data Class ========================================
        private SWEXEW34_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW34_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-RTP-DETAIL-0002EV , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1832596784(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1832596784
        /// </summary>
        private void M_MAIN_1832596784(string returnMethod = "")
        {
            M_PARA_1832596784_INIT("M_PARA_1832596784_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1832596784-INIT THRU PARA-1832596784-INIT-EXIT
            M_PARA_1832596784("M_PARA_1832596784_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1832596784 THRU PARA-1832596784-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1832596784
        /// </summary>
        private void M_PARA_1832596784(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF96 IS A PART OF SWEXEW34*
            //COMMENT: ******************************************
        ...
        {
            WS.RECOUT.SetValue(LS.TEXT_200_0002);                                                               //COBOL==> MOVE TEXT-200-0002 TO RECOUT
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1832596784_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832596784_EXIT
        /// </summary>
        private void M_PARA_1832596784_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832596784_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1832596784_EXIT") { M_PARA_1832596784_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832596784_INIT
        /// </summary>
        private void M_PARA_1832596784_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1832596784_INIT") { M_PARA_1832596784_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832596784_INIT_EXIT
        /// </summary>
        private void M_PARA_1832596784_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832596784_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
