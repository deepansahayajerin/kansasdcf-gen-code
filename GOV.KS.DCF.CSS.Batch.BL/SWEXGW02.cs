...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: SP_EAB_B730_PROCESS_INPUT_FILE   DATE: 2003/06/09
       TARGET OS:   MVS                       TIME: 07:30:24
       TARGET DBMS: DB2                       USER: SWDPBEL
       GENERATION OPTIONS:
   ...
   **************************************************************
    12/5/11 RMATHEWS CQ31405 MODIFIED TO PROCESS LEGAL ACTION ID
    6/10/13 RMATHEWS CQ39342 MODIFIED TO PROCESS CHILD'S NUMBER
   **************************************************************
*/
#endregion
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGW02_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGW02_fd_FileSection";
            internal const string IN_FILE = "IN_FILE";
            internal const string IN_REC = "IN_REC";
            internal const string IN_REC_DATA = "IN_REC_DATA";
            internal const string IN_REC_PERSON_NUMBER = "IN_REC_PERSON_NUMBER";
            internal const string FILLER_1 = "FILLER_1";
            internal const string IN_REC_CASE_NUMBER = "IN_REC_CASE_NUMBER";
            internal const string FILLER_2 = "FILLER_2";
            internal const string IN_REC_CASE_ROLE = "IN_REC_CASE_ROLE";
            internal const string FILLER_3 = "FILLER_3";
            internal const string IN_REC_LEG_ACT_ID = "IN_REC_LEG_ACT_ID";
            internal const string FILLER_4 = "FILLER_4";
            internal const string IN_REC_CH_PERS_NUM = "IN_REC_CH_PERS_NUM";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink IN_FILE { get; set; }
        public IGroup IN_REC { get { return GetElementByName<IGroup>(Names.IN_REC); } }
        public IGroup IN_REC_DATA { get { return GetElementByName<IGroup>(Names.IN_REC_DATA); } }
        public IField IN_REC_PERSON_NUMBER { get { return GetElementByName<IField>(Names.IN_REC_PERSON_NUMBER); } }
        public IField FILLER_1 { get { return GetElementByName<IField>(Names.FILLER_1); } }
        public IField IN_REC_CASE_NUMBER { get { return GetElementByName<IField>(Names.IN_REC_CASE_NUMBER); } }
        public IField FILLER_2 { get { return GetElementByName<IField>(Names.FILLER_2); } }
        public IField IN_REC_CASE_ROLE { get { return GetElementByName<IField>(Names.IN_REC_CASE_ROLE); } }
        public IField FILLER_3 { get { return GetElementByName<IField>(Names.FILLER_3); } }
        public IField IN_REC_LEG_ACT_ID { get { return GetElementByName<IField>(Names.IN_REC_LEG_ACT_ID); } }
        public IField FILLER_4 { get { return GetElementByName<IField>(Names.FILLER_4); } }
        public IField IN_REC_CH_PERS_NUM { get { return GetElementByName<IField>(Names.IN_REC_CH_PERS_NUM); } }


        internal SWEXGW02_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IN_REC, (IN_REC) =>
           {
               IN_REC.CreateNewGroup(Names.IN_REC_DATA, (IN_REC_DATA) =>
               {
                   IN_REC_DATA.CreateNewField(Names.IN_REC_PERSON_NUMBER, FieldType.String, 10);
                   IN_REC_DATA.CreateNewField(Names.FILLER_1, FieldType.String, 1);
                   IN_REC_DATA.CreateNewField(Names.IN_REC_CASE_NUMBER, FieldType.String, 10);
                   IN_REC_DATA.CreateNewField(Names.FILLER_2, FieldType.String, 1);
                   IN_REC_DATA.CreateNewField(Names.IN_REC_CASE_ROLE, FieldType.String, 2);
                   IN_REC_DATA.CreateNewField(Names.FILLER_3, FieldType.String, 1);
                   IN_REC_DATA.CreateNewField(Names.IN_REC_LEG_ACT_ID, FieldType.UnsignedNumeric, 9);
                   IN_REC_DATA.CreateNewField(Names.FILLER_4, FieldType.String, 1);
                   IN_REC_DATA.CreateNewField(Names.IN_REC_CH_PERS_NUM, FieldType.String, 10);
                   IN_REC_DATA.CreateNewFillerField(88, FillWith.Hashes);
               });
           });
        ...
        public override void Initialize()
        {
            ...
            IN_FILE = FileHandler.GetFile("INFL");
            IN_FILE.StatusField = WS.IN_FILE_STAT;
            IN_FILE.AssociatedBuffer = IN_REC;
        }
        #endregion

        #region Constructors
        public SWEXGW02_fd(SWEXGW02_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXGW02_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGW02_ws_WorkingStorage";
            internal const string IN_FILE_STAT = "IN_FILE_STAT";
        }
        #endregion

        #region Direct-access element properties
        public IField IN_FILE_STAT { get { return GetElementByName<IField>(Names.IN_FILE_STAT); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewField(Names.IN_FILE_STAT, FieldType.String, 2);
    ...
    internal class SWEXGW02_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGW02_ls_LinkageSection";
            ...
            internal const string EXPORT_CHILD_0007EV = "EXPORT_CHILD_0007EV";
            internal const string CSE_PERSON_0007EV = "CSE_PERSON_0007EV";
            ...
            internal const string CASE_ROLE_0002ET = "CASE_ROLE_0002ET";
        ...
        public IGroup EXPORT_CHILD_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_CHILD_0007EV); } }
        public IGroup CSE_PERSON_0007EV { get { return GetElementByName<IGroup>(Names.CSE_PERSON_0007EV); } }
        ...
        public IGroup CASE_ROLE_0002ET { get { return GetElementByName<IGroup>(Names.CASE_ROLE_0002ET); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_CHILD_0007EV, (EXPORT_CHILD_0007EV) =>
           {
               EXPORT_CHILD_0007EV.CreateNewGroup(Names.CSE_PERSON_0007EV, (CSE_PERSON_0007EV) =>
               {
                   CSE_PERSON_0007EV.CreateNewField(Names.NUMBER_0007AS, FieldType.String, 1);

                   IField NUMBER_0007_local = CSE_PERSON_0007EV.CreateNewField(Names.NUMBER_0007, FieldType.String, 10);
                   CSE_PERSON_0007EV.CreateNewFieldRedefine(Names.NUMBER_0007XX, FieldType.String, NUMBER_0007_local, 10);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0006EV, (EXPORT_0006EV) =>
           {
               EXPORT_0006EV.CreateNewGroup(Names.LEGAL_ACTION_0006ET, (LEGAL_ACTION_0006ET) =>
               {
                   LEGAL_ACTION_0006ET.CreateNewField(Names.IDENTIFIER_0006AS, FieldType.String, 1);

                   IField IDENTIFIER_0006_local = LEGAL_ACTION_0006ET.CreateNewField(Names.IDENTIFIER_0006, FieldType.UnsignedNumeric, 9);
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.CASE_ROLE_0002ET, (CASE_ROLE_0002ET) =>
               {
                   CASE_ROLE_0002ET.CreateNewField(Names.TYPE_0002AS, FieldType.String, 1);

                   IField TYPE_0002_local = CASE_ROLE_0002ET.CreateNewField(Names.TYPE_0002, FieldType.String, 2);
                   CASE_ROLE_0002ET.CreateNewFieldRedefine(Names.TYPE_0002XX, FieldType.String, TYPE_0002_local, 2);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_CHILD_0007EV, args, 4);
            SetPassedParm(EXPORT_0006EV, args, 5);
            SetPassedParm(EXPORT_0002EV, args, 6);
            SetPassedParm(EXPORT_0003EV, args, 7);
            SetPassedParm(EXPORT_0004EV, args, 8);
            SetPassedParm(EXPORT_0005EV, args, 9);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_CHILD_0007EV, args, 4);
            SetReturnParm(EXPORT_0006EV, args, 5);
            SetReturnParm(EXPORT_0002EV, args, 6);
            SetReturnParm(EXPORT_0003EV, args, 7);
            SetReturnParm(EXPORT_0004EV, args, 8);
            SetReturnParm(EXPORT_0005EV, args, 9);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXGW02 : EABBase
    {
        ...
        public SWEXGW02()
            : base()
        {
            this.ProgramName.SetValue("SWEXGW02");

            WS = new SWEXGW02_ws();
            FD = new SWEXGW02_fd(WS);
            LS = new SWEXGW02_ls();
        }
        ...
        private SWEXGW02_ws WS;

        //==== File Data Class ========================================
        private SWEXGW02_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGW02_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-CHILD-0007EV , EXPORT-0006EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-0004EV , EXPORT-0005EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0114299870(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0114299870
        /// </summary>
        private void M_MAIN_0114299870(string returnMethod = "")
        {
            M_PARA_0114299870_INIT("M_PARA_0114299870_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0114299870-INIT THRU PARA-0114299870-INIT-EXIT
            M_PARA_0114299870("M_PARA_0114299870_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0114299870 THRU PARA-0114299870-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0114299870
        /// </summary>
        private void M_PARA_0114299870(string returnMethod = "")
        {
            // EvaluateList !LS.ACTION_0001!                                                                    //COBOL==> EVALUATE ACTION-0001
            if ((LS.ACTION_0001.IsEqualTo("OPEN")))                                                             //COBOL==> WHEN 'OPEN'
            {
                FD.IN_FILE.OpenFile(FileAccessMode.Read);                                                           //COBOL==> OPEN INPUT IN-FILE
                if (WS.IN_FILE_STAT.IsEqualTo("00"))                                                                //COBOL==> IF IN-FILE-STAT = '00'
                {
                    LS.STATUS_0005.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0005
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    LS.STATUS_0005.SetValue(WS.IN_FILE_STAT);                                                           //COBOL==> MOVE IN-FILE-STAT TO STATUS-0005
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                //COBOL==> WHEN 'READ'
            else
            if ((LS.ACTION_0001.IsEqualTo("READ")))
            {
                FD.IN_FILE.ReadLine();                                                                              //COBOL==> READ IN-FILE
                LS.NUMBER_0004.SetValue(FD.IN_REC_PERSON_NUMBER);                                                   //COBOL==> MOVE IN-REC-PERSON-NUMBER TO NUMBER-0004
                LS.NUMBER_0003.SetValue(FD.IN_REC_CASE_NUMBER);                                                     //COBOL==> MOVE IN-REC-CASE-NUMBER TO NUMBER-0003
                LS.TYPE_0002.SetValue(FD.IN_REC_CASE_ROLE);                                                         //COBOL==> MOVE IN-REC-CASE-ROLE TO TYPE-0002
                LS.IDENTIFIER_0006.SetValue(FD.IN_REC_LEG_ACT_ID);                                                  //COBOL==> MOVE IN-REC-LEG-ACT-ID TO IDENTIFIER-0006
                LS.NUMBER_0007.SetValue(FD.IN_REC_CH_PERS_NUM);                                                     //COBOL==> MOVE IN-REC-CH-PERS-NUM TO NUMBER-0007
                if (WS.IN_FILE_STAT.IsEqualTo("00"))                                                                //COBOL==> IF IN-FILE-STAT = '00'
                {
                    LS.STATUS_0005.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0005
                }                                                                                                   //COBOL==> ELSE
                ...
                {
                    if (WS.IN_FILE_STAT.IsEqualTo("10"))                                                                //COBOL==> IF IN-FILE-STAT = '10'
                    {
                        LS.STATUS_0005.SetValue("EOF");                                                                     //COBOL==> MOVE 'EOF' TO STATUS-0005
                    }                                                                                                   //COBOL==> ELSE
                    else
                    {
                        LS.STATUS_0005.SetValue(WS.IN_FILE_STAT);                                                           //COBOL==> MOVE IN-FILE-STAT TO STATUS-0005
            ...
            {
                FD.IN_FILE.CloseFile();                                                                             //COBOL==> CLOSE IN-FILE
                if (WS.IN_FILE_STAT.IsEqualTo("00"))                                                                //COBOL==> IF IN-FILE-STAT = '00'
                {
                    LS.STATUS_0005.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0005
                }                                                                                                   //COBOL==> ELSE
            ...
            {
                LS.STATUS_0005.SetValue("99");                                                                      //COBOL==> MOVE '99' TO STATUS-0005
            }                                                                                                   //COBOL==> END-EVALUATE.
            if (returnMethod != "" && returnMethod != "M_PARA_0114299870") { M_PARA_0114299870_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0114299870_EXIT
        /// </summary>
        private void M_PARA_0114299870_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0114299870_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0114299870_EXIT") { M_PARA_0114299870_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0114299870_INIT
        /// </summary>
        private void M_PARA_0114299870_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_CHILD_0007EV.ResetToInitialValue();                                                       //COBOL==> INITIALIZE EXPORT-CHILD-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0114299870_INIT") { M_PARA_0114299870_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0114299870_INIT_EXIT
        /// </summary>
        private void M_PARA_0114299870_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0114299870_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
