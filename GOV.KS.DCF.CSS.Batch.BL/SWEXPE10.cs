...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:54:12 PM
   **        *   FROM COBOL PGM   :  SWEXPE10
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: EAB_SP_B376_FILE_EXTRACT_READ    DATE: 2009/12/01
       TARGET OS:   MVS                       TIME: 08:21:52
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXPE10_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXPE10_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.INFILE_REC, FieldType.String, 151);
        ...
        public override void Initialize()
        {
            ...
            INFILE.StatusField = WS.EXTFILE_STAT;
            INFILE.AssociatedBuffer = INFILE_REC;
            INFILE.RecordLength = 151;
        }
        #endregion

        #region Constructors
        public SWEXPE10_fd(SWEXPE10_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXPE10_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXPE10_ws_WorkingStorage";
            internal const string EXTFILE_STAT = "EXTFILE_STAT";
            internal const string TEMPREC = "TEMPREC";
            internal const string OFFICE_ID = "OFFICE_ID";
            internal const string OFFICE_NAME = "OFFICE_NAME";
            internal const string SUPERVISOR_LAST_NM = "SUPERVISOR_LAST_NM";
            internal const string SUPERVISOR_FRST_NM = "SUPERVISOR_FRST_NM";
            internal const string SUPERVISOR_MID_NM = "SUPERVISOR_MID_NM";
            internal const string CO_OFFICER_LAST_NM = "CO_OFFICER_LAST_NM";
            internal const string CO_OFFICER_FRST_NM = "CO_OFFICER_FRST_NM";
            internal const string CO_OFFICER_MID_NM = "CO_OFFICER_MID_NM";
            internal const string DEL_OR_NOT_REVIEWED = "DEL_OR_NOT_REVIEWED";
            internal const string REVIEW_DATE = "REVIEW_DATE";
            internal const string CASE_NUMBER = "CASE_NUMBER";
            internal const string AP_NAME_LAST_NM = "AP_NAME_LAST_NM";
            internal const string AP_NAME_FRST_NM = "AP_NAME_FRST_NM";
            internal const string AP_NAME_MID_NM = "AP_NAME_MID_NM";
            internal const string CASE_OPEN_DATE = "CASE_OPEN_DATE";
        }
        #endregion

        #region Direct-access element properties
        public IField EXTFILE_STAT { get { return GetExternalElementByName<IField>(Names.EXTFILE_STAT); } }
        public IGroup TEMPREC { get { return GetElementByName<IGroup>(Names.TEMPREC); } }
        public IField OFFICE_ID { get { return GetElementByName<IField>(Names.OFFICE_ID); } }
        public IField OFFICE_NAME { get { return GetElementByName<IField>(Names.OFFICE_NAME); } }
        public IField SUPERVISOR_LAST_NM { get { return GetElementByName<IField>(Names.SUPERVISOR_LAST_NM); } }
        public IField SUPERVISOR_FRST_NM { get { return GetElementByName<IField>(Names.SUPERVISOR_FRST_NM); } }
        public IField SUPERVISOR_MID_NM { get { return GetElementByName<IField>(Names.SUPERVISOR_MID_NM); } }
        public IField CO_OFFICER_LAST_NM { get { return GetElementByName<IField>(Names.CO_OFFICER_LAST_NM); } }
        public IField CO_OFFICER_FRST_NM { get { return GetElementByName<IField>(Names.CO_OFFICER_FRST_NM); } }
        public IField CO_OFFICER_MID_NM { get { return GetElementByName<IField>(Names.CO_OFFICER_MID_NM); } }
        public IField DEL_OR_NOT_REVIEWED { get { return GetElementByName<IField>(Names.DEL_OR_NOT_REVIEWED); } }
        public IField REVIEW_DATE { get { return GetElementByName<IField>(Names.REVIEW_DATE); } }
        public IField CASE_NUMBER { get { return GetElementByName<IField>(Names.CASE_NUMBER); } }
        public IField AP_NAME_LAST_NM { get { return GetElementByName<IField>(Names.AP_NAME_LAST_NM); } }
        public IField AP_NAME_FRST_NM { get { return GetElementByName<IField>(Names.AP_NAME_FRST_NM); } }
        public IField AP_NAME_MID_NM { get { return GetElementByName<IField>(Names.AP_NAME_MID_NM); } }
        public IField CASE_OPEN_DATE { get { return GetElementByName<IField>(Names.CASE_OPEN_DATE); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.TEMPREC, (TEMPREC) =>
           {
               TEMPREC.CreateNewField(Names.OFFICE_ID, FieldType.String, 4);
               TEMPREC.CreateNewField(Names.OFFICE_NAME, FieldType.String, 30);
               TEMPREC.CreateNewField(Names.SUPERVISOR_LAST_NM, FieldType.String, 17);
               TEMPREC.CreateNewField(Names.SUPERVISOR_FRST_NM, FieldType.String, 12);
               TEMPREC.CreateNewField(Names.SUPERVISOR_MID_NM, FieldType.String, 1);
               TEMPREC.CreateNewField(Names.CO_OFFICER_LAST_NM, FieldType.String, 17);
               TEMPREC.CreateNewField(Names.CO_OFFICER_FRST_NM, FieldType.String, 12);
               TEMPREC.CreateNewField(Names.CO_OFFICER_MID_NM, FieldType.String, 1);
               TEMPREC.CreateNewField(Names.DEL_OR_NOT_REVIEWED, FieldType.String, 1);
               TEMPREC.CreateNewField(Names.REVIEW_DATE, FieldType.String, 8);
               TEMPREC.CreateNewField(Names.CASE_NUMBER, FieldType.String, 10);
               TEMPREC.CreateNewField(Names.AP_NAME_LAST_NM, FieldType.String, 17);
               TEMPREC.CreateNewField(Names.AP_NAME_FRST_NM, FieldType.String, 12);
               TEMPREC.CreateNewField(Names.AP_NAME_MID_NM, FieldType.String, 1);
               TEMPREC.CreateNewField(Names.CASE_OPEN_DATE, FieldType.String, 8);
           });
    ...
    internal class SWEXPE10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXPE10_ls_LinkageSection";
            ...
            internal const string ACTION_ENTRY_0001AS = "ACTION_ENTRY_0001AS";
            ...
            internal const string EXPORT_SS_0004EV = "EXPORT_SS_0004EV";
            ...
            internal const string EXPORT_CO_0005EV = "EXPORT_CO_0005EV";
            ...
            internal const string EXPORT_REVIEW_0006EV = "EXPORT_REVIEW_0006EV";
            ...
            internal const string EXPORT_AP_0007EV = "EXPORT_AP_0007EV";
            ...
            internal const string CASE_0008ET = "CASE_0008ET";
            ...
            internal const string CSE_OPEN_DATE_0008AS = "CSE_OPEN_DATE_0008AS";
            internal const string CSE_OPEN_DATE_0008 = "CSE_OPEN_DATE_0008";
            internal const string CSE_OPEN_DATE_0008XX = "CSE_OPEN_DATE_0008XX";
            internal const string EXPORT_DELINQUENT_OR_NE_0009EV = "EXPORT_DELINQUENT_OR_NE_0009EV";
            ...
            internal const string EXPORT_OFFICE_NUMBER_0010EV = "EXPORT_OFFICE_NUMBER_0010EV";
            internal const string TEXT_WORK_AREA_0010ET = "TEXT_WORK_AREA_0010ET";
            internal const string TEXT_4_0010AS = "TEXT_4_0010AS";
            internal const string TEXT_4_0010 = "TEXT_4_0010";
            internal const string TEXT_4_0010XX = "TEXT_4_0010XX";
            internal const string EXPORT_DELIN_DATE_TEXT_0011EV = "EXPORT_DELIN_DATE_TEXT_0011EV";
            internal const string DATE_WORK_AREA_0011ET = "DATE_WORK_AREA_0011ET";
            internal const string TEXT_DATE_0011AS = "TEXT_DATE_0011AS";
            internal const string TEXT_DATE_0011 = "TEXT_DATE_0011";
            internal const string TEXT_DATE_0011XX = "TEXT_DATE_0011XX";
        }
        #endregion
        ...
        public IField ACTION_ENTRY_0001AS { get { return GetElementByName<IField>(Names.ACTION_ENTRY_0001AS); } }
        ...
        public IGroup EXPORT_SS_0004EV { get { return GetElementByName<IGroup>(Names.EXPORT_SS_0004EV); } }
        ...
        public IGroup EXPORT_CO_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_CO_0005EV); } }
        ...
        public IGroup EXPORT_REVIEW_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_REVIEW_0006EV); } }
        ...
        public IGroup EXPORT_AP_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_AP_0007EV); } }
        ...
        public IGroup CASE_0008ET { get { return GetElementByName<IGroup>(Names.CASE_0008ET); } }
        ...
        public IField CSE_OPEN_DATE_0008AS { get { return GetElementByName<IField>(Names.CSE_OPEN_DATE_0008AS); } }
        public IField CSE_OPEN_DATE_0008 { get { return GetElementByName<IField>(Names.CSE_OPEN_DATE_0008); } }
        public IField CSE_OPEN_DATE_0008XX { get { return GetElementByName<IField>(Names.CSE_OPEN_DATE_0008XX); } }
        public IGroup EXPORT_DELINQUENT_OR_NE_0009EV { get { return GetElementByName<IGroup>(Names.EXPORT_DELINQUENT_OR_NE_0009EV); } }
        ...
        public IGroup EXPORT_OFFICE_NUMBER_0010EV { get { return GetElementByName<IGroup>(Names.EXPORT_OFFICE_NUMBER_0010EV); } }
        public IGroup TEXT_WORK_AREA_0010ET { get { return GetElementByName<IGroup>(Names.TEXT_WORK_AREA_0010ET); } }
        public IField TEXT_4_0010AS { get { return GetElementByName<IField>(Names.TEXT_4_0010AS); } }
        public IField TEXT_4_0010 { get { return GetElementByName<IField>(Names.TEXT_4_0010); } }
        public IField TEXT_4_0010XX { get { return GetElementByName<IField>(Names.TEXT_4_0010XX); } }
        public IGroup EXPORT_DELIN_DATE_TEXT_0011EV { get { return GetElementByName<IGroup>(Names.EXPORT_DELIN_DATE_TEXT_0011EV); } }
        public IGroup DATE_WORK_AREA_0011ET { get { return GetElementByName<IGroup>(Names.DATE_WORK_AREA_0011ET); } }
        public IField TEXT_DATE_0011AS { get { return GetElementByName<IField>(Names.TEXT_DATE_0011AS); } }
        public IField TEXT_DATE_0011 { get { return GetElementByName<IField>(Names.TEXT_DATE_0011); } }
        public IField TEXT_DATE_0011XX { get { return GetElementByName<IField>(Names.TEXT_DATE_0011XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.IEF_SUPPLIED_0001ET, (IEF_SUPPLIED_0001ET) =>
               {
                   IEF_SUPPLIED_0001ET.CreateNewField(Names.ACTION_ENTRY_0001AS, FieldType.String, 1);
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0003EV, (EXPORT_0003EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_SS_0004EV, (EXPORT_SS_0004EV) =>
           {
               EXPORT_SS_0004EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0004ET, (CSE_PERSONS_WORK_SET_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_CO_0005EV, (EXPORT_CO_0005EV) =>
           {
               EXPORT_CO_0005EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0005ET, (CSE_PERSONS_WORK_SET_0005ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_REVIEW_0006EV, (EXPORT_REVIEW_0006EV) =>
           {
               EXPORT_REVIEW_0006EV.CreateNewGroup(Names.DATE_WORK_AREA_0006ET, (DATE_WORK_AREA_0006ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_AP_0007EV, (EXPORT_AP_0007EV) =>
           {
               EXPORT_AP_0007EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0007ET, (CSE_PERSONS_WORK_SET_0007ET) =>
               {
           ...
           {
               EXPORT_0008EV.CreateNewGroup(Names.CASE_0008ET, (CASE_0008ET) =>
               {
                   CASE_0008ET.CreateNewField(Names.NUMBER_0008AS, FieldType.String, 1);

                   IField NUMBER_0008_local = CASE_0008ET.CreateNewField(Names.NUMBER_0008, FieldType.String, 10);
                   CASE_0008ET.CreateNewFieldRedefine(Names.NUMBER_0008XX, FieldType.String, NUMBER_0008_local, 10);
                   CASE_0008ET.CreateNewField(Names.CSE_OPEN_DATE_0008AS, FieldType.String, 1);

                   IField CSE_OPEN_DATE_0008_local = CASE_0008ET.CreateNewField(Names.CSE_OPEN_DATE_0008, FieldType.SignedNumeric, 8);
                   CASE_0008ET.CreateNewFieldRedefine(Names.CSE_OPEN_DATE_0008XX, FieldType.String, CSE_OPEN_DATE_0008_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_DELINQUENT_OR_NE_0009EV, (EXPORT_DELINQUENT_OR_NE_0009EV) =>
           {
               EXPORT_DELINQUENT_OR_NE_0009EV.CreateNewGroup(Names.IEF_SUPPLIED_0009ET, (IEF_SUPPLIED_0009ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_OFFICE_NUMBER_0010EV, (EXPORT_OFFICE_NUMBER_0010EV) =>
           {
               EXPORT_OFFICE_NUMBER_0010EV.CreateNewGroup(Names.TEXT_WORK_AREA_0010ET, (TEXT_WORK_AREA_0010ET) =>
               {
                   TEXT_WORK_AREA_0010ET.CreateNewField(Names.TEXT_4_0010AS, FieldType.String, 1);

                   IField TEXT_4_0010_local = TEXT_WORK_AREA_0010ET.CreateNewField(Names.TEXT_4_0010, FieldType.String, 4);
                   TEXT_WORK_AREA_0010ET.CreateNewFieldRedefine(Names.TEXT_4_0010XX, FieldType.String, TEXT_4_0010_local, 4);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_DELIN_DATE_TEXT_0011EV, (EXPORT_DELIN_DATE_TEXT_0011EV) =>
           {
               EXPORT_DELIN_DATE_TEXT_0011EV.CreateNewGroup(Names.DATE_WORK_AREA_0011ET, (DATE_WORK_AREA_0011ET) =>
               {
                   DATE_WORK_AREA_0011ET.CreateNewField(Names.TEXT_DATE_0011AS, FieldType.String, 1);

                   IField TEXT_DATE_0011_local = DATE_WORK_AREA_0011ET.CreateNewField(Names.TEXT_DATE_0011, FieldType.String, 8);
                   DATE_WORK_AREA_0011ET.CreateNewFieldRedefine(Names.TEXT_DATE_0011XX, FieldType.String, TEXT_DATE_0011_local, 8);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_SS_0004EV, args, 6);
            SetPassedParm(EXPORT_CO_0005EV, args, 7);
            SetPassedParm(EXPORT_REVIEW_0006EV, args, 8);
            SetPassedParm(EXPORT_AP_0007EV, args, 9);
            SetPassedParm(EXPORT_0008EV, args, 10);
            SetPassedParm(EXPORT_DELINQUENT_OR_NE_0009EV, args, 11);
            SetPassedParm(EXPORT_OFFICE_NUMBER_0010EV, args, 12);
            SetPassedParm(EXPORT_DELIN_DATE_TEXT_0011EV, args, 13);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_SS_0004EV, args, 6);
            SetReturnParm(EXPORT_CO_0005EV, args, 7);
            SetReturnParm(EXPORT_REVIEW_0006EV, args, 8);
            SetReturnParm(EXPORT_AP_0007EV, args, 9);
            SetReturnParm(EXPORT_0008EV, args, 10);
            SetReturnParm(EXPORT_DELINQUENT_OR_NE_0009EV, args, 11);
            SetReturnParm(EXPORT_OFFICE_NUMBER_0010EV, args, 12);
            SetReturnParm(EXPORT_DELIN_DATE_TEXT_0011EV, args, 13);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXPE10 : EABBase
    {
        ...
        public SWEXPE10()
            : base()
        {
            this.ProgramName.SetValue("SWEXPE10");

            WS = new SWEXPE10_ws();
            FD = new SWEXPE10_fd(WS);
            LS = new SWEXPE10_ls();
        }
        ...
        private SWEXPE10_ws WS;

        //==== File Data Class ========================================
        private SWEXPE10_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXPE10_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-SS-0004EV , EXPORT-CO-0005EV , EXPORT-REVIEW-0006EV , EXPORT-AP-0007EV , EXPORT-0008EV , EXPORT-DELINQUENT-OR-NE-0009EV , EXPORT-OFFICE-NUMBER-0010EV , EXPORT-DELIN-DATE-TEXT-0011EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0297397101(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0297397101
        /// </summary>
        private void M_MAIN_0297397101(string returnMethod = "")
        {
            M_PARA_0297397101_INIT("M_PARA_0297397101_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0297397101-INIT THRU PARA-0297397101-INIT-EXIT
            M_PARA_0297397101("M_PARA_0297397101_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0297397101 THRU PARA-0297397101-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0297397101
        /// </summary>
        private void M_PARA_0297397101(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
                                                                                                                // EvaluateList !LS.ACTION_ENTRY_0001!                                                              //COBOL==> EVALUATE ACTION-ENTRY-0001
            if ((LS.ACTION_ENTRY_0001.IsEqualTo("OP")))                                                         //COBOL==> WHEN 'OP'
            {
            ...
            if ((LS.ACTION_ENTRY_0001.IsEqualTo("RD")))
            {
                M_6000_READ("M_6000_EXIT"); if (Control.ExitProgram) { return; }                                      //COBOL==> PERFORM 6000-READ THRU 6000-EXIT
            }                                                                                                //COBOL==> WHEN 'CL'
            else
            if ((LS.ACTION_ENTRY_0001.IsEqualTo("CL")))
            {
                M_8000_CLOSE("M_8000_EXIT"); if (Control.ExitProgram) { return; }                                     //COBOL==> PERFORM 8000-CLOSE THRU 8000-EXIT
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0002.SetValue("AB");                                                                      //COBOL==> MOVE 'AB' TO STATUS-0002
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        private void M_0100_INITIALIZE_AND_OPEN(string returnMethod = "")
        {
            ...
            if (WS.EXTFILE_STAT.IsEqualTo(0))                                                                   //COBOL==> IF EXTFILE-STAT = 0
            {
                LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_0100_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_0100_EXIT") { M_6000_READ(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_6000_READ
        /// </summary>
        ...
        {
            WS.TEMPREC.SetValue(FD.INFILE.ReadLineInto());                                                      //COBOL==> READ INFILE INTO TEMPREC.
            if (WS.EXTFILE_STAT.IsEqualTo(10))                                                                  //COBOL==> IF EXTFILE-STAT = 10
            {
                LS.STATUS_0002.SetValue("C");                                                                       //COBOL==> MOVE 'C' TO STATUS-0002
            ...
            {
                LS.STATUS_0002.SetValue("NOK");                                                                     //COBOL==> MOVE 'NOK' TO STATUS-0002
                M_6000_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 6000-EXIT
            }                                                                                                   //COBOL==> END-IF.
            LS.TEXT_4_0010.SetValue(WS.OFFICE_ID);                                                              //COBOL==> MOVE OFFICE-ID TO TEXT-4-0010
            LS.NAME_0003.SetValue(WS.OFFICE_NAME);                                                              //COBOL==> MOVE OFFICE-NAME TO NAME-0003
            LS.LAST_NAME_0004.SetValue(WS.SUPERVISOR_LAST_NM);                                                  //COBOL==> MOVE SUPERVISOR-LAST-NM TO LAST-NAME-0004
            LS.FIRST_NAME_0004.SetValue(WS.SUPERVISOR_FRST_NM);                                                 //COBOL==> MOVE SUPERVISOR-FRST-NM TO FIRST-NAME-0004
            LS.MIDDLE_INITIAL_0004.SetValue(WS.SUPERVISOR_MID_NM);                                              //COBOL==> MOVE SUPERVISOR-MID-NM TO MIDDLE-INITIAL-0004
            LS.LAST_NAME_0005.SetValue(WS.CO_OFFICER_LAST_NM);                                                  //COBOL==> MOVE CO-OFFICER-LAST-NM TO LAST-NAME-0005
            LS.FIRST_NAME_0005.SetValue(WS.CO_OFFICER_FRST_NM);                                                 //COBOL==> MOVE CO-OFFICER-FRST-NM TO FIRST-NAME-0005
            LS.MIDDLE_INITIAL_0005.SetValue(WS.CO_OFFICER_MID_NM);                                              //COBOL==> MOVE CO-OFFICER-MID-NM TO MIDDLE-INITIAL-0005
            LS.TEXT_DATE_0011.SetValue(WS.REVIEW_DATE);                                                         //COBOL==> MOVE REVIEW-DATE TO TEXT-DATE-0011
            LS.LAST_NAME_0007.SetValue(WS.AP_NAME_LAST_NM);                                                     //COBOL==> MOVE AP-NAME-LAST-NM TO LAST-NAME-0007
            LS.FIRST_NAME_0007.SetValue(WS.AP_NAME_FRST_NM);                                                    //COBOL==> MOVE AP-NAME-FRST-NM TO FIRST-NAME-0007
            LS.MIDDLE_INITIAL_0007.SetValue(WS.AP_NAME_MID_NM);                                                 //COBOL==> MOVE AP-NAME-MID-NM TO MIDDLE-INITIAL-0007
            LS.NUMBER_0008.SetValue(WS.CASE_NUMBER);                                                            //COBOL==> MOVE CASE-NUMBER TO NUMBER-0008
            LS.FLAG_0009.SetValue(WS.DEL_OR_NOT_REVIEWED);                                                      //COBOL==> MOVE DEL-OR-NOT-REVIEWED TO FLAG-0009
            LS.CSE_OPEN_DATE_0008.SetValue(WS.CASE_OPEN_DATE);                                                  //COBOL==> MOVE CASE-OPEN-DATE TO CSE-OPEN-DATE-0008.
        ...
        /// </summary>
        /// <remarks>
        ///COMMENT:     PERFORM 7000-MOVE-WS THRU 7000-EXIT.
        /// </remarks>
        private void M_6000_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_6000_EXIT") { return; }                                                      //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_6000_EXIT") { M_8000_CLOSE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_8000_CLOSE
        /// </summary>
        /// <remarks>
        ///COMMENT: 7000-MOVE-WS.
        ///COMMENT:     MOVE INFILE-REC             TO TEMPREC
        ///COMMENT: 7000-EXIT.
        ///COMMENT:     EXIT.
        /// </remarks>
        private void M_8000_CLOSE(string returnMethod = "")
        {
            FD.INFILE.CloseFile();                                                                              //COBOL==> CLOSE INFILE.
            if (returnMethod != "" && returnMethod != "M_8000_CLOSE") { M_8000_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_8000_EXIT
        /// </summary>
        private void M_8000_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_8000_EXIT") { M_9999_FINISHED(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0297397101_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0297397101_EXIT
        /// </summary>
        private void M_PARA_0297397101_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0297397101_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0297397101_EXIT") { M_PARA_0297397101_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0297397101_INIT
        /// </summary>
        private void M_PARA_0297397101_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_SS_0004EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-SS-0004EV
            LS.EXPORT_CO_0005EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-CO-0005EV
            LS.EXPORT_REVIEW_0006EV.ResetToInitialValue();                                                      //COBOL==> INITIALIZE EXPORT-REVIEW-0006EV
            LS.EXPORT_AP_0007EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-AP-0007EV
            LS.EXPORT_0008EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0008EV
            LS.EXPORT_DELINQUENT_OR_NE_0009EV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-DELINQUENT-OR-NE-0009EV
            LS.EXPORT_OFFICE_NUMBER_0010EV.ResetToInitialValue();                                               //COBOL==> INITIALIZE EXPORT-OFFICE-NUMBER-0010EV
            LS.EXPORT_DELIN_DATE_TEXT_0011EV.ResetToInitialValue();                                             //COBOL==> INITIALIZE EXPORT-DELIN-DATE-TEXT-0011EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0297397101_INIT") { M_PARA_0297397101_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0297397101_INIT_EXIT
        /// </summary>
        private void M_PARA_0297397101_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0297397101_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
