...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:27 PM
   **        *   FROM COBOL PGM   :  SWEXLR02
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_EAB_READ_B576_FILE_EXTRACT    DATE: 2009/04/28
       TARGET OS:   MVS                       TIME: 17:14:39
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXLR02_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLR02_fd_FileSection";
            internal const string CLFILE = "CLFILE";
            internal const string CL_REC = "CL_REC";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink CLFILE { get; set; }
        public IField CL_REC { get { return GetElementByName<IField>(Names.CL_REC); } }


        internal SWEXLR02_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.CL_REC, FieldType.String, 150);
        ...
        public override void Initialize()
        {
            ...
            CLFILE = FileHandler.GetFile("INFILE");
            CLFILE.StatusField = WS.CLFILE_STAT;
            CLFILE.AssociatedBuffer = CL_REC;
            CLFILE.RecordLength = 150;
        }
        #endregion

        #region Constructors
        public SWEXLR02_fd(SWEXLR02_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLR02_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLR02_ws_WorkingStorage";
            internal const string CLFILE_STAT = "CLFILE_STAT";
            internal const string WS_CL_REC = "WS_CL_REC";
            internal const string CL_REGION_CODE = "CL_REGION_CODE";
            internal const string CL_REGION_NAME = "CL_REGION_NAME";
            internal const string CL_OFF_ID = "CL_OFF_ID";
            internal const string CL_OFFICE_NAME = "CL_OFFICE_NAME";
            internal const string CL_SPD_ID = "CL_SPD_ID";
            internal const string CL_SPD_LAST_NAME = "CL_SPD_LAST_NAME";
            internal const string CL_SPD_FIRST_NAME = "CL_SPD_FIRST_NAME";
            internal const string CL_SPD_MIDDLE_INITIAL = "CL_SPD_MIDDLE_INITIAL";
            internal const string CL_CASELOAD_CNT = "CL_CASELOAD_CNT";
            internal const string CL_REFERRED_CNT = "CL_REFERRED_CNT";
        }
        #endregion

        #region Direct-access element properties
        public IField CLFILE_STAT { get { return GetExternalElementByName<IField>(Names.CLFILE_STAT); } }
        public IGroup WS_CL_REC { get { return GetElementByName<IGroup>(Names.WS_CL_REC); } }
        public IField CL_REGION_CODE { get { return GetElementByName<IField>(Names.CL_REGION_CODE); } }
        public IField CL_REGION_NAME { get { return GetElementByName<IField>(Names.CL_REGION_NAME); } }
        public IField CL_OFF_ID { get { return GetElementByName<IField>(Names.CL_OFF_ID); } }
        public IField CL_OFFICE_NAME { get { return GetElementByName<IField>(Names.CL_OFFICE_NAME); } }
        public IField CL_SPD_ID { get { return GetElementByName<IField>(Names.CL_SPD_ID); } }
        public IField CL_SPD_LAST_NAME { get { return GetElementByName<IField>(Names.CL_SPD_LAST_NAME); } }
        public IField CL_SPD_FIRST_NAME { get { return GetElementByName<IField>(Names.CL_SPD_FIRST_NAME); } }
        public IField CL_SPD_MIDDLE_INITIAL { get { return GetElementByName<IField>(Names.CL_SPD_MIDDLE_INITIAL); } }
        public IField CL_CASELOAD_CNT { get { return GetElementByName<IField>(Names.CL_CASELOAD_CNT); } }
        public IField CL_REFERRED_CNT { get { return GetElementByName<IField>(Names.CL_REFERRED_CNT); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.CLFILE_STAT, FieldType.UnsignedNumeric, 2);

            recordDef.CreateNewGroup(Names.WS_CL_REC, (WS_CL_REC) =>
           {
               WS_CL_REC.CreateNewField(Names.CL_REGION_CODE, FieldType.String, 2, SPACES);
               WS_CL_REC.CreateNewField(Names.CL_REGION_NAME, FieldType.String, 20, SPACES);
               WS_CL_REC.CreateNewField(Names.CL_OFF_ID, FieldType.UnsignedNumeric, 4, ZEROES);
               WS_CL_REC.CreateNewField(Names.CL_OFFICE_NAME, FieldType.String, 30, SPACES);
               WS_CL_REC.CreateNewField(Names.CL_SPD_ID, FieldType.UnsignedNumeric, 5, ZEROES);
               WS_CL_REC.CreateNewField(Names.CL_SPD_LAST_NAME, FieldType.String, 17, SPACES);
               WS_CL_REC.CreateNewField(Names.CL_SPD_FIRST_NAME, FieldType.String, 12, SPACES);
               WS_CL_REC.CreateNewField(Names.CL_SPD_MIDDLE_INITIAL, FieldType.String, 1, SPACES);
               WS_CL_REC.CreateNewField(Names.CL_CASELOAD_CNT, FieldType.UnsignedNumeric, 9, ZEROES);
               WS_CL_REC.CreateNewField(Names.CL_REFERRED_CNT, FieldType.UnsignedNumeric, 9, ZEROES);
               WS_CL_REC.CreateNewFillerField(FieldType.String, 41, SPACES);
           });
    ...
    internal class SWEXLR02_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLR02_ls_LinkageSection";
            ...
            internal const string EXPORT_REGION_INFO_0003EV = "EXPORT_REGION_INFO_0003EV";
            internal const string CSE_ORGANIZATION_0003ET = "CSE_ORGANIZATION_0003ET";
            internal const string CODE_0003AS = "CODE_0003AS";
            internal const string CODE_0003 = "CODE_0003";
            internal const string CODE_0003XX = "CODE_0003XX";
            ...
            internal const string EXPORT_OFFICE_INFO_0004EV = "EXPORT_OFFICE_INFO_0004EV";
            internal const string OFFICE_0004ET = "OFFICE_0004ET";
            ...
            internal const string NAME_0004AS = "NAME_0004AS";
            internal const string NAME_0004 = "NAME_0004";
            internal const string NAME_0004XX = "NAME_0004XX";
            internal const string EXPORT_SP_INFO_0005EV = "EXPORT_SP_INFO_0005EV";
            ...
            internal const string EXPORT_CO_CASELOAD_CNT_0006EV = "EXPORT_CO_CASELOAD_CNT_0006EV";
            ...
            internal const string EXPORT_CO_REFERRED_CNT_0007EV = "EXPORT_CO_REFERRED_CNT_0007EV";
        ...
        public IGroup EXPORT_REGION_INFO_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_REGION_INFO_0003EV); } }
        public IGroup CSE_ORGANIZATION_0003ET { get { return GetElementByName<IGroup>(Names.CSE_ORGANIZATION_0003ET); } }
        public IField CODE_0003AS { get { return GetElementByName<IField>(Names.CODE_0003AS); } }
        public IField CODE_0003 { get { return GetElementByName<IField>(Names.CODE_0003); } }
        public IField CODE_0003XX { get { return GetElementByName<IField>(Names.CODE_0003XX); } }
        ...
        public IGroup EXPORT_OFFICE_INFO_0004EV { get { return GetElementByName<IGroup>(Names.EXPORT_OFFICE_INFO_0004EV); } }
        public IGroup OFFICE_0004ET { get { return GetElementByName<IGroup>(Names.OFFICE_0004ET); } }
        ...
        public IField NAME_0004AS { get { return GetElementByName<IField>(Names.NAME_0004AS); } }
        public IField NAME_0004 { get { return GetElementByName<IField>(Names.NAME_0004); } }
        public IField NAME_0004XX { get { return GetElementByName<IField>(Names.NAME_0004XX); } }
        public IGroup EXPORT_SP_INFO_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_SP_INFO_0005EV); } }
        ...
        public IGroup EXPORT_CO_CASELOAD_CNT_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_CO_CASELOAD_CNT_0006EV); } }
        ...
        public IGroup EXPORT_CO_REFERRED_CNT_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_CO_REFERRED_CNT_0007EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_REGION_INFO_0003EV, (EXPORT_REGION_INFO_0003EV) =>
           {
               EXPORT_REGION_INFO_0003EV.CreateNewGroup(Names.CSE_ORGANIZATION_0003ET, (CSE_ORGANIZATION_0003ET) =>
               {
                   CSE_ORGANIZATION_0003ET.CreateNewField(Names.CODE_0003AS, FieldType.String, 1);

                   IField CODE_0003_local = CSE_ORGANIZATION_0003ET.CreateNewField(Names.CODE_0003, FieldType.String, 2);
                   CSE_ORGANIZATION_0003ET.CreateNewFieldRedefine(Names.CODE_0003XX, FieldType.String, CODE_0003_local, 2);
                   CSE_ORGANIZATION_0003ET.CreateNewField(Names.NAME_0003AS, FieldType.String, 1);

                   IField NAME_0003_local = CSE_ORGANIZATION_0003ET.CreateNewField(Names.NAME_0003, FieldType.String, 20);
                   CSE_ORGANIZATION_0003ET.CreateNewFieldRedefine(Names.NAME_0003XX, FieldType.String, NAME_0003_local, 20);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_OFFICE_INFO_0004EV, (EXPORT_OFFICE_INFO_0004EV) =>
           {
               EXPORT_OFFICE_INFO_0004EV.CreateNewGroup(Names.OFFICE_0004ET, (OFFICE_0004ET) =>
               {
                   OFFICE_0004ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0004AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_ID_0004_local = OFFICE_0004ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0004, FieldType.SignedNumeric, 4);
                   OFFICE_0004ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_ID_0004XX, FieldType.String, SYSTEM_GENERATED_ID_0004_local, 4);
                   OFFICE_0004ET.CreateNewField(Names.NAME_0004AS, FieldType.String, 1);

                   IField NAME_0004_local = OFFICE_0004ET.CreateNewField(Names.NAME_0004, FieldType.String, 30);
                   OFFICE_0004ET.CreateNewFieldRedefine(Names.NAME_0004XX, FieldType.String, NAME_0004_local, 30);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_SP_INFO_0005EV, (EXPORT_SP_INFO_0005EV) =>
           {
               EXPORT_SP_INFO_0005EV.CreateNewGroup(Names.SERVICE_PROVIDER_0005ET, (SERVICE_PROVIDER_0005ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_CO_CASELOAD_CNT_0006EV, (EXPORT_CO_CASELOAD_CNT_0006EV) =>
           {
               EXPORT_CO_CASELOAD_CNT_0006EV.CreateNewGroup(Names.IEF_SUPPLIED_0006ET, (IEF_SUPPLIED_0006ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_CO_REFERRED_CNT_0007EV, (EXPORT_CO_REFERRED_CNT_0007EV) =>
           {
               EXPORT_CO_REFERRED_CNT_0007EV.CreateNewGroup(Names.IEF_SUPPLIED_0007ET, (IEF_SUPPLIED_0007ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_REGION_INFO_0003EV, args, 5);
            SetPassedParm(EXPORT_OFFICE_INFO_0004EV, args, 6);
            SetPassedParm(EXPORT_SP_INFO_0005EV, args, 7);
            SetPassedParm(EXPORT_CO_CASELOAD_CNT_0006EV, args, 8);
            SetPassedParm(EXPORT_CO_REFERRED_CNT_0007EV, args, 9);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_REGION_INFO_0003EV, args, 5);
            SetReturnParm(EXPORT_OFFICE_INFO_0004EV, args, 6);
            SetReturnParm(EXPORT_SP_INFO_0005EV, args, 7);
            SetReturnParm(EXPORT_CO_CASELOAD_CNT_0006EV, args, 8);
            SetReturnParm(EXPORT_CO_REFERRED_CNT_0007EV, args, 9);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXLR02 : EABBase
    {
        ...
        public SWEXLR02()
            : base()
        {
            this.ProgramName.SetValue("SWEXLR02");

            WS = new SWEXLR02_ws();
            FD = new SWEXLR02_fd(WS);
            LS = new SWEXLR02_ls();
        }
        ...
        private SWEXLR02_ws WS;

        //==== File Data Class ========================================
        private SWEXLR02_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLR02_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-REGION-INFO-0003EV , EXPORT-OFFICE-INFO-0004EV , EXPORT-SP-INFO-0005EV , EXPORT-CO-CASELOAD-CNT-0006EV , EXPORT-CO-REFERRED-CNT-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0149946614(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0149946614
        /// </summary>
        private void M_MAIN_0149946614(string returnMethod = "")
        {
            M_PARA_0149946614_INIT("M_PARA_0149946614_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0149946614-INIT THRU PARA-0149946614-INIT-EXIT
            M_PARA_0149946614("M_PARA_0149946614_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0149946614 THRU PARA-0149946614-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0149946614
        /// </summary>
        private void M_PARA_0149946614(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: *************************************************************
            //COMMENT:   SWEXL76P - THIS CODE IS PART OF SWEXLR02 ,TO READ RECORDS
            //COMMENT:   FROM THE INPUT FILE.
            ...
            {
                M_200_READ_PARA("M_209_READ_EXIT"); if (Control.ExitProgram) { return; }                              //COBOL==> PERFORM 200-READ-PARA THRU 209-READ-EXIT
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0149946614") { M_PARA_0149946614_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0149946614_EXIT
        /// </summary>
        private void M_PARA_0149946614_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0149946614_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0149946614_EXIT") { M_100_OPEN_PARA(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        /// <remarks>
        ///COMMENT: *************************************************************
        ///COMMENT:   SWEXL76L - THIS CODE IS PART OF SWEXLR02 ,TO READ RECORDS
        ///COMMENT:   FROM THE INPUT FILE.
        ...
        {
            FD.CLFILE.OpenFile(FileAccessMode.Read);                                                            //COBOL==> OPEN INPUT CLFILE.
            if (WS.CLFILE_STAT.IsEqualTo(0))                                                                    //COBOL==> IF CLFILE-STAT = 0
            {
        ...
        {
            FD.CLFILE.CloseFile();                                                                              //COBOL==> CLOSE CLFILE.
            if (WS.CLFILE_STAT.IsEqualTo(0))                                                                    //COBOL==> IF CLFILE-STAT = 0
            {
                LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_309_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_309_CLOSE_EXIT") { M_200_READ_PARA(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_200_READ_PARA
        /// </summary>
        /// <remarks>
        ///COMMENT: -----------------------------------------------------*
        ///COMMENT:                    READ FILE                         *
        ///COMMENT: -----------------------------------------------------*
        /// </remarks>
        private void M_200_READ_PARA(string returnMethod = "")
        {
            FD.CLFILE.ReadLine();                                                                               //COBOL==> READ CLFILE.
                                                                                                                // EvaluateList !WS.CLFILE_STAT!                                                                    //COBOL==> EVALUATE CLFILE-STAT
            if ((WS.CLFILE_STAT.IsZeroes()))                                                                    //COBOL==> WHEN 0
            {
                LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
                WS.WS_CL_REC.SetValue(FD.CL_REC);                                                                   //COBOL==> MOVE CL-REC TO WS-CL-REC
                                                                                                                    //COMMENT: - REGION INFORMATION
                LS.CODE_0003.SetValue(WS.CL_REGION_CODE);                                                           //COBOL==> MOVE CL-REGION-CODE TO CODE-0003
                LS.NAME_0003.SetValue(WS.CL_REGION_NAME);                                                           //COBOL==> MOVE CL-REGION-NAME TO NAME-0003
                                                                                                                    //COMMENT: - OFFICE INFORMATION
                LS.SYSTEM_GENERATED_ID_0004.SetValue(WS.CL_OFF_ID);                                                 //COBOL==> MOVE CL-OFF-ID TO SYSTEM-GENERATED-ID-0004
                LS.NAME_0004.SetValue(WS.CL_OFFICE_NAME);                                                           //COBOL==> MOVE CL-OFFICE-NAME TO NAME-0004
                                                                                                                    //COMMENT: - SERVICE PROVIDER INFORMATION
                LS.SYSTEM_GENERATED_ID_0005.SetValue(WS.CL_SPD_ID);                                                 //COBOL==> MOVE CL-SPD-ID TO SYSTEM-GENERATED-ID-0005
                LS.LAST_NAME_0005.SetValue(WS.CL_SPD_LAST_NAME);                                                    //COBOL==> MOVE CL-SPD-LAST-NAME TO LAST-NAME-0005
                LS.FIRST_NAME_0005.SetValue(WS.CL_SPD_FIRST_NAME);                                                  //COBOL==> MOVE CL-SPD-FIRST-NAME TO FIRST-NAME-0005
                LS.MIDDLE_INITIAL_0005.SetValue(WS.CL_SPD_MIDDLE_INITIAL);                                          //COBOL==> MOVE CL-SPD-MIDDLE-INITIAL TO MIDDLE-INITIAL-0005
                                                                                                                    //COMMENT: - CASELOAD COUNT
                LS.COUNT_0006.SetValue(WS.CL_CASELOAD_CNT);                                                         //COBOL==> MOVE CL-CASELOAD-CNT TO COUNT-0006
                                                                                                                    //COMMENT: - CASE REFERRED COUNT
                LS.COUNT_0007.SetValue(WS.CL_REFERRED_CNT);                                                         //COBOL==> MOVE CL-REFERRED-CNT TO COUNT-0007
            }                                                                                                //COBOL==> WHEN 10
            else
            if ((WS.CLFILE_STAT.IsEqualTo(10)))
            {
                LS.STATUS_0002.SetValue("EF");                                                                      //COBOL==> MOVE 'EF' TO STATUS-0002
            }                                                                                                   //COBOL==> END-EVALUATE.
            if (returnMethod != "" && returnMethod != "M_200_READ_PARA") { M_209_READ_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_209_READ_EXIT
        /// </summary>
        private void M_209_READ_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_209_READ_EXIT") { return; }                                                  //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_209_READ_EXIT") { M_PARA_0149946614_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0149946614_INIT
        /// </summary>
        private void M_PARA_0149946614_INIT(string returnMethod = "")
        {
            LS.EXPORT_0002EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0002EV
            LS.EXPORT_REGION_INFO_0003EV.ResetToInitialValue();                                                 //COBOL==> INITIALIZE EXPORT-REGION-INFO-0003EV
            LS.EXPORT_OFFICE_INFO_0004EV.ResetToInitialValue();                                                 //COBOL==> INITIALIZE EXPORT-OFFICE-INFO-0004EV
            LS.EXPORT_SP_INFO_0005EV.ResetToInitialValue();                                                     //COBOL==> INITIALIZE EXPORT-SP-INFO-0005EV
            LS.EXPORT_CO_CASELOAD_CNT_0006EV.ResetToInitialValue();                                             //COBOL==> INITIALIZE EXPORT-CO-CASELOAD-CNT-0006EV
            LS.EXPORT_CO_REFERRED_CNT_0007EV.ResetToInitialValue();                                             //COBOL==> INITIALIZE EXPORT-CO-REFERRED-CNT-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0149946614_INIT") { M_PARA_0149946614_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0149946614_INIT_EXIT
        /// </summary>
        private void M_PARA_0149946614_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0149946614_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
