...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:46:00 PM
   **        *   FROM COBOL PGM   :  SWEXF238
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXF238_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXF238_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.SEQFILE_REC, FieldType.String, 170);
        ...
        public override void Initialize()
        {
            ...
            SEQ_FILE.RecordLength = 170;
        }
        #endregion

        #region Constructors
        public SWEXF238_fd(SWEXF238_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXF238_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXF238_ws_WorkingStorage";
            internal const string WS_FILE_STATUS = "WS_FILE_STATUS";
            internal const string WS_WORK_REC = "WS_WORK_REC";
            internal const string WS_USR_ID = "WS_USR_ID";
            internal const string WS_LST_NME = "WS_LST_NME";
            internal const string WS_FST_NME = "WS_FST_NME";
            internal const string WS_OB_TYPE = "WS_OB_TYPE";
            internal const string WS_PRIOR_BAL = "WS_PRIOR_BAL";
            ...
            internal const string WS_OS_BAL = "WS_OS_BAL";
            internal const string WS_PRCNT_TOT_COLL = "WS_PRCNT_TOT_COLL";
            internal const string WS_OBL_CNT = "WS_OBL_CNT";
            internal const string WS_CRT_ORD_CNT = "WS_CRT_ORD_CNT";
            internal const string WS_PRCNT_CRT_ORD = "WS_PRCNT_CRT_ORD";
        }
        #endregion
        ...
        public IField WS_USR_ID { get { return GetElementByName<IField>(Names.WS_USR_ID); } }
        public IField WS_LST_NME { get { return GetElementByName<IField>(Names.WS_LST_NME); } }
        public IField WS_FST_NME { get { return GetElementByName<IField>(Names.WS_FST_NME); } }
        public IField WS_OB_TYPE { get { return GetElementByName<IField>(Names.WS_OB_TYPE); } }
        public IField WS_PRIOR_BAL { get { return GetElementByName<IField>(Names.WS_PRIOR_BAL); } }
        ...
        public IField WS_OS_BAL { get { return GetElementByName<IField>(Names.WS_OS_BAL); } }
        public IField WS_PRCNT_TOT_COLL { get { return GetElementByName<IField>(Names.WS_PRCNT_TOT_COLL); } }
        public IField WS_OBL_CNT { get { return GetElementByName<IField>(Names.WS_OBL_CNT); } }
        public IField WS_CRT_ORD_CNT { get { return GetElementByName<IField>(Names.WS_CRT_ORD_CNT); } }
        public IField WS_PRCNT_CRT_ORD { get { return GetElementByName<IField>(Names.WS_PRCNT_CRT_ORD); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_WORK_REC.CreateNewField(Names.WS_USR_ID, FieldType.String, 8);
               WS_WORK_REC.CreateNewField(Names.WS_LST_NME, FieldType.String, 17);
               WS_WORK_REC.CreateNewField(Names.WS_FST_NME, FieldType.String, 12);
               WS_WORK_REC.CreateNewField(Names.WS_OB_TYPE, FieldType.String, 7);
               WS_WORK_REC.CreateNewField(Names.WS_PRIOR_BAL, FieldType.SignedNumeric, 15, null, 2);
               ...
               WS_WORK_REC.CreateNewField(Names.WS_OS_BAL, FieldType.SignedNumeric, 15, null, 2);
               WS_WORK_REC.CreateNewField(Names.WS_PRCNT_TOT_COLL, FieldType.SignedNumeric, 15, null, 2);
               WS_WORK_REC.CreateNewField(Names.WS_OBL_CNT, FieldType.SignedNumeric, 9);
               WS_WORK_REC.CreateNewField(Names.WS_CRT_ORD_CNT, FieldType.SignedNumeric, 9);
               WS_WORK_REC.CreateNewField(Names.WS_PRCNT_CRT_ORD, FieldType.SignedNumeric, 15, null, 2);
    ...
    internal class SWEXF238_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXF238_ls_LinkageSection";
            ...
            internal const string ERROR_ENCNTERED_SW = "ERROR_ENCNTERED_SW";
            ...
            internal const string LS_IN_OBLIGATION_TYPE_ET = "LS_IN_OBLIGATION_TYPE_ET";
            internal const string LS_IN_CODE_01MS = "LS_IN_CODE_01MS";
            internal const string LS_IN_CODE_01XX = "LS_IN_CODE_01XX";
            internal const string LS_IN_CODE_01 = "LS_IN_CODE_01";
            internal const string LS_IMP_V2 = "LS_IMP_V2";
            internal const string LS_IN_SERVICE_PROVIDER_ET = "LS_IN_SERVICE_PROVIDER_ET";
            internal const string LS_IN_USR_ID_02MS = "LS_IN_USR_ID_02MS";
            internal const string LS_IN_USR_ID_02XX = "LS_IN_USR_ID_02XX";
            internal const string LS_IN_USR_ID_02 = "LS_IN_USR_ID_02";
            internal const string LS_IN_LST_NME_03MS = "LS_IN_LST_NME_03MS";
            internal const string LS_IN_LST_NME_03XX = "LS_IN_LST_NME_03XX";
            internal const string LS_IN_LST_NME_03 = "LS_IN_LST_NME_03";
            internal const string LS_IN_FST_NME_04MS = "LS_IN_FST_NME_04MS";
            internal const string LS_IN_FST_NME_04XX = "LS_IN_FST_NME_04XX";
            internal const string LS_IN_FST_NME_04 = "LS_IN_FST_NME_04";
            internal const string LS_IMP_HI_DTE_V3 = "LS_IMP_HI_DTE_V3";
            internal const string LS_IN_DTE_WORK_AREA_ET = "LS_IN_DTE_WORK_AREA_ET";
            internal const string LS_IN_DTE_05MS = "LS_IN_DTE_05MS";
            internal const string LS_IN_DTE_05XX = "LS_IN_DTE_05XX";
            internal const string LS_IN_DTE_05 = "LS_IN_DTE_05";
            internal const string LS_IMP_LO_DTE_V4 = "LS_IMP_LO_DTE_V4";
            internal const string LS_IN_DTE_WORK_AREA_ET_d2 = "LS_IN_DTE_WORK_AREA_ET_d2";
            internal const string LS_IN_DTE_06MS = "LS_IN_DTE_06MS";
            internal const string LS_IN_DTE_06XX = "LS_IN_DTE_06XX";
            internal const string LS_IN_DTE_06 = "LS_IN_DTE_06";
            internal const string LS_IMP_V5 = "LS_IMP_V5";
            internal const string LS_IN_REPORT_PARMS_ET = "LS_IN_REPORT_PARMS_ET";
            internal const string LS_IN_PARM1_07MS = "LS_IN_PARM1_07MS";
            internal const string LS_IN_PARM1_07XX = "LS_IN_PARM1_07XX";
            internal const string IO_CONTROL_CD = "IO_CONTROL_CD";
            internal const string LS_IN_PARM2_08MS = "LS_IN_PARM2_08MS";
            internal const string LS_IN_PARM2_08XX = "LS_IN_PARM2_08XX";
            internal const string LS_IN_PARM2_08 = "LS_IN_PARM2_08";
            internal const string LS_IMP_TOT_COLL_V6 = "LS_IMP_TOT_COLL_V6";
            internal const string LS_IN_IEF_SUPPLIED_ET = "LS_IN_IEF_SUPPLIED_ET";
            internal const string LS_IN_TOT_CURR_09MS = "LS_IN_TOT_CURR_09MS";
            internal const string LS_IN_TOT_CURR_09XX = "LS_IN_TOT_CURR_09XX";
            internal const string LS_IN_TOT_CURR_09 = "LS_IN_TOT_CURR_09";
            internal const string LS_IMP_BAL_OWED_V7 = "LS_IMP_BAL_OWED_V7";
            internal const string LS_IN_IEF_SUPPLIED_ET_d2 = "LS_IN_IEF_SUPPLIED_ET_d2";
            ...
            internal const string LS_IMP_PRIOR_BAL_OWED_V8 = "LS_IMP_PRIOR_BAL_OWED_V8";
            internal const string LS_IN_IEF_SUPPLIED_ET_d3 = "LS_IN_IEF_SUPPLIED_ET_d3";
            internal const string LS_IN_TOT_CURR_11MS = "LS_IN_TOT_CURR_11MS";
            internal const string LS_IN_TOT_CURR_11XX = "LS_IN_TOT_CURR_11XX";
            internal const string LS_IN_TOT_CURR_11 = "LS_IN_TOT_CURR_11";
            internal const string LS_IMP_INT_OWED_V9 = "LS_IMP_INT_OWED_V9";
            internal const string LS_IN_IEF_SUPPLIED_ET_d4 = "LS_IN_IEF_SUPPLIED_ET_d4";
            internal const string LS_IN_TOT_CURR_12MS = "LS_IN_TOT_CURR_12MS";
            internal const string LS_IN_TOT_CURR_12XX = "LS_IN_TOT_CURR_12XX";
            internal const string LS_IN_TOT_CURR_12 = "LS_IN_TOT_CURR_12";
            internal const string LS_IMP_TOT_OS_BAL_V10 = "LS_IMP_TOT_OS_BAL_V10";
            internal const string LS_IN_IEF_SUPPLIED_ET_d5 = "LS_IN_IEF_SUPPLIED_ET_d5";
            internal const string LS_IN_TOT_CURR_13MS = "LS_IN_TOT_CURR_13MS";
            internal const string LS_IN_TOT_CURR_13XX = "LS_IN_TOT_CURR_13XX";
            internal const string LS_IN_TOT_CURR_13 = "LS_IN_TOT_CURR_13";
            internal const string LS_IMP_PRCNT_COLLECTED_V11 = "LS_IMP_PRCNT_COLLECTED_V11";
            internal const string LS_IN_IEF_SUPPLIED_ET_d6 = "LS_IN_IEF_SUPPLIED_ET_d6";
            ...
            internal const string LS_IMP_PRCNT_COURT_ORD_V12 = "LS_IMP_PRCNT_COURT_ORD_V12";
            internal const string LS_IN_IEF_SUPPLIED_ET_d7 = "LS_IN_IEF_SUPPLIED_ET_d7";
            internal const string LS_IN_TOT_CURR_15MS = "LS_IN_TOT_CURR_15MS";
            internal const string LS_IN_TOT_CURR_15XX = "LS_IN_TOT_CURR_15XX";
            internal const string LS_IN_TOT_CURR_15 = "LS_IN_TOT_CURR_15";
            internal const string LS_IMP_CRT_ORD_V13 = "LS_IMP_CRT_ORD_V13";
            internal const string LS_IN_IEF_SUPPLIED_ET_d8 = "LS_IN_IEF_SUPPLIED_ET_d8";
            internal const string LS_IN_CNT_16MS = "LS_IN_CNT_16MS";
            internal const string LS_IN_CNT_16XX = "LS_IN_CNT_16XX";
            internal const string LS_IN_CNT_16 = "LS_IN_CNT_16";
            internal const string LS_IMP_OBLIGATION_V14 = "LS_IMP_OBLIGATION_V14";
            internal const string LS_IN_IEF_SUPPLIED_ET_d9 = "LS_IN_IEF_SUPPLIED_ET_d9";
            internal const string LS_IN_CNT_17MS = "LS_IN_CNT_17MS";
            internal const string LS_IN_CNT_17XX = "LS_IN_CNT_17XX";
            internal const string LS_IN_CNT_17 = "LS_IN_CNT_17";
            internal const string LS_EXP_V15 = "LS_EXP_V15";
            internal const string LS_OUT_REPORT_PARMS_ET = "LS_OUT_REPORT_PARMS_ET";
            internal const string LS_OUT_PARM1_18MS = "LS_OUT_PARM1_18MS";
            internal const string LS_OUT_PARM1_18XX = "LS_OUT_PARM1_18XX";
            internal const string LS_RETURN_CD = "LS_RETURN_CD";
            internal const string LS_OUT_PARM2_19MS = "LS_OUT_PARM2_19MS";
            internal const string LS_OUT_PARM2_19XX = "LS_OUT_PARM2_19XX";
            internal const string LS_OUT_PARM2_19 = "LS_OUT_PARM2_19";
        }
        #endregion
        ...
        public IField ERROR_ENCNTERED_SW { get { return GetElementByName<IField>(Names.ERROR_ENCNTERED_SW); } }
        ...
        public IGroup LS_IN_OBLIGATION_TYPE_ET { get { return GetElementByName<IGroup>(Names.LS_IN_OBLIGATION_TYPE_ET); } }
        public IField LS_IN_CODE_01MS { get { return GetElementByName<IField>(Names.LS_IN_CODE_01MS); } }
        public IGroup LS_IN_CODE_01XX { get { return GetElementByName<IGroup>(Names.LS_IN_CODE_01XX); } }
        public IField LS_IN_CODE_01 { get { return GetElementByName<IField>(Names.LS_IN_CODE_01); } }
        public IGroup LS_IMP_V2 { get { return GetElementByName<IGroup>(Names.LS_IMP_V2); } }
        public IGroup LS_IN_SERVICE_PROVIDER_ET { get { return GetElementByName<IGroup>(Names.LS_IN_SERVICE_PROVIDER_ET); } }
        public IField LS_IN_USR_ID_02MS { get { return GetElementByName<IField>(Names.LS_IN_USR_ID_02MS); } }
        public IGroup LS_IN_USR_ID_02XX { get { return GetElementByName<IGroup>(Names.LS_IN_USR_ID_02XX); } }
        public IField LS_IN_USR_ID_02 { get { return GetElementByName<IField>(Names.LS_IN_USR_ID_02); } }
        public IField LS_IN_LST_NME_03MS { get { return GetElementByName<IField>(Names.LS_IN_LST_NME_03MS); } }
        public IGroup LS_IN_LST_NME_03XX { get { return GetElementByName<IGroup>(Names.LS_IN_LST_NME_03XX); } }
        public IField LS_IN_LST_NME_03 { get { return GetElementByName<IField>(Names.LS_IN_LST_NME_03); } }
        public IField LS_IN_FST_NME_04MS { get { return GetElementByName<IField>(Names.LS_IN_FST_NME_04MS); } }
        public IGroup LS_IN_FST_NME_04XX { get { return GetElementByName<IGroup>(Names.LS_IN_FST_NME_04XX); } }
        public IField LS_IN_FST_NME_04 { get { return GetElementByName<IField>(Names.LS_IN_FST_NME_04); } }
        public IGroup LS_IMP_HI_DTE_V3 { get { return GetElementByName<IGroup>(Names.LS_IMP_HI_DTE_V3); } }
        public IGroup LS_IN_DTE_WORK_AREA_ET { get { return GetElementByName<IGroup>(Names.LS_IN_DTE_WORK_AREA_ET); } }
        public IField LS_IN_DTE_05MS { get { return GetElementByName<IField>(Names.LS_IN_DTE_05MS); } }
        public IGroup LS_IN_DTE_05XX { get { return GetElementByName<IGroup>(Names.LS_IN_DTE_05XX); } }
        public IField LS_IN_DTE_05 { get { return GetElementByName<IField>(Names.LS_IN_DTE_05); } }
        public IGroup LS_IMP_LO_DTE_V4 { get { return GetElementByName<IGroup>(Names.LS_IMP_LO_DTE_V4); } }
        public IGroup LS_IN_DTE_WORK_AREA_ET_d2 { get { return GetElementByName<IGroup>(Names.LS_IN_DTE_WORK_AREA_ET_d2); } }
        public IField LS_IN_DTE_06MS { get { return GetElementByName<IField>(Names.LS_IN_DTE_06MS); } }
        public IGroup LS_IN_DTE_06XX { get { return GetElementByName<IGroup>(Names.LS_IN_DTE_06XX); } }
        public IField LS_IN_DTE_06 { get { return GetElementByName<IField>(Names.LS_IN_DTE_06); } }
        ...
        public IField LS_IN_PARM1_07MS { get { return GetElementByName<IField>(Names.LS_IN_PARM1_07MS); } }
        public IGroup LS_IN_PARM1_07XX { get { return GetElementByName<IGroup>(Names.LS_IN_PARM1_07XX); } }
        public IField IO_CONTROL_CD { get { return GetElementByName<IField>(Names.IO_CONTROL_CD); } }
        public IField LS_IN_PARM2_08MS { get { return GetElementByName<IField>(Names.LS_IN_PARM2_08MS); } }
        public IGroup LS_IN_PARM2_08XX { get { return GetElementByName<IGroup>(Names.LS_IN_PARM2_08XX); } }
        public IField LS_IN_PARM2_08 { get { return GetElementByName<IField>(Names.LS_IN_PARM2_08); } }
        public IGroup LS_IMP_TOT_COLL_V6 { get { return GetElementByName<IGroup>(Names.LS_IMP_TOT_COLL_V6); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET); } }
        public IField LS_IN_TOT_CURR_09MS { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_09MS); } }
        public IGroup LS_IN_TOT_CURR_09XX { get { return GetElementByName<IGroup>(Names.LS_IN_TOT_CURR_09XX); } }
        public IField LS_IN_TOT_CURR_09 { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_09); } }
        public IGroup LS_IMP_BAL_OWED_V7 { get { return GetElementByName<IGroup>(Names.LS_IMP_BAL_OWED_V7); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d2 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d2); } }
        ...
        public IGroup LS_IMP_PRIOR_BAL_OWED_V8 { get { return GetElementByName<IGroup>(Names.LS_IMP_PRIOR_BAL_OWED_V8); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d3 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d3); } }
        public IField LS_IN_TOT_CURR_11MS { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_11MS); } }
        public IGroup LS_IN_TOT_CURR_11XX { get { return GetElementByName<IGroup>(Names.LS_IN_TOT_CURR_11XX); } }
        public IField LS_IN_TOT_CURR_11 { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_11); } }
        public IGroup LS_IMP_INT_OWED_V9 { get { return GetElementByName<IGroup>(Names.LS_IMP_INT_OWED_V9); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d4 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d4); } }
        public IField LS_IN_TOT_CURR_12MS { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_12MS); } }
        public IGroup LS_IN_TOT_CURR_12XX { get { return GetElementByName<IGroup>(Names.LS_IN_TOT_CURR_12XX); } }
        public IField LS_IN_TOT_CURR_12 { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_12); } }
        public IGroup LS_IMP_TOT_OS_BAL_V10 { get { return GetElementByName<IGroup>(Names.LS_IMP_TOT_OS_BAL_V10); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d5 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d5); } }
        public IField LS_IN_TOT_CURR_13MS { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_13MS); } }
        public IGroup LS_IN_TOT_CURR_13XX { get { return GetElementByName<IGroup>(Names.LS_IN_TOT_CURR_13XX); } }
        public IField LS_IN_TOT_CURR_13 { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_13); } }
        public IGroup LS_IMP_PRCNT_COLLECTED_V11 { get { return GetElementByName<IGroup>(Names.LS_IMP_PRCNT_COLLECTED_V11); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d6 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d6); } }
        ...
        public IGroup LS_IMP_PRCNT_COURT_ORD_V12 { get { return GetElementByName<IGroup>(Names.LS_IMP_PRCNT_COURT_ORD_V12); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d7 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d7); } }
        public IField LS_IN_TOT_CURR_15MS { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_15MS); } }
        public IGroup LS_IN_TOT_CURR_15XX { get { return GetElementByName<IGroup>(Names.LS_IN_TOT_CURR_15XX); } }
        public IField LS_IN_TOT_CURR_15 { get { return GetElementByName<IField>(Names.LS_IN_TOT_CURR_15); } }
        public IGroup LS_IMP_CRT_ORD_V13 { get { return GetElementByName<IGroup>(Names.LS_IMP_CRT_ORD_V13); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d8 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d8); } }
        public IField LS_IN_CNT_16MS { get { return GetElementByName<IField>(Names.LS_IN_CNT_16MS); } }
        public IGroup LS_IN_CNT_16XX { get { return GetElementByName<IGroup>(Names.LS_IN_CNT_16XX); } }
        public IField LS_IN_CNT_16 { get { return GetElementByName<IField>(Names.LS_IN_CNT_16); } }
        public IGroup LS_IMP_OBLIGATION_V14 { get { return GetElementByName<IGroup>(Names.LS_IMP_OBLIGATION_V14); } }
        public IGroup LS_IN_IEF_SUPPLIED_ET_d9 { get { return GetElementByName<IGroup>(Names.LS_IN_IEF_SUPPLIED_ET_d9); } }
        public IField LS_IN_CNT_17MS { get { return GetElementByName<IField>(Names.LS_IN_CNT_17MS); } }
        public IGroup LS_IN_CNT_17XX { get { return GetElementByName<IGroup>(Names.LS_IN_CNT_17XX); } }
        public IField LS_IN_CNT_17 { get { return GetElementByName<IField>(Names.LS_IN_CNT_17); } }
        public IGroup LS_EXP_V15 { get { return GetElementByName<IGroup>(Names.LS_EXP_V15); } }
        public IGroup LS_OUT_REPORT_PARMS_ET { get { return GetElementByName<IGroup>(Names.LS_OUT_REPORT_PARMS_ET); } }
        public IField LS_OUT_PARM1_18MS { get { return GetElementByName<IField>(Names.LS_OUT_PARM1_18MS); } }
        public IGroup LS_OUT_PARM1_18XX { get { return GetElementByName<IGroup>(Names.LS_OUT_PARM1_18XX); } }
        public IField LS_RETURN_CD { get { return GetElementByName<IField>(Names.LS_RETURN_CD); } }
        public IField LS_OUT_PARM2_19MS { get { return GetElementByName<IField>(Names.LS_OUT_PARM2_19MS); } }
        public IGroup LS_OUT_PARM2_19XX { get { return GetElementByName<IGroup>(Names.LS_OUT_PARM2_19XX); } }
        public IField LS_OUT_PARM2_19 { get { return GetElementByName<IField>(Names.LS_OUT_PARM2_19); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
               ...
               GLOBDATA.CreateNewGroup(Names.PSMGR_ERROR_DATA, (PSMGR_ERROR_DATA) =>
               {
                   ...
                   PSMGR_ERROR_DATA.CreateNewField(Names.ERROR_ENCNTERED_SW, FieldType.String, 1);
           ...
           {
               LS_IMP_V1.CreateNewGroup(Names.LS_IN_OBLIGATION_TYPE_ET, (LS_IN_OBLIGATION_TYPE_ET) =>
               {
                   LS_IN_OBLIGATION_TYPE_ET.CreateNewField(Names.LS_IN_CODE_01MS, FieldType.String, 1);
                   LS_IN_OBLIGATION_TYPE_ET.CreateNewGroup(Names.LS_IN_CODE_01XX, (LS_IN_CODE_01XX) =>
                   {
                       LS_IN_CODE_01XX.CreateNewField(Names.LS_IN_CODE_01, FieldType.String, 7);
                   });
               });
           });
           ...
           {
               LS_IMP_V2.CreateNewGroup(Names.LS_IN_SERVICE_PROVIDER_ET, (LS_IN_SERVICE_PROVIDER_ET) =>
               {
                   LS_IN_SERVICE_PROVIDER_ET.CreateNewField(Names.LS_IN_USR_ID_02MS, FieldType.String, 1);
                   LS_IN_SERVICE_PROVIDER_ET.CreateNewGroup(Names.LS_IN_USR_ID_02XX, (LS_IN_USR_ID_02XX) =>
                   {
                       LS_IN_USR_ID_02XX.CreateNewField(Names.LS_IN_USR_ID_02, FieldType.String, 8);
                   });
                   LS_IN_SERVICE_PROVIDER_ET.CreateNewField(Names.LS_IN_LST_NME_03MS, FieldType.String, 1);
                   LS_IN_SERVICE_PROVIDER_ET.CreateNewGroup(Names.LS_IN_LST_NME_03XX, (LS_IN_LST_NME_03XX) =>
                   {
                       LS_IN_LST_NME_03XX.CreateNewField(Names.LS_IN_LST_NME_03, FieldType.String, 17);
                   });
                   LS_IN_SERVICE_PROVIDER_ET.CreateNewField(Names.LS_IN_FST_NME_04MS, FieldType.String, 1);
                   LS_IN_SERVICE_PROVIDER_ET.CreateNewGroup(Names.LS_IN_FST_NME_04XX, (LS_IN_FST_NME_04XX) =>
                   {
                       LS_IN_FST_NME_04XX.CreateNewField(Names.LS_IN_FST_NME_04, FieldType.String, 12);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_HI_DTE_V3, (LS_IMP_HI_DTE_V3) =>
           {
               LS_IMP_HI_DTE_V3.CreateNewGroup(Names.LS_IN_DTE_WORK_AREA_ET, (LS_IN_DTE_WORK_AREA_ET) =>
               {
                   LS_IN_DTE_WORK_AREA_ET.CreateNewField(Names.LS_IN_DTE_05MS, FieldType.String, 1);
                   LS_IN_DTE_WORK_AREA_ET.CreateNewGroup(Names.LS_IN_DTE_05XX, (LS_IN_DTE_05XX) =>
                   {
                       LS_IN_DTE_05XX.CreateNewField(Names.LS_IN_DTE_05, FieldType.SignedNumeric, 8);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_LO_DTE_V4, (LS_IMP_LO_DTE_V4) =>
           {
               LS_IMP_LO_DTE_V4.CreateNewGroup(Names.LS_IN_DTE_WORK_AREA_ET_d2, (LS_IN_DTE_WORK_AREA_ET_d2) =>
               {
                   LS_IN_DTE_WORK_AREA_ET_d2.CreateNewField(Names.LS_IN_DTE_06MS, FieldType.String, 1);
                   LS_IN_DTE_WORK_AREA_ET_d2.CreateNewGroup(Names.LS_IN_DTE_06XX, (LS_IN_DTE_06XX) =>
                   {
                       LS_IN_DTE_06XX.CreateNewField(Names.LS_IN_DTE_06, FieldType.SignedNumeric, 8);
                   });
               });
           });
           ...
           {
               LS_IMP_V5.CreateNewGroup(Names.LS_IN_REPORT_PARMS_ET, (LS_IN_REPORT_PARMS_ET) =>
               {
                   LS_IN_REPORT_PARMS_ET.CreateNewField(Names.LS_IN_PARM1_07MS, FieldType.String, 1);
                   LS_IN_REPORT_PARMS_ET.CreateNewGroup(Names.LS_IN_PARM1_07XX, (LS_IN_PARM1_07XX) =>
                   {
                       LS_IN_PARM1_07XX.CreateNewField(Names.IO_CONTROL_CD, FieldType.String, 2);
                   });
                   LS_IN_REPORT_PARMS_ET.CreateNewField(Names.LS_IN_PARM2_08MS, FieldType.String, 1);
                   LS_IN_REPORT_PARMS_ET.CreateNewGroup(Names.LS_IN_PARM2_08XX, (LS_IN_PARM2_08XX) =>
                   {
                       LS_IN_PARM2_08XX.CreateNewField(Names.LS_IN_PARM2_08, FieldType.String, 2);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_TOT_COLL_V6, (LS_IMP_TOT_COLL_V6) =>
           {
               LS_IMP_TOT_COLL_V6.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET, (LS_IN_IEF_SUPPLIED_ET) =>
               {
                   LS_IN_IEF_SUPPLIED_ET.CreateNewField(Names.LS_IN_TOT_CURR_09MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET.CreateNewGroup(Names.LS_IN_TOT_CURR_09XX, (LS_IN_TOT_CURR_09XX) =>
                   {
                       LS_IN_TOT_CURR_09XX.CreateNewField(Names.LS_IN_TOT_CURR_09, FieldType.SignedNumeric, 15, null, 2);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_BAL_OWED_V7, (LS_IMP_BAL_OWED_V7) =>
           {
               LS_IMP_BAL_OWED_V7.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d2, (LS_IN_IEF_SUPPLIED_ET_d2) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d2.CreateNewField(Names.LS_IN_TOT_CURR_10MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d2.CreateNewGroup(Names.LS_IN_TOT_CURR_10XX, (LS_IN_TOT_CURR_10XX) =>
                   {
            ...
            recordDef.CreateNewGroup(Names.LS_IMP_PRIOR_BAL_OWED_V8, (LS_IMP_PRIOR_BAL_OWED_V8) =>
           {
               LS_IMP_PRIOR_BAL_OWED_V8.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d3, (LS_IN_IEF_SUPPLIED_ET_d3) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d3.CreateNewField(Names.LS_IN_TOT_CURR_11MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d3.CreateNewGroup(Names.LS_IN_TOT_CURR_11XX, (LS_IN_TOT_CURR_11XX) =>
                   {
                       LS_IN_TOT_CURR_11XX.CreateNewField(Names.LS_IN_TOT_CURR_11, FieldType.SignedNumeric, 15, null, 2);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_INT_OWED_V9, (LS_IMP_INT_OWED_V9) =>
           {
               LS_IMP_INT_OWED_V9.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d4, (LS_IN_IEF_SUPPLIED_ET_d4) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d4.CreateNewField(Names.LS_IN_TOT_CURR_12MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d4.CreateNewGroup(Names.LS_IN_TOT_CURR_12XX, (LS_IN_TOT_CURR_12XX) =>
                   {
                       LS_IN_TOT_CURR_12XX.CreateNewField(Names.LS_IN_TOT_CURR_12, FieldType.SignedNumeric, 15, null, 2);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_TOT_OS_BAL_V10, (LS_IMP_TOT_OS_BAL_V10) =>
           {
               LS_IMP_TOT_OS_BAL_V10.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d5, (LS_IN_IEF_SUPPLIED_ET_d5) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d5.CreateNewField(Names.LS_IN_TOT_CURR_13MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d5.CreateNewGroup(Names.LS_IN_TOT_CURR_13XX, (LS_IN_TOT_CURR_13XX) =>
                   {
                       LS_IN_TOT_CURR_13XX.CreateNewField(Names.LS_IN_TOT_CURR_13, FieldType.SignedNumeric, 15, null, 2);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_PRCNT_COLLECTED_V11, (LS_IMP_PRCNT_COLLECTED_V11) =>
           {
               LS_IMP_PRCNT_COLLECTED_V11.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d6, (LS_IN_IEF_SUPPLIED_ET_d6) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d6.CreateNewField(Names.LS_IN_TOT_CURR_14MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d6.CreateNewGroup(Names.LS_IN_TOT_CURR_14XX, (LS_IN_TOT_CURR_14XX) =>
                   {
            ...
            recordDef.CreateNewGroup(Names.LS_IMP_PRCNT_COURT_ORD_V12, (LS_IMP_PRCNT_COURT_ORD_V12) =>
           {
               LS_IMP_PRCNT_COURT_ORD_V12.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d7, (LS_IN_IEF_SUPPLIED_ET_d7) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d7.CreateNewField(Names.LS_IN_TOT_CURR_15MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d7.CreateNewGroup(Names.LS_IN_TOT_CURR_15XX, (LS_IN_TOT_CURR_15XX) =>
                   {
                       LS_IN_TOT_CURR_15XX.CreateNewField(Names.LS_IN_TOT_CURR_15, FieldType.SignedNumeric, 15, null, 2);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_CRT_ORD_V13, (LS_IMP_CRT_ORD_V13) =>
           {
               LS_IMP_CRT_ORD_V13.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d8, (LS_IN_IEF_SUPPLIED_ET_d8) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d8.CreateNewField(Names.LS_IN_CNT_16MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d8.CreateNewGroup(Names.LS_IN_CNT_16XX, (LS_IN_CNT_16XX) =>
                   {
                       LS_IN_CNT_16XX.CreateNewField(Names.LS_IN_CNT_16, FieldType.SignedNumeric, 9);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_IMP_OBLIGATION_V14, (LS_IMP_OBLIGATION_V14) =>
           {
               LS_IMP_OBLIGATION_V14.CreateNewGroup(Names.LS_IN_IEF_SUPPLIED_ET_d9, (LS_IN_IEF_SUPPLIED_ET_d9) =>
               {
                   LS_IN_IEF_SUPPLIED_ET_d9.CreateNewField(Names.LS_IN_CNT_17MS, FieldType.String, 1);
                   LS_IN_IEF_SUPPLIED_ET_d9.CreateNewGroup(Names.LS_IN_CNT_17XX, (LS_IN_CNT_17XX) =>
                   {
                       LS_IN_CNT_17XX.CreateNewField(Names.LS_IN_CNT_17, FieldType.SignedNumeric, 9);
                   });
               });
           });

            recordDef.CreateNewGroup(Names.LS_EXP_V15, (LS_EXP_V15) =>
           {
               LS_EXP_V15.CreateNewGroup(Names.LS_OUT_REPORT_PARMS_ET, (LS_OUT_REPORT_PARMS_ET) =>
               {
                   LS_OUT_REPORT_PARMS_ET.CreateNewField(Names.LS_OUT_PARM1_18MS, FieldType.String, 1);
                   LS_OUT_REPORT_PARMS_ET.CreateNewGroup(Names.LS_OUT_PARM1_18XX, (LS_OUT_PARM1_18XX) =>
                   {
                       LS_OUT_PARM1_18XX.CreateNewField(Names.LS_RETURN_CD, FieldType.String, 2);
                   });
                   LS_OUT_REPORT_PARMS_ET.CreateNewField(Names.LS_OUT_PARM2_19MS, FieldType.String, 1);
                   LS_OUT_REPORT_PARMS_ET.CreateNewGroup(Names.LS_OUT_PARM2_19XX, (LS_OUT_PARM2_19XX) =>
                   {
                       LS_OUT_PARM2_19XX.CreateNewField(Names.LS_OUT_PARM2_19, FieldType.String, 2);
                   });
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(LS_IMP_HI_DTE_V3, args, 5);
            SetPassedParm(LS_IMP_LO_DTE_V4, args, 6);
            SetPassedParm(LS_IMP_V5, args, 7);
            SetPassedParm(LS_IMP_TOT_COLL_V6, args, 8);
            SetPassedParm(LS_IMP_BAL_OWED_V7, args, 9);
            SetPassedParm(LS_IMP_PRIOR_BAL_OWED_V8, args, 10);
            SetPassedParm(LS_IMP_INT_OWED_V9, args, 11);
            SetPassedParm(LS_IMP_TOT_OS_BAL_V10, args, 12);
            SetPassedParm(LS_IMP_PRCNT_COLLECTED_V11, args, 13);
            SetPassedParm(LS_IMP_PRCNT_COURT_ORD_V12, args, 14);
            SetPassedParm(LS_IMP_CRT_ORD_V13, args, 15);
            SetPassedParm(LS_IMP_OBLIGATION_V14, args, 16);
            SetPassedParm(LS_EXP_V15, args, 17);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(LS_IMP_HI_DTE_V3, args, 5);
            SetReturnParm(LS_IMP_LO_DTE_V4, args, 6);
            SetReturnParm(LS_IMP_V5, args, 7);
            SetReturnParm(LS_IMP_TOT_COLL_V6, args, 8);
            SetReturnParm(LS_IMP_BAL_OWED_V7, args, 9);
            SetReturnParm(LS_IMP_PRIOR_BAL_OWED_V8, args, 10);
            SetReturnParm(LS_IMP_INT_OWED_V9, args, 11);
            SetReturnParm(LS_IMP_TOT_OS_BAL_V10, args, 12);
            SetReturnParm(LS_IMP_PRCNT_COLLECTED_V11, args, 13);
            SetReturnParm(LS_IMP_PRCNT_COURT_ORD_V12, args, 14);
            SetReturnParm(LS_IMP_CRT_ORD_V13, args, 15);
            SetReturnParm(LS_IMP_OBLIGATION_V14, args, 16);
            SetReturnParm(LS_EXP_V15, args, 17);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXF238 : EABBase
    {
        ...
        public SWEXF238()
            : base()
        {
            this.ProgramName.SetValue("SWEXF238");

            WS = new SWEXF238_ws();
            FD = new SWEXF238_fd(WS);
            LS = new SWEXF238_ls();
        }
        ...
        private SWEXF238_ws WS;

        //==== File Data Class ========================================
        private SWEXF238_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXF238_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING TI-RUNTIME-PARM1 , TI-RUNTIME-PARM2 , GLOBDATA , LS-IMP-V1 , LS-IMP-V2 , LS-IMP-HI-DTE-V3 , LS-IMP-LO-DTE-V4 , LS-IMP-V5 , LS-IMP-TOT-COLL-V6 , LS-IMP-BAL-OWED-V7 , LS-IMP-PRIOR-BAL-OWED-V8 , LS-IMP-INT-OWED-V9 , LS-IMP-TOT-OS-BAL-V10 , LS-IMP-PRCNT-COLLECTED-V11 , LS-IMP-PRCNT-COURT-ORD-V12 , LS-IMP-CRT-ORD-V13 , LS-IMP-OBLIGATION-V14 , LS-EXP-V15.
        {
            try
            {
                WS.Initialize();
        ...
        {
            //COMMENT:  INITIALIZE - IMPORT ATTRIBUTES, IF THEY HAVE INVALID VALUES
            //COMMENT:  INITIALIZE - EXPORT ATTRIBUTES ALWAYS
            //COMMENT:  VALIDATE NUMERIC FIELDS.
            if (!(LS.LS_IN_DTE_05.IsNumericValue()))                                                           //COBOL==> IF LS-IN-DTE-05 IS NOT NUMERIC
            {
                LS.LS_IN_DTE_05.SetValueWithZeroes();                                                               //COBOL==> MOVE ZEROS TO LS-IN-DTE-05
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.LS_IN_DTE_06.IsNumericValue()))                                                           //COBOL==> IF LS-IN-DTE-06 IS NOT NUMERIC
            {
                LS.LS_IN_DTE_06.SetValueWithZeroes();                                                               //COBOL==> MOVE ZEROS TO LS-IN-DTE-06
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.LS_IN_TOT_CURR_09.IsNumericValue()))                                                      //COBOL==> IF LS-IN-TOT-CURR-09 IS NOT NUMERIC
            {
                LS.LS_IN_TOT_CURR_09.SetValueWithZeroes();                                                          //COBOL==> MOVE ZEROS TO LS-IN-TOT-CURR-09
            }                                                                                                   //COBOL==> END-IF.
            ...
            if (!(LS.LS_IN_TOT_CURR_11.IsNumericValue()))                                                      //COBOL==> IF LS-IN-TOT-CURR-11 IS NOT NUMERIC
            {
                LS.LS_IN_TOT_CURR_11.SetValueWithZeroes();                                                          //COBOL==> MOVE ZEROS TO LS-IN-TOT-CURR-11
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.LS_IN_TOT_CURR_12.IsNumericValue()))                                                      //COBOL==> IF LS-IN-TOT-CURR-12 IS NOT NUMERIC
            {
                LS.LS_IN_TOT_CURR_12.SetValueWithZeroes();                                                          //COBOL==> MOVE ZEROS TO LS-IN-TOT-CURR-12
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.LS_IN_TOT_CURR_13.IsNumericValue()))                                                      //COBOL==> IF LS-IN-TOT-CURR-13 IS NOT NUMERIC
            {
                LS.LS_IN_TOT_CURR_13.SetValueWithZeroes();                                                          //COBOL==> MOVE ZEROS TO LS-IN-TOT-CURR-13
            }                                                                                                   //COBOL==> END-IF.
            ...
            if (!(LS.LS_IN_TOT_CURR_15.IsNumericValue()))                                                      //COBOL==> IF LS-IN-TOT-CURR-15 IS NOT NUMERIC
            {
                LS.LS_IN_TOT_CURR_15.SetValueWithZeroes();                                                          //COBOL==> MOVE ZEROS TO LS-IN-TOT-CURR-15
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.LS_IN_CNT_16.IsNumericValue()))                                                           //COBOL==> IF LS-IN-CNT-16 IS NOT NUMERIC
            {
                LS.LS_IN_CNT_16.SetValueWithZeroes();                                                               //COBOL==> MOVE ZEROS TO LS-IN-CNT-16
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.LS_IN_CNT_17.IsNumericValue()))                                                           //COBOL==> IF LS-IN-CNT-17 IS NOT NUMERIC
            {
                LS.LS_IN_CNT_17.SetValueWithZeroes();                                                               //COBOL==> MOVE ZEROS TO LS-IN-CNT-17
            }                                                                                                   //COBOL==> END-IF.
                                                                                                                //COMMENT:  VALIDATE TEXT FIELDS.
            if ((LS.LS_IN_CODE_01XX.IsEqualTo(HIGH_VALUES))
             || (LS.LS_IN_CODE_01XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LS-IN-CODE-01XX = HIGH-VALUES OR LS-IN-CODE-01XX = LOW-VALUES
            {
                LS.LS_IN_CODE_01.SetValueWithSpaces();                                                              //COBOL==> MOVE SPACES TO LS-IN-CODE-01
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_USR_ID_02XX.IsEqualTo(HIGH_VALUES))
             || (LS.LS_IN_USR_ID_02XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LS-IN-USR-ID-02XX = HIGH-VALUES OR LS-IN-USR-ID-02XX = LOW-VALUES
            {
                LS.LS_IN_USR_ID_02.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO LS-IN-USR-ID-02
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_LST_NME_03XX.IsEqualTo(HIGH_VALUES))
             || (LS.LS_IN_LST_NME_03XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LS-IN-LST-NME-03XX = HIGH-VALUES OR LS-IN-LST-NME-03XX = LOW-VALUES
            {
                LS.LS_IN_LST_NME_03.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-LST-NME-03
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_FST_NME_04XX.IsEqualTo(HIGH_VALUES))
             || (LS.LS_IN_FST_NME_04XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LS-IN-FST-NME-04XX = HIGH-VALUES OR LS-IN-FST-NME-04XX = LOW-VALUES
            {
                LS.LS_IN_FST_NME_04.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-FST-NME-04
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_PARM1_07XX.IsEqualTo(HIGH_VALUES))
             || (LS.LS_IN_PARM1_07XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LS-IN-PARM1-07XX = HIGH-VALUES OR LS-IN-PARM1-07XX = LOW-VALUES
            {
                LS.LS_IN_PARM1_07XX.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-PARM1-07XX
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.LS_IN_PARM2_08XX.IsEqualTo(HIGH_VALUES))
             || (LS.LS_IN_PARM2_08XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF LS-IN-PARM2-08XX = HIGH-VALUES OR LS-IN-PARM2-08XX = LOW-VALUES
            {
                LS.LS_IN_PARM2_08XX.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO LS-IN-PARM2-08XX
            }                                                                                                   //COBOL==> END-IF.
            LS.LS_OUT_PARM1_18XX.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO LS-OUT-PARM1-18XX.
            LS.LS_OUT_PARM2_19XX.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO LS-OUT-PARM2-19XX.
        ...
        {
            WS.WS_USR_ID.SetValue(LS.LS_IN_USR_ID_02);                                                          //COBOL==> MOVE LS-IN-USR-ID-02 TO WS-USR-ID.
            WS.WS_LST_NME.SetValue(LS.LS_IN_LST_NME_03);                                                        //COBOL==> MOVE LS-IN-LST-NME-03 TO WS-LST-NME.
            WS.WS_FST_NME.SetValue(LS.LS_IN_FST_NME_04);                                                        //COBOL==> MOVE LS-IN-FST-NME-04 TO WS-FST-NME.
            WS.WS_OB_TYPE.SetValue(LS.LS_IN_CODE_01);                                                           //COBOL==> MOVE LS-IN-CODE-01 TO WS-OB-TYPE.
            WS.WS_PRIOR_BAL.SetValue(LS.LS_IN_TOT_CURR_11);                                                     //COBOL==> MOVE LS-IN-TOT-CURR-11 TO WS-PRIOR-BAL.
            WS.WS_TOT_COLL.SetValue(LS.LS_IN_TOT_CURR_09);                                                      //COBOL==> MOVE LS-IN-TOT-CURR-09 TO WS-TOT-COLL.
            WS.WS_BAL_OWED.SetValue(LS.LS_IN_TOT_CURR_10);                                                      //COBOL==> MOVE LS-IN-TOT-CURR-10 TO WS-BAL-OWED.
            WS.WS_INT_OWED.SetValue(LS.LS_IN_TOT_CURR_12);                                                      //COBOL==> MOVE LS-IN-TOT-CURR-12 TO WS-INT-OWED.
            WS.WS_OS_BAL.SetValue(LS.LS_IN_TOT_CURR_13);                                                        //COBOL==> MOVE LS-IN-TOT-CURR-13 TO WS-OS-BAL.
            WS.WS_PRCNT_TOT_COLL.SetValue(LS.LS_IN_TOT_CURR_14);                                                //COBOL==> MOVE LS-IN-TOT-CURR-14 TO WS-PRCNT-TOT-COLL.
            WS.WS_OBL_CNT.SetValue(LS.LS_IN_CNT_17);                                                            //COBOL==> MOVE LS-IN-CNT-17 TO WS-OBL-CNT.
            WS.WS_CRT_ORD_CNT.SetValue(LS.LS_IN_CNT_16);                                                        //COBOL==> MOVE LS-IN-CNT-16 TO WS-CRT-ORD-CNT.
            WS.WS_PRCNT_CRT_ORD.SetValue(LS.LS_IN_TOT_CURR_15);                                                 //COBOL==> MOVE LS-IN-TOT-CURR-15 TO WS-PRCNT-CRT-ORD.
