...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:53 PM
   **        *   FROM COBOL PGM   :  SWEXEW20
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: SP_EAB_WRITE_3_YR_MOD_RPT        DATE: 2014/10/16
       TARGET OS:   MVS                       TIME: 11:35:48
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW20_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW20_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.ARSTOUT_RECORD, FieldType.String, 166);
        ...
        #region Constructors
        public SWEXEW20_fd(SWEXEW20_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW20_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW20_ws_WorkingStorage";
            ...
            internal const string RECORD_DETL = "RECORD_DETL";
        }
        #endregion
        ...
        public IField RECORD_DETL { get { return GetElementByName<IField>(Names.RECORD_DETL); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW20 WORKING STORAGE STARTS HERE");
           ...
           {
               WS_ARSTOUT.CreateNewField(Names.RECOUT, FieldType.String, 166);
           });

            recordDef.CreateNewGroup(Names.WS_DETAIL, (WS_DETAIL) =>
           {
               WS_DETAIL.CreateNewField(Names.RECORD_DETL, FieldType.String, 166);
           });
    ...
    internal class SWEXEW20_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW20_ls_LinkageSection";
            ...
            internal const string IMPORT_3YR_LINE_0002EV = "IMPORT_3YR_LINE_0002EV";
            internal const string WORK_AREA_0002ET = "WORK_AREA_0002ET";
            internal const string TEXT_166_0002AS = "TEXT_166_0002AS";
            internal const string TEXT_166_0002 = "TEXT_166_0002";
            internal const string TEXT_166_0002XX = "TEXT_166_0002XX";
        ...
        public IGroup IMPORT_3YR_LINE_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_3YR_LINE_0002EV); } }
        public IGroup WORK_AREA_0002ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0002ET); } }
        public IField TEXT_166_0002AS { get { return GetElementByName<IField>(Names.TEXT_166_0002AS); } }
        public IField TEXT_166_0002 { get { return GetElementByName<IField>(Names.TEXT_166_0002); } }
        public IField TEXT_166_0002XX { get { return GetElementByName<IField>(Names.TEXT_166_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_3YR_LINE_0002EV, (IMPORT_3YR_LINE_0002EV) =>
           {
               IMPORT_3YR_LINE_0002EV.CreateNewGroup(Names.WORK_AREA_0002ET, (WORK_AREA_0002ET) =>
               {
                   WORK_AREA_0002ET.CreateNewField(Names.TEXT_166_0002AS, FieldType.String, 1);

                   IField TEXT_166_0002_local = WORK_AREA_0002ET.CreateNewField(Names.TEXT_166_0002, FieldType.String, 166);
                   WORK_AREA_0002ET.CreateNewFieldRedefine(Names.TEXT_166_0002XX, FieldType.String, TEXT_166_0002_local, 166);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_3YR_LINE_0002EV, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_3YR_LINE_0002EV, args, 4);
    ...
    public class SWEXEW20 : EABBase
    {
        ...
        public SWEXEW20()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW20");

            WS = new SWEXEW20_ws();
            FD = new SWEXEW20_fd(WS);
            LS = new SWEXEW20_ls();
        }
        ...
        private SWEXEW20_ws WS;

        //==== File Data Class ========================================
        private SWEXEW20_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW20_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-3YR-LINE-0002EV , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1832393902(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1832393902
        /// </summary>
        private void M_MAIN_1832393902(string returnMethod = "")
        {
            M_PARA_1832393902_INIT("M_PARA_1832393902_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1832393902-INIT THRU PARA-1832393902-INIT-EXIT
            M_PARA_1832393902("M_PARA_1832393902_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1832393902 THRU PARA-1832393902-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1832393902
        /// </summary>
        private void M_PARA_1832393902(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF60 IS A PART OF SWEXEW20*
            //COMMENT: ******************************************
        ...
        private void M_0100_INITIALIZE_AND_OPEN(string returnMethod = "")
        {
            ...
            if (!(WS.ARSTOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF ARSTOUT-STAT NOT = 00
            {
                ...
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.ARSTOUT_STAT);                                              //COBOL==> MOVE ARSTOUT-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            WS.RECOUT.SetValue(LS.TEXT_166_0002);                                                               //COBOL==> MOVE TEXT-166-0002 TO RECOUT
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1832393902_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832393902_EXIT
        /// </summary>
        private void M_PARA_1832393902_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832393902_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1832393902_EXIT") { M_PARA_1832393902_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832393902_INIT
        /// </summary>
        private void M_PARA_1832393902_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1832393902_INIT") { M_PARA_1832393902_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1832393902_INIT_EXIT
        /// </summary>
        private void M_PARA_1832393902_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1832393902_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
