...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:35 PM
   **        *   FROM COBOL PGM   :  SWEXGP09
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGP09_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP09_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT09");
    ...
    internal class SWEXGP09_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP09_ws_WorkingStorage";
    ...
    internal class SWEXGP09_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP09_ls_LinkageSection";
    ...
    public class SWEXGP09 : EABBase
    {
        ...
        public SWEXGP09()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP09");
        ...
        private SWEXGP09_ws WS;

        //==== File Data Class ========================================
        private SWEXGP09_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP09_ls LS;
        #endregion
