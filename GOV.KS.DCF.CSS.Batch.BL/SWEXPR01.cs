...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2021-12-07 03:23:58 PM
   **        *   FROM COBOL PGM   :  SWEXPR01
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: SP_EAB_READ_DOCUMENT_TEMPLATE    DATE: 2000/02/08
       TARGET OS:   MVS                       TIME: 08:42:46
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXPR01_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXPR01_fd_FileSection";
            internal const string TEXTIN = "TEXTIN";
            internal const string TXT_IN1 = "TXT_IN1";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink TEXTIN { get; set; }
        public IField TXT_IN1 { get { return GetElementByName<IField>(Names.TXT_IN1); } }
        ...
        {
            recordDef.CreateNewField(Names.TXT_IN1, FieldType.String, 80);
        ...
        public override void Initialize()
        {
            ...
            TEXTIN = FileHandler.GetFile("UT_S_TXTIN");
            TEXTIN.AssociatedBuffer = TXT_IN1;
            TEXTIN.RecordLength = 80;
        }
        #endregion
    ...
    internal class SWEXPR01_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXPR01_ws_WorkingStorage";
            internal const string WS_IN = "WS_IN";
        }
        #endregion

        #region Direct-access element properties
        public IField WS_IN { get { return GetElementByName<IField>(Names.WS_IN); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewField(Names.WS_IN, FieldType.String, 80);
    ...
    internal class SWEXPR01_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXPR01_ls_LinkageSection";
            ...
            internal const string TEXT_80_0002AS = "TEXT_80_0002AS";
            internal const string TEXT_80_0002 = "TEXT_80_0002";
            internal const string TEXT_80_0002XX = "TEXT_80_0002XX";
        ...
        public IField TEXT_80_0002AS { get { return GetElementByName<IField>(Names.TEXT_80_0002AS); } }
        public IField TEXT_80_0002 { get { return GetElementByName<IField>(Names.TEXT_80_0002); } }
        public IField TEXT_80_0002XX { get { return GetElementByName<IField>(Names.TEXT_80_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0002EV.CreateNewGroup(Names.WORK_AREA_0002ET, (WORK_AREA_0002ET) =>
               {
                   WORK_AREA_0002ET.CreateNewField(Names.TEXT_80_0002AS, FieldType.String, 1);

                   IField TEXT_80_0002_local = WORK_AREA_0002ET.CreateNewField(Names.TEXT_80_0002, FieldType.String, 80);
                   WORK_AREA_0002ET.CreateNewFieldRedefine(Names.TEXT_80_0002XX, FieldType.String, TEXT_80_0002_local, 80);
               });
           });
    ...
    public class SWEXPR01 : EABBase
    {
        ...
        public SWEXPR01()
            : base()
        {
            this.ProgramName.SetValue("SWEXPR01");
        ...
        private SWEXPR01_ws WS;

        //==== File Data Class ========================================
        private SWEXPR01_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXPR01_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1297089053(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1297089053
        /// </summary>
        private void M_MAIN_1297089053(string returnMethod = "")
        {
            M_PARA_1297089053_INIT("M_PARA_1297089053_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1297089053-INIT THRU PARA-1297089053-INIT-EXIT
            M_PARA_1297089053("M_PARA_1297089053_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1297089053 THRU PARA-1297089053-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1297089053
        /// </summary>
        private void M_PARA_1297089053(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1297089053") { M_PARA_1297089053_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1297089053_EXIT
        /// </summary>
        private void M_PARA_1297089053_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1297089053_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1297089053_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.TEXTIN.OpenFile(FileAccessMode.Read);                                                            //COBOL==> OPEN INPUT TEXTIN
        ...
        {
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003
            WS.WS_IN.SetValue(FD.TEXTIN.ReadLineInto());                                                        //COBOL==> READ TEXTIN INTO WS-IN
            if (FD.TEXTIN.FileStatus == FileStatus.End_of_file)                                                 //COBOL==> AT END
            {
        ...
        {
            LS.TEXT_80_0002.SetValue(WS.WS_IN);                                                                 //COBOL==> MOVE WS-IN TO TEXT-80-0002 .
        ...
        {
            FD.TEXTIN.CloseFile();                                                                              //COBOL==> CLOSE TEXTIN.
            LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_1297089053_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1297089053_INIT
        /// </summary>
        private void M_PARA_1297089053_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1297089053_INIT") { M_PARA_1297089053_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1297089053_INIT_EXIT
        /// </summary>
        private void M_PARA_1297089053_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1297089053_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
