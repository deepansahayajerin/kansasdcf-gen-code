...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:54:27 PM
   **        *   FROM COBOL PGM   :  SWEXSI10
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: SI_EAB_WRITE_PCG_MEDICAID_MATCH  DATE: 2000/10/03
       TARGET OS:   MVS                       TIME: 14:42:03
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXSI10_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXSI10_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.OUTFILE_REC, FieldType.String, 130);
        ...
        public override void Initialize()
        {
            ...
            OUTFILE.RecordLength = 130;
        }
        #endregion

        #region Constructors
        public SWEXSI10_fd(SWEXSI10_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXSI10_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXSI10_ws_WorkingStorage";
            internal const string WS_START_FILLER = "WS_START_FILLER";
            ...
            internal const string WS_AP_CSE_PERS = "WS_AP_CSE_PERS";
            internal const string WS_AP_DOB = "WS_AP_DOB";
            internal const string WS_CH_SSN = "WS_CH_SSN";
            internal const string WS_CH_NAME = "WS_CH_NAME";
            internal const string WS_CH_CSE_PERS = "WS_CH_CSE_PERS";
            internal const string WS_CH_DOB = "WS_CH_DOB";
            internal const string WS_EDIT_AREA = "WS_EDIT_AREA";
            internal const string WS_DOB_EDIT = "WS_DOB_EDIT";
            internal const string WS_DOB_EDIT_R = "WS_DOB_EDIT_R";
            internal const string WS_SIGN = "WS_SIGN";
            internal const string WS_DOB = "WS_DOB";
            internal const string WS_END_FILLER = "WS_END_FILLER";
        }
        #endregion

        #region Direct-access element properties
        public IField WS_START_FILLER { get { return GetElementByName<IField>(Names.WS_START_FILLER); } }
        ...
        public IField WS_AP_CSE_PERS { get { return GetElementByName<IField>(Names.WS_AP_CSE_PERS); } }
        public IField WS_AP_DOB { get { return GetElementByName<IField>(Names.WS_AP_DOB); } }
        public IField WS_CH_SSN { get { return GetElementByName<IField>(Names.WS_CH_SSN); } }
        public IField WS_CH_NAME { get { return GetElementByName<IField>(Names.WS_CH_NAME); } }
        public IField WS_CH_CSE_PERS { get { return GetElementByName<IField>(Names.WS_CH_CSE_PERS); } }
        public IField WS_CH_DOB { get { return GetElementByName<IField>(Names.WS_CH_DOB); } }
        public IGroup WS_EDIT_AREA { get { return GetElementByName<IGroup>(Names.WS_EDIT_AREA); } }
        public IField WS_DOB_EDIT { get { return GetElementByName<IField>(Names.WS_DOB_EDIT); } }
        public IGroup WS_DOB_EDIT_R { get { return GetElementByName<IGroup>(Names.WS_DOB_EDIT_R); } }
        public IField WS_SIGN { get { return GetElementByName<IField>(Names.WS_SIGN); } }
        public IField WS_DOB { get { return GetElementByName<IField>(Names.WS_DOB); } }
        public IField WS_END_FILLER { get { return GetElementByName<IField>(Names.WS_END_FILLER); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewField(Names.WS_START_FILLER, FieldType.String, 48, "* * * * * WORKING STORAGE STARTS HERE * * * * *");
           ...
           {
               WS_OUTFILE_REC.CreateNewField(Names.WS_CASE_NUMBER, FieldType.String, 10);
               WS_OUTFILE_REC.CreateNewField(Names.WS_AP_SSN, FieldType.String, 9);
               WS_OUTFILE_REC.CreateNewField(Names.WS_AP_NAME, FieldType.String, 33);
               WS_OUTFILE_REC.CreateNewField(Names.WS_AP_CSE_PERS, FieldType.String, 10);
               WS_OUTFILE_REC.CreateNewField(Names.WS_AP_DOB, FieldType.UnsignedNumeric, 8);
               WS_OUTFILE_REC.CreateNewField(Names.WS_CH_SSN, FieldType.String, 9);
               WS_OUTFILE_REC.CreateNewField(Names.WS_CH_NAME, FieldType.String, 33);
               WS_OUTFILE_REC.CreateNewField(Names.WS_CH_CSE_PERS, FieldType.String, 10);
               WS_OUTFILE_REC.CreateNewField(Names.WS_CH_DOB, FieldType.UnsignedNumeric, 8);
           });

            recordDef.CreateNewGroup(Names.WS_EDIT_AREA, (WS_EDIT_AREA) =>
           {

               IField WS_DOB_EDIT_local = WS_EDIT_AREA.CreateNewField(Names.WS_DOB_EDIT, FieldType.SignedNumeric, 9);
               WS_EDIT_AREA.CreateNewGroupRedefine(Names.WS_DOB_EDIT_R, WS_DOB_EDIT_local, (WS_DOB_EDIT_R) =>
               {
                   WS_DOB_EDIT_R.CreateNewField(Names.WS_SIGN, FieldType.String, 1);
                   WS_DOB_EDIT_R.CreateNewField(Names.WS_DOB, FieldType.UnsignedNumeric, 8);
               });
           });
            recordDef.CreateNewField(Names.WS_END_FILLER, FieldType.String, 48, "* * * * * WORKING STORAGE  ENDS  HERE * * * * *");
    ...
    internal class SWEXSI10_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXSI10_ls_LinkageSection";
            ...
            internal const string IMPORT_AP_0001EV = "IMPORT_AP_0001EV";
            ...
            internal const string IMPORT_CH_0002EV = "IMPORT_CH_0002EV";
        ...
        public IGroup IMPORT_AP_0001EV { get { return GetElementByName<IGroup>(Names.IMPORT_AP_0001EV); } }
        ...
        public IGroup IMPORT_CH_0002EV { get { return GetElementByName<IGroup>(Names.IMPORT_CH_0002EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.GLOBDATA, (GLOBDATA) =>
           {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_AP_0001EV, (IMPORT_AP_0001EV) =>
           {
               IMPORT_AP_0001EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0001ET, (CSE_PERSONS_WORK_SET_0001ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CH_0002EV, (IMPORT_CH_0002EV) =>
           {
               IMPORT_CH_0002EV.CreateNewGroup(Names.CSE_PERSONS_WORK_SET_0002ET, (CSE_PERSONS_WORK_SET_0002ET) =>
               {
           ...
           {
               IMPORT_AP_0003EV.CreateNewGroup(Names.CASE_0003ET, (CASE_0003ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_AP_0001EV, args, 3);
            SetPassedParm(IMPORT_CH_0002EV, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_AP_0001EV, args, 3);
            SetReturnParm(IMPORT_CH_0002EV, args, 4);
    ...
    public class SWEXSI10 : EABBase
    {
        ...
        public SWEXSI10()
            : base()
        {
            this.ProgramName.SetValue("SWEXSI10");

            WS = new SWEXSI10_ws();
            FD = new SWEXSI10_fd(WS);
            LS = new SWEXSI10_ls();
        }
        ...
        private SWEXSI10_ws WS;

        //==== File Data Class ========================================
        private SWEXSI10_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXSI10_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-AP-0001EV , IMPORT-CH-0002EV , IMPORT-AP-0003EV , IMPORT-0004EV , EXPORT-0005EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0310642405(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0310642405
        /// </summary>
        private void M_MAIN_0310642405(string returnMethod = "")
        {
            M_PARA_0310642405_INIT("M_PARA_0310642405_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0310642405-INIT THRU PARA-0310642405-INIT-EXIT
            M_PARA_0310642405("M_PARA_0310642405_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0310642405 THRU PARA-0310642405-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0310642405
        /// </summary>
        private void M_PARA_0310642405(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0310642405") { M_1000_EAB_CODE_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            // EvaluateList !LS.FILE_INSTRUCTION_0004!                                                          //COBOL==> EVALUATE FILE-INSTRUCTION-0004
            if ((LS.FILE_INSTRUCTION_0004.IsEqualTo("OPEN")))                                                   //COBOL==> WHEN 'OPEN'
            {
        ...
        private void M_1100_OPEN_FILES(string returnMethod = "")
        {
            ...
            {
                LS.TEXT_RETURN_CODE_0005.SetValue("O1");                                                            //COBOL==> MOVE 'O1' TO TEXT-RETURN-CODE-0005
        ...
        {
            WS.WS_CASE_NUMBER.SetValue(LS.NUMBER_0003);                                                         //COBOL==> MOVE NUMBER-0003 TO WS-CASE-NUMBER.
            WS.WS_AP_CSE_PERS.SetValue(LS.NUMBER_0001);                                                         //COBOL==> MOVE NUMBER-0001 TO WS-AP-CSE-PERS.
            WS.WS_DOB_EDIT.SetValue(LS.DOB_0001);                                                               //COBOL==> MOVE DOB-0001 TO WS-DOB-EDIT.
            WS.WS_AP_DOB.SetValue(WS.WS_DOB);                                                                   //COBOL==> MOVE WS-DOB TO WS-AP-DOB.
            WS.WS_AP_SSN.SetValue(LS.SSN_0001);                                                                 //COBOL==> MOVE SSN-0001 TO WS-AP-SSN.
            WS.WS_AP_NAME.SetValue(LS.FORMATTED_NAME_0001);                                                     //COBOL==> MOVE FORMATTED-NAME-0001 TO WS-AP-NAME.
            WS.WS_CH_CSE_PERS.SetValue(LS.NUMBER_0002);                                                         //COBOL==> MOVE NUMBER-0002 TO WS-CH-CSE-PERS.
            WS.WS_DOB_EDIT.SetValue(LS.DOB_0002);                                                               //COBOL==> MOVE DOB-0002 TO WS-DOB-EDIT.
            WS.WS_CH_DOB.SetValue(WS.WS_DOB);                                                                   //COBOL==> MOVE WS-DOB TO WS-CH-DOB.
            WS.WS_CH_SSN.SetValue(LS.SSN_0002);                                                                 //COBOL==> MOVE SSN-0002 TO WS-CH-SSN.
            WS.WS_CH_NAME.SetValue(LS.FORMATTED_NAME_0002);                                                     //COBOL==> MOVE FORMATTED-NAME-0002 TO WS-CH-NAME.
            FD.OUTFILE.WriteLine(WS.WS_OUTFILE_REC.AsBytes);                                                    //COBOL==> WRITE OUTFILE-REC FROM WS-OUTFILE-REC.
            if (!(WS.OUTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF OUTFILE-STAT NOT = 0
            {
                LS.TEXT_RETURN_CODE_0005.SetValue("W1");                                                            //COBOL==> MOVE 'W1' TO TEXT-RETURN-CODE-0005
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_1400_CLOSE_FILES(string returnMethod = "")
        {
            ...
            if (!(WS.OUTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF OUTFILE-STAT NOT = 0
            {
                LS.TEXT_RETURN_CODE_0005.SetValue("C1");                                                            //COBOL==> MOVE 'C1' TO TEXT-RETURN-CODE-0005
        ...
        private void M_9999_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_EXIT") { M_PARA_0310642405_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0310642405_EXIT
        /// </summary>
        private void M_PARA_0310642405_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0310642405_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0310642405_EXIT") { M_PARA_0310642405_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0310642405_INIT
        /// </summary>
        private void M_PARA_0310642405_INIT(string returnMethod = "")
        {
            LS.EXPORT_0005EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0005EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0310642405_INIT") { M_PARA_0310642405_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0310642405_INIT_EXIT
        /// </summary>
        private void M_PARA_0310642405_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0310642405_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
