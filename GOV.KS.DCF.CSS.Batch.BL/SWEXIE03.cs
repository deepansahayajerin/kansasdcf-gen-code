...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:51:02 PM
   **        *   FROM COBOL PGM   :  SWEXIE03
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: SI_B283_EAB_WRITE_INITIATIVE_FIL DATE: 2016/01/20
       TARGET OS:   MVS                       TIME: 20:55:41
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXIE03_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXIE03_fd_FileSection";
            internal const string OUTPUT_FILE = "OUTPUT_FILE";
            internal const string OUTPUT_FILE_RECORD = "OUTPUT_FILE_RECORD";
            internal const string RECORD_DETAIL = "RECORD_DETAIL";
            internal const string TEMP_FILE = "TEMP_FILE";
            internal const string TEMP_FILE_RECORD = "TEMP_FILE_RECORD";
            internal const string TEMP_DETAIL = "TEMP_DETAIL";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink OUTPUT_FILE { get; set; }
        public IGroup OUTPUT_FILE_RECORD { get { return GetElementByName<IGroup>(Names.OUTPUT_FILE_RECORD); } }
        public IField RECORD_DETAIL { get { return GetElementByName<IField>(Names.RECORD_DETAIL); } }
        public IFileLink TEMP_FILE { get; set; }
        public IGroup TEMP_FILE_RECORD { get { return GetElementByName<IGroup>(Names.TEMP_FILE_RECORD); } }
        public IField TEMP_DETAIL { get { return GetElementByName<IField>(Names.TEMP_DETAIL); } }


        internal SWEXIE03_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.OUTPUT_FILE_RECORD, (OUTPUT_FILE_RECORD) =>
           {
               OUTPUT_FILE_RECORD.CreateNewField(Names.RECORD_DETAIL, FieldType.String, 254);
           });

            recordDef.CreateNewGroup(Names.TEMP_FILE_RECORD, (TEMP_FILE_RECORD) =>
           {
               TEMP_FILE_RECORD.CreateNewField(Names.TEMP_DETAIL, FieldType.String, 254);
           });
        ...
        public override void Initialize()
        {
            ...
            OUTPUT_FILE.AssociatedBuffer = OUTPUT_FILE_RECORD;

            TEMP_FILE = FileHandler.GetFile("TEMPFILE");
            TEMP_FILE.StatusField = WS.FILE_STATUS;
            TEMP_FILE.AssociatedBuffer = TEMP_FILE_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXIE03_fd(SWEXIE03_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXIE03_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXIE03_ws_WorkingStorage";
    ...
    internal class SWEXIE03_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIE03_ls_LinkageSection";
            ...
            internal const string NEW_HIRE_INITIATIVE_REC_0002ET = "NEW_HIRE_INITIATIVE_REC_0002ET";
            internal const string OUTPUT_RECORD_0002AS = "OUTPUT_RECORD_0002AS";
            internal const string OUTPUT_RECORD_0002 = "OUTPUT_RECORD_0002";
            internal const string OUTPUT_RECORD_0002XX = "OUTPUT_RECORD_0002XX";
        ...
        public IGroup NEW_HIRE_INITIATIVE_REC_0002ET { get { return GetElementByName<IGroup>(Names.NEW_HIRE_INITIATIVE_REC_0002ET); } }
        public IField OUTPUT_RECORD_0002AS { get { return GetElementByName<IField>(Names.OUTPUT_RECORD_0002AS); } }
        public IField OUTPUT_RECORD_0002 { get { return GetElementByName<IField>(Names.OUTPUT_RECORD_0002); } }
        public IField OUTPUT_RECORD_0002XX { get { return GetElementByName<IField>(Names.OUTPUT_RECORD_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.NEW_HIRE_INITIATIVE_REC_0002ET, (NEW_HIRE_INITIATIVE_REC_0002ET) =>
               {
                   NEW_HIRE_INITIATIVE_REC_0002ET.CreateNewField(Names.OUTPUT_RECORD_0002AS, FieldType.String, 1);

                   IField OUTPUT_RECORD_0002_local = NEW_HIRE_INITIATIVE_REC_0002ET.CreateNewField(Names.OUTPUT_RECORD_0002, FieldType.String, 254);
                   NEW_HIRE_INITIATIVE_REC_0002ET.CreateNewFieldRedefine(Names.OUTPUT_RECORD_0002XX, FieldType.String, OUTPUT_RECORD_0002_local, 254);
               });
           });
    ...
    public class SWEXIE03 : EABBase
    {
        ...
        public SWEXIE03()
            : base()
        {
            this.ProgramName.SetValue("SWEXIE03");

            WS = new SWEXIE03_ws();
            FD = new SWEXIE03_fd(WS);
            LS = new SWEXIE03_ls();
        }
        ...
        private SWEXIE03_ws WS;

        //==== File Data Class ========================================
        private SWEXIE03_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXIE03_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0767297322(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0767297322
        /// </summary>
        private void M_MAIN_0767297322(string returnMethod = "")
        {
            M_PARA_0767297322_INIT("M_PARA_0767297322_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0767297322-INIT THRU PARA-0767297322-INIT-EXIT
            M_PARA_0767297322("M_PARA_0767297322_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0767297322 THRU PARA-0767297322-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0767297322
        /// </summary>
        private void M_PARA_0767297322(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0767297322") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_1000_OPEN_FILE(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1000_OPEN_FILE") { M_2000_WRITE_RECORD(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            //COMMENT: ******************
            FD.TEMP_FILE_RECORD.SetValue(LS.OUTPUT_RECORD_0002);                                                //COBOL==> MOVE OUTPUT-RECORD-0002 TO TEMP-FILE-RECORD
            FD.TEMP_FILE.WriteLine(FD.TEMP_FILE_RECORD.AsBytes);                                                //COBOL==> WRITE TEMP-FILE-RECORD
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003
            }                                                                                                   //COBOL==> ELSE
        ...
        private void M_3000_COMMIT_FILE(string returnMethod = "")
        {
            ...
            FD.OUTPUT_FILE.OpenFile(FileAccessMode.WriteExtend);                                                //COBOL==> OPEN EXTEND OUTPUT-FILE
            if (WS.FILE_STATUS.IsEqualTo("00"))                                                                 //COBOL==> IF FILE-STATUS = '00'
            {
                LS.STATUS_0003.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0003
            }                                                                                                   //COBOL==> ELSE
            ...
            {
                FD.OUTPUT_FILE_RECORD.SetValue(FD.TEMP_FILE_RECORD);                                                //COBOL==> MOVE TEMP-FILE-RECORD TO OUTPUT-FILE-RECORD
                FD.OUTPUT_FILE.WriteLine(FD.OUTPUT_FILE_RECORD.AsBytes);                                            //COBOL==> WRITE OUTPUT-FILE-RECORD
                if (!(WS.FILE_STATUS.IsEqualTo("00")))                                                              //COBOL==> IF FILE-STATUS NOT = '00'
                {
                    LS.STATUS_0003.SetValue("W2");                                                                      //COBOL==> MOVE 'W2' TO STATUS-0003
                    M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED
                }                                                                                                   //COBOL==> END-IF
                FD.TEMP_FILE.ReadLine();                                                                            //COBOL==> READ TEMP-FILE
                if (FD.TEMP_FILE.FileStatus == FileStatus.End_of_file)                                              //COBOL==> AT END
        ...
        {
            //COMMENT: ******************
            FD.TEMP_FILE.CloseFile();                                                                           //COBOL==> CLOSE TEMP-FILE , OUTPUT-FILE.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0767297322_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0767297322_EXIT
        /// </summary>
        private void M_PARA_0767297322_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0767297322_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0767297322_EXIT") { M_PARA_0767297322_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0767297322_INIT
        /// </summary>
        private void M_PARA_0767297322_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0767297322_INIT") { M_PARA_0767297322_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0767297322_INIT_EXIT
        /// </summary>
        private void M_PARA_0767297322_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0767297322_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
