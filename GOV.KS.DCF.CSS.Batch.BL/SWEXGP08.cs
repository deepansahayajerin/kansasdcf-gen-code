...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:34 PM
   **        *   FROM COBOL PGM   :  SWEXGP08
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGP08_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP08_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT08");
    ...
    internal class SWEXGP08_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP08_ws_WorkingStorage";
    ...
    internal class SWEXGP08_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP08_ls_LinkageSection";
    ...
    public class SWEXGP08 : EABBase
    {
        ...
        public SWEXGP08()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP08");
        ...
        private SWEXGP08_ws WS;

        //==== File Data Class ========================================
        private SWEXGP08_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP08_ls LS;
        #endregion
