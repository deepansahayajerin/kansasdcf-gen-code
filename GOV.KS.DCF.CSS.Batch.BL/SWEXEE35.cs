...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:11 PM
   **        *   FROM COBOL PGM   :  SWEXEE35
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_WRITE_HINS_AVAILABILITY_CHGS DATE: 1999/07/14
       TARGET OS:   MVS                       TIME: 13:53:36
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEE35_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEE35_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.DETAIL_01, FieldType.String, 332);
            recordDef.CreateNewField(Names.TRAILER_02, FieldType.String, 332);
    ...
    internal class SWEXEE35_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEE35_ws_WorkingStorage";
            internal const string WS_TYPED = "WS_TYPED";
            internal const string WSD_RECORD_TYPE = "WSD_RECORD_TYPE";
            internal const string WSD_BENEFICIARY_NUMBER = "WSD_BENEFICIARY_NUMBER";
            internal const string WSD_BENEFICIARY_L_NAME = "WSD_BENEFICIARY_L_NAME";
            internal const string WSD_BENEFICIARY_F_NAME = "WSD_BENEFICIARY_F_NAME";
            internal const string WSD_BENEFICIARY_M_INIT = "WSD_BENEFICIARY_M_INIT";
            internal const string WSD_INS_POLICY_ID = "WSD_INS_POLICY_ID";
            internal const string WSD_GROUP_NUMBER = "WSD_GROUP_NUMBER";
            internal const string WSD_INSURERS_NAME = "WSD_INSURERS_NAME";
            internal const string WSD_INSURERS_ADDR1 = "WSD_INSURERS_ADDR1";
            internal const string WSD_INSURERS_ADDR2 = "WSD_INSURERS_ADDR2";
            internal const string WSD_INSURERS_CITY = "WSD_INSURERS_CITY";
            internal const string WSD_INSURERS_STATE = "WSD_INSURERS_STATE";
            internal const string WSD_INSURERS_ZIP9 = "WSD_INSURERS_ZIP9";
            internal const string WSD_INSURERS_ZIP = "WSD_INSURERS_ZIP";
            internal const string WSD_INSURERS_ZIP5 = "WSD_INSURERS_ZIP5";
            internal const string WSD_INSURERS_ZIP4 = "WSD_INSURERS_ZIP4";
            internal const string WSD_AVAIL_VERIFIED_DATE = "WSD_AVAIL_VERIFIED_DATE";
            internal const string WSD_AVAIL_END_DATE = "WSD_AVAIL_END_DATE";
            ...
            internal const string WSD_EMPLOYER_ZIP9 = "WSD_EMPLOYER_ZIP9";
            internal const string WSD_EMPLOYER_ZIP = "WSD_EMPLOYER_ZIP";
        ...
        public IField WSD_BENEFICIARY_NUMBER { get { return GetElementByName<IField>(Names.WSD_BENEFICIARY_NUMBER); } }
        public IField WSD_BENEFICIARY_L_NAME { get { return GetElementByName<IField>(Names.WSD_BENEFICIARY_L_NAME); } }
        public IField WSD_BENEFICIARY_F_NAME { get { return GetElementByName<IField>(Names.WSD_BENEFICIARY_F_NAME); } }
        public IField WSD_BENEFICIARY_M_INIT { get { return GetElementByName<IField>(Names.WSD_BENEFICIARY_M_INIT); } }
        public IField WSD_INS_POLICY_ID { get { return GetElementByName<IField>(Names.WSD_INS_POLICY_ID); } }
        public IField WSD_GROUP_NUMBER { get { return GetElementByName<IField>(Names.WSD_GROUP_NUMBER); } }
        public IField WSD_INSURERS_NAME { get { return GetElementByName<IField>(Names.WSD_INSURERS_NAME); } }
        public IField WSD_INSURERS_ADDR1 { get { return GetElementByName<IField>(Names.WSD_INSURERS_ADDR1); } }
        public IField WSD_INSURERS_ADDR2 { get { return GetElementByName<IField>(Names.WSD_INSURERS_ADDR2); } }
        public IField WSD_INSURERS_CITY { get { return GetElementByName<IField>(Names.WSD_INSURERS_CITY); } }
        public IField WSD_INSURERS_STATE { get { return GetElementByName<IField>(Names.WSD_INSURERS_STATE); } }
        public IField WSD_INSURERS_ZIP9 { get { return GetElementByName<IField>(Names.WSD_INSURERS_ZIP9); } }
        public IGroup WSD_INSURERS_ZIP { get { return GetElementByName<IGroup>(Names.WSD_INSURERS_ZIP); } }
        public IField WSD_INSURERS_ZIP5 { get { return GetElementByName<IField>(Names.WSD_INSURERS_ZIP5); } }
        public IField WSD_INSURERS_ZIP4 { get { return GetElementByName<IField>(Names.WSD_INSURERS_ZIP4); } }
        public IField WSD_AVAIL_VERIFIED_DATE { get { return GetElementByName<IField>(Names.WSD_AVAIL_VERIFIED_DATE); } }
        public IField WSD_AVAIL_END_DATE { get { return GetElementByName<IField>(Names.WSD_AVAIL_END_DATE); } }
        public IField WSD_EMPLOYER_NAME { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_NAME); } }
        public IField WSD_EMPLOYER_ADDR1 { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_ADDR1); } }
        public IField WSD_EMPLOYER_ADDR2 { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_ADDR2); } }
        public IField WSD_EMPLOYER_CITY { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_CITY); } }
        public IField WSD_EMPLOYER_STATE { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_STATE); } }
        public IField WSD_EMPLOYER_ZIP9 { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_ZIP9); } }
        public IGroup WSD_EMPLOYER_ZIP { get { return GetElementByName<IGroup>(Names.WSD_EMPLOYER_ZIP); } }
        public IField WSD_EMPLOYER_ZIP5 { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_ZIP5); } }
        public IField WSD_EMPLOYER_ZIP4 { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_ZIP4); } }
        public IField WSD_EMPLOYER_AREA_CODE { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_AREA_CODE); } }
        public IField WSD_EMPLOYER_PHONE_NUM { get { return GetElementByName<IField>(Names.WSD_EMPLOYER_PHONE_NUM); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_TYPED, (WS_TYPED) =>
           {
               ...
               WS_TYPED.CreateNewField(Names.WSD_BENEFICIARY_NUMBER, FieldType.String, 11, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_BENEFICIARY_L_NAME, FieldType.String, 17, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_BENEFICIARY_F_NAME, FieldType.String, 14, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_BENEFICIARY_M_INIT, FieldType.String, 1, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_INS_POLICY_ID, FieldType.String, 12, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_GROUP_NUMBER, FieldType.String, 9, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_INSURERS_NAME, FieldType.String, 30, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_INSURERS_ADDR1, FieldType.String, 25, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_INSURERS_ADDR2, FieldType.String, 25, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_INSURERS_CITY, FieldType.String, 15, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_INSURERS_STATE, FieldType.String, 2, SPACES);

               IField WSD_INSURERS_ZIP9_local = WS_TYPED.CreateNewField(Names.WSD_INSURERS_ZIP9, FieldType.String, 9, SPACES);
               WS_TYPED.CreateNewGroupRedefine(Names.WSD_INSURERS_ZIP, WSD_INSURERS_ZIP9_local, (WSD_INSURERS_ZIP) =>
               {
                   WSD_INSURERS_ZIP.CreateNewField(Names.WSD_INSURERS_ZIP5, FieldType.String, 5);
                   WSD_INSURERS_ZIP.CreateNewField(Names.WSD_INSURERS_ZIP4, FieldType.String, 4);
               });
               WS_TYPED.CreateNewField(Names.WSD_AVAIL_VERIFIED_DATE, FieldType.UnsignedNumeric, 8, ZERO);
               WS_TYPED.CreateNewField(Names.WSD_AVAIL_END_DATE, FieldType.UnsignedNumeric, 8, ZERO);
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_NAME, FieldType.String, 30, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_ADDR1, FieldType.String, 25, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_ADDR2, FieldType.String, 25, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_CITY, FieldType.String, 15, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_STATE, FieldType.String, 2, SPACES);

               IField WSD_EMPLOYER_ZIP9_local = WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_ZIP9, FieldType.String, 9, SPACES);
               WS_TYPED.CreateNewGroupRedefine(Names.WSD_EMPLOYER_ZIP, WSD_EMPLOYER_ZIP9_local, (WSD_EMPLOYER_ZIP) =>
               {
                   WSD_EMPLOYER_ZIP.CreateNewField(Names.WSD_EMPLOYER_ZIP5, FieldType.String, 5);
                   WSD_EMPLOYER_ZIP.CreateNewField(Names.WSD_EMPLOYER_ZIP4, FieldType.String, 4);
               });
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_AREA_CODE, FieldType.String, 3, SPACES);
               WS_TYPED.CreateNewField(Names.WSD_EMPLOYER_PHONE_NUM, FieldType.String, 7, SPACES);
               WS_TYPED.CreateNewFillerField(FieldType.String, 29, SPACES);
           });
            ...
            recordDef.CreateNewGroup(Names.WS_TYPET, (WS_TYPET) =>
           {
               ...
               WS_TYPET.CreateNewFillerField(FieldType.String, 313, SPACES);
           });
    ...
    internal class SWEXEE35_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEE35_ls_LinkageSection";
            ...
            internal const string HEALTH_INSURANCE_AVAILA_0002ET = "HEALTH_INSURANCE_AVAILA_0002ET";
            internal const string INSURANCE_ID_0002AS = "INSURANCE_ID_0002AS";
            internal const string INSURANCE_ID_0002 = "INSURANCE_ID_0002";
            internal const string INSURANCE_ID_0002XX = "INSURANCE_ID_0002XX";
            internal const string INSURANCE_POLICY_NUMBER_0003AS = "INSURANCE_POLICY_NUMBER_0003AS";
            internal const string INSURANCE_POLICY_NUMBER_0003 = "INSURANCE_POLICY_NUMBER_0003";
            internal const string INSURANCE_POLICY_NUMBER_0003XX = "INSURANCE_POLICY_NUMBER_0003XX";
            ...
            internal const string INSURANCE_NAME_0003AS = "INSURANCE_NAME_0003AS";
            internal const string INSURANCE_NAME_0003 = "INSURANCE_NAME_0003";
            internal const string INSURANCE_NAME_0003XX = "INSURANCE_NAME_0003XX";
            ...
            internal const string ZIP_5_0003AS = "ZIP_5_0003AS";
            internal const string ZIP_5_0003 = "ZIP_5_0003";
            internal const string ZIP_5_0003XX = "ZIP_5_0003XX";
            internal const string ZIP_4_0003AS = "ZIP_4_0003AS";
            internal const string ZIP_4_0003 = "ZIP_4_0003";
            internal const string ZIP_4_0003XX = "ZIP_4_0003XX";
            internal const string VERIFIED_DATE_0003AS = "VERIFIED_DATE_0003AS";
            internal const string VERIFIED_DATE_0003 = "VERIFIED_DATE_0003";
            internal const string VERIFIED_DATE_0003XX = "VERIFIED_DATE_0003XX";
            internal const string END_DATE_0003AS = "END_DATE_0003AS";
            internal const string END_DATE_0003 = "END_DATE_0003";
            internal const string END_DATE_0003XX = "END_DATE_0003XX";
            internal const string EMPLOYER_NAME_0003AS = "EMPLOYER_NAME_0003AS";
            internal const string EMPLOYER_NAME_0003 = "EMPLOYER_NAME_0003";
            internal const string EMPLOYER_NAME_0003XX = "EMPLOYER_NAME_0003XX";
            internal const string EMP_STREET_1_0003AS = "EMP_STREET_1_0003AS";
            internal const string EMP_STREET_1_0003 = "EMP_STREET_1_0003";
            internal const string EMP_STREET_1_0003XX = "EMP_STREET_1_0003XX";
            internal const string EMP_STREET_2_0003AS = "EMP_STREET_2_0003AS";
            internal const string EMP_STREET_2_0003 = "EMP_STREET_2_0003";
            internal const string EMP_STREET_2_0003XX = "EMP_STREET_2_0003XX";
            internal const string EMP_CITY_0003AS = "EMP_CITY_0003AS";
            internal const string EMP_CITY_0003 = "EMP_CITY_0003";
            internal const string EMP_CITY_0003XX = "EMP_CITY_0003XX";
            internal const string EMP_STATE_0003AS = "EMP_STATE_0003AS";
            internal const string EMP_STATE_0003 = "EMP_STATE_0003";
            internal const string EMP_STATE_0003XX = "EMP_STATE_0003XX";
            internal const string EMP_ZIP_5_0003AS = "EMP_ZIP_5_0003AS";
            internal const string EMP_ZIP_5_0003 = "EMP_ZIP_5_0003";
            internal const string EMP_ZIP_5_0003XX = "EMP_ZIP_5_0003XX";
            internal const string EMP_ZIP_4_0003AS = "EMP_ZIP_4_0003AS";
            internal const string EMP_ZIP_4_0003 = "EMP_ZIP_4_0003";
            internal const string EMP_ZIP_4_0003XX = "EMP_ZIP_4_0003XX";
            internal const string EMP_PHONE_AREA_CODE_0003AS = "EMP_PHONE_AREA_CODE_0003AS";
            internal const string EMP_PHONE_AREA_CODE_0003 = "EMP_PHONE_AREA_CODE_0003";
            internal const string EMP_PHONE_AREA_CODE_0003XX = "EMP_PHONE_AREA_CODE_0003XX";
            internal const string EMP_PHONE_NO_0003AS = "EMP_PHONE_NO_0003AS";
            internal const string EMP_PHONE_NO_0003 = "EMP_PHONE_NO_0003";
            internal const string EMP_PHONE_NO_0003XX = "EMP_PHONE_NO_0003XX";
            ...
            internal const string IMPORT_RECORD_0005EV = "IMPORT_RECORD_0005EV";
            ...
            internal const string EAB_FILE_HANDLING_0006ET = "EAB_FILE_HANDLING_0006ET";
            internal const string ACTION_0006AS = "ACTION_0006AS";
            internal const string ACTION_0006 = "ACTION_0006";
            internal const string ACTION_0006XX = "ACTION_0006XX";
        ...
        public IGroup HEALTH_INSURANCE_AVAILA_0002ET { get { return GetElementByName<IGroup>(Names.HEALTH_INSURANCE_AVAILA_0002ET); } }
        public IField INSURANCE_ID_0002AS { get { return GetElementByName<IField>(Names.INSURANCE_ID_0002AS); } }
        public IField INSURANCE_ID_0002 { get { return GetElementByName<IField>(Names.INSURANCE_ID_0002); } }
        public IField INSURANCE_ID_0002XX { get { return GetElementByName<IField>(Names.INSURANCE_ID_0002XX); } }
        public IField INSURANCE_POLICY_NUMBER_0003AS { get { return GetElementByName<IField>(Names.INSURANCE_POLICY_NUMBER_0003AS); } }
        public IField INSURANCE_POLICY_NUMBER_0003 { get { return GetElementByName<IField>(Names.INSURANCE_POLICY_NUMBER_0003); } }
        public IField INSURANCE_POLICY_NUMBER_0003XX { get { return GetElementByName<IField>(Names.INSURANCE_POLICY_NUMBER_0003XX); } }
        ...
        public IField INSURANCE_NAME_0003AS { get { return GetElementByName<IField>(Names.INSURANCE_NAME_0003AS); } }
        public IField INSURANCE_NAME_0003 { get { return GetElementByName<IField>(Names.INSURANCE_NAME_0003); } }
        public IField INSURANCE_NAME_0003XX { get { return GetElementByName<IField>(Names.INSURANCE_NAME_0003XX); } }
        ...
        public IField ZIP_5_0003AS { get { return GetElementByName<IField>(Names.ZIP_5_0003AS); } }
        public IField ZIP_5_0003 { get { return GetElementByName<IField>(Names.ZIP_5_0003); } }
        public IField ZIP_5_0003XX { get { return GetElementByName<IField>(Names.ZIP_5_0003XX); } }
        public IField ZIP_4_0003AS { get { return GetElementByName<IField>(Names.ZIP_4_0003AS); } }
        public IField ZIP_4_0003 { get { return GetElementByName<IField>(Names.ZIP_4_0003); } }
        public IField ZIP_4_0003XX { get { return GetElementByName<IField>(Names.ZIP_4_0003XX); } }
        public IField VERIFIED_DATE_0003AS { get { return GetElementByName<IField>(Names.VERIFIED_DATE_0003AS); } }
        public IField VERIFIED_DATE_0003 { get { return GetElementByName<IField>(Names.VERIFIED_DATE_0003); } }
        public IField VERIFIED_DATE_0003XX { get { return GetElementByName<IField>(Names.VERIFIED_DATE_0003XX); } }
        public IField END_DATE_0003AS { get { return GetElementByName<IField>(Names.END_DATE_0003AS); } }
        public IField END_DATE_0003 { get { return GetElementByName<IField>(Names.END_DATE_0003); } }
        public IField END_DATE_0003XX { get { return GetElementByName<IField>(Names.END_DATE_0003XX); } }
        public IField EMPLOYER_NAME_0003AS { get { return GetElementByName<IField>(Names.EMPLOYER_NAME_0003AS); } }
        public IField EMPLOYER_NAME_0003 { get { return GetElementByName<IField>(Names.EMPLOYER_NAME_0003); } }
        public IField EMPLOYER_NAME_0003XX { get { return GetElementByName<IField>(Names.EMPLOYER_NAME_0003XX); } }
        public IField EMP_STREET_1_0003AS { get { return GetElementByName<IField>(Names.EMP_STREET_1_0003AS); } }
        public IField EMP_STREET_1_0003 { get { return GetElementByName<IField>(Names.EMP_STREET_1_0003); } }
        public IField EMP_STREET_1_0003XX { get { return GetElementByName<IField>(Names.EMP_STREET_1_0003XX); } }
        public IField EMP_STREET_2_0003AS { get { return GetElementByName<IField>(Names.EMP_STREET_2_0003AS); } }
        public IField EMP_STREET_2_0003 { get { return GetElementByName<IField>(Names.EMP_STREET_2_0003); } }
        public IField EMP_STREET_2_0003XX { get { return GetElementByName<IField>(Names.EMP_STREET_2_0003XX); } }
        public IField EMP_CITY_0003AS { get { return GetElementByName<IField>(Names.EMP_CITY_0003AS); } }
        public IField EMP_CITY_0003 { get { return GetElementByName<IField>(Names.EMP_CITY_0003); } }
        public IField EMP_CITY_0003XX { get { return GetElementByName<IField>(Names.EMP_CITY_0003XX); } }
        public IField EMP_STATE_0003AS { get { return GetElementByName<IField>(Names.EMP_STATE_0003AS); } }
        public IField EMP_STATE_0003 { get { return GetElementByName<IField>(Names.EMP_STATE_0003); } }
        public IField EMP_STATE_0003XX { get { return GetElementByName<IField>(Names.EMP_STATE_0003XX); } }
        public IField EMP_ZIP_5_0003AS { get { return GetElementByName<IField>(Names.EMP_ZIP_5_0003AS); } }
        public IField EMP_ZIP_5_0003 { get { return GetElementByName<IField>(Names.EMP_ZIP_5_0003); } }
        public IField EMP_ZIP_5_0003XX { get { return GetElementByName<IField>(Names.EMP_ZIP_5_0003XX); } }
        public IField EMP_ZIP_4_0003AS { get { return GetElementByName<IField>(Names.EMP_ZIP_4_0003AS); } }
        public IField EMP_ZIP_4_0003 { get { return GetElementByName<IField>(Names.EMP_ZIP_4_0003); } }
        public IField EMP_ZIP_4_0003XX { get { return GetElementByName<IField>(Names.EMP_ZIP_4_0003XX); } }
        public IField EMP_PHONE_AREA_CODE_0003AS { get { return GetElementByName<IField>(Names.EMP_PHONE_AREA_CODE_0003AS); } }
        public IField EMP_PHONE_AREA_CODE_0003 { get { return GetElementByName<IField>(Names.EMP_PHONE_AREA_CODE_0003); } }
        public IField EMP_PHONE_AREA_CODE_0003XX { get { return GetElementByName<IField>(Names.EMP_PHONE_AREA_CODE_0003XX); } }
        public IField EMP_PHONE_NO_0003AS { get { return GetElementByName<IField>(Names.EMP_PHONE_NO_0003AS); } }
        public IField EMP_PHONE_NO_0003 { get { return GetElementByName<IField>(Names.EMP_PHONE_NO_0003); } }
        public IField EMP_PHONE_NO_0003XX { get { return GetElementByName<IField>(Names.EMP_PHONE_NO_0003XX); } }
        ...
        public IGroup IMPORT_RECORD_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_RECORD_0005EV); } }
        ...
        public IGroup EAB_FILE_HANDLING_0006ET { get { return GetElementByName<IGroup>(Names.EAB_FILE_HANDLING_0006ET); } }
        public IField ACTION_0006AS { get { return GetElementByName<IField>(Names.ACTION_0006AS); } }
        public IField ACTION_0006 { get { return GetElementByName<IField>(Names.ACTION_0006); } }
        public IField ACTION_0006XX { get { return GetElementByName<IField>(Names.ACTION_0006XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.HEALTH_INSURANCE_AVAILA_0002ET, (HEALTH_INSURANCE_AVAILA_0002ET) =>
               {
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_ID_0002AS, FieldType.String, 1);

                   IField INSURANCE_ID_0002_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_ID_0002, FieldType.SignedNumeric, 5);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.INSURANCE_ID_0002XX, FieldType.String, INSURANCE_ID_0002_local, 5);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_POLICY_NUMBER_0003AS, FieldType.String, 1);

                   IField INSURANCE_POLICY_NUMBER_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_POLICY_NUMBER_0003, FieldType.String, 20);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.INSURANCE_POLICY_NUMBER_0003XX, FieldType.String, INSURANCE_POLICY_NUMBER_0003_local, 20);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_GROUP_NUMBER_0003AS, FieldType.String, 1);

                   IField INSURANCE_GROUP_NUMBER_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_GROUP_NUMBER_0003, FieldType.String, 20);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.INSURANCE_GROUP_NUMBER_0003XX, FieldType.String, INSURANCE_GROUP_NUMBER_0003_local, 20);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_NAME_0003AS, FieldType.String, 1);

                   IField INSURANCE_NAME_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.INSURANCE_NAME_0003, FieldType.String, 30);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.INSURANCE_NAME_0003XX, FieldType.String, INSURANCE_NAME_0003_local, 30);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.STREET_1_0003AS, FieldType.String, 1);

                   IField STREET_1_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.STREET_1_0003, FieldType.String, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.STREET_1_0003XX, FieldType.String, STREET_1_0003_local, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.STREET_2_0003AS, FieldType.String, 1);

                   IField STREET_2_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.STREET_2_0003, FieldType.String, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.STREET_2_0003XX, FieldType.String, STREET_2_0003_local, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.CITY_0003AS, FieldType.String, 1);

                   IField CITY_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.CITY_0003, FieldType.String, 15);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.CITY_0003XX, FieldType.String, CITY_0003_local, 15);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.STATE_0003AS, FieldType.String, 1);

                   IField STATE_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.STATE_0003, FieldType.String, 2);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.STATE_0003XX, FieldType.String, STATE_0003_local, 2);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.ZIP_5_0003AS, FieldType.String, 1);

                   IField ZIP_5_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.ZIP_5_0003, FieldType.String, 5);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.ZIP_5_0003XX, FieldType.String, ZIP_5_0003_local, 5);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.ZIP_4_0003AS, FieldType.String, 1);

                   IField ZIP_4_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.ZIP_4_0003, FieldType.String, 4);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.ZIP_4_0003XX, FieldType.String, ZIP_4_0003_local, 4);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.VERIFIED_DATE_0003AS, FieldType.String, 1);

                   IField VERIFIED_DATE_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.VERIFIED_DATE_0003, FieldType.SignedNumeric, 8);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.VERIFIED_DATE_0003XX, FieldType.String, VERIFIED_DATE_0003_local, 8);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.END_DATE_0003AS, FieldType.String, 1);

                   IField END_DATE_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.END_DATE_0003, FieldType.SignedNumeric, 8);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.END_DATE_0003XX, FieldType.String, END_DATE_0003_local, 8);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMPLOYER_NAME_0003AS, FieldType.String, 1);

                   IField EMPLOYER_NAME_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMPLOYER_NAME_0003, FieldType.String, 30);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMPLOYER_NAME_0003XX, FieldType.String, EMPLOYER_NAME_0003_local, 30);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_STREET_1_0003AS, FieldType.String, 1);

                   IField EMP_STREET_1_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_STREET_1_0003, FieldType.String, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_STREET_1_0003XX, FieldType.String, EMP_STREET_1_0003_local, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_STREET_2_0003AS, FieldType.String, 1);

                   IField EMP_STREET_2_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_STREET_2_0003, FieldType.String, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_STREET_2_0003XX, FieldType.String, EMP_STREET_2_0003_local, 25);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_CITY_0003AS, FieldType.String, 1);

                   IField EMP_CITY_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_CITY_0003, FieldType.String, 15);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_CITY_0003XX, FieldType.String, EMP_CITY_0003_local, 15);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_STATE_0003AS, FieldType.String, 1);

                   IField EMP_STATE_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_STATE_0003, FieldType.String, 2);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_STATE_0003XX, FieldType.String, EMP_STATE_0003_local, 2);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_ZIP_5_0003AS, FieldType.String, 1);

                   IField EMP_ZIP_5_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_ZIP_5_0003, FieldType.String, 5);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_ZIP_5_0003XX, FieldType.String, EMP_ZIP_5_0003_local, 5);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_ZIP_4_0003AS, FieldType.String, 1);

                   IField EMP_ZIP_4_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_ZIP_4_0003, FieldType.String, 4);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_ZIP_4_0003XX, FieldType.String, EMP_ZIP_4_0003_local, 4);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_PHONE_AREA_CODE_0003AS, FieldType.String, 1);

                   IField EMP_PHONE_AREA_CODE_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_PHONE_AREA_CODE_0003, FieldType.SignedNumeric, 3);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_PHONE_AREA_CODE_0003XX, FieldType.String, EMP_PHONE_AREA_CODE_0003_local, 3);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_PHONE_NO_0003AS, FieldType.String, 1);

                   IField EMP_PHONE_NO_0003_local = HEALTH_INSURANCE_AVAILA_0002ET.CreateNewField(Names.EMP_PHONE_NO_0003, FieldType.SignedNumeric, 7);
                   HEALTH_INSURANCE_AVAILA_0002ET.CreateNewFieldRedefine(Names.EMP_PHONE_NO_0003XX, FieldType.String, EMP_PHONE_NO_0003_local, 7);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0004EV, (IMPORT_0004EV) =>
           {
               IMPORT_0004EV.CreateNewGroup(Names.DATE_WORK_AREA_0004ET, (DATE_WORK_AREA_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_RECORD_0005EV, (IMPORT_RECORD_0005EV) =>
           {
               IMPORT_RECORD_0005EV.CreateNewGroup(Names.IEF_SUPPLIED_0005ET, (IEF_SUPPLIED_0005ET) =>
               {
           ...
           {
               IMPORT_0006EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0006ET, (EAB_FILE_HANDLING_0006ET) =>
               {
                   EAB_FILE_HANDLING_0006ET.CreateNewField(Names.ACTION_0006AS, FieldType.String, 1);

                   IField ACTION_0006_local = EAB_FILE_HANDLING_0006ET.CreateNewField(Names.ACTION_0006, FieldType.String, 8);
                   EAB_FILE_HANDLING_0006ET.CreateNewFieldRedefine(Names.ACTION_0006XX, FieldType.String, ACTION_0006_local, 8);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_0004EV, args, 5);
            SetPassedParm(IMPORT_RECORD_0005EV, args, 6);
            SetPassedParm(IMPORT_0006EV, args, 7);
            SetPassedParm(EXPORT_0007EV, args, 8);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_0004EV, args, 5);
            SetReturnParm(IMPORT_RECORD_0005EV, args, 6);
            SetReturnParm(IMPORT_0006EV, args, 7);
            SetReturnParm(EXPORT_0007EV, args, 8);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXEE35 : EABBase
    {
        ...
        public SWEXEE35()
            : base()
        {
            this.ProgramName.SetValue("SWEXEE35");
        ...
        private SWEXEE35_ws WS;

        //==== File Data Class ========================================
        private SWEXEE35_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEE35_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV IMPORT-0002EV IMPORT-0004EV IMPORT-RECORD-0005EV IMPORT-0006EV , EXPORT-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0613688943(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0613688943
        /// </summary>
        private void M_MAIN_0613688943(string returnMethod = "")
        {
            M_PARA_0613688943_INIT("M_PARA_0613688943_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0613688943-INIT THRU PARA-0613688943-INIT-EXIT
            M_PARA_0613688943("M_PARA_0613688943_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0613688943 THRU PARA-0613688943-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0613688943
        /// </summary>
        private void M_PARA_0613688943(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            // EvaluateList !LS.ACTION_0006!                                                                    //COBOL==> EVALUATE ACTION-0006
            if ((LS.ACTION_0006.IsEqualTo("OPEN")))                                                             //COBOL==> WHEN 'OPEN'
            {
                M_PARA_OPEN("M_PARA_OPEN_EXIT"); if (Control.ExitProgram) { return; }                                 //COBOL==> PERFORM PARA-OPEN THRU PARA-OPEN-EXIT
            }                                                                                                //COBOL==> WHEN 'WRITE'
            else
            if ((LS.ACTION_0006.IsEqualTo("WRITE")))
            {
                M_PARA_MAIN("M_PARA_MAIN_EXIT"); if (Control.ExitProgram) { return; }                                 //COBOL==> PERFORM PARA-MAIN THRU PARA-MAIN-EXIT
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
            if ((LS.ACTION_0006.IsEqualTo("CLOSE")))
            {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_0613688943") { M_PARA_0613688943_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0613688943_EXIT
        /// </summary>
        private void M_PARA_0613688943_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0613688943_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0613688943_EXIT") { M_PARA_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_MAIN
        /// </summary>
        ...
        {
            WS.WSD_BENEFICIARY_NUMBER.SetValue(LS.NUMBER_0001);                                                 //COBOL==> MOVE NUMBER-0001 TO WSD-BENEFICIARY-NUMBER
            WS.WSD_BENEFICIARY_L_NAME.SetValue(LS.LAST_NAME_0001);                                              //COBOL==> MOVE LAST-NAME-0001 TO WSD-BENEFICIARY-L-NAME
            WS.WSD_BENEFICIARY_F_NAME.SetValue(LS.FIRST_NAME_0001);                                             //COBOL==> MOVE FIRST-NAME-0001 TO WSD-BENEFICIARY-F-NAME
            WS.WSD_BENEFICIARY_M_INIT.SetValue(LS.MIDDLE_INITIAL_0001);                                         //COBOL==> MOVE MIDDLE-INITIAL-0001 TO WSD-BENEFICIARY-M-INIT
            WS.WSD_INS_POLICY_ID.SetValue(LS.INSURANCE_POLICY_NUMBER_0003);                                     //COBOL==> MOVE INSURANCE-POLICY-NUMBER-0003 TO WSD-INS-POLICY-ID
            WS.WSD_GROUP_NUMBER.SetValue(LS.INSURANCE_GROUP_NUMBER_0003);                                       //COBOL==> MOVE INSURANCE-GROUP-NUMBER-0003 TO WSD-GROUP-NUMBER
            WS.WSD_INSURERS_NAME.SetValue(LS.INSURANCE_NAME_0003);                                              //COBOL==> MOVE INSURANCE-NAME-0003 TO WSD-INSURERS-NAME
            WS.WSD_INSURERS_ADDR1.SetValue(LS.STREET_1_0003);                                                   //COBOL==> MOVE STREET-1-0003 TO WSD-INSURERS-ADDR1
            WS.WSD_INSURERS_ADDR2.SetValue(LS.STREET_2_0003);                                                   //COBOL==> MOVE STREET-2-0003 TO WSD-INSURERS-ADDR2
            WS.WSD_INSURERS_CITY.SetValue(LS.CITY_0003);                                                        //COBOL==> MOVE CITY-0003 TO WSD-INSURERS-CITY
            WS.WSD_INSURERS_STATE.SetValue(LS.STATE_0003);                                                      //COBOL==> MOVE STATE-0003 TO WSD-INSURERS-STATE
            WS.WSD_INSURERS_ZIP5.SetValue(LS.ZIP_5_0003);                                                       //COBOL==> MOVE ZIP-5-0003 TO WSD-INSURERS-ZIP5
            WS.WSD_INSURERS_ZIP4.SetValue(LS.ZIP_4_0003);                                                       //COBOL==> MOVE ZIP-4-0003 TO WSD-INSURERS-ZIP4
            WS.WSD_AVAIL_VERIFIED_DATE.SetValue(LS.VERIFIED_DATE_0003);                                         //COBOL==> MOVE VERIFIED-DATE-0003 TO WSD-AVAIL-VERIFIED-DATE
            WS.WSD_AVAIL_END_DATE.SetValue(LS.END_DATE_0003);                                                   //COBOL==> MOVE END-DATE-0003 TO WSD-AVAIL-END-DATE
            WS.WSD_EMPLOYER_NAME.SetValue(LS.EMPLOYER_NAME_0003);                                               //COBOL==> MOVE EMPLOYER-NAME-0003 TO WSD-EMPLOYER-NAME
            WS.WSD_EMPLOYER_ADDR1.SetValue(LS.EMP_STREET_1_0003);                                               //COBOL==> MOVE EMP-STREET-1-0003 TO WSD-EMPLOYER-ADDR1
            WS.WSD_EMPLOYER_ADDR2.SetValue(LS.EMP_STREET_2_0003);                                               //COBOL==> MOVE EMP-STREET-2-0003 TO WSD-EMPLOYER-ADDR2
            WS.WSD_EMPLOYER_CITY.SetValue(LS.EMP_CITY_0003);                                                    //COBOL==> MOVE EMP-CITY-0003 TO WSD-EMPLOYER-CITY
            WS.WSD_EMPLOYER_STATE.SetValue(LS.EMP_STATE_0003);                                                  //COBOL==> MOVE EMP-STATE-0003 TO WSD-EMPLOYER-STATE
            WS.WSD_EMPLOYER_ZIP5.SetValue(LS.EMP_ZIP_5_0003);                                                   //COBOL==> MOVE EMP-ZIP-5-0003 TO WSD-EMPLOYER-ZIP5
            WS.WSD_EMPLOYER_ZIP4.SetValue(LS.EMP_ZIP_4_0003);                                                   //COBOL==> MOVE EMP-ZIP-4-0003 TO WSD-EMPLOYER-ZIP4
            WS.WSD_EMPLOYER_AREA_CODE.SetValue(LS.EMP_PHONE_AREA_CODE_0003);                                    //COBOL==> MOVE EMP-PHONE-AREA-CODE-0003 TO WSD-EMPLOYER-AREA-CODE
            WS.WSD_EMPLOYER_PHONE_NUM.SetValue(LS.EMP_PHONE_NO_0003);                                           //COBOL==> MOVE EMP-PHONE-NO-0003 TO WSD-EMPLOYER-PHONE-NUM
        ...
        {
            WS.WST_CREATION_DATE.SetValue(LS.DATE_0004);                                                        //COBOL==> MOVE DATE-0004 TO WST-CREATION-DATE.
            WS.WST_CREATION_TIME.SetValue(LS.TIME_0004);                                                        //COBOL==> MOVE TIME-0004 TO WST-CREATION-TIME.
            WS.WST_RECORD_COUNT.SetValue(LS.COUNT_0005);                                                        //COBOL==> MOVE COUNT-0005 TO WST-RECORD-COUNT.
        ...
        private void M_PARA_CLOSE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_CLOSE_EXIT") { M_PARA_0613688943_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0613688943_INIT
        /// </summary>
        private void M_PARA_0613688943_INIT(string returnMethod = "")
        {
            LS.EXPORT_0007EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0613688943_INIT") { M_PARA_0613688943_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0613688943_INIT_EXIT
        /// </summary>
        private void M_PARA_0613688943_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0613688943_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
