...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:47:15 PM
   **        *   FROM COBOL PGM   :  SWEXFE05
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B721_EXT_READ_FILE            DATE: 2003/12/19
       TARGET OS:   MVS                       TIME: 17:25:12
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXFE05_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE05_fd_FileSection";
            internal const string INPUT_FILE_00 = "INPUT_FILE_00";
            internal const string INPUT_RECORD_00 = "INPUT_RECORD_00";
            internal const string RECORD_00_DETAIL = "RECORD_00_DETAIL";
            ...
            internal const string INPUT_FILE_03 = "INPUT_FILE_03";
            internal const string INPUT_RECORD_03 = "INPUT_RECORD_03";
            internal const string RECORD_03_DETAIL = "RECORD_03_DETAIL";
            internal const string INPUT_FILE_04 = "INPUT_FILE_04";
            internal const string INPUT_RECORD_04 = "INPUT_RECORD_04";
            internal const string RECORD_04_DETAIL = "RECORD_04_DETAIL";
            internal const string INPUT_FILE_05 = "INPUT_FILE_05";
            internal const string INPUT_RECORD_05 = "INPUT_RECORD_05";
            internal const string RECORD_05_DETAIL = "RECORD_05_DETAIL";
            internal const string INPUT_FILE_06 = "INPUT_FILE_06";
            internal const string INPUT_RECORD_06 = "INPUT_RECORD_06";
            internal const string RECORD_06_DETAIL = "RECORD_06_DETAIL";
            internal const string INPUT_FILE_07 = "INPUT_FILE_07";
            internal const string INPUT_RECORD_07 = "INPUT_RECORD_07";
            internal const string RECORD_07_DETAIL = "RECORD_07_DETAIL";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink INPUT_FILE_00 { get; set; }
        public IGroup INPUT_RECORD_00 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_00); } }
        public IField RECORD_00_DETAIL { get { return GetElementByName<IField>(Names.RECORD_00_DETAIL); } }
        ...
        public IFileLink INPUT_FILE_03 { get; set; }
        public IGroup INPUT_RECORD_03 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_03); } }
        public IField RECORD_03_DETAIL { get { return GetElementByName<IField>(Names.RECORD_03_DETAIL); } }
        public IFileLink INPUT_FILE_04 { get; set; }
        public IGroup INPUT_RECORD_04 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_04); } }
        public IField RECORD_04_DETAIL { get { return GetElementByName<IField>(Names.RECORD_04_DETAIL); } }
        public IFileLink INPUT_FILE_05 { get; set; }
        public IGroup INPUT_RECORD_05 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_05); } }
        public IField RECORD_05_DETAIL { get { return GetElementByName<IField>(Names.RECORD_05_DETAIL); } }
        public IFileLink INPUT_FILE_06 { get; set; }
        public IGroup INPUT_RECORD_06 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_06); } }
        public IField RECORD_06_DETAIL { get { return GetElementByName<IField>(Names.RECORD_06_DETAIL); } }
        public IFileLink INPUT_FILE_07 { get; set; }
        public IGroup INPUT_RECORD_07 { get { return GetElementByName<IGroup>(Names.INPUT_RECORD_07); } }
        public IField RECORD_07_DETAIL { get { return GetElementByName<IField>(Names.RECORD_07_DETAIL); } }


        internal SWEXFE05_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.INPUT_RECORD_00, (INPUT_RECORD_00) =>
           {
               INPUT_RECORD_00.CreateNewField(Names.RECORD_00_DETAIL, FieldType.String, 80);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_01, (INPUT_RECORD_01) =>
           {
               INPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_02, (INPUT_RECORD_02) =>
           {
               INPUT_RECORD_02.CreateNewField(Names.RECORD_02_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_03, (INPUT_RECORD_03) =>
           {
               INPUT_RECORD_03.CreateNewField(Names.RECORD_03_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_04, (INPUT_RECORD_04) =>
           {
               INPUT_RECORD_04.CreateNewField(Names.RECORD_04_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_05, (INPUT_RECORD_05) =>
           {
               INPUT_RECORD_05.CreateNewField(Names.RECORD_05_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_06, (INPUT_RECORD_06) =>
           {
               INPUT_RECORD_06.CreateNewField(Names.RECORD_06_DETAIL, FieldType.String, 132);
           });

            recordDef.CreateNewGroup(Names.INPUT_RECORD_07, (INPUT_RECORD_07) =>
           {
               INPUT_RECORD_07.CreateNewField(Names.RECORD_07_DETAIL, FieldType.String, 132);
           });
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE_00 = FileHandler.GetFile("INFILE0");
            INPUT_FILE_00.StatusField = WS.FILE_STATUS;
            INPUT_FILE_00.AssociatedBuffer = INPUT_RECORD_00;

            INPUT_FILE_01 = FileHandler.GetFile("INFILE1");
            INPUT_FILE_01.StatusField = WS.FILE_STATUS;
            INPUT_FILE_01.AssociatedBuffer = INPUT_RECORD_01;

            INPUT_FILE_02 = FileHandler.GetFile("INFILE2");
            INPUT_FILE_02.StatusField = WS.FILE_STATUS;
            INPUT_FILE_02.AssociatedBuffer = INPUT_RECORD_02;

            INPUT_FILE_03 = FileHandler.GetFile("INFILE3");
            INPUT_FILE_03.StatusField = WS.FILE_STATUS;
            INPUT_FILE_03.AssociatedBuffer = INPUT_RECORD_03;

            INPUT_FILE_04 = FileHandler.GetFile("INFILE4");
            INPUT_FILE_04.StatusField = WS.FILE_STATUS;
            INPUT_FILE_04.AssociatedBuffer = INPUT_RECORD_04;

            INPUT_FILE_05 = FileHandler.GetFile("INFILE5");
            INPUT_FILE_05.StatusField = WS.FILE_STATUS;
            INPUT_FILE_05.AssociatedBuffer = INPUT_RECORD_05;

            INPUT_FILE_06 = FileHandler.GetFile("INFILE6");
            INPUT_FILE_06.StatusField = WS.FILE_STATUS;
            INPUT_FILE_06.AssociatedBuffer = INPUT_RECORD_06;

            INPUT_FILE_07 = FileHandler.GetFile("INFILE7");
            INPUT_FILE_07.StatusField = WS.FILE_STATUS;
            INPUT_FILE_07.AssociatedBuffer = INPUT_RECORD_07;
        }
        #endregion

        #region Constructors
        public SWEXFE05_fd(SWEXFE05_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE05_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE05_ws_WorkingStorage";
            internal const string FILE_STATUS = "FILE_STATUS";
            internal const string WS_INPUT_RECORD = "WS_INPUT_RECORD";
            internal const string TEXT_80 = "TEXT_80";
        }
        #endregion
        ...
        public IField TEXT_80 { get { return GetElementByName<IField>(Names.TEXT_80); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_INPUT_RECORD.CreateNewField(Names.TEXT_80, FieldType.String, 132);
           });
    ...
    internal class SWEXFE05_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE05_ls_LinkageSection";
    ...
    public class SWEXFE05 : EABBase
    {
        ...
        public SWEXFE05()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE05");

            WS = new SWEXFE05_ws();
            FD = new SWEXFE05_fd(WS);
            LS = new SWEXFE05_ls();
        }
        ...
        private SWEXFE05_ws WS;

        //==== File Data Class ========================================
        private SWEXFE05_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE05_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0430972356(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0430972356
        /// </summary>
        private void M_MAIN_0430972356(string returnMethod = "")
        {
            M_PARA_0430972356_INIT("M_PARA_0430972356_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0430972356-INIT THRU PARA-0430972356-INIT-EXIT
            M_PARA_0430972356("M_PARA_0430972356_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0430972356 THRU PARA-0430972356-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0430972356
        /// </summary>
        private void M_PARA_0430972356(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0430972356") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_1000_OPEN_FILES(string returnMethod = "")
        {
            ...
            if ((LS.COUNT_0001.IsZeroes()))                                                                     //COBOL==> WHEN 0
            {
                FD.INPUT_FILE_00.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-00
            }                                                                                                //COBOL==> WHEN 1
            else
            if ((LS.COUNT_0001.IsEqualTo(1)))
            {
            ...
            {
                FD.INPUT_FILE_03.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-03
            }                                                                                                //COBOL==> WHEN 4
            else
            if ((LS.COUNT_0001.IsEqualTo(4)))
            {
                FD.INPUT_FILE_04.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-04
            }                                                                                                //COBOL==> WHEN 5
            else
            if ((LS.COUNT_0001.IsEqualTo(5)))
            {
                FD.INPUT_FILE_05.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-05
            }                                                                                                //COBOL==> WHEN 6
            else
            if ((LS.COUNT_0001.IsEqualTo(6)))
            {
                FD.INPUT_FILE_06.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-06
            }                                                                                                //COBOL==> WHEN 7
            else
            if ((LS.COUNT_0001.IsEqualTo(7)))
            {
                FD.INPUT_FILE_07.OpenFile(FileAccessMode.Read);                                                     //COBOL==> OPEN INPUT INPUT-FILE-07
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            if ((LS.COUNT_0001.IsZeroes()))                                                                     //COBOL==> WHEN 0
            {
                FD.INPUT_FILE_00.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-00
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_00_DETAIL);                                                 //COBOL==> MOVE RECORD-00-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 1
            else
            if ((LS.COUNT_0001.IsEqualTo(1)))
            {
                FD.INPUT_FILE_01.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-01
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_01_DETAIL);                                                 //COBOL==> MOVE RECORD-01-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 2
            else
            if ((LS.COUNT_0001.IsEqualTo(2)))
            {
                FD.INPUT_FILE_02.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-02
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_02_DETAIL);                                                 //COBOL==> MOVE RECORD-02-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 3
            else
            if ((LS.COUNT_0001.IsEqualTo(3)))
            {
                FD.INPUT_FILE_03.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-03
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_03_DETAIL);                                                 //COBOL==> MOVE RECORD-03-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 4
            else
            if ((LS.COUNT_0001.IsEqualTo(4)))
            {
                FD.INPUT_FILE_04.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-04
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_04_DETAIL);                                                 //COBOL==> MOVE RECORD-04-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 5
            else
            if ((LS.COUNT_0001.IsEqualTo(5)))
            {
                FD.INPUT_FILE_05.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-05
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_05_DETAIL);                                                 //COBOL==> MOVE RECORD-05-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 6
            else
            if ((LS.COUNT_0001.IsEqualTo(6)))
            {
                FD.INPUT_FILE_06.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-06
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_06_DETAIL);                                                 //COBOL==> MOVE RECORD-06-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN 7
            else
            if ((LS.COUNT_0001.IsEqualTo(7)))
            {
                FD.INPUT_FILE_07.ReadLine();                                                                        //COBOL==> READ INPUT-FILE-07
                LS.TEXT_LINE_80_0003.SetValue(FD.RECORD_07_DETAIL);                                                 //COBOL==> MOVE RECORD-07-DETAIL TO TEXT-LINE-80-0003
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("BN");                                                            //COBOL==> MOVE 'BN' TO TEXT-RETURN-CODE-0003
        ...
        private void M_3000_CLOSE_FILES(string returnMethod = "")
        {
            ...
            if ((LS.COUNT_0001.IsZeroes()))                                                                     //COBOL==> WHEN 0
            {
                FD.INPUT_FILE_00.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-00
            }                                                                                                //COBOL==> WHEN 1
            else
            if ((LS.COUNT_0001.IsEqualTo(1)))
            {
            ...
            if ((LS.COUNT_0001.IsEqualTo(3)))
            {
                FD.INPUT_FILE_03.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-03
            }                                                                                                //COBOL==> WHEN 4
            else
            if ((LS.COUNT_0001.IsEqualTo(4)))
            {
                FD.INPUT_FILE_04.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-04
            }                                                                                                //COBOL==> WHEN 5
            else
            if ((LS.COUNT_0001.IsEqualTo(5)))
            {
                FD.INPUT_FILE_05.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-05
            }                                                                                                //COBOL==> WHEN 6
            else
            if ((LS.COUNT_0001.IsEqualTo(6)))
            {
                FD.INPUT_FILE_06.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-06
            }                                                                                                //COBOL==> WHEN 7
            else
            if ((LS.COUNT_0001.IsEqualTo(7)))
            {
                FD.INPUT_FILE_07.CloseFile();                                                                       //COBOL==> CLOSE INPUT-FILE-07
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("BN");                                                            //COBOL==> MOVE 'BN' TO TEXT-RETURN-CODE-0003
            ...
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("CE");                                                            //COBOL==> MOVE 'CE' TO TEXT-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0430972356_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0430972356_EXIT
        /// </summary>
        private void M_PARA_0430972356_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0430972356_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0430972356_EXIT") { M_PARA_0430972356_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0430972356_INIT
        /// </summary>
        private void M_PARA_0430972356_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0430972356_INIT") { M_PARA_0430972356_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0430972356_INIT_EXIT
        /// </summary>
        private void M_PARA_0430972356_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0430972356_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
