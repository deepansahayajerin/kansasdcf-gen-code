...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:54:23 PM
   **        *   FROM COBOL PGM   :  SWEXPR05
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: SP_B316_EAB_READ_INPUT_FILE      DATE: 2013/08/15
       TARGET OS:   MVS                       TIME: 21:34:40
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXPR05_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXPR05_fd_FileSection";
            internal const string INFILE = "INFILE";
            internal const string INREC = "INREC";
            internal const string IN_FILE_FROM_OFF_ID = "IN_FILE_FROM_OFF_ID";
            internal const string IN_FILE_FROM_SPD_ID = "IN_FILE_FROM_SPD_ID";
            internal const string IN_FILE_FROM_ROLE_CODE = "IN_FILE_FROM_ROLE_CODE";
            internal const string IN_FILE_TO_OFF_ID = "IN_FILE_TO_OFF_ID";
            internal const string IN_FILE_TO_SPD_ID = "IN_FILE_TO_SPD_ID";
            internal const string IN_FILE_TO_ROLE_CODE = "IN_FILE_TO_ROLE_CODE";
            internal const string IN_FILE_TRIBUNAL = "IN_FILE_TRIBUNAL";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink INFILE { get; set; }
        public IGroup INREC { get { return GetElementByName<IGroup>(Names.INREC); } }
        public IField IN_FILE_FROM_OFF_ID { get { return GetElementByName<IField>(Names.IN_FILE_FROM_OFF_ID); } }
        public IField IN_FILE_FROM_SPD_ID { get { return GetElementByName<IField>(Names.IN_FILE_FROM_SPD_ID); } }
        public IField IN_FILE_FROM_ROLE_CODE { get { return GetElementByName<IField>(Names.IN_FILE_FROM_ROLE_CODE); } }
        public IField IN_FILE_TO_OFF_ID { get { return GetElementByName<IField>(Names.IN_FILE_TO_OFF_ID); } }
        public IField IN_FILE_TO_SPD_ID { get { return GetElementByName<IField>(Names.IN_FILE_TO_SPD_ID); } }
        public IField IN_FILE_TO_ROLE_CODE { get { return GetElementByName<IField>(Names.IN_FILE_TO_ROLE_CODE); } }
        public IField IN_FILE_TRIBUNAL { get { return GetElementByName<IField>(Names.IN_FILE_TRIBUNAL); } }


        internal SWEXPR05_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.INREC, (INREC) =>
           {
               INREC.CreateNewField(Names.IN_FILE_FROM_OFF_ID, FieldType.String, 4);
               INREC.CreateNewFillerField(1, FillWith.Hashes);
               INREC.CreateNewField(Names.IN_FILE_FROM_SPD_ID, FieldType.String, 5);
               INREC.CreateNewFillerField(1, FillWith.Hashes);
               INREC.CreateNewField(Names.IN_FILE_FROM_ROLE_CODE, FieldType.String, 2);
               INREC.CreateNewFillerField(13, FillWith.Hashes);
               INREC.CreateNewField(Names.IN_FILE_TO_OFF_ID, FieldType.String, 4);
               INREC.CreateNewFillerField(1, FillWith.Hashes);
               INREC.CreateNewField(Names.IN_FILE_TO_SPD_ID, FieldType.String, 5);
               INREC.CreateNewFillerField(1, FillWith.Hashes);
               INREC.CreateNewField(Names.IN_FILE_TO_ROLE_CODE, FieldType.String, 2);
               INREC.CreateNewFillerField(1, FillWith.Hashes);
               INREC.CreateNewField(Names.IN_FILE_TRIBUNAL, FieldType.String, 9);
               INREC.CreateNewFillerField(31, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            INFILE = FileHandler.GetFile("LEGALREF");
            INFILE.StatusField = WS.IN_FSTAT;
            INFILE.AssociatedBuffer = INREC;
        }
        #endregion

        #region Constructors
        public SWEXPR05_fd(SWEXPR05_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXPR05_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXPR05_ws_WorkingStorage";
            internal const string WS_FILE_STATUS = "WS_FILE_STATUS";
            internal const string IN_FSTAT = "IN_FSTAT";
            internal const string WS_INREC = "WS_INREC";
            internal const string WS_FILE_FROM_OFF_ID = "WS_FILE_FROM_OFF_ID";
            internal const string WS_FILE_FROM_SPD_ID = "WS_FILE_FROM_SPD_ID";
            internal const string WS_FILE_FROM_ROLE_CODE = "WS_FILE_FROM_ROLE_CODE";
            internal const string WS_FILE_TO_OFF_ID = "WS_FILE_TO_OFF_ID";
            internal const string WS_FILE_TO_SPD_ID = "WS_FILE_TO_SPD_ID";
            internal const string WS_FILE_TO_ROLE_CODE = "WS_FILE_TO_ROLE_CODE";
            internal const string WS_FILE_TRIBUNAL = "WS_FILE_TRIBUNAL";
        }
        #endregion

        #region Direct-access element properties
        public IGroup WS_FILE_STATUS { get { return GetElementByName<IGroup>(Names.WS_FILE_STATUS); } }
        public IField IN_FSTAT { get { return GetElementByName<IField>(Names.IN_FSTAT); } }
        public IGroup WS_INREC { get { return GetElementByName<IGroup>(Names.WS_INREC); } }
        public IField WS_FILE_FROM_OFF_ID { get { return GetElementByName<IField>(Names.WS_FILE_FROM_OFF_ID); } }
        public IField WS_FILE_FROM_SPD_ID { get { return GetElementByName<IField>(Names.WS_FILE_FROM_SPD_ID); } }
        public IField WS_FILE_FROM_ROLE_CODE { get { return GetElementByName<IField>(Names.WS_FILE_FROM_ROLE_CODE); } }
        public IField WS_FILE_TO_OFF_ID { get { return GetElementByName<IField>(Names.WS_FILE_TO_OFF_ID); } }
        public IField WS_FILE_TO_SPD_ID { get { return GetElementByName<IField>(Names.WS_FILE_TO_SPD_ID); } }
        public IField WS_FILE_TO_ROLE_CODE { get { return GetElementByName<IField>(Names.WS_FILE_TO_ROLE_CODE); } }
        public IField WS_FILE_TRIBUNAL { get { return GetElementByName<IField>(Names.WS_FILE_TRIBUNAL); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_FILE_STATUS, (WS_FILE_STATUS) =>
           {
               WS_FILE_STATUS.CreateNewField(Names.IN_FSTAT, FieldType.String, 2, SPACES);
           });

            recordDef.CreateNewGroup(Names.WS_INREC, (WS_INREC) =>
           {
               WS_INREC.CreateNewField(Names.WS_FILE_FROM_OFF_ID, FieldType.String, 4);
               WS_INREC.CreateNewFillerField(1, FillWith.Hashes);
               WS_INREC.CreateNewField(Names.WS_FILE_FROM_SPD_ID, FieldType.String, 5);
               WS_INREC.CreateNewFillerField(1, FillWith.Hashes);
               WS_INREC.CreateNewField(Names.WS_FILE_FROM_ROLE_CODE, FieldType.String, 2);
               WS_INREC.CreateNewFillerField(13, FillWith.Hashes);
               WS_INREC.CreateNewField(Names.WS_FILE_TO_OFF_ID, FieldType.String, 4);
               WS_INREC.CreateNewFillerField(1, FillWith.Hashes);
               WS_INREC.CreateNewField(Names.WS_FILE_TO_SPD_ID, FieldType.String, 5);
               WS_INREC.CreateNewFillerField(1, FillWith.Hashes);
               WS_INREC.CreateNewField(Names.WS_FILE_TO_ROLE_CODE, FieldType.String, 2);
               WS_INREC.CreateNewFillerField(1, FillWith.Hashes);
               WS_INREC.CreateNewField(Names.WS_FILE_TRIBUNAL, FieldType.String, 9);
               WS_INREC.CreateNewFillerField(31, FillWith.Hashes);
           });
    ...
    internal class SWEXPR05_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXPR05_ls_LinkageSection";
            ...
            internal const string EXPORT_TO_0002EV = "EXPORT_TO_0002EV";
            ...
            internal const string EXPORT_FROM_0003EV = "EXPORT_FROM_0003EV";
            ...
            internal const string EXPORT_TO_0004EV = "EXPORT_TO_0004EV";
            internal const string SERVICE_PROVIDER_0004ET = "SERVICE_PROVIDER_0004ET";
            internal const string SYSTEM_GENERATED_ID_0004AS = "SYSTEM_GENERATED_ID_0004AS";
            internal const string SYSTEM_GENERATED_ID_0004 = "SYSTEM_GENERATED_ID_0004";
            internal const string SYSTEM_GENERATED_ID_0004XX = "SYSTEM_GENERATED_ID_0004XX";
            internal const string EXPORT_FROM_0005EV = "EXPORT_FROM_0005EV";
            ...
            internal const string STATUS_0006AS = "STATUS_0006AS";
            internal const string STATUS_0006 = "STATUS_0006";
            internal const string STATUS_0006XX = "STATUS_0006XX";
            internal const string EXPORT_FROM_0007EV = "EXPORT_FROM_0007EV";
            internal const string OFFICE_SERVICE_PROVIDER_0007ET = "OFFICE_SERVICE_PROVIDER_0007ET";
            internal const string ROLE_CODE_0007AS = "ROLE_CODE_0007AS";
            internal const string ROLE_CODE_0007 = "ROLE_CODE_0007";
            internal const string ROLE_CODE_0007XX = "ROLE_CODE_0007XX";
            internal const string EXPORT_RESULT_DETAIL_0008EV = "EXPORT_RESULT_DETAIL_0008EV";
            internal const string EXTERNAL_0008ET = "EXTERNAL_0008ET";
            internal const string TEXT_LINE_130_0008AS = "TEXT_LINE_130_0008AS";
            internal const string TEXT_LINE_130_0008 = "TEXT_LINE_130_0008";
            internal const string TEXT_LINE_130_0008XX = "TEXT_LINE_130_0008XX";
            internal const string EXPORT_TO_0009EV = "EXPORT_TO_0009EV";
            ...
            internal const string TRIBUNAL_0010ET = "TRIBUNAL_0010ET";
        ...
        public IGroup EXPORT_TO_0002EV { get { return GetElementByName<IGroup>(Names.EXPORT_TO_0002EV); } }
        ...
        public IGroup EXPORT_FROM_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_FROM_0003EV); } }
        ...
        public IGroup EXPORT_TO_0004EV { get { return GetElementByName<IGroup>(Names.EXPORT_TO_0004EV); } }
        public IGroup SERVICE_PROVIDER_0004ET { get { return GetElementByName<IGroup>(Names.SERVICE_PROVIDER_0004ET); } }
        public IField SYSTEM_GENERATED_ID_0004AS { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_ID_0004AS); } }
        public IField SYSTEM_GENERATED_ID_0004 { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_ID_0004); } }
        public IField SYSTEM_GENERATED_ID_0004XX { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_ID_0004XX); } }
        public IGroup EXPORT_FROM_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_FROM_0005EV); } }
        ...
        public IField STATUS_0006AS { get { return GetElementByName<IField>(Names.STATUS_0006AS); } }
        public IField STATUS_0006 { get { return GetElementByName<IField>(Names.STATUS_0006); } }
        public IField STATUS_0006XX { get { return GetElementByName<IField>(Names.STATUS_0006XX); } }
        public IGroup EXPORT_FROM_0007EV { get { return GetElementByName<IGroup>(Names.EXPORT_FROM_0007EV); } }
        public IGroup OFFICE_SERVICE_PROVIDER_0007ET { get { return GetElementByName<IGroup>(Names.OFFICE_SERVICE_PROVIDER_0007ET); } }
        public IField ROLE_CODE_0007AS { get { return GetElementByName<IField>(Names.ROLE_CODE_0007AS); } }
        public IField ROLE_CODE_0007 { get { return GetElementByName<IField>(Names.ROLE_CODE_0007); } }
        public IField ROLE_CODE_0007XX { get { return GetElementByName<IField>(Names.ROLE_CODE_0007XX); } }
        public IGroup EXPORT_RESULT_DETAIL_0008EV { get { return GetElementByName<IGroup>(Names.EXPORT_RESULT_DETAIL_0008EV); } }
        public IGroup EXTERNAL_0008ET { get { return GetElementByName<IGroup>(Names.EXTERNAL_0008ET); } }
        public IField TEXT_LINE_130_0008AS { get { return GetElementByName<IField>(Names.TEXT_LINE_130_0008AS); } }
        public IField TEXT_LINE_130_0008 { get { return GetElementByName<IField>(Names.TEXT_LINE_130_0008); } }
        public IField TEXT_LINE_130_0008XX { get { return GetElementByName<IField>(Names.TEXT_LINE_130_0008XX); } }
        public IGroup EXPORT_TO_0009EV { get { return GetElementByName<IGroup>(Names.EXPORT_TO_0009EV); } }
        ...
        public IGroup TRIBUNAL_0010ET { get { return GetElementByName<IGroup>(Names.TRIBUNAL_0010ET); } }
        public IField IDENTIFIER_0010AS { get { return GetElementByName<IField>(Names.IDENTIFIER_0010AS); } }
        public IField IDENTIFIER_0010 { get { return GetElementByName<IField>(Names.IDENTIFIER_0010); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_TO_0002EV, (EXPORT_TO_0002EV) =>
           {
               EXPORT_TO_0002EV.CreateNewGroup(Names.OFFICE_0002ET, (OFFICE_0002ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_FROM_0003EV, (EXPORT_FROM_0003EV) =>
           {
               EXPORT_FROM_0003EV.CreateNewGroup(Names.OFFICE_0003ET, (OFFICE_0003ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_TO_0004EV, (EXPORT_TO_0004EV) =>
           {
               EXPORT_TO_0004EV.CreateNewGroup(Names.SERVICE_PROVIDER_0004ET, (SERVICE_PROVIDER_0004ET) =>
               {
                   SERVICE_PROVIDER_0004ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0004AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_ID_0004_local = SERVICE_PROVIDER_0004ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0004, FieldType.SignedNumeric, 5);
                   SERVICE_PROVIDER_0004ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_ID_0004XX, FieldType.String, SYSTEM_GENERATED_ID_0004_local, 5);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_FROM_0005EV, (EXPORT_FROM_0005EV) =>
           {
               EXPORT_FROM_0005EV.CreateNewGroup(Names.SERVICE_PROVIDER_0005ET, (SERVICE_PROVIDER_0005ET) =>
               {
                   SERVICE_PROVIDER_0005ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0005AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_ID_0005_local = SERVICE_PROVIDER_0005ET.CreateNewField(Names.SYSTEM_GENERATED_ID_0005, FieldType.SignedNumeric, 5);
                   SERVICE_PROVIDER_0005ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_ID_0005XX, FieldType.String, SYSTEM_GENERATED_ID_0005_local, 5);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_0006EV, (EXPORT_0006EV) =>
           {
               EXPORT_0006EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0006ET, (EAB_FILE_HANDLING_0006ET) =>
               {
                   ...
                   EAB_FILE_HANDLING_0006ET.CreateNewField(Names.STATUS_0006AS, FieldType.String, 1);

                   IField STATUS_0006_local = EAB_FILE_HANDLING_0006ET.CreateNewField(Names.STATUS_0006, FieldType.String, 8);
                   EAB_FILE_HANDLING_0006ET.CreateNewFieldRedefine(Names.STATUS_0006XX, FieldType.String, STATUS_0006_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_FROM_0007EV, (EXPORT_FROM_0007EV) =>
           {
               EXPORT_FROM_0007EV.CreateNewGroup(Names.OFFICE_SERVICE_PROVIDER_0007ET, (OFFICE_SERVICE_PROVIDER_0007ET) =>
               {
                   OFFICE_SERVICE_PROVIDER_0007ET.CreateNewField(Names.ROLE_CODE_0007AS, FieldType.String, 1);

                   IField ROLE_CODE_0007_local = OFFICE_SERVICE_PROVIDER_0007ET.CreateNewField(Names.ROLE_CODE_0007, FieldType.String, 2);
                   OFFICE_SERVICE_PROVIDER_0007ET.CreateNewFieldRedefine(Names.ROLE_CODE_0007XX, FieldType.String, ROLE_CODE_0007_local, 2);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_RESULT_DETAIL_0008EV, (EXPORT_RESULT_DETAIL_0008EV) =>
           {
               EXPORT_RESULT_DETAIL_0008EV.CreateNewGroup(Names.EXTERNAL_0008ET, (EXTERNAL_0008ET) =>
               {
                   EXTERNAL_0008ET.CreateNewField(Names.TEXT_LINE_130_0008AS, FieldType.String, 1);

                   IField TEXT_LINE_130_0008_local = EXTERNAL_0008ET.CreateNewField(Names.TEXT_LINE_130_0008, FieldType.String, 130);
                   EXTERNAL_0008ET.CreateNewFieldRedefine(Names.TEXT_LINE_130_0008XX, FieldType.String, TEXT_LINE_130_0008_local, 130);
               });
           });

            recordDef.CreateNewGroup(Names.EXPORT_TO_0009EV, (EXPORT_TO_0009EV) =>
           {
               EXPORT_TO_0009EV.CreateNewGroup(Names.OFFICE_SERVICE_PROVIDER_0009ET, (OFFICE_SERVICE_PROVIDER_0009ET) =>
               {
           ...
           {
               EXPORT_0010EV.CreateNewGroup(Names.TRIBUNAL_0010ET, (TRIBUNAL_0010ET) =>
               {
                   TRIBUNAL_0010ET.CreateNewField(Names.IDENTIFIER_0010AS, FieldType.String, 1);

                   IField IDENTIFIER_0010_local = TRIBUNAL_0010ET.CreateNewField(Names.IDENTIFIER_0010, FieldType.SignedNumeric, 9);
                   TRIBUNAL_0010ET.CreateNewFieldRedefine(Names.IDENTIFIER_0010XX, FieldType.String, IDENTIFIER_0010_local, 9);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_TO_0002EV, args, 4);
            SetPassedParm(EXPORT_FROM_0003EV, args, 5);
            SetPassedParm(EXPORT_TO_0004EV, args, 6);
            SetPassedParm(EXPORT_FROM_0005EV, args, 7);
            SetPassedParm(EXPORT_0006EV, args, 8);
            SetPassedParm(EXPORT_FROM_0007EV, args, 9);
            SetPassedParm(EXPORT_RESULT_DETAIL_0008EV, args, 10);
            SetPassedParm(EXPORT_TO_0009EV, args, 11);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_TO_0002EV, args, 4);
            SetReturnParm(EXPORT_FROM_0003EV, args, 5);
            SetReturnParm(EXPORT_TO_0004EV, args, 6);
            SetReturnParm(EXPORT_FROM_0005EV, args, 7);
            SetReturnParm(EXPORT_0006EV, args, 8);
            SetReturnParm(EXPORT_FROM_0007EV, args, 9);
            SetReturnParm(EXPORT_RESULT_DETAIL_0008EV, args, 10);
            SetReturnParm(EXPORT_TO_0009EV, args, 11);
    ...
    public class SWEXPR05 : EABBase
    {
        ...
        public SWEXPR05()
            : base()
        {
            this.ProgramName.SetValue("SWEXPR05");

            WS = new SWEXPR05_ws();
            FD = new SWEXPR05_fd(WS);
            LS = new SWEXPR05_ls();
        }
        ...
        private SWEXPR05_ws WS;

        //==== File Data Class ========================================
        private SWEXPR05_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXPR05_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-TO-0002EV , EXPORT-FROM-0003EV , EXPORT-TO-0004EV , EXPORT-FROM-0005EV , EXPORT-0006EV , EXPORT-FROM-0007EV , EXPORT-RESULT-DETAIL-0008EV , EXPORT-TO-0009EV , EXPORT-0010EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0667680889(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0667680889
        /// </summary>
        private void M_MAIN_0667680889(string returnMethod = "")
        {
            M_PARA_0667680889_INIT("M_PARA_0667680889_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0667680889-INIT THRU PARA-0667680889-INIT-EXIT
            M_PARA_0667680889("M_PARA_0667680889_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0667680889 THRU PARA-0667680889-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0667680889
        /// </summary>
        private void M_PARA_0667680889(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if ((LS.ACTION_0001.IsEqualTo("OPEN")))                                                             //COBOL==> WHEN 'OPEN'
            {
                ...
                if (WS.IN_FSTAT.IsEqualTo("00"))                                                                    //COBOL==> IF IN-FSTAT = '00'
                {
                    LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    LS.STATUS_0006.SetValue("FILE ERR");                                                                //COBOL==> MOVE 'FILE ERR' TO STATUS-0006
                    LS.TEXT_LINE_130_0008.SetValue(StringUtils.Stringify(StringUtils.DelimitedByString(SPACES, "ERROR OPENING INPUT FILE, STATUS:", WS.IN_FSTAT.AsString())));  //COBOL==> STRING 'ERROR OPENING INPUT FILE, STATUS:' IN-FSTAT DELIMITED BY SPACE INTO TEXT-LINE-130-0008
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                //COBOL==> WHEN 'READ'
            else
            if ((LS.ACTION_0001.IsEqualTo("READ")))
            {
                WS.WS_INREC.SetValue(FD.INFILE.ReadLineInto());                                                     //COBOL==> READ INFILE INTO WS-INREC
                if (FD.INFILE.FileStatus == FileStatus.End_of_file)                                                 //COBOL==> AT END
                {
                    LS.STATUS_0006.SetValue("EOF");                                                                     //COBOL==> MOVE 'EOF' TO STATUS-0006
                }                                                                                                   //COBOL==> END-READ
                                                                                                                    // EvaluateList !WS.IN_FSTAT!                                                                       //COBOL==> EVALUATE IN-FSTAT
                if ((WS.IN_FSTAT.IsEqualTo("00")))                                                                  //COBOL==> WHEN '00'
                {
                    LS.SYSTEM_GENERATED_ID_0003.SetValue(FD.IN_FILE_FROM_OFF_ID);                                       //COBOL==> MOVE IN-FILE-FROM-OFF-ID TO SYSTEM-GENERATED-ID-0003
                    LS.SYSTEM_GENERATED_ID_0005.SetValue(FD.IN_FILE_FROM_SPD_ID);                                       //COBOL==> MOVE IN-FILE-FROM-SPD-ID TO SYSTEM-GENERATED-ID-0005
                    LS.ROLE_CODE_0007.SetValue(FD.IN_FILE_FROM_ROLE_CODE);                                              //COBOL==> MOVE IN-FILE-FROM-ROLE-CODE TO ROLE-CODE-0007
                    LS.SYSTEM_GENERATED_ID_0002.SetValue(FD.IN_FILE_TO_OFF_ID);                                         //COBOL==> MOVE IN-FILE-TO-OFF-ID TO SYSTEM-GENERATED-ID-0002
                    LS.SYSTEM_GENERATED_ID_0004.SetValue(FD.IN_FILE_TO_SPD_ID);                                         //COBOL==> MOVE IN-FILE-TO-SPD-ID TO SYSTEM-GENERATED-ID-0004
                    LS.ROLE_CODE_0009.SetValue(FD.IN_FILE_TO_ROLE_CODE);                                                //COBOL==> MOVE IN-FILE-TO-ROLE-CODE TO ROLE-CODE-0009
                    if (FD.IN_FILE_TRIBUNAL.IsSpaces())                                                                 //COBOL==> IF IN-FILE-TRIBUNAL = SPACES
                    {
                        LS.IDENTIFIER_0010.SetValueWithZeroes();                                                            //COBOL==> MOVE 0 TO IDENTIFIER-0010
                    }                                                                                                   //COBOL==> ELSE
                    else
                    {
                        LS.IDENTIFIER_0010XX.SetValue(FD.IN_FILE_TRIBUNAL);                                                 //COBOL==> MOVE IN-FILE-TRIBUNAL TO IDENTIFIER-0010XX
                    }                                                                                                   //COBOL==> END-IF
                    LS.STATUS_0006.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0006
                }                                                                                                //COBOL==> WHEN '10'
                else
                if ((WS.IN_FSTAT.IsEqualTo("10")))
                {
                    LS.STATUS_0006.SetValue("EOF");                                                                     //COBOL==> MOVE 'EOF' TO STATUS-0006
                }                                                                                                //COBOL==> WHEN OTHER
                else
                {
                    LS.STATUS_0006.SetValue("FILE ERR");                                                                //COBOL==> MOVE 'FILE ERR' TO STATUS-0006
                    LS.TEXT_LINE_130_0008.SetValue(StringUtils.Stringify(StringUtils.DelimitedByString(SPACES, "ERROR READING INPUT FILE, STATUS:", WS.IN_FSTAT.AsString())));  //COBOL==> STRING 'ERROR READING INPUT FILE, STATUS:' IN-FSTAT DELIMITED BY SPACE INTO TEXT-LINE-130-0008
                }                                                                                                   //COBOL==> END-EVALUATE
            }                                                                                                //COBOL==> WHEN 'CLOSE'
            else
            if ((LS.ACTION_0001.IsEqualTo("CLOSE")))
            {
                ...
                {
                    LS.STATUS_0006.SetValue("FILE ERR");                                                                //COBOL==> MOVE 'FILE ERR' TO STATUS-0006
                    LS.TEXT_LINE_130_0008.SetValue(StringUtils.Stringify(StringUtils.DelimitedByString(SPACES, "ERROR CLOSING INPUT FILE, STATUS:", WS.IN_FSTAT.AsString())));  //COBOL==> STRING 'ERROR CLOSING INPUT FILE, STATUS:' IN-FSTAT DELIMITED BY SPACE INTO TEXT-LINE-130-0008
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                   //COBOL==> END-EVALUATE .
            if (returnMethod != "" && returnMethod != "M_PARA_0667680889") { M_PARA_0667680889_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0667680889_EXIT
        /// </summary>
        private void M_PARA_0667680889_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0667680889_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0667680889_EXIT") { M_PARA_0667680889_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0667680889_INIT
        /// </summary>
        private void M_PARA_0667680889_INIT(string returnMethod = "")
        {
            LS.EXPORT_TO_0002EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-TO-0002EV
            LS.EXPORT_FROM_0003EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE EXPORT-FROM-0003EV
            LS.EXPORT_TO_0004EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-TO-0004EV
            LS.EXPORT_FROM_0005EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE EXPORT-FROM-0005EV
            LS.EXPORT_0006EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0006EV
            LS.EXPORT_FROM_0007EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE EXPORT-FROM-0007EV
            LS.EXPORT_RESULT_DETAIL_0008EV.ResetToInitialValue();                                               //COBOL==> INITIALIZE EXPORT-RESULT-DETAIL-0008EV
            LS.EXPORT_TO_0009EV.ResetToInitialValue();                                                          //COBOL==> INITIALIZE EXPORT-TO-0009EV
            LS.EXPORT_0010EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0010EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0667680889_INIT") { M_PARA_0667680889_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0667680889_INIT_EXIT
        /// </summary>
        private void M_PARA_0667680889_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0667680889_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
