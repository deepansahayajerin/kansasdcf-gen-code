...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:41:48 PM
   **        *   FROM COBOL PGM   :  EABCSLDT
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: EAB_CSLD_TEST                    DATE: 2013/08/21
       TARGET OS:   MVS                       TIME: 11:30:20
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class EABCSLDT_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "EABCSLDT_fd_FileSection";
            internal const string REPORT_FILE = "REPORT_FILE";
            internal const string RPTFILE_REC = "RPTFILE_REC";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink REPORT_FILE { get; set; }
        public IField RPTFILE_REC { get { return GetElementByName<IField>(Names.RPTFILE_REC); } }


        internal EABCSLDT_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.RPTFILE_REC, FieldType.String, 52);
        ...
        public override void Initialize()
        {
            ...
            REPORT_FILE = FileHandler.GetFile("EABCSLT");
            REPORT_FILE.StatusField = WS.WS_FILE_STATUS;
            REPORT_FILE.AssociatedBuffer = RPTFILE_REC;
            REPORT_FILE.RecordLength = 52;
        }
        #endregion

        #region Constructors
        public EABCSLDT_fd(EABCSLDT_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class EABCSLDT_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "EABCSLDT_ws_WorkingStorage";
            internal const string WS_FILE_STATUS = "WS_FILE_STATUS";
            internal const string WS_RPTFILE_REC = "WS_RPTFILE_REC";
            internal const string WS_SUBRPT_CD = "WS_SUBRPT_CD";
            internal const string WS_SYS_GEN_ID = "WS_SYS_GEN_ID";
            internal const string WS_CASE_NBR = "WS_CASE_NBR";
            internal const string WS_PGM_CD = "WS_PGM_CD";
            internal const string WS_TRIB_ID = "WS_TRIB_ID";
            internal const string WS_FUNC_TXT3 = "WS_FUNC_TXT3";
            internal const string WS_TXT8 = "WS_TXT8";
            internal const string WS_OLD_USR = "WS_OLD_USR";
            internal const string WS_NEW_USR = "WS_NEW_USR";
        }
        #endregion

        #region Direct-access element properties
        public IField WS_FILE_STATUS { get { return GetElementByName<IField>(Names.WS_FILE_STATUS); } }
        public IGroup WS_RPTFILE_REC { get { return GetElementByName<IGroup>(Names.WS_RPTFILE_REC); } }
        public IField WS_SUBRPT_CD { get { return GetElementByName<IField>(Names.WS_SUBRPT_CD); } }
        public IField WS_SYS_GEN_ID { get { return GetElementByName<IField>(Names.WS_SYS_GEN_ID); } }
        public IField WS_CASE_NBR { get { return GetElementByName<IField>(Names.WS_CASE_NBR); } }
        public IField WS_PGM_CD { get { return GetElementByName<IField>(Names.WS_PGM_CD); } }
        public IField WS_TRIB_ID { get { return GetElementByName<IField>(Names.WS_TRIB_ID); } }
        public IField WS_FUNC_TXT3 { get { return GetElementByName<IField>(Names.WS_FUNC_TXT3); } }
        public IField WS_TXT8 { get { return GetElementByName<IField>(Names.WS_TXT8); } }
        public IField WS_OLD_USR { get { return GetElementByName<IField>(Names.WS_OLD_USR); } }
        public IField WS_NEW_USR { get { return GetElementByName<IField>(Names.WS_NEW_USR); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_RPTFILE_REC, (WS_RPTFILE_REC) =>
           {
               WS_RPTFILE_REC.CreateNewField(Names.WS_SUBRPT_CD, FieldType.String, 4);
               WS_RPTFILE_REC.CreateNewField(Names.WS_SYS_GEN_ID, FieldType.SignedNumeric, 4);
               WS_RPTFILE_REC.CreateNewField(Names.WS_CASE_NBR, FieldType.String, 10);
               WS_RPTFILE_REC.CreateNewField(Names.WS_PGM_CD, FieldType.String, 3);
               WS_RPTFILE_REC.CreateNewField(Names.WS_TRIB_ID, FieldType.String, 4);
               WS_RPTFILE_REC.CreateNewField(Names.WS_FUNC_TXT3, FieldType.String, 3);
               WS_RPTFILE_REC.CreateNewField(Names.WS_TXT8, FieldType.String, 8);
               WS_RPTFILE_REC.CreateNewField(Names.WS_OLD_USR, FieldType.String, 8);
               WS_RPTFILE_REC.CreateNewField(Names.WS_NEW_USR, FieldType.String, 8);
           });
    ...
    internal class EABCSLDT_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "EABCSLDT_ls_LinkageSection";
            ...
            internal const string IMPORT_TRIBUNAL_0005EV = "IMPORT_TRIBUNAL_0005EV";
            ...
            internal const string CASE_FUNC_WORK_SET_0006ET = "CASE_FUNC_WORK_SET_0006ET";
            internal const string FUNC_TEXT_3_0006AS = "FUNC_TEXT_3_0006AS";
            internal const string FUNC_TEXT_3_0006 = "FUNC_TEXT_3_0006";
            internal const string FUNC_TEXT_3_0006XX = "FUNC_TEXT_3_0006XX";
            internal const string IMPORT_0007EV = "IMPORT_0007EV";
            internal const string TEXT_WORK_AREA_0007ET = "TEXT_WORK_AREA_0007ET";
            internal const string TEXT_8_0007AS = "TEXT_8_0007AS";
            internal const string TEXT_8_0007 = "TEXT_8_0007";
            internal const string TEXT_8_0007XX = "TEXT_8_0007XX";
            internal const string IMPORT_OLD_SP_0008EV = "IMPORT_OLD_SP_0008EV";
            internal const string SERVICE_PROVIDER_0008ET = "SERVICE_PROVIDER_0008ET";
            internal const string USER_ID_0008AS = "USER_ID_0008AS";
            internal const string USER_ID_0008 = "USER_ID_0008";
            internal const string USER_ID_0008XX = "USER_ID_0008XX";
            internal const string IMPORT_NEW_SP_0009EV = "IMPORT_NEW_SP_0009EV";
            internal const string SERVICE_PROVIDER_0009ET = "SERVICE_PROVIDER_0009ET";
            internal const string USER_ID_0009AS = "USER_ID_0009AS";
            internal const string USER_ID_0009 = "USER_ID_0009";
            internal const string USER_ID_0009XX = "USER_ID_0009XX";
        ...
        public IGroup IMPORT_TRIBUNAL_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_TRIBUNAL_0005EV); } }
        ...
        public IGroup CASE_FUNC_WORK_SET_0006ET { get { return GetElementByName<IGroup>(Names.CASE_FUNC_WORK_SET_0006ET); } }
        public IField FUNC_TEXT_3_0006AS { get { return GetElementByName<IField>(Names.FUNC_TEXT_3_0006AS); } }
        public IField FUNC_TEXT_3_0006 { get { return GetElementByName<IField>(Names.FUNC_TEXT_3_0006); } }
        public IField FUNC_TEXT_3_0006XX { get { return GetElementByName<IField>(Names.FUNC_TEXT_3_0006XX); } }
        ...
        public IField TEXT_8_0007AS { get { return GetElementByName<IField>(Names.TEXT_8_0007AS); } }
        public IField TEXT_8_0007 { get { return GetElementByName<IField>(Names.TEXT_8_0007); } }
        public IField TEXT_8_0007XX { get { return GetElementByName<IField>(Names.TEXT_8_0007XX); } }
        public IGroup IMPORT_OLD_SP_0008EV { get { return GetElementByName<IGroup>(Names.IMPORT_OLD_SP_0008EV); } }
        public IGroup SERVICE_PROVIDER_0008ET { get { return GetElementByName<IGroup>(Names.SERVICE_PROVIDER_0008ET); } }
        public IField USER_ID_0008AS { get { return GetElementByName<IField>(Names.USER_ID_0008AS); } }
        public IField USER_ID_0008 { get { return GetElementByName<IField>(Names.USER_ID_0008); } }
        public IField USER_ID_0008XX { get { return GetElementByName<IField>(Names.USER_ID_0008XX); } }
        public IGroup IMPORT_NEW_SP_0009EV { get { return GetElementByName<IGroup>(Names.IMPORT_NEW_SP_0009EV); } }
        public IGroup SERVICE_PROVIDER_0009ET { get { return GetElementByName<IGroup>(Names.SERVICE_PROVIDER_0009ET); } }
        public IField USER_ID_0009AS { get { return GetElementByName<IField>(Names.USER_ID_0009AS); } }
        public IField USER_ID_0009 { get { return GetElementByName<IField>(Names.USER_ID_0009); } }
        public IField USER_ID_0009XX { get { return GetElementByName<IField>(Names.USER_ID_0009XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.OFFICE_0002ET, (OFFICE_0002ET) =>
               {
           ...
           {
               IMPORT_0004EV.CreateNewGroup(Names.PROGRAM_0004ET, (PROGRAM_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_TRIBUNAL_0005EV, (IMPORT_TRIBUNAL_0005EV) =>
           {
               IMPORT_TRIBUNAL_0005EV.CreateNewGroup(Names.TEXT_WORK_AREA_0005ET, (TEXT_WORK_AREA_0005ET) =>
               {
           ...
           {
               IMPORT_0006EV.CreateNewGroup(Names.CASE_FUNC_WORK_SET_0006ET, (CASE_FUNC_WORK_SET_0006ET) =>
               {
                   CASE_FUNC_WORK_SET_0006ET.CreateNewField(Names.FUNC_TEXT_3_0006AS, FieldType.String, 1);

                   IField FUNC_TEXT_3_0006_local = CASE_FUNC_WORK_SET_0006ET.CreateNewField(Names.FUNC_TEXT_3_0006, FieldType.String, 3);
                   CASE_FUNC_WORK_SET_0006ET.CreateNewFieldRedefine(Names.FUNC_TEXT_3_0006XX, FieldType.String, FUNC_TEXT_3_0006_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0007EV, (IMPORT_0007EV) =>
           {
               IMPORT_0007EV.CreateNewGroup(Names.TEXT_WORK_AREA_0007ET, (TEXT_WORK_AREA_0007ET) =>
               {
                   TEXT_WORK_AREA_0007ET.CreateNewField(Names.TEXT_8_0007AS, FieldType.String, 1);

                   IField TEXT_8_0007_local = TEXT_WORK_AREA_0007ET.CreateNewField(Names.TEXT_8_0007, FieldType.String, 8);
                   TEXT_WORK_AREA_0007ET.CreateNewFieldRedefine(Names.TEXT_8_0007XX, FieldType.String, TEXT_8_0007_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_OLD_SP_0008EV, (IMPORT_OLD_SP_0008EV) =>
           {
               IMPORT_OLD_SP_0008EV.CreateNewGroup(Names.SERVICE_PROVIDER_0008ET, (SERVICE_PROVIDER_0008ET) =>
               {
                   SERVICE_PROVIDER_0008ET.CreateNewField(Names.USER_ID_0008AS, FieldType.String, 1);

                   IField USER_ID_0008_local = SERVICE_PROVIDER_0008ET.CreateNewField(Names.USER_ID_0008, FieldType.String, 8);
                   SERVICE_PROVIDER_0008ET.CreateNewFieldRedefine(Names.USER_ID_0008XX, FieldType.String, USER_ID_0008_local, 8);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_NEW_SP_0009EV, (IMPORT_NEW_SP_0009EV) =>
           {
               IMPORT_NEW_SP_0009EV.CreateNewGroup(Names.SERVICE_PROVIDER_0009ET, (SERVICE_PROVIDER_0009ET) =>
               {
                   SERVICE_PROVIDER_0009ET.CreateNewField(Names.USER_ID_0009AS, FieldType.String, 1);

                   IField USER_ID_0009_local = SERVICE_PROVIDER_0009ET.CreateNewField(Names.USER_ID_0009, FieldType.String, 8);
                   SERVICE_PROVIDER_0009ET.CreateNewFieldRedefine(Names.USER_ID_0009XX, FieldType.String, USER_ID_0009_local, 8);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_TRIBUNAL_0005EV, args, 7);
            SetPassedParm(IMPORT_0006EV, args, 8);
            SetPassedParm(IMPORT_0007EV, args, 9);
            SetPassedParm(IMPORT_OLD_SP_0008EV, args, 10);
            SetPassedParm(IMPORT_NEW_SP_0009EV, args, 11);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_TRIBUNAL_0005EV, args, 7);
            SetReturnParm(IMPORT_0006EV, args, 8);
            SetReturnParm(IMPORT_0007EV, args, 9);
            SetReturnParm(IMPORT_OLD_SP_0008EV, args, 10);
            SetReturnParm(IMPORT_NEW_SP_0009EV, args, 11);
    ...
    public class EABCSLDT : BatchBase
    {
        ...
        public EABCSLDT()
            : base()
        {
            this.ProgramName.SetValue("EABCSLDT");

            WS = new EABCSLDT_ws();
            FD = new EABCSLDT_fd(WS);
            LS = new EABCSLDT_ls();
        }
        ...
        private EABCSLDT_ws WS;

        //==== File Data Class ========================================
        private EABCSLDT_fd FD;

        //==== Linkage Section Data Class ========================================
        private EABCSLDT_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0003EV , IMPORT-0004EV , IMPORT-TRIBUNAL-0005EV , IMPORT-0006EV , IMPORT-0007EV , IMPORT-OLD-SP-0008EV , IMPORT-NEW-SP-0009EV , EXPORT-0010EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0298706562(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0298706562
        /// </summary>
        private void M_MAIN_0298706562(string returnMethod = "")
        {
            M_PARA_0298706562_INIT("M_PARA_0298706562_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0298706562-INIT THRU PARA-0298706562-INIT-EXIT
            M_PARA_0298706562("M_PARA_0298706562_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0298706562 THRU PARA-0298706562-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0298706562
        /// </summary>
        private void M_PARA_0298706562(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if ((LS.PARM1_0001.IsEqualTo("GR")))
            {
                ...
                FD.REPORT_FILE.WriteLine(WS.WS_RPTFILE_REC.AsBytes);                                                //COBOL==> WRITE RPTFILE-REC FROM WS-RPTFILE-REC
            }                                                                                                //COBOL==> WHEN 'CF'
            else
            ...
            {
                LS.PARM1_0010.SetValue(WS.WS_FILE_STATUS);                                                          //COBOL==> MOVE WS-FILE-STATUS TO PARM1-0010
            }                                                                                                   //COBOL==> END-IF.
            if (returnMethod != "" && returnMethod != "M_PARA_0298706562") { M_PARA_0298706562_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0298706562_EXIT
        /// </summary>
        /// <remarks>
        ///COMMENT:     GOBACK.
        /// </remarks>
        private void M_PARA_0298706562_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0298706562_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0298706562_EXIT") { M_B000_INIT_FIELDS(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_B000_INIT_FIELDS(string returnMethod = "")
        {
            ...
            if (!(LS.SYSTEM_GENERATED_ID_0002.IsNumericValue()))                                               //COBOL==> IF SYSTEM-GENERATED-ID-0002 IS NOT NUMERIC
            {
                LS.SYSTEM_GENERATED_ID_0002.SetValueWithZeroes();                                                   //COBOL==> MOVE ZEROS TO SYSTEM-GENERATED-ID-0002
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.NUMBER_0003XX.IsEqualTo(HIGH_VALUES))
             || (LS.NUMBER_0003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF NUMBER-0003XX = HIGH-VALUES OR NUMBER-0003XX = LOW-VALUES
            {
                LS.NUMBER_0003.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO NUMBER-0003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.CODE_0004XX.IsEqualTo(HIGH_VALUES))
             || (LS.CODE_0004XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF CODE-0004XX = HIGH-VALUES OR CODE-0004XX = LOW-VALUES
            {
                LS.CODE_0004.SetValueWithSpaces();                                                                  //COBOL==> MOVE SPACES TO CODE-0004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.TEXT_4_0005XX.IsEqualTo(HIGH_VALUES))
             || (LS.TEXT_4_0005XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF TEXT-4-0005XX = HIGH-VALUES OR TEXT-4-0005XX = LOW-VALUES
            {
                LS.TEXT_4_0005.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO TEXT-4-0005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.FUNC_TEXT_3_0006XX.IsEqualTo(HIGH_VALUES))
             || (LS.FUNC_TEXT_3_0006XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF FUNC-TEXT-3-0006XX = HIGH-VALUES OR FUNC-TEXT-3-0006XX = LOW-VALUES
            {
                LS.FUNC_TEXT_3_0006.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO FUNC-TEXT-3-0006
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.TEXT_8_0007XX.IsEqualTo(HIGH_VALUES))
             || (LS.TEXT_8_0007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF TEXT-8-0007XX = HIGH-VALUES OR TEXT-8-0007XX = LOW-VALUES
            {
                LS.TEXT_8_0007.SetValueWithSpaces();                                                                //COBOL==> MOVE SPACES TO TEXT-8-0007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.USER_ID_0008XX.IsEqualTo(HIGH_VALUES))
             || (LS.USER_ID_0008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF USER-ID-0008XX = HIGH-VALUES OR USER-ID-0008XX = LOW-VALUES
            {
                LS.USER_ID_0008.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO USER-ID-0008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.USER_ID_0009XX.IsEqualTo(HIGH_VALUES))
             || (LS.USER_ID_0009XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF USER-ID-0009XX = HIGH-VALUES OR USER-ID-0009XX = LOW-VALUES
            {
                LS.USER_ID_0009.SetValueWithSpaces();                                                               //COBOL==> MOVE SPACES TO USER-ID-0009
            }                                                                                                   //COBOL==> END-IF.
            LS.PARM1_0010.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO PARM1-0010.
        ...
        {
            WS.WS_SUBRPT_CD.SetValue(LS.SUBREPORT_CODE_0001);                                                   //COBOL==> MOVE SUBREPORT-CODE-0001 TO WS-SUBRPT-CD.
            WS.WS_SYS_GEN_ID.SetValue(LS.SYSTEM_GENERATED_ID_0002);                                             //COBOL==> MOVE SYSTEM-GENERATED-ID-0002 TO WS-SYS-GEN-ID.
            WS.WS_CASE_NBR.SetValue(LS.NUMBER_0003);                                                            //COBOL==> MOVE NUMBER-0003 TO WS-CASE-NBR.
            WS.WS_PGM_CD.SetValue(LS.CODE_0004);                                                                //COBOL==> MOVE CODE-0004 TO WS-PGM-CD.
            WS.WS_TRIB_ID.SetValue(LS.TEXT_4_0005);                                                             //COBOL==> MOVE TEXT-4-0005 TO WS-TRIB-ID.
            WS.WS_FUNC_TXT3.SetValue(LS.FUNC_TEXT_3_0006);                                                      //COBOL==> MOVE FUNC-TEXT-3-0006 TO WS-FUNC-TXT3.
            WS.WS_TXT8.SetValue(LS.TEXT_8_0007);                                                                //COBOL==> MOVE TEXT-8-0007 TO WS-TXT8.
            WS.WS_OLD_USR.SetValue(LS.USER_ID_0008);                                                            //COBOL==> MOVE USER-ID-0008 TO WS-OLD-USR.
            WS.WS_NEW_USR.SetValue(LS.USER_ID_0009);                                                            //COBOL==> MOVE USER-ID-0009 TO WS-NEW-USR.
        ...
        private void M_B100_SETUP_REC_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_B100_SETUP_REC_EXIT") { M_PARA_0298706562_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0298706562_INIT
        /// </summary>
        private void M_PARA_0298706562_INIT(string returnMethod = "")
        {
            LS.EXPORT_0010EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0010EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0298706562_INIT") { M_PARA_0298706562_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0298706562_INIT_EXIT
        /// </summary>
        private void M_PARA_0298706562_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0298706562_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
