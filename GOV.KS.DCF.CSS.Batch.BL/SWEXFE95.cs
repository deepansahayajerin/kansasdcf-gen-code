...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:47:44 PM
   **        *   FROM COBOL PGM   :  SWEXFE95
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: EAB_ACCESS_DOA_EFT_RETURN_FILE   DATE: 1999/03/06
       TARGET OS:   MVS                       TIME: 17:50:54
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXFE95_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE95_fd_FileSection";
            internal const string DOA_INPUT_FILE = "DOA_INPUT_FILE";
            internal const string DOA_INPUT_RECORD = "DOA_INPUT_RECORD";
            internal const string DOA_EFT_RETURN_FILE_COUNT = "DOA_EFT_RETURN_FILE_COUNT";
            internal const string DOA_EFT_RETURN_FILE_AMOUNT = "DOA_EFT_RETURN_FILE_AMOUNT";
            internal const string DOA_EFT_RETURN_FILE_DATE = "DOA_EFT_RETURN_FILE_DATE";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink DOA_INPUT_FILE { get; set; }
        public IGroup DOA_INPUT_RECORD { get { return GetElementByName<IGroup>(Names.DOA_INPUT_RECORD); } }
        public IField DOA_EFT_RETURN_FILE_COUNT { get { return GetElementByName<IField>(Names.DOA_EFT_RETURN_FILE_COUNT); } }
        public IField DOA_EFT_RETURN_FILE_AMOUNT { get { return GetElementByName<IField>(Names.DOA_EFT_RETURN_FILE_AMOUNT); } }
        public IField DOA_EFT_RETURN_FILE_DATE { get { return GetElementByName<IField>(Names.DOA_EFT_RETURN_FILE_DATE); } }


        internal SWEXFE95_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.DOA_INPUT_RECORD, (DOA_INPUT_RECORD) =>
           {
               DOA_INPUT_RECORD.CreateNewField(Names.DOA_EFT_RETURN_FILE_COUNT, FieldType.String, 9);
               DOA_INPUT_RECORD.CreateNewField(Names.DOA_EFT_RETURN_FILE_AMOUNT, FieldType.UnsignedNumeric, 11, null, 2);
               DOA_INPUT_RECORD.CreateNewField(Names.DOA_EFT_RETURN_FILE_DATE, FieldType.String, 8);
           });
        ...
        public override void Initialize()
        {
            ...
            DOA_INPUT_FILE = FileHandler.GetFile("DOAINPUT");
            DOA_INPUT_FILE.StatusField = WS.DOA_FILE_STATUS;
            DOA_INPUT_FILE.AssociatedBuffer = DOA_INPUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXFE95_fd(SWEXFE95_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE95_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE95_ws_WorkingStorage";
    ...
    internal class SWEXFE95_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE95_ls_LinkageSection";
            ...
            internal const string EXPORT_DOA_EFT_RETURN_R_0001GV = "EXPORT_DOA_EFT_RETURN_R_0001GV";
            internal const string EXPORT_TOTALS_0005EV = "EXPORT_TOTALS_0005EV";
            ...
            internal const string EXPORT_SETTLEMENT_DATE_0006EV = "EXPORT_SETTLEMENT_DATE_0006EV";
        ...
        public IGroup EXPORT_DOA_EFT_RETURN_R_0001GV { get { return GetElementByName<IGroup>(Names.EXPORT_DOA_EFT_RETURN_R_0001GV); } }
        public IGroup EXPORT_TOTALS_0005EV { get { return GetElementByName<IGroup>(Names.EXPORT_TOTALS_0005EV); } }
        ...
        public IGroup EXPORT_SETTLEMENT_DATE_0006EV { get { return GetElementByName<IGroup>(Names.EXPORT_SETTLEMENT_DATE_0006EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_ERROR_0003EV, (EXPORT_ERROR_0003EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_DOA_EFT_RETURN_R_0001GV, (EXPORT_DOA_EFT_RETURN_R_0001GV) =>
           {
               EXPORT_DOA_EFT_RETURN_R_0001GV.CreateNewGroup(Names.EXPORT_TOTALS_0005EV, (EXPORT_TOTALS_0005EV) =>
               {
                   EXPORT_TOTALS_0005EV.CreateNewGroup(Names.IEF_SUPPLIED_0005ET, (IEF_SUPPLIED_0005ET) =>
                   {
               ...
               EXPORT_DOA_EFT_RETURN_R_0001GV.CreateNewGroup(Names.EXPORT_SETTLEMENT_DATE_0006EV, (EXPORT_SETTLEMENT_DATE_0006EV) =>
               {
                   EXPORT_SETTLEMENT_DATE_0006EV.CreateNewGroup(Names.DATE_WORK_AREA_0006ET, (DATE_WORK_AREA_0006ET) =>
                   {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_0002EV, args, 3);
            SetPassedParm(EXPORT_ERROR_0003EV, args, 4);
            SetPassedParm(EXPORT_DOA_EFT_RETURN_R_0001GV, args, 5);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_0002EV, args, 3);
            SetReturnParm(EXPORT_ERROR_0003EV, args, 4);
            SetReturnParm(EXPORT_DOA_EFT_RETURN_R_0001GV, args, 5);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXFE95 : EABBase
    {
        ...
        public SWEXFE95()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE95");

            WS = new SWEXFE95_ws();
            FD = new SWEXFE95_fd(WS);
            LS = new SWEXFE95_ls();
        }
        ...
        private SWEXFE95_ws WS;

        //==== File Data Class ========================================
        private SWEXFE95_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE95_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , EXPORT-0002EV EXPORT-ERROR-0003EV EXPORT-DOA-EFT-RETURN-R-0001GV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0069222335(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0069222335
        /// </summary>
        private void M_MAIN_0069222335(string returnMethod = "")
        {
            M_PARA_0069222335_INIT("M_PARA_0069222335_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0069222335-INIT THRU PARA-0069222335-INIT-EXIT
            M_PARA_0069222335("M_PARA_0069222335_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0069222335 THRU PARA-0069222335-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0069222335
        /// </summary>
        private void M_PARA_0069222335(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_0069222335") { M_0000_EAB_CODE_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_EAB_CODE_MAIN(string returnMethod = "")
        {
            ...
            FD.DOA_INPUT_FILE.OpenFile(FileAccessMode.Read);                                                    //COBOL==> OPEN INPUT DOA-INPUT-FILE
            if (WS.DOA_FILE_STATUS.IsEqualTo("00"))                                                             //COBOL==> IF DOA-FILE-STATUS = '00'
            {
                FD.DOA_INPUT_FILE.ReadLine();                                                                       //COBOL==> READ DOA-INPUT-FILE
                DisplayToLog(FD.DOA_INPUT_RECORD.AsString());                                                       //COBOL==> DISPLAY DOA-INPUT-RECORD
                if (WS.DOA_FILE_STATUS.IsEqualTo("00"))                                                             //COBOL==> IF DOA-FILE-STATUS = '00'
                {
                    M_1000_MOVE_FIELDS(); if (Control.ExitProgram) { return; }                                            //COBOL==> PERFORM 1000-MOVE-FIELDS
                }                                                                                                   //COBOL==> ELSE
                else
                {
                    DisplayToLog("STATUS ON READING DOA EFT RETURN FILE = " + WS.DOA_FILE_STATUS.AsString());           //COBOL==> DISPLAY 'STATUS ON READING DOA EFT RETURN FILE = ' DOA-FILE-STATUS
                    LS.STATUS_0002.SetValue(WS.DOA_FILE_STATUS);                                                        //COBOL==> MOVE DOA-FILE-STATUS TO STATUS-0002
                    LS.RPT_DETAIL_0003.SetValue("STATUS ERROR ON READING DOA EFT RETURN FILE ");                        //COBOL==> MOVE 'STATUS ERROR ON READING DOA EFT RETURN FILE ' TO RPT-DETAIL-0003
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                   //COBOL==> ELSE
            else
            {
                DisplayToLog("STATUS ON OPENING DOA EFT RETURN FILE = " + WS.DOA_FILE_STATUS.AsString());           //COBOL==> DISPLAY 'STATUS ON OPENING DOA EFT RETURN FILE = ' DOA-FILE-STATUS
                LS.STATUS_0002.SetValue(WS.DOA_FILE_STATUS);                                                        //COBOL==> MOVE DOA-FILE-STATUS TO STATUS-0002
                LS.RPT_DETAIL_0003.SetValue("STATUS ON OPENING DOA EFT RETURN FILE = ");                            //COBOL==> MOVE 'STATUS ON OPENING DOA EFT RETURN FILE = ' TO RPT-DETAIL-0003
            }                                                                                                   //COBOL==> END-IF.
            M_9999_FINISHED(CheckGotoReturn(returnMethod)); return;                                             //COBOL==> GO TO 9999-FINISHED.
        }
        /// <summary>
        /// Method M_1000_MOVE_FIELDS
        /// </summary>
        /// <remarks>
        ///COMMENT: ***************
        /// </remarks>
        private void M_1000_MOVE_FIELDS(string returnMethod = "")
        {
            //COMMENT: ***************
            LS.COUNT_0005XX.SetValue(FD.DOA_EFT_RETURN_FILE_COUNT);                                             //COBOL==> MOVE DOA-EFT-RETURN-FILE-COUNT TO COUNT-0005XX.
            DisplayToLog("COUNT = " + LS.COUNT_0005.AsString());                                                //COBOL==> DISPLAY 'COUNT = ' COUNT-0005.
            LS.TOTAL_CURRENCY_0005.SetValue(FD.DOA_EFT_RETURN_FILE_AMOUNT);                                     //COBOL==> MOVE DOA-EFT-RETURN-FILE-AMOUNT TO TOTAL-CURRENCY-0005.
            DisplayToLog("TOTAL CURRENCY = " + LS.TOTAL_CURRENCY_0005.AsString());                              //COBOL==> DISPLAY 'TOTAL CURRENCY = ' TOTAL-CURRENCY-0005.
            LS.DATE_0006XX.SetValue(FD.DOA_EFT_RETURN_FILE_DATE);                                               //COBOL==> MOVE DOA-EFT-RETURN-FILE-DATE TO DATE-0006XX.
            DisplayToLog("EFFECTIVE DATE = " + LS.DATE_0006XX.AsString());                                      //COBOL==> DISPLAY 'EFFECTIVE DATE = ' DATE-0006XX.
                                                                                                                //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            if ((WS.DOA_FILE_STATUS.IsEqualTo("00")))                                                           //COBOL==> WHEN '00'
            {
                ...
                DisplayToLog(FD.DOA_INPUT_RECORD.AsString());                                                       //COBOL==> DISPLAY DOA-INPUT-RECORD
                DisplayToLog(" ");                                                                                  //COBOL==> DISPLAY ' '
                DisplayToLog("MORE THAN ONE RECORD IN DOA RETURN FILE");                                            //COBOL==> DISPLAY 'MORE THAN ONE RECORD IN DOA RETURN FILE'
                LS.STATUS_0002.SetValue("NOT EOF");                                                                 //COBOL==> MOVE 'NOT EOF' TO STATUS-0002
                LS.RPT_DETAIL_0003.SetValue("MORE THAN ONE RECORD IN DOA RETURN FILE");                             //COBOL==> MOVE 'MORE THAN ONE RECORD IN DOA RETURN FILE' TO RPT-DETAIL-0003
            }                                                                                                //COBOL==> WHEN '10'
            else
            if ((WS.DOA_FILE_STATUS.IsEqualTo("10")))
            {
                LS.STATUS_0002.SetValue("OK");                                                                      //COBOL==> MOVE 'OK' TO STATUS-0002
            }                                                                                                //COBOL==> WHEN OTHER
            else
            {
                LS.STATUS_0002.SetValue(WS.DOA_FILE_STATUS);                                                        //COBOL==> MOVE DOA-FILE-STATUS TO STATUS-0002
                DisplayToLog("STATUS ERROR ON SECOND DOA FILE READ = " + WS.DOA_FILE_STATUS.AsString());            //COBOL==> DISPLAY 'STATUS ERROR ON SECOND DOA FILE READ = ' DOA-FILE-STATUS
                LS.RPT_DETAIL_0003.SetValue("STATUS ERROR ON SECOND DOA FILE READ");                                //COBOL==> MOVE 'STATUS ERROR ON SECOND DOA FILE READ' TO RPT-DETAIL-0003
            }                                                                                                   //COBOL==> END-EVALUATE.
            if (returnMethod != "" && returnMethod != "M_1000_MOVE_FIELDS") { M_9999_FINISHED(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0069222335_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0069222335_EXIT
        /// </summary>
        private void M_PARA_0069222335_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0069222335_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0069222335_EXIT") { M_PARA_0069222335_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0069222335_INIT
        /// </summary>
        private void M_PARA_0069222335_INIT(string returnMethod = "")
        {
            ...
            LS.EXPORT_DOA_EFT_RETURN_R_0001GV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-DOA-EFT-RETURN-R-0001GV .
            if (returnMethod != "" && returnMethod != "M_PARA_0069222335_INIT") { M_PARA_0069222335_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0069222335_INIT_EXIT
        /// </summary>
        private void M_PARA_0069222335_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0069222335_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
