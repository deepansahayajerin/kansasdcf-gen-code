...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:29 PM
   **        *   FROM COBOL PGM   :  SWEXLR03
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_EAB_READ_KDOL_UI_OFFSET_INFO  DATE: 2012/05/25
       TARGET OS:   MVS                       TIME: 16:56:39
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXLR03_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLR03_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 150);
           });
        ...
        public override void Initialize()
        {
            ...
            INPUT_FILE_01 = FileHandler.GetFile("KDOLIN");
        ...
        #region Constructors
        public SWEXLR03_fd(SWEXLR03_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLR03_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLR03_ws_WorkingStorage";
    ...
    internal class SWEXLR03_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLR03_ls_LinkageSection";
            ...
            internal const string KDOL_UI_INBOUND_FILE_0003ET = "KDOL_UI_INBOUND_FILE_0003ET";
            internal const string UI_WITHHOLDING_RECORD_0003AS = "UI_WITHHOLDING_RECORD_0003AS";
            internal const string UI_WITHHOLDING_RECORD_0003 = "UI_WITHHOLDING_RECORD_0003";
            internal const string UI_WITHHOLDING_RECORD_0003XX = "UI_WITHHOLDING_RECORD_0003XX";
        }
        #endregion
        ...
        public IGroup KDOL_UI_INBOUND_FILE_0003ET { get { return GetElementByName<IGroup>(Names.KDOL_UI_INBOUND_FILE_0003ET); } }
        public IField UI_WITHHOLDING_RECORD_0003AS { get { return GetElementByName<IField>(Names.UI_WITHHOLDING_RECORD_0003AS); } }
        public IField UI_WITHHOLDING_RECORD_0003 { get { return GetElementByName<IField>(Names.UI_WITHHOLDING_RECORD_0003); } }
        public IField UI_WITHHOLDING_RECORD_0003XX { get { return GetElementByName<IField>(Names.UI_WITHHOLDING_RECORD_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.KDOL_UI_INBOUND_FILE_0003ET, (KDOL_UI_INBOUND_FILE_0003ET) =>
               {
                   KDOL_UI_INBOUND_FILE_0003ET.CreateNewField(Names.UI_WITHHOLDING_RECORD_0003AS, FieldType.String, 1);

                   IField UI_WITHHOLDING_RECORD_0003_local = KDOL_UI_INBOUND_FILE_0003ET.CreateNewField(Names.UI_WITHHOLDING_RECORD_0003, FieldType.String, 150);
                   KDOL_UI_INBOUND_FILE_0003ET.CreateNewFieldRedefine(Names.UI_WITHHOLDING_RECORD_0003XX, FieldType.String, UI_WITHHOLDING_RECORD_0003_local, 150);
               });
           });
    ...
    public class SWEXLR03 : EABBase
    {
        ...
        public SWEXLR03()
            : base()
        {
            this.ProgramName.SetValue("SWEXLR03");

            WS = new SWEXLR03_ws();
            FD = new SWEXLR03_fd(WS);
            LS = new SWEXLR03_ls();
        }
        ...
        private SWEXLR03_ws WS;

        //==== File Data Class ========================================
        private SWEXLR03_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLR03_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1383073511(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1383073511
        /// </summary>
        private void M_MAIN_1383073511(string returnMethod = "")
        {
            M_PARA_1383073511_INIT("M_PARA_1383073511_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1383073511-INIT THRU PARA-1383073511-INIT-EXIT
            M_PARA_1383073511("M_PARA_1383073511_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1383073511 THRU PARA-1383073511-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1383073511
        /// </summary>
        private void M_PARA_1383073511(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1383073511") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.UI_WITHHOLDING_RECORD_0003.SetValue(FD.RECORD_01_DETAIL);                                        //COBOL==> MOVE RECORD-01-DETAIL TO UI-WITHHOLDING-RECORD-0003
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1383073511_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1383073511_EXIT
        /// </summary>
        private void M_PARA_1383073511_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1383073511_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1383073511_EXIT") { M_PARA_1383073511_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1383073511_INIT
        /// </summary>
        private void M_PARA_1383073511_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1383073511_INIT") { M_PARA_1383073511_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1383073511_INIT_EXIT
        /// </summary>
        private void M_PARA_1383073511_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1383073511_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
