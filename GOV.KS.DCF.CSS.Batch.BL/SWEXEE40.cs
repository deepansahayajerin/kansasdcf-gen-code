...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:25 PM
   **        *   FROM COBOL PGM   :  SWEXEE40
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_WRITE_LOCATE_REQUESTS     DATE: 2000/07/03
       TARGET OS:   MVS                       TIME: 10:44:38
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEE40_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEE40_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.EXTFILE_RECORD, FieldType.String, 350);
        ...
        #region Constructors
        public SWEXEE40_fd(SWEXEE40_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEE40_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEE40_ws_WorkingStorage";
            ...
            internal const string WS_EXTERNAL_LOCATE_REQUEST = "WS_EXTERNAL_LOCATE_REQUEST";
            ...
            internal const string AGENCY_NUMBER = "AGENCY_NUMBER";
        ...
        public IGroup WS_EXTERNAL_LOCATE_REQUEST { get { return GetElementByName<IGroup>(Names.WS_EXTERNAL_LOCATE_REQUEST); } }
        ...
        public IField REQUEST_DATE { get { return GetElementByName<IField>(Names.REQUEST_DATE); } }
        ...
        public IField AGENCY_NUMBER { get { return GetElementByName<IField>(Names.AGENCY_NUMBER); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEE40 WORKING STORAGE STARTS HERE");
               WS_MISC.CreateNewField(Names.WS_RECORD_COUNT, FieldType.UnsignedNumeric, 7, ZEROES);
           });

            recordDef.CreateNewGroup(Names.WS_EXTERNAL_LOCATE_REQUEST, (WS_EXTERNAL_LOCATE_REQUEST) =>
           {
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.SPACES_1, FieldType.String, 30);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.DATE_OF_BIRTH, FieldType.String, 8);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.SPACES_2, FieldType.String, 180);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.REQUEST_DATE, FieldType.String, 8);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.SPACES_2_d2, FieldType.String, 51);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.CSE_PERSON_NO, FieldType.String, 10);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.AGENCY_NUMBER, FieldType.String, 5);
               WS_EXTERNAL_LOCATE_REQUEST.CreateNewField(Names.SPACES_2_d3, FieldType.String, 49);
           });
    ...
    internal class SWEXEE40_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEE40_ls_LinkageSection";
            ...
            internal const string EXTERNAL_LOCATE_REQUEST_0001ET = "EXTERNAL_LOCATE_REQUEST_0001ET";
            ...
            internal const string DATE_OF_BIRTH_0001AS = "DATE_OF_BIRTH_0001AS";
            internal const string DATE_OF_BIRTH_0001 = "DATE_OF_BIRTH_0001";
            internal const string DATE_OF_BIRTH_0001XX = "DATE_OF_BIRTH_0001XX";
            internal const string REQUEST_DATE_0001AS = "REQUEST_DATE_0001AS";
            internal const string REQUEST_DATE_0001 = "REQUEST_DATE_0001";
            internal const string REQUEST_DATE_0001XX = "REQUEST_DATE_0001XX";
            ...
            internal const string SUSP_STATUS_0001AS = "SUSP_STATUS_0001AS";
            internal const string SUSP_STATUS_0001 = "SUSP_STATUS_0001";
            internal const string SUSP_STATUS_0001XX = "SUSP_STATUS_0001XX";
        ...
        public IGroup EXTERNAL_LOCATE_REQUEST_0001ET { get { return GetElementByName<IGroup>(Names.EXTERNAL_LOCATE_REQUEST_0001ET); } }
        ...
        public IField DATE_OF_BIRTH_0001AS { get { return GetElementByName<IField>(Names.DATE_OF_BIRTH_0001AS); } }
        public IField DATE_OF_BIRTH_0001 { get { return GetElementByName<IField>(Names.DATE_OF_BIRTH_0001); } }
        public IField DATE_OF_BIRTH_0001XX { get { return GetElementByName<IField>(Names.DATE_OF_BIRTH_0001XX); } }
        public IField REQUEST_DATE_0001AS { get { return GetElementByName<IField>(Names.REQUEST_DATE_0001AS); } }
        public IField REQUEST_DATE_0001 { get { return GetElementByName<IField>(Names.REQUEST_DATE_0001); } }
        public IField REQUEST_DATE_0001XX { get { return GetElementByName<IField>(Names.REQUEST_DATE_0001XX); } }
        ...
        public IField SUSP_STATUS_0001AS { get { return GetElementByName<IField>(Names.SUSP_STATUS_0001AS); } }
        public IField SUSP_STATUS_0001 { get { return GetElementByName<IField>(Names.SUSP_STATUS_0001); } }
        public IField SUSP_STATUS_0001XX { get { return GetElementByName<IField>(Names.SUSP_STATUS_0001XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0001EV.CreateNewGroup(Names.EXTERNAL_LOCATE_REQUEST_0001ET, (EXTERNAL_LOCATE_REQUEST_0001ET) =>
               {
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.SSN_0001AS, FieldType.String, 1);

                   IField SSN_0001_local = EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.SSN_0001, FieldType.String, 9);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewFieldRedefine(Names.SSN_0001XX, FieldType.String, SSN_0001_local, 9);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.DATE_OF_BIRTH_0001AS, FieldType.String, 1);

                   IField DATE_OF_BIRTH_0001_local = EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.DATE_OF_BIRTH_0001, FieldType.SignedNumeric, 8);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewFieldRedefine(Names.DATE_OF_BIRTH_0001XX, FieldType.String, DATE_OF_BIRTH_0001_local, 8);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.REQUEST_DATE_0001AS, FieldType.String, 1);

                   IField REQUEST_DATE_0001_local = EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.REQUEST_DATE_0001, FieldType.SignedNumeric, 8);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewFieldRedefine(Names.REQUEST_DATE_0001XX, FieldType.String, REQUEST_DATE_0001_local, 8);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.CSE_PERSON_NUMBER_0001AS, FieldType.String, 1);

                   IField CSE_PERSON_NUMBER_0001_local = EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.CSE_PERSON_NUMBER_0001, FieldType.String, 10);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewFieldRedefine(Names.CSE_PERSON_NUMBER_0001XX, FieldType.String, CSE_PERSON_NUMBER_0001_local, 10);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.AGENCY_NUMBER_0001AS, FieldType.String, 1);

                   IField AGENCY_NUMBER_0001_local = EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.AGENCY_NUMBER_0001, FieldType.String, 5);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewFieldRedefine(Names.AGENCY_NUMBER_0001XX, FieldType.String, AGENCY_NUMBER_0001_local, 5);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.SUSP_STATUS_0001AS, FieldType.String, 1);

                   IField SUSP_STATUS_0001_local = EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewField(Names.SUSP_STATUS_0001, FieldType.String, 1);
                   EXTERNAL_LOCATE_REQUEST_0001ET.CreateNewFieldRedefine(Names.SUSP_STATUS_0001XX, FieldType.String, SUSP_STATUS_0001_local, 1);
               });
           });
    ...
    public class SWEXEE40 : EABBase
    {
        ...
        public SWEXEE40()
            : base()
        {
            this.ProgramName.SetValue("SWEXEE40");

            WS = new SWEXEE40_ws();
            FD = new SWEXEE40_fd(WS);
            LS = new SWEXEE40_ls();
        }
        ...
        private SWEXEE40_ws WS;

        //==== File Data Class ========================================
        private SWEXEE40_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEE40_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_2032403459(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_2032403459
        /// </summary>
        private void M_MAIN_2032403459(string returnMethod = "")
        {
            M_PARA_2032403459_INIT("M_PARA_2032403459_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-2032403459-INIT THRU PARA-2032403459-INIT-EXIT
            M_PARA_2032403459("M_PARA_2032403459_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-2032403459 THRU PARA-2032403459-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_2032403459
        /// </summary>
        private void M_PARA_2032403459(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:     *******************************************
            //COMMENT:     THIS CODE SWCSZ800 IS A PART OF SWEXEE40  *
            //COMMENT:     OE_EAB_WRITE_LOCATE_REQUEST               *
            //COMMENT:     *******************************************
            ...
            LS.FILE_INSTRUCTION_0003.SetValue(LS.FILE_INSTRUCTION_0002);                                        //COBOL==> MOVE FILE-INSTRUCTION-0002 TO FILE-INSTRUCTION-0003.
            if (returnMethod != "" && returnMethod != "M_PARA_2032403459") { M_1000_EAB_CODE_MAIN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_1000_EAB_CODE_MAIN(string returnMethod = "")
        {
            ...
            if (LS.FILE_INSTRUCTION_0002.IsEqualTo("WRITED"))                                                   //COBOL==> IF FILE-INSTRUCTION-0002 = 'WRITED'
            {
        ...
        {
            WS.WS_EXTERNAL_LOCATE_REQUEST.SetValueWithSpaces();                                                 //COBOL==> MOVE SPACES TO WS-EXTERNAL-LOCATE-REQUEST.
            WS.SSN.SetValue(LS.SSN_0001);                                                                       //COBOL==> MOVE SSN-0001 TO SSN.
            WS.DATE_OF_BIRTH.SetValue(LS.DATE_OF_BIRTH_0001);                                                   //COBOL==> MOVE DATE-OF-BIRTH-0001 TO DATE-OF-BIRTH.
            WS.REQUEST_DATE.SetValue(LS.REQUEST_DATE_0001);                                                     //COBOL==> MOVE REQUEST-DATE-0001 TO REQUEST-DATE.
            WS.CSE_PERSON_NO.SetValue(LS.CSE_PERSON_NUMBER_0001);                                               //COBOL==> MOVE CSE-PERSON-NUMBER-0001 TO CSE-PERSON-NO.
            WS.AGENCY_NUMBER.SetValue(LS.AGENCY_NUMBER_0001);                                                   //COBOL==> MOVE AGENCY-NUMBER-0001 TO AGENCY-NUMBER.
            FD.EXTFILE_RECORD.SetValue(WS.WS_EXTERNAL_LOCATE_REQUEST);                                          //COBOL==> MOVE WS-EXTERNAL-LOCATE-REQUEST TO EXTFILE-RECORD.
            FD.EXTFILE.WriteLine(FD.EXTFILE_RECORD.AsBytes);                                                    //COBOL==> WRITE EXTFILE-RECORD.
            if (!(WS.EXTFILE_STAT.IsEqualTo(0)))                                                                //COBOL==> IF EXTFILE-STAT NOT = 0
            {
                LS.TEXT_RETURN_CODE_0003.SetValue("WD");                                                            //COBOL==> MOVE 'WD' TO TEXT-RETURN-CODE-0003
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.EXTFILE_STAT);                                              //COBOL==> MOVE EXTFILE-STAT TO NUMERIC-RETURN-CODE-0003
        ...
        private void M_9999_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_EXIT") { M_PARA_2032403459_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2032403459_EXIT
        /// </summary>
        private void M_PARA_2032403459_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_2032403459_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_2032403459_EXIT") { M_PARA_2032403459_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2032403459_INIT
        /// </summary>
        private void M_PARA_2032403459_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_2032403459_INIT") { M_PARA_2032403459_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_2032403459_INIT_EXIT
        /// </summary>
        private void M_PARA_2032403459_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_2032403459_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
