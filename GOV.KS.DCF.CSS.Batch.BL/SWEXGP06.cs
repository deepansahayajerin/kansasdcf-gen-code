...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:48:31 PM
   **        *   FROM COBOL PGM   :  SWEXGP06
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXGP06_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXGP06_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            REPTOUT = FileHandler.GetFile("UT_S_RPT06");
    ...
    internal class SWEXGP06_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXGP06_ws_WorkingStorage";
    ...
    internal class SWEXGP06_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXGP06_ls_LinkageSection";
    ...
    public class SWEXGP06 : EABBase
    {
        ...
        public SWEXGP06()
            : base()
        {
            this.ProgramName.SetValue("SWEXGP06");
        ...
        private SWEXGP06_ws WS;

        //==== File Data Class ========================================
        private SWEXGP06_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXGP06_ls LS;
        #endregion
