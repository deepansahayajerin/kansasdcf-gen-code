...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:54:29 PM
   **        *   FROM COBOL PGM   :  SWEXWF15
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_EXT_SWEFMB1_WRITE_FILE        DATE: 2002/08/24
       TARGET OS:   MVS                       TIME: 16:19:28
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXWF15_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXWF15_fd_FileSection";
            internal const string FIXOUT_FILE = "FIXOUT_FILE";
            internal const string FIXOUT_RECORD = "FIXOUT_RECORD";
            internal const string CSP_NUMBER = "CSP_NUMBER";
            internal const string OB_ID = "OB_ID";
            internal const string OB_TRN_ID = "OB_TRN_ID";
            internal const string DDSH_UPDATES = "DDSH_UPDATES";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink FIXOUT_FILE { get; set; }
        public IGroup FIXOUT_RECORD { get { return GetElementByName<IGroup>(Names.FIXOUT_RECORD); } }
        public IField CSP_NUMBER { get { return GetElementByName<IField>(Names.CSP_NUMBER); } }
        public IField OB_ID { get { return GetElementByName<IField>(Names.OB_ID); } }
        public IField OB_TRN_ID { get { return GetElementByName<IField>(Names.OB_TRN_ID); } }
        public IField DDSH_UPDATES { get { return GetElementByName<IField>(Names.DDSH_UPDATES); } }


        internal SWEXWF15_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.FIXOUT_RECORD, (FIXOUT_RECORD) =>
           {
               FIXOUT_RECORD.CreateNewField(Names.CSP_NUMBER, FieldType.String, 10);
               FIXOUT_RECORD.CreateNewFillerField(FieldType.String, 2, SPACES);
               FIXOUT_RECORD.CreateNewField(Names.OB_ID, FieldType.UnsignedNumeric, 3);
               FIXOUT_RECORD.CreateNewFillerField(FieldType.String, 2, SPACES);
               FIXOUT_RECORD.CreateNewField(Names.OB_TRN_ID, FieldType.UnsignedNumeric, 9);
               FIXOUT_RECORD.CreateNewFillerField(FieldType.String, 2, SPACES);
               FIXOUT_RECORD.CreateNewField(Names.DDSH_UPDATES, FieldType.UnsignedNumeric, 9);
               FIXOUT_RECORD.CreateNewFillerField(FieldType.String, 3, SPACES);
           });
        ...
        public override void Initialize()
        {
            ...
            FIXOUT_FILE = FileHandler.GetFile("FIXOUT");
            FIXOUT_FILE.StatusField = WS.WS_FILE_STATUS;
            FIXOUT_FILE.AssociatedBuffer = FIXOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXWF15_fd(SWEXWF15_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXWF15_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXWF15_ws_WorkingStorage";
    ...
    internal class SWEXWF15_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXWF15_ls_LinkageSection";
            ...
            internal const string STATUS_0001AS = "STATUS_0001AS";
            ...
            internal const string OBLIGATION_0003ET = "OBLIGATION_0003ET";
            internal const string SYSTEM_GENERATED_IDENTI_0004AS = "SYSTEM_GENERATED_IDENTI_0004AS";
            internal const string SYSTEM_GENERATED_IDENTIFI_0004 = "SYSTEM_GENERATED_IDENTIFI_0004";
            internal const string SYSTEM_GENERATED_IDENTI_0004XX = "SYSTEM_GENERATED_IDENTI_0004XX";
            internal const string IMIPORT_0005EV = "IMIPORT_0005EV";
            ...
            internal const string IMPORT_NUMBER_DDSH_UPDA_0007EV = "IMPORT_NUMBER_DDSH_UPDA_0007EV";
            ...
            internal const string IMPORT_NOT_USED_0008EV = "IMPORT_NOT_USED_0008EV";
            internal const string DEBT_DETAIL_STATUS_HIST_0008ET = "DEBT_DETAIL_STATUS_HIST_0008ET";
            internal const string EFFECTIVE_DT_0008AS = "EFFECTIVE_DT_0008AS";
            internal const string EFFECTIVE_DT_0008 = "EFFECTIVE_DT_0008";
            internal const string EFFECTIVE_DT_0008XX = "EFFECTIVE_DT_0008XX";
            internal const string DISCONTINUE_DT_0008AS = "DISCONTINUE_DT_0008AS";
            internal const string DISCONTINUE_DT_0008 = "DISCONTINUE_DT_0008";
            internal const string DISCONTINUE_DT_0008XX = "DISCONTINUE_DT_0008XX";
            internal const string SYSTEM_GENERATED_IDENTI_0009AS = "SYSTEM_GENERATED_IDENTI_0009AS";
            internal const string SYSTEM_GENERATED_IDENTIFI_0009 = "SYSTEM_GENERATED_IDENTIFI_0009";
            internal const string SYSTEM_GENERATED_IDENTI_0009XX = "SYSTEM_GENERATED_IDENTI_0009XX";
            internal const string IMPORT_OLD_NOT_USED_0010EV = "IMPORT_OLD_NOT_USED_0010EV";
            internal const string DEBT_DETAIL_STATUS_HIST_0010ET = "DEBT_DETAIL_STATUS_HIST_0010ET";
            internal const string DISCONTINUE_DT_0010AS = "DISCONTINUE_DT_0010AS";
            internal const string DISCONTINUE_DT_0010 = "DISCONTINUE_DT_0010";
            internal const string DISCONTINUE_DT_0010XX = "DISCONTINUE_DT_0010XX";
        ...
        public IField STATUS_0001AS { get { return GetElementByName<IField>(Names.STATUS_0001AS); } }
        ...
        public IGroup OBLIGATION_0003ET { get { return GetElementByName<IGroup>(Names.OBLIGATION_0003ET); } }
        public IField SYSTEM_GENERATED_IDENTI_0004AS { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTI_0004AS); } }
        public IField SYSTEM_GENERATED_IDENTIFI_0004 { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTIFI_0004); } }
        public IField SYSTEM_GENERATED_IDENTI_0004XX { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTI_0004XX); } }
        public IGroup IMIPORT_0005EV { get { return GetElementByName<IGroup>(Names.IMIPORT_0005EV); } }
        ...
        public IGroup IMPORT_NUMBER_DDSH_UPDA_0007EV { get { return GetElementByName<IGroup>(Names.IMPORT_NUMBER_DDSH_UPDA_0007EV); } }
        ...
        public IGroup IMPORT_NOT_USED_0008EV { get { return GetElementByName<IGroup>(Names.IMPORT_NOT_USED_0008EV); } }
        public IGroup DEBT_DETAIL_STATUS_HIST_0008ET { get { return GetElementByName<IGroup>(Names.DEBT_DETAIL_STATUS_HIST_0008ET); } }
        public IField EFFECTIVE_DT_0008AS { get { return GetElementByName<IField>(Names.EFFECTIVE_DT_0008AS); } }
        public IField EFFECTIVE_DT_0008 { get { return GetElementByName<IField>(Names.EFFECTIVE_DT_0008); } }
        public IField EFFECTIVE_DT_0008XX { get { return GetElementByName<IField>(Names.EFFECTIVE_DT_0008XX); } }
        public IField DISCONTINUE_DT_0008AS { get { return GetElementByName<IField>(Names.DISCONTINUE_DT_0008AS); } }
        public IField DISCONTINUE_DT_0008 { get { return GetElementByName<IField>(Names.DISCONTINUE_DT_0008); } }
        public IField DISCONTINUE_DT_0008XX { get { return GetElementByName<IField>(Names.DISCONTINUE_DT_0008XX); } }
        public IField SYSTEM_GENERATED_IDENTI_0009AS { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTI_0009AS); } }
        public IField SYSTEM_GENERATED_IDENTIFI_0009 { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTIFI_0009); } }
        public IField SYSTEM_GENERATED_IDENTI_0009XX { get { return GetElementByName<IField>(Names.SYSTEM_GENERATED_IDENTI_0009XX); } }
        public IGroup IMPORT_OLD_NOT_USED_0010EV { get { return GetElementByName<IGroup>(Names.IMPORT_OLD_NOT_USED_0010EV); } }
        public IGroup DEBT_DETAIL_STATUS_HIST_0010ET { get { return GetElementByName<IGroup>(Names.DEBT_DETAIL_STATUS_HIST_0010ET); } }
        public IField DISCONTINUE_DT_0010AS { get { return GetElementByName<IField>(Names.DISCONTINUE_DT_0010AS); } }
        public IField DISCONTINUE_DT_0010 { get { return GetElementByName<IField>(Names.DISCONTINUE_DT_0010); } }
        public IField DISCONTINUE_DT_0010XX { get { return GetElementByName<IField>(Names.DISCONTINUE_DT_0010XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
               IMPORT_0001EV.CreateNewGroup(Names.EAB_FILE_HANDLING_0001ET, (EAB_FILE_HANDLING_0001ET) =>
               {
                   ...
                   EAB_FILE_HANDLING_0001ET.CreateNewField(Names.STATUS_0001AS, FieldType.String, 1);
           ...
           {
               IMPORT_0003EV.CreateNewGroup(Names.OBLIGATION_0003ET, (OBLIGATION_0003ET) =>
               {
                   OBLIGATION_0003ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTI_0004AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_IDENTIFI_0004_local = OBLIGATION_0003ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTIFI_0004, FieldType.SignedNumeric, 3);
                   OBLIGATION_0003ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_IDENTI_0004XX, FieldType.String, SYSTEM_GENERATED_IDENTIFI_0004_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.IMIPORT_0005EV, (IMIPORT_0005EV) =>
           {
               IMIPORT_0005EV.CreateNewGroup(Names.OBLIGATION_TRANSACTION_0005ET, (OBLIGATION_TRANSACTION_0005ET) =>
               {
                   OBLIGATION_TRANSACTION_0005ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTI_0006AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_IDENTIFI_0006_local = OBLIGATION_TRANSACTION_0005ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTIFI_0006, FieldType.SignedNumeric, 9);
                   OBLIGATION_TRANSACTION_0005ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_IDENTI_0006XX, FieldType.String, SYSTEM_GENERATED_IDENTIFI_0006_local, 9);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_NUMBER_DDSH_UPDA_0007EV, (IMPORT_NUMBER_DDSH_UPDA_0007EV) =>
           {
               IMPORT_NUMBER_DDSH_UPDA_0007EV.CreateNewGroup(Names.IEF_SUPPLIED_0007ET, (IEF_SUPPLIED_0007ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_NOT_USED_0008EV, (IMPORT_NOT_USED_0008EV) =>
           {
               IMPORT_NOT_USED_0008EV.CreateNewGroup(Names.DEBT_DETAIL_STATUS_HIST_0008ET, (DEBT_DETAIL_STATUS_HIST_0008ET) =>
               {
                   DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewField(Names.EFFECTIVE_DT_0008AS, FieldType.String, 1);

                   IField EFFECTIVE_DT_0008_local = DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewField(Names.EFFECTIVE_DT_0008, FieldType.SignedNumeric, 8);
                   DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewFieldRedefine(Names.EFFECTIVE_DT_0008XX, FieldType.String, EFFECTIVE_DT_0008_local, 8);
                   DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewField(Names.DISCONTINUE_DT_0008AS, FieldType.String, 1);

                   IField DISCONTINUE_DT_0008_local = DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewField(Names.DISCONTINUE_DT_0008, FieldType.SignedNumeric, 8);
                   DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewFieldRedefine(Names.DISCONTINUE_DT_0008XX, FieldType.String, DISCONTINUE_DT_0008_local, 8);
                   DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTI_0009AS, FieldType.String, 1);

                   IField SYSTEM_GENERATED_IDENTIFI_0009_local = DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewField(Names.SYSTEM_GENERATED_IDENTIFI_0009, FieldType.SignedNumeric, 3);
                   DEBT_DETAIL_STATUS_HIST_0008ET.CreateNewFieldRedefine(Names.SYSTEM_GENERATED_IDENTI_0009XX, FieldType.String, SYSTEM_GENERATED_IDENTIFI_0009_local, 3);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_OLD_NOT_USED_0010EV, (IMPORT_OLD_NOT_USED_0010EV) =>
           {
               IMPORT_OLD_NOT_USED_0010EV.CreateNewGroup(Names.DEBT_DETAIL_STATUS_HIST_0010ET, (DEBT_DETAIL_STATUS_HIST_0010ET) =>
               {
                   DEBT_DETAIL_STATUS_HIST_0010ET.CreateNewField(Names.DISCONTINUE_DT_0010AS, FieldType.String, 1);

                   IField DISCONTINUE_DT_0010_local = DEBT_DETAIL_STATUS_HIST_0010ET.CreateNewField(Names.DISCONTINUE_DT_0010, FieldType.SignedNumeric, 8);
                   DEBT_DETAIL_STATUS_HIST_0010ET.CreateNewFieldRedefine(Names.DISCONTINUE_DT_0010XX, FieldType.String, DISCONTINUE_DT_0010_local, 8);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMIPORT_0005EV, args, 6);
            SetPassedParm(IMPORT_NUMBER_DDSH_UPDA_0007EV, args, 7);
            SetPassedParm(IMPORT_NOT_USED_0008EV, args, 8);
            SetPassedParm(IMPORT_OLD_NOT_USED_0010EV, args, 9);
            SetPassedParm(EXPORT_0011EV, args, 10);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMIPORT_0005EV, args, 6);
            SetReturnParm(IMPORT_NUMBER_DDSH_UPDA_0007EV, args, 7);
            SetReturnParm(IMPORT_NOT_USED_0008EV, args, 8);
            SetReturnParm(IMPORT_OLD_NOT_USED_0010EV, args, 9);
            SetReturnParm(EXPORT_0011EV, args, 10);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXWF15 : EABBase
    {
        ...
        public SWEXWF15()
            : base()
        {
            this.ProgramName.SetValue("SWEXWF15");

            WS = new SWEXWF15_ws();
            FD = new SWEXWF15_fd(WS);
            LS = new SWEXWF15_ls();
        }
        ...
        private SWEXWF15_ws WS;

        //==== File Data Class ========================================
        private SWEXWF15_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXWF15_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0003EV , IMIPORT-0005EV , IMPORT-NUMBER-DDSH-UPDA-0007EV , IMPORT-NOT-USED-0008EV , IMPORT-OLD-NOT-USED-0010EV , EXPORT-0011EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1911816458(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1911816458
        /// </summary>
        private void M_MAIN_1911816458(string returnMethod = "")
        {
            M_PARA_1911816458_INIT("M_PARA_1911816458_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1911816458-INIT THRU PARA-1911816458-INIT-EXIT
            M_PARA_1911816458("M_PARA_1911816458_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1911816458 THRU PARA-1911816458-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1911816458
        /// </summary>
        private void M_PARA_1911816458(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            ...
            {
                LS.STATUS_0011.SetValue("ABEND");                                                                   //COBOL==> MOVE 'ABEND' TO STATUS-0011 .
            }
            if (returnMethod != "" && returnMethod != "M_PARA_1911816458") { M_PARA_1911816458_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1911816458_EXIT
        /// </summary>
        private void M_PARA_1911816458_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1911816458_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1911816458_EXIT") { M_PARA_OPEN(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_OPEN
        /// </summary>
        ...
        {
            FD.FIXOUT_FILE.OpenFile(FileAccessMode.Write);                                                      //COBOL==> OPEN OUTPUT FIXOUT-FILE.
        ...
        /// </summary>
        /// <remarks>
        ///COMMENT:     MOVE 'OK' TO STATUS-0011.
        /// </remarks>
        ...
        {
            FD.FIXOUT_FILE.CloseFile();                                                                         //COBOL==> CLOSE FIXOUT-FILE.
        ...
        {
            FD.CSP_NUMBER.SetValue(LS.NUMBER_0002);                                                             //COBOL==> MOVE NUMBER-0002 TO CSP-NUMBER
            FD.OB_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0004);                                               //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0004 TO OB-ID
            FD.OB_TRN_ID.SetValue(LS.SYSTEM_GENERATED_IDENTIFI_0006);                                           //COBOL==> MOVE SYSTEM-GENERATED-IDENTIFI-0006 TO OB-TRN-ID
            FD.DDSH_UPDATES.SetValue(LS.COUNT_0007);                                                            //COBOL==> MOVE COUNT-0007 TO DDSH-UPDATES.
            FD.FIXOUT_FILE.WriteLine(FD.FIXOUT_RECORD.AsBytes);                                                 //COBOL==> WRITE FIXOUT-RECORD.
        ...
        private void M_PARA_WRITE_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_WRITE_EXIT") { M_PARA_1911816458_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1911816458_INIT
        /// </summary>
        private void M_PARA_1911816458_INIT(string returnMethod = "")
        {
            LS.EXPORT_0011EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0011EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1911816458_INIT") { M_PARA_1911816458_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1911816458_INIT_EXIT
        /// </summary>
        private void M_PARA_1911816458_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1911816458_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
