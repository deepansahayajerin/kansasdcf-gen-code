...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:19 PM
   **        *   FROM COBOL PGM   :  SWEXLE88
...
/* Original Program Identification Comments
   **************************************************************
       ...
       COPYRIGHT 2007 COMPUTER ASSOCIATES INTERNATIONAL, INC.
       NAME: EAB_WRITE_FDSO_TO_TRANSFILE      DATE: 2007/08/20
       TARGET OS:   MVS                       TIME: 17:04:05
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXLE88_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE88_fd_FileSection";
        ...
        public override void Initialize()
        {
            ...
            OUTFILE.StatusField = WS.FILE_STATUS;
        ...
        #region Constructors
        public SWEXLE88_fd(SWEXLE88_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE88_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE88_ws_WorkingStorage";
            internal const string FDSO99 = "FDSO99";
            internal const string F99_SUBMITTING_STATE = "F99_SUBMITTING_STATE";
            internal const string F99_LOCAL_CODE = "F99_LOCAL_CODE";
            internal const string F99_SSN = "F99_SSN";
            internal const string F99_CASE_NUMBER = "F99_CASE_NUMBER";
            internal const string F99_LAST_NAME = "F99_LAST_NAME";
            internal const string F99_FIRST_NAME = "F99_FIRST_NAME";
            internal const string F99_AMOUNT_OWED = "F99_AMOUNT_OWED";
            internal const string F99_TRANS_TYPE = "F99_TRANS_TYPE";
            internal const string F99_CASE_TYPE = "F99_CASE_TYPE";
            internal const string F99_TRANSFER_STATE = "F99_TRANSFER_STATE";
            internal const string F99_LOCAL_FOR_TRANSFER = "F99_LOCAL_FOR_TRANSFER";
            internal const string F99_PROCESS_YEAR = "F99_PROCESS_YEAR";
            internal const string F99_ADDRESS_LINE1 = "F99_ADDRESS_LINE1";
            internal const string F99_ADDRESS_LINE2 = "F99_ADDRESS_LINE2";
            internal const string F99_CITY = "F99_CITY";
            internal const string F99_STATE_CODE = "F99_STATE_CODE";
            internal const string F99_ZIP = "F99_ZIP";
            internal const string F99_DT_ISS_NOTICE = "F99_DT_ISS_NOTICE";
            internal const string F99_OFFSET_EXCLUSION = "F99_OFFSET_EXCLUSION";
            internal const string FDSO98 = "FDSO98";
            internal const string F98_SUBMITTING_STATE = "F98_SUBMITTING_STATE";
            internal const string F98_CONTROL = "F98_CONTROL";
            internal const string F98_TANF_COUNT = "F98_TANF_COUNT";
            internal const string F98_NONTANF_COUNT = "F98_NONTANF_COUNT";
            internal const string F98_TANF_AMOUNT = "F98_TANF_AMOUNT";
            internal const string F98_NONTANF_AMOUNT = "F98_NONTANF_AMOUNT";
            internal const string FILE_STATUS = "FILE_STATUS";
        }
        #endregion

        #region Direct-access element properties
        public IGroup FDSO99 { get { return GetElementByName<IGroup>(Names.FDSO99); } }
        public IField F99_SUBMITTING_STATE { get { return GetElementByName<IField>(Names.F99_SUBMITTING_STATE); } }
        public IField F99_LOCAL_CODE { get { return GetElementByName<IField>(Names.F99_LOCAL_CODE); } }
        public IField F99_SSN { get { return GetElementByName<IField>(Names.F99_SSN); } }
        public IField F99_CASE_NUMBER { get { return GetElementByName<IField>(Names.F99_CASE_NUMBER); } }
        public IField F99_LAST_NAME { get { return GetElementByName<IField>(Names.F99_LAST_NAME); } }
        public IField F99_FIRST_NAME { get { return GetElementByName<IField>(Names.F99_FIRST_NAME); } }
        public IField F99_AMOUNT_OWED { get { return GetElementByName<IField>(Names.F99_AMOUNT_OWED); } }
        public IField F99_TRANS_TYPE { get { return GetElementByName<IField>(Names.F99_TRANS_TYPE); } }
        public IField F99_CASE_TYPE { get { return GetElementByName<IField>(Names.F99_CASE_TYPE); } }
        public IField F99_TRANSFER_STATE { get { return GetElementByName<IField>(Names.F99_TRANSFER_STATE); } }
        public IField F99_LOCAL_FOR_TRANSFER { get { return GetElementByName<IField>(Names.F99_LOCAL_FOR_TRANSFER); } }
        public IField F99_PROCESS_YEAR { get { return GetElementByName<IField>(Names.F99_PROCESS_YEAR); } }
        public IField F99_ADDRESS_LINE1 { get { return GetElementByName<IField>(Names.F99_ADDRESS_LINE1); } }
        public IField F99_ADDRESS_LINE2 { get { return GetElementByName<IField>(Names.F99_ADDRESS_LINE2); } }
        public IField F99_CITY { get { return GetElementByName<IField>(Names.F99_CITY); } }
        public IField F99_STATE_CODE { get { return GetElementByName<IField>(Names.F99_STATE_CODE); } }
        public IField F99_ZIP { get { return GetElementByName<IField>(Names.F99_ZIP); } }
        public IField F99_DT_ISS_NOTICE { get { return GetElementByName<IField>(Names.F99_DT_ISS_NOTICE); } }
        public IField F99_OFFSET_EXCLUSION { get { return GetElementByName<IField>(Names.F99_OFFSET_EXCLUSION); } }
        public IGroup FDSO98 { get { return GetElementByName<IGroup>(Names.FDSO98); } }
        public IField F98_SUBMITTING_STATE { get { return GetElementByName<IField>(Names.F98_SUBMITTING_STATE); } }
        public IField F98_CONTROL { get { return GetElementByName<IField>(Names.F98_CONTROL); } }
        public IField F98_TANF_COUNT { get { return GetElementByName<IField>(Names.F98_TANF_COUNT); } }
        public IField F98_NONTANF_COUNT { get { return GetElementByName<IField>(Names.F98_NONTANF_COUNT); } }
        public IField F98_TANF_AMOUNT { get { return GetElementByName<IField>(Names.F98_TANF_AMOUNT); } }
        public IField F98_NONTANF_AMOUNT { get { return GetElementByName<IField>(Names.F98_NONTANF_AMOUNT); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.FDSO99, (FDSO99) =>
           {
               FDSO99.CreateNewField(Names.F99_SUBMITTING_STATE, FieldType.String, 2);
               FDSO99.CreateNewField(Names.F99_LOCAL_CODE, FieldType.UnsignedNumeric, 3);
               FDSO99.CreateNewField(Names.F99_SSN, FieldType.UnsignedNumeric, 9);
               FDSO99.CreateNewField(Names.F99_CASE_NUMBER, FieldType.String, 15);
               FDSO99.CreateNewField(Names.F99_LAST_NAME, FieldType.String, 20);
               FDSO99.CreateNewField(Names.F99_FIRST_NAME, FieldType.String, 15);
               FDSO99.CreateNewField(Names.F99_AMOUNT_OWED, FieldType.UnsignedNumeric, 8);
               FDSO99.CreateNewField(Names.F99_TRANS_TYPE, FieldType.String, 1);
               FDSO99.CreateNewField(Names.F99_CASE_TYPE, FieldType.String, 1);
               FDSO99.CreateNewField(Names.F99_TRANSFER_STATE, FieldType.String, 2);
               FDSO99.CreateNewField(Names.F99_LOCAL_FOR_TRANSFER, FieldType.UnsignedNumeric, 3);
               FDSO99.CreateNewField(Names.F99_PROCESS_YEAR, FieldType.String, 4);
               FDSO99.CreateNewField(Names.F99_ADDRESS_LINE1, FieldType.String, 30);
               FDSO99.CreateNewField(Names.F99_ADDRESS_LINE2, FieldType.String, 30);
               FDSO99.CreateNewField(Names.F99_CITY, FieldType.String, 25);
               FDSO99.CreateNewField(Names.F99_STATE_CODE, FieldType.String, 2);
               FDSO99.CreateNewField(Names.F99_ZIP, FieldType.String, 9);
               FDSO99.CreateNewField(Names.F99_DT_ISS_NOTICE, FieldType.String, 8);
               FDSO99.CreateNewField(Names.F99_OFFSET_EXCLUSION, FieldType.String, 40);
               FDSO99.CreateNewFillerField(18, FillWith.Hashes);
           });

            recordDef.CreateNewGroup(Names.FDSO98, (FDSO98) =>
           {
               FDSO98.CreateNewField(Names.F98_SUBMITTING_STATE, FieldType.String, 2);
               FDSO98.CreateNewField(Names.F98_CONTROL, FieldType.String, 3);
               FDSO98.CreateNewField(Names.F98_TANF_COUNT, FieldType.UnsignedNumeric, 9);
               FDSO98.CreateNewField(Names.F98_NONTANF_COUNT, FieldType.UnsignedNumeric, 9);
               FDSO98.CreateNewField(Names.F98_TANF_AMOUNT, FieldType.UnsignedNumeric, 11);
               FDSO98.CreateNewField(Names.F98_NONTANF_AMOUNT, FieldType.UnsignedNumeric, 11);
           });
    ...
    internal class SWEXLE88_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE88_ls_LinkageSection";
            ...
            internal const string FDSO_CERTIFICATION_TAPE_0002ET = "FDSO_CERTIFICATION_TAPE_0002ET";
            ...
            internal const string CASE_TYPE_IND_0002AS = "CASE_TYPE_IND_0002AS";
            internal const string CASE_TYPE_IND_0002 = "CASE_TYPE_IND_0002";
            internal const string CASE_TYPE_IND_0002XX = "CASE_TYPE_IND_0002XX";
            internal const string TRANSFER_STATE_0002AS = "TRANSFER_STATE_0002AS";
            internal const string TRANSFER_STATE_0002 = "TRANSFER_STATE_0002";
            internal const string TRANSFER_STATE_0002XX = "TRANSFER_STATE_0002XX";
            internal const string LOCAL_FOR_TRANSFER_0002AS = "LOCAL_FOR_TRANSFER_0002AS";
            internal const string LOCAL_FOR_TRANSFER_0002 = "LOCAL_FOR_TRANSFER_0002";
            internal const string LOCAL_FOR_TRANSFER_0002XX = "LOCAL_FOR_TRANSFER_0002XX";
            internal const string PROCESS_YEAR_0002AS = "PROCESS_YEAR_0002AS";
            internal const string PROCESS_YEAR_0002 = "PROCESS_YEAR_0002";
            internal const string PROCESS_YEAR_0002XX = "PROCESS_YEAR_0002XX";
            internal const string ADDRESS_LINE1_0002AS = "ADDRESS_LINE1_0002AS";
            internal const string ADDRESS_LINE1_0002 = "ADDRESS_LINE1_0002";
            internal const string ADDRESS_LINE1_0002XX = "ADDRESS_LINE1_0002XX";
            internal const string ADDRESS_LINE2_0002AS = "ADDRESS_LINE2_0002AS";
            internal const string ADDRESS_LINE2_0002 = "ADDRESS_LINE2_0002";
            internal const string ADDRESS_LINE2_0002XX = "ADDRESS_LINE2_0002XX";
            ...
            internal const string STATE_CODE_0002AS = "STATE_CODE_0002AS";
            internal const string STATE_CODE_0002 = "STATE_CODE_0002";
            internal const string STATE_CODE_0002XX = "STATE_CODE_0002XX";
            ...
            internal const string OFFSET_EXCLUSION_TYPE_0002AS = "OFFSET_EXCLUSION_TYPE_0002AS";
            internal const string OFFSET_EXCLUSION_TYPE_0002 = "OFFSET_EXCLUSION_TYPE_0002";
            internal const string OFFSET_EXCLUSION_TYPE_0002XX = "OFFSET_EXCLUSION_TYPE_0002XX";
            internal const string ADC_AMOUNT_0002AS = "ADC_AMOUNT_0002AS";
            internal const string ADC_AMOUNT_0002 = "ADC_AMOUNT_0002";
            internal const string ADC_AMOUNT_0002XX = "ADC_AMOUNT_0002XX";
            internal const string NON_ADC_AMOUNT_0002AS = "NON_ADC_AMOUNT_0002AS";
            internal const string NON_ADC_AMOUNT_0002 = "NON_ADC_AMOUNT_0002";
            internal const string NON_ADC_AMOUNT_0002XX = "NON_ADC_AMOUNT_0002XX";
        ...
        public IGroup FDSO_CERTIFICATION_TAPE_0002ET { get { return GetElementByName<IGroup>(Names.FDSO_CERTIFICATION_TAPE_0002ET); } }
        ...
        public IField CASE_TYPE_IND_0002AS { get { return GetElementByName<IField>(Names.CASE_TYPE_IND_0002AS); } }
        public IField CASE_TYPE_IND_0002 { get { return GetElementByName<IField>(Names.CASE_TYPE_IND_0002); } }
        public IField CASE_TYPE_IND_0002XX { get { return GetElementByName<IField>(Names.CASE_TYPE_IND_0002XX); } }
        public IField TRANSFER_STATE_0002AS { get { return GetElementByName<IField>(Names.TRANSFER_STATE_0002AS); } }
        public IField TRANSFER_STATE_0002 { get { return GetElementByName<IField>(Names.TRANSFER_STATE_0002); } }
        public IField TRANSFER_STATE_0002XX { get { return GetElementByName<IField>(Names.TRANSFER_STATE_0002XX); } }
        public IField LOCAL_FOR_TRANSFER_0002AS { get { return GetElementByName<IField>(Names.LOCAL_FOR_TRANSFER_0002AS); } }
        public IField LOCAL_FOR_TRANSFER_0002 { get { return GetElementByName<IField>(Names.LOCAL_FOR_TRANSFER_0002); } }
        public IField LOCAL_FOR_TRANSFER_0002XX { get { return GetElementByName<IField>(Names.LOCAL_FOR_TRANSFER_0002XX); } }
        public IField PROCESS_YEAR_0002AS { get { return GetElementByName<IField>(Names.PROCESS_YEAR_0002AS); } }
        public IField PROCESS_YEAR_0002 { get { return GetElementByName<IField>(Names.PROCESS_YEAR_0002); } }
        public IField PROCESS_YEAR_0002XX { get { return GetElementByName<IField>(Names.PROCESS_YEAR_0002XX); } }
        public IField ADDRESS_LINE1_0002AS { get { return GetElementByName<IField>(Names.ADDRESS_LINE1_0002AS); } }
        public IField ADDRESS_LINE1_0002 { get { return GetElementByName<IField>(Names.ADDRESS_LINE1_0002); } }
        public IField ADDRESS_LINE1_0002XX { get { return GetElementByName<IField>(Names.ADDRESS_LINE1_0002XX); } }
        public IField ADDRESS_LINE2_0002AS { get { return GetElementByName<IField>(Names.ADDRESS_LINE2_0002AS); } }
        public IField ADDRESS_LINE2_0002 { get { return GetElementByName<IField>(Names.ADDRESS_LINE2_0002); } }
        public IField ADDRESS_LINE2_0002XX { get { return GetElementByName<IField>(Names.ADDRESS_LINE2_0002XX); } }
        ...
        public IField STATE_CODE_0002AS { get { return GetElementByName<IField>(Names.STATE_CODE_0002AS); } }
        public IField STATE_CODE_0002 { get { return GetElementByName<IField>(Names.STATE_CODE_0002); } }
        public IField STATE_CODE_0002XX { get { return GetElementByName<IField>(Names.STATE_CODE_0002XX); } }
        ...
        public IField OFFSET_EXCLUSION_TYPE_0002AS { get { return GetElementByName<IField>(Names.OFFSET_EXCLUSION_TYPE_0002AS); } }
        public IField OFFSET_EXCLUSION_TYPE_0002 { get { return GetElementByName<IField>(Names.OFFSET_EXCLUSION_TYPE_0002); } }
        public IField OFFSET_EXCLUSION_TYPE_0002XX { get { return GetElementByName<IField>(Names.OFFSET_EXCLUSION_TYPE_0002XX); } }
        public IField ADC_AMOUNT_0002AS { get { return GetElementByName<IField>(Names.ADC_AMOUNT_0002AS); } }
        public IField ADC_AMOUNT_0002 { get { return GetElementByName<IField>(Names.ADC_AMOUNT_0002); } }
        public IField ADC_AMOUNT_0002XX { get { return GetElementByName<IField>(Names.ADC_AMOUNT_0002XX); } }
        public IField NON_ADC_AMOUNT_0002AS { get { return GetElementByName<IField>(Names.NON_ADC_AMOUNT_0002AS); } }
        public IField NON_ADC_AMOUNT_0002 { get { return GetElementByName<IField>(Names.NON_ADC_AMOUNT_0002); } }
        public IField NON_ADC_AMOUNT_0002XX { get { return GetElementByName<IField>(Names.NON_ADC_AMOUNT_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.FDSO_CERTIFICATION_TAPE_0002ET, (FDSO_CERTIFICATION_TAPE_0002ET) =>
               {
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.SUBMITTING_STATE_0002AS, FieldType.String, 1);

                   IField SUBMITTING_STATE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.SUBMITTING_STATE_0002, FieldType.String, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.SUBMITTING_STATE_0002XX, FieldType.String, SUBMITTING_STATE_0002_local, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.LOCAL_CODE_0002AS, FieldType.String, 1);

                   IField LOCAL_CODE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.LOCAL_CODE_0002, FieldType.String, 3);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.LOCAL_CODE_0002XX, FieldType.String, LOCAL_CODE_0002_local, 3);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.SSN_0002AS, FieldType.String, 1);

                   IField SSN_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.SSN_0002, FieldType.String, 9);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.SSN_0002XX, FieldType.String, SSN_0002_local, 9);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.CASE_NUMBER_0002AS, FieldType.String, 1);

                   IField CASE_NUMBER_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.CASE_NUMBER_0002, FieldType.String, 15);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.CASE_NUMBER_0002XX, FieldType.String, CASE_NUMBER_0002_local, 15);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.LAST_NAME_0002AS, FieldType.String, 1);

                   IField LAST_NAME_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.LAST_NAME_0002, FieldType.String, 20);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.LAST_NAME_0002XX, FieldType.String, LAST_NAME_0002_local, 20);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.FIRST_NAME_0002AS, FieldType.String, 1);

                   IField FIRST_NAME_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.FIRST_NAME_0002, FieldType.String, 15);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.FIRST_NAME_0002XX, FieldType.String, FIRST_NAME_0002_local, 15);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.TRANSACTION_TYPE_0002AS, FieldType.String, 1);

                   IField TRANSACTION_TYPE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.TRANSACTION_TYPE_0002, FieldType.String, 1);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.TRANSACTION_TYPE_0002XX, FieldType.String, TRANSACTION_TYPE_0002_local, 1);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.CASE_TYPE_IND_0002AS, FieldType.String, 1);

                   IField CASE_TYPE_IND_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.CASE_TYPE_IND_0002, FieldType.String, 1);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.CASE_TYPE_IND_0002XX, FieldType.String, CASE_TYPE_IND_0002_local, 1);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.TRANSFER_STATE_0002AS, FieldType.String, 1);

                   IField TRANSFER_STATE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.TRANSFER_STATE_0002, FieldType.String, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.TRANSFER_STATE_0002XX, FieldType.String, TRANSFER_STATE_0002_local, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.LOCAL_FOR_TRANSFER_0002AS, FieldType.String, 1);

                   IField LOCAL_FOR_TRANSFER_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.LOCAL_FOR_TRANSFER_0002, FieldType.SignedNumeric, 3);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.LOCAL_FOR_TRANSFER_0002XX, FieldType.String, LOCAL_FOR_TRANSFER_0002_local, 3);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.PROCESS_YEAR_0002AS, FieldType.String, 1);

                   IField PROCESS_YEAR_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.PROCESS_YEAR_0002, FieldType.String, 4);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.PROCESS_YEAR_0002XX, FieldType.String, PROCESS_YEAR_0002_local, 4);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ADDRESS_LINE1_0002AS, FieldType.String, 1);

                   IField ADDRESS_LINE1_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ADDRESS_LINE1_0002, FieldType.String, 30);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.ADDRESS_LINE1_0002XX, FieldType.String, ADDRESS_LINE1_0002_local, 30);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ADDRESS_LINE2_0002AS, FieldType.String, 1);

                   IField ADDRESS_LINE2_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ADDRESS_LINE2_0002, FieldType.String, 30);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.ADDRESS_LINE2_0002XX, FieldType.String, ADDRESS_LINE2_0002_local, 30);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.CITY_0002AS, FieldType.String, 1);

                   IField CITY_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.CITY_0002, FieldType.String, 25);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.CITY_0002XX, FieldType.String, CITY_0002_local, 25);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.STATE_CODE_0002AS, FieldType.String, 1);

                   IField STATE_CODE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.STATE_CODE_0002, FieldType.String, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.STATE_CODE_0002XX, FieldType.String, STATE_CODE_0002_local, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ZIP_CODE_0002AS, FieldType.String, 1);

                   IField ZIP_CODE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ZIP_CODE_0002, FieldType.String, 9);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.ZIP_CODE_0002XX, FieldType.String, ZIP_CODE_0002_local, 9);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.OFFSET_EXCLUSION_TYPE_0002AS, FieldType.String, 1);

                   IField OFFSET_EXCLUSION_TYPE_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.OFFSET_EXCLUSION_TYPE_0002, FieldType.String, 40);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.OFFSET_EXCLUSION_TYPE_0002XX, FieldType.String, OFFSET_EXCLUSION_TYPE_0002_local, 40);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ADC_AMOUNT_0002AS, FieldType.String, 1);

                   IField ADC_AMOUNT_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.ADC_AMOUNT_0002, FieldType.SignedNumeric, 9, null, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.ADC_AMOUNT_0002XX, FieldType.String, ADC_AMOUNT_0002_local, 9);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.NON_ADC_AMOUNT_0002AS, FieldType.String, 1);

                   IField NON_ADC_AMOUNT_0002_local = FDSO_CERTIFICATION_TAPE_0002ET.CreateNewField(Names.NON_ADC_AMOUNT_0002, FieldType.SignedNumeric, 9, null, 2);
                   FDSO_CERTIFICATION_TAPE_0002ET.CreateNewFieldRedefine(Names.NON_ADC_AMOUNT_0002XX, FieldType.String, NON_ADC_AMOUNT_0002_local, 9);
               });
           });
    ...
    public class SWEXLE88 : EABBase
    {
        ...
        public SWEXLE88()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE88");

            WS = new SWEXLE88_ws();
            FD = new SWEXLE88_fd(WS);
            LS = new SWEXLE88_ls();
        }
        ...
        private SWEXLE88_ws WS;

        //==== File Data Class ========================================
        private SWEXLE88_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE88_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0967638493(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0967638493
        /// </summary>
        private void M_MAIN_0967638493(string returnMethod = "")
        {
            M_PARA_0967638493_INIT("M_PARA_0967638493_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0967638493-INIT THRU PARA-0967638493-INIT-EXIT
            M_PARA_0967638493("M_PARA_0967638493_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0967638493 THRU PARA-0967638493-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0967638493
        /// </summary>
        private void M_PARA_0967638493(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: *************************************************************
            //COMMENT:     SWEXLE96 - THIS CODE IS PART OF SWEXLE88,WRITE FDSO RECORDS
            //COMMENT:     TO A OUTPUT FILE.
            //COMMENT: *************************************************************
        ...
        {
            //COMMENT: *************************
            WS.F99_SUBMITTING_STATE.SetValue(LS.SUBMITTING_STATE_0002);                                         //COBOL==> MOVE SUBMITTING-STATE-0002 TO F99-SUBMITTING-STATE
            WS.F99_LOCAL_CODE.SetValue(LS.LOCAL_CODE_0002);                                                     //COBOL==> MOVE LOCAL-CODE-0002 TO F99-LOCAL-CODE
            WS.F99_SSN.SetValue(LS.SSN_0002);                                                                   //COBOL==> MOVE SSN-0002 TO F99-SSN
            WS.F99_CASE_NUMBER.SetValue(LS.CASE_NUMBER_0002);                                                   //COBOL==> MOVE CASE-NUMBER-0002 TO F99-CASE-NUMBER
            WS.F99_LAST_NAME.SetValue(LS.LAST_NAME_0002);                                                       //COBOL==> MOVE LAST-NAME-0002 TO F99-LAST-NAME
            WS.F99_FIRST_NAME.SetValue(LS.FIRST_NAME_0002);                                                     //COBOL==> MOVE FIRST-NAME-0002 TO F99-FIRST-NAME
            WS.F99_TRANS_TYPE.SetValue(LS.TRANSACTION_TYPE_0002);                                               //COBOL==> MOVE TRANSACTION-TYPE-0002 TO F99-TRANS-TYPE
            WS.F99_TRANSFER_STATE.SetValue(LS.TRANSFER_STATE_0002);                                             //COBOL==> MOVE TRANSFER-STATE-0002 TO F99-TRANSFER-STATE
            WS.F99_LOCAL_FOR_TRANSFER.SetValue(LS.LOCAL_FOR_TRANSFER_0002);                                     //COBOL==> MOVE LOCAL-FOR-TRANSFER-0002 TO F99-LOCAL-FOR-TRANSFER
            WS.F99_PROCESS_YEAR.SetValue(LS.PROCESS_YEAR_0002);                                                 //COBOL==> MOVE PROCESS-YEAR-0002 TO F99-PROCESS-YEAR
            WS.F99_ADDRESS_LINE1.SetValue(LS.ADDRESS_LINE1_0002);                                               //COBOL==> MOVE ADDRESS-LINE1-0002 TO F99-ADDRESS-LINE1
            WS.F99_ADDRESS_LINE2.SetValue(LS.ADDRESS_LINE2_0002);                                               //COBOL==> MOVE ADDRESS-LINE2-0002 TO F99-ADDRESS-LINE2
            WS.F99_CITY.SetValue(LS.CITY_0002);                                                                 //COBOL==> MOVE CITY-0002 TO F99-CITY
            WS.F99_STATE_CODE.SetValue(LS.STATE_CODE_0002);                                                     //COBOL==> MOVE STATE-CODE-0002 TO F99-STATE-CODE
            WS.F99_ZIP.SetValue(LS.ZIP_CODE_0002);                                                              //COBOL==> MOVE ZIP-CODE-0002 TO F99-ZIP
            WS.F99_OFFSET_EXCLUSION.SetValue(LS.OFFSET_EXCLUSION_TYPE_0002);                                    //COBOL==> MOVE OFFSET-EXCLUSION-TYPE-0002 TO F99-OFFSET-EXCLUSION
            if ((LS.CASE_TYPE_IND_0002.IsEqualTo("A"))
             || (LS.CASE_TYPE_IND_0002.IsEqualTo("B")))  //COBOL==> IF CASE-TYPE-IND-0002 = 'A' OR CASE-TYPE-IND-0002 = 'B'
            {
                WS.F99_CASE_TYPE.SetValue("A");                                                                     //COBOL==> MOVE 'A' TO F99-CASE-TYPE
                WS.F99_AMOUNT_OWED.SetValue(LS.ADC_AMOUNT_0002);                                                    //COBOL==> MOVE ADC-AMOUNT-0002 TO F99-AMOUNT-OWED
                FD.OUTFILE_REC.SetValue(WS.FDSO99);                                                                 //COBOL==> MOVE FDSO99 TO OUTFILE-REC
                FD.OUTFILE.WriteLine(FD.OUTFILE_REC.AsBytes);                                                       //COBOL==> WRITE OUTFILE-REC
                                                                                                                    // EvaluateList !WS.FILE_STATUS!                                                                    //COBOL==> EVALUATE FILE-STATUS
                if ((WS.FILE_STATUS.IsEqualTo("00")))                                                               //COBOL==> WHEN '00'
                {
                    WS.F98_TANF_COUNT.Add(1);                                                                           //COBOL==> ADD 1 TO F98-TANF-COUNT
                    WS.F98_TANF_AMOUNT.Add(WS.F99_AMOUNT_OWED.AsDecimal());                                             //COBOL==> ADD F99-AMOUNT-OWED TO F98-TANF-AMOUNT
                }                                                                                                //COBOL==> WHEN OTHER
                else
                {
                    LS.STATUS_0003.SetValue("BR");                                                                      //COBOL==> MOVE 'BR' TO STATUS-0003
                }                                                                                                   //COBOL==> END-EVALUATE
                                                                                                                    //COMMENT:        DISPLAY 'AP NBR: '  CASE-NUMBER-0002
                                                                                                                    //COMMENT:        DISPLAY 'ADC > 0, ADC AMOUNT :' ADC-AMOUNT-0002XX
            }                                                                                                   //COBOL==> END-IF
            if ((LS.CASE_TYPE_IND_0002.IsEqualTo("N"))
             || (LS.CASE_TYPE_IND_0002.IsEqualTo("B")))  //COBOL==> IF CASE-TYPE-IND-0002 = 'N' OR CASE-TYPE-IND-0002 = 'B'
            {
                WS.F99_CASE_TYPE.SetValue("N");                                                                     //COBOL==> MOVE 'N' TO F99-CASE-TYPE
                WS.F99_AMOUNT_OWED.SetValue(LS.NON_ADC_AMOUNT_0002);                                                //COBOL==> MOVE NON-ADC-AMOUNT-0002 TO F99-AMOUNT-OWED
                FD.OUTFILE_REC.SetValue(WS.FDSO99);                                                                 //COBOL==> MOVE FDSO99 TO OUTFILE-REC
                FD.OUTFILE.WriteLine(FD.OUTFILE_REC.AsBytes);                                                       //COBOL==> WRITE OUTFILE-REC
                                                                                                                    // EvaluateList !WS.FILE_STATUS!                                                                    //COBOL==> EVALUATE FILE-STATUS
                if ((WS.FILE_STATUS.IsEqualTo("00")))                                                               //COBOL==> WHEN '00'
                {
                    WS.F98_NONTANF_COUNT.Add(1);                                                                        //COBOL==> ADD 1 TO F98-NONTANF-COUNT
                    WS.F98_NONTANF_AMOUNT.Add(WS.F99_AMOUNT_OWED.AsDecimal());                                          //COBOL==> ADD F99-AMOUNT-OWED TO F98-NONTANF-AMOUNT
                }                                                                                                //COBOL==> WHEN OTHER
                else
                {
                    LS.STATUS_0003.SetValue("BR");                                                                      //COBOL==> MOVE 'BR' TO STATUS-0003
                                                                                                                    ...
                                                                                                                    //COMMENT:        DISPLAY 'AP NBR: '  CASE-NUMBER-0002
                                                                                                                    //COMMENT:        DISPLAY 'NADC > 0, NADC AMOUNT :' NON-ADC-AMOUNT-0002XX
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT: *************************
            WS.F98_SUBMITTING_STATE.SetValue("KS");                                                             //COBOL==> MOVE 'KS' TO F98-SUBMITTING-STATE
            WS.F98_CONTROL.SetValue("CTL");                                                                     //COBOL==> MOVE 'CTL' TO F98-CONTROL
            FD.OUTFILE_REC.SetValue(WS.FDSO98);                                                                 //COBOL==> MOVE FDSO98 TO OUTFILE-REC
            FD.OUTFILE.WriteLine(FD.OUTFILE_REC.AsBytes);                                                       //COBOL==> WRITE OUTFILE-REC
                                                                                                                // EvaluateList !WS.FILE_STATUS!                                                                    //COBOL==> EVALUATE FILE-STATUS
            if ((WS.FILE_STATUS.IsEqualTo("00")))                                                               //COBOL==> WHEN '00'
            {
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_0967638493_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0967638493_EXIT
        /// </summary>
        private void M_PARA_0967638493_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0967638493_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0967638493_EXIT") { M_PARA_0967638493_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0967638493_INIT
        /// </summary>
        private void M_PARA_0967638493_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0967638493_INIT") { M_PARA_0967638493_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0967638493_INIT_EXIT
        /// </summary>
        private void M_PARA_0967638493_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0967638493_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
