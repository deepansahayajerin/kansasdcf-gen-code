...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:26 PM
   **        *   FROM COBOL PGM   :  SWEXEW05
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_REQUEST_TO_KDWP           DATE: 2007/04/04
       TARGET OS:   MVS                       TIME: 10:34:11
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW05_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW05_fd_FileSection";
            internal const string KDWPOUT = "KDWPOUT";
            internal const string KDWPOUT_RECORD = "KDWPOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink KDWPOUT { get; set; }
        public IField KDWPOUT_RECORD { get { return GetElementByName<IField>(Names.KDWPOUT_RECORD); } }


        internal SWEXEW05_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.KDWPOUT_RECORD, FieldType.String, 920);
        ...
        public override void Initialize()
        {
            ...
            KDWPOUT = FileHandler.GetFile("KDWPOUT");
            KDWPOUT.StatusField = WS.KDWPOUT_STAT;
            KDWPOUT.AssociatedBuffer = KDWPOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW05_fd(SWEXEW05_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW05_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW05_ws_WorkingStorage";
            internal const string KDWPOUT_STAT = "KDWPOUT_STAT";
            ...
            internal const string WS_KDWPOUT = "WS_KDWPOUT";
            ...
            internal const string ALIAS_IND = "ALIAS_IND";
        }
        #endregion

        #region Direct-access element properties
        public IField KDWPOUT_STAT { get { return GetExternalElementByName<IField>(Names.KDWPOUT_STAT); } }
        ...
        public IGroup WS_KDWPOUT { get { return GetElementByName<IGroup>(Names.WS_KDWPOUT); } }
        ...
        public IField ALIAS_IND { get { return GetElementByName<IField>(Names.ALIAS_IND); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.KDWPOUT_STAT, FieldType.UnsignedNumeric, 2);
            ...
            recordDef.CreateNewGroup(Names.WS_MISC, (WS_MISC) =>
           {
            ...
            recordDef.CreateNewGroup(Names.WS_KDWPOUT, (WS_KDWPOUT) =>
           {
               WS_KDWPOUT.CreateNewField(Names.CSE_PERSON_NUMBER, FieldType.String, 10);
               WS_KDWPOUT.CreateNewField(Names.LAST_NAME, FieldType.String, 30);
               WS_KDWPOUT.CreateNewField(Names.FIRST_NAME, FieldType.String, 16);
               WS_KDWPOUT.CreateNewField(Names.MIDDLE_NAME, FieldType.String, 16);
               WS_KDWPOUT.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_KDWPOUT.CreateNewField(Names.DOB, FieldType.String, 8);
               WS_KDWPOUT.CreateNewField(Names.ALIAS_IND, FieldType.String, 1);
               WS_KDWPOUT.CreateNewFillerField(830, FillWith.Hashes);
           });
    ...
    internal class SWEXEW05_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW05_ls_LinkageSection";
            ...
            internal const string KDWP_OUTPUT_0002ET = "KDWP_OUTPUT_0002ET";
            ...
            internal const string MIDDLE_NAME_0002AS = "MIDDLE_NAME_0002AS";
            internal const string MIDDLE_NAME_0002 = "MIDDLE_NAME_0002";
            internal const string MIDDLE_NAME_0002XX = "MIDDLE_NAME_0002XX";
            ...
            internal const string ALIAS_IND_0002AS = "ALIAS_IND_0002AS";
            internal const string ALIAS_IND_0002 = "ALIAS_IND_0002";
            internal const string ALIAS_IND_0002XX = "ALIAS_IND_0002XX";
        ...
        public IGroup KDWP_OUTPUT_0002ET { get { return GetElementByName<IGroup>(Names.KDWP_OUTPUT_0002ET); } }
        ...
        public IField MIDDLE_NAME_0002AS { get { return GetElementByName<IField>(Names.MIDDLE_NAME_0002AS); } }
        public IField MIDDLE_NAME_0002 { get { return GetElementByName<IField>(Names.MIDDLE_NAME_0002); } }
        public IField MIDDLE_NAME_0002XX { get { return GetElementByName<IField>(Names.MIDDLE_NAME_0002XX); } }
        ...
        public IField ALIAS_IND_0002AS { get { return GetElementByName<IField>(Names.ALIAS_IND_0002AS); } }
        public IField ALIAS_IND_0002 { get { return GetElementByName<IField>(Names.ALIAS_IND_0002); } }
        public IField ALIAS_IND_0002XX { get { return GetElementByName<IField>(Names.ALIAS_IND_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.KDWP_OUTPUT_0002ET, (KDWP_OUTPUT_0002ET) =>
               {
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.CSE_PERSON_NUMBER_0002AS, FieldType.String, 1);

                   IField CSE_PERSON_NUMBER_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.CSE_PERSON_NUMBER_0002, FieldType.String, 10);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.CSE_PERSON_NUMBER_0002XX, FieldType.String, CSE_PERSON_NUMBER_0002_local, 10);
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.LAST_NAME_0002AS, FieldType.String, 1);

                   IField LAST_NAME_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.LAST_NAME_0002, FieldType.String, 30);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.LAST_NAME_0002XX, FieldType.String, LAST_NAME_0002_local, 30);
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.FIRST_NAME_0002AS, FieldType.String, 1);

                   IField FIRST_NAME_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.FIRST_NAME_0002, FieldType.String, 16);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.FIRST_NAME_0002XX, FieldType.String, FIRST_NAME_0002_local, 16);
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.MIDDLE_NAME_0002AS, FieldType.String, 1);

                   IField MIDDLE_NAME_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.MIDDLE_NAME_0002, FieldType.String, 16);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.MIDDLE_NAME_0002XX, FieldType.String, MIDDLE_NAME_0002_local, 16);
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.SSN_0002AS, FieldType.String, 1);

                   IField SSN_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.SSN_0002, FieldType.String, 9);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.SSN_0002XX, FieldType.String, SSN_0002_local, 9);
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.DOB_0002AS, FieldType.String, 1);

                   IField DOB_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.DOB_0002, FieldType.String, 8);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.DOB_0002XX, FieldType.String, DOB_0002_local, 8);
                   KDWP_OUTPUT_0002ET.CreateNewField(Names.ALIAS_IND_0002AS, FieldType.String, 1);

                   IField ALIAS_IND_0002_local = KDWP_OUTPUT_0002ET.CreateNewField(Names.ALIAS_IND_0002, FieldType.String, 1);
                   KDWP_OUTPUT_0002ET.CreateNewFieldRedefine(Names.ALIAS_IND_0002XX, FieldType.String, ALIAS_IND_0002_local, 1);
               });
           });
    ...
    public class SWEXEW05 : EABBase
    {
        ...
        public SWEXEW05()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW05");

            WS = new SWEXEW05_ws();
            FD = new SWEXEW05_fd(WS);
            LS = new SWEXEW05_ls();
        }
        ...
        private SWEXEW05_ws WS;

        //==== File Data Class ========================================
        private SWEXEW05_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW05_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230571164(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230571164
        /// </summary>
        private void M_MAIN_1230571164(string returnMethod = "")
        {
            M_PARA_1230571164_INIT("M_PARA_1230571164_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230571164-INIT THRU PARA-1230571164-INIT-EXIT
            M_PARA_1230571164("M_PARA_1230571164_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230571164 THRU PARA-1230571164-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230571164
        /// </summary>
        private void M_PARA_1230571164(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE68 IS A PART OF SWEXEW05*
            //COMMENT: ******************************************
        ...
        {
            FD.KDWPOUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT KDWPOUT.
            if (!(WS.KDWPOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDWPOUT-STAT NOT = 00
            {
                ...
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDWPOUT_STAT);                                              //COBOL==> MOVE KDWPOUT-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.KDWPOUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO KDWPOUT-RECORD.
            FD.KDWPOUT_RECORD.SetValue(WS.WS_KDWPOUT);                                                          //COBOL==> MOVE WS-KDWPOUT TO KDWPOUT-RECORD.
            FD.KDWPOUT.WriteLine(FD.KDWPOUT_RECORD.AsBytes);                                                    //COBOL==> WRITE KDWPOUT-RECORD.
            if (!(WS.KDWPOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDWPOUT-STAT NOT = 00
            {
        ...
        {
            FD.KDWPOUT.CloseFile();                                                                             //COBOL==> CLOSE KDWPOUT.
            if (!(WS.KDWPOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF KDWPOUT-STAT NOT = 00
            {
        ...
        {
            WS.WS_KDWPOUT.SetValueWithSpaces();                                                                 //COBOL==> MOVE SPACES TO WS-KDWPOUT
            ...
            WS.MIDDLE_NAME.SetValue(LS.MIDDLE_NAME_0002);                                                       //COBOL==> MOVE MIDDLE-NAME-0002 TO MIDDLE-NAME
            WS.ALIAS_IND.SetValue(LS.ALIAS_IND_0002);                                                           //COBOL==> MOVE ALIAS-IND-0002 TO ALIAS-IND
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230571164_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230571164_EXIT
        /// </summary>
        private void M_PARA_1230571164_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230571164_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230571164_EXIT") { M_PARA_1230571164_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230571164_INIT
        /// </summary>
        private void M_PARA_1230571164_INIT(string returnMethod = "")
        {
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1230571164_INIT") { M_PARA_1230571164_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230571164_INIT_EXIT
        /// </summary>
        private void M_PARA_1230571164_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230571164_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
