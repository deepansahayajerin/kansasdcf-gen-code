...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:42 PM
   **        *   FROM COBOL PGM   :  SWEXEW16
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: FN_EAB_B608_WRITE_ERROR          DATE: 2012/11/28
       TARGET OS:   MVS                       TIME: 08:17:02
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW16_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW16_fd_FileSection";
            internal const string AERROUT = "AERROUT";
            internal const string AERROUT_RECORD = "AERROUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink AERROUT { get; set; }
        public IField AERROUT_RECORD { get { return GetElementByName<IField>(Names.AERROUT_RECORD); } }


        internal SWEXEW16_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.AERROUT_RECORD, FieldType.String, 222);
        ...
        public override void Initialize()
        {
            ...
            AERROUT = FileHandler.GetFile("AERROUT");
            AERROUT.StatusField = WS.AERROUT_STAT;
            AERROUT.AssociatedBuffer = AERROUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW16_fd(SWEXEW16_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW16_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW16_ws_WorkingStorage";
            internal const string AERROUT_STAT = "AERROUT_STAT";
            ...
            internal const string WS_AERROUT = "WS_AERROUT";
            ...
            internal const string MIDDLE_INITIAL = "MIDDLE_INITIAL";
            internal const string OFFICE_NAME = "OFFICE_NAME";
            internal const string REGION_NAME = "REGION_NAME";
            internal const string RPT_DETAIL = "RPT_DETAIL";
        }
        #endregion

        #region Direct-access element properties
        public IField AERROUT_STAT { get { return GetExternalElementByName<IField>(Names.AERROUT_STAT); } }
        ...
        public IGroup WS_AERROUT { get { return GetElementByName<IGroup>(Names.WS_AERROUT); } }
        ...
        public IField MIDDLE_INITIAL { get { return GetElementByName<IField>(Names.MIDDLE_INITIAL); } }
        public IField OFFICE_NAME { get { return GetElementByName<IField>(Names.OFFICE_NAME); } }
        public IField REGION_NAME { get { return GetElementByName<IField>(Names.REGION_NAME); } }
        public IField RPT_DETAIL { get { return GetElementByName<IField>(Names.RPT_DETAIL); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.AERROUT_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW16 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_AERROUT, (WS_AERROUT) =>
           {
               WS_AERROUT.CreateNewField(Names.CASE_NUMBER, FieldType.String, 10);
               WS_AERROUT.CreateNewField(Names.LAST_NAME, FieldType.String, 17);
               WS_AERROUT.CreateNewField(Names.FIRST_NAME, FieldType.String, 12);
               WS_AERROUT.CreateNewField(Names.MIDDLE_INITIAL, FieldType.String, 1);
               WS_AERROUT.CreateNewField(Names.OFFICE_NAME, FieldType.String, 30);
               WS_AERROUT.CreateNewField(Names.REGION_NAME, FieldType.String, 20);
               WS_AERROUT.CreateNewField(Names.RPT_DETAIL, FieldType.String, 132);
           });
    ...
    internal class SWEXEW16_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW16_ls_LinkageSection";
            ...
            internal const string IMPORT_REGION_0005EV = "IMPORT_REGION_0005EV";
            internal const string CSE_ORGANIZATION_0005ET = "CSE_ORGANIZATION_0005ET";
            internal const string NAME_0005AS = "NAME_0005AS";
            internal const string NAME_0005 = "NAME_0005";
            internal const string NAME_0005XX = "NAME_0005XX";
            internal const string IMPORT_0006EV = "IMPORT_0006EV";
            internal const string EAB_REPORT_SEND_0006ET = "EAB_REPORT_SEND_0006ET";
            internal const string RPT_DETAIL_0006AS = "RPT_DETAIL_0006AS";
            internal const string RPT_DETAIL_0006 = "RPT_DETAIL_0006";
            internal const string RPT_DETAIL_0006XX = "RPT_DETAIL_0006XX";
        ...
        public IGroup IMPORT_REGION_0005EV { get { return GetElementByName<IGroup>(Names.IMPORT_REGION_0005EV); } }
        public IGroup CSE_ORGANIZATION_0005ET { get { return GetElementByName<IGroup>(Names.CSE_ORGANIZATION_0005ET); } }
        public IField NAME_0005AS { get { return GetElementByName<IField>(Names.NAME_0005AS); } }
        public IField NAME_0005 { get { return GetElementByName<IField>(Names.NAME_0005); } }
        public IField NAME_0005XX { get { return GetElementByName<IField>(Names.NAME_0005XX); } }
        public IGroup IMPORT_0006EV { get { return GetElementByName<IGroup>(Names.IMPORT_0006EV); } }
        public IGroup EAB_REPORT_SEND_0006ET { get { return GetElementByName<IGroup>(Names.EAB_REPORT_SEND_0006ET); } }
        public IField RPT_DETAIL_0006AS { get { return GetElementByName<IField>(Names.RPT_DETAIL_0006AS); } }
        public IField RPT_DETAIL_0006 { get { return GetElementByName<IField>(Names.RPT_DETAIL_0006); } }
        public IField RPT_DETAIL_0006XX { get { return GetElementByName<IField>(Names.RPT_DETAIL_0006XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0004EV.CreateNewGroup(Names.OFFICE_0004ET, (OFFICE_0004ET) =>
               {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_REGION_0005EV, (IMPORT_REGION_0005EV) =>
           {
               IMPORT_REGION_0005EV.CreateNewGroup(Names.CSE_ORGANIZATION_0005ET, (CSE_ORGANIZATION_0005ET) =>
               {
                   CSE_ORGANIZATION_0005ET.CreateNewField(Names.NAME_0005AS, FieldType.String, 1);

                   IField NAME_0005_local = CSE_ORGANIZATION_0005ET.CreateNewField(Names.NAME_0005, FieldType.String, 20);
                   CSE_ORGANIZATION_0005ET.CreateNewFieldRedefine(Names.NAME_0005XX, FieldType.String, NAME_0005_local, 20);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0006EV, (IMPORT_0006EV) =>
           {
               IMPORT_0006EV.CreateNewGroup(Names.EAB_REPORT_SEND_0006ET, (EAB_REPORT_SEND_0006ET) =>
               {
                   EAB_REPORT_SEND_0006ET.CreateNewField(Names.RPT_DETAIL_0006AS, FieldType.String, 1);

                   IField RPT_DETAIL_0006_local = EAB_REPORT_SEND_0006ET.CreateNewField(Names.RPT_DETAIL_0006, FieldType.String, 132);
                   EAB_REPORT_SEND_0006ET.CreateNewFieldRedefine(Names.RPT_DETAIL_0006XX, FieldType.String, RPT_DETAIL_0006_local, 132);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_REGION_0005EV, args, 7);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_REGION_0005EV, args, 7);
    ...
    public class SWEXEW16 : EABBase
    {
        ...
        public SWEXEW16()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW16");

            WS = new SWEXEW16_ws();
            FD = new SWEXEW16_fd(WS);
            LS = new SWEXEW16_ls();
        }
        ...
        private SWEXEW16_ws WS;

        //==== File Data Class ========================================
        private SWEXEW16_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW16_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-0003EV , IMPORT-0004EV , IMPORT-REGION-0005EV , IMPORT-0006EV , EXPORT-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1266563784(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1266563784
        /// </summary>
        private void M_MAIN_1266563784(string returnMethod = "")
        {
            M_PARA_1266563784_INIT("M_PARA_1266563784_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1266563784-INIT THRU PARA-1266563784-INIT-EXIT
            M_PARA_1266563784("M_PARA_1266563784_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1266563784 THRU PARA-1266563784-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1266563784
        /// </summary>
        private void M_PARA_1266563784(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF39 IS A PART OF SWEXEW16*
            //COMMENT: ******************************************
        ...
        {
            FD.AERROUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT AERROUT.
            if (!(WS.AERROUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF AERROUT-STAT NOT = 00
            {
                ...
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.AERROUT_STAT);                                              //COBOL==> MOVE AERROUT-STAT TO NUMERIC-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.AERROUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO AERROUT-RECORD.
            FD.AERROUT_RECORD.SetValue(WS.WS_AERROUT);                                                          //COBOL==> MOVE WS-AERROUT TO AERROUT-RECORD.
            FD.AERROUT.WriteLine(FD.AERROUT_RECORD.AsBytes);                                                    //COBOL==> WRITE AERROUT-RECORD.
            if (!(WS.AERROUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF AERROUT-STAT NOT = 00
            {
        ...
        {
            FD.AERROUT.CloseFile();                                                                             //COBOL==> CLOSE AERROUT
            if (!(WS.AERROUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF AERROUT-STAT NOT = 00
            {
        ...
        {
            //COMMENT:       MOVE SPACES TO WS-AERROUT
            WS.CASE_NUMBER.SetValue(LS.NUMBER_0002);                                                            //COBOL==> MOVE NUMBER-0002 TO CASE-NUMBER
            ...
            WS.MIDDLE_INITIAL.SetValue(LS.MIDDLE_INITIAL_0003);                                                 //COBOL==> MOVE MIDDLE-INITIAL-0003 TO MIDDLE-INITIAL
            WS.OFFICE_NAME.SetValue(LS.NAME_0004);                                                              //COBOL==> MOVE NAME-0004 TO OFFICE-NAME
            WS.REGION_NAME.SetValue(LS.NAME_0005);                                                              //COBOL==> MOVE NAME-0005 TO REGION-NAME
            WS.RPT_DETAIL.SetValue(LS.RPT_DETAIL_0006);                                                         //COBOL==> MOVE RPT-DETAIL-0006 TO RPT-DETAIL
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1266563784_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266563784_EXIT
        /// </summary>
        private void M_PARA_1266563784_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266563784_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1266563784_EXIT") { M_PARA_1266563784_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266563784_INIT
        /// </summary>
        private void M_PARA_1266563784_INIT(string returnMethod = "")
        {
            LS.EXPORT_0007EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1266563784_INIT") { M_PARA_1266563784_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266563784_INIT_EXIT
        /// </summary>
        private void M_PARA_1266563784_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266563784_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
