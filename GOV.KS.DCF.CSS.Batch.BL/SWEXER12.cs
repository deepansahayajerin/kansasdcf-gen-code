...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:42 PM
   **        *   FROM COBOL PGM   :  SWEXER12
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_RESTRICT_CONFIRM_DENIED   DATE: 2008/08/28
       TARGET OS:   MVS                       TIME: 09:01:21
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXER12_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER12_fd_FileSection";
            internal const string KDORIN = "KDORIN";
            internal const string KDORIN_RECORD = "KDORIN_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink KDORIN { get; set; }
        public IField KDORIN_RECORD { get { return GetElementByName<IField>(Names.KDORIN_RECORD); } }


        internal SWEXER12_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.KDORIN_RECORD, FieldType.String, 250);
        ...
        public override void Initialize()
        {
            ...
            KDORIN = FileHandler.GetFile("KDORIN");
            KDORIN.StatusField = WS.KDORIN_STAT;
            KDORIN.AssociatedBuffer = KDORIN_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXER12_fd(SWEXER12_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER12_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER12_ws_WorkingStorage";
            internal const string KDORIN_STAT = "KDORIN_STAT";
            ...
            internal const string WS_KDORIN = "WS_KDORIN";
            internal const string FILE_TYPE = "FILE_TYPE";
            ...
            internal const string DRIVER_LICENSE_NUM = "DRIVER_LICENSE_NUM";
            internal const string PROCESS_DATE = "PROCESS_DATE";
            internal const string DENIAL_REASON = "DENIAL_REASON";
        }
        #endregion

        #region Direct-access element properties
        public IField KDORIN_STAT { get { return GetExternalElementByName<IField>(Names.KDORIN_STAT); } }
        ...
        public IGroup WS_KDORIN { get { return GetElementByName<IGroup>(Names.WS_KDORIN); } }
        public IField FILE_TYPE { get { return GetElementByName<IField>(Names.FILE_TYPE); } }
        ...
        public IField DOB { get { return GetElementByName<IField>(Names.DOB); } }
        public IField CSE_PERSON_NUMBER { get { return GetElementByName<IField>(Names.CSE_PERSON_NUMBER); } }
        public IField DRIVER_LICENSE_NUM { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUM); } }
        public IField PROCESS_DATE { get { return GetElementByName<IField>(Names.PROCESS_DATE); } }
        public IField DENIAL_REASON { get { return GetElementByName<IField>(Names.DENIAL_REASON); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.KDORIN_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW12 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_KDORIN, (WS_KDORIN) =>
           {
               WS_KDORIN.CreateNewField(Names.FILE_TYPE, FieldType.String, 1);
               WS_KDORIN.CreateNewField(Names.LAST_NAME, FieldType.String, 17);
               WS_KDORIN.CreateNewField(Names.FIRST_NAME, FieldType.String, 12);
               WS_KDORIN.CreateNewField(Names.SSN, FieldType.String, 9);
               WS_KDORIN.CreateNewField(Names.DOB, FieldType.String, 8);
               WS_KDORIN.CreateNewField(Names.CSE_PERSON_NUMBER, FieldType.String, 10);
               WS_KDORIN.CreateNewField(Names.DRIVER_LICENSE_NUM, FieldType.String, 9);
               WS_KDORIN.CreateNewField(Names.PROCESS_DATE, FieldType.String, 8);
               WS_KDORIN.CreateNewField(Names.DENIAL_REASON, FieldType.String, 37);
               WS_KDORIN.CreateNewFillerField(139, FillWith.Hashes);
           });
    ...
    internal class SWEXER12_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER12_ls_LinkageSection";
            ...
            internal const string KDMV_FILE_0003ET = "KDMV_FILE_0003ET";
            ...
            internal const string FILE_TYPE_0003AS = "FILE_TYPE_0003AS";
            internal const string FILE_TYPE_0003 = "FILE_TYPE_0003";
            internal const string FILE_TYPE_0003XX = "FILE_TYPE_0003XX";
            ...
            internal const string DRIVER_LICENSE_NUMBER_0003AS = "DRIVER_LICENSE_NUMBER_0003AS";
            internal const string DRIVER_LICENSE_NUMBER_0003 = "DRIVER_LICENSE_NUMBER_0003";
            internal const string DRIVER_LICENSE_NUMBER_0003XX = "DRIVER_LICENSE_NUMBER_0003XX";
            internal const string DMV_PROBLEM_TEXT_0003AS = "DMV_PROBLEM_TEXT_0003AS";
            internal const string DMV_PROBLEM_TEXT_0003 = "DMV_PROBLEM_TEXT_0003";
            internal const string DMV_PROBLEM_TEXT_0003XX = "DMV_PROBLEM_TEXT_0003XX";
        ...
        public IGroup KDMV_FILE_0003ET { get { return GetElementByName<IGroup>(Names.KDMV_FILE_0003ET); } }
        ...
        public IField FILE_TYPE_0003AS { get { return GetElementByName<IField>(Names.FILE_TYPE_0003AS); } }
        public IField FILE_TYPE_0003 { get { return GetElementByName<IField>(Names.FILE_TYPE_0003); } }
        public IField FILE_TYPE_0003XX { get { return GetElementByName<IField>(Names.FILE_TYPE_0003XX); } }
        ...
        public IField DRIVER_LICENSE_NUMBER_0003AS { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUMBER_0003AS); } }
        public IField DRIVER_LICENSE_NUMBER_0003 { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUMBER_0003); } }
        public IField DRIVER_LICENSE_NUMBER_0003XX { get { return GetElementByName<IField>(Names.DRIVER_LICENSE_NUMBER_0003XX); } }
        public IField DMV_PROBLEM_TEXT_0003AS { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_0003AS); } }
        public IField DMV_PROBLEM_TEXT_0003 { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_0003); } }
        public IField DMV_PROBLEM_TEXT_0003XX { get { return GetElementByName<IField>(Names.DMV_PROBLEM_TEXT_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.KDMV_FILE_0003ET, (KDMV_FILE_0003ET) =>
               {
                   KDMV_FILE_0003ET.CreateNewField(Names.CSE_PERSON_NUMBER_0003AS, FieldType.String, 1);

                   IField CSE_PERSON_NUMBER_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.CSE_PERSON_NUMBER_0003, FieldType.String, 10);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.CSE_PERSON_NUMBER_0003XX, FieldType.String, CSE_PERSON_NUMBER_0003_local, 10);
                   KDMV_FILE_0003ET.CreateNewField(Names.FILE_TYPE_0003AS, FieldType.String, 1);

                   IField FILE_TYPE_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.FILE_TYPE_0003, FieldType.String, 1);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.FILE_TYPE_0003XX, FieldType.String, FILE_TYPE_0003_local, 1);
                   KDMV_FILE_0003ET.CreateNewField(Names.LAST_NAME_0003AS, FieldType.String, 1);

                   IField LAST_NAME_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.LAST_NAME_0003, FieldType.String, 17);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.LAST_NAME_0003XX, FieldType.String, LAST_NAME_0003_local, 17);
                   KDMV_FILE_0003ET.CreateNewField(Names.FIRST_NAME_0003AS, FieldType.String, 1);

                   IField FIRST_NAME_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.FIRST_NAME_0003, FieldType.String, 12);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.FIRST_NAME_0003XX, FieldType.String, FIRST_NAME_0003_local, 12);
                   KDMV_FILE_0003ET.CreateNewField(Names.SSN_0003AS, FieldType.String, 1);

                   IField SSN_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.SSN_0003, FieldType.String, 9);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.SSN_0003XX, FieldType.String, SSN_0003_local, 9);
                   KDMV_FILE_0003ET.CreateNewField(Names.DOB_0003AS, FieldType.String, 1);

                   IField DOB_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.DOB_0003, FieldType.String, 8);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.DOB_0003XX, FieldType.String, DOB_0003_local, 8);
                   KDMV_FILE_0003ET.CreateNewField(Names.DRIVER_LICENSE_NUMBER_0003AS, FieldType.String, 1);

                   IField DRIVER_LICENSE_NUMBER_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.DRIVER_LICENSE_NUMBER_0003, FieldType.String, 9);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.DRIVER_LICENSE_NUMBER_0003XX, FieldType.String, DRIVER_LICENSE_NUMBER_0003_local, 9);
                   KDMV_FILE_0003ET.CreateNewField(Names.DMV_PROBLEM_TEXT_0003AS, FieldType.String, 1);

                   IField DMV_PROBLEM_TEXT_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.DMV_PROBLEM_TEXT_0003, FieldType.String, 37);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.DMV_PROBLEM_TEXT_0003XX, FieldType.String, DMV_PROBLEM_TEXT_0003_local, 37);
                   KDMV_FILE_0003ET.CreateNewField(Names.PROCESS_DATE_0003AS, FieldType.String, 1);

                   IField PROCESS_DATE_0003_local = KDMV_FILE_0003ET.CreateNewField(Names.PROCESS_DATE_0003, FieldType.String, 8);
                   KDMV_FILE_0003ET.CreateNewFieldRedefine(Names.PROCESS_DATE_0003XX, FieldType.String, PROCESS_DATE_0003_local, 8);
               });
           });
    ...
    public class SWEXER12 : EABBase
    {
        ...
        public SWEXER12()
            : base()
        {
            this.ProgramName.SetValue("SWEXER12");

            WS = new SWEXER12_ws();
            FD = new SWEXER12_fd(WS);
            LS = new SWEXER12_ls();
        }
        ...
        private SWEXER12_ws WS;

        //==== File Data Class ========================================
        private SWEXER12_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER12_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230609343(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230609343
        /// </summary>
        private void M_MAIN_1230609343(string returnMethod = "")
        {
            M_PARA_1230609343_INIT("M_PARA_1230609343_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230609343-INIT THRU PARA-1230609343-INIT-EXIT
            M_PARA_1230609343("M_PARA_1230609343_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230609343 THRU PARA-1230609343-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230609343
        /// </summary>
        private void M_PARA_1230609343(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE84 IS A PART OF SWEXER12*
            //COMMENT: ******************************************
        ...
        {
            FD.KDORIN.OpenFile(FileAccessMode.Read);                                                            //COBOL==> OPEN INPUT KDORIN.
            if (WS.KDORIN_STAT.IsEqualTo(00))                                                                   //COBOL==> IF KDORIN-STAT = 00
            {
                LS.NUMERIC_RETURN_CODE_0002.SetValue(WS.KDORIN_STAT);                                               //COBOL==> MOVE KDORIN-STAT TO NUMERIC-RETURN-CODE-0002
            }                                                                                                   //COBOL==> ELSE
            else
            {
        ...
        {
            WS.WS_KDORIN.SetValue(FD.KDORIN.ReadLineInto());                                                    //COBOL==> READ KDORIN INTO WS-KDORIN.
            if (WS.KDORIN_STAT.IsEqualTo(10))                                                                   //COBOL==> IF KDORIN-STAT = 10
            {
                LS.TEXT_LINE_80_0002.SetValue("REACHED END OF KDOR RESPONSE FILE");                                 //COBOL==> MOVE 'REACHED END OF KDOR RESPONSE FILE' TO TEXT-LINE-80-0002
            ...
            if (!(WS.KDORIN_STAT.IsEqualTo(00)))                                                                //COBOL==> IF KDORIN-STAT NOT = 00
            {
                LS.TEXT_LINE_80_0002.SetValue("ERROR IN READING RESPONSE FILE");                                    //COBOL==> MOVE 'ERROR IN READING RESPONSE FILE' TO TEXT-LINE-80-0002
                LS.TEXT_RETURN_CODE_0002.SetValue("XX");                                                            //COBOL==> MOVE 'XX' TO TEXT-RETURN-CODE-0002
                LS.NUMERIC_RETURN_CODE_0002.SetValue(WS.KDORIN_STAT);                                               //COBOL==> MOVE KDORIN-STAT TO NUMERIC-RETURN-CODE-0002
                M_0500_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 0500-EXIT
            }                                                                                                   //COBOL==> END-IF.
            LS.FILE_TYPE_0003.SetValue(WS.FILE_TYPE);                                                           //COBOL==> MOVE FILE-TYPE TO FILE-TYPE-0003
            ...
            LS.DOB_0003.SetValue(WS.DOB);                                                                       //COBOL==> MOVE DOB TO DOB-0003
            LS.DRIVER_LICENSE_NUMBER_0003.SetValue(WS.DRIVER_LICENSE_NUM);                                      //COBOL==> MOVE DRIVER-LICENSE-NUM TO DRIVER-LICENSE-NUMBER-0003
            LS.DMV_PROBLEM_TEXT_0003.SetValue(WS.DENIAL_REASON);                                                //COBOL==> MOVE DENIAL-REASON TO DMV-PROBLEM-TEXT-0003
            LS.PROCESS_DATE_0003.SetValue(WS.PROCESS_DATE);                                                     //COBOL==> MOVE PROCESS-DATE TO PROCESS-DATE-0003
        ...
        {
            FD.KDORIN.CloseFile();                                                                              //COBOL==> CLOSE KDORIN.
            if (!(WS.KDORIN_STAT.IsEqualTo(00)))                                                                //COBOL==> IF KDORIN-STAT NOT = 00
            {
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230609343_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230609343_EXIT
        /// </summary>
        private void M_PARA_1230609343_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230609343_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230609343_EXIT") { M_PARA_1230609343_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230609343_INIT
        /// </summary>
        private void M_PARA_1230609343_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1230609343_INIT") { M_PARA_1230609343_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230609343_INIT_EXIT
        /// </summary>
        private void M_PARA_1230609343_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230609343_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
