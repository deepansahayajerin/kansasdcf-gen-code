...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:31 PM
   **        *   FROM COBOL PGM   :  SWEXLR04
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: LE_EAB_READ_KDOL_IWO_NOTICE_INFO DATE: 2012/05/25
       TARGET OS:   MVS                       TIME: 15:39:05
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXLR04_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLR04_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD_01.CreateNewField(Names.RECORD_01_DETAIL, FieldType.String, 107);
           });
        ...
        #region Constructors
        public SWEXLR04_fd(SWEXLR04_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLR04_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLR04_ws_WorkingStorage";
    ...
    internal class SWEXLR04_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLR04_ls_LinkageSection";
            ...
            internal const string NEW_CLAIMANT_RECORD_0003AS = "NEW_CLAIMANT_RECORD_0003AS";
            internal const string NEW_CLAIMANT_RECORD_0003 = "NEW_CLAIMANT_RECORD_0003";
            internal const string NEW_CLAIMANT_RECORD_0003XX = "NEW_CLAIMANT_RECORD_0003XX";
        }
        #endregion
        ...
        public IField NEW_CLAIMANT_RECORD_0003AS { get { return GetElementByName<IField>(Names.NEW_CLAIMANT_RECORD_0003AS); } }
        public IField NEW_CLAIMANT_RECORD_0003 { get { return GetElementByName<IField>(Names.NEW_CLAIMANT_RECORD_0003); } }
        public IField NEW_CLAIMANT_RECORD_0003XX { get { return GetElementByName<IField>(Names.NEW_CLAIMANT_RECORD_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0003EV, (EXPORT_0003EV) =>
           {
               ...
               {
                   KDOL_UI_INBOUND_FILE_0003ET.CreateNewField(Names.NEW_CLAIMANT_RECORD_0003AS, FieldType.String, 1);

                   IField NEW_CLAIMANT_RECORD_0003_local = KDOL_UI_INBOUND_FILE_0003ET.CreateNewField(Names.NEW_CLAIMANT_RECORD_0003, FieldType.String, 107);
                   KDOL_UI_INBOUND_FILE_0003ET.CreateNewFieldRedefine(Names.NEW_CLAIMANT_RECORD_0003XX, FieldType.String, NEW_CLAIMANT_RECORD_0003_local, 107);
               });
           });
    ...
    public class SWEXLR04 : EABBase
    {
        ...
        public SWEXLR04()
            : base()
        {
            this.ProgramName.SetValue("SWEXLR04");

            WS = new SWEXLR04_ws();
            FD = new SWEXLR04_fd(WS);
            LS = new SWEXLR04_ls();
        }
        ...
        private SWEXLR04_ws WS;

        //==== File Data Class ========================================
        private SWEXLR04_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLR04_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1383078325(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1383078325
        /// </summary>
        private void M_MAIN_1383078325(string returnMethod = "")
        {
            M_PARA_1383078325_INIT("M_PARA_1383078325_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1383078325-INIT THRU PARA-1383078325-INIT-EXIT
            M_PARA_1383078325("M_PARA_1383078325_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1383078325 THRU PARA-1383078325-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1383078325
        /// </summary>
        private void M_PARA_1383078325(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1383078325") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.NEW_CLAIMANT_RECORD_0003.SetValue(FD.RECORD_01_DETAIL);                                          //COBOL==> MOVE RECORD-01-DETAIL TO NEW-CLAIMANT-RECORD-0003
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1383078325_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1383078325_EXIT
        /// </summary>
        private void M_PARA_1383078325_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1383078325_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1383078325_EXIT") { M_PARA_1383078325_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1383078325_INIT
        /// </summary>
        private void M_PARA_1383078325_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1383078325_INIT") { M_PARA_1383078325_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1383078325_INIT_EXIT
        /// </summary>
        private void M_PARA_1383078325_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1383078325_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
