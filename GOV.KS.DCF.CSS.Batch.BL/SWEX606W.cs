...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:42:13 PM
   **        *   FROM COBOL PGM   :  SWEX606W
...
/* Original Program Identification Comments
   *********************************************************
     ...
     REPORT COMPOSER LICENSE INFORMATION:
           STATE OF KANSAS
    EAB DEFINITION NAME:  FN SWEFB606 FILE GENERATOR
    ACTION BLOCK NAME:    EAB-B606-FILE-WRITER
    LANGUAGE:             COBOL
    STYLE:                WRITER - POSITIONAL FILE
                          CHECKPOINT RESTART NOT ENABLED
    TARGET OS:            MVS
    SOURCE:               C:\CANAM\SWEX606W.CBL
    GEN DATE:             01/21/2000
    GEN TIME:             10:21:43
    LAST UPDATE USER:     BROWN , MAUREEN
    LAST UPDATE DATE:     01/21/2000 10:21:43 AM
    ...
    RETURN CODE VALUES:
       ...
       'ET' - TEXT FIELD READ IS LONGER THAN ATTRIBUTE LENGTH
       'ED' - DATA FIELD READ IS LONGER THAN THE FILE FIELD LENGTH
       'EC' - THE NUMBER OF FIELDS IN THE FILE OF A DELIMITED READER
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEX606W_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEX606W_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               SEQ_FILE_RECORD.CreateNewFillerField(140, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            SEQ_FILE = FileHandler.GetFile("EXTRT159");
        ...
        #region Constructors
        public SWEX606W_fd(SWEX606W_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEX606W_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEX606W_ws_WorkingStorage";
            ...
            internal const string WS_1_WS1_USER_ID_X = "WS_1_WS1_USER_ID_X";
            internal const string WS_9_WS9_LAST_NAME_X = "WS_9_WS9_LAST_NAME_X";
            internal const string WS_26_WS26_FIRST_NAME_X = "WS_26_WS26_FIRST_NAME_X";
            internal const string WS_38_WS38_MIDDLE_INITIAL_X = "WS_38_WS38_MIDDLE_INITIAL_X";
            internal const string WS_39_WS39_NAME_X = "WS_39_WS39_NAME_X";
            internal const string WS_69_WS69_JUDICIAL_DISTRICT_X = "WS_69_WS69_JUDICIAL_DISTRICT_X";
            internal const string WS_74_WS74_COUNTY_DESCRIPTIO_X = "WS_74_WS74_COUNTY_DESCRIPTIO_X";
            internal const string WS_94_WS94_STANDARD_NUMBER_X = "WS_94_WS94_STANDARD_NUMBER_X";
            internal const string WS_114_WS114_FLAG_X = "WS_114_WS114_FLAG_X";
            internal const string WS_115_WS115_TEXT_1_X = "WS_115_WS115_TEXT_1_X";
            internal const string WS_116_WS116_FLAG_X = "WS_116_WS116_FLAG_X";
            internal const string WS_117_WS117_TOTAL_CURRENCY_X = "WS_117_WS117_TOTAL_CURRENCY_X";
            internal const string WS_117_WS117_TOTAL_CURRENCY_9 = "WS_117_WS117_TOTAL_CURRENCY_9";
            internal const string WS_132_WS132_COUNT_X = "WS_132_WS132_COUNT_X";
            internal const string WS_132_WS132_COUNT_9 = "WS_132_WS132_COUNT_9";
        ...
        public IField WS_1_WS1_USER_ID_X { get { return GetElementByName<IField>(Names.WS_1_WS1_USER_ID_X); } }
        public IField WS_9_WS9_LAST_NAME_X { get { return GetElementByName<IField>(Names.WS_9_WS9_LAST_NAME_X); } }
        public IField WS_26_WS26_FIRST_NAME_X { get { return GetElementByName<IField>(Names.WS_26_WS26_FIRST_NAME_X); } }
        public IField WS_38_WS38_MIDDLE_INITIAL_X { get { return GetElementByName<IField>(Names.WS_38_WS38_MIDDLE_INITIAL_X); } }
        public IField WS_39_WS39_NAME_X { get { return GetElementByName<IField>(Names.WS_39_WS39_NAME_X); } }
        public IField WS_69_WS69_JUDICIAL_DISTRICT_X { get { return GetElementByName<IField>(Names.WS_69_WS69_JUDICIAL_DISTRICT_X); } }
        public IField WS_74_WS74_COUNTY_DESCRIPTIO_X { get { return GetElementByName<IField>(Names.WS_74_WS74_COUNTY_DESCRIPTIO_X); } }
        public IField WS_94_WS94_STANDARD_NUMBER_X { get { return GetElementByName<IField>(Names.WS_94_WS94_STANDARD_NUMBER_X); } }
        public IField WS_114_WS114_FLAG_X { get { return GetElementByName<IField>(Names.WS_114_WS114_FLAG_X); } }
        public IField WS_115_WS115_TEXT_1_X { get { return GetElementByName<IField>(Names.WS_115_WS115_TEXT_1_X); } }
        public IField WS_116_WS116_FLAG_X { get { return GetElementByName<IField>(Names.WS_116_WS116_FLAG_X); } }
        public IField WS_117_WS117_TOTAL_CURRENCY_X { get { return GetElementByName<IField>(Names.WS_117_WS117_TOTAL_CURRENCY_X); } }
        public IField WS_117_WS117_TOTAL_CURRENCY_9 { get { return GetElementByName<IField>(Names.WS_117_WS117_TOTAL_CURRENCY_9); } }
        public IField WS_132_WS132_COUNT_X { get { return GetElementByName<IField>(Names.WS_132_WS132_COUNT_X); } }
        public IField WS_132_WS132_COUNT_9 { get { return GetElementByName<IField>(Names.WS_132_WS132_COUNT_9); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewFillerField(FieldType.String, 40, "SWEX606W WORKING STORAGE STARTS HERE");
           ...
           {
               WS_RECORD.CreateNewField(Names.WS_1_WS1_USER_ID_X, FieldType.String, 8);
               WS_RECORD.CreateNewField(Names.WS_9_WS9_LAST_NAME_X, FieldType.String, 17);
               WS_RECORD.CreateNewField(Names.WS_26_WS26_FIRST_NAME_X, FieldType.String, 12);
               WS_RECORD.CreateNewField(Names.WS_38_WS38_MIDDLE_INITIAL_X, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.WS_39_WS39_NAME_X, FieldType.String, 30);
               WS_RECORD.CreateNewField(Names.WS_69_WS69_JUDICIAL_DISTRICT_X, FieldType.String, 5);
               WS_RECORD.CreateNewField(Names.WS_74_WS74_COUNTY_DESCRIPTIO_X, FieldType.String, 20);
               WS_RECORD.CreateNewField(Names.WS_94_WS94_STANDARD_NUMBER_X, FieldType.String, 20);
               WS_RECORD.CreateNewField(Names.WS_114_WS114_FLAG_X, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.WS_115_WS115_TEXT_1_X, FieldType.String, 1);
               WS_RECORD.CreateNewField(Names.WS_116_WS116_FLAG_X, FieldType.String, 1);

               IField WS_117_WS117_TOTAL_CURRENCY_X_local = WS_RECORD.CreateNewField(Names.WS_117_WS117_TOTAL_CURRENCY_X, FieldType.String, 15);
               WS_RECORD.CreateNewFieldRedefine(Names.WS_117_WS117_TOTAL_CURRENCY_9, FieldType.SignedNumeric, WS_117_WS117_TOTAL_CURRENCY_X_local, 15, null, 2);

               IField WS_132_WS132_COUNT_X_local = WS_RECORD.CreateNewField(Names.WS_132_WS132_COUNT_X, FieldType.String, 9);
               WS_RECORD.CreateNewFieldRedefine(Names.WS_132_WS132_COUNT_9, FieldType.SignedNumeric, WS_132_WS132_COUNT_X_local, 9);
           });
    ...
    internal class SWEX606W_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEX606W_ls_LinkageSection";
            ...
            internal const string I_USER_ID_0002_003MS = "I_USER_ID_0002_003MS";
            internal const string I_USER_ID_0002_003 = "I_USER_ID_0002_003";
            internal const string I_USER_ID_0002_003XX = "I_USER_ID_0002_003XX";
            internal const string I_LAST_NAME_0002_004MS = "I_LAST_NAME_0002_004MS";
            internal const string I_LAST_NAME_0002_004 = "I_LAST_NAME_0002_004";
            internal const string I_LAST_NAME_0002_004XX = "I_LAST_NAME_0002_004XX";
            internal const string I_FIRST_NAME_0002_005MS = "I_FIRST_NAME_0002_005MS";
            internal const string I_FIRST_NAME_0002_005 = "I_FIRST_NAME_0002_005";
            internal const string I_FIRST_NAME_0002_005XX = "I_FIRST_NAME_0002_005XX";
            internal const string I_MIDDLE_INITIAL_0002_006MS = "I_MIDDLE_INITIAL_0002_006MS";
            internal const string I_MIDDLE_INITIAL_0002_006 = "I_MIDDLE_INITIAL_0002_006";
            internal const string I_MIDDLE_INITIAL_0002_006XX = "I_MIDDLE_INITIAL_0002_006XX";
            internal const string I_IMPORT_EV3 = "I_IMPORT_EV3";
            internal const string I_TRIBUNAL_ET = "I_TRIBUNAL_ET";
            internal const string I_NAME_0003_007MS = "I_NAME_0003_007MS";
            internal const string I_NAME_0003_007 = "I_NAME_0003_007";
            internal const string I_NAME_0003_007XX = "I_NAME_0003_007XX";
            internal const string I_JUDICIAL_DISTRICT_0003_008MS = "I_JUDICIAL_DISTRICT_0003_008MS";
            internal const string I_JUDICIAL_DISTRICT_0003_008 = "I_JUDICIAL_DISTRICT_0003_008";
            internal const string I_JUDICIAL_DISTRICT_0003_008XX = "I_JUDICIAL_DISTRICT_0003_008XX";
            internal const string I_IMPORT_EV4 = "I_IMPORT_EV4";
            internal const string I_FIPS_ET = "I_FIPS_ET";
            internal const string I_COUNTY_DESCRIPTION_000409MS = "I_COUNTY_DESCRIPTION_000409MS";
            internal const string I_COUNTY_DESCRIPTION_0004_009 = "I_COUNTY_DESCRIPTION_0004_009";
            internal const string I_COUNTY_DESCRIPTION_000409XX = "I_COUNTY_DESCRIPTION_000409XX";
            internal const string I_IMPORT_EV5 = "I_IMPORT_EV5";
            internal const string I_LEGAL_ACTION_ET = "I_LEGAL_ACTION_ET";
            internal const string I_STANDARD_NUMBER_0005_010MS = "I_STANDARD_NUMBER_0005_010MS";
            internal const string I_STANDARD_NUMBER_0005_010 = "I_STANDARD_NUMBER_0005_010";
            internal const string I_STANDARD_NUMBER_0005_010XX = "I_STANDARD_NUMBER_0005_010XX";
            internal const string I_IMPORT_COLL_OR_DEBT_REC__EV6 = "I_IMPORT_COLL_OR_DEBT_REC__EV6";
            internal const string I_IEF_SUPPLIED_ET = "I_IEF_SUPPLIED_ET";
            internal const string I_FLAG_0006_011MS = "I_FLAG_0006_011MS";
            internal const string I_FLAG_0006_011 = "I_FLAG_0006_011";
            internal const string I_FLAG_0006_011XX = "I_FLAG_0006_011XX";
            internal const string I_IMPORT_PRGM_EV7 = "I_IMPORT_PRGM_EV7";
            internal const string I_TEXT_WORK_AREA_ET = "I_TEXT_WORK_AREA_ET";
            internal const string I_TEXT_1_0007_012MS = "I_TEXT_1_0007_012MS";
            internal const string I_TEXT_1_0007_012 = "I_TEXT_1_0007_012";
            internal const string I_TEXT_1_0007_012XX = "I_TEXT_1_0007_012XX";
            internal const string I_IMPORT_ARREARS_OR_CURREN_EV8 = "I_IMPORT_ARREARS_OR_CURREN_EV8";
            internal const string I_IEF_SUPPLIED_ET_d2 = "I_IEF_SUPPLIED_ET_d2";
            internal const string I_FLAG_0008_013MS = "I_FLAG_0008_013MS";
            internal const string I_FLAG_0008_013 = "I_FLAG_0008_013";
            internal const string I_FLAG_0008_013XX = "I_FLAG_0008_013XX";
            internal const string I_IMPORT_COLL_OR_DEBT_AMOU_EV9 = "I_IMPORT_COLL_OR_DEBT_AMOU_EV9";
            internal const string I_IEF_SUPPLIED_ET_d3 = "I_IEF_SUPPLIED_ET_d3";
            internal const string I_TOTAL_CURRENCY_0009_014MS = "I_TOTAL_CURRENCY_0009_014MS";
            internal const string I_TOTAL_CURRENCY_0009_014 = "I_TOTAL_CURRENCY_0009_014";
            internal const string I_TOTAL_CURRENCY_0009_014XX = "I_TOTAL_CURRENCY_0009_014XX";
            internal const string I_IMPORT_NUMBER_OF_CASES_EV10 = "I_IMPORT_NUMBER_OF_CASES_EV10";
            internal const string I_IEF_SUPPLIED_ET_d4 = "I_IEF_SUPPLIED_ET_d4";
            internal const string I_COUNT_0010_015MS = "I_COUNT_0010_015MS";
            internal const string I_COUNT_0010_015 = "I_COUNT_0010_015";
            internal const string I_COUNT_0010_015XX = "I_COUNT_0010_015XX";
            internal const string E_EXPORT_EV11 = "E_EXPORT_EV11";
            internal const string E_REPORT_PARMS_ET = "E_REPORT_PARMS_ET";
            internal const string E_PARM1_0011_016MS = "E_PARM1_0011_016MS";
            internal const string E_PARM1_0011_016 = "E_PARM1_0011_016";
            internal const string E_PARM1_0011_016XX = "E_PARM1_0011_016XX";
            internal const string LS_RETURN_CD = "LS_RETURN_CD";
            internal const string E_PARM2_0011_017MS = "E_PARM2_0011_017MS";
            internal const string E_PARM2_0011_017 = "E_PARM2_0011_017";
            internal const string E_PARM2_0011_017XX = "E_PARM2_0011_017XX";
        }
        #endregion
        ...
        public IField I_USER_ID_0002_003MS { get { return GetElementByName<IField>(Names.I_USER_ID_0002_003MS); } }
        public IField I_USER_ID_0002_003 { get { return GetElementByName<IField>(Names.I_USER_ID_0002_003); } }
        public IField I_USER_ID_0002_003XX { get { return GetElementByName<IField>(Names.I_USER_ID_0002_003XX); } }
        public IField I_LAST_NAME_0002_004MS { get { return GetElementByName<IField>(Names.I_LAST_NAME_0002_004MS); } }
        public IField I_LAST_NAME_0002_004 { get { return GetElementByName<IField>(Names.I_LAST_NAME_0002_004); } }
        public IField I_LAST_NAME_0002_004XX { get { return GetElementByName<IField>(Names.I_LAST_NAME_0002_004XX); } }
        public IField I_FIRST_NAME_0002_005MS { get { return GetElementByName<IField>(Names.I_FIRST_NAME_0002_005MS); } }
        public IField I_FIRST_NAME_0002_005 { get { return GetElementByName<IField>(Names.I_FIRST_NAME_0002_005); } }
        public IField I_FIRST_NAME_0002_005XX { get { return GetElementByName<IField>(Names.I_FIRST_NAME_0002_005XX); } }
        public IField I_MIDDLE_INITIAL_0002_006MS { get { return GetElementByName<IField>(Names.I_MIDDLE_INITIAL_0002_006MS); } }
        public IField I_MIDDLE_INITIAL_0002_006 { get { return GetElementByName<IField>(Names.I_MIDDLE_INITIAL_0002_006); } }
        public IField I_MIDDLE_INITIAL_0002_006XX { get { return GetElementByName<IField>(Names.I_MIDDLE_INITIAL_0002_006XX); } }
        public IGroup I_IMPORT_EV3 { get { return GetElementByName<IGroup>(Names.I_IMPORT_EV3); } }
        public IGroup I_TRIBUNAL_ET { get { return GetElementByName<IGroup>(Names.I_TRIBUNAL_ET); } }
        public IField I_NAME_0003_007MS { get { return GetElementByName<IField>(Names.I_NAME_0003_007MS); } }
        public IField I_NAME_0003_007 { get { return GetElementByName<IField>(Names.I_NAME_0003_007); } }
        public IField I_NAME_0003_007XX { get { return GetElementByName<IField>(Names.I_NAME_0003_007XX); } }
        public IField I_JUDICIAL_DISTRICT_0003_008MS { get { return GetElementByName<IField>(Names.I_JUDICIAL_DISTRICT_0003_008MS); } }
        public IField I_JUDICIAL_DISTRICT_0003_008 { get { return GetElementByName<IField>(Names.I_JUDICIAL_DISTRICT_0003_008); } }
        public IField I_JUDICIAL_DISTRICT_0003_008XX { get { return GetElementByName<IField>(Names.I_JUDICIAL_DISTRICT_0003_008XX); } }
        public IGroup I_IMPORT_EV4 { get { return GetElementByName<IGroup>(Names.I_IMPORT_EV4); } }
        public IGroup I_FIPS_ET { get { return GetElementByName<IGroup>(Names.I_FIPS_ET); } }
        public IField I_COUNTY_DESCRIPTION_000409MS { get { return GetElementByName<IField>(Names.I_COUNTY_DESCRIPTION_000409MS); } }
        public IField I_COUNTY_DESCRIPTION_0004_009 { get { return GetElementByName<IField>(Names.I_COUNTY_DESCRIPTION_0004_009); } }
        public IField I_COUNTY_DESCRIPTION_000409XX { get { return GetElementByName<IField>(Names.I_COUNTY_DESCRIPTION_000409XX); } }
        ...
        public IField I_STANDARD_NUMBER_0005_010MS { get { return GetElementByName<IField>(Names.I_STANDARD_NUMBER_0005_010MS); } }
        public IField I_STANDARD_NUMBER_0005_010 { get { return GetElementByName<IField>(Names.I_STANDARD_NUMBER_0005_010); } }
        public IField I_STANDARD_NUMBER_0005_010XX { get { return GetElementByName<IField>(Names.I_STANDARD_NUMBER_0005_010XX); } }
        public IGroup I_IMPORT_COLL_OR_DEBT_REC__EV6 { get { return GetElementByName<IGroup>(Names.I_IMPORT_COLL_OR_DEBT_REC__EV6); } }
        public IGroup I_IEF_SUPPLIED_ET { get { return GetElementByName<IGroup>(Names.I_IEF_SUPPLIED_ET); } }
        public IField I_FLAG_0006_011MS { get { return GetElementByName<IField>(Names.I_FLAG_0006_011MS); } }
        public IField I_FLAG_0006_011 { get { return GetElementByName<IField>(Names.I_FLAG_0006_011); } }
        public IField I_FLAG_0006_011XX { get { return GetElementByName<IField>(Names.I_FLAG_0006_011XX); } }
        public IGroup I_IMPORT_PRGM_EV7 { get { return GetElementByName<IGroup>(Names.I_IMPORT_PRGM_EV7); } }
        public IGroup I_TEXT_WORK_AREA_ET { get { return GetElementByName<IGroup>(Names.I_TEXT_WORK_AREA_ET); } }
        public IField I_TEXT_1_0007_012MS { get { return GetElementByName<IField>(Names.I_TEXT_1_0007_012MS); } }
        public IField I_TEXT_1_0007_012 { get { return GetElementByName<IField>(Names.I_TEXT_1_0007_012); } }
        public IField I_TEXT_1_0007_012XX { get { return GetElementByName<IField>(Names.I_TEXT_1_0007_012XX); } }
        public IGroup I_IMPORT_ARREARS_OR_CURREN_EV8 { get { return GetElementByName<IGroup>(Names.I_IMPORT_ARREARS_OR_CURREN_EV8); } }
        public IGroup I_IEF_SUPPLIED_ET_d2 { get { return GetElementByName<IGroup>(Names.I_IEF_SUPPLIED_ET_d2); } }
        public IField I_FLAG_0008_013MS { get { return GetElementByName<IField>(Names.I_FLAG_0008_013MS); } }
        public IField I_FLAG_0008_013 { get { return GetElementByName<IField>(Names.I_FLAG_0008_013); } }
        public IField I_FLAG_0008_013XX { get { return GetElementByName<IField>(Names.I_FLAG_0008_013XX); } }
        public IGroup I_IMPORT_COLL_OR_DEBT_AMOU_EV9 { get { return GetElementByName<IGroup>(Names.I_IMPORT_COLL_OR_DEBT_AMOU_EV9); } }
        public IGroup I_IEF_SUPPLIED_ET_d3 { get { return GetElementByName<IGroup>(Names.I_IEF_SUPPLIED_ET_d3); } }
        public IField I_TOTAL_CURRENCY_0009_014MS { get { return GetElementByName<IField>(Names.I_TOTAL_CURRENCY_0009_014MS); } }
        public IField I_TOTAL_CURRENCY_0009_014 { get { return GetElementByName<IField>(Names.I_TOTAL_CURRENCY_0009_014); } }
        public IField I_TOTAL_CURRENCY_0009_014XX { get { return GetElementByName<IField>(Names.I_TOTAL_CURRENCY_0009_014XX); } }
        public IGroup I_IMPORT_NUMBER_OF_CASES_EV10 { get { return GetElementByName<IGroup>(Names.I_IMPORT_NUMBER_OF_CASES_EV10); } }
        public IGroup I_IEF_SUPPLIED_ET_d4 { get { return GetElementByName<IGroup>(Names.I_IEF_SUPPLIED_ET_d4); } }
        public IField I_COUNT_0010_015MS { get { return GetElementByName<IField>(Names.I_COUNT_0010_015MS); } }
        public IField I_COUNT_0010_015 { get { return GetElementByName<IField>(Names.I_COUNT_0010_015); } }
        public IField I_COUNT_0010_015XX { get { return GetElementByName<IField>(Names.I_COUNT_0010_015XX); } }
        ...
        public IField E_PARM1_0011_016MS { get { return GetElementByName<IField>(Names.E_PARM1_0011_016MS); } }
        public IField E_PARM1_0011_016 { get { return GetElementByName<IField>(Names.E_PARM1_0011_016); } }
        public IField E_PARM1_0011_016XX { get { return GetElementByName<IField>(Names.E_PARM1_0011_016XX); } }
        public IField LS_RETURN_CD { get { return GetElementByName<IField>(Names.LS_RETURN_CD); } }
        public IField E_PARM2_0011_017MS { get { return GetElementByName<IField>(Names.E_PARM2_0011_017MS); } }
        public IField E_PARM2_0011_017 { get { return GetElementByName<IField>(Names.E_PARM2_0011_017); } }
        public IField E_PARM2_0011_017XX { get { return GetElementByName<IField>(Names.E_PARM2_0011_017XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               I_IMPORT_EV2.CreateNewGroup(Names.I_SERVICE_PROVIDER_ET, (I_SERVICE_PROVIDER_ET) =>
               {
                   I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_USER_ID_0002_003MS, FieldType.String, 1);

                   IField I_USER_ID_0002_003_local = I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_USER_ID_0002_003, FieldType.String, 8);
                   I_SERVICE_PROVIDER_ET.CreateNewFieldRedefine(Names.I_USER_ID_0002_003XX, FieldType.String, I_USER_ID_0002_003_local, 8);
                   I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_LAST_NAME_0002_004MS, FieldType.String, 1);

                   IField I_LAST_NAME_0002_004_local = I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_LAST_NAME_0002_004, FieldType.String, 17);
                   I_SERVICE_PROVIDER_ET.CreateNewFieldRedefine(Names.I_LAST_NAME_0002_004XX, FieldType.String, I_LAST_NAME_0002_004_local, 17);
                   I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_FIRST_NAME_0002_005MS, FieldType.String, 1);

                   IField I_FIRST_NAME_0002_005_local = I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_FIRST_NAME_0002_005, FieldType.String, 12);
                   I_SERVICE_PROVIDER_ET.CreateNewFieldRedefine(Names.I_FIRST_NAME_0002_005XX, FieldType.String, I_FIRST_NAME_0002_005_local, 12);
                   I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_MIDDLE_INITIAL_0002_006MS, FieldType.String, 1);

                   IField I_MIDDLE_INITIAL_0002_006_local = I_SERVICE_PROVIDER_ET.CreateNewField(Names.I_MIDDLE_INITIAL_0002_006, FieldType.String, 1);
                   I_SERVICE_PROVIDER_ET.CreateNewFieldRedefine(Names.I_MIDDLE_INITIAL_0002_006XX, FieldType.String, I_MIDDLE_INITIAL_0002_006_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_EV3, (I_IMPORT_EV3) =>
           {
               I_IMPORT_EV3.CreateNewGroup(Names.I_TRIBUNAL_ET, (I_TRIBUNAL_ET) =>
               {
                   I_TRIBUNAL_ET.CreateNewField(Names.I_NAME_0003_007MS, FieldType.String, 1);

                   IField I_NAME_0003_007_local = I_TRIBUNAL_ET.CreateNewField(Names.I_NAME_0003_007, FieldType.String, 30);
                   I_TRIBUNAL_ET.CreateNewFieldRedefine(Names.I_NAME_0003_007XX, FieldType.String, I_NAME_0003_007_local, 30);
                   I_TRIBUNAL_ET.CreateNewField(Names.I_JUDICIAL_DISTRICT_0003_008MS, FieldType.String, 1);

                   IField I_JUDICIAL_DISTRICT_0003_008_local = I_TRIBUNAL_ET.CreateNewField(Names.I_JUDICIAL_DISTRICT_0003_008, FieldType.String, 5);
                   I_TRIBUNAL_ET.CreateNewFieldRedefine(Names.I_JUDICIAL_DISTRICT_0003_008XX, FieldType.String, I_JUDICIAL_DISTRICT_0003_008_local, 5);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_EV4, (I_IMPORT_EV4) =>
           {
               I_IMPORT_EV4.CreateNewGroup(Names.I_FIPS_ET, (I_FIPS_ET) =>
               {
                   I_FIPS_ET.CreateNewField(Names.I_COUNTY_DESCRIPTION_000409MS, FieldType.String, 1);

                   IField I_COUNTY_DESCRIPTION_0004_009_local = I_FIPS_ET.CreateNewField(Names.I_COUNTY_DESCRIPTION_0004_009, FieldType.String, 20);
                   I_FIPS_ET.CreateNewFieldRedefine(Names.I_COUNTY_DESCRIPTION_000409XX, FieldType.String, I_COUNTY_DESCRIPTION_0004_009_local, 20);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_EV5, (I_IMPORT_EV5) =>
           {
               I_IMPORT_EV5.CreateNewGroup(Names.I_LEGAL_ACTION_ET, (I_LEGAL_ACTION_ET) =>
               {
                   I_LEGAL_ACTION_ET.CreateNewField(Names.I_STANDARD_NUMBER_0005_010MS, FieldType.String, 1);

                   IField I_STANDARD_NUMBER_0005_010_local = I_LEGAL_ACTION_ET.CreateNewField(Names.I_STANDARD_NUMBER_0005_010, FieldType.String, 20);
                   I_LEGAL_ACTION_ET.CreateNewFieldRedefine(Names.I_STANDARD_NUMBER_0005_010XX, FieldType.String, I_STANDARD_NUMBER_0005_010_local, 20);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_COLL_OR_DEBT_REC__EV6, (I_IMPORT_COLL_OR_DEBT_REC__EV6) =>
           {
               I_IMPORT_COLL_OR_DEBT_REC__EV6.CreateNewGroup(Names.I_IEF_SUPPLIED_ET, (I_IEF_SUPPLIED_ET) =>
               {
                   I_IEF_SUPPLIED_ET.CreateNewField(Names.I_FLAG_0006_011MS, FieldType.String, 1);

                   IField I_FLAG_0006_011_local = I_IEF_SUPPLIED_ET.CreateNewField(Names.I_FLAG_0006_011, FieldType.String, 1);
                   I_IEF_SUPPLIED_ET.CreateNewFieldRedefine(Names.I_FLAG_0006_011XX, FieldType.String, I_FLAG_0006_011_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_PRGM_EV7, (I_IMPORT_PRGM_EV7) =>
           {
               I_IMPORT_PRGM_EV7.CreateNewGroup(Names.I_TEXT_WORK_AREA_ET, (I_TEXT_WORK_AREA_ET) =>
               {
                   I_TEXT_WORK_AREA_ET.CreateNewField(Names.I_TEXT_1_0007_012MS, FieldType.String, 1);

                   IField I_TEXT_1_0007_012_local = I_TEXT_WORK_AREA_ET.CreateNewField(Names.I_TEXT_1_0007_012, FieldType.String, 1);
                   I_TEXT_WORK_AREA_ET.CreateNewFieldRedefine(Names.I_TEXT_1_0007_012XX, FieldType.String, I_TEXT_1_0007_012_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_ARREARS_OR_CURREN_EV8, (I_IMPORT_ARREARS_OR_CURREN_EV8) =>
           {
               I_IMPORT_ARREARS_OR_CURREN_EV8.CreateNewGroup(Names.I_IEF_SUPPLIED_ET_d2, (I_IEF_SUPPLIED_ET_d2) =>
               {
                   I_IEF_SUPPLIED_ET_d2.CreateNewField(Names.I_FLAG_0008_013MS, FieldType.String, 1);

                   IField I_FLAG_0008_013_local = I_IEF_SUPPLIED_ET_d2.CreateNewField(Names.I_FLAG_0008_013, FieldType.String, 1);
                   I_IEF_SUPPLIED_ET_d2.CreateNewFieldRedefine(Names.I_FLAG_0008_013XX, FieldType.String, I_FLAG_0008_013_local, 1);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_COLL_OR_DEBT_AMOU_EV9, (I_IMPORT_COLL_OR_DEBT_AMOU_EV9) =>
           {
               I_IMPORT_COLL_OR_DEBT_AMOU_EV9.CreateNewGroup(Names.I_IEF_SUPPLIED_ET_d3, (I_IEF_SUPPLIED_ET_d3) =>
               {
                   I_IEF_SUPPLIED_ET_d3.CreateNewField(Names.I_TOTAL_CURRENCY_0009_014MS, FieldType.String, 1);

                   IField I_TOTAL_CURRENCY_0009_014_local = I_IEF_SUPPLIED_ET_d3.CreateNewField(Names.I_TOTAL_CURRENCY_0009_014, FieldType.SignedNumeric, 15, null, 2);
                   I_IEF_SUPPLIED_ET_d3.CreateNewFieldRedefine(Names.I_TOTAL_CURRENCY_0009_014XX, FieldType.String, I_TOTAL_CURRENCY_0009_014_local, 15);
               });
           });

            recordDef.CreateNewGroup(Names.I_IMPORT_NUMBER_OF_CASES_EV10, (I_IMPORT_NUMBER_OF_CASES_EV10) =>
           {
               I_IMPORT_NUMBER_OF_CASES_EV10.CreateNewGroup(Names.I_IEF_SUPPLIED_ET_d4, (I_IEF_SUPPLIED_ET_d4) =>
               {
                   I_IEF_SUPPLIED_ET_d4.CreateNewField(Names.I_COUNT_0010_015MS, FieldType.String, 1);

                   IField I_COUNT_0010_015_local = I_IEF_SUPPLIED_ET_d4.CreateNewField(Names.I_COUNT_0010_015, FieldType.SignedNumeric, 9);
                   I_IEF_SUPPLIED_ET_d4.CreateNewFieldRedefine(Names.I_COUNT_0010_015XX, FieldType.String, I_COUNT_0010_015_local, 9);
               });
           });
            ...
            recordDef.CreateNewGroup(Names.E_EXPORT_EV11, (E_EXPORT_EV11) =>
           {
               ...
               {
                   E_REPORT_PARMS_ET.CreateNewField(Names.E_PARM1_0011_016MS, FieldType.String, 1);

                   IField E_PARM1_0011_016_local = E_REPORT_PARMS_ET.CreateNewField(Names.E_PARM1_0011_016, FieldType.String, 2);
                   E_REPORT_PARMS_ET.CreateNewFieldRedefine(Names.E_PARM1_0011_016XX, FieldType.String, E_PARM1_0011_016_local, 2);
                   E_REPORT_PARMS_ET.CreateNewFieldRedefine(Names.LS_RETURN_CD, FieldType.String, E_PARM1_0011_016_local, 2);
                   E_REPORT_PARMS_ET.CreateNewField(Names.E_PARM2_0011_017MS, FieldType.String, 1);

                   IField E_PARM2_0011_017_local = E_REPORT_PARMS_ET.CreateNewField(Names.E_PARM2_0011_017, FieldType.String, 2);
                   E_REPORT_PARMS_ET.CreateNewFieldRedefine(Names.E_PARM2_0011_017XX, FieldType.String, E_PARM2_0011_017_local, 2);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(I_IMPORT_COLL_OR_DEBT_REC__EV6, args, 8);
            SetPassedParm(I_IMPORT_PRGM_EV7, args, 9);
            SetPassedParm(I_IMPORT_ARREARS_OR_CURREN_EV8, args, 10);
            SetPassedParm(I_IMPORT_COLL_OR_DEBT_AMOU_EV9, args, 11);
            SetPassedParm(I_IMPORT_NUMBER_OF_CASES_EV10, args, 12);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(I_IMPORT_COLL_OR_DEBT_REC__EV6, args, 8);
            SetReturnParm(I_IMPORT_PRGM_EV7, args, 9);
            SetReturnParm(I_IMPORT_ARREARS_OR_CURREN_EV8, args, 10);
            SetReturnParm(I_IMPORT_COLL_OR_DEBT_AMOU_EV9, args, 11);
            SetReturnParm(I_IMPORT_NUMBER_OF_CASES_EV10, args, 12);
    ...
    public class SWEX606W : EABBase
    {
        ...
        public SWEX606W()
            : base()
        {
            this.ProgramName.SetValue("SWEX606W");

            WS = new SWEX606W_ws();
            FD = new SWEX606W_fd(WS);
            LS = new SWEX606W_ls();
        }
        ...
        private SWEX606W_ws WS;

        //==== File Data Class ========================================
        private SWEX606W_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEX606W_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING TI-RUNTIME-PARM1 , TI-RUNTIME-PARM2 , GLOBDATA , I-IMPORT-EV1 , I-IMPORT-EV2 , I-IMPORT-EV3 , I-IMPORT-EV4 , I-IMPORT-EV5 , I-IMPORT-COLL-OR-DEBT-REC--EV6 , I-IMPORT-PRGM-EV7 , I-IMPORT-ARREARS-OR-CURREN-EV8 , I-IMPORT-COLL-OR-DEBT-AMOU-EV9 , I-IMPORT-NUMBER-OF-CASES-EV10 , E-EXPORT-EV11.
        {
            try
            {
                WS.Initialize();
        ...
        {
            LS.E_PARM1_0011_016.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM1-0011-016.
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        LS.E_PARM1_0011_016.SetValue("II");                                                                 //COBOL==> MOVE 'II' TO E-PARM1-0011-016
                    }                                                                                                   //COBOL==> END-IF
                }                                                                                                   //COBOL==> END-IF
            }                                                                                                   //COBOL==> END-IF.
            LS.E_PARM2_0011_017.SetValue(WS.WS_FILE_STATUS);                                                    //COBOL==> MOVE WS-FILE-STATUS TO E-PARM2-0011-017.
        ...
        {
            //COMMENT:     ALLOW FOR APPENDING TO AN EXISTING SEQUENTIAL FILE
            //COMMENT:        IF PARM1 IS "OF" THEN OPEN THE FILE NORMALLY
            //COMMENT:        IF PARM1 IS "AF" THEN OPEN THE FILE WITH EXTEND TO APPEND
            if (LS.I_PARM1_0001_001.IsEqualTo("OF"))                                                            //COBOL==> IF I-PARM1-0001-001 = 'OF'
            {
                FD.SEQ_FILE.OpenFile(FileAccessMode.Write);                                                         //COBOL==> OPEN OUTPUT SEQ-FILE
            }                                                                                                   //COBOL==> END-IF.
            if (LS.I_PARM1_0001_001.IsEqualTo("AF"))                                                            //COBOL==> IF I-PARM1-0001-001 = 'AF'
            {
                FD.SEQ_FILE.OpenFile(FileAccessMode.WriteExtend);                                                   //COBOL==> OPEN EXTEND SEQ-FILE
            }                                                                                                   //COBOL==> END-IF.
            if (!(WS.WS_FILE_STATUS.IsEqualTo("00")))                                                           //COBOL==> IF WS-FILE-STATUS NOT = '00'
            {
                LS.E_PARM1_0011_016.SetValue("EO");                                                                 //COBOL==> MOVE 'EO' TO E-PARM1-0011-016
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            WS.WS_1_WS1_USER_ID_X.SetValue(LS.I_USER_ID_0002_003);                                              //COBOL==> MOVE I-USER-ID-0002-003 TO WS-1-WS1-USER-ID-X.
            WS.WS_9_WS9_LAST_NAME_X.SetValue(LS.I_LAST_NAME_0002_004);                                          //COBOL==> MOVE I-LAST-NAME-0002-004 TO WS-9-WS9-LAST-NAME-X.
            WS.WS_26_WS26_FIRST_NAME_X.SetValue(LS.I_FIRST_NAME_0002_005);                                      //COBOL==> MOVE I-FIRST-NAME-0002-005 TO WS-26-WS26-FIRST-NAME-X.
            WS.WS_38_WS38_MIDDLE_INITIAL_X.SetValue(LS.I_MIDDLE_INITIAL_0002_006);                              //COBOL==> MOVE I-MIDDLE-INITIAL-0002-006 TO WS-38-WS38-MIDDLE-INITIAL-X.
            WS.WS_39_WS39_NAME_X.SetValue(LS.I_NAME_0003_007);                                                  //COBOL==> MOVE I-NAME-0003-007 TO WS-39-WS39-NAME-X.
            WS.WS_69_WS69_JUDICIAL_DISTRICT_X.SetValue(LS.I_JUDICIAL_DISTRICT_0003_008);                        //COBOL==> MOVE I-JUDICIAL-DISTRICT-0003-008 TO WS-69-WS69-JUDICIAL-DISTRICT-X.
            WS.WS_74_WS74_COUNTY_DESCRIPTIO_X.SetValue(LS.I_COUNTY_DESCRIPTION_0004_009);                       //COBOL==> MOVE I-COUNTY-DESCRIPTION-0004-009 TO WS-74-WS74-COUNTY-DESCRIPTIO-X.
            WS.WS_94_WS94_STANDARD_NUMBER_X.SetValue(LS.I_STANDARD_NUMBER_0005_010);                            //COBOL==> MOVE I-STANDARD-NUMBER-0005-010 TO WS-94-WS94-STANDARD-NUMBER-X.
            WS.WS_114_WS114_FLAG_X.SetValue(LS.I_FLAG_0006_011);                                                //COBOL==> MOVE I-FLAG-0006-011 TO WS-114-WS114-FLAG-X.
            WS.WS_115_WS115_TEXT_1_X.SetValue(LS.I_TEXT_1_0007_012);                                            //COBOL==> MOVE I-TEXT-1-0007-012 TO WS-115-WS115-TEXT-1-X.
            WS.WS_116_WS116_FLAG_X.SetValue(LS.I_FLAG_0008_013);                                                //COBOL==> MOVE I-FLAG-0008-013 TO WS-116-WS116-FLAG-X.
            WS.WS_117_WS117_TOTAL_CURRENCY_9.SetValue(LS.I_TOTAL_CURRENCY_0009_014);                            //COBOL==> MOVE I-TOTAL-CURRENCY-0009-014 TO WS-117-WS117-TOTAL-CURRENCY-9.
            WS.WS_132_WS132_COUNT_9.SetValue(LS.I_COUNT_0010_015);                                              //COBOL==> MOVE I-COUNT-0010-015 TO WS-132-WS132-COUNT-9.
            FD.SEQ_FILE.WriteLine(WS.WS_RECORD.AsBytes);                                                        //COBOL==> WRITE SEQ-FILE-RECORD FROM WS-RECORD.
            if (!(WS.WS_FILE_STATUS.IsEqualTo("00")))                                                           //COBOL==> IF WS-FILE-STATUS NOT = '00'
            {
                LS.E_PARM1_0011_016.SetValue("ER");                                                                 //COBOL==> MOVE 'ER' TO E-PARM1-0011-016
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.E_PARM1_0011_016.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM1-0011-016
        ...
        private void M_PROCESS_RECORD_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PROCESS_RECORD_EXIT") { M_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_CLOSE_FILE
        /// </summary>
        private void M_CLOSE_FILE(string returnMethod = "")
        {
            ...
            if (!(WS.WS_FILE_STATUS.IsEqualTo("00")))                                                           //COBOL==> IF WS-FILE-STATUS NOT = '00'
            {
                LS.E_PARM1_0011_016.SetValue("EC");                                                                 //COBOL==> MOVE 'EC' TO E-PARM1-0011-016
            }                                                                                                   //COBOL==> ELSE
            else
            {
                LS.E_PARM1_0011_016.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM1-0011-016
        ...
        private void M_INIT_LINKAGE(string returnMethod = "")
        {
            ...
            if ((LS.I_USER_ID_0002_003XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_USER_ID_0002_003XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-USER-ID-0002-003XX = HIGH-VALUES OR I-USER-ID-0002-003XX = LOW-VALUES
            {
                LS.I_USER_ID_0002_003.SetValueWithSpaces();                                                         //COBOL==> MOVE SPACES TO I-USER-ID-0002-003
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_LAST_NAME_0002_004XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_LAST_NAME_0002_004XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-LAST-NAME-0002-004XX = HIGH-VALUES OR I-LAST-NAME-0002-004XX = LOW-VALUES
            {
                LS.I_LAST_NAME_0002_004.SetValueWithSpaces();                                                       //COBOL==> MOVE SPACES TO I-LAST-NAME-0002-004
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_FIRST_NAME_0002_005XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_FIRST_NAME_0002_005XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-FIRST-NAME-0002-005XX = HIGH-VALUES OR I-FIRST-NAME-0002-005XX = LOW-VALUES
            {
                LS.I_FIRST_NAME_0002_005.SetValueWithSpaces();                                                      //COBOL==> MOVE SPACES TO I-FIRST-NAME-0002-005
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_MIDDLE_INITIAL_0002_006XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_MIDDLE_INITIAL_0002_006XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-MIDDLE-INITIAL-0002-006XX = HIGH-VALUES OR I-MIDDLE-INITIAL-0002-006XX = LOW-VALUES
            {
                LS.I_MIDDLE_INITIAL_0002_006.SetValueWithSpaces();                                                  //COBOL==> MOVE SPACES TO I-MIDDLE-INITIAL-0002-006
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_NAME_0003_007XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_NAME_0003_007XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-NAME-0003-007XX = HIGH-VALUES OR I-NAME-0003-007XX = LOW-VALUES
            {
                LS.I_NAME_0003_007.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO I-NAME-0003-007
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_JUDICIAL_DISTRICT_0003_008XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_JUDICIAL_DISTRICT_0003_008XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-JUDICIAL-DISTRICT-0003-008XX = HIGH-VALUES OR I-JUDICIAL-DISTRICT-0003-008XX = LOW-VALUES
            {
                LS.I_JUDICIAL_DISTRICT_0003_008.SetValueWithSpaces();                                               //COBOL==> MOVE SPACES TO I-JUDICIAL-DISTRICT-0003-008
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_COUNTY_DESCRIPTION_000409XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_COUNTY_DESCRIPTION_000409XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-COUNTY-DESCRIPTION-000409XX = HIGH-VALUES OR I-COUNTY-DESCRIPTION-000409XX = LOW-VALUES
            {
                LS.I_COUNTY_DESCRIPTION_0004_009.SetValueWithSpaces();                                              //COBOL==> MOVE SPACES TO I-COUNTY-DESCRIPTION-0004-009
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_STANDARD_NUMBER_0005_010XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_STANDARD_NUMBER_0005_010XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-STANDARD-NUMBER-0005-010XX = HIGH-VALUES OR I-STANDARD-NUMBER-0005-010XX = LOW-VALUES
            {
                LS.I_STANDARD_NUMBER_0005_010.SetValueWithSpaces();                                                 //COBOL==> MOVE SPACES TO I-STANDARD-NUMBER-0005-010
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_FLAG_0006_011XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_FLAG_0006_011XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-FLAG-0006-011XX = HIGH-VALUES OR I-FLAG-0006-011XX = LOW-VALUES
            {
                LS.I_FLAG_0006_011.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO I-FLAG-0006-011
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_TEXT_1_0007_012XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_TEXT_1_0007_012XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-TEXT-1-0007-012XX = HIGH-VALUES OR I-TEXT-1-0007-012XX = LOW-VALUES
            {
                LS.I_TEXT_1_0007_012.SetValueWithSpaces();                                                          //COBOL==> MOVE SPACES TO I-TEXT-1-0007-012
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.I_FLAG_0008_013XX.IsEqualTo(HIGH_VALUES))
             || (LS.I_FLAG_0008_013XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF I-FLAG-0008-013XX = HIGH-VALUES OR I-FLAG-0008-013XX = LOW-VALUES
            {
                LS.I_FLAG_0008_013.SetValueWithSpaces();                                                            //COBOL==> MOVE SPACES TO I-FLAG-0008-013
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.I_TOTAL_CURRENCY_0009_014.IsNumericValue()))                                              //COBOL==> IF I-TOTAL-CURRENCY-0009-014 IS NOT NUMERIC
            {
                LS.I_TOTAL_CURRENCY_0009_014.SetValueWithZeroes();                                                  //COBOL==> MOVE ZEROS TO I-TOTAL-CURRENCY-0009-014
            }                                                                                                   //COBOL==> END-IF.
            if (!(LS.I_COUNT_0010_015.IsNumericValue()))                                                       //COBOL==> IF I-COUNT-0010-015 IS NOT NUMERIC
            {
                LS.I_COUNT_0010_015.SetValueWithZeroes();                                                           //COBOL==> MOVE ZEROS TO I-COUNT-0010-015
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_PARM1_0011_016XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_PARM1_0011_016XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-PARM1-0011-016XX = HIGH-VALUES OR E-PARM1-0011-016XX = LOW-VALUES
            {
                LS.E_PARM1_0011_016.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM1-0011-016
            }                                                                                                   //COBOL==> END-IF.
            if ((LS.E_PARM2_0011_017XX.IsEqualTo(HIGH_VALUES))
             || (LS.E_PARM2_0011_017XX.IsEqualTo(LOW_VALUES)))  //COBOL==> IF E-PARM2-0011-017XX = HIGH-VALUES OR E-PARM2-0011-017XX = LOW-VALUES
            {
                LS.E_PARM2_0011_017.SetValueWithSpaces();                                                           //COBOL==> MOVE SPACES TO E-PARM2-0011-017
            }                                                                                                   //COBOL==> END-IF.
