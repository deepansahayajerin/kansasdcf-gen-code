...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:51:04 PM
   **        *   FROM COBOL PGM   :  SWEXIE04
...
/* Original Program Identification Comments
   ***************************************************************
      ...
      COPYRIGHT (C) 2019 CA TECHNOLOGIES. ALL RIGHTS RESERVED.
       NAME: SI_B286_READ_DL_ERROR_FILE       DATE: 2019/01/14
       TARGET OS:   MVS                       TIME: 14:20:31
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXIE04_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXIE04_fd_FileSection";
            ...
            internal const string ERROR_REASON_0003 = "ERROR_REASON_0003";
        }
        #endregion
        ...
        public IField ERROR_REASON_0003 { get { return GetElementByName<IField>(Names.ERROR_REASON_0003); } }


        internal SWEXIE04_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.INPUT_RECORD, (INPUT_RECORD) =>
           {
               ...
               IField LAST_NAME_0003_local = INPUT_RECORD.CreateNewField(Names.LAST_NAME_0003, FieldType.String, 17);

               IField FIRST_NAME_0003_local = INPUT_RECORD.CreateNewField(Names.FIRST_NAME_0003, FieldType.String, 12);

               IField SSN_0003_local = INPUT_RECORD.CreateNewField(Names.SSN_0003, FieldType.String, 9);

               IField DATE_OF_BIRTH_0003_local = INPUT_RECORD.CreateNewField(Names.DATE_OF_BIRTH_0003, FieldType.String, 8);

               IField PERSON_NUMBER_0003_local = INPUT_RECORD.CreateNewField(Names.PERSON_NUMBER_0003, FieldType.String, 10);

               IField DRIVERS_LICENSE_NUMBER_0003_local = INPUT_RECORD.CreateNewField(Names.DRIVERS_LICENSE_NUMBER_0003, FieldType.String, 9);

               IField STATUS_0003_local = INPUT_RECORD.CreateNewField(Names.STATUS_0003, FieldType.String, 3);

               IField ERROR_REASON_0003_local = INPUT_RECORD.CreateNewField(Names.ERROR_REASON_0003, FieldType.String, 20);
               INPUT_RECORD.CreateNewFillerField(162, FillWith.Hashes);
           });
        ...
        #region Constructors
        public SWEXIE04_fd(SWEXIE04_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXIE04_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXIE04_ws_WorkingStorage";
    ...
    internal class SWEXIE04_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXIE04_ls_LinkageSection";
            ...
            internal const string KDOR_DL_ERROR_RECORD_0003ET = "KDOR_DL_ERROR_RECORD_0003ET";
            ...
            internal const string STATUS_0003_d2 = "STATUS_0003_d2";
            internal const string STATUS_0003XX = "STATUS_0003XX";
            internal const string ERROR_REASON_0003AS = "ERROR_REASON_0003AS";
            internal const string ERROR_REASON_0003_d2 = "ERROR_REASON_0003_d2";
            internal const string ERROR_REASON_0003XX = "ERROR_REASON_0003XX";
        }
        #endregion
        ...
        public IGroup KDOR_DL_ERROR_RECORD_0003ET { get { return GetElementByName<IGroup>(Names.KDOR_DL_ERROR_RECORD_0003ET); } }
        ...
        public IField STATUS_0003_d2 { get { return GetElementByName<IField>(Names.STATUS_0003_d2); } }
        public IField STATUS_0003XX { get { return GetElementByName<IField>(Names.STATUS_0003XX); } }
        public IField ERROR_REASON_0003AS { get { return GetElementByName<IField>(Names.ERROR_REASON_0003AS); } }
        public IField ERROR_REASON_0003_d2 { get { return GetElementByName<IField>(Names.ERROR_REASON_0003_d2); } }
        public IField ERROR_REASON_0003XX { get { return GetElementByName<IField>(Names.ERROR_REASON_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0003EV.CreateNewGroup(Names.KDOR_DL_ERROR_RECORD_0003ET, (KDOR_DL_ERROR_RECORD_0003ET) =>
               {
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.LAST_NAME_0003AS, FieldType.String, 1);

                   IField LAST_NAME_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.LAST_NAME_0003_d2, FieldType.String, 17);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.LAST_NAME_0003XX, FieldType.String, LAST_NAME_0003_d2_local, 17);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.FIRST_NAME_0003AS, FieldType.String, 1);

                   IField FIRST_NAME_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.FIRST_NAME_0003_d2, FieldType.String, 12);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.FIRST_NAME_0003XX, FieldType.String, FIRST_NAME_0003_d2_local, 12);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.SSN_0003AS, FieldType.String, 1);

                   IField SSN_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.SSN_0003_d2, FieldType.String, 9);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.SSN_0003XX, FieldType.String, SSN_0003_d2_local, 9);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.DATE_OF_BIRTH_0003AS, FieldType.String, 1);

                   IField DATE_OF_BIRTH_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.DATE_OF_BIRTH_0003_d2, FieldType.String, 8);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.DATE_OF_BIRTH_0003XX, FieldType.String, DATE_OF_BIRTH_0003_d2_local, 8);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.PERSON_NUMBER_0003AS, FieldType.String, 1);

                   IField PERSON_NUMBER_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.PERSON_NUMBER_0003_d2, FieldType.String, 10);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.PERSON_NUMBER_0003XX, FieldType.String, PERSON_NUMBER_0003_d2_local, 10);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.DRIVERS_LICENSE_NUMBER_0003AS, FieldType.String, 1);

                   IField DRIVERS_LICENSE_NUMBER_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.DRIVERS_LICENSE_NUMBER_0003_d2, FieldType.String, 9);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.DRIVERS_LICENSE_NUMBER_0003XX, FieldType.String, DRIVERS_LICENSE_NUMBER_0003_d2_local, 9);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.STATUS_0003AS, FieldType.String, 1);

                   IField STATUS_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.STATUS_0003_d2, FieldType.String, 3);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.STATUS_0003XX, FieldType.String, STATUS_0003_d2_local, 3);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.ERROR_REASON_0003AS, FieldType.String, 1);

                   IField ERROR_REASON_0003_d2_local = KDOR_DL_ERROR_RECORD_0003ET.CreateNewField(Names.ERROR_REASON_0003_d2, FieldType.String, 20);
                   KDOR_DL_ERROR_RECORD_0003ET.CreateNewFieldRedefine(Names.ERROR_REASON_0003XX, FieldType.String, ERROR_REASON_0003_d2_local, 20);
               });
           });
    ...
    public class SWEXIE04 : EABBase
    {
        ...
        public SWEXIE04()
            : base()
        {
            this.ProgramName.SetValue("SWEXIE04");

            WS = new SWEXIE04_ws();
            FD = new SWEXIE04_fd(WS);
            LS = new SWEXIE04_ls();
        }
        ...
        private SWEXIE04_ws WS;

        //==== File Data Class ========================================
        private SWEXIE04_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXIE04_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1838941558(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1838941558
        /// </summary>
        private void M_MAIN_1838941558(string returnMethod = "")
        {
            M_PARA_1838941558_INIT("M_PARA_1838941558_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1838941558-INIT THRU PARA-1838941558-INIT-EXIT
            M_PARA_1838941558("M_PARA_1838941558_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1838941558 THRU PARA-1838941558-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1838941558
        /// </summary>
        private void M_PARA_1838941558(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1838941558") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.KDOR_DL_ERROR_RECORD_0003ET.SetValueCorresponding(FD.INPUT_RECORD);                              //COBOL==> MOVE CORR INPUT-RECORD TO KDOR-DL-ERROR-RECORD-0003ET
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1838941558_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1838941558_EXIT
        /// </summary>
        private void M_PARA_1838941558_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1838941558_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1838941558_EXIT") { M_PARA_1838941558_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1838941558_INIT
        /// </summary>
        private void M_PARA_1838941558_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1838941558_INIT") { M_PARA_1838941558_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1838941558_INIT_EXIT
        /// </summary>
        private void M_PARA_1838941558_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1838941558_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
