...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:47:39 PM
   **        *   FROM COBOL PGM   :  SWEXFE48
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: FN_B677_READ_AE_INTERFACE        DATE: 2005/09/19
       TARGET OS:   MVS                       TIME: 08:54:16
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXFE48_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXFE48_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXTRACT_RECORD.CreateNewFillerField(10, FillWith.Hashes);
               EXTRACT_RECORD.CreateNewField(Names.CSP_NUMBER, FieldType.String, 10);
               EXTRACT_RECORD.CreateNewFillerField(287, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            EXTRACT_FILE = FileHandler.GetFile("HKAE");
        ...
        #region Constructors
        public SWEXFE48_fd(SWEXFE48_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXFE48_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXFE48_ws_WorkingStorage";
    ...
    internal class SWEXFE48_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXFE48_ls_LinkageSection";
            ...
            internal const string S1168115059_0002EV = "S1168115059_0002EV";
        ...
        public IGroup S1168115059_0002EV { get { return GetElementByName<IGroup>(Names.S1168115059_0002EV); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.IMPORT_0001EV, (IMPORT_0001EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.S1168115059_0002EV, (S1168115059_0002EV) =>
           {
               S1168115059_0002EV.CreateNewGroup(Names.DISPLACED_PERSON_0002ET, (DISPLACED_PERSON_0002ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(S1168115059_0002EV, args, 4);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(S1168115059_0002EV, args, 4);
    ...
    public class SWEXFE48 : EABBase
    {
        ...
        public SWEXFE48()
            : base()
        {
            this.ProgramName.SetValue("SWEXFE48");

            WS = new SWEXFE48_ws();
            FD = new SWEXFE48_fd(WS);
            LS = new SWEXFE48_ls();
        }
        ...
        private SWEXFE48_ws WS;

        //==== File Data Class ========================================
        private SWEXFE48_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXFE48_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , S1168115059-0002EV , EXPORT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1168115046(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1168115046
        /// </summary>
        private void M_MAIN_1168115046(string returnMethod = "")
        {
            M_PARA_1168115046_INIT("M_PARA_1168115046_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1168115046-INIT THRU PARA-1168115046-INIT-EXIT
            M_PARA_1168115046("M_PARA_1168115046_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1168115046 THRU PARA-1168115046-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1168115046
        /// </summary>
        private void M_PARA_1168115046(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1168115046") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1168115046_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1168115046_EXIT
        /// </summary>
        private void M_PARA_1168115046_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1168115046_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1168115046_EXIT") { M_PARA_1168115046_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1168115046_INIT
        /// </summary>
        private void M_PARA_1168115046_INIT(string returnMethod = "")
        {
            LS.S1168115059_0002EV.ResetToInitialValue();                                                        //COBOL==> INITIALIZE S1168115059-0002EV
            LS.EXPORT_0003EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1168115046_INIT") { M_PARA_1168115046_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1168115046_INIT_EXIT
        /// </summary>
        private void M_PARA_1168115046_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1168115046_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
