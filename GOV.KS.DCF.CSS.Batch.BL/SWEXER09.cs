...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:38 PM
   **        *   FROM COBOL PGM   :  SWEXER09
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_KDMV_RESPONSE             DATE: 2008/03/10
       TARGET OS:   MVS                       TIME: 15:39:10
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXER09_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER09_fd_FileSection";
        ...
        {
            recordDef.CreateNewField(Names.EXTFILE_RECORD, FieldType.String, 250);
        ...
        public override void Initialize()
        {
            ...
            EXTFILE.StatusField = WS.KDORIN_STAT;
            EXTFILE.AssociatedBuffer = EXTFILE_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXER09_fd(SWEXER09_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER09_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER09_ws_WorkingStorage";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.WS_KDORIN, (WS_KDORIN) =>
           {
               ...
               WS_KDORIN.CreateNewFillerField(185, FillWith.Hashes);
           });
    ...
    internal class SWEXER09_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER09_ls_LinkageSection";
            ...
            internal const string PROCESS_STATUS_0002AS = "PROCESS_STATUS_0002AS";
            internal const string PROCESS_STATUS_0002 = "PROCESS_STATUS_0002";
            internal const string PROCESS_STATUS_0002XX = "PROCESS_STATUS_0002XX";
        ...
        public IField PROCESS_STATUS_0002AS { get { return GetElementByName<IField>(Names.PROCESS_STATUS_0002AS); } }
        public IField PROCESS_STATUS_0002 { get { return GetElementByName<IField>(Names.PROCESS_STATUS_0002); } }
        public IField PROCESS_STATUS_0002XX { get { return GetElementByName<IField>(Names.PROCESS_STATUS_0002XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_0002EV, (EXPORT_0002EV) =>
           {
               EXPORT_0002EV.CreateNewGroup(Names.KDMV_FILE_0002ET, (KDMV_FILE_0002ET) =>
               {
                   ...
                   IField DMV_PROBLEM_TEXT_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.DMV_PROBLEM_TEXT_0002, FieldType.String, 30);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.DMV_PROBLEM_TEXT_0002XX, FieldType.String, DMV_PROBLEM_TEXT_0002_local, 30);
                   ...
                   KDMV_FILE_0002ET.CreateNewField(Names.PROCESS_STATUS_0002AS, FieldType.String, 1);

                   IField PROCESS_STATUS_0002_local = KDMV_FILE_0002ET.CreateNewField(Names.PROCESS_STATUS_0002, FieldType.String, 1);
                   KDMV_FILE_0002ET.CreateNewFieldRedefine(Names.PROCESS_STATUS_0002XX, FieldType.String, PROCESS_STATUS_0002_local, 1);
               });
           });
    ...
    public class SWEXER09 : EABBase
    {
        ...
        public SWEXER09()
            : base()
        {
            this.ProgramName.SetValue("SWEXER09");

            WS = new SWEXER09_ws();
            FD = new SWEXER09_fd(WS);
            LS = new SWEXER09_ls();
        }
        ...
        private SWEXER09_ws WS;

        //==== File Data Class ========================================
        private SWEXER09_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER09_ls LS;
        #endregion
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1230586067(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1230586067
        /// </summary>
        private void M_MAIN_1230586067(string returnMethod = "")
        {
            M_PARA_1230586067_INIT("M_PARA_1230586067_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1230586067-INIT THRU PARA-1230586067-INIT-EXIT
            M_PARA_1230586067("M_PARA_1230586067_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1230586067 THRU PARA-1230586067-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1230586067
        /// </summary>
        private void M_PARA_1230586067(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZE72 IS A PART OF SWEXER09*
            //COMMENT: ******************************************
        ...
        private void M_0100_OPEN(string returnMethod = "")
        {
            ...
            {
                LS.NUMERIC_RETURN_CODE_0003.SetValue(WS.KDORIN_STAT);                                               //COBOL==> MOVE KDORIN-STAT TO NUMERIC-RETURN-CODE-0003
            }                                                                                                   //COBOL==> ELSE
            else
            {
        ...
        {
            WS.WS_KDORIN.SetValue(FD.EXTFILE.ReadLineInto());                                                   //COBOL==> READ EXTFILE INTO WS-KDORIN.
            if (WS.KDORIN_STAT.IsEqualTo(10))                                                                   //COBOL==> IF KDORIN-STAT = 10
            {
                LS.TEXT_LINE_80_0003.SetValue("REACHED END OF KDOR RESPONSE FILE");                                 //COBOL==> MOVE 'REACHED END OF KDOR RESPONSE FILE' TO TEXT-LINE-80-0003
            ...
            LS.CSE_PERSON_NUMBER_0002.SetValue(WS.CSE_PERSON_NUMBER);                                           //COBOL==> MOVE CSE-PERSON-NUMBER TO CSE-PERSON-NUMBER-0002
            ...
            LS.DOB_0002.SetValue(WS.DOB);                                                                       //COBOL==> MOVE DOB TO DOB-0002
            LS.DRIVER_LICENSE_NUMBER_0002.SetValue(WS.DRIVER_LICENSE_NUM);                                      //COBOL==> MOVE DRIVER-LICENSE-NUM TO DRIVER-LICENSE-NUMBER-0002
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1230586067_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230586067_EXIT
        /// </summary>
        private void M_PARA_1230586067_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230586067_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1230586067_EXIT") { M_PARA_1230586067_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230586067_INIT
        /// </summary>
        private void M_PARA_1230586067_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1230586067_INIT") { M_PARA_1230586067_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1230586067_INIT_EXIT
        /// </summary>
        private void M_PARA_1230586067_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1230586067_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
