...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:44:40 PM
   **        *   FROM COBOL PGM   :  SWEXEW15
...
/* Original Program Identification Comments
   ***************************************************************
       ...
       NAME: OE_EAB_WRITE_AP_DEBT_DERIVATION  DATE: 2012/08/16
       TARGET OS:   MVS                       TIME: 09:06:00
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXEW15_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXEW15_fd_FileSection";
            internal const string LREFOUT = "LREFOUT";
            internal const string LREFOUT_RECORD = "LREFOUT_RECORD";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink LREFOUT { get; set; }
        public IField LREFOUT_RECORD { get { return GetElementByName<IField>(Names.LREFOUT_RECORD); } }


        internal SWEXEW15_ws WS;
        #endregion
        ...
        {
            recordDef.CreateNewField(Names.LREFOUT_RECORD, FieldType.String, 220);
        ...
        public override void Initialize()
        {
            ...
            LREFOUT = FileHandler.GetFile("LREFOUT");
            LREFOUT.StatusField = WS.LREFOUT_STAT;
            LREFOUT.AssociatedBuffer = LREFOUT_RECORD;
        }
        #endregion

        #region Constructors
        public SWEXEW15_fd(SWEXEW15_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXEW15_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXEW15_ws_WorkingStorage";
            internal const string LREFOUT_STAT = "LREFOUT_STAT";
            ...
            internal const string WS_LREFOUT = "WS_LREFOUT";
            ...
            internal const string CASE_NUMBER1 = "CASE_NUMBER1";
            internal const string CASE_NUMBER2 = "CASE_NUMBER2";
            internal const string CASE_NUMBER3 = "CASE_NUMBER3";
            internal const string CASE_NUMBER4 = "CASE_NUMBER4";
            internal const string CASE_NUMBER5 = "CASE_NUMBER5";
            internal const string STANDARD_NUMBER = "STANDARD_NUMBER";
            internal const string SUMMED_AMOUNT = "SUMMED_AMOUNT";
            internal const string STREET_1 = "STREET_1";
            internal const string STREET_2 = "STREET_2";
            internal const string CITY = "CITY";
            internal const string STATE = "STATE";
            internal const string ZIP = "ZIP";
            internal const string ZIP4 = "ZIP4";
            internal const string WS_CASE_NUMBERS = "WS_CASE_NUMBERS";
            internal const string CASE_NUMBER1A = "CASE_NUMBER1A";
            internal const string CASE_NUMBER2A = "CASE_NUMBER2A";
            internal const string CASE_NUMBER3A = "CASE_NUMBER3A";
            internal const string CASE_NUMBER4A = "CASE_NUMBER4A";
            internal const string CASE_NUMBER5A = "CASE_NUMBER5A";
        }
        #endregion

        #region Direct-access element properties
        public IField LREFOUT_STAT { get { return GetExternalElementByName<IField>(Names.LREFOUT_STAT); } }
        ...
        public IGroup WS_LREFOUT { get { return GetElementByName<IGroup>(Names.WS_LREFOUT); } }
        ...
        public IField CASE_NUMBER1 { get { return GetElementByName<IField>(Names.CASE_NUMBER1); } }
        public IField CASE_NUMBER2 { get { return GetElementByName<IField>(Names.CASE_NUMBER2); } }
        public IField CASE_NUMBER3 { get { return GetElementByName<IField>(Names.CASE_NUMBER3); } }
        public IField CASE_NUMBER4 { get { return GetElementByName<IField>(Names.CASE_NUMBER4); } }
        public IField CASE_NUMBER5 { get { return GetElementByName<IField>(Names.CASE_NUMBER5); } }
        public IField STANDARD_NUMBER { get { return GetElementByName<IField>(Names.STANDARD_NUMBER); } }
        public IField SUMMED_AMOUNT { get { return GetElementByName<IField>(Names.SUMMED_AMOUNT); } }
        public IField STREET_1 { get { return GetElementByName<IField>(Names.STREET_1); } }
        public IField STREET_2 { get { return GetElementByName<IField>(Names.STREET_2); } }
        ...
        public IField ZIP { get { return GetElementByName<IField>(Names.ZIP); } }
        public IField ZIP4 { get { return GetElementByName<IField>(Names.ZIP4); } }
        public IGroup WS_CASE_NUMBERS { get { return GetElementByName<IGroup>(Names.WS_CASE_NUMBERS); } }
        public IField CASE_NUMBER1A { get { return GetElementByName<IField>(Names.CASE_NUMBER1A); } }
        public IField CASE_NUMBER2A { get { return GetElementByName<IField>(Names.CASE_NUMBER2A); } }
        public IField CASE_NUMBER3A { get { return GetElementByName<IField>(Names.CASE_NUMBER3A); } }
        public IField CASE_NUMBER4A { get { return GetElementByName<IField>(Names.CASE_NUMBER4A); } }
        public IField CASE_NUMBER5A { get { return GetElementByName<IField>(Names.CASE_NUMBER5A); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            WsExternals.Instance.CreateNewField(Names.LREFOUT_STAT, FieldType.UnsignedNumeric, 2);
           ...
           {
               WS_MISC.CreateNewField(Names.WS_ENTRY, FieldType.String, 40, "SWEXEW10 WORKING STORAGE STARTS HERE");
            ...
            recordDef.CreateNewGroup(Names.WS_LREFOUT, (WS_LREFOUT) =>
           {
               WS_LREFOUT.CreateNewField(Names.FIRST_NAME, FieldType.String, 12);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.LAST_NAME, FieldType.String, 18);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.AP_NUMBER, FieldType.String, 10);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.CASE_NUMBER1, FieldType.String, 10);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.CASE_NUMBER2, FieldType.String, 10);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.CASE_NUMBER3, FieldType.String, 10);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.CASE_NUMBER4, FieldType.String, 10);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.CASE_NUMBER5, FieldType.String, 10);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.STANDARD_NUMBER, FieldType.String, 20);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.SUMMED_AMOUNT, FieldType.String, 11);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.STREET_1, FieldType.String, 25);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.STREET_2, FieldType.String, 25);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.CITY, FieldType.String, 15);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.STATE, FieldType.String, 2);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.ZIP, FieldType.String, 5);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewField(Names.ZIP4, FieldType.String, 4);
               WS_LREFOUT.CreateNewFillerField(FieldType.String, 1, ";");
               WS_LREFOUT.CreateNewFillerField(4, FillWith.Hashes);
           });

            recordDef.CreateNewGroup(Names.WS_CASE_NUMBERS, (WS_CASE_NUMBERS) =>
           {
               WS_CASE_NUMBERS.CreateNewField(Names.CASE_NUMBER1A, FieldType.String, 10);
               WS_CASE_NUMBERS.CreateNewFillerField(1, FillWith.Hashes);
               WS_CASE_NUMBERS.CreateNewField(Names.CASE_NUMBER2A, FieldType.String, 10);
               WS_CASE_NUMBERS.CreateNewFillerField(1, FillWith.Hashes);
               WS_CASE_NUMBERS.CreateNewField(Names.CASE_NUMBER3A, FieldType.String, 10);
               WS_CASE_NUMBERS.CreateNewFillerField(1, FillWith.Hashes);
               WS_CASE_NUMBERS.CreateNewField(Names.CASE_NUMBER4A, FieldType.String, 10);
               WS_CASE_NUMBERS.CreateNewFillerField(1, FillWith.Hashes);
               WS_CASE_NUMBERS.CreateNewField(Names.CASE_NUMBER5A, FieldType.String, 10);
               WS_CASE_NUMBERS.CreateNewFillerField(6, FillWith.Hashes);
           });
    ...
    internal class SWEXEW15_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXEW15_ls_LinkageSection";
            ...
            internal const string STANDARD_NUMBER_0002AS = "STANDARD_NUMBER_0002AS";
            ...
            internal const string IMPORT_CASES_0003EV = "IMPORT_CASES_0003EV";
            internal const string WORK_AREA_0003ET = "WORK_AREA_0003ET";
            internal const string TEXT_60_0003AS = "TEXT_60_0003AS";
            internal const string TEXT_60_0003 = "TEXT_60_0003";
            internal const string TEXT_60_0003XX = "TEXT_60_0003XX";
            internal const string IMPORT_SUMMED_AMOUNT_0004EV = "IMPORT_SUMMED_AMOUNT_0004EV";
            internal const string WORK_AREA_0004ET = "WORK_AREA_0004ET";
            internal const string TEXT_11_0004AS = "TEXT_11_0004AS";
            internal const string TEXT_11_0004 = "TEXT_11_0004";
            internal const string TEXT_11_0004XX = "TEXT_11_0004XX";
        ...
        public IField STANDARD_NUMBER_0002AS { get { return GetElementByName<IField>(Names.STANDARD_NUMBER_0002AS); } }
        ...
        public IGroup IMPORT_CASES_0003EV { get { return GetElementByName<IGroup>(Names.IMPORT_CASES_0003EV); } }
        public IGroup WORK_AREA_0003ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0003ET); } }
        public IField TEXT_60_0003AS { get { return GetElementByName<IField>(Names.TEXT_60_0003AS); } }
        public IField TEXT_60_0003 { get { return GetElementByName<IField>(Names.TEXT_60_0003); } }
        public IField TEXT_60_0003XX { get { return GetElementByName<IField>(Names.TEXT_60_0003XX); } }
        public IGroup IMPORT_SUMMED_AMOUNT_0004EV { get { return GetElementByName<IGroup>(Names.IMPORT_SUMMED_AMOUNT_0004EV); } }
        public IGroup WORK_AREA_0004ET { get { return GetElementByName<IGroup>(Names.WORK_AREA_0004ET); } }
        public IField TEXT_11_0004AS { get { return GetElementByName<IField>(Names.TEXT_11_0004AS); } }
        public IField TEXT_11_0004 { get { return GetElementByName<IField>(Names.TEXT_11_0004); } }
        public IField TEXT_11_0004XX { get { return GetElementByName<IField>(Names.TEXT_11_0004XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               IMPORT_0002EV.CreateNewGroup(Names.LEGAL_ACTION_0002ET, (LEGAL_ACTION_0002ET) =>
               {
                   LEGAL_ACTION_0002ET.CreateNewField(Names.STANDARD_NUMBER_0002AS, FieldType.String, 1);
            ...
            recordDef.CreateNewGroup(Names.IMPORT_CASES_0003EV, (IMPORT_CASES_0003EV) =>
           {
               IMPORT_CASES_0003EV.CreateNewGroup(Names.WORK_AREA_0003ET, (WORK_AREA_0003ET) =>
               {
                   WORK_AREA_0003ET.CreateNewField(Names.TEXT_60_0003AS, FieldType.String, 1);

                   IField TEXT_60_0003_local = WORK_AREA_0003ET.CreateNewField(Names.TEXT_60_0003, FieldType.String, 60);
                   WORK_AREA_0003ET.CreateNewFieldRedefine(Names.TEXT_60_0003XX, FieldType.String, TEXT_60_0003_local, 60);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_SUMMED_AMOUNT_0004EV, (IMPORT_SUMMED_AMOUNT_0004EV) =>
           {
               IMPORT_SUMMED_AMOUNT_0004EV.CreateNewGroup(Names.WORK_AREA_0004ET, (WORK_AREA_0004ET) =>
               {
                   WORK_AREA_0004ET.CreateNewField(Names.TEXT_11_0004AS, FieldType.String, 1);

                   IField TEXT_11_0004_local = WORK_AREA_0004ET.CreateNewField(Names.TEXT_11_0004, FieldType.String, 11);
                   WORK_AREA_0004ET.CreateNewFieldRedefine(Names.TEXT_11_0004XX, FieldType.String, TEXT_11_0004_local, 11);
               });
           });

            recordDef.CreateNewGroup(Names.IMPORT_0005EV, (IMPORT_0005EV) =>
           {
               IMPORT_0005EV.CreateNewGroup(Names.CSE_PERSON_ADDRESS_0005ET, (CSE_PERSON_ADDRESS_0005ET) =>
               {
           ...
           {
               EXPORT_0007EV.CreateNewGroup(Names.EXTERNAL_0007ET, (EXTERNAL_0007ET) =>
               {
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(IMPORT_CASES_0003EV, args, 5);
            SetPassedParm(IMPORT_SUMMED_AMOUNT_0004EV, args, 6);
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(IMPORT_CASES_0003EV, args, 5);
            SetReturnParm(IMPORT_SUMMED_AMOUNT_0004EV, args, 6);
    ...
    public class SWEXEW15 : EABBase
    {
        ...
        public SWEXEW15()
            : base()
        {
            this.ProgramName.SetValue("SWEXEW15");

            WS = new SWEXEW15_ws();
            FD = new SWEXEW15_fd(WS);
            LS = new SWEXEW15_ls();
        }
        ...
        private SWEXEW15_ws WS;

        //==== File Data Class ========================================
        private SWEXEW15_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXEW15_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , IMPORT-0002EV , IMPORT-CASES-0003EV , IMPORT-SUMMED-AMOUNT-0004EV , IMPORT-0005EV , IMPORT-0006EV , EXPORT-0007EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1266553794(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1266553794
        /// </summary>
        private void M_MAIN_1266553794(string returnMethod = "")
        {
            M_PARA_1266553794_INIT("M_PARA_1266553794_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1266553794-INIT THRU PARA-1266553794-INIT-EXIT
            M_PARA_1266553794("M_PARA_1266553794_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1266553794 THRU PARA-1266553794-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1266553794
        /// </summary>
        private void M_PARA_1266553794(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT: ******************************************
            //COMMENT:  THIS  CODE SWCSZF30 IS A PART OF SWEXEW15*
            //COMMENT: ******************************************
            ...
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("AB");                                                            //COBOL==> MOVE 'AB' TO TEXT-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-EVALUATE
        ...
        {
            FD.LREFOUT.OpenFile(FileAccessMode.Write);                                                          //COBOL==> OPEN OUTPUT LREFOUT.
            if (!(WS.LREFOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF LREFOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("OP");                                                            //COBOL==> MOVE 'OP' TO TEXT-RETURN-CODE-0007
                LS.TEXT_LINE_80_0007.SetValue("AN ERROR OCCURRED ON OPEN ");                                        //COBOL==> MOVE 'AN ERROR OCCURRED ON OPEN ' TO TEXT-LINE-80-0007
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.LREFOUT_STAT);                                              //COBOL==> MOVE LREFOUT-STAT TO NUMERIC-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.LREFOUT_RECORD.SetValueWithSpaces();                                                             //COBOL==> MOVE SPACES TO LREFOUT-RECORD.
            FD.LREFOUT_RECORD.SetValue(WS.WS_LREFOUT);                                                          //COBOL==> MOVE WS-LREFOUT TO LREFOUT-RECORD.
            FD.LREFOUT.WriteLine(FD.LREFOUT_RECORD.AsBytes);                                                    //COBOL==> WRITE LREFOUT-RECORD.
            if (!(WS.LREFOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF LREFOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("WR");                                                            //COBOL==> MOVE 'WR' TO TEXT-RETURN-CODE-0007
                LS.TEXT_LINE_80_0007.SetValue("AN ERROR OCCURRED IN WRITTING");                                     //COBOL==> MOVE 'AN ERROR OCCURRED IN WRITTING' TO TEXT-LINE-80-0007
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.LREFOUT_STAT);                                              //COBOL==> MOVE LREFOUT-STAT TO NUMERIC-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            FD.LREFOUT.CloseFile();                                                                             //COBOL==> CLOSE LREFOUT
            if (!(WS.LREFOUT_STAT.IsEqualTo(00)))                                                               //COBOL==> IF LREFOUT-STAT NOT = 00
            {
                LS.TEXT_RETURN_CODE_0007.SetValue("CL");                                                            //COBOL==> MOVE 'CL' TO TEXT-RETURN-CODE-0007
                LS.TEXT_LINE_80_0007.SetValue("ERROR IN CLOSING FILE");                                             //COBOL==> MOVE 'ERROR IN CLOSING FILE' TO TEXT-LINE-80-0007
                LS.NUMERIC_RETURN_CODE_0007.SetValue(WS.LREFOUT_STAT);                                              //COBOL==> MOVE LREFOUT-STAT TO NUMERIC-RETURN-CODE-0007
            }                                                                                                   //COBOL==> END-IF.
        ...
        {
            //COMMENT:       MOVE SPACES TO WS-LREFOUT
            ...
            WS.AP_NUMBER.SetValue(LS.NUMBER_0001);                                                              //COBOL==> MOVE NUMBER-0001 TO AP-NUMBER
            WS.STANDARD_NUMBER.SetValue(LS.STANDARD_NUMBER_0002);                                               //COBOL==> MOVE STANDARD-NUMBER-0002 TO STANDARD-NUMBER
            WS.WS_CASE_NUMBERS.SetValue(LS.TEXT_60_0003);                                                       //COBOL==> MOVE TEXT-60-0003 TO WS-CASE-NUMBERS
            WS.CASE_NUMBER1.SetValue(WS.CASE_NUMBER1A);                                                         //COBOL==> MOVE CASE-NUMBER1A TO CASE-NUMBER1
            WS.CASE_NUMBER2.SetValue(WS.CASE_NUMBER2A);                                                         //COBOL==> MOVE CASE-NUMBER2A TO CASE-NUMBER2
            WS.CASE_NUMBER3.SetValue(WS.CASE_NUMBER3A);                                                         //COBOL==> MOVE CASE-NUMBER3A TO CASE-NUMBER3
            WS.CASE_NUMBER4.SetValue(WS.CASE_NUMBER4A);                                                         //COBOL==> MOVE CASE-NUMBER4A TO CASE-NUMBER4
            WS.CASE_NUMBER5.SetValue(WS.CASE_NUMBER5A);                                                         //COBOL==> MOVE CASE-NUMBER5A TO CASE-NUMBER5
            WS.SUMMED_AMOUNT.SetValue(LS.TEXT_11_0004);                                                         //COBOL==> MOVE TEXT-11-0004 TO SUMMED-AMOUNT
            WS.STREET_1.SetValue(LS.STREET_1_0005);                                                             //COBOL==> MOVE STREET-1-0005 TO STREET-1
            WS.STREET_2.SetValue(LS.STREET_2_0005);                                                             //COBOL==> MOVE STREET-2-0005 TO STREET-2
            WS.CITY.SetValue(LS.CITY_0005);                                                                     //COBOL==> MOVE CITY-0005 TO CITY
            WS.STATE.SetValue(LS.STATE_0005);                                                                   //COBOL==> MOVE STATE-0005 TO STATE
            WS.ZIP.SetValue(LS.ZIP_CODE_0005);                                                                  //COBOL==> MOVE ZIP-CODE-0005 TO ZIP
            WS.ZIP4.SetValue(LS.ZIP4_0005);                                                                     //COBOL==> MOVE ZIP4-0005 TO ZIP4
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1266553794_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266553794_EXIT
        /// </summary>
        private void M_PARA_1266553794_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266553794_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1266553794_EXIT") { M_PARA_1266553794_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266553794_INIT
        /// </summary>
        private void M_PARA_1266553794_INIT(string returnMethod = "")
        {
            LS.EXPORT_0007EV.ResetToInitialValue();                                                             //COBOL==> INITIALIZE EXPORT-0007EV .
            if (returnMethod != "" && returnMethod != "M_PARA_1266553794_INIT") { M_PARA_1266553794_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1266553794_INIT_EXIT
        /// </summary>
        private void M_PARA_1266553794_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1266553794_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
