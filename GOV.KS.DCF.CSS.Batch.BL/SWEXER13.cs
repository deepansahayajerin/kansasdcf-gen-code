...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:43:44 PM
   **        *   FROM COBOL PGM   :  SWEXER13
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: OE_EAB_READ_OUT_FCR_ALERT_RECORD DATE: 2009/02/04
       TARGET OS:   MVS                       TIME: 09:12:45
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXER13_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXER13_fd_FileSection";
            internal const string FCR_OUT_ALERT_FILE = "FCR_OUT_ALERT_FILE";
            internal const string FCR_ALERT_REC = "FCR_ALERT_REC";
            internal const string SSNOUT_CASE_ID = "SSNOUT_CASE_ID";
            internal const string SSNOUT_CASE_ID_FILLER = "SSNOUT_CASE_ID_FILLER";
            internal const string SSNOUT_PERSON_NUMBER_ZEROS = "SSNOUT_PERSON_NUMBER_ZEROS";
            internal const string SSNOUT_PERSON_NUMBER = "SSNOUT_PERSON_NUMBER";
            internal const string SSNOUT_FCR_SSN = "SSNOUT_FCR_SSN";
            internal const string SSNOUT_CSE_SSN = "SSNOUT_CSE_SSN";
            internal const string SSNOUT_FCR_ADDITIONAL_SSN1 = "SSNOUT_FCR_ADDITIONAL_SSN1";
            internal const string SSNOUT_FCR_ADDITIONAL_SSN2 = "SSNOUT_FCR_ADDITIONAL_SSN2";
            internal const string SSNOUT_CSE_ADDITIONAL_SSN1 = "SSNOUT_CSE_ADDITIONAL_SSN1";
            internal const string SSNOUT_CSE_ADDITIONAL_SSN2 = "SSNOUT_CSE_ADDITIONAL_SSN2";
        }
        #endregion

        #region Direct-access element properties
        public IFileLink FCR_OUT_ALERT_FILE { get; set; }
        public IGroup FCR_ALERT_REC { get { return GetElementByName<IGroup>(Names.FCR_ALERT_REC); } }
        public IField SSNOUT_CASE_ID { get { return GetElementByName<IField>(Names.SSNOUT_CASE_ID); } }
        public IField SSNOUT_CASE_ID_FILLER { get { return GetElementByName<IField>(Names.SSNOUT_CASE_ID_FILLER); } }
        public IField SSNOUT_PERSON_NUMBER_ZEROS { get { return GetElementByName<IField>(Names.SSNOUT_PERSON_NUMBER_ZEROS); } }
        public IField SSNOUT_PERSON_NUMBER { get { return GetElementByName<IField>(Names.SSNOUT_PERSON_NUMBER); } }
        public IField SSNOUT_FCR_SSN { get { return GetElementByName<IField>(Names.SSNOUT_FCR_SSN); } }
        public IField SSNOUT_CSE_SSN { get { return GetElementByName<IField>(Names.SSNOUT_CSE_SSN); } }
        public IField SSNOUT_FCR_ADDITIONAL_SSN1 { get { return GetElementByName<IField>(Names.SSNOUT_FCR_ADDITIONAL_SSN1); } }
        public IField SSNOUT_FCR_ADDITIONAL_SSN2 { get { return GetElementByName<IField>(Names.SSNOUT_FCR_ADDITIONAL_SSN2); } }
        public IField SSNOUT_CSE_ADDITIONAL_SSN1 { get { return GetElementByName<IField>(Names.SSNOUT_CSE_ADDITIONAL_SSN1); } }
        public IField SSNOUT_CSE_ADDITIONAL_SSN2 { get { return GetElementByName<IField>(Names.SSNOUT_CSE_ADDITIONAL_SSN2); } }


        internal SWEXER13_ws WS;
        #endregion
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.FCR_ALERT_REC, (FCR_ALERT_REC) =>
           {
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_CASE_ID, FieldType.String, 10);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_CASE_ID_FILLER, FieldType.String, 5);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_PERSON_NUMBER_ZEROS, FieldType.String, 5);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_PERSON_NUMBER, FieldType.String, 10);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_FCR_SSN, FieldType.String, 9);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_CSE_SSN, FieldType.String, 9);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_FCR_ADDITIONAL_SSN1, FieldType.String, 9);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_FCR_ADDITIONAL_SSN2, FieldType.String, 9);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_CSE_ADDITIONAL_SSN1, FieldType.String, 9);
               FCR_ALERT_REC.CreateNewField(Names.SSNOUT_CSE_ADDITIONAL_SSN2, FieldType.String, 9);
               FCR_ALERT_REC.CreateNewFillerField(16, FillWith.Hashes);
           });
        ...
        public override void Initialize()
        {
            ...
            FCR_OUT_ALERT_FILE = FileHandler.GetFile("FCRALRT");
            FCR_OUT_ALERT_FILE.StatusField = WS.FCRALRT_STAT;
            FCR_OUT_ALERT_FILE.AssociatedBuffer = FCR_ALERT_REC;
        }
        #endregion

        #region Constructors
        public SWEXER13_fd(SWEXER13_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXER13_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXER13_ws_WorkingStorage";
            internal const string FCRALRT_STAT = "FCRALRT_STAT";
            internal const string WS_LITERALS_AND_CNTRS = "WS_LITERALS_AND_CNTRS";
            internal const string ALERT_EOF = "ALERT_EOF";
            internal const string NO_MORE_ALERTS = "NO_MORE_ALERTS";
        }
        #endregion

        #region Direct-access element properties
        public IField FCRALRT_STAT { get { return GetElementByName<IField>(Names.FCRALRT_STAT); } }
        public IGroup WS_LITERALS_AND_CNTRS { get { return GetElementByName<IGroup>(Names.WS_LITERALS_AND_CNTRS); } }
        public IField ALERT_EOF { get { return GetElementByName<IField>(Names.ALERT_EOF); } }
        public ICheckField NO_MORE_ALERTS { get { return GetElementByName<ICheckField>(Names.NO_MORE_ALERTS); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            recordDef.CreateNewField(Names.FCRALRT_STAT, FieldType.String, 2, SPACES);

            recordDef.CreateNewGroup(Names.WS_LITERALS_AND_CNTRS, (WS_LITERALS_AND_CNTRS) =>
           {
               WS_LITERALS_AND_CNTRS.CreateNewField(Names.ALERT_EOF, FieldType.String, 1, "N")
                   .NewCheckField(Names.NO_MORE_ALERTS, "Y")
                   ;
           });
    ...
    internal class SWEXER13_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXER13_ls_LinkageSection";
            ...
            internal const string EXPORT_FCR_ALERT_0003EV = "EXPORT_FCR_ALERT_0003EV";
            internal const string FCR_ALERT_RECORD_0003ET = "FCR_ALERT_RECORD_0003ET";
            ...
            internal const string PERSON_ID_0003AS = "PERSON_ID_0003AS";
            internal const string PERSON_ID_0003 = "PERSON_ID_0003";
            internal const string PERSON_ID_0003XX = "PERSON_ID_0003XX";
            internal const string FCR_SSN_0003AS = "FCR_SSN_0003AS";
            internal const string FCR_SSN_0003 = "FCR_SSN_0003";
            internal const string FCR_SSN_0003XX = "FCR_SSN_0003XX";
            internal const string CSE_SSN_0003AS = "CSE_SSN_0003AS";
            internal const string CSE_SSN_0003 = "CSE_SSN_0003";
            internal const string CSE_SSN_0003XX = "CSE_SSN_0003XX";
            internal const string CSE_ADDITIONAL_SSN1_0003AS = "CSE_ADDITIONAL_SSN1_0003AS";
            internal const string CSE_ADDITIONAL_SSN1_0003 = "CSE_ADDITIONAL_SSN1_0003";
            internal const string CSE_ADDITIONAL_SSN1_0003XX = "CSE_ADDITIONAL_SSN1_0003XX";
            internal const string CSE_ADDITIONAL_SSN2_0003AS = "CSE_ADDITIONAL_SSN2_0003AS";
            internal const string CSE_ADDITIONAL_SSN2_0003 = "CSE_ADDITIONAL_SSN2_0003";
            internal const string CSE_ADDITIONAL_SSN2_0003XX = "CSE_ADDITIONAL_SSN2_0003XX";
            internal const string FCR_ADDITIONAL_SSN1_0003AS = "FCR_ADDITIONAL_SSN1_0003AS";
            internal const string FCR_ADDITIONAL_SSN1_0003 = "FCR_ADDITIONAL_SSN1_0003";
            internal const string FCR_ADDITIONAL_SSN1_0003XX = "FCR_ADDITIONAL_SSN1_0003XX";
            internal const string FCR_ADDITIONAL_SSN2_0003AS = "FCR_ADDITIONAL_SSN2_0003AS";
            internal const string FCR_ADDITIONAL_SSN2_0003 = "FCR_ADDITIONAL_SSN2_0003";
            internal const string FCR_ADDITIONAL_SSN2_0003XX = "FCR_ADDITIONAL_SSN2_0003XX";
        }
        #endregion
        ...
        public IGroup EXPORT_FCR_ALERT_0003EV { get { return GetElementByName<IGroup>(Names.EXPORT_FCR_ALERT_0003EV); } }
        public IGroup FCR_ALERT_RECORD_0003ET { get { return GetElementByName<IGroup>(Names.FCR_ALERT_RECORD_0003ET); } }
        ...
        public IField PERSON_ID_0003AS { get { return GetElementByName<IField>(Names.PERSON_ID_0003AS); } }
        public IField PERSON_ID_0003 { get { return GetElementByName<IField>(Names.PERSON_ID_0003); } }
        public IField PERSON_ID_0003XX { get { return GetElementByName<IField>(Names.PERSON_ID_0003XX); } }
        public IField FCR_SSN_0003AS { get { return GetElementByName<IField>(Names.FCR_SSN_0003AS); } }
        public IField FCR_SSN_0003 { get { return GetElementByName<IField>(Names.FCR_SSN_0003); } }
        public IField FCR_SSN_0003XX { get { return GetElementByName<IField>(Names.FCR_SSN_0003XX); } }
        public IField CSE_SSN_0003AS { get { return GetElementByName<IField>(Names.CSE_SSN_0003AS); } }
        public IField CSE_SSN_0003 { get { return GetElementByName<IField>(Names.CSE_SSN_0003); } }
        public IField CSE_SSN_0003XX { get { return GetElementByName<IField>(Names.CSE_SSN_0003XX); } }
        public IField CSE_ADDITIONAL_SSN1_0003AS { get { return GetElementByName<IField>(Names.CSE_ADDITIONAL_SSN1_0003AS); } }
        public IField CSE_ADDITIONAL_SSN1_0003 { get { return GetElementByName<IField>(Names.CSE_ADDITIONAL_SSN1_0003); } }
        public IField CSE_ADDITIONAL_SSN1_0003XX { get { return GetElementByName<IField>(Names.CSE_ADDITIONAL_SSN1_0003XX); } }
        public IField CSE_ADDITIONAL_SSN2_0003AS { get { return GetElementByName<IField>(Names.CSE_ADDITIONAL_SSN2_0003AS); } }
        public IField CSE_ADDITIONAL_SSN2_0003 { get { return GetElementByName<IField>(Names.CSE_ADDITIONAL_SSN2_0003); } }
        public IField CSE_ADDITIONAL_SSN2_0003XX { get { return GetElementByName<IField>(Names.CSE_ADDITIONAL_SSN2_0003XX); } }
        public IField FCR_ADDITIONAL_SSN1_0003AS { get { return GetElementByName<IField>(Names.FCR_ADDITIONAL_SSN1_0003AS); } }
        public IField FCR_ADDITIONAL_SSN1_0003 { get { return GetElementByName<IField>(Names.FCR_ADDITIONAL_SSN1_0003); } }
        public IField FCR_ADDITIONAL_SSN1_0003XX { get { return GetElementByName<IField>(Names.FCR_ADDITIONAL_SSN1_0003XX); } }
        public IField FCR_ADDITIONAL_SSN2_0003AS { get { return GetElementByName<IField>(Names.FCR_ADDITIONAL_SSN2_0003AS); } }
        public IField FCR_ADDITIONAL_SSN2_0003 { get { return GetElementByName<IField>(Names.FCR_ADDITIONAL_SSN2_0003); } }
        public IField FCR_ADDITIONAL_SSN2_0003XX { get { return GetElementByName<IField>(Names.FCR_ADDITIONAL_SSN2_0003XX); } }
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_EXTERNAL_FILE_ST_0002EV, (EXPORT_EXTERNAL_FILE_ST_0002EV) =>
           {
            ...
            recordDef.CreateNewGroup(Names.EXPORT_FCR_ALERT_0003EV, (EXPORT_FCR_ALERT_0003EV) =>
           {
               EXPORT_FCR_ALERT_0003EV.CreateNewGroup(Names.FCR_ALERT_RECORD_0003ET, (FCR_ALERT_RECORD_0003ET) =>
               {
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CASE_ID_0003AS, FieldType.String, 1);

                   IField CASE_ID_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CASE_ID_0003, FieldType.String, 10);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.CASE_ID_0003XX, FieldType.String, CASE_ID_0003_local, 10);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.PERSON_ID_0003AS, FieldType.String, 1);

                   IField PERSON_ID_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.PERSON_ID_0003, FieldType.String, 10);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.PERSON_ID_0003XX, FieldType.String, PERSON_ID_0003_local, 10);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.FCR_SSN_0003AS, FieldType.String, 1);

                   IField FCR_SSN_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.FCR_SSN_0003, FieldType.String, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.FCR_SSN_0003XX, FieldType.String, FCR_SSN_0003_local, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CSE_SSN_0003AS, FieldType.String, 1);

                   IField CSE_SSN_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CSE_SSN_0003, FieldType.String, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.CSE_SSN_0003XX, FieldType.String, CSE_SSN_0003_local, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CSE_ADDITIONAL_SSN1_0003AS, FieldType.String, 1);

                   IField CSE_ADDITIONAL_SSN1_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CSE_ADDITIONAL_SSN1_0003, FieldType.String, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.CSE_ADDITIONAL_SSN1_0003XX, FieldType.String, CSE_ADDITIONAL_SSN1_0003_local, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CSE_ADDITIONAL_SSN2_0003AS, FieldType.String, 1);

                   IField CSE_ADDITIONAL_SSN2_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.CSE_ADDITIONAL_SSN2_0003, FieldType.String, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.CSE_ADDITIONAL_SSN2_0003XX, FieldType.String, CSE_ADDITIONAL_SSN2_0003_local, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.FCR_ADDITIONAL_SSN1_0003AS, FieldType.String, 1);

                   IField FCR_ADDITIONAL_SSN1_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.FCR_ADDITIONAL_SSN1_0003, FieldType.String, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.FCR_ADDITIONAL_SSN1_0003XX, FieldType.String, FCR_ADDITIONAL_SSN1_0003_local, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewField(Names.FCR_ADDITIONAL_SSN2_0003AS, FieldType.String, 1);

                   IField FCR_ADDITIONAL_SSN2_0003_local = FCR_ALERT_RECORD_0003ET.CreateNewField(Names.FCR_ADDITIONAL_SSN2_0003, FieldType.String, 9);
                   FCR_ALERT_RECORD_0003ET.CreateNewFieldRedefine(Names.FCR_ADDITIONAL_SSN2_0003XX, FieldType.String, FCR_ADDITIONAL_SSN2_0003_local, 9);
               });
           });
        ...
        public void SetPassedParameters(object[] args)
        {
            ...
            SetPassedParm(EXPORT_FCR_ALERT_0003EV, args, 5);
        }
        ...
        public void UpdateReturnParameters(object[] args)
        {
            ...
            SetReturnParm(EXPORT_FCR_ALERT_0003EV, args, 5);
        }
    }
    #endregion Linkage Section Class

    #region Business Logic Class
    public class SWEXER13 : EABBase
    {
        ...
        public SWEXER13()
            : base()
        {
            this.ProgramName.SetValue("SWEXER13");

            WS = new SWEXER13_ws();
            FD = new SWEXER13_fd(WS);
            LS = new SWEXER13_ls();
        }
        ...
        private SWEXER13_ws WS;

        //==== File Data Class ========================================
        private SWEXER13_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXER13_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-EXTERNAL-FILE-ST-0001EV , EXPORT-EXTERNAL-FILE-ST-0002EV , EXPORT-FCR-ALERT-0003EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_0041158661(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_0041158661
        /// </summary>
        private void M_MAIN_0041158661(string returnMethod = "")
        {
            M_PARA_0041158661_INIT("M_PARA_0041158661_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-0041158661-INIT THRU PARA-0041158661-INIT-EXIT
            M_PARA_0041158661("M_PARA_0041158661_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-0041158661 THRU PARA-0041158661-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_0041158661
        /// </summary>
        private void M_PARA_0041158661(string returnMethod = "")
        {
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:    USER-WRITTEN CODE SHOULD BE INSERTED HERE
            //COMMENT:  * * * * * * * * * * * * * * * * * * * * * *
            //COMMENT:     ******************************************
            //COMMENT:     *THIS CODE SWCSZE36 IS A PART OF SWEXER13*
            //COMMENT:     ******************************************
            LS.FILE_INSTRUCTION_0002.SetValue(LS.FILE_INSTRUCTION_0001);                                        //COBOL==> MOVE FILE-INSTRUCTION-0001 TO FILE-INSTRUCTION-0002.
            LS.NUMERIC_RETURN_CODE_0002.ResetToInitialValue();                                                  //COBOL==> INITIALIZE NUMERIC-RETURN-CODE-0002 , TEXT-RETURN-CODE-0002 , TEXT-LINE-8-0002.
            LS.TEXT_RETURN_CODE_0002.ResetToInitialValue();
            LS.TEXT_LINE_8_0002.ResetToInitialValue();
            if (returnMethod != "" && returnMethod != "M_PARA_0041158661") { M_0000_MAIN_PARA(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_0000_MAIN_PARA(string returnMethod = "")
        {
            ...
            {
                M_1200_PROCESS_ALERTS("M_1200_EXIT"); if (Control.ExitProgram) { return; }                            //COBOL==> PERFORM 1200-PROCESS-ALERTS THRU 1200-EXIT
                M_9999_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 9999-EXIT
            }                                                                                                   //COBOL==> END-IF.
            ...
            LS.TEXT_RETURN_CODE_0002.SetValue("FN");                                                            //COBOL==> MOVE 'FN' TO TEXT-RETURN-CODE-0002.
            LS.TEXT_LINE_80_0002.SetValue("BAD FILE INSTRUCTION SENT");                                         //COBOL==> MOVE 'BAD FILE INSTRUCTION SENT' TO TEXT-LINE-80-0002.
        ...
        {
            FD.FCR_OUT_ALERT_FILE.OpenFile(FileAccessMode.Read);                                                //COBOL==> OPEN INPUT FCR-OUT-ALERT-FILE.
            if (!(WS.FCRALRT_STAT.IsEqualTo("00")))                                                             //COBOL==> IF FCRALRT-STAT NOT = '00'
            {
                ...
                LS.NUMERIC_RETURN_CODE_0002.SetValue(WS.FCRALRT_STAT);                                              //COBOL==> MOVE FCRALRT-STAT TO NUMERIC-RETURN-CODE-0002
            }                                                                                                   //COBOL==> END-IF.
        ...
        private void M_1100_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1100_EXIT") { M_1200_PROCESS_ALERTS(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1200_PROCESS_ALERTS
        /// </summary>
        /// <remarks>
        ///COMMENT:     PROCESS THE INPUT FCR ALERT FILE
        /// </remarks>
        private void M_1200_PROCESS_ALERTS(string returnMethod = "")
        {
            M_1210_READ_ALERTS("M_1210_EXIT"); if (Control.ExitProgram) { return; }                               //COBOL==> PERFORM 1210-READ-ALERTS THRU 1210-EXIT.
            if (WS.NO_MORE_ALERTS.Value)                                                                        //COBOL==> IF NO-MORE-ALERTS
            {
                M_1200_EXIT(CheckGotoReturn(returnMethod)); return;                                                 //COBOL==> GO TO 1200-EXIT.
            }
            LS.CASE_ID_0003.SetValue(FD.SSNOUT_CASE_ID);                                                        //COBOL==> MOVE SSNOUT-CASE-ID TO CASE-ID-0003
            LS.PERSON_ID_0003.SetValue(FD.SSNOUT_PERSON_NUMBER);                                                //COBOL==> MOVE SSNOUT-PERSON-NUMBER TO PERSON-ID-0003
            LS.FCR_SSN_0003.SetValue(FD.SSNOUT_FCR_SSN);                                                        //COBOL==> MOVE SSNOUT-FCR-SSN TO FCR-SSN-0003
            LS.CSE_SSN_0003.SetValue(FD.SSNOUT_CSE_SSN);                                                        //COBOL==> MOVE SSNOUT-CSE-SSN TO CSE-SSN-0003
            LS.FCR_ADDITIONAL_SSN1_0003.SetValue(FD.SSNOUT_FCR_ADDITIONAL_SSN1);                                //COBOL==> MOVE SSNOUT-FCR-ADDITIONAL-SSN1 TO FCR-ADDITIONAL-SSN1-0003
            LS.FCR_ADDITIONAL_SSN2_0003.SetValue(FD.SSNOUT_FCR_ADDITIONAL_SSN2);                                //COBOL==> MOVE SSNOUT-FCR-ADDITIONAL-SSN2 TO FCR-ADDITIONAL-SSN2-0003
            LS.CSE_ADDITIONAL_SSN1_0003.SetValue(FD.SSNOUT_CSE_ADDITIONAL_SSN1);                                //COBOL==> MOVE SSNOUT-CSE-ADDITIONAL-SSN1 TO CSE-ADDITIONAL-SSN1-0003
            LS.CSE_ADDITIONAL_SSN2_0003.SetValue(FD.SSNOUT_CSE_ADDITIONAL_SSN2);                                //COBOL==> MOVE SSNOUT-CSE-ADDITIONAL-SSN2 TO CSE-ADDITIONAL-SSN2-0003.
            if (returnMethod != "" && returnMethod != "M_1200_PROCESS_ALERTS") { M_1200_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1200_EXIT
        /// </summary>
        private void M_1200_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1200_EXIT") { M_1210_READ_ALERTS(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1210_READ_ALERTS
        /// </summary>
        private void M_1210_READ_ALERTS(string returnMethod = "")
        {
            FD.FCR_OUT_ALERT_FILE.ReadLine();                                                                   //COBOL==> READ FCR-OUT-ALERT-FILE
            if (FD.FCR_OUT_ALERT_FILE.FileStatus == FileStatus.End_of_file)                                     //COBOL==> AT END
            {
                WS.NO_MORE_ALERTS.SetValue(true);                                                                   //COBOL==> SET NO-MORE-ALERTS TO TRUE.
            }
            if (WS.FCRALRT_STAT.IsEqualTo("10"))                                                                //COBOL==> IF FCRALRT-STAT = '10'
            {
                LS.TEXT_LINE_80_0002.SetValue("REACHED END OF FCR ALERT FILE");                                     //COBOL==> MOVE 'REACHED END OF FCR ALERT FILE' TO TEXT-LINE-80-0002
            ...
            if (!(WS.FCRALRT_STAT.IsEqualTo("00")))                                                             //COBOL==> IF FCRALRT-STAT NOT = '00'
            {
                LS.TEXT_LINE_80_0002.SetValue("ERROR IN READING ALERT FILE");                                       //COBOL==> MOVE 'ERROR IN READING ALERT FILE' TO TEXT-LINE-80-0002
            ...
            if (returnMethod != "" && returnMethod != "M_1210_READ_ALERTS") { M_1210_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_1210_EXIT
        /// </summary>
        private void M_1210_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_1210_EXIT") { M_1400_CLOSE_FILE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        {
            FD.FCR_OUT_ALERT_FILE.CloseFile();                                                                  //COBOL==> CLOSE FCR-OUT-ALERT-FILE.
            if (!(WS.FCRALRT_STAT.IsEqualTo("00")))                                                             //COBOL==> IF FCRALRT-STAT NOT = '00'
            {
        ...
        private void M_9999_EXIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_EXIT") { M_PARA_0041158661_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0041158661_EXIT
        /// </summary>
        private void M_PARA_0041158661_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0041158661_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_0041158661_EXIT") { M_PARA_0041158661_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0041158661_INIT
        /// </summary>
        private void M_PARA_0041158661_INIT(string returnMethod = "")
        {
            LS.EXPORT_EXTERNAL_FILE_ST_0002EV.ResetToInitialValue();                                            //COBOL==> INITIALIZE EXPORT-EXTERNAL-FILE-ST-0002EV
            LS.EXPORT_FCR_ALERT_0003EV.ResetToInitialValue();                                                   //COBOL==> INITIALIZE EXPORT-FCR-ALERT-0003EV .
            if (returnMethod != "" && returnMethod != "M_PARA_0041158661_INIT") { M_PARA_0041158661_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_0041158661_INIT_EXIT
        /// </summary>
        private void M_PARA_0041158661_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_0041158661_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
