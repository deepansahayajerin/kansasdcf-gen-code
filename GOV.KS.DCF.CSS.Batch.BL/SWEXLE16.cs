...
/* Conversion Comments
   ...
   ************************************************************
   ** INIT   *  INITIAL VERSION   *  2022-03-02 04:53:07 PM
   **        *   FROM COBOL PGM   :  SWEXLE16
...
/* Original Program Identification Comments
   **************************************************************
       ...
       NAME: LE_BFX5_READ_EXTRACT_DATA_FILE   DATE: 2007/02/09
       TARGET OS:   MVS                       TIME: 11:49:34
...
namespace GOV.KS.DCF.CSS.Batch.BL
{
    ...
    internal class SWEXLE16_fd : PredefinedRecordBase
    {
        ...
        {
            internal const string FileSection = "SWEXLE16_fd_FileSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               INPUT_RECORD.CreateNewField(Names.CSP_NUMBER, FieldType.String, 10);
               INPUT_RECORD.CreateNewField(Names.CSP_NAME, FieldType.String, 33);
               INPUT_RECORD.CreateNewField(Names.STREET, FieldType.String, 25);
               INPUT_RECORD.CreateNewField(Names.STREET_2, FieldType.String, 25);
               INPUT_RECORD.CreateNewField(Names.CITY, FieldType.String, 15);
               INPUT_RECORD.CreateNewField(Names.STATE, FieldType.String, 2);
        ...
        #region Constructors
        public SWEXLE16_fd(SWEXLE16_ws ws)
            : base()
        {
            this.WS = ws;
            Initialize();
    ...
    internal class SWEXLE16_ws : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string WorkingStorage = "SWEXLE16_ws_WorkingStorage";
    ...
    internal class SWEXLE16_ls : PredefinedRecordBase
    {
        #region Name constants
        /// <summary>
        /// Name constants.
        ...
        internal static class Names
        {
            internal const string LinkageSection = "SWEXLE16_ls_LinkageSection";
        ...
        protected override void DefineRecordStructure(IStructureDefinition recordDef)
        {
           ...
           {
               EXPORT_0004EV.CreateNewGroup(Names.CSE_PERSON_ADDRESS_0004ET, (CSE_PERSON_ADDRESS_0004ET) =>
               {
    ...
    public class SWEXLE16 : EABBase
    {
        ...
        public SWEXLE16()
            : base()
        {
            this.ProgramName.SetValue("SWEXLE16");

            WS = new SWEXLE16_ws();
            FD = new SWEXLE16_fd(WS);
            LS = new SWEXLE16_ls();
        }
        ...
        private SWEXLE16_ws WS;

        //==== File Data Class ========================================
        private SWEXLE16_fd FD;

        //==== Linkage Section Data Class ========================================
        private SWEXLE16_ls LS;
        #endregion
        ...
        //========================================================================
        public override int ExecuteMain(params object[] args)                                              //COBOL==> PROCEDURE DIVISION USING IEF-RUNTIME-PARM1 , IEF-RUNTIME-PARM2 , GLOBDATA , IMPORT-0001EV , EXPORT-0002EV , EXPORT-0003EV , EXPORT-0004EV.
        {
            try
            {
                WS.Initialize();
        ...
        private void RunMain()
        {
            ...
            M_MAIN_1546390448(returnMethod);
        }
        /// <summary>
        /// Method M_MAIN_1546390448
        /// </summary>
        private void M_MAIN_1546390448(string returnMethod = "")
        {
            M_PARA_1546390448_INIT("M_PARA_1546390448_INIT_EXIT"); if (Control.ExitProgram) { return; }           //COBOL==> PERFORM PARA-1546390448-INIT THRU PARA-1546390448-INIT-EXIT
            M_PARA_1546390448("M_PARA_1546390448_EXIT"); if (Control.ExitProgram) { return; }                     //COBOL==> PERFORM PARA-1546390448 THRU PARA-1546390448-EXIT
            Control.ExitProgram = true; return;                                                                 //COBOL==> GOBACK.
        }
        /// <summary>
        /// Method M_PARA_1546390448
        /// </summary>
        private void M_PARA_1546390448(string returnMethod = "")
        {
            if (returnMethod != "" && returnMethod != "M_PARA_1546390448") { M_0000_MAINLINE(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        ...
        private void M_2000_READ_FILE(string returnMethod = "")
        {
            ...
            {
                LS.NUMBER_0003.SetValue(FD.CSP_NUMBER);                                                             //COBOL==> MOVE CSP-NUMBER TO NUMBER-0003
                LS.FORMATTED_NAME_0003.SetValue(FD.CSP_NAME);                                                       //COBOL==> MOVE CSP-NAME TO FORMATTED-NAME-0003
                LS.STREET_1_0004.SetValue(FD.STREET);                                                               //COBOL==> MOVE STREET TO STREET-1-0004
                LS.STREET_2_0004.SetValue(FD.STREET_2);                                                             //COBOL==> MOVE STREET-2 TO STREET-2-0004
                LS.CITY_0004.SetValue(FD.CITY);                                                                     //COBOL==> MOVE CITY TO CITY-0004
                LS.STATE_0004.SetValue(FD.STATE);                                                                   //COBOL==> MOVE STATE TO STATE-0004
                LS.ZIP_CODE_0004.SetValue(FD.ZIP_CODE);                                                             //COBOL==> MOVE ZIP-CODE TO ZIP-CODE-0004
            }                                                                                                //COBOL==> WHEN '10'
            else
        ...
        private void M_9999_FINISHED(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_9999_FINISHED") { M_PARA_1546390448_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1546390448_EXIT
        /// </summary>
        private void M_PARA_1546390448_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1546390448_EXIT") { return; }                                           //COBOL==> EXIT.
            if (returnMethod != "" && returnMethod != "M_PARA_1546390448_EXIT") { M_PARA_1546390448_INIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1546390448_INIT
        /// </summary>
        private void M_PARA_1546390448_INIT(string returnMethod = "")
        {
            ...
            if (returnMethod != "" && returnMethod != "M_PARA_1546390448_INIT") { M_PARA_1546390448_INIT_EXIT(returnMethod); }  //Check for pass through to next method
        }
        /// <summary>
        /// Method M_PARA_1546390448_INIT_EXIT
        /// </summary>
        private void M_PARA_1546390448_INIT_EXIT(string returnMethod = "")
        {
            if (returnMethod == "M_PARA_1546390448_INIT_EXIT") { return; }                                      //COBOL==> EXIT.
        }
        #endregion
    }
    #endregion
